; ModuleID = 'urr.cpp-amdgcn-amd-amdhsa-gfx942.o.5.precodegen.bc'
...
define hidden noundef double @_ZNK6openmc7UrrData4probEiNS_13URRTableParamEi(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(240) %this, i32 noundef %i_energy, i32 noundef %i_tableparam, i32 noundef %band) local_unnamed_addr #0 align 2 {
entry:
