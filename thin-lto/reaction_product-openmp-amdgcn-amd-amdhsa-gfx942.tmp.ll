; ModuleID = 'reaction_product-openmp-amdgcn-amd-amdhsa-gfx942.tmp.bc'
...
define hidden void @_ZN6openmc19ReactionProductFlatC2EPKh(ptr noundef nonnull align 8 dereferenceable(32) %this, ptr noundef %data) unnamed_addr #3 align 2 {
entry:
  ...
  %data_ = getelementptr inbounds nuw %"class.openmc::ReactionProductFlat", ptr %this1, i32 0, i32 0
  %0 = load ptr, ptr %data.addr.ascast, align 8, !tbaa !25
  store ptr %0, ptr %data_, align 8, !tbaa !27
  %data_2 = getelementptr inbounds nuw %"class.openmc::ReactionProductFlat", ptr %this1, i32 0, i32 0
  ...
  %yield_size_ = getelementptr inbounds nuw %"class.openmc::ReactionProductFlat", ptr %this1, i32 0, i32 1
  store i64 %2, ptr %yield_size_, align 8, !tbaa !31
  %data_3 = getelementptr inbounds nuw %"class.openmc::ReactionProductFlat", ptr %this1, i32 0, i32 0
  %3 = load ptr, ptr %data_3, align 8, !tbaa !27
  %add.ptr4 = getelementptr inbounds i8, ptr %3, i64 24
  %yield_size_5 = getelementptr inbounds nuw %"class.openmc::ReactionProductFlat", ptr %this1, i32 0, i32 1
  %4 = load i64, ptr %yield_size_5, align 8, !tbaa !31
  %add.ptr6 = getelementptr inbounds nuw i8, ptr %add.ptr4, i64 %4
  %5 = load i64, ptr %add.ptr6, align 8, !tbaa !30
  %n_applicability_ = getelementptr inbounds nuw %"class.openmc::ReactionProductFlat", ptr %this1, i32 0, i32 2
  store i64 %5, ptr %n_applicability_, align 8, !tbaa !32
  %data_7 = getelementptr inbounds nuw %"class.openmc::ReactionProductFlat", ptr %this1, i32 0, i32 0
  %6 = load ptr, ptr %data_7, align 8, !tbaa !27
  %add.ptr8 = getelementptr inbounds i8, ptr %6, i64 32
  %yield_size_9 = getelementptr inbounds nuw %"class.openmc::ReactionProductFlat", ptr %this1, i32 0, i32 1
  %7 = load i64, ptr %yield_size_9, align 8, !tbaa !31
  %add.ptr10 = getelementptr inbounds nuw i8, ptr %add.ptr8, i64 %7
  %8 = load i64, ptr %add.ptr10, align 8, !tbaa !30
  %n_distribution_ = getelementptr inbounds nuw %"class.openmc::ReactionProductFlat", ptr %this1, i32 0, i32 3
  store i64 %8, ptr %n_distribution_, align 8, !tbaa !33
  ret void
}

; Function Attrs: convergent mustprogress nounwind
define hidden void @_ZNK6openmc19ReactionProductFlat6sampleEdRdS1_Pm(ptr noundef nonnull align 8 dereferenceable(32) %this, double noundef %E_in, ptr noundef nonnull align 8 dereferenceable(8) %E_out, ptr noundef nonnull align 8 dereferenceable(8) %mu, ptr noundef %seed) #3 align 2 {
entry:
  %this.addr = alloca ptr, align 8, addrspace(5)
  ...
  store ptr %E_out, ptr %E_out.addr.ascast, align 8, !tbaa !34
  store ptr %mu, ptr %mu.addr.ascast, align 8, !tbaa !34
  store ptr %seed, ptr %seed.addr.ascast, align 8, !tbaa !36
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %n) #7
  %n_applicability_ = getelementptr inbounds nuw %"class.openmc::ReactionProductFlat", ptr %this1, i32 0, i32 2
  %0 = load i64, ptr %n_applicability_, align 8, !tbaa !32
  store i64 %0, ptr %n.ascast, align 8, !tbaa !30
  %1 = load i64, ptr %n.ascast, align 8, !tbaa !30
  %cmp = icmp ugt i64 %1, 1
  br i1 %cmp, label %if.then, label %if.else

if.then:                                          ; preds = %entry
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %prob) #7
  store double 0.000000e+00, ptr %prob.ascast, align 8, !tbaa !14
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %c) #7
  %2 = load ptr, ptr %seed.addr.ascast, align 8, !tbaa !36
  %call = call noundef double @_ZN6openmc3prnEPm(ptr noundef %2) #9
...
for.body:                                         ; preds = %for.cond
  call void @llvm.lifetime.start.p5(i64 24, ptr addrspace(5) %ref.tmp) #7
  %5 = load i32, ptr %i.ascast, align 4, !tbaa !18
  %conv3 = sext i32 %5 to i64
  %call4 = call %"class.openmc::Tabulated1DFlat" @_ZNK6openmc19ReactionProductFlat13applicabilityEl(ptr noundef nonnull align 8 dereferenceable(32) %this1, i64 noundef %conv3) #9
  %6 = getelementptr inbounds nuw %"class.openmc::Tabulated1DFlat", ptr %ref.tmp.ascast, i32 0, i32 0
  %7 = extractvalue %"class.openmc::Tabulated1DFlat" %call4, 0
  store ptr %7, ptr %6, align 8
  %8 = getelementptr inbounds nuw %"class.openmc::Tabulated1DFlat", ptr %ref.tmp.ascast, i32 0, i32 1
  %9 = extractvalue %"class.openmc::Tabulated1DFlat" %call4, 1
  store i64 %9, ptr %8, align 8
  %10 = getelementptr inbounds nuw %"class.openmc::Tabulated1DFlat", ptr %ref.tmp.ascast, i32 0, i32 2
  %11 = extractvalue %"class.openmc::Tabulated1DFlat" %call4, 2
  store i64 %11, ptr %10, align 8
  %12 = load double, ptr %E_in.addr.ascast, align 8, !tbaa !14
  %call5 = call noundef double @_ZNK6openmc15Tabulated1DFlatclEd(ptr noundef nonnull align 8 dereferenceable(24) %ref.tmp.ascast, double noundef %12) #9
  %13 = load double, ptr %prob.ascast, align 8, !tbaa !14
  %add = fadd double %13, %call5
  store double %add, ptr %prob.ascast, align 8, !tbaa !14
  call void @llvm.lifetime.end.p5(i64 24, ptr addrspace(5) %ref.tmp) #7
  %14 = load double, ptr %c.ascast, align 8, !tbaa !14
  %15 = load double, ptr %prob.ascast, align 8, !tbaa !14
  %cmp6 = fcmp ole double %14, %15
  br i1 %cmp6, label %if.then7, label %if.end

if.then7:                                         ; preds = %for.body
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %ref.tmp8) #7
  %16 = load i32, ptr %i.ascast, align 4, !tbaa !18
  %conv9 = sext i32 %16 to i64
  %call10 = call ptr @_ZNK6openmc19ReactionProductFlat12distributionEl(ptr noundef nonnull align 8 dereferenceable(32) %this1, i64 noundef %conv9) #9
  %coerce.dive = getelementptr inbounds nuw %"class.openmc::AngleEnergyFlat", ptr %ref.tmp8.ascast, i32 0, i32 0
  store ptr %call10, ptr %coerce.dive, align 8
  %17 = load double, ptr %E_in.addr.ascast, align 8, !tbaa !14
  %18 = load ptr, ptr %E_out.addr.ascast, align 8, !tbaa !34
  %19 = load ptr, ptr %mu.addr.ascast, align 8, !tbaa !34
  %20 = load ptr, ptr %seed.addr.ascast, align 8, !tbaa !36
  call void @_ZNK6openmc15AngleEnergyFlat6sampleEdRdS1_Pm(ptr noundef nonnull align 8 dereferenceable(8) %ref.tmp8.ascast, double noundef %17, ptr noundef nonnull align 8 dereferenceable(8) %18, ptr noundef nonnull align 8 dereferenceable(8) %19, ptr noundef %20) #9
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %ref.tmp8) #7
  br label %if.end
...
for.end:                                          ; preds = %for.cond.cleanup
  ...
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %prob) #7
  br label %if.end14

if.else:                                          ; preds = %entry
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %ref.tmp11) #7
  %call12 = call ptr @_ZNK6openmc19ReactionProductFlat12distributionEl(ptr noundef nonnull align 8 dereferenceable(32) %this1, i64 noundef 0) #9
  %coerce.dive13 = getelementptr inbounds nuw %"class.openmc::AngleEnergyFlat", ptr %ref.tmp11.ascast, i32 0, i32 0
  store ptr %call12, ptr %coerce.dive13, align 8
  %22 = load double, ptr %E_in.addr.ascast, align 8, !tbaa !14
  %23 = load ptr, ptr %E_out.addr.ascast, align 8, !tbaa !34
  %24 = load ptr, ptr %mu.addr.ascast, align 8, !tbaa !34
  %25 = load ptr, ptr %seed.addr.ascast, align 8, !tbaa !36
  call void @_ZNK6openmc15AngleEnergyFlat6sampleEdRdS1_Pm(ptr noundef nonnull align 8 dereferenceable(8) %ref.tmp11.ascast, double noundef %22, ptr noundef nonnull align 8 dereferenceable(8) %23, ptr noundef nonnull align 8 dereferenceable(8) %24, ptr noundef %25) #9
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %ref.tmp11) #7
  br label %if.end14

if.end14:                                         ; preds = %if.else, %for.end
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %n) #7
  ret void
}
...
; Function Attrs: convergent mustprogress nounwind
define hidden %"class.openmc::Tabulated1DFlat" @_ZNK6openmc19ReactionProductFlat13applicabilityEl(ptr noundef nonnull align 8 dereferenceable(32) %this, i64 noundef %i) #3 align 2 {
entry:
  ...
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %indices) #7
  %data_ = getelementptr inbounds nuw %"class.openmc::ReactionProductFlat", ptr %this1, i32 0, i32 0
  %0 = load ptr, ptr %data_, align 8, !tbaa !27
  %add.ptr = getelementptr inbounds i8, ptr %0, i64 40
  %yield_size_ = getelementptr inbounds nuw %"class.openmc::ReactionProductFlat", ptr %this1, i32 0, i32 1
  %1 = load i64, ptr %yield_size_, align 8, !tbaa !31
  %add.ptr2 = getelementptr inbounds nuw i8, ptr %add.ptr, i64 %1
  store ptr %add.ptr2, ptr %indices.ascast, align 8, !tbaa !40
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %offset) #7
  %2 = load ptr, ptr %indices.ascast, align 8, !tbaa !40
  ...
  %data_3 = getelementptr inbounds nuw %"class.openmc::ReactionProductFlat", ptr %this1, i32 0, i32 0
  %5 = load ptr, ptr %data_3, align 8, !tbaa !27
  %6 = load i64, ptr %offset.ascast, align 8, !tbaa !30
  %add.ptr4 = getelementptr inbounds nuw i8, ptr %5, i64 %6
  call void @_ZN6openmc15Tabulated1DFlatC1EPKh(ptr noundef nonnull align 8 dereferenceable(24) %retval.ascast, ptr noundef %add.ptr4) #9
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %offset) #7
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %indices) #7
  %7 = load %"class.openmc::Tabulated1DFlat", ptr %retval.ascast, align 8
  ret %"class.openmc::Tabulated1DFlat" %7
}
...
; Function Attrs: convergent mustprogress nounwind
define hidden ptr @_ZNK6openmc19ReactionProductFlat12distributionEl(ptr noundef nonnull align 8 dereferenceable(32) %this, i64 noundef %i) #3 align 2 {
entry:
  ...
  %2 = load ptr, ptr %indices.ascast, align 8, !tbaa !40
  %n_applicability_ = getelementptr inbounds nuw %"class.openmc::ReactionProductFlat", ptr %this1, i32 0, i32 2
  %3 = load i64, ptr %n_applicability_, align 8, !tbaa !32
  %4 = load i64, ptr %i.addr.ascast, align 8, !tbaa !30
  %add = add i64 %3, %4
  %arrayidx = getelementptr inbounds nuw i32, ptr %2, i64 %add
  %5 = load i32, ptr %arrayidx, align 4, !tbaa !18
  %conv = sext i32 %5 to i64
  store i64 %conv, ptr %offset.ascast, align 8, !tbaa !30
  %data_3 = getelementptr inbounds nuw %"class.openmc::ReactionProductFlat", ptr %this1, i32 0, i32 0
  %6 = load ptr, ptr %data_3, align 8, !tbaa !27
  %7 = load i64, ptr %offset.ascast, align 8, !tbaa !30
  %add.ptr4 = getelementptr inbounds nuw i8, ptr %6, i64 %7
  call void @_ZN6openmc15AngleEnergyFlatC2EPKh(ptr noundef nonnull align 8 dereferenceable(8) %retval.ascast, ptr noundef %add.ptr4) #9
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %offset) #7
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %indices) #7
...
; Function Attrs: convergent
declare void @_ZNK6openmc15AngleEnergyFlat6sampleEdRdS1_Pm(ptr noundef nonnull align 8 dereferenceable(8), double noundef, ptr noundef nonnull align 8 dereferenceable(8), ptr noundef nonnull align 8 dereferenceable(8), ptr noundef) #4
...
; Function Attrs: convergent mustprogress nounwind
define hidden noundef i32 @_ZNK6openmc19ReactionProductFlat8particleEv(ptr noundef nonnull align 8 dereferenceable(32) %this) #3 align 2 {
entry:
  ...
  %data_ = getelementptr inbounds nuw %"class.openmc::ReactionProductFlat", ptr %this1, i32 0, i32 0
  %0 = load ptr, ptr %data_, align 8, !tbaa !27
  %1 = load i32, ptr %0, align 4, !tbaa !46
  ret i32 %1
}

; Function Attrs: convergent mustprogress nounwind
define hidden noundef i32 @_ZNK6openmc19ReactionProductFlat13emission_modeEv(ptr noundef nonnull align 8 dereferenceable(32) %this) #3 align 2 {
entry:
  %retval = alloca i32, align 4, addrspace(5)
  %this.addr = alloca ptr, align 8, addrspace(5)
  %retval.ascast = addrspacecast ptr addrspace(5) %retval to ptr
  ...
  %1 = load i32, ptr %add.ptr, align 4, !tbaa !48
  ret i32 %1
}

; Function Attrs: convergent mustprogress nounwind
define hidden noundef double @_ZNK6openmc19ReactionProductFlat10decay_rateEv(ptr noundef nonnull align 8 dereferenceable(32) %this) #3 align 2 {
entry:
...
; Function Attrs: convergent mustprogress nounwind
define hidden ptr @_ZNK6openmc19ReactionProductFlat5yieldEv(ptr noundef nonnull align 8 dereferenceable(32) %this) #3 align 2 {
entry:
  ...
  call void @_ZN6openmc14Function1DFlatC2EPKh(ptr noundef nonnull align 8 dereferenceable(8) %retval.ascast, ptr noundef %add.ptr) #9
...
entry:
  ...
  %0 = load ptr, ptr %data.addr.ascast, align 8, !tbaa !25
  store ptr %0, ptr %data_, align 8, !tbaa !52
  ret void
}
...
define internal double @__ocml_logb_f64(double noundef %0) #5 {
  ...
  %5 = load i8, ptr addrspace(4) @__oclc_finite_only_opt, align 1, !tbaa !54, !range !58, !noundef !59
  %6 = icmp eq i8 %5, 0
...
!21 = !{!"float", !16, i64 0}
!22 = !{!23, !23, i64 0}
!23 = !{!"p1 _ZTSN6openmc19ReactionProductFlatE", !24, i64 0}
!24 = !{!"any pointer", !16, i64 0}
!25 = !{!26, !26, i64 0}
!26 = !{!"p1 omnipotent char", !24, i64 0}
!27 = !{!28, !26, i64 0}
!28 = !{!"_ZTSN6openmc19ReactionProductFlatE", !26, i64 0, !29, i64 8, !29, i64 16, !29, i64 24}
!29 = !{!"long", !16, i64 0}
!30 = !{!29, !29, i64 0}
!31 = !{!28, !29, i64 8}
!32 = !{!28, !29, i64 16}
...
!41 = !{!"p1 int", !24, i64 0}
!42 = !{!43, !43, i64 0}
!43 = !{!"p1 _ZTSN6openmc15AngleEnergyFlatE", !24, i64 0}
!44 = !{!45, !26, i64 0}
!45 = !{!"_ZTSN6openmc15AngleEnergyFlatE", !26, i64 0}
!46 = !{!47, !47, i64 0}
!47 = !{!"_ZTSN6openmc8Particle4TypeE", !16, i64 0}
!48 = !{!49, !49, i64 0}
!49 = !{!"_ZTSN6openmc15ReactionProduct12EmissionModeE", !16, i64 0}
!50 = !{!51, !51, i64 0}
!51 = !{!"p1 _ZTSN6openmc14Function1DFlatE", !24, i64 0}
!52 = !{!53, !26, i64 0}
!53 = !{!"_ZTSN6openmc14Function1DFlatE", !26, i64 0}
!54 = !{!55, !55, i64 0}
!55 = !{!"bool", !56, i64 0}
