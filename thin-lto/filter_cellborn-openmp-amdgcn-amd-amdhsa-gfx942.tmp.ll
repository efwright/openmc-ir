; ModuleID = 'filter_cellborn-openmp-amdgcn-amd-amdhsa-gfx942.tmp.bc'
...
entry:
  ...
  %1 = load i32, ptr %cell_born_, align 4, !tbaa !31
  %call = call noundef ptr @_ZNK6openmc10static_mapIiiNS_12integer_hashIiEEE4findEi(ptr noundef nonnull align 8 dereferenceable(50) %map_, i32 noundef %1) #10
  store ptr %call, ptr %search.ascast, align 8, !tbaa !47
...
if.then:                                          ; preds = %entry
  %3 = load ptr, ptr %match.addr.ascast, align 8, !tbaa !29
  %4 = load ptr, ptr %search.ascast, align 8, !tbaa !47
  %second = getelementptr inbounds nuw %"struct.std::pair", ptr %4, i32 0, i32 1
  %5 = load i32, ptr %second, align 4, !tbaa !49
  call void @_ZN6openmc11FilterMatch9push_backEid(ptr noundef nonnull align 8 dereferenceable(1513) %3, i32 noundef %5, double noundef 1.000000e+00) #10
  br label %if.end
