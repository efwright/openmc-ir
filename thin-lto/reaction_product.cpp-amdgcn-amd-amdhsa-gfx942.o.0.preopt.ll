; ModuleID = 'reaction_product.cpp-amdgcn-amd-amdhsa-gfx942.o.0.preopt.bc'
...
; Function Attrs: convergent mustprogress nounwind
define hidden %"class.openmc::Tabulated1DFlat" @_ZNK6openmc19ReactionProductFlat13applicabilityEl(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(32) %this, i64 noundef %i) local_unnamed_addr #4 align 2 {
entry:
  ...
  call void @_ZN6openmc15Tabulated1DFlatC1EPKh(ptr noundef nonnull align 8 dereferenceable(24) %retval.ascast, ptr noundef %add.ptr4) #8
