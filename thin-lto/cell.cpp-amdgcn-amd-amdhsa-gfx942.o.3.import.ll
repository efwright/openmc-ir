; ModuleID = 'cell.cpp-amdgcn-amd-amdhsa-gfx942.o.3.import.bc'
...
if.else8.i:                                       ; preds = %if.else.i
  ...
  %5 = tail call noundef range(i32 0, -2147483648) i32 @llvm.abs.i32(i32 %3, i1 true) #4, !range !51
...
if.else11.i:                                      ; preds = %if.else.i8
  ...
  %12 = tail call noundef range(i32 0, -2147483648) i32 @llvm.abs.i32(i32 %10, i1 true) #4, !range !51
