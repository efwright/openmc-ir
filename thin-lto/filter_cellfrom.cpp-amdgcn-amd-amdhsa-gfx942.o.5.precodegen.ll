; ModuleID = 'filter_cellfrom.cpp-amdgcn-amd-amdhsa-gfx942.o.5.precodegen.bc'
...
define hidden void @_ZNK6openmc6Filter27CellFromFilter_get_all_binsERKNS_8ParticleENS_14TallyEstimatorERNS_11FilterMatchE(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(448) %this, ptr noundef nonnull readonly align 8 captures(none) dereferenceable(2728) %p, i32 noundef %estimator, ptr noundef nonnull align 8 captures(none) dereferenceable(1513) %match) local_unnamed_addr #0 align 2 {
entry:
  %n_coord_last_ = getelementptr inbounds nuw i8, ptr %p, i64 1368
  %0 = load i32, ptr %n_coord_last_, align 8, !tbaa !15
...
for.body:                                         ; preds = %if.end, %for.body.lr.ph
  %4 = phi i32 [ %0, %for.body.lr.ph ], [ %12, %if.end ]
  ...
  %5 = load i32, ptr %arrayidx, align 4, !tbaa !44
  ...
  %6 = load <2 x i64>, ptr %arrayidx.i.i, align 8
  %7 = extractelement <2 x i64> %6, i64 1
  %add.ptr.i = getelementptr inbounds nuw %"struct.std::pair", ptr %this.val1.i, i64 %7
  %8 = extractelement <2 x i64> %6, i64 0
  %cmp.not6.i = icmp samesign eq i64 %8, %7
...
for.body.preheader.i:                             ; preds = %for.body
  %add.ptr6.i = getelementptr inbounds nuw %"struct.std::pair", ptr %this.val1.i, i64 %8
  br label %for.body.i

for.body.i:                                       ; preds = %for.inc.i, %for.body.preheader.i
  %iter.07.i = phi ptr [ %incdec.ptr.i, %for.inc.i ], [ %add.ptr6.i, %for.body.preheader.i ]
  %9 = load i32, ptr %iter.07.i, align 4, !tbaa !45
...
for.inc.i:                                        ; preds = %for.body.i
  ...
  br i1 %cmp.not.i, label %_ZNK6openmc10static_mapIiiNS_12integer_hashIiEEE4findEi.internalized.exit, label %for.body.i, !llvm.loop !47
...
if.then:                                          ; preds = %_ZNK6openmc10static_mapIiiNS_12integer_hashIiEEE4findEi.internalized.exit
  %this.val.i7 = load i32, ptr %3, align 8, !tbaa !49
...
if.then.i:                                        ; preds = %if.then
  ...
  %10 = load i32, ptr %second, align 4, !tbaa !51
  %idxprom.i = sext i32 %this.val.i7 to i64
  %arrayidx.i = getelementptr inbounds [125 x i32], ptr %match, i64 0, i64 %idxprom.i
  store i32 %10, ptr %arrayidx.i, align 4, !tbaa !44
  %11 = load i32, ptr %3, align 8, !tbaa !49
  %idxprom3.i = sext i32 %11 to i64
  %arrayidx4.i = getelementptr inbounds [125 x double], ptr %weights_.i, i64 0, i64 %idxprom3.i
  store double 1.000000e+00, ptr %arrayidx4.i, align 8, !tbaa !52
  %inc.i = add nsw i32 %11, 1
  store i32 %inc.i, ptr %3, align 8, !tbaa !49
  %.pre = load i32, ptr %n_coord_last_, align 8, !tbaa !15
  br label %if.end

if.end:                                           ; preds = %if.then.i, %if.then, %_ZNK6openmc10static_mapIiiNS_12integer_hashIiEEE4findEi.internalized.exit
  %12 = phi i32 [ %.pre, %if.then.i ], [ %4, %if.then ], [ %4, %_ZNK6openmc10static_mapIiiNS_12integer_hashIiEEE4findEi.internalized.exit ]
