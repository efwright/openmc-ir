; ModuleID = 'filter_delayedgroup-openmp-amdgcn-amd-amdhsa-gfx942.tmp.bc'
...
entry:
  ...
  %0 = load ptr, ptr %match.addr.ascast, align 8, !tbaa !29
  call void @_ZN6openmc11FilterMatch9push_backEid(ptr noundef nonnull align 8 dereferenceable(1513) %0, i32 noundef 0, double noundef 1.000000e+00) #8
  ret void
}
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i32, ptr %bins_weights_length_, align 8, !tbaa !31
  ...
  %3 = load i32, ptr %bins_weights_length_2, align 8, !tbaa !31
  ...
  %4 = load i32, ptr %bins_weights_length_5, align 8, !tbaa !31
  %inc = add nsw i32 %4, 1
  store i32 %inc, ptr %bins_weights_length_5, align 8, !tbaa !31
  br label %if.end
...
entry:
  ...
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  %bins_weights_length_ = getelementptr inbounds nuw %"class.openmc::FilterMatch", ptr %this1, i32 0, i32 3
  %0 = load i32, ptr %bins_weights_length_, align 8, !tbaa !31
...
define internal double @__ocml_logb_f64(double noundef %0) #4 {
  ...
  %5 = load i8, ptr addrspace(4) @__oclc_finite_only_opt, align 1, !tbaa !34, !range !38, !noundef !39
  %6 = icmp eq i8 %5, 0
...
!31 = !{!32, !19, i64 1504}
!32 = !{!"_ZTSN6openmc11FilterMatchE", !16, i64 0, !16, i64 504, !19, i64 1504, !19, i64 1508, !33, i64 1512}
!33 = !{!"bool", !16, i64 0}
!34 = !{!35, !35, i64 0}
!35 = !{!"bool", !36, i64 0}
