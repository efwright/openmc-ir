; ModuleID = 'secondary_flat.cpp-amdgcn-amd-amdhsa-gfx942.o.0.preopt.bc'
...
sw.bb.i:                                          ; preds = %entry
  ...
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %dist.i) #6
  store ptr %this.val, ptr addrspace(5) %dist.i, align 8, !tbaa !21
  call void @_ZNK6openmc27UncorrelatedAngleEnergyFlat6sampleEdRdS1_Pm(ptr noundef nonnull align 8 dereferenceable(8) %dist.ascast.i, double noundef %E_in, ptr noundef nonnull align 8 dereferenceable(8) %E_out, ptr noundef nonnull align 8 dereferenceable(8) %mu, ptr noundef %seed) #7
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %dist.i) #8
...
sw.bb2.i:                                         ; preds = %entry
  ...
  call void @llvm.lifetime.start.p5(i64 24, ptr addrspace(5) %dist3.i) #8
  call void @_ZN6openmc15KalbachMannFlatC1EPKh(ptr noundef nonnull align 8 dereferenceable(24) %dist3.ascast.i, ptr noundef nonnull %this.val) #7
  ...
  call void @llvm.lifetime.end.p5(i64 24, ptr addrspace(5) %dist3.i) #8
  br label %_ZNK6openmc15AngleEnergyFlat6sampleEdRdS1_Pm.internalized.exit

sw.bb5.i:                                         ; preds = %entry
  %dist6.ascast.i = addrspacecast ptr addrspace(5) %dist6.i to ptr
  call void @llvm.lifetime.start.p5(i64 24, ptr addrspace(5) %dist6.i) #8
  call void @_ZN6openmc25CorrelatedAngleEnergyFlatC1EPKh(ptr noundef nonnull align 8 dereferenceable(24) %dist6.ascast.i, ptr noundef nonnull %this.val) #7
  ...
  call void @llvm.lifetime.end.p5(i64 24, ptr addrspace(5) %dist6.i) #8
  br label %_ZNK6openmc15AngleEnergyFlat6sampleEdRdS1_Pm.internalized.exit

sw.bb8.i:                                         ; preds = %entry
  %dist9.ascast.i = addrspacecast ptr addrspace(5) %dist9.i to ptr
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %dist9.i) #8
  ...
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %dist9.i) #8
  br label %_ZNK6openmc15AngleEnergyFlat6sampleEdRdS1_Pm.internalized.exit

sw.bb11.i:                                        ; preds = %entry
  %dist12.ascast.i = addrspacecast ptr addrspace(5) %dist12.i to ptr
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %dist12.i) #8
  ...
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %dist12.i) #8
  br label %_ZNK6openmc15AngleEnergyFlat6sampleEdRdS1_Pm.internalized.exit

sw.bb14.i:                                        ; preds = %entry
  %dist15.ascast.i = addrspacecast ptr addrspace(5) %dist15.i to ptr
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %dist15.i) #8
  ...
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %dist15.i) #8
  br label %_ZNK6openmc15AngleEnergyFlat6sampleEdRdS1_Pm.internalized.exit

sw.bb17.i:                                        ; preds = %entry
  %dist18.ascast.i = addrspacecast ptr addrspace(5) %dist18.i to ptr
  call void @llvm.lifetime.start.p5(i64 32, ptr addrspace(5) %dist18.i) #8
  call void @_ZN6openmc31IncoherentElasticAEDiscreteFlatC1EPKh(ptr noundef nonnull align 8 dereferenceable(32) %dist18.ascast.i, ptr noundef nonnull %this.val) #7
  ...
  call void @llvm.lifetime.end.p5(i64 32, ptr addrspace(5) %dist18.i) #8
  br label %_ZNK6openmc15AngleEnergyFlat6sampleEdRdS1_Pm.internalized.exit

sw.bb20.i:                                        ; preds = %entry
  %dist21.ascast.i = addrspacecast ptr addrspace(5) %dist21.i to ptr
  call void @llvm.lifetime.start.p5(i64 16, ptr addrspace(5) %dist21.i) #8
  call void @_ZN6openmc25IncoherentInelasticAEFlatC1EPKh(ptr noundef nonnull align 8 dereferenceable(16) %dist21.ascast.i, ptr noundef nonnull %this.val) #7
  ...
  call void @llvm.lifetime.end.p5(i64 16, ptr addrspace(5) %dist21.i) #8
  br label %_ZNK6openmc15AngleEnergyFlat6sampleEdRdS1_Pm.internalized.exit

sw.bb23.i:                                        ; preds = %entry
  %dist24.ascast.i = addrspacecast ptr addrspace(5) %dist24.i to ptr
  call void @llvm.lifetime.start.p5(i64 48, ptr addrspace(5) %dist24.i) #8
  call void @_ZN6openmc33IncoherentInelasticAEDiscreteFlatC1EPKh(ptr noundef nonnull align 8 dereferenceable(48) %dist24.ascast.i, ptr noundef nonnull %this.val) #7
  ...
  call void @llvm.lifetime.end.p5(i64 48, ptr addrspace(5) %dist24.i) #8
  br label %_ZNK6openmc15AngleEnergyFlat6sampleEdRdS1_Pm.internalized.exit
...
sw.bb:                                            ; preds = %entry
  ...
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %dist) #8
  store ptr %0, ptr addrspace(5) %dist, align 8, !tbaa !21
  call void @_ZNK6openmc27UncorrelatedAngleEnergyFlat6sampleEdRdS1_Pm(ptr noundef nonnull align 8 dereferenceable(8) %dist.ascast, double noundef %E_in, ptr noundef nonnull align 8 dereferenceable(8) %E_out, ptr noundef nonnull align 8 dereferenceable(8) %mu, ptr noundef %seed) #7
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %dist) #8
  br label %sw.epilog

sw.bb2:                                           ; preds = %entry
  %dist3.ascast = addrspacecast ptr addrspace(5) %dist3 to ptr
  call void @llvm.lifetime.start.p5(i64 24, ptr addrspace(5) %dist3) #8
  call void @_ZN6openmc15KalbachMannFlatC1EPKh(ptr noundef nonnull align 8 dereferenceable(24) %dist3.ascast, ptr noundef nonnull %0) #7
  call void @_ZNK6openmc15KalbachMannFlat6sampleEdRdS1_Pm(ptr noundef nonnull align 8 dereferenceable(24) %dist3.ascast, double noundef %E_in, ptr noundef nonnull align 8 dereferenceable(8) %E_out, ptr noundef nonnull align 8 dereferenceable(8) %mu, ptr noundef %seed) #7
  call void @llvm.lifetime.end.p5(i64 24, ptr addrspace(5) %dist3) #8
  br label %sw.epilog

sw.bb5:                                           ; preds = %entry
  %dist6.ascast = addrspacecast ptr addrspace(5) %dist6 to ptr
  call void @llvm.lifetime.start.p5(i64 24, ptr addrspace(5) %dist6) #8
  call void @_ZN6openmc25CorrelatedAngleEnergyFlatC1EPKh(ptr noundef nonnull align 8 dereferenceable(24) %dist6.ascast, ptr noundef nonnull %0) #7
  call void @_ZNK6openmc25CorrelatedAngleEnergyFlat6sampleEdRdS1_Pm(ptr noundef nonnull align 8 dereferenceable(24) %dist6.ascast, double noundef %E_in, ptr noundef nonnull align 8 dereferenceable(8) %E_out, ptr noundef nonnull align 8 dereferenceable(8) %mu, ptr noundef %seed) #7
  call void @llvm.lifetime.end.p5(i64 24, ptr addrspace(5) %dist6) #8
  br label %sw.epilog

sw.bb8:                                           ; preds = %entry
  %dist9.ascast = addrspacecast ptr addrspace(5) %dist9 to ptr
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %dist9) #8
  store ptr %0, ptr addrspace(5) %dist9, align 8, !tbaa !23
  call void @_ZNK6openmc19NBodyPhaseSpaceFlat6sampleEdRdS1_Pm(ptr noundef nonnull align 8 dereferenceable(8) %dist9.ascast, double noundef %E_in, ptr noundef nonnull align 8 dereferenceable(8) %E_out, ptr noundef nonnull align 8 dereferenceable(8) %mu, ptr noundef %seed) #7
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %dist9) #8
  br label %sw.epilog

sw.bb11:                                          ; preds = %entry
  %dist12.ascast = addrspacecast ptr addrspace(5) %dist12 to ptr
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %dist12) #8
  store ptr %0, ptr addrspace(5) %dist12, align 8, !tbaa !25
  call void @_ZNK6openmc21CoherentElasticAEFlat6sampleEdRdS1_Pm(ptr noundef nonnull align 8 dereferenceable(8) %dist12.ascast, double noundef %E_in, ptr noundef nonnull align 8 dereferenceable(8) %E_out, ptr noundef nonnull align 8 dereferenceable(8) %mu, ptr noundef %seed) #7
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %dist12) #8
  br label %sw.epilog

sw.bb14:                                          ; preds = %entry
  %dist15.ascast = addrspacecast ptr addrspace(5) %dist15 to ptr
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %dist15) #8
  store ptr %0, ptr addrspace(5) %dist15, align 8, !tbaa !27
  call void @_ZNK6openmc23IncoherentElasticAEFlat6sampleEdRdS1_Pm(ptr noundef nonnull align 8 dereferenceable(8) %dist15.ascast, double noundef %E_in, ptr noundef nonnull align 8 dereferenceable(8) %E_out, ptr noundef nonnull align 8 dereferenceable(8) %mu, ptr noundef %seed) #7
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %dist15) #8
  br label %sw.epilog

sw.bb17:                                          ; preds = %entry
  %dist18.ascast = addrspacecast ptr addrspace(5) %dist18 to ptr
  call void @llvm.lifetime.start.p5(i64 32, ptr addrspace(5) %dist18) #8
  call void @_ZN6openmc31IncoherentElasticAEDiscreteFlatC1EPKh(ptr noundef nonnull align 8 dereferenceable(32) %dist18.ascast, ptr noundef nonnull %0) #7
  call void @_ZNK6openmc31IncoherentElasticAEDiscreteFlat6sampleEdRdS1_Pm(ptr noundef nonnull align 8 dereferenceable(32) %dist18.ascast, double noundef %E_in, ptr noundef nonnull align 8 dereferenceable(8) %E_out, ptr noundef nonnull align 8 dereferenceable(8) %mu, ptr noundef %seed) #7
  call void @llvm.lifetime.end.p5(i64 32, ptr addrspace(5) %dist18) #8
  br label %sw.epilog

sw.bb20:                                          ; preds = %entry
  %dist21.ascast = addrspacecast ptr addrspace(5) %dist21 to ptr
  call void @llvm.lifetime.start.p5(i64 16, ptr addrspace(5) %dist21) #8
  call void @_ZN6openmc25IncoherentInelasticAEFlatC1EPKh(ptr noundef nonnull align 8 dereferenceable(16) %dist21.ascast, ptr noundef nonnull %0) #7
  call void @_ZNK6openmc25IncoherentInelasticAEFlat6sampleEdRdS1_Pm(ptr noundef nonnull align 8 dereferenceable(16) %dist21.ascast, double noundef %E_in, ptr noundef nonnull align 8 dereferenceable(8) %E_out, ptr noundef nonnull align 8 dereferenceable(8) %mu, ptr noundef %seed) #7
  call void @llvm.lifetime.end.p5(i64 16, ptr addrspace(5) %dist21) #8
  br label %sw.epilog

sw.bb23:                                          ; preds = %entry
  %dist24.ascast = addrspacecast ptr addrspace(5) %dist24 to ptr
  call void @llvm.lifetime.start.p5(i64 48, ptr addrspace(5) %dist24) #8
  call void @_ZN6openmc33IncoherentInelasticAEDiscreteFlatC1EPKh(ptr noundef nonnull align 8 dereferenceable(48) %dist24.ascast, ptr noundef nonnull %0) #7
  call void @_ZNK6openmc33IncoherentInelasticAEDiscreteFlat6sampleEdRdS1_Pm(ptr noundef nonnull align 8 dereferenceable(48) %dist24.ascast, double noundef %E_in, ptr noundef nonnull align 8 dereferenceable(8) %E_out, ptr noundef nonnull align 8 dereferenceable(8) %mu, ptr noundef %seed) #7
  call void @llvm.lifetime.end.p5(i64 48, ptr addrspace(5) %dist24) #8
  br label %sw.epilog
...
define hidden noundef i32 @_ZNK6openmc15AngleEnergyFlat4typeEv(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(8) %this) local_unnamed_addr #4 align 2 {
entry:
  %0 = load ptr, ptr %this, align 8, !tbaa !29
  %1 = load i32, ptr %0, align 4, !tbaa !19
  ret i32 %1
...
declare void @_ZNK6openmc27UncorrelatedAngleEnergyFlat6sampleEdRdS1_Pm(ptr noundef nonnull align 8 dereferenceable(8), double noundef, ptr noundef nonnull align 8 dereferenceable(8), ptr noundef nonnull align 8 dereferenceable(8), ptr noundef) local_unnamed_addr #5

; Function Attrs: convergent
declare void @_ZN6openmc15KalbachMannFlatC1EPKh(ptr noundef nonnull align 8 dereferenceable(24), ptr noundef) unnamed_addr #5
...
; Function Attrs: convergent
declare void @_ZN6openmc25CorrelatedAngleEnergyFlatC1EPKh(ptr noundef nonnull align 8 dereferenceable(24), ptr noundef) unnamed_addr #5
...
; Function Attrs: convergent
declare void @_ZN6openmc31IncoherentElasticAEDiscreteFlatC1EPKh(ptr noundef nonnull align 8 dereferenceable(32), ptr noundef) unnamed_addr #5
...
; Function Attrs: convergent
declare void @_ZN6openmc25IncoherentInelasticAEFlatC1EPKh(ptr noundef nonnull align 8 dereferenceable(16), ptr noundef) unnamed_addr #5
...
; Function Attrs: convergent
declare void @_ZN6openmc33IncoherentInelasticAEDiscreteFlatC1EPKh(ptr noundef nonnull align 8 dereferenceable(48), ptr noundef) unnamed_addr #5
