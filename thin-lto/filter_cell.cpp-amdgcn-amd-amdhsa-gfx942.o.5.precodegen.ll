; ModuleID = 'filter_cell.cpp-amdgcn-amd-amdhsa-gfx942.o.5.precodegen.bc'
...
define hidden void @_ZNK6openmc6Filter23CellFilter_get_all_binsERKNS_8ParticleENS_14TallyEstimatorERNS_11FilterMatchE(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(448) %this, ptr noundef nonnull readonly align 8 captures(none) dereferenceable(2728) %p, i32 noundef %estimator, ptr noundef nonnull align 8 captures(none) dereferenceable(1513) %match) local_unnamed_addr #0 align 2 {
entry:
...
for.body:                                         ; preds = %if.end, %for.body.lr.ph
  %5 = phi i32 [ %0, %for.body.lr.ph ], [ %13, %if.end ]
  ...
  %6 = load i32, ptr %cell, align 8, !tbaa !44
  ...
  %7 = load <2 x i64>, ptr %arrayidx.i.i, align 8
  %8 = extractelement <2 x i64> %7, i64 1
  %add.ptr.i = getelementptr inbounds nuw %"struct.std::pair", ptr %this.val1.i, i64 %8
  %9 = extractelement <2 x i64> %7, i64 0
  %cmp.not6.i = icmp samesign eq i64 %9, %8
...
for.body.preheader.i:                             ; preds = %for.body
  %add.ptr6.i = getelementptr inbounds nuw %"struct.std::pair", ptr %this.val1.i, i64 %9
  br label %for.body.i

for.body.i:                                       ; preds = %for.inc.i, %for.body.preheader.i
  %iter.07.i = phi ptr [ %incdec.ptr.i, %for.inc.i ], [ %add.ptr6.i, %for.body.preheader.i ]
  %10 = load i32, ptr %iter.07.i, align 4, !tbaa !46
  %cmp8.i = icmp eq i32 %6, %10
...
if.then.i:                                        ; preds = %if.then
  ...
  %11 = load i32, ptr %second, align 4, !tbaa !52
  %idxprom.i = sext i32 %this.val.i7 to i64
  %arrayidx.i = getelementptr inbounds [125 x i32], ptr %match, i64 0, i64 %idxprom.i
  store i32 %11, ptr %arrayidx.i, align 4, !tbaa !53
  %12 = load i32, ptr %4, align 8, !tbaa !50
...
if.end:                                           ; preds = %if.then.i, %if.then, %_ZNK6openmc10static_mapIiiNS_12integer_hashIiEEE4findEi.internalized.exit
  %13 = phi i32 [ %.pre, %if.then.i ], [ %5, %if.then ], [ %5, %_ZNK6openmc10static_mapIiiNS_12integer_hashIiEEE4findEi.internalized.exit ]
