; ModuleID = 'output.cpp-amdgcn-amd-amdhsa-gfx942.o.5.precodegen.bc'
...
entry:
  %0 = tail call i32 @__kmpc_target_init(ptr addrspacecast (ptr addrspace(1) @__omp_offloading_52_26f9b69__ZN6openmc9is_deviceEv_l403_kernel_environment to ptr), ptr %dyn_ptr) #2
...
user_code.entry:                                  ; preds = %entry
  %is_initial.global1 = addrspacecast ptr %is_initial to ptr addrspace(1)
  store i32 0, ptr addrspace(1) %is_initial.global1, align 4, !tbaa !29
  tail call void @__kmpc_target_deinit() #2
  br label %common.ret
}
