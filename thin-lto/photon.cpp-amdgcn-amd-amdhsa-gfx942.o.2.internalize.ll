; ModuleID = 'photon.cpp-amdgcn-amd-amdhsa-gfx942.o.2.internalize.bc'
...
entry:
  ...
  %0 = tail call i32 @__kmpc_target_init(ptr addrspacecast (ptr addrspace(1) @__omp_offloading_52_26f9b84__ZN6openmc17PhotonInteraction14copy_to_deviceEv_l863_kernel_environment to ptr), ptr %dyn_ptr) #8
...
entry:
  ...
  %123 = fneg double %122
  %124 = call double @llvm.fma.f64(double %2, double %119, double %123) #9
  %125 = call double @llvm.fma.f64(double %2, double %121, double %124) #9
  %126 = fadd double %122, %125
  %127 = fsub double %126, %122
  %128 = fsub double %125, %127
  %129 = call double @llvm.fabs.f64(double %122) #9
  ...
  %157 = call double @llvm.fma.f64(double %156, double %134, double %156) #9
  %158 = call double @llvm.fabs.f64(double %156) #9
  %159 = fcmp oeq double %158, 0x7FF0000000000000
  %160 = select i1 %159, double %156, double %157
  %161 = call double @llvm.trunc.f64(double %2) #9
  %162 = fcmp oeq double %161, %2
  %163 = fmul double %2, 5.000000e-01
  %164 = call double @llvm.trunc.f64(double %163) #9
  %165 = fcmp une double %164, %163
  %166 = and i1 %162, %165
  %167 = select i1 %166, double %0, double 1.000000e+00
  %168 = call double @llvm.copysign.f64(double %160, double %167) #9
  ...
  %179 = call double @llvm.copysign.f64(double %177, double %178) #9
...
while.cond.i:                                     ; preds = %if.end26.i, %while.cond
  %call.i = call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #10
  %cmp1.i = fcmp olt double %call.i, %div.i
  br i1 %cmp1.i, label %if.then2.i, label %if.else.i

if.then2.i:                                       ; preds = %while.cond.i
  %call3.i = call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #10
  %mul.i = fmul double %call3.i, 2.000000e+00
  %277 = call double @llvm.fmuladd.f64(double %alpha, double %mul.i, double 1.000000e+00)
  %call5.i = call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #10
...
if.else.i:                                        ; preds = %while.cond.i
  %call13.i = call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #10
  ...
  %call19.i = call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #10
...
if.else28.i:                                      ; preds = %while.cond
  %call31.i = call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #10
...
if.then43.i:                                      ; preds = %if.else28.i
  %call45.i = call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #10
...
if.then51.i:                                      ; preds = %if.else48.i
  %call53.i = call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #10
...
if.then61.i:                                      ; preds = %if.else57.i
  %call62.i = call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #10
  %282 = call double @llvm.fmuladd.f64(double %neg.i, double %call62.i, double 1.000000e+00)
  %283 = call noundef double @llvm.sqrt.f64(double %282) #9
  %mul65.i = fmul double %alpha, %283
  br label %if.end72.i

if.else66.i:                                      ; preds = %if.else57.i
  %call67.i = call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #10
  ...
  %287 = call double @llvm.fabs.f64(double %286) #9
  ...
  %407 = fneg double %406
  %408 = call double @llvm.fma.f64(double %284, double %403, double %407) #9
  %409 = call double @llvm.fma.f64(double %284, double %405, double %408) #9
  %410 = fadd double %406, %409
  %411 = fsub double %410, %406
  %412 = fsub double %409, %411
  %413 = call double @llvm.fabs.f64(double %406) #9
  %414 = fcmp oeq double %413, 0x7FF0000000000000
  %415 = select i1 %414, double %406, double %410
  %416 = call double @llvm.fabs.f64(double %415) #9
  ...
  %441 = call double @llvm.fma.f64(double %440, double %418, double %440) #9
  %442 = call double @llvm.fabs.f64(double %440) #9
  %443 = fcmp oeq double %442, 0x7FF0000000000000
  %444 = select i1 %443, double %440, double %441
  %445 = call double @llvm.trunc.f64(double %284) #9
  %446 = fcmp oeq double %445, %284
  %447 = fmul double %284, 5.000000e-01
  %448 = call double @llvm.trunc.f64(double %447) #9
  %449 = fcmp une double %448, %447
  %450 = and i1 %446, %449
  %451 = select i1 %450, double %286, double 1.000000e+00
  %452 = call double @llvm.copysign.f64(double %444, double %451) #9
  ...
  %456 = call double @llvm.fabs.f64(double %284) #9
  ...
  %472 = call double @llvm.copysign.f64(double %470, double %471) #9
...
_ZN6openmc13klein_nishinaEdPm.internalized.exit:  ; preds = %if.end72.i, %while.end.i
  ...
  %476 = call noundef double @llvm.sqrt.f64(double %mul4) #9
  %mul6 = fmul double %mul, %476
  call void @llvm.lifetime.start.p5(i64 24, ptr addrspace(5) %ref.tmp7) #8
  ...
  %call9 = call noundef double @_ZNK6openmc15Tabulated1DFlatclEd(ptr noundef nonnull align 8 dereferenceable(24) %ref.tmp7.ascast, double noundef %mul6) #10
  call void @llvm.lifetime.end.p5(i64 24, ptr addrspace(5) %ref.tmp7) #8
  %cmp = fcmp oeq double %form_factor_xmax.0, 0.000000e+00
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %_ZN6openmc13klein_nishinaEdPm.internalized.exit
  call void @llvm.lifetime.start.p5(i64 24, ptr addrspace(5) %ref.tmp10) #8
  ...
  call void @_ZN6openmc15Tabulated1DFlatC1EPKh(ptr noundef nonnull align 8 dereferenceable(24) %retval.ascast.i18, ptr noundef nonnull %add.ptr.i19) #10
  ...
  %call13 = call noundef double @_ZNK6openmc15Tabulated1DFlatclEd(ptr noundef nonnull align 8 dereferenceable(24) %ref.tmp10.ascast, double noundef %mul) #10
  call void @llvm.lifetime.end.p5(i64 24, ptr addrspace(5) %ref.tmp10) #8
  br label %if.end
...
if.end:                                           ; preds = %if.then, %_ZN6openmc13klein_nishinaEdPm.internalized.exit
  ...
  %call14 = call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #10
...
while.cond.i29:                                   ; preds = %while.cond.backedge.i, %if.then17
  %call.i30 = call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #10
...
if.end10.i:                                       ; preds = %for.end.i
  ...
  %486 = call noundef double @llvm.sqrt.f64(double %485) #9
...
while.body.i.i.i.i:                               ; preds = %while.body.i.i.i.i, %if.end.i.i
  ...
  %492 = call i1 @llvm.is.constant.i64(i64 range(i64 0, 4611686018427387904) %shr.i.i.i.i) #9
...
if.else62.i:                                      ; preds = %if.else57.i35
  ...
  %504 = call double @llvm.fabs.f64(double %501) #9
  ...
  %624 = fneg double %623
  %625 = call double @llvm.fma.f64(double %503, double %620, double %624) #9
  %626 = call double @llvm.fma.f64(double %503, double %622, double %625) #9
  %627 = fadd double %623, %626
  %628 = fsub double %627, %623
  %629 = fsub double %626, %628
  %630 = call double @llvm.fabs.f64(double %623) #9
  %631 = fcmp oeq double %630, 0x7FF0000000000000
  %632 = select i1 %631, double %623, double %627
  %633 = call double @llvm.fabs.f64(double %632) #9
  ...
  %658 = call double @llvm.fma.f64(double %657, double %635, double %657) #9
  %659 = call double @llvm.fabs.f64(double %657) #9
  %660 = fcmp oeq double %659, 0x7FF0000000000000
  %661 = select i1 %660, double %657, double %658
  %662 = call double @llvm.trunc.f64(double %503) #9
  %663 = fcmp oeq double %662, %503
  %664 = fmul double %503, 5.000000e-01
  %665 = call double @llvm.trunc.f64(double %664) #9
  %666 = fcmp une double %665, %664
  %667 = and i1 %663, %666
  %668 = select i1 %667, double %501, double 1.000000e+00
  %669 = call double @llvm.copysign.f64(double %661, double %668) #9
  ...
  %678 = call double @llvm.copysign.f64(double %676, double %677) #9
...
if.end76.i:                                       ; preds = %if.else62.i, %if.then59.i, %_ZN6openmc17lower_bound_indexIPddEENSt15iterator_traitsIT_E15difference_typeES3_S3_RKT0_.internalized.exit.i, %if.then34.i
  ...
  %call77.i = call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #10
...
while.body.i.i.i45.i:                             ; preds = %while.body.i.i.i45.i, %if.end.i33.i
  ...
  %686 = call i1 @llvm.is.constant.i64(i64 range(i64 0, 4611686018427387904) %shr.i.i.i48.i) #9
...
if.else115.i:                                     ; preds = %if.else109.i
  ...
  %696 = call noundef double @llvm.sqrt.f64(double %695) #9
...
if.end129.i:                                      ; preds = %if.else115.i, %if.then111.i, %_ZN6openmc17lower_bound_indexIPddEENSt15iterator_traitsIT_E15difference_typeES3_S3_RKT0_.internalized.exit63.i
  ...
  %699 = call double @llvm.fabs.f64(double %div130.i) #9
  ...
  %819 = fneg double %818
  %820 = call double @llvm.fma.f64(double %698, double %815, double %819) #9
  %821 = call double @llvm.fma.f64(double %698, double %817, double %820) #9
  %822 = fadd double %818, %821
  %823 = fsub double %822, %818
  %824 = fsub double %821, %823
  %825 = call double @llvm.fabs.f64(double %818) #9
  %826 = fcmp oeq double %825, 0x7FF0000000000000
  %827 = select i1 %826, double %818, double %822
  %828 = call double @llvm.fabs.f64(double %827) #9
  ...
  %853 = call double @llvm.fma.f64(double %852, double %830, double %852) #9
  %854 = call double @llvm.fabs.f64(double %852) #9
  %855 = fcmp oeq double %854, 0x7FF0000000000000
  %856 = select i1 %855, double %852, double %853
  %857 = call double @llvm.trunc.f64(double %698) #9
  %858 = fcmp oeq double %857, %698
  %859 = fmul double %698, 5.000000e-01
  %860 = call double @llvm.trunc.f64(double %859) #9
  %861 = fcmp une double %860, %859
  %862 = and i1 %858, %861
  %863 = select i1 %862, double %div130.i, double 1.000000e+00
  %864 = call double @llvm.copysign.f64(double %856, double %863) #9
  ...
  %873 = call double @llvm.copysign.f64(double %871, double %872) #9
...
if.end153.i:                                      ; preds = %if.end129.i
  %882 = call noundef double @llvm.sqrt.f64(double %881) #9
...
if.then165.i:                                     ; preds = %if.then163.i
  %call166.i = call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #10
...
entry:
  ...
  %2 = load double, ptr %E_, align 8, !tbaa !123
  ...
  %87 = load ptr, ptr %device_energy_, align 8, !tbaa !139
...
while.body.i.i.i:                                 ; preds = %while.body.i.i.i, %if.else8
  ...
  %91 = tail call i1 @llvm.is.constant.i64(i64 range(i64 0, 4611686018427387904) %shr.i.i.i) #9
  ...
  br i1 %cmp.i.i.i, label %while.body.i.i.i, label %_ZSt11upper_boundIPddET_S1_S1_RKT0_.internalized.exit.loopexit.i, !llvm.loop !140
...
if.end15:                                         ; preds = %_ZN6openmc17upper_bound_indexIPddEENSt15iterator_traitsIT_E15difference_typeES3_S3_RKT0_.internalized.exit, %if.then6, %entry
  ...
  %102 = tail call double @llvm.fmuladd.f64(double %div, double %sub47, double %100) #9
  ...
  store double %124, ptr %coherent, align 8, !tbaa !146
  %device_incoherent_ = getelementptr inbounds nuw i8, ptr %this, i64 640
  %125 = load ptr, ptr %device_incoherent_, align 8, !tbaa !147
  ...
  %128 = tail call double @llvm.fmuladd.f64(double %div, double %sub58, double %126) #9
  ...
  store double %150, ptr %incoherent, align 8, !tbaa !148
  %photoelectric = getelementptr inbounds nuw i8, ptr %arrayidx37, i64 48
  store double 0.000000e+00, ptr %photoelectric, align 8, !tbaa !149
...
for.cond.cleanup:                                 ; preds = %cleanup, %if.end15
  ...
  %153 = load ptr, ptr %device_pair_production_total_, align 8, !tbaa !150
  ...
  %156 = tail call double @llvm.fmuladd.f64(double %div, double %sub97, double %154) #9
  ...
  store double %178, ptr %pair_production, align 8, !tbaa !151
  ...
  store double %add105, ptr %total, align 8, !tbaa !152
  %last_E = getelementptr inbounds nuw i8, ptr %arrayidx37, i64 8
  store double %2, ptr %last_E, align 8, !tbaa !153
  ret void
...
for.body:                                         ; preds = %cleanup, %for.body.lr.ph
  ...
  %180 = load i32, ptr %threshold, align 4, !tbaa !154
...
if.end68:                                         ; preds = %for.body
  ...
  %183 = tail call double @llvm.fmuladd.f64(double %div, double %sub81, double %181) #9
  ...
  store double %add84, ptr %photoelectric, align 8, !tbaa !149
  br label %cleanup
...
cleanup:                                          ; preds = %if.end68, %for.body
  ...
  br i1 %cmp62, label %for.body, label %for.cond.cleanup, !llvm.loop !156
}
...
entry:
  ...
  %2 = call double @llvm.fabs.f64(double %mul) #9
  ...
  %122 = fneg double %121
  %123 = call double @llvm.fma.f64(double %1, double %118, double %122) #9
  %124 = call double @llvm.fma.f64(double %1, double %120, double %123) #9
  %125 = fadd double %121, %124
  %126 = fsub double %125, %121
  %127 = fsub double %124, %126
  %128 = call double @llvm.fabs.f64(double %121) #9
  %129 = fcmp oeq double %128, 0x7FF0000000000000
  %130 = select i1 %129, double %121, double %125
  %131 = call double @llvm.fabs.f64(double %130) #9
  ...
  %156 = call double @llvm.fma.f64(double %155, double %133, double %155) #9
  %157 = call double @llvm.fabs.f64(double %155) #9
  %158 = fcmp oeq double %157, 0x7FF0000000000000
  %159 = select i1 %158, double %155, double %156
  %160 = call double @llvm.trunc.f64(double %1) #9
  %161 = fcmp oeq double %160, %1
  %162 = fmul double %1, 5.000000e-01
  %163 = call double @llvm.trunc.f64(double %162) #9
  %164 = fcmp une double %163, %162
  %165 = and i1 %161, %164
  %166 = select i1 %165, double %mul, double 1.000000e+00
  %167 = call double @llvm.copysign.f64(double %159, double %166) #9
  ...
  %176 = call double @llvm.copysign.f64(double %174, double %175) #9
...
while.cond:                                       ; preds = %_ZN6openmc17lower_bound_indexIPKddEENSt15iterator_traitsIT_E15difference_typeES4_S4_RKT0_.internalized.exit, %entry
  call void @llvm.lifetime.start.p5(i64 24, ptr addrspace(5) %form_factor) #8
  ...
  %call3 = call noundef double @_ZNK6openmc15Tabulated1DFlatclEd(ptr noundef nonnull align 8 dereferenceable(24) %form_factor.ascast, double noundef %179) #10
  %call4 = call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #10
  %mul5 = fmul double %call3, %call4
  %call6 = call %"class.gsl::span" @_ZNK6openmc15Tabulated1DFlat1xEv(ptr noundef nonnull align 8 dereferenceable(24) %form_factor.ascast) #10
  %184 = extractvalue %"class.gsl::span" %call6, 0
  %call8 = call %"class.gsl::span" @_ZNK6openmc15Tabulated1DFlat1yEv(ptr noundef nonnull align 8 dereferenceable(24) %form_factor.ascast) #10
...
while.body.i.i.i:                                 ; preds = %while.body.i.i.i, %if.end.i
  ...
  %shr.i.i.i = lshr i64 %__len.04.i.i.i, 1
  %188 = call i1 @llvm.is.constant.i64(i64 range(i64 0, 576460752303423488) %shr.i.i.i) #9
  %cmp.i.i.i.i.i = icmp eq i64 %shr.i.i.i, 1
  ...
  %cmp.i.i.i = icmp sgt i64 %__len.1.i.i.i, 0
  br i1 %cmp.i.i.i, label %while.body.i.i.i, label %_ZSt11lower_boundIPKddET_S2_S2_RKT0_.internalized.exit.loopexit.i, !llvm.loop !157
...
_ZN6openmc17lower_bound_indexIPKddEENSt15iterator_traitsIT_E15difference_typeES4_S4_RKT0_.internalized.exit: ; preds = %_ZSt11lower_boundIPKddET_S2_S2_RKT0_.internalized.exit.i, %while.cond
  ...
  %call31 = call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #10
  ...
  call void @llvm.lifetime.end.p5(i64 24, ptr addrspace(5) %form_factor) #8
...
entry:
  ...
  %0 = load i32, ptr %Z_, align 8, !tbaa !158
  %conv = sitofp i32 %0 to double
  %div = fdiv double %conv, 0x40612126E7AA960E
  %mul = fmul double %div, %div
  %1 = tail call double @llvm.fmuladd.f64(double %div, double %div, double 1.000000e+00) #9
  %div3 = fdiv double 1.000000e+00, %1
  %add = fadd double %div3, 2.020590e-01
  %2 = tail call double @llvm.fmuladd.f64(double %mul, double 3.000000e-05, double -1.200000e-04) #9
  %3 = tail call double @llvm.fmuladd.f64(double %mul, double %2, double 4.900000e-04) #9
  %4 = tail call double @llvm.fmuladd.f64(double %mul, double %3, double -2.010000e-03) #9
  %5 = tail call double @llvm.fmuladd.f64(double %mul, double %4, double 8.350000e-03) #9
  %6 = tail call double @llvm.fmuladd.f64(double %mul, double %5, double -3.693000e-02) #9
  %7 = tail call double @llvm.fmuladd.f64(double %mul, double %6, double %add) #9
  %mul16 = fmul double %mul, %7
  %div17 = fdiv double 2.000000e+00, %alpha
  %8 = tail call noundef double @llvm.sqrt.f64(double %div17) #9
  %9 = tail call double @llvm.fmuladd.f64(double %div, double -1.210000e+01, double -1.774000e-01) #9
  %mul19 = fmul double %div, 1.118000e+01
  %10 = tail call double @llvm.fmuladd.f64(double %mul19, double %div, double %9) #9
  %mul22 = fmul double %8, %8
  %11 = tail call double @llvm.fmuladd.f64(double %div, double 7.326000e+01, double 0x40210BC6A7EF9DB2) #9
  ...
  %13 = tail call double @llvm.fmuladd.f64(double %8, double %10, double %mul26) #9
  %mul28 = fmul double %8, %mul22
  %14 = tail call double @llvm.fmuladd.f64(double %div, double -1.211000e+02, double -1.352000e+01) #9
  %mul30 = fmul double %div, 0x40581A3D70A3D70A
  %15 = tail call double @llvm.fmuladd.f64(double %mul30, double %div, double %14) #9
  %16 = tail call double @llvm.fmuladd.f64(double %mul28, double %15, double %13) #9
  %mul35 = fmul double %8, %mul28
  %17 = tail call double @llvm.fmuladd.f64(double %div, double 6.205000e+01, double 8.946000e+00) #9
  %neg39 = fmul double %div, -6.341000e+01
  %18 = tail call double @llvm.fmuladd.f64(double %neg39, double %div, double %17) #9
  ...
  %104 = tail call double @llvm.fabs.f64(double %div47) #9
  ...
  %130 = fneg double %129
  %131 = tail call double @llvm.fma.f64(double 0x3FEDD9AD336A0500, double 0x3FFAF154EEB562D6, double %130) #9
  %132 = select i1 %105, double %131, double %129
  %133 = tail call noundef double @llvm.copysign.f64(double %132, double %div47) #9
  %mul49 = fmul double %div43, %133
  %mul50 = fmul double %div43, %div43
  %134 = tail call double @llvm.fmuladd.f64(double %mul49, double -4.000000e+00, double 4.000000e+00) #9
  ...
  %300 = tail call double @llvm.fmuladd.f64(double %mul49, double -3.000000e+00, double %sub69) #9
  ...
  %304 = tail call double @llvm.fabs.f64(double %sub74) #9
  ...
  %424 = fneg double %423
  %425 = tail call double @llvm.fma.f64(double %303, double %420, double %424) #9
  %426 = tail call double @llvm.fma.f64(double %303, double %422, double %425) #9
  %427 = fadd double %423, %426
  %428 = fsub double %427, %423
  %429 = fsub double %426, %428
  %430 = tail call double @llvm.fabs.f64(double %423) #9
  %431 = fcmp oeq double %430, 0x7FF0000000000000
  %432 = select i1 %431, double %423, double %427
  %433 = tail call double @llvm.fabs.f64(double %432) #9
  ...
  %458 = tail call double @llvm.fma.f64(double %457, double %435, double %457) #9
  %459 = tail call double @llvm.fabs.f64(double %457) #9
  %460 = fcmp oeq double %459, 0x7FF0000000000000
  %461 = select i1 %460, double %457, double %458
  %462 = tail call double @llvm.trunc.f64(double %303) #9
  %463 = fcmp oeq double %462, %303
  %464 = fmul double %303, 5.000000e-01
  %465 = tail call double @llvm.trunc.f64(double %464) #9
  %466 = fcmp une double %465, %464
  %467 = and i1 %463, %466
  %468 = select i1 %467, double %sub74, double 1.000000e+00
  %469 = tail call double @llvm.copysign.f64(double %461, double %468) #9
  ...
  %478 = tail call double @llvm.copysign.f64(double %476, double %477) #9
...
while.cond:                                       ; preds = %if.end145, %entry
  %call78 = tail call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #10
  %call79 = tail call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #10
...
cond.true:                                        ; preds = %if.then
  ...
  %485 = tail call double @llvm.fabs.f64(double %482) #9
  ...
  %605 = fneg double %604
  %606 = tail call double @llvm.fma.f64(double %484, double %601, double %605) #9
  %607 = tail call double @llvm.fma.f64(double %484, double %603, double %606) #9
  %608 = fadd double %604, %607
  %609 = fsub double %608, %604
  %610 = fsub double %607, %609
  %611 = tail call double @llvm.fabs.f64(double %604) #9
  %612 = fcmp oeq double %611, 0x7FF0000000000000
  %613 = select i1 %612, double %604, double %608
  %614 = tail call double @llvm.fabs.f64(double %613) #9
  ...
  %639 = tail call double @llvm.fma.f64(double %638, double %616, double %638) #9
  %640 = tail call double @llvm.fabs.f64(double %638) #9
  %641 = fcmp oeq double %640, 0x7FF0000000000000
  %642 = select i1 %641, double %638, double %639
  %643 = tail call double @llvm.trunc.f64(double %484) #9
  %644 = fcmp oeq double %643, %484
  %645 = fmul double %484, 5.000000e-01
  %646 = tail call double @llvm.trunc.f64(double %645) #9
  %647 = fcmp une double %646, %645
  %648 = and i1 %644, %647
  %649 = select i1 %648, double %482, double 1.000000e+00
  %650 = tail call double @llvm.copysign.f64(double %642, double %649) #9
  ...
  %659 = tail call double @llvm.copysign.f64(double %657, double %658) #9
...
cond.false:                                       ; preds = %if.then
  ...
  %667 = tail call double @llvm.fabs.f64(double %664) #9
  ...
  %787 = fneg double %786
  %788 = tail call double @llvm.fma.f64(double %666, double %783, double %787) #9
  %789 = tail call double @llvm.fma.f64(double %666, double %785, double %788) #9
  %790 = fadd double %786, %789
  %791 = fsub double %790, %786
  %792 = fsub double %789, %791
  %793 = tail call double @llvm.fabs.f64(double %786) #9
  %794 = fcmp oeq double %793, 0x7FF0000000000000
  %795 = select i1 %794, double %786, double %790
  %796 = tail call double @llvm.fabs.f64(double %795) #9
  ...
  %821 = tail call double @llvm.fma.f64(double %820, double %798, double %820) #9
  %822 = tail call double @llvm.fabs.f64(double %820) #9
  %823 = fcmp oeq double %822, 0x7FF0000000000000
  %824 = select i1 %823, double %820, double %821
  %825 = tail call double @llvm.trunc.f64(double %666) #9
  %826 = fcmp oeq double %825, %666
  %827 = fmul double %666, 5.000000e-01
  %828 = tail call double @llvm.trunc.f64(double %827) #9
  %829 = fcmp une double %828, %827
  %830 = and i1 %826, %829
  %831 = select i1 %830, double %664, double 1.000000e+00
  %832 = tail call double @llvm.copysign.f64(double %824, double %831) #9
  ...
  %841 = tail call double @llvm.copysign.f64(double %839, double %840) #9
...
if.end:                                           ; preds = %if.else, %cond.false, %cond.true
  ...
  %847 = load i32, ptr %Z_, align 8, !tbaa !158
  ...
  %932 = tail call double @llvm.fabs.f64(double %div110) #9
  ...
  %958 = fneg double %957
  %959 = tail call double @llvm.fma.f64(double 0x3FEDD9AD336A0500, double 0x3FFAF154EEB562D6, double %958) #9
  %960 = select i1 %933, double %959, double %957
  %961 = tail call noundef double @llvm.copysign.f64(double %960, double %div110) #9
...
if.then122:                                       ; preds = %if.end
  ...
  %call127 = tail call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #10
...
if.else132:                                       ; preds = %if.end
  ...
  %call137 = tail call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #10
...
while.end:                                        ; preds = %if.else132, %if.then122
  ...
  %1052 = tail call noundef double @llvm.sqrt.f64(double %mul156) #9
  %add158 = fadd double %1051, 0x411F305BC8CE703B
  %div159 = fdiv double %1052, %add158
  %call161 = tail call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #10
  ...
  %1056 = tail call noundef double @llvm.sqrt.f64(double %mul167) #9
  %add169 = fadd double %1055, 0x411F305BC8CE703B
  %div170 = fdiv double %1056, %add169
  %call171 = tail call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #10
...
__ocml_sin_f64.exit:                              ; preds = %167, %148
  ...
  %287 = load double, ptr %binding_energy, align 8, !tbaa !160
  %288 = load double, ptr %wgt_66, align 8, !tbaa !161
  tail call void @_ZN6openmc8Particle16create_secondaryEdNS_8PositionEdNS0_4TypeE(ptr noundef nonnull align 8 dereferenceable(2728) %p, double noundef %288, double %4, double %mul13, double %mul18, double noundef %287, i32 noundef 1) #10
  br label %cleanup

if.end:                                           ; preds = %while.body
  %call20 = tail call noundef double @_ZN6openmc3prnEPm(ptr noundef nonnull %add.ptr.i) #10
...
for.cond:                                         ; preds = %for.body
  ...
  br i1 %cmp24, label %for.body, label %for.end, !llvm.loop !162
...
for.body:                                         ; preds = %for.cond, %for.body.preheader
  ...
  %289 = load double, ptr %probability, align 8, !tbaa !163
...
for.end:                                          ; preds = %for.body, %for.cond, %if.end
  ...
  %294 = tail call noundef double @llvm.sqrt.f64(double %293) #9
  %295 = tail call double @llvm.fabs.f64(double %mul42) #9
...
__ocml_sin_f64.exit82:                            ; preds = %454, %435
  ...
  %574 = load i32, ptr %arrayidx.i62, align 8, !tbaa !165
  ...
  %576 = load i32, ptr %secondary_subshell, align 4, !tbaa !166
...
if.then61:                                        ; preds = %__ocml_sin_f64.exit82
  ...
  %578 = load double, ptr %wgt_66, align 8, !tbaa !161
  %energy = getelementptr inbounds nuw i8, ptr %arrayidx.i62, i64 8
  %579 = load double, ptr %energy, align 8, !tbaa !167
  tail call void @_ZN6openmc8Particle16create_secondaryEdNS_8PositionEdNS0_4TypeE(ptr noundef nonnull align 8 dereferenceable(2728) %p, double noundef %578, double %291, double %mul49, double %mul55, double noundef %579, i32 noundef 2) #10
  br label %cleanup

if.else:                                          ; preds = %__ocml_sin_f64.exit82
  %580 = load double, ptr %wgt_66, align 8, !tbaa !161
  %energy70 = getelementptr inbounds nuw i8, ptr %arrayidx.i62, i64 8
  %581 = load double, ptr %energy70, align 8, !tbaa !167
  tail call void @_ZN6openmc8Particle16create_secondaryEdNS_8PositionEdNS0_4TypeE(ptr noundef nonnull align 8 dereferenceable(2728) %p, double noundef %580, double %291, double %mul49, double %mul55, double noundef %581, i32 noundef 1) #10
  br label %cleanup
...
!122 = !{!58, !58, i64 0}
!123 = !{!124, !52, i64 1400}
!124 = !{!"_ZTSN6openmc8ParticleE", !125, i64 0, !30, i64 168, !126, i64 744, !32, i64 864, !127, i64 872, !58, i64 876, !58, i64 880, !30, i64 888, !58, i64 1368, !30, i64 1372, !52, i64 1400, !52, i64 1408, !58, i64 1416, !58, i64 1420, !52, i64 1424, !52, i64 1432, !128, i64 1440, !128, i64 1464, !128, i64 1488, !52, i64 1512, !129, i64 1520, !130, i64 1524, !58, i64 1528, !58, i64 1532, !58, i64 1536, !58, i64 1540, !58, i64 1544, !52, i64 1552, !30, i64 1560, !58, i64 1592, !58, i64 1596, !58, i64 1600, !58, i64 1604, !131, i64 1608, !52, i64 1640, !52, i64 1648, !58, i64 1656, !129, i64 1660, !30, i64 1664, !58, i64 1728, !30, i64 1736, !32, i64 2216, !32, i64 2224, !30, i64 2232, !133, i64 2240, !134, i64 2248, !30, i64 2272, !52, i64 2656, !52, i64 2664, !52, i64 2672, !52, i64 2680, !129, i64 2688, !52, i64 2696, !52, i64 2704, !58, i64 2712, !32, i64 2720}
!125 = !{!"_ZTSN6openmc19NuclideMicroXSCacheE", !30, i64 0}
!126 = !{!"_ZTSN6openmc7MacroXSE", !52, i64 0, !52, i64 8, !52, i64 16, !52, i64 24, !52, i64 32, !30, i64 40, !52, i64 88, !52, i64 96, !52, i64 104, !52, i64 112}
!127 = !{!"_ZTSN6openmc8Particle4TypeE", !30, i64 0}
!128 = !{!"_ZTSN6openmc8PositionE", !52, i64 0, !52, i64 8, !52, i64 16}
!129 = !{!"bool", !30, i64 0}
!130 = !{!"_ZTSN6openmc10TallyEventE", !30, i64 0}
!131 = !{!"_ZTSN6openmc12BoundaryInfoE", !52, i64 0, !58, i64 8, !58, i64 12, !132, i64 16}
!132 = !{!"_ZTSSt5arrayIiLm3EE", !30, i64 0}
!133 = !{!"p1 _ZTSN6openmc11FilterMatchE", !29, i64 0}
...
!138 = !{!"p1 _ZTSSt6vectorIN6openmc8PositionESaIS1_EE", !29, i64 0}
!139 = !{!54, !36, i64 624}
!140 = distinct !{!140, !49}
!141 = !{!54, !32, i64 40}
!142 = !{!143, !58, i64 0}
!143 = !{!"_ZTSN6openmc14ElementMicroXSE", !58, i64 0, !52, i64 8, !52, i64 16, !52, i64 24, !52, i64 32, !52, i64 40, !52, i64 48, !52, i64 56}
!144 = !{!143, !52, i64 16}
!145 = !{!54, !36, i64 632}
!146 = !{!143, !52, i64 32}
!147 = !{!54, !36, i64 640}
...
!153 = !{!143, !52, i64 8}
!154 = !{!155, !58, i64 4}
!155 = !{!"_ZTSN6openmc16ElectronSubshellE", !58, i64 0, !58, i64 4, !52, i64 8, !52, i64 16, !35, i64 24, !42, i64 40}
!156 = distinct !{!156, !49}
!157 = distinct !{!157, !49}
!158 = !{!54, !58, i64 32}
!159 = !{!124, !58, i64 1728}
...
!162 = distinct !{!162, !49}
!163 = !{!164, !52, i64 16}
!164 = !{!"_ZTSN6openmc16ElectronSubshell10TransitionE", !58, i64 0, !58, i64 4, !52, i64 8, !52, i64 16}
!165 = !{!164, !58, i64 0}
!166 = !{!164, !58, i64 4}
!167 = !{!164, !52, i64 8}
