; ModuleID = 'secondary_uncorrelated.cpp-amdgcn-amd-amdhsa-gfx942.o.0.preopt.bc'
...
if.else:                                          ; preds = %entry
  ...
  call void @llvm.lifetime.start.p5(i64 16, ptr addrspace(5) %ref.tmp) #6
  ...
  call void @_ZN6openmc21AngleDistributionFlatC1EPKh(ptr noundef nonnull align 8 dereferenceable(16) %retval.ascast.i, ptr noundef nonnull %add.ptr.i) #7
  ...
  %call3 = call noundef double @_ZNK6openmc21AngleDistributionFlat6sampleEdPm(ptr noundef nonnull align 8 dereferenceable(16) %ref.tmp.ascast, double noundef %E_in, ptr noundef %seed) #7
  call void @llvm.lifetime.end.p5(i64 16, ptr addrspace(5) %ref.tmp) #6
...
if.end:                                           ; preds = %if.else, %entry
  ...
  call void @llvm.lifetime.start.p5(i64 16, ptr addrspace(5) %ref.tmp4) #6
  ...
  call void @_ZN6openmc22EnergyDistributionFlatC1EPKh(ptr noundef nonnull align 8 dereferenceable(16) %retval.ascast.i7, ptr noundef %add.ptr3.i) #7
  ...
  %call6 = call noundef double @_ZNK6openmc22EnergyDistributionFlat6sampleEdPm(ptr noundef nonnull align 8 dereferenceable(16) %ref.tmp4.ascast, double noundef %E_in, ptr noundef %seed) #7
  store double %call6, ptr %E_out, align 8, !tbaa !23
  call void @llvm.lifetime.end.p5(i64 16, ptr addrspace(5) %ref.tmp4) #6
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(read, inaccessiblemem: none)
define hidden noundef zeroext i1 @_ZNK6openmc27UncorrelatedAngleEnergyFlat7fissionEv(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(8) %this) local_unnamed_addr #4 align 2 {
entry:
...
entry:
  ...
  call void @_ZN6openmc21AngleDistributionFlatC1EPKh(ptr noundef nonnull align 8 dereferenceable(16) %retval.ascast, ptr noundef nonnull %add.ptr) #7
...
; Function Attrs: convergent mustprogress nounwind
define hidden %"class.openmc::EnergyDistributionFlat" @_ZNK6openmc27UncorrelatedAngleEnergyFlat6energyEv(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(8) %this) local_unnamed_addr #3 align 2 {
entry:
  ...
  %add.ptr3 = getelementptr inbounds nuw i8, ptr %0, i64 %conv
  call void @_ZN6openmc22EnergyDistributionFlatC1EPKh(ptr noundef nonnull align 8 dereferenceable(16) %retval.ascast, ptr noundef %add.ptr3) #7
  %.fca.0.load = load i32, ptr addrspace(5) %retval, align 8
  %.fca.0.insert = insertvalue %"class.openmc::EnergyDistributionFlat" poison, i32 %.fca.0.load, 0
  %.fca.1.gep = getelementptr inbounds nuw i8, ptr addrspace(5) %retval, i32 8
  %.fca.1.load = load ptr, ptr addrspace(5) %.fca.1.gep, align 8
  %.fca.1.insert = insertvalue %"class.openmc::EnergyDistributionFlat" %.fca.0.insert, ptr %.fca.1.load, 1
  ret %"class.openmc::EnergyDistributionFlat" %.fca.1.insert
}
...
; Function Attrs: convergent
declare void @_ZN6openmc21AngleDistributionFlatC1EPKh(ptr noundef nonnull align 8 dereferenceable(16), ptr noundef) unnamed_addr #5

; Function Attrs: convergent
declare void @_ZN6openmc22EnergyDistributionFlatC1EPKh(ptr noundef nonnull align 8 dereferenceable(16), ptr noundef) unnamed_addr #5
