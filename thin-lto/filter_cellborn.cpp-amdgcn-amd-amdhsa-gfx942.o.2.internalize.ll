; ModuleID = 'filter_cellborn.cpp-amdgcn-amd-amdhsa-gfx942.o.2.internalize.bc'
...
entry:
  ...
  %0 = load i32, ptr %cell_born_, align 4, !tbaa !15
...
for.body.i:                                       ; preds = %for.inc.i, %for.body.preheader.i
  ...
  %2 = load i32, ptr %iter.07.i, align 4, !tbaa !44
...
for.end.i:                                        ; preds = %for.inc.i, %entry
  ...
  %this.val4.i = load i64, ptr %3, align 8, !tbaa !48
...
if.then:                                          ; preds = %_ZNK6openmc10static_mapIiiNS_12integer_hashIiEEE4findEi.internalized.exit
  ...
  %this.val.i4 = load i32, ptr %4, align 8, !tbaa !49
...
if.then.i:                                        ; preds = %if.then
  ...
  store i32 %inc.i, ptr %4, align 8, !tbaa !49
  br label %if.end
