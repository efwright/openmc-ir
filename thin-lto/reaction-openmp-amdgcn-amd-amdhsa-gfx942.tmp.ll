; ModuleID = 'reaction-openmp-amdgcn-amd-amdhsa-gfx942.tmp.bc'
...
@_ZN6openmc12ReactionFlatC1EPKh = hidden unnamed_addr alias void (ptr, ptr), ptr @_ZN6openmc12ReactionFlatC2EPKh
...
define hidden void @_ZN6openmc12ReactionFlatC2EPKh(ptr noundef nonnull align 8 dereferenceable(24) %this, ptr noundef %data) unnamed_addr #3 align 2 {
entry:
  ...
  %data_ = getelementptr inbounds nuw %"class.openmc::ReactionFlat", ptr %this1, i32 0, i32 0
  %0 = load ptr, ptr %data.addr.ascast, align 8, !tbaa !25
  store ptr %0, ptr %data_, align 8, !tbaa !27
  %data_2 = getelementptr inbounds nuw %"class.openmc::ReactionFlat", ptr %this1, i32 0, i32 0
  ...
  %n_xs_ = getelementptr inbounds nuw %"class.openmc::ReactionFlat", ptr %this1, i32 0, i32 1
  store i64 %2, ptr %n_xs_, align 8, !tbaa !31
  %data_3 = getelementptr inbounds nuw %"class.openmc::ReactionFlat", ptr %this1, i32 0, i32 0
  %3 = load ptr, ptr %data_3, align 8, !tbaa !27
  %add.ptr4 = getelementptr inbounds i8, ptr %3, i64 32
  %4 = load i64, ptr %add.ptr4, align 8, !tbaa !30
  %n_products_ = getelementptr inbounds nuw %"class.openmc::ReactionFlat", ptr %this1, i32 0, i32 2
  store i64 %4, ptr %n_products_, align 8, !tbaa !32
  ret void
}

; Function Attrs: convergent mustprogress nounwind
define hidden noundef double @_ZNK6openmc12ReactionFlat2xsElld(ptr noundef nonnull align 8 dereferenceable(24) %this, i64 noundef %i_temp, i64 noundef %i_grid, double noundef %interp_factor) #3 align 2 {
entry:
  %retval = alloca double, align 8, addrspace(5)
  %this.addr = alloca ptr, align 8, addrspace(5)
  %i_temp.addr = alloca i64, align 8, addrspace(5)
  %i_grid.addr = alloca i64, align 8, addrspace(5)
  %interp_factor.addr = alloca double, align 8, addrspace(5)
  %indices = alloca ptr, align 8, addrspace(5)
  %xs_data = alloca ptr, align 8, addrspace(5)
  %threshold = alloca i32, align 4, addrspace(5)
  %xs_value = alloca ptr, align 8, addrspace(5)
  %cleanup.dest.slot = alloca i32, align 4, addrspace(5)
  %retval.ascast = addrspacecast ptr addrspace(5) %retval to ptr
  %this.addr.ascast = addrspacecast ptr addrspace(5) %this.addr to ptr
  ...
  %xs_data.ascast = addrspacecast ptr addrspace(5) %xs_data to ptr
  %threshold.ascast = addrspacecast ptr addrspace(5) %threshold to ptr
  %xs_value.ascast = addrspacecast ptr addrspace(5) %xs_value to ptr
  store ptr %this, ptr %this.addr.ascast, align 8, !tbaa !22
  store i64 %i_temp, ptr %i_temp.addr.ascast, align 8, !tbaa !30
  store i64 %i_grid, ptr %i_grid.addr.ascast, align 8, !tbaa !30
  store double %interp_factor, ptr %interp_factor.addr.ascast, align 8, !tbaa !14
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  ...
  store ptr %add.ptr, ptr %indices.ascast, align 8, !tbaa !33
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %xs_data) #7
  %data_2 = getelementptr inbounds nuw %"class.openmc::ReactionFlat", ptr %this1, i32 0, i32 0
  %1 = load ptr, ptr %data_2, align 8, !tbaa !27
  %2 = load ptr, ptr %indices.ascast, align 8, !tbaa !33
  %3 = load i64, ptr %i_temp.addr.ascast, align 8, !tbaa !30
  ...
  store ptr %add.ptr3, ptr %xs_data.ascast, align 8, !tbaa !25
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %threshold) #7
  %5 = load ptr, ptr %xs_data.ascast, align 8, !tbaa !25
  %6 = load i32, ptr %5, align 4, !tbaa !18
  store i32 %6, ptr %threshold.ascast, align 4, !tbaa !18
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %xs_value) #7
  %7 = load ptr, ptr %xs_data.ascast, align 8, !tbaa !25
  %add.ptr4 = getelementptr inbounds i8, ptr %7, i64 8
  store ptr %add.ptr4, ptr %xs_value.ascast, align 8, !tbaa !35
  %8 = load i64, ptr %i_grid.addr.ascast, align 8, !tbaa !30
  %9 = load i32, ptr %threshold.ascast, align 4, !tbaa !18
  %conv = sext i32 %9 to i64
  %cmp = icmp slt i64 %8, %conv
...
cond.false:                                       ; preds = %entry
  %10 = load double, ptr %interp_factor.addr.ascast, align 8, !tbaa !14
  %sub = fsub double 1.000000e+00, %10
  %11 = load ptr, ptr %xs_value.ascast, align 8, !tbaa !35
  %12 = load i64, ptr %i_grid.addr.ascast, align 8, !tbaa !30
  %13 = load i32, ptr %threshold.ascast, align 4, !tbaa !18
  %conv5 = sext i32 %13 to i64
  %sub6 = sub nsw i64 %12, %conv5
  %arrayidx7 = getelementptr inbounds double, ptr %11, i64 %sub6
  %14 = load double, ptr %arrayidx7, align 8, !tbaa !14
  %15 = load double, ptr %interp_factor.addr.ascast, align 8, !tbaa !14
  %16 = load ptr, ptr %xs_value.ascast, align 8, !tbaa !35
  %17 = load i64, ptr %i_grid.addr.ascast, align 8, !tbaa !30
  %18 = load i32, ptr %threshold.ascast, align 4, !tbaa !18
  %conv8 = sext i32 %18 to i64
  %sub9 = sub nsw i64 %17, %conv8
  %add = add nsw i64 %sub9, 1
  %arrayidx10 = getelementptr inbounds double, ptr %16, i64 %add
  %19 = load double, ptr %arrayidx10, align 8, !tbaa !14
  %mul11 = fmul double %15, %19
  %20 = call double @llvm.fmuladd.f64(double %sub, double %14, double %mul11)
  br label %cond.end

cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi double [ 0.000000e+00, %cond.true ], [ %20, %cond.false ]
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %xs_value) #7
  call void @llvm.lifetime.end.p5(i64 4, ptr addrspace(5) %threshold) #7
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %xs_data) #7
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %indices) #7
  ret double %cond
}

; Function Attrs: convergent mustprogress nounwind
define hidden noundef double @_ZNK6openmc12ReactionFlat2xsERKNS_14NuclideMicroXSE(ptr noundef nonnull align 8 dereferenceable(24) %this, ptr noundef nonnull align 8 dereferenceable(168) %micro) #3 align 2 {
entry:
  %retval = alloca double, align 8, addrspace(5)
  %this.addr = alloca ptr, align 8, addrspace(5)
  ...
  store ptr %this, ptr %this.addr.ascast, align 8, !tbaa !22
  store ptr %micro, ptr %micro.addr.ascast, align 8, !tbaa !37
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  %0 = load ptr, ptr %micro.addr.ascast, align 8, !tbaa !37
  %index_temp = getelementptr inbounds nuw %"struct.openmc::NuclideMicroXS", ptr %0, i32 0, i32 10
  %1 = load i32, ptr %index_temp, align 4, !tbaa !39
  %conv = sext i32 %1 to i64
  %2 = load ptr, ptr %micro.addr.ascast, align 8, !tbaa !37
  %index_grid = getelementptr inbounds nuw %"struct.openmc::NuclideMicroXS", ptr %2, i32 0, i32 9
  %3 = load i32, ptr %index_grid, align 8, !tbaa !42
  %conv2 = sext i32 %3 to i64
  %4 = load ptr, ptr %micro.addr.ascast, align 8, !tbaa !37
  %interp_factor = getelementptr inbounds nuw %"struct.openmc::NuclideMicroXS", ptr %4, i32 0, i32 11
  %5 = load double, ptr %interp_factor, align 8, !tbaa !43
  %call = call noundef double @_ZNK6openmc12ReactionFlat2xsElld(ptr noundef nonnull align 8 dereferenceable(24) %this1, i64 noundef %conv, i64 noundef %conv2, double noundef %5) #9
  ret double %call
}

; Function Attrs: convergent mustprogress nounwind
define hidden noundef i32 @_ZNK6openmc12ReactionFlat2mtEv(ptr noundef nonnull align 8 dereferenceable(24) %this) #3 align 2 {
entry:
...
; Function Attrs: convergent mustprogress nounwind
define hidden noundef double @_ZNK6openmc12ReactionFlat7q_valueEv(ptr noundef nonnull align 8 dereferenceable(24) %this) #3 align 2 {
entry:
  %retval = alloca double, align 8, addrspace(5)
  %this.addr = alloca ptr, align 8, addrspace(5)
  %retval.ascast = addrspacecast ptr addrspace(5) %retval to ptr
...
; Function Attrs: convergent mustprogress nounwind
define hidden noundef zeroext i1 @_ZNK6openmc12ReactionFlat13scatter_in_cmEv(ptr noundef nonnull align 8 dereferenceable(24) %this) #3 align 2 {
entry:
...
; Function Attrs: convergent mustprogress nounwind
define hidden noundef zeroext i1 @_ZNK6openmc12ReactionFlat9redundantEv(ptr noundef nonnull align 8 dereferenceable(24) %this) #3 align 2 {
entry:
  %retval = alloca i1, align 1, addrspace(5)
  %this.addr = alloca ptr, align 8, addrspace(5)
  %retval.ascast = addrspacecast ptr addrspace(5) %retval to ptr
...
; Function Attrs: convergent mustprogress nounwind
define hidden noundef i32 @_ZNK6openmc12ReactionFlat12xs_thresholdEl(ptr noundef nonnull align 8 dereferenceable(24) %this, i64 noundef %i_temp) #3 align 2 {
entry:
  %retval = alloca i32, align 4, addrspace(5)
  %this.addr = alloca ptr, align 8, addrspace(5)
  %i_temp.addr = alloca i64, align 8, addrspace(5)
  ...
  %1 = load ptr, ptr %indices.ascast, align 8, !tbaa !33
  %2 = load i64, ptr %i_temp.addr.ascast, align 8, !tbaa !30
  %arrayidx = getelementptr inbounds i32, ptr %1, i64 %2
  %3 = load i32, ptr %arrayidx, align 4, !tbaa !18
  store i32 %3, ptr %offset.ascast, align 4, !tbaa !18
  %data_2 = getelementptr inbounds nuw %"class.openmc::ReactionFlat", ptr %this1, i32 0, i32 0
  %4 = load ptr, ptr %data_2, align 8, !tbaa !27
  %5 = load i32, ptr %offset.ascast, align 4, !tbaa !18
  %idx.ext = sext i32 %5 to i64
  %add.ptr3 = getelementptr inbounds i8, ptr %4, i64 %idx.ext
  %6 = load i32, ptr %add.ptr3, align 4, !tbaa !18
...
; Function Attrs: convergent mustprogress nounwind
define hidden %"class.openmc::ReactionProductFlat" @_ZNK6openmc12ReactionFlat8productsEl(ptr noundef nonnull align 8 dereferenceable(24) %this, i64 noundef %i) #3 align 2 {
entry:
  ...
  %2 = load ptr, ptr %indices.ascast, align 8, !tbaa !33
  %n_xs_ = getelementptr inbounds nuw %"class.openmc::ReactionFlat", ptr %this1, i32 0, i32 1
  %3 = load i64, ptr %n_xs_, align 8, !tbaa !31
  ...
  %idx.ext = sext i32 %5 to i64
  %add.ptr3 = getelementptr inbounds i8, ptr %1, i64 %idx.ext
  call void @_ZN6openmc19ReactionProductFlatC1EPKh(ptr noundef nonnull align 8 dereferenceable(32) %retval.ascast, ptr noundef %add.ptr3) #9
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %indices) #7
  %6 = load %"class.openmc::ReactionProductFlat", ptr %retval.ascast, align 8
  ret %"class.openmc::ReactionProductFlat" %6
}

; Function Attrs: convergent
declare void @_ZN6openmc19ReactionProductFlatC1EPKh(ptr noundef nonnull align 8 dereferenceable(32), ptr noundef) unnamed_addr #4

; Function Attrs: convergent mustprogress nounwind
define hidden %"class.openmc::ReactionFlat" @_ZNK6openmc21ReactionFlatContainer3objEv(ptr noundef nonnull align 8 dereferenceable(32) %this) #3 align 2 {
entry:
  ...
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  %buffer_ = getelementptr inbounds nuw %"class.openmc::ReactionFlatContainer", ptr %this1, i32 0, i32 0
  %data_ = getelementptr inbounds nuw %"class.openmc::DataBuffer", ptr %buffer_, i32 0, i32 0
  %0 = load ptr, ptr %data_, align 8, !tbaa !46
  call void @_ZN6openmc12ReactionFlatC1EPKh(ptr noundef nonnull align 8 dereferenceable(24) %retval.ascast, ptr noundef %0) #9
  %1 = load %"class.openmc::ReactionFlat", ptr %retval.ascast, align 8
  ret %"class.openmc::ReactionFlat" %1
}
...
define internal double @__ocml_logb_f64(double noundef %0) #5 {
  ...
  %5 = load i8, ptr addrspace(4) @__oclc_finite_only_opt, align 1, !tbaa !50, !range !54, !noundef !55
  %6 = icmp eq i8 %5, 0
...
!21 = !{!"float", !16, i64 0}
!22 = !{!23, !23, i64 0}
!23 = !{!"p1 _ZTSN6openmc12ReactionFlatE", !24, i64 0}
!24 = !{!"any pointer", !16, i64 0}
!25 = !{!26, !26, i64 0}
!26 = !{!"p1 omnipotent char", !24, i64 0}
!27 = !{!28, !26, i64 0}
!28 = !{!"_ZTSN6openmc12ReactionFlatE", !26, i64 0, !29, i64 8, !29, i64 16}
!29 = !{!"long", !16, i64 0}
!30 = !{!29, !29, i64 0}
!31 = !{!28, !29, i64 8}
!32 = !{!28, !29, i64 16}
...
!37 = !{!38, !38, i64 0}
!38 = !{!"p1 _ZTSN6openmc14NuclideMicroXSE", !24, i64 0}
!39 = !{!40, !19, i64 116}
!40 = !{!"_ZTSN6openmc14NuclideMicroXSE", !15, i64 0, !15, i64 8, !15, i64 16, !15, i64 24, !15, i64 32, !15, i64 40, !15, i64 48, !15, i64 56, !16, i64 64, !19, i64 112, !19, i64 116, !15, i64 120, !19, i64 128, !19, i64 132, !15, i64 136, !41, i64 144, !15, i64 152, !15, i64 160}
!41 = !{!"bool", !16, i64 0}
!42 = !{!40, !19, i64 112}
!43 = !{!40, !15, i64 120}
!44 = !{!45, !45, i64 0}
!45 = !{!"p1 _ZTSN6openmc21ReactionFlatContainerE", !24, i64 0}
!46 = !{!47, !26, i64 0}
!47 = !{!"_ZTSN6openmc21ReactionFlatContainerE", !48, i64 0}
!48 = !{!"_ZTSN6openmc10DataBufferE", !26, i64 0, !29, i64 8, !29, i64 16, !49, i64 24}
!49 = !{!"_ZTSN6openmc10DataBuffer4ModeE", !16, i64 0}
!50 = !{!51, !51, i64 0}
!51 = !{!"bool", !52, i64 0}
