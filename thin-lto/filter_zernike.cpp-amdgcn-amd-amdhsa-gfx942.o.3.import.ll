; ModuleID = 'filter_zernike.cpp-amdgcn-amd-amdhsa-gfx942.o.3.import.bc'
...
if.then:                                          ; preds = %entry
  ...
  %8 = load i32, ptr %n_bins_, align 4, !tbaa !51
...
for.body.lr.ph:                                   ; preds = %if.then
  ...
  %this.val.i.pre = load i32, ptr %9, align 8, !tbaa !52
  br label %for.body
...
if.then.i:                                        ; preds = %for.body
  ...
  %11 = load double, ptr addrspace(5) %arrayidx, align 8, !tbaa !54
  %idxprom.i = sext i32 %this.val.i to i64
  %arrayidx.i = getelementptr inbounds [125 x i32], ptr %match, i64 0, i64 %idxprom.i
  store i32 %i.010, ptr %arrayidx.i, align 4, !tbaa !55
  %12 = load i32, ptr %9, align 8, !tbaa !52
  %idxprom3.i = sext i32 %12 to i64
  %arrayidx4.i = getelementptr inbounds [125 x double], ptr %weights_.i, i64 0, i64 %idxprom3.i
  store double %11, ptr %arrayidx4.i, align 8, !tbaa !54
  %inc.i = add nsw i32 %12, 1
  store i32 %inc.i, ptr %9, align 8, !tbaa !52
  %.pre = load i32, ptr %n_bins_, align 4, !tbaa !51
...
_ZN6openmc11FilterMatch9push_backEid.internalized.exit: ; preds = %if.then.i, %for.body
  ...
  br i1 %cmp8, label %for.body, label %for.cond.cleanup, !llvm.loop !56
...
define available_externally hidden void @calc_zn_rad(i32 noundef %n, double noundef %rho, ptr noundef captures(none) initializes((0, 8)) %zn_rad) local_unnamed_addr #4 {
entry:
  store double 1.000000e+00, ptr %zn_rad, align 8, !tbaa !54
...
if.then.peel:                                     ; preds = %entry
  ...
  store double %0, ptr %arrayidx4.peel, align 8, !tbaa !54
...
!51 = !{!22, !24, i64 4}
!52 = !{!53, !24, i64 1504}
!53 = !{!"_ZTSN6openmc11FilterMatchE", !19, i64 0, !19, i64 504, !24, i64 1504, !24, i64 1508, !36, i64 1512}
!54 = !{!18, !18, i64 0}
!55 = !{!24, !24, i64 0}
!56 = distinct !{!56, !57}
