; ModuleID = 'filter_cell_instance.cpp-amdgcn-amd-amdhsa-gfx942.o.5.precodegen.bc'
...
entry:
  ...
  %5 = load <2 x i64>, ptr %arrayidx.i.i, align 8
  %this.val1.i = load ptr, ptr %imap_, align 8, !tbaa !44
  %6 = extractelement <2 x i64> %5, i64 1
  %add.ptr.i = getelementptr inbounds nuw %"struct.std::pair", ptr %this.val1.i, i64 %6
  %7 = extractelement <2 x i64> %5, i64 0
  %cmp.not7.i = icmp samesign eq i64 %7, %6
  br i1 %cmp.not7.i, label %for.end.i, label %for.body.preheader.i

for.body.preheader.i:                             ; preds = %entry
  %add.ptr7.i = getelementptr inbounds nuw %"struct.std::pair", ptr %this.val1.i, i64 %7
  br label %for.body.i
...
for.body.i:                                       ; preds = %for.inc.i, %for.body.preheader.i
  ...
  %8 = getelementptr i8, ptr %iter.08.i, i64 8
  %iter.0.val3.i = load i64, ptr %8, align 8
  %cmp.i.i = icmp eq i64 %iter.0.val.i, %conv
  %cmp4.i.i = icmp eq i64 %iter.0.val3.i, %conv2
  %9 = select i1 %cmp.i.i, i1 %cmp4.i.i, i1 false
  br i1 %9, label %_ZNK6openmc10static_mapINS_12CellInstanceElNS_16CellInstanceHashEE4findES1_.internalized.exit.loopexit, label %for.inc.i
...
for.end.i:                                        ; preds = %for.inc.i, %entry
  %10 = getelementptr inbounds nuw i8, ptr %this, i64 160
  %this.val5.i = load i64, ptr %10, align 8, !tbaa !51
...
if.then:                                          ; preds = %_ZNK6openmc10static_mapINS_12CellInstanceElNS_16CellInstanceHashEE4findES1_.internalized.exit
  %11 = getelementptr inbounds nuw i8, ptr %match, i64 1504
  %this.val.i6 = load i32, ptr %11, align 8, !tbaa !52
...
if.then.i:                                        ; preds = %if.then
  ...
  %12 = load i64, ptr %second, align 8, !tbaa !54
  ...
  %13 = load i32, ptr %11, align 8, !tbaa !52
  ...
  store i32 %inc.i, ptr %11, align 8, !tbaa !52
  br label %if.end
