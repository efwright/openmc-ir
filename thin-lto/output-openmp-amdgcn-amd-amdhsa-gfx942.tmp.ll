; ModuleID = 'output-openmp-amdgcn-amd-amdhsa-gfx942.tmp.bc'
...
define weak_odr protected amdgpu_kernel void @__omp_offloading_52_26f9b69__ZN6openmc9is_deviceEv_l403(ptr noalias noundef %dyn_ptr, ptr noundef nonnull align 4 dereferenceable(4) %is_initial) #0 {
entry:
  %dyn_ptr.addr = alloca ptr, align 8, addrspace(5)
  %is_initial.addr = alloca ptr, align 8, addrspace(5)
  %dyn_ptr.addr.ascast = addrspacecast ptr addrspace(5) %dyn_ptr.addr to ptr
  %is_initial.addr.ascast = addrspacecast ptr addrspace(5) %is_initial.addr to ptr
  store ptr %dyn_ptr, ptr %dyn_ptr.addr.ascast, align 8, !tbaa !28
  store ptr %is_initial, ptr %is_initial.addr.ascast, align 8, !tbaa !32
  %0 = load ptr, ptr %is_initial.addr.ascast, align 8, !tbaa !32
  %1 = call i32 @__kmpc_target_init(ptr addrspacecast (ptr addrspace(1) @__omp_offloading_52_26f9b69__ZN6openmc9is_deviceEv_l403_kernel_environment to ptr), ptr %dyn_ptr)
  %exec_user_code = icmp eq i32 %1, -1
  br i1 %exec_user_code, label %user_code.entry, label %worker.exit

user_code.entry:                                  ; preds = %entry
  %call = call noundef i32 @"_ZL57omp_is_initial_device$ompvariant$S2$s6$Pnohost$s7$Pamdgcnv"() #7
  store i32 %call, ptr %0, align 4, !tbaa !34
...
define internal noundef i32 @"_ZL57omp_is_initial_device$ompvariant$S2$s6$Pnohost$s7$Pamdgcnv"() #1 {
entry:
...
define weak hidden { double, double } @__muldc3(double noundef %__a, double noundef %__b, double noundef %__c, double noundef %__d) #2 {
entry:
  ...
  store double %__a, ptr %__a.addr.ascast, align 8, !tbaa !36
  store double %__b, ptr %__b.addr.ascast, align 8, !tbaa !36
  store double %__c, ptr %__c.addr.ascast, align 8, !tbaa !36
  store double %__d, ptr %__d.addr.ascast, align 8, !tbaa !36
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %__ac) #8
  %0 = load double, ptr %__a.addr.ascast, align 8, !tbaa !36
  %1 = load double, ptr %__c.addr.ascast, align 8, !tbaa !36
  %mul = fmul double %0, %1
  store double %mul, ptr %__ac.ascast, align 8, !tbaa !36
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %__bd) #8
  %2 = load double, ptr %__b.addr.ascast, align 8, !tbaa !36
  %3 = load double, ptr %__d.addr.ascast, align 8, !tbaa !36
  %mul1 = fmul double %2, %3
  store double %mul1, ptr %__bd.ascast, align 8, !tbaa !36
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %__ad) #8
  %4 = load double, ptr %__a.addr.ascast, align 8, !tbaa !36
  %5 = load double, ptr %__d.addr.ascast, align 8, !tbaa !36
  %mul2 = fmul double %4, %5
  store double %mul2, ptr %__ad.ascast, align 8, !tbaa !36
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %__bc) #8
  %6 = load double, ptr %__b.addr.ascast, align 8, !tbaa !36
  %7 = load double, ptr %__c.addr.ascast, align 8, !tbaa !36
  %mul3 = fmul double %6, %7
  store double %mul3, ptr %__bc.ascast, align 8, !tbaa !36
  call void @llvm.lifetime.start.p5(i64 16, ptr addrspace(5) %z) #8
  %8 = load double, ptr %__ac.ascast, align 8, !tbaa !36
  %9 = load double, ptr %__bd.ascast, align 8, !tbaa !36
  %sub = fsub double %8, %9
  %z.ascast.realp = getelementptr inbounds nuw { double, double }, ptr %z.ascast, i32 0, i32 0
  store double %sub, ptr %z.ascast.realp, align 8, !tbaa !36
  %10 = load double, ptr %__ad.ascast, align 8, !tbaa !36
  %11 = load double, ptr %__bc.ascast, align 8, !tbaa !36
  %add = fadd double %10, %11
  %z.ascast.imagp = getelementptr inbounds nuw { double, double }, ptr %z.ascast, i32 0, i32 1
  store double %add, ptr %z.ascast.imagp, align 8, !tbaa !36
  %z.ascast.realp4 = getelementptr inbounds nuw { double, double }, ptr %z.ascast, i32 0, i32 0
  %12 = load double, ptr %z.ascast.realp4, align 8, !tbaa !36
...
land.lhs.true:                                    ; preds = %entry
  ...
  %13 = load double, ptr %z.ascast.imagp5, align 8, !tbaa !36
...
if.then:                                          ; preds = %land.lhs.true
  ...
  store i32 0, ptr %__recalc.ascast, align 4, !tbaa !34
  %14 = load double, ptr %__a.addr.ascast, align 8, !tbaa !36
  %call8 = call i32 @__ocml_isinf_f64(double noundef %14) #9
  %tobool9 = icmp ne i32 %call8, 0
  br i1 %tobool9, label %if.then12, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %if.then
  %15 = load double, ptr %__b.addr.ascast, align 8, !tbaa !36
...
if.then12:                                        ; preds = %lor.lhs.false, %if.then
  %16 = load double, ptr %__a.addr.ascast, align 8, !tbaa !36
  ...
  %18 = load double, ptr %__a.addr.ascast, align 8, !tbaa !36
  %call15 = call double @__ocml_copysign_f64(double noundef %conv, double noundef %18) #9
  store double %call15, ptr %__a.addr.ascast, align 8, !tbaa !36
  %19 = load double, ptr %__b.addr.ascast, align 8, !tbaa !36
  ...
  %21 = load double, ptr %__b.addr.ascast, align 8, !tbaa !36
  %call20 = call double @__ocml_copysign_f64(double noundef %conv19, double noundef %21) #9
  store double %call20, ptr %__b.addr.ascast, align 8, !tbaa !36
  %22 = load double, ptr %__c.addr.ascast, align 8, !tbaa !36
...
if.then23:                                        ; preds = %if.then12
  %23 = load double, ptr %__c.addr.ascast, align 8, !tbaa !36
  %call24 = call double @__ocml_copysign_f64(double noundef 0.000000e+00, double noundef %23) #9
  store double %call24, ptr %__c.addr.ascast, align 8, !tbaa !36
  br label %if.end

if.end:                                           ; preds = %if.then23, %if.then12
  %24 = load double, ptr %__d.addr.ascast, align 8, !tbaa !36
  %call25 = call i32 @__ocml_isnan_f64(double noundef %24) #9
  %tobool26 = icmp ne i32 %call25, 0
  br i1 %tobool26, label %if.then27, label %if.end29

if.then27:                                        ; preds = %if.end
  %25 = load double, ptr %__d.addr.ascast, align 8, !tbaa !36
  %call28 = call double @__ocml_copysign_f64(double noundef 0.000000e+00, double noundef %25) #9
  store double %call28, ptr %__d.addr.ascast, align 8, !tbaa !36
  br label %if.end29

if.end29:                                         ; preds = %if.then27, %if.end
  store i32 1, ptr %__recalc.ascast, align 4, !tbaa !34
  br label %if.end30

if.end30:                                         ; preds = %if.end29, %lor.lhs.false
  %26 = load double, ptr %__c.addr.ascast, align 8, !tbaa !36
...
lor.lhs.false33:                                  ; preds = %if.end30
  %27 = load double, ptr %__d.addr.ascast, align 8, !tbaa !36
...
if.then36:                                        ; preds = %lor.lhs.false33, %if.end30
  %28 = load double, ptr %__c.addr.ascast, align 8, !tbaa !36
  ...
  %30 = load double, ptr %__c.addr.ascast, align 8, !tbaa !36
  %call41 = call double @__ocml_copysign_f64(double noundef %conv40, double noundef %30) #9
  store double %call41, ptr %__c.addr.ascast, align 8, !tbaa !36
  %31 = load double, ptr %__d.addr.ascast, align 8, !tbaa !36
...
if.end57:                                         ; preds = %if.end56, %lor.lhs.false33
  %38 = load i32, ptr %__recalc.ascast, align 4, !tbaa !34
  %tobool58 = icmp ne i32 %38, 0
  br i1 %tobool58, label %if.end92, label %land.lhs.true59

land.lhs.true59:                                  ; preds = %if.end57
  %39 = load double, ptr %__ac.ascast, align 8, !tbaa !36
...
if.end92:                                         ; preds = %if.end91, %lor.lhs.false68, %if.end57
  %51 = load i32, ptr %__recalc.ascast, align 4, !tbaa !34
  %tobool93 = icmp ne i32 %51, 0
  br i1 %tobool93, label %if.then94, label %if.end103

if.then94:                                        ; preds = %if.end92
  %52 = load double, ptr %__a.addr.ascast, align 8, !tbaa !36
  %53 = load double, ptr %__c.addr.ascast, align 8, !tbaa !36
  %54 = load double, ptr %__b.addr.ascast, align 8, !tbaa !36
  %55 = load double, ptr %__d.addr.ascast, align 8, !tbaa !36
  ...
  store double %mul97, ptr %z.ascast.realp98, align 8, !tbaa !36
  %57 = load double, ptr %__a.addr.ascast, align 8, !tbaa !36
  %58 = load double, ptr %__d.addr.ascast, align 8, !tbaa !36
  %59 = load double, ptr %__b.addr.ascast, align 8, !tbaa !36
  %60 = load double, ptr %__c.addr.ascast, align 8, !tbaa !36
  ...
  store double %mul101, ptr %z.ascast.imagp102, align 8, !tbaa !36
  br label %if.end103
...
; Function Attrs: cold convergent mustprogress noinline nounwind optsize
define weak hidden [2 x i32] @__mulsc3(float noundef %__a, float noundef %__b, float noundef %__c, float noundef %__d) #2 {
entry:
...
; Function Attrs: cold convergent mustprogress noinline nounwind optsize
define weak hidden { double, double } @__divdc3(double noundef %__a, double noundef %__b, double noundef %__c, double noundef %__d) #2 {
entry:
  %retval = alloca { double, double }, align 8, addrspace(5)
  %__a.addr = alloca double, align 8, addrspace(5)
  %__b.addr = alloca double, align 8, addrspace(5)
  ...
  store i32 0, ptr %__ilogbw.ascast, align 4, !tbaa !34
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %__logbw) #8
  %0 = load double, ptr %__c.addr.ascast, align 8, !tbaa !36
  %call = call double @__ocml_fabs_f64(double noundef %0) #9
  %1 = load double, ptr %__d.addr.ascast, align 8, !tbaa !36
  ...
  store double %call3, ptr %__logbw.ascast, align 8, !tbaa !36
  %2 = load double, ptr %__logbw.ascast, align 8, !tbaa !36
  %call4 = call i32 @__ocml_isfinite_f64(double noundef %2) #9
  %tobool = icmp ne i32 %call4, 0
  br i1 %tobool, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %3 = load double, ptr %__logbw.ascast, align 8, !tbaa !36
  %conv = fptosi double %3 to i32
  store i32 %conv, ptr %__ilogbw.ascast, align 4, !tbaa !34
  %4 = load double, ptr %__c.addr.ascast, align 8, !tbaa !36
  %5 = load i32, ptr %__ilogbw.ascast, align 4, !tbaa !34
  %sub = sub nsw i32 0, %5
  %call5 = call double @__ocml_scalbn_f64(double noundef %4, i32 noundef %sub) #9
  store double %call5, ptr %__c.addr.ascast, align 8, !tbaa !36
  %6 = load double, ptr %__d.addr.ascast, align 8, !tbaa !36
  %7 = load i32, ptr %__ilogbw.ascast, align 4, !tbaa !34
  %sub6 = sub nsw i32 0, %7
  %call7 = call double @__ocml_scalbn_f64(double noundef %6, i32 noundef %sub6) #9
  store double %call7, ptr %__d.addr.ascast, align 8, !tbaa !36
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %__denom) #8
  %8 = load double, ptr %__c.addr.ascast, align 8, !tbaa !36
  %9 = load double, ptr %__c.addr.ascast, align 8, !tbaa !36
  %10 = load double, ptr %__d.addr.ascast, align 8, !tbaa !36
  %11 = load double, ptr %__d.addr.ascast, align 8, !tbaa !36
  %mul8 = fmul double %10, %11
  %12 = call double @llvm.fmuladd.f64(double %8, double %9, double %mul8)
  store double %12, ptr %__denom.ascast, align 8, !tbaa !36
  call void @llvm.lifetime.start.p5(i64 16, ptr addrspace(5) %z) #8
  %13 = load double, ptr %__a.addr.ascast, align 8, !tbaa !36
  %14 = load double, ptr %__c.addr.ascast, align 8, !tbaa !36
  %15 = load double, ptr %__b.addr.ascast, align 8, !tbaa !36
  %16 = load double, ptr %__d.addr.ascast, align 8, !tbaa !36
  %mul9 = fmul double %15, %16
  %17 = call double @llvm.fmuladd.f64(double %13, double %14, double %mul9)
  %18 = load double, ptr %__denom.ascast, align 8, !tbaa !36
  %div = fdiv double %17, %18
  %19 = load i32, ptr %__ilogbw.ascast, align 4, !tbaa !34
  %sub10 = sub nsw i32 0, %19
  %call11 = call double @__ocml_scalbn_f64(double noundef %div, i32 noundef %sub10) #9
  %z.ascast.realp = getelementptr inbounds nuw { double, double }, ptr %z.ascast, i32 0, i32 0
  store double %call11, ptr %z.ascast.realp, align 8, !tbaa !36
  %20 = load double, ptr %__b.addr.ascast, align 8, !tbaa !36
  %21 = load double, ptr %__c.addr.ascast, align 8, !tbaa !36
  %22 = load double, ptr %__a.addr.ascast, align 8, !tbaa !36
  %23 = load double, ptr %__d.addr.ascast, align 8, !tbaa !36
  %mul12 = fmul double %22, %23
  %neg = fneg double %mul12
  %24 = call double @llvm.fmuladd.f64(double %20, double %21, double %neg)
  %25 = load double, ptr %__denom.ascast, align 8, !tbaa !36
  %div13 = fdiv double %24, %25
  %26 = load i32, ptr %__ilogbw.ascast, align 4, !tbaa !34
  %sub14 = sub nsw i32 0, %26
  %call15 = call double @__ocml_scalbn_f64(double noundef %div13, i32 noundef %sub14) #9
  %z.ascast.imagp = getelementptr inbounds nuw { double, double }, ptr %z.ascast, i32 0, i32 1
  store double %call15, ptr %z.ascast.imagp, align 8, !tbaa !36
  %z.ascast.realp16 = getelementptr inbounds nuw { double, double }, ptr %z.ascast, i32 0, i32 0
  %27 = load double, ptr %z.ascast.realp16, align 8, !tbaa !36
...
if.then45:                                        ; preds = %land.lhs.true42
  ...
  %42 = load double, ptr %__a.addr.ascast, align 8, !tbaa !36
  %call48 = call double @__ocml_copysign_f64(double noundef %cond, double noundef %42) #9
  store double %call48, ptr %__a.addr.ascast, align 8, !tbaa !36
  %43 = load double, ptr %__b.addr.ascast, align 8, !tbaa !36
  ...
  store double %call52, ptr %__b.addr.ascast, align 8, !tbaa !36
  %46 = load double, ptr %__a.addr.ascast, align 8, !tbaa !36
  %47 = load double, ptr %__c.addr.ascast, align 8, !tbaa !36
  %48 = load double, ptr %__b.addr.ascast, align 8, !tbaa !36
  %49 = load double, ptr %__d.addr.ascast, align 8, !tbaa !36
  ...
  store double %mul55, ptr %z.ascast.realp56, align 8, !tbaa !36
  %51 = load double, ptr %__b.addr.ascast, align 8, !tbaa !36
  %52 = load double, ptr %__c.addr.ascast, align 8, !tbaa !36
  %53 = load double, ptr %__a.addr.ascast, align 8, !tbaa !36
  %54 = load double, ptr %__d.addr.ascast, align 8, !tbaa !36
  ...
  store double %mul60, ptr %z.ascast.imagp61, align 8, !tbaa !36
  br label %if.end92

if.else62:                                        ; preds = %land.lhs.true42, %land.lhs.true39, %lor.lhs.false36
  %56 = load double, ptr %__logbw.ascast, align 8, !tbaa !36
...
land.lhs.true65:                                  ; preds = %if.else62
  %57 = load double, ptr %__logbw.ascast, align 8, !tbaa !36
...
land.lhs.true67:                                  ; preds = %land.lhs.true65
  %58 = load double, ptr %__a.addr.ascast, align 8, !tbaa !36
...
if.then73:                                        ; preds = %land.lhs.true70
  ...
  %62 = load double, ptr %__c.addr.ascast, align 8, !tbaa !36
  %call77 = call double @__ocml_copysign_f64(double noundef %cond76, double noundef %62) #9
  store double %call77, ptr %__c.addr.ascast, align 8, !tbaa !36
  %63 = load double, ptr %__d.addr.ascast, align 8, !tbaa !36
  ...
  %65 = load double, ptr %__d.addr.ascast, align 8, !tbaa !36
  %call81 = call double @__ocml_copysign_f64(double noundef %cond80, double noundef %65) #9
  store double %call81, ptr %__d.addr.ascast, align 8, !tbaa !36
  %66 = load double, ptr %__a.addr.ascast, align 8, !tbaa !36
  %67 = load double, ptr %__c.addr.ascast, align 8, !tbaa !36
  %68 = load double, ptr %__b.addr.ascast, align 8, !tbaa !36
  %69 = load double, ptr %__d.addr.ascast, align 8, !tbaa !36
  ...
  store double %mul84, ptr %z.ascast.realp85, align 8, !tbaa !36
  %71 = load double, ptr %__b.addr.ascast, align 8, !tbaa !36
  %72 = load double, ptr %__c.addr.ascast, align 8, !tbaa !36
  %73 = load double, ptr %__a.addr.ascast, align 8, !tbaa !36
  %74 = load double, ptr %__d.addr.ascast, align 8, !tbaa !36
  ...
  store double %mul89, ptr %z.ascast.imagp90, align 8, !tbaa !36
  br label %if.end91
...
; Function Attrs: cold convergent mustprogress noinline nounwind optsize
define weak hidden [2 x i32] @__divsc3(float noundef %__a, float noundef %__b, float noundef %__c, float noundef %__d) #2 {
entry:
  %retval = alloca { float, float }, align 4, addrspace(5)
  %__a.addr = alloca float, align 4, addrspace(5)
  %__b.addr = alloca float, align 4, addrspace(5)
...
define internal double @__ocml_logb_f64(double noundef %0) #5 {
  ...
  %5 = load i8, ptr addrspace(4) @__oclc_finite_only_opt, align 1, !tbaa !40, !range !44, !noundef !45
  %6 = icmp eq i8 %5, 0
...
attributes #2 = { cold convergent mustprogress noinline nounwind optsize "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="gfx942" "target-features"="+16-bit-insts,+atomic-buffer-global-pk-add-f16-insts,+atomic-ds-pk-add-16-insts,+atomic-fadd-rtn-insts,+atomic-flat-pk-add-16-insts,+atomic-global-pk-add-bf16-inst,+ci-insts,+dl-insts,+dot1-insts,+dot10-insts,+dot2-insts,+dot3-insts,+dot4-insts,+dot5-insts,+dot6-insts,+dot7-insts,+dpp,+fp8-conversion-insts,+fp8-insts,+gfx8-insts,+gfx9-insts,+gfx90a-insts,+gfx940-insts,+mai-insts,+s-memrealtime,+s-memtime-inst,+wavefrontsize64,+xf32-insts" }
...
!llvm.ident = !{!25, !26, !26, !26, !26, !26, !26, !26, !26}
!opencl.ocl.version = !{!27, !27, !27, !27, !27, !27, !27, !27}
...
!25 = !{!"clang version 21.0.0git (https://github.com/llvm/llvm-project.git da17ced11b1cf44b433cb2b850978df4b6bff279)"}
!26 = !{!"AMD clang version 18.0.0git (https://github.com/RadeonOpenCompute/llvm-project roc-6.3.1 24491 1e0fda770a2079fbd71e4b70974d74f62fd3af10)"}
!27 = !{i32 2, i32 0}
!28 = !{!29, !29, i64 0}
