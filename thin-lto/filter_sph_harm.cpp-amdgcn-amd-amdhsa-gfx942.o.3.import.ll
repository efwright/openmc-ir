; ModuleID = 'filter_sph_harm.cpp-amdgcn-amd-amdhsa-gfx942.o.3.import.bc'
...
entry:
  ...
  call void @llvm.lifetime.start.p5(i64 1000, ptr addrspace(5) %wgt) #6
...
for.cond.preheader:                               ; preds = %entry
  ...
  %1 = load i32, ptr %order_2, align 8, !tbaa !45
...
if.then:                                          ; preds = %entry
  ...
  %2 = load i32, ptr %order_, align 8, !tbaa !45
  %mu_ = getelementptr inbounds nuw i8, ptr %p, i64 1432
  %3 = load double, ptr %mu_, align 8, !tbaa !46
  call void @calc_pn_c(i32 noundef %2, double noundef %3, ptr noundef %wgt.ascast) #7
  %.pre = load i32, ptr %order_, align 8, !tbaa !45
  br label %if.end
...
for.body:                                         ; preds = %for.body, %for.cond.preheader
  ...
  br i1 %exitcond.not, label %if.end, label %for.body, !llvm.loop !62

if.end:                                           ; preds = %for.body, %if.then, %for.cond.preheader
  %4 = phi i32 [ %1, %for.cond.preheader ], [ %.pre, %if.then ], [ %1, %for.body ]
  call void @llvm.lifetime.start.p5(i64 1000, ptr addrspace(5) %rn) #6
  ...
  call void @_ZN6openmc7calc_rnEiNS_8PositionEPd(i32 noundef %4, double %agg.tmp.sroa.0.0.copyload, double %agg.tmp.sroa.2.0.copyload, double %agg.tmp.sroa.3.0.copyload, ptr noundef %rn.ascast) #7
  %5 = load i32, ptr %order_4, align 8, !tbaa !45
...
for.body12.lr.ph:                                 ; preds = %if.end
  ...
  %this.val.i.pre.pre = load i32, ptr %6, align 8, !tbaa !64
  br label %for.body12

for.cond.cleanup10:                               ; preds = %for.cond.cleanup17, %if.end
  call void @llvm.lifetime.end.p5(i64 1000, ptr addrspace(5) %rn) #6
  call void @llvm.lifetime.end.p5(i64 1000, ptr addrspace(5) %wgt) #6
  ret void
...
for.cond.cleanup17:                               ; preds = %_ZN6openmc11FilterMatch9push_backEid.internalized.exit
  ...
  %8 = load i32, ptr %order_4, align 8, !tbaa !45
  %cmp9.not.not = icmp slt i32 %n.016, %8
  %indvars.iv.next = add i32 %indvars.iv, 2
  br i1 %cmp9.not.not, label %for.body12, label %for.cond.cleanup10, !llvm.loop !66
...
if.then.i:                                        ; preds = %for.body18
  %9 = load double, ptr addrspace(5) %arrayidx20, align 8, !tbaa !61
  %arrayidx22 = getelementptr inbounds [125 x double], ptr addrspace(5) %rn, i32 0, i32 %j.112
  %10 = load double, ptr addrspace(5) %arrayidx22, align 8, !tbaa !61
  ...
  store i32 %j.112, ptr %arrayidx.i, align 4, !tbaa !67
  ...
  store i32 %inc.i, ptr %6, align 8, !tbaa !64
...
_ZN6openmc11FilterMatch9push_backEid.internalized.exit: ; preds = %if.then.i, %for.body18
  ...
  br i1 %exitcond17.not, label %for.cond.cleanup17, label %for.body18, !llvm.loop !68
}
...
define available_externally hidden void @calc_pn_c(i32 noundef %n, double noundef %x, ptr noundef captures(none) initializes((0, 8)) %pnx) local_unnamed_addr #5 {
entry:
  store double 1.000000e+00, ptr %pnx, align 8, !tbaa !61
  %cmp = icmp sgt i32 %n, 0
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %arrayidx1 = getelementptr inbounds nuw i8, ptr %pnx, i64 8
  store double %x, ptr %arrayidx1, align 8, !tbaa !61
  br label %if.end
...
for.body.preheader:                               ; preds = %if.end
  ...
  %.pre = load double, ptr %arrayidx4.phi.trans.insert, align 8, !tbaa !61
...
for.body:                                         ; preds = %for.body, %for.body.preheader
  ...
  %1 = load double, ptr %gep, align 8, !tbaa !61
  %2 = fneg double %conv6
  %neg = fmul double %1, %2
  ...
  store double %div, ptr %arrayidx14, align 8, !tbaa !61
