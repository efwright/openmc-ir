; ModuleID = 'wmp.cpp-amdgcn-amd-amdhsa-gfx942.o.5.precodegen.bc'
...
for.body35:                                       ; preds = %if.end45, %for.body35.lr.ph
  ...
  %mul21.i188 = add i32 %i_poly29.0436, %mul.i186
  %add.i189 = mul i32 %mul21.i188, %117
...
if.then52:                                        ; preds = %if.end50
  ...
  %125 = load <2 x i32>, ptr %arrayidx.i, align 4, !tbaa !81
  %126 = extractelement <2 x i32> %125, i64 0
  %127 = extractelement <2 x i32> %125, i64 1
  %cmp54.not462 = icmp sgt i32 %126, %127
  br i1 %cmp54.not462, label %if.end139, label %for.body57.lr.ph

for.body57.lr.ph:                                 ; preds = %if.then52
  %128 = getelementptr inbounds nuw i8, ptr %this, i64 320
  %129 = getelementptr inbounds nuw i8, ptr %this, i64 336
  %fissionable_76 = getelementptr inbounds nuw i8, ptr %this, i64 68
  br label %for.body57

for.body57:                                       ; preds = %if.end85, %for.body57.lr.ph
  %i_pole.0466 = phi i32 [ %126, %for.body57.lr.ph ], [ %inc87, %if.end85 ]
  ...
  %this.val = load ptr, ptr %128, align 8, !tbaa !82
  %this.val131 = load i32, ptr %129, align 8, !tbaa !83
  ...
  %retval.sroa.2.0.copyload.i = load double, ptr %retval.sroa.2.0.arrayidx.sroa_idx.i, align 8, !tbaa !84
  ...
  %this.val132 = load ptr, ptr %128, align 8, !tbaa !82
  %this.val133 = load i32, ptr %129, align 8, !tbaa !83
  %mul.i226 = mul nsw i32 %this.val133, %i_pole.0466
  %130 = sext i32 %mul.i226 to i64
  %131 = getelementptr %"class.std::complex", ptr %this.val132, i64 %130
  %arrayidx.i229 = getelementptr i8, ptr %131, i64 16
  %retval.sroa.0.0.copyload.i230 = load double, ptr %arrayidx.i229, align 8
  %retval.sroa.2.0.arrayidx.sroa_idx.i231 = getelementptr i8, ptr %131, i64 24
  %retval.sroa.2.0.copyload.i232 = load double, ptr %retval.sroa.2.0.arrayidx.sroa_idx.i231, align 8, !tbaa !84
  ...
  br i1 %isnan_cmp.i.i, label %complex_mul_imag_nan.i.i, label %_ZStmlIdESt7complexIT_ERKS2_S4_.internalized.exit, !prof !85
...
complex_mul_imag_nan.i.i:                         ; preds = %for.body57
  ...
  br i1 %isnan_cmp4.i.i, label %complex_mul_libcall.i.i, label %_ZStmlIdESt7complexIT_ERKS2_S4_.internalized.exit, !prof !85
...
complex_mul_libcall.i.i:                          ; preds = %complex_mul_imag_nan.i.i
  ...
  %132 = extractvalue { double, double } %call5.i.i, 0
  %this.val134.pre = load ptr, ptr %128, align 8, !tbaa !82
  %this.val135.pre = load i32, ptr %129, align 8, !tbaa !83
...
_ZStmlIdESt7complexIT_ERKS2_S4_.internalized.exit: ; preds = %complex_mul_libcall.i.i, %complex_mul_imag_nan.i.i, %for.body57
  %.pre-phi = phi i64 [ %130, %for.body57 ], [ %130, %complex_mul_imag_nan.i.i ], [ %.pre480, %complex_mul_libcall.i.i ]
  %this.val134 = phi ptr [ %this.val132, %for.body57 ], [ %this.val132, %complex_mul_imag_nan.i.i ], [ %this.val134.pre, %complex_mul_libcall.i.i ]
  %real_mul_phi.i.i = phi double [ %mul_r.i.i, %for.body57 ], [ %mul_r.i.i, %complex_mul_imag_nan.i.i ], [ %132, %complex_mul_libcall.i.i ]
  %add = fadd double %sig_s.3465, %real_mul_phi.i.i
  %133 = getelementptr %"class.std::complex", ptr %this.val134, i64 %.pre-phi
  %arrayidx.i243 = getelementptr i8, ptr %133, i64 32
  %retval.sroa.0.0.copyload.i244 = load double, ptr %arrayidx.i243, align 8
  %retval.sroa.2.0.arrayidx.sroa_idx.i245 = getelementptr i8, ptr %133, i64 40
  %retval.sroa.2.0.copyload.i246 = load double, ptr %retval.sroa.2.0.arrayidx.sroa_idx.i245, align 8, !tbaa !84
  ...
  br i1 %isnan_cmp.i.i258, label %complex_mul_imag_nan.i.i263, label %_ZStmlIdESt7complexIT_ERKS2_S4_.internalized.exit267, !prof !85
...
complex_mul_imag_nan.i.i263:                      ; preds = %_ZStmlIdESt7complexIT_ERKS2_S4_.internalized.exit
  ...
  br i1 %isnan_cmp4.i.i264, label %complex_mul_libcall.i.i265, label %_ZStmlIdESt7complexIT_ERKS2_S4_.internalized.exit267, !prof !85
...
complex_mul_libcall.i.i265:                       ; preds = %complex_mul_imag_nan.i.i263
  ...
  %134 = extractvalue { double, double } %call5.i.i266, 0
...
_ZStmlIdESt7complexIT_ERKS2_S4_.internalized.exit267: ; preds = %complex_mul_libcall.i.i265, %complex_mul_imag_nan.i.i263, %_ZStmlIdESt7complexIT_ERKS2_S4_.internalized.exit
  %real_mul_phi.i.i259 = phi double [ %mul_r.i.i256, %_ZStmlIdESt7complexIT_ERKS2_S4_.internalized.exit ], [ %mul_r.i.i256, %complex_mul_imag_nan.i.i263 ], [ %134, %complex_mul_libcall.i.i265 ]
  %add75 = fadd double %sig_a.3464, %real_mul_phi.i.i259
  %135 = load i8, ptr %fissionable_76, align 4, !tbaa !78, !range !69, !noundef !70
  %loadedv77 = trunc nuw i8 %135 to i1
  br i1 %loadedv77, label %if.then78, label %if.end85

if.then78:                                        ; preds = %_ZStmlIdESt7complexIT_ERKS2_S4_.internalized.exit267
  %this.val136 = load ptr, ptr %128, align 8, !tbaa !82
  %this.val137 = load i32, ptr %129, align 8, !tbaa !83
  %mul.i268 = mul nsw i32 %this.val137, %i_pole.0466
  %136 = sext i32 %mul.i268 to i64
  %137 = getelementptr %"class.std::complex", ptr %this.val136, i64 %136
  %arrayidx.i271 = getelementptr i8, ptr %137, i64 48
  %retval.sroa.0.0.copyload.i272 = load double, ptr %arrayidx.i271, align 8
  %retval.sroa.2.0.arrayidx.sroa_idx.i273 = getelementptr i8, ptr %137, i64 56
  %retval.sroa.2.0.copyload.i274 = load double, ptr %retval.sroa.2.0.arrayidx.sroa_idx.i273, align 8, !tbaa !84
  ...
  br i1 %isnan_cmp.i.i286, label %complex_mul_imag_nan.i.i291, label %_ZStmlIdESt7complexIT_ERKS2_S4_.internalized.exit295, !prof !85
...
complex_mul_imag_nan.i.i291:                      ; preds = %if.then78
  ...
  br i1 %isnan_cmp4.i.i292, label %complex_mul_libcall.i.i293, label %_ZStmlIdESt7complexIT_ERKS2_S4_.internalized.exit295, !prof !85
...
complex_mul_libcall.i.i293:                       ; preds = %complex_mul_imag_nan.i.i291
  ...
  %138 = extractvalue { double, double } %call5.i.i294, 0
...
_ZStmlIdESt7complexIT_ERKS2_S4_.internalized.exit295: ; preds = %complex_mul_libcall.i.i293, %complex_mul_imag_nan.i.i291, %if.then78
  %real_mul_phi.i.i287 = phi double [ %mul_r.i.i284, %if.then78 ], [ %mul_r.i.i284, %complex_mul_imag_nan.i.i291 ], [ %138, %complex_mul_libcall.i.i293 ]
...
if.end85:                                         ; preds = %_ZStmlIdESt7complexIT_ERKS2_S4_.internalized.exit295, %_ZStmlIdESt7complexIT_ERKS2_S4_.internalized.exit267
  ...
  %139 = load i32, ptr %index_end, align 4, !tbaa !86
  %cmp54.not.not = icmp slt i32 %i_pole.0466, %139
...
if.else89:                                        ; preds = %if.end50
  ...
  %140 = load double, ptr %sqrt_awr_91, align 8, !tbaa !71
  %div92 = fdiv double %140, %sqrtkT
  %index_end96 = getelementptr inbounds nuw i8, ptr %arrayidx.i, i64 4
  %141 = load <2 x i32>, ptr %arrayidx.i, align 4, !tbaa !81
  %142 = extractelement <2 x i32> %141, i64 0
  %143 = extractelement <2 x i32> %141, i64 1
  %cmp97.not454 = icmp sgt i32 %142, %143
  br i1 %cmp97.not454, label %if.end139, label %for.body100.lr.ph

for.body100.lr.ph:                                ; preds = %if.else89
  %144 = getelementptr inbounds nuw i8, ptr %this, i64 320
  %145 = getelementptr inbounds nuw i8, ptr %this, i64 336
  %fissionable_126 = getelementptr inbounds nuw i8, ptr %this, i64 68
  br label %for.body100

for.body100:                                      ; preds = %if.end135, %for.body100.lr.ph
  %i_pole93.0458 = phi i32 [ %142, %for.body100.lr.ph ], [ %inc137, %if.end135 ]
  ...
  %this.val138 = load ptr, ptr %144, align 8, !tbaa !82
  %this.val139 = load i32, ptr %145, align 8, !tbaa !83
  ...
  %retval.sroa.2.0.copyload.i302 = load double, ptr %retval.sroa.2.0.arrayidx.sroa_idx.i301, align 8, !tbaa !84
  ...
  %146 = insertvalue { double, double } poison, double %mul.rl.i.i310, 0
  %147 = insertvalue { double, double } %146, double %mul.il.i.i311, 1
  %call109 = tail call %"class.std::complex" @_ZN6openmc8faddeevaESt7complexIdE({ double, double } %147) #7
  %148 = extractvalue %"class.std::complex" %call109, 0
  %.fca.0.extract23 = extractvalue { double, double } %148, 0
  %.fca.1.extract25 = extractvalue { double, double } %148, 1
  ...
  %this.val140 = load ptr, ptr %144, align 8, !tbaa !82
  %this.val141 = load i32, ptr %145, align 8, !tbaa !83
  %mul.i335 = mul nsw i32 %this.val141, %i_pole93.0458
  %149 = sext i32 %mul.i335 to i64
  %150 = getelementptr %"class.std::complex", ptr %this.val140, i64 %149
  %arrayidx.i338 = getelementptr i8, ptr %150, i64 16
  %retval.sroa.0.0.copyload.i339 = load double, ptr %arrayidx.i338, align 8
  %retval.sroa.2.0.arrayidx.sroa_idx.i340 = getelementptr i8, ptr %150, i64 24
  %retval.sroa.2.0.copyload.i341 = load double, ptr %retval.sroa.2.0.arrayidx.sroa_idx.i340, align 8, !tbaa !84
  ...
  br i1 %isnan_cmp.i.i353, label %complex_mul_imag_nan.i.i358, label %_ZStmlIdESt7complexIT_ERKS2_S4_.internalized.exit362, !prof !85
...
complex_mul_imag_nan.i.i358:                      ; preds = %for.body100
  ...
  br i1 %isnan_cmp4.i.i359, label %complex_mul_libcall.i.i360, label %_ZStmlIdESt7complexIT_ERKS2_S4_.internalized.exit362, !prof !85
...
complex_mul_libcall.i.i360:                       ; preds = %complex_mul_imag_nan.i.i358
  ...
  %151 = extractvalue { double, double } %call5.i.i361, 0
  %this.val142.pre = load ptr, ptr %144, align 8, !tbaa !82
  %this.val143.pre = load i32, ptr %145, align 8, !tbaa !83
...
_ZStmlIdESt7complexIT_ERKS2_S4_.internalized.exit362: ; preds = %complex_mul_libcall.i.i360, %complex_mul_imag_nan.i.i358, %for.body100
  %.pre-phi483 = phi i64 [ %149, %for.body100 ], [ %149, %complex_mul_imag_nan.i.i358 ], [ %.pre482, %complex_mul_libcall.i.i360 ]
  ...
  %real_mul_phi.i.i354 = phi double [ %mul_r.i.i351, %for.body100 ], [ %mul_r.i.i351, %complex_mul_imag_nan.i.i358 ], [ %151, %complex_mul_libcall.i.i360 ]
  %add119 = fadd double %sig_s.4457, %real_mul_phi.i.i354
  %152 = getelementptr %"class.std::complex", ptr %this.val142, i64 %.pre-phi483
  %arrayidx.i366 = getelementptr i8, ptr %152, i64 32
  %retval.sroa.0.0.copyload.i367 = load double, ptr %arrayidx.i366, align 8
  %retval.sroa.2.0.arrayidx.sroa_idx.i368 = getelementptr i8, ptr %152, i64 40
  %retval.sroa.2.0.copyload.i369 = load double, ptr %retval.sroa.2.0.arrayidx.sroa_idx.i368, align 8, !tbaa !84
  ...
  br i1 %isnan_cmp.i.i381, label %complex_mul_imag_nan.i.i386, label %_ZStmlIdESt7complexIT_ERKS2_S4_.internalized.exit390, !prof !85
...
complex_mul_imag_nan.i.i386:                      ; preds = %_ZStmlIdESt7complexIT_ERKS2_S4_.internalized.exit362
  ...
  br i1 %isnan_cmp4.i.i387, label %complex_mul_libcall.i.i388, label %_ZStmlIdESt7complexIT_ERKS2_S4_.internalized.exit390, !prof !85
...
complex_mul_libcall.i.i388:                       ; preds = %complex_mul_imag_nan.i.i386
  ...
  %153 = extractvalue { double, double } %call5.i.i389, 0
...
_ZStmlIdESt7complexIT_ERKS2_S4_.internalized.exit390: ; preds = %complex_mul_libcall.i.i388, %complex_mul_imag_nan.i.i386, %_ZStmlIdESt7complexIT_ERKS2_S4_.internalized.exit362
  %real_mul_phi.i.i382 = phi double [ %mul_r.i.i379, %_ZStmlIdESt7complexIT_ERKS2_S4_.internalized.exit362 ], [ %mul_r.i.i379, %complex_mul_imag_nan.i.i386 ], [ %153, %complex_mul_libcall.i.i388 ]
  %add125 = fadd double %sig_a.4456, %real_mul_phi.i.i382
  %154 = load i8, ptr %fissionable_126, align 4, !tbaa !78, !range !69, !noundef !70
  %loadedv127 = trunc nuw i8 %154 to i1
  br i1 %loadedv127, label %if.then128, label %if.end135

if.then128:                                       ; preds = %_ZStmlIdESt7complexIT_ERKS2_S4_.internalized.exit390
  %this.val144 = load ptr, ptr %144, align 8, !tbaa !82
  %this.val145 = load i32, ptr %145, align 8, !tbaa !83
  %mul.i391 = mul nsw i32 %this.val145, %i_pole93.0458
  %155 = sext i32 %mul.i391 to i64
  %156 = getelementptr %"class.std::complex", ptr %this.val144, i64 %155
  %arrayidx.i394 = getelementptr i8, ptr %156, i64 48
  %retval.sroa.0.0.copyload.i395 = load double, ptr %arrayidx.i394, align 8
  %retval.sroa.2.0.arrayidx.sroa_idx.i396 = getelementptr i8, ptr %156, i64 56
  %retval.sroa.2.0.copyload.i397 = load double, ptr %retval.sroa.2.0.arrayidx.sroa_idx.i396, align 8, !tbaa !84
  ...
  br i1 %isnan_cmp.i.i409, label %complex_mul_imag_nan.i.i414, label %_ZStmlIdESt7complexIT_ERKS2_S4_.internalized.exit418, !prof !85
...
complex_mul_imag_nan.i.i414:                      ; preds = %if.then128
  ...
  br i1 %isnan_cmp4.i.i415, label %complex_mul_libcall.i.i416, label %_ZStmlIdESt7complexIT_ERKS2_S4_.internalized.exit418, !prof !85
...
complex_mul_libcall.i.i416:                       ; preds = %complex_mul_imag_nan.i.i414
  ...
  %157 = extractvalue { double, double } %call5.i.i417, 0
...
_ZStmlIdESt7complexIT_ERKS2_S4_.internalized.exit418: ; preds = %complex_mul_libcall.i.i416, %complex_mul_imag_nan.i.i414, %if.then128
  %real_mul_phi.i.i410 = phi double [ %mul_r.i.i407, %if.then128 ], [ %mul_r.i.i407, %complex_mul_imag_nan.i.i414 ], [ %157, %complex_mul_libcall.i.i416 ]
...
if.end135:                                        ; preds = %_ZStmlIdESt7complexIT_ERKS2_S4_.internalized.exit418, %_ZStmlIdESt7complexIT_ERKS2_S4_.internalized.exit390
  ...
  %158 = load i32, ptr %index_end96, align 4, !tbaa !86
  %cmp97.not.not = icmp slt i32 %i_pole93.0458, %158
...
if.end139:                                        ; preds = %if.end135, %if.else89, %if.end85, %if.then52
  ...
  %159 = getelementptr inbounds nuw i8, ptr addrspace(5) %agg.result, i32 8
  store double %sig_a.5, ptr addrspace(5) %159, align 8, !tbaa !94, !alias.scope !91
  %160 = getelementptr inbounds nuw i8, ptr addrspace(5) %agg.result, i32 16
  store double %sig_s.5, ptr addrspace(5) %160, align 8, !tbaa !96, !alias.scope !91
  ret void
}
