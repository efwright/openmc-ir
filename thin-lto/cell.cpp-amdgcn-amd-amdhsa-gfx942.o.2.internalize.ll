; ModuleID = 'cell.cpp-amdgcn-amd-amdhsa-gfx942.o.2.internalize.bc'
...
if.else:                                          ; preds = %if.then
  %4 = load ptr, ptr %device_partitions_lengths_31, align 8, !tbaa !53
  ...
  %6 = load ptr, ptr %device_partitions_34, align 8, !tbaa !60
  %7 = load ptr, ptr %device_partitions_offsets_35, align 8, !tbaa !61
...
if.else30:                                        ; preds = %if.else23
  %9 = load ptr, ptr %device_partitions_lengths_31, align 8, !tbaa !53
  ...
  %11 = load ptr, ptr %device_partitions_34, align 8, !tbaa !60
  %12 = load ptr, ptr %device_partitions_offsets_35, align 8, !tbaa !61
...
cleanup45:                                        ; preds = %if.end44, %cleanup41, %cleanup
  ...
  br i1 %cond1, label %while.cond, label %cleanup48, !llvm.loop !62
...
!52 = distinct !{!52, !51}
!53 = !{!54, !35, i64 64}
!54 = !{!"_ZTSN6openmc19UniversePartitionerE", !34, i64 0, !55, i64 24, !35, i64 48, !35, i64 56, !35, i64 64}
!55 = !{!"_ZTSSt6vectorIS_IiSaIiEESaIS1_EE", !56, i64 0}
!56 = !{!"_ZTSSt12_Vector_baseISt6vectorIiSaIiEESaIS2_EE", !57, i64 0}
!57 = !{!"_ZTSNSt12_Vector_baseISt6vectorIiSaIiEESaIS2_EE12_Vector_implE", !58, i64 0}
!58 = !{!"_ZTSNSt12_Vector_baseISt6vectorIiSaIiEESaIS2_EE17_Vector_impl_dataE", !59, i64 0, !59, i64 8, !59, i64 16}
!59 = !{!"p1 _ZTSSt6vectorIiSaIiEE", !31, i64 0}
!60 = !{!54, !35, i64 48}
!61 = !{!54, !35, i64 56}
!62 = distinct !{!62, !51}
