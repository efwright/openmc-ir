; ModuleID = 'surface.cpp-amdgcn-amd-amdhsa-gfx942.o.3.import.bc'
...
_ZNK6openmc7Surface6normalENS_8PositionE.internalized.exit: ; preds = %sw.bb33.i, %sw.bb30.i, %sw.bb27.i, %sw.bb24.i, %sw.bb21.i, %sw.bb18.i, %sw.bb15.i, %sw.bb12.i, %sw.bb9.i, %sw.bb6.i, %sw.bb3.i, %entry
  ...
  %agg.tmp7.sroa.0.0.copyload.i = load double, ptr addrspace(5) %n.i, align 8, !tbaa !48
  %agg.tmp7.sroa.2.0.copyload.i = load double, ptr addrspace(5) %40, align 8, !tbaa !48
  %agg.tmp7.sroa.3.0.copyload.i = load double, ptr addrspace(5) %41, align 8, !tbaa !48
  ...
  %retval.sroa.0.0.copyload.i.i = load double, ptr %call.i.i, align 8, !tbaa !48
  %retval.sroa.2.0.call.sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %call.i.i, i64 8
  %retval.sroa.2.0.copyload.i.i = load double, ptr %retval.sroa.2.0.call.sroa_idx.i.i, align 8, !tbaa !48
  %retval.sroa.3.0.call.sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %call.i.i, i64 16
  %retval.sroa.3.0.copyload.i.i = load double, ptr %retval.sroa.3.0.call.sroa_idx.i.i, align 8, !tbaa !48
...
_ZNK6openmc7Surface6normalENS_8PositionE.internalized.exit: ; preds = %sw.bb33.i, %sw.bb30.i, %sw.bb27.i, %sw.bb24.i, %sw.bb21.i, %sw.bb18.i, %sw.bb15.i, %sw.bb12.i, %sw.bb9.i, %sw.bb6.i, %sw.bb3.i, %entry
  ...
  %45 = load double, ptr addrspace(5) %n, align 8, !tbaa !49
  %46 = load double, ptr addrspace(5) %40, align 8, !tbaa !50
  %mul5.i = fmul double %u.coerce1, %46
  %47 = call double @llvm.fmuladd.f64(double %45, double %u.coerce0, double %mul5.i) #7
  %48 = load double, ptr addrspace(5) %41, align 8, !tbaa !51
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %agg.tmp12.sroa.0.0.copyload = load double, ptr addrspace(5) %n, align 8, !tbaa !48
  %agg.tmp12.sroa.2.0.copyload = load double, ptr addrspace(5) %40, align 8, !tbaa !48
  %agg.tmp12.sroa.3.0.copyload = load double, ptr addrspace(5) %41, align 8, !tbaa !48
  ...
  %retval.sroa.0.0.copyload.i = load double, ptr %call.i, align 8, !tbaa !48
  %retval.sroa.2.0.call.sroa_idx.i = getelementptr inbounds nuw i8, ptr %call.i, i64 8
  %retval.sroa.2.0.copyload.i = load double, ptr %retval.sroa.2.0.call.sroa_idx.i, align 8, !tbaa !48
  %retval.sroa.3.0.call.sroa_idx.i = getelementptr inbounds nuw i8, ptr %call.i, i64 16
  %retval.sroa.3.0.copyload.i = load double, ptr %retval.sroa.3.0.call.sroa_idx.i, align 8, !tbaa !48
...
define available_externally hidden noundef nonnull align 8 dereferenceable(24) ptr @_ZN6openmc8PositionmIES0_(ptr noundef nonnull returned align 8 captures(ret: address, provenance) dereferenceable(24) %this, double %other.coerce0, double %other.coerce1, double %other.coerce2) local_unnamed_addr #6 align 2 {
entry:
  %0 = load double, ptr %this, align 8, !tbaa !49
  %sub = fsub double %0, %other.coerce0
  store double %sub, ptr %this, align 8, !tbaa !49
  %y4 = getelementptr inbounds nuw i8, ptr %this, i64 8
  %1 = load double, ptr %y4, align 8, !tbaa !50
  %sub5 = fsub double %1, %other.coerce1
  store double %sub5, ptr %y4, align 8, !tbaa !50
  %z6 = getelementptr inbounds nuw i8, ptr %this, i64 16
  %2 = load double, ptr %z6, align 8, !tbaa !51
  %sub7 = fsub double %2, %other.coerce2
  store double %sub7, ptr %z6, align 8, !tbaa !51
  ret ptr %this
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite)
define available_externally hidden noundef nonnull align 8 dereferenceable(24) ptr @_ZN6openmc8PositionmLEd(ptr noundef nonnull returned align 8 captures(ret: address, provenance) dereferenceable(24) %this, double noundef %v) local_unnamed_addr #6 align 2 {
entry:
  %0 = load double, ptr %this, align 8, !tbaa !49
  %mul = fmul double %v, %0
  store double %mul, ptr %this, align 8, !tbaa !49
  %y = getelementptr inbounds nuw i8, ptr %this, i64 8
  %1 = load double, ptr %y, align 8, !tbaa !50
  %mul2 = fmul double %v, %1
  store double %mul2, ptr %y, align 8, !tbaa !50
  %z = getelementptr inbounds nuw i8, ptr %this, i64 16
  %2 = load double, ptr %z, align 8, !tbaa !51
  %mul3 = fmul double %v, %2
  store double %mul3, ptr %z, align 8, !tbaa !51
  ret ptr %this
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite)
define available_externally hidden noundef nonnull align 8 dereferenceable(24) ptr @_ZN6openmc8PositiondVEd(ptr noundef nonnull returned align 8 captures(ret: address, provenance) dereferenceable(24) %this, double noundef %v) local_unnamed_addr #6 align 2 {
entry:
  %0 = load double, ptr %this, align 8, !tbaa !49
  %div = fdiv double %0, %v
  store double %div, ptr %this, align 8, !tbaa !49
  %y = getelementptr inbounds nuw i8, ptr %this, i64 8
  %1 = load double, ptr %y, align 8, !tbaa !50
  %div2 = fdiv double %1, %v
  store double %div2, ptr %y, align 8, !tbaa !50
  %z = getelementptr inbounds nuw i8, ptr %this, i64 16
  %2 = load double, ptr %z, align 8, !tbaa !51
  %div3 = fdiv double %2, %v
  store double %div3, ptr %z, align 8, !tbaa !51
  ret ptr %this
}
...
entry:
  %0 = load i64, ptr %seed, align 8, !tbaa !52
  %mul = mul i64 %0, 2806196910506780709
  %add = add i64 %mul, 1
  %and = and i64 %add, 9223372036854775807
  store i64 %and, ptr %seed, align 8, !tbaa !52
...
!opencl.ocl.version = !{!14, !14, !14}
!llvm.ident = !{!15, !16, !15, !16, !15, !16}
