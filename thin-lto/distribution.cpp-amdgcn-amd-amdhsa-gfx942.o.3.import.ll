; ModuleID = 'distribution.cpp-amdgcn-amd-amdhsa-gfx942.o.3.import.bc'
...
define internal void @_ZN6openmc11TabularFlatC2EPKh(ptr noundef nonnull writeonly align 8 captures(none) dereferenceable(16) initializes((0, 16)) %this, ptr noundef %data) unnamed_addr #2 align 2 {
entry:
...
entry:
  ...
  %this.val25 = load i64, ptr %0, align 8, !tbaa !25
...
for.body:                                         ; preds = %for.cond, %entry
  ...
  br i1 %cmp9, label %for.cond, label %for.body.for.end_crit_edge, !llvm.loop !28

for.body.for.end_crit_edge:                       ; preds = %for.body
  %3 = add nuw i64 %conv55, 1
  br label %for.end, !llvm.loop !28
...
if.else39:                                        ; preds = %if.else24
  ...
  %9 = tail call noundef double @llvm.sqrt.f64(double %.sroa.speculated) #5
...
entry:
  %0 = load i64, ptr %seed, align 8, !tbaa !30
  %mul = mul i64 %0, 2806196910506780709
  %add = add i64 %mul, 1
  %and = and i64 %add, 9223372036854775807
  store i64 %and, ptr %seed, align 8, !tbaa !30
