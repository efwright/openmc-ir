; ModuleID = 'secondary_nbody.cpp-amdgcn-amd-amdhsa-gfx942.o.3.import.bc'
...
entry:
  ...
  store double %0, ptr %mu, align 8, !tbaa !16
  %this.val = load ptr, ptr %this, align 8, !tbaa !20
  %1 = getelementptr i8, ptr %this.val, i64 8
  %this.val.val = load double, ptr %1, align 8, !tbaa !16
  %2 = getelementptr i8, ptr %this.val, i64 16
  %this.val20.val = load double, ptr %2, align 8, !tbaa !16
  %3 = getelementptr i8, ptr %this.val, i64 24
  %this.val22.val = load double, ptr %3, align 8, !tbaa !16
  %call7 = tail call double @maxwell_spectrum(double noundef 1.000000e+00, ptr noundef %seed) #5
  %this.val23 = load ptr, ptr %this, align 8, !tbaa !20
  %4 = getelementptr i8, ptr %this.val23, i64 4
  %this.val23.val = load i32, ptr %4, align 4, !tbaa !24
...
sw.bb:                                            ; preds = %entry
  %call9 = tail call double @maxwell_spectrum(double noundef 1.000000e+00, ptr noundef %seed) #5
  br label %sw.epilog

sw.bb10:                                          ; preds = %entry
  %call11 = tail call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #5
  %call12 = tail call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #5
  %call13 = tail call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #5
...
sw.bb17:                                          ; preds = %entry
  %call18 = tail call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #5
  %call19 = tail call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #5
  %call20 = tail call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #5
  %call21 = tail call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #5
  %call22 = tail call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #5
  ...
  %251 = tail call double @llvm.fabs.f64(double %mul30) #6
...
__ocml_cos_f64.exit:                              ; preds = %272, %253
  ...
  %393 = tail call double @llvm.fabs.f64(double %390) #6
  ...
  %513 = fneg double %512
  %514 = tail call double @llvm.fma.f64(double %392, double %509, double %513) #6
  %515 = tail call double @llvm.fma.f64(double %392, double %511, double %514) #6
  %516 = fadd double %512, %515
  %517 = fsub double %516, %512
  %518 = fsub double %515, %517
  %519 = tail call double @llvm.fabs.f64(double %512) #6
  %520 = fcmp oeq double %519, 0x7FF0000000000000
  %521 = select i1 %520, double %512, double %516
  %522 = tail call double @llvm.fabs.f64(double %521) #6
  ...
  %547 = tail call double @llvm.fma.f64(double %546, double %524, double %546) #6
  %548 = tail call double @llvm.fabs.f64(double %546) #6
  %549 = fcmp oeq double %548, 0x7FF0000000000000
  %550 = select i1 %549, double %546, double %547
  %551 = tail call double @llvm.trunc.f64(double %392) #6
  %552 = fcmp oeq double %551, %392
  %553 = fmul double %392, 5.000000e-01
  %554 = tail call double @llvm.trunc.f64(double %553) #6
  %555 = fcmp une double %554, %553
  %556 = and i1 %552, %555
  %557 = select i1 %556, double %390, double 1.000000e+00
  %558 = tail call double @llvm.copysign.f64(double %550, double %557) #6
  ...
  %567 = tail call double @llvm.copysign.f64(double %565, double %566) #6
...
sw.epilog:                                        ; preds = %__ocml_cos_f64.exit, %sw.bb10, %sw.bb, %entry
  ...
  store double %mul36, ptr %E_out, align 8, !tbaa !16
  ret void
}
...
define available_externally hidden noundef double @_ZN6openmc3prnEPm(ptr noundef captures(none) %seed) local_unnamed_addr #4 {
entry:
...
!19 = !{!"Simple C++ TBAA"}
!20 = !{!21, !22, i64 0}
!21 = !{!"_ZTSN6openmc19NBodyPhaseSpaceFlatE", !22, i64 0}
