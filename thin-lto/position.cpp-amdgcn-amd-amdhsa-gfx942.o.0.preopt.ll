; ModuleID = 'position.cpp-amdgcn-amd-amdhsa-gfx942.o.0.preopt.bc'
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite)
define hidden noundef nonnull align 8 dereferenceable(24) ptr @_ZN6openmc8PositionpLEd(ptr noundef nonnull returned align 8 captures(ret: address, provenance) dereferenceable(24) %this, double noundef %v) local_unnamed_addr #0 align 2 {
entry:
  %0 = load double, ptr %this, align 8, !tbaa !9
  %add = fadd double %v, %0
  store double %add, ptr %this, align 8, !tbaa !9
  ...
  %add2 = fadd double %v, %1
  store double %add2, ptr %y, align 8, !tbaa !14
  %z = getelementptr inbounds nuw i8, ptr %this, i64 16
  %2 = load double, ptr %z, align 8, !tbaa !15
  %add3 = fadd double %v, %2
  store double %add3, ptr %z, align 8, !tbaa !15
  ret ptr %this
}
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite)
define hidden noundef nonnull align 8 dereferenceable(24) ptr @_ZN6openmc8PositionmIEd(ptr noundef nonnull returned align 8 captures(ret: address, provenance) dereferenceable(24) %this, double noundef %v) local_unnamed_addr #0 align 2 {
entry:
  %0 = load double, ptr %this, align 8, !tbaa !9
  %sub = fsub double %0, %v
  store double %sub, ptr %this, align 8, !tbaa !9
  %y = getelementptr inbounds nuw i8, ptr %this, i64 8
  %1 = load double, ptr %y, align 8, !tbaa !14
  %sub2 = fsub double %1, %v
  store double %sub2, ptr %y, align 8, !tbaa !14
  %z = getelementptr inbounds nuw i8, ptr %this, i64 16
  %2 = load double, ptr %z, align 8, !tbaa !15
  %sub3 = fsub double %2, %v
  store double %sub3, ptr %z, align 8, !tbaa !15
  ret ptr %this
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite)
define hidden noundef nonnull align 8 dereferenceable(24) ptr @_ZN6openmc8PositionmLES0_(ptr noundef nonnull returned align 8 captures(ret: address, provenance) dereferenceable(24) %this, double %other.coerce0, double %other.coerce1, double %other.coerce2) local_unnamed_addr #0 align 2 {
entry:
  %0 = load double, ptr %this, align 8, !tbaa !9
  %mul = fmul double %other.coerce0, %0
  store double %mul, ptr %this, align 8, !tbaa !9
  %y4 = getelementptr inbounds nuw i8, ptr %this, i64 8
  %1 = load double, ptr %y4, align 8, !tbaa !14
  %mul5 = fmul double %other.coerce1, %1
  store double %mul5, ptr %y4, align 8, !tbaa !14
  %z6 = getelementptr inbounds nuw i8, ptr %this, i64 16
  %2 = load double, ptr %z6, align 8, !tbaa !15
  %mul7 = fmul double %other.coerce2, %2
  store double %mul7, ptr %z6, align 8, !tbaa !15
  ret ptr %this
}
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite)
define hidden noundef nonnull align 8 dereferenceable(24) ptr @_ZN6openmc8PositiondVES0_(ptr noundef nonnull returned align 8 captures(ret: address, provenance) dereferenceable(24) %this, double %other.coerce0, double %other.coerce1, double %other.coerce2) local_unnamed_addr #0 align 2 {
entry:
  %0 = load double, ptr %this, align 8, !tbaa !9
  %div = fdiv double %0, %other.coerce0
  store double %div, ptr %this, align 8, !tbaa !9
  %y4 = getelementptr inbounds nuw i8, ptr %this, i64 8
  %1 = load double, ptr %y4, align 8, !tbaa !14
  %div5 = fdiv double %1, %other.coerce1
  store double %div5, ptr %y4, align 8, !tbaa !14
  %z6 = getelementptr inbounds nuw i8, ptr %this, i64 16
  %2 = load double, ptr %z6, align 8, !tbaa !15
  %div7 = fdiv double %2, %other.coerce2
  store double %div7, ptr %z6, align 8, !tbaa !15
  ret ptr %this
}
