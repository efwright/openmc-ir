; ModuleID = 'secondary_correlated.cpp-amdgcn-amd-amdhsa-gfx942.o.3.import.bc'
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite)
define internal void @_ZN6openmc25CorrelatedAngleEnergyFlatC2EPKh(ptr noundef nonnull writeonly align 8 captures(none) dereferenceable(24) initializes((0, 24)) %this, ptr noundef %data) unnamed_addr #3 align 2 {
entry:
...
if.end22:                                         ; preds = %_ZN6openmc17lower_bound_indexIPKddEENSt15iterator_traitsIT_E15difference_typeES4_S4_RKT0_.internalized.exit, %if.then7, %entry
  ...
  %16 = load i32, ptr %arrayidx.i144, align 4, !tbaa !23
  ...
  %17 = load i64, ptr %add.ptr.i.i145, align 8, !tbaa !26
  ...
  %18 = load double, ptr %arrayidx.i156, align 8, !tbaa !28
  %sub34 = shl i64 %17, 32
  ...
  %20 = load double, ptr %arrayidx.i157, align 8, !tbaa !28
  %arrayidx.i166 = getelementptr i8, ptr %arrayidx.i144, i64 4
  %21 = load i32, ptr %arrayidx.i166, align 4, !tbaa !23
  ...
  %22 = load i64, ptr %add.ptr.i.i169, align 8, !tbaa !26
  ...
  %23 = load double, ptr %arrayidx.i180, align 8, !tbaa !28
  %sub46 = shl i64 %22, 32
  ...
  %25 = load double, ptr %arrayidx.i181, align 8, !tbaa !28
  ...
  %29 = load double, ptr %add.ptr4.i194, align 8, !tbaa !28
...
for.body:                                         ; preds = %for.inc, %for.body.preheader
  ...
  %31 = load double, ptr %arrayidx.i203, align 8, !tbaa !28
...
for.body75:                                       ; preds = %for.cond72, %cleanup
  ...
  %32 = load double, ptr %arrayidx.i204, align 8, !tbaa !28
...
cleanup85:                                        ; preds = %for.body75.cleanup85_crit_edge, %for.cond72, %cleanup
  ...
  %33 = load double, ptr %arrayidx.i205, align 8, !tbaa !28
  %arrayidx.i206 = getelementptr inbounds nuw double, ptr %add.ptr4.i188, i64 %conv87
  %34 = load double, ptr %arrayidx.i206, align 8, !tbaa !28
  %35 = getelementptr i8, ptr %cond55.val121.sroa.speculated, i64 4
  %cond55.val127.val = load i32, ptr %35, align 4, !tbaa !23
...
if.then105:                                       ; preds = %cleanup85
  ...
  %36 = load double, ptr %arrayidx.i207, align 8, !tbaa !28
  %arrayidx.i208 = getelementptr inbounds nuw double, ptr %add.ptr4.i188, i64 %conv107
  %37 = load double, ptr %arrayidx.i208, align 8, !tbaa !28
...
if.else120:                                       ; preds = %if.then105
  ...
  %39 = tail call noundef double @llvm.sqrt.f64(double %.sroa.speculated) #7
...
if.then134:                                       ; preds = %if.end132
  %40 = load double, ptr %E_out, align 8, !tbaa !28
...
if.then154:                                       ; preds = %if.end150
  call void @llvm.lifetime.start.p5(i64 16, ptr addrspace(5) %ref.tmp155) #8
  ...
  %41 = load i32, ptr %arrayidx.i213, align 4, !tbaa !23
  %conv.i214 = sext i32 %41 to i64
  %add.ptr6.i215 = getelementptr inbounds nuw i8, ptr %cond55.val121.sroa.speculated, i64 %conv.i214
  call void @_ZN6openmc11TabularFlatC1EPKh(ptr noundef nonnull align 8 dereferenceable(16) %retval.ascast.i, ptr noundef nonnull %add.ptr6.i215) #6
  ...
  %call158 = call noundef double @_ZNK6openmc11TabularFlat6sampleEPm(ptr noundef nonnull align 8 dereferenceable(16) %ref.tmp155.ascast, ptr noundef %seed) #6
  call void @llvm.lifetime.end.p5(i64 16, ptr addrspace(5) %ref.tmp155) #8
  br label %if.end165

if.else159:                                       ; preds = %if.end150
  call void @llvm.lifetime.start.p5(i64 16, ptr addrspace(5) %ref.tmp160) #8
  ...
  %43 = load i32, ptr %arrayidx.i223, align 4, !tbaa !23
  %conv.i224 = sext i32 %43 to i64
  %add.ptr6.i225 = getelementptr inbounds nuw i8, ptr %cond55.val121.sroa.speculated, i64 %conv.i224
  call void @_ZN6openmc11TabularFlatC1EPKh(ptr noundef nonnull align 8 dereferenceable(16) %retval.ascast.i219, ptr noundef nonnull %add.ptr6.i225) #6
  ...
  %call164 = call noundef double @_ZNK6openmc11TabularFlat6sampleEPm(ptr noundef nonnull align 8 dereferenceable(16) %ref.tmp160.ascast, ptr noundef %seed) #6
  call void @llvm.lifetime.end.p5(i64 16, ptr addrspace(5) %ref.tmp160) #8
  br label %if.end165
...
entry:
  ...
  %this.val25 = load i64, ptr %0, align 8, !tbaa !36
  ...
  %1 = load double, ptr %add.ptr2.i43, align 8, !tbaa !28
...
for.body:                                         ; preds = %for.cond, %entry
  ...
  %2 = load double, ptr %arrayidx.i, align 8, !tbaa !28
  %cmp9 = fcmp ugt double %call, %2
  br i1 %cmp9, label %for.cond, label %for.body.for.end_crit_edge, !llvm.loop !37

for.body.for.end_crit_edge:                       ; preds = %for.body
  %3 = add nuw i64 %conv55, 1
  br label %for.end, !llvm.loop !37
...
for.end:                                          ; preds = %for.body.for.end_crit_edge, %for.cond, %entry
  ...
  %4 = load double, ptr %arrayidx.i48, align 8, !tbaa !28
  %arrayidx.i49 = getelementptr inbounds nuw double, ptr %add.ptr2.i, i64 %conv.lcssa
  %5 = load double, ptr %arrayidx.i49, align 8, !tbaa !28
...
if.else24:                                        ; preds = %for.end
  ...
  %6 = load double, ptr %arrayidx.i50, align 8, !tbaa !28
  %arrayidx.i51 = getelementptr inbounds nuw double, ptr %add.ptr2.i, i64 %conv26
  %7 = load double, ptr %arrayidx.i51, align 8, !tbaa !28
...
if.else39:                                        ; preds = %if.else24
  ...
  %9 = tail call noundef double @llvm.sqrt.f64(double %.sroa.speculated) #7
...
entry:
  store ptr %data, ptr %this, align 8, !tbaa !34
  %add.ptr = getelementptr inbounds nuw i8, ptr %data, i64 4
  %0 = load i32, ptr %add.ptr, align 4, !tbaa !23
  %conv = sext i32 %0 to i64
  %n_ = getelementptr inbounds nuw i8, ptr %this, i64 8
  store i64 %conv, ptr %n_, align 8, !tbaa !36
  ret void
}
...
!33 = distinct !{!33, !31}
!34 = !{!35, !18, i64 0}
!35 = !{!"_ZTSN6openmc11TabularFlatE", !18, i64 0, !22, i64 8}
!36 = !{!35, !22, i64 8}
!37 = distinct !{!37, !31}
