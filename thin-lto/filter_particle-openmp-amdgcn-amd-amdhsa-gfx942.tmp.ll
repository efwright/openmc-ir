; ModuleID = 'filter_particle-openmp-amdgcn-amd-amdhsa-gfx942.tmp.bc'
...
%"struct.openmc::BoundaryInfo" = type <{ double, i32, i32, %"struct.std::array.8", [4 x i8] }>
...
$_ZNK6openmc6vectorINS_8Particle4TypeEE4sizeEv = comdat any

$_ZNK6openmc6vectorINS_8Particle4TypeEEixEm = comdat any
...
define hidden void @_ZNK6openmc6Filter27ParticleFilter_get_all_binsERKNS_8ParticleENS_14TallyEstimatorERNS_11FilterMatchE(ptr noundef nonnull align 8 dereferenceable(448) %this, ptr noundef nonnull align 8 dereferenceable(2728) %p, i32 noundef %estimator, ptr noundef nonnull align 8 dereferenceable(1513) %match) #3 align 2 {
entry:
  ...
  store i32 %estimator, ptr %estimator.addr.ascast, align 4, !tbaa !27
  store ptr %match, ptr %match.addr.ascast, align 8, !tbaa !29
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %i) #6
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %particles_ = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 20
  %call = call noundef i64 @_ZNK6openmc6vectorINS_8Particle4TypeEE4sizeEv(ptr noundef nonnull align 8 dereferenceable(24) %particles_) #8
  %cmp = icmp ult i64 %conv, %call
  br i1 %cmp, label %for.body, label %for.cond.cleanup

for.cond.cleanup:                                 ; preds = %for.cond
  call void @llvm.lifetime.end.p5(i64 4, ptr addrspace(5) %i) #6
  br label %for.end

for.body:                                         ; preds = %for.cond
  %particles_2 = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 20
  %1 = load i32, ptr %i.ascast, align 4, !tbaa !18
  %conv3 = sext i32 %1 to i64
  %call4 = call noundef nonnull align 4 dereferenceable(4) ptr @_ZNK6openmc6vectorINS_8Particle4TypeEEixEm(ptr noundef nonnull align 8 dereferenceable(24) %particles_2, i64 noundef %conv3) #8
  %2 = load i32, ptr %call4, align 4, !tbaa !31
  %3 = load ptr, ptr %p.addr.ascast, align 8, !tbaa !25
  %type_ = getelementptr inbounds nuw %"class.openmc::Particle", ptr %3, i32 0, i32 4
  %4 = load i32, ptr %type_, align 8, !tbaa !33
  %cmp5 = icmp eq i32 %2, %4
  br i1 %cmp5, label %if.then, label %if.end

if.then:                                          ; preds = %for.body
  %5 = load ptr, ptr %match.addr.ascast, align 8, !tbaa !29
  %6 = load i32, ptr %i.ascast, align 4, !tbaa !18
  call void @_ZN6openmc11FilterMatch9push_backEid(ptr noundef nonnull align 8 dereferenceable(1513) %5, i32 noundef %6, double noundef 1.000000e+00) #8
  br label %if.end
...
for.inc:                                          ; preds = %if.end
  %7 = load i32, ptr %i.ascast, align 4, !tbaa !18
  %inc = add nsw i32 %7, 1
...
; Function Attrs: convergent mustprogress nounwind
define linkonce_odr hidden noundef i64 @_ZNK6openmc6vectorINS_8Particle4TypeEE4sizeEv(ptr noundef nonnull align 8 dereferenceable(24) %this) #3 comdat align 2 {
entry:
  ...
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  %size_ = getelementptr inbounds nuw %"class.openmc::vector.7", ptr %this1, i32 0, i32 1
  %0 = load i64, ptr %size_, align 8, !tbaa !52
  ret i64 %0
}

; Function Attrs: convergent mustprogress nounwind
define linkonce_odr hidden noundef nonnull align 4 dereferenceable(4) ptr @_ZNK6openmc6vectorINS_8Particle4TypeEEixEm(ptr noundef nonnull align 8 dereferenceable(24) %this, i64 noundef %pos) #3 comdat align 2 {
entry:
  ...
  store ptr %this, ptr %this.addr.ascast, align 8, !tbaa !50
  store i64 %pos, ptr %pos.addr.ascast, align 8, !tbaa !54
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  %data_ = getelementptr inbounds nuw %"class.openmc::vector.7", ptr %this1, i32 0, i32 0
  %0 = load ptr, ptr %data_, align 8, !tbaa !55
  %1 = load i64, ptr %pos.addr.ascast, align 8, !tbaa !54
...
entry:
  ...
  store i32 %bin, ptr %bin.addr.ascast, align 4, !tbaa !18
  store double %weight, ptr %weight.addr.ascast, align 8, !tbaa !14
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  %call = call noundef zeroext i1 @_ZN6openmc11FilterMatch7is_fullEv(ptr noundef nonnull align 8 dereferenceable(1513) %this1) #8
  br i1 %call, label %if.end, label %if.then

if.then:                                          ; preds = %entry
  %0 = load i32, ptr %bin.addr.ascast, align 4, !tbaa !18
  ...
  %2 = load double, ptr %weight.addr.ascast, align 8, !tbaa !14
  ...
  store double %2, ptr %arrayidx4, align 8, !tbaa !14
...
!21 = !{!"float", !16, i64 0}
!22 = !{!23, !23, i64 0}
!23 = !{!"p1 _ZTSN6openmc6FilterE", !24, i64 0}
!24 = !{!"any pointer", !16, i64 0}
!25 = !{!26, !26, i64 0}
!26 = !{!"p1 _ZTSN6openmc8ParticleE", !24, i64 0}
!27 = !{!28, !28, i64 0}
!28 = !{!"_ZTSN6openmc14TallyEstimatorE", !16, i64 0}
!29 = !{!30, !30, i64 0}
!30 = !{!"p1 _ZTSN6openmc11FilterMatchE", !24, i64 0}
!31 = !{!32, !32, i64 0}
!32 = !{!"_ZTSN6openmc8Particle4TypeE", !16, i64 0}
!33 = !{!34, !32, i64 872}
!34 = !{!"_ZTSN6openmc8ParticleE", !35, i64 0, !16, i64 168, !36, i64 744, !37, i64 864, !32, i64 872, !19, i64 876, !19, i64 880, !16, i64 888, !19, i64 1368, !16, i64 1372, !15, i64 1400, !15, i64 1408, !19, i64 1416, !19, i64 1420, !15, i64 1424, !15, i64 1432, !38, i64 1440, !38, i64 1464, !38, i64 1488, !15, i64 1512, !39, i64 1520, !40, i64 1524, !19, i64 1528, !19, i64 1532, !19, i64 1536, !19, i64 1540, !19, i64 1544, !15, i64 1552, !16, i64 1560, !19, i64 1592, !19, i64 1596, !19, i64 1600, !19, i64 1604, !41, i64 1608, !15, i64 1640, !15, i64 1648, !19, i64 1656, !39, i64 1660, !16, i64 1664, !19, i64 1728, !16, i64 1736, !37, i64 2216, !37, i64 2224, !16, i64 2232, !30, i64 2240, !43, i64 2248, !16, i64 2272, !15, i64 2656, !15, i64 2664, !15, i64 2672, !15, i64 2680, !39, i64 2688, !15, i64 2696, !15, i64 2704, !19, i64 2712, !37, i64 2720}
!35 = !{!"_ZTSN6openmc19NuclideMicroXSCacheE", !16, i64 0}
!36 = !{!"_ZTSN6openmc7MacroXSE", !15, i64 0, !15, i64 8, !15, i64 16, !15, i64 24, !15, i64 32, !16, i64 40, !15, i64 88, !15, i64 96, !15, i64 104, !15, i64 112}
!37 = !{!"long", !16, i64 0}
!38 = !{!"_ZTSN6openmc8PositionE", !15, i64 0, !15, i64 8, !15, i64 16}
!39 = !{!"bool", !16, i64 0}
!40 = !{!"_ZTSN6openmc10TallyEventE", !16, i64 0}
!41 = !{!"_ZTSN6openmc12BoundaryInfoE", !15, i64 0, !19, i64 8, !19, i64 12, !42, i64 16}
!42 = !{!"_ZTSSt5arrayIiLm3EE", !16, i64 0}
...
!47 = !{!"p1 _ZTSSt6vectorIN6openmc8PositionESaIS1_EE", !24, i64 0}
!48 = distinct !{!48, !49}
!49 = !{!"llvm.loop.mustprogress"}
!50 = !{!51, !51, i64 0}
!51 = !{!"p1 _ZTSN6openmc6vectorINS_8Particle4TypeEEE", !24, i64 0}
!52 = !{!53, !37, i64 8}
!53 = !{!"_ZTSN6openmc6vectorINS_8Particle4TypeEEE", !24, i64 0, !37, i64 8, !37, i64 16}
!54 = !{!37, !37, i64 0}
!55 = !{!53, !24, i64 0}
!56 = !{!57, !19, i64 1504}
!57 = !{!"_ZTSN6openmc11FilterMatchE", !16, i64 0, !16, i64 504, !19, i64 1504, !19, i64 1508, !39, i64 1512}
!58 = !{!59, !59, i64 0}
!59 = !{!"bool", !60, i64 0}
