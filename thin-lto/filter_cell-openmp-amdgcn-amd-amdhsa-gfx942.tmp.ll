; ModuleID = 'filter_cell-openmp-amdgcn-amd-amdhsa-gfx942.tmp.bc'
source_filename = "/g/g0/wright117/workspace/openmc/openmc-omp/openmc/src/tallies/filter_cell.cpp"
...
define hidden void @_ZNK6openmc6Filter23CellFilter_get_all_binsERKNS_8ParticleENS_14TallyEstimatorERNS_11FilterMatchE(ptr noundef nonnull align 8 dereferenceable(448) %this, ptr noundef nonnull align 8 dereferenceable(2728) %p, i32 noundef %estimator, ptr noundef nonnull align 8 dereferenceable(1513) %match) #3 align 2 {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = load i32, ptr %i.ascast, align 4, !tbaa !18
  ...
  %5 = load i32, ptr %cell, align 8, !tbaa !47
  %call = call noundef ptr @_ZNK6openmc10static_mapIiiNS_12integer_hashIiEEE4findEi(ptr noundef nonnull align 8 dereferenceable(50) %map_, i32 noundef %5) #10
  store ptr %call, ptr %search.ascast, align 8, !tbaa !49
  %6 = load ptr, ptr %search.ascast, align 8, !tbaa !49
  %map_2 = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 6
  %call3 = call noundef ptr @_ZNK6openmc10static_mapIiiNS_12integer_hashIiEEE3endEv(ptr noundef nonnull align 8 dereferenceable(50) %map_2) #10
  %cmp4 = icmp ne ptr %6, %call3
  br i1 %cmp4, label %if.then, label %if.end

if.then:                                          ; preds = %for.body
  %7 = load ptr, ptr %match.addr.ascast, align 8, !tbaa !29
  %8 = load ptr, ptr %search.ascast, align 8, !tbaa !49
  %second = getelementptr inbounds nuw %"struct.std::pair", ptr %8, i32 0, i32 1
  %9 = load i32, ptr %second, align 4, !tbaa !51
  call void @_ZN6openmc11FilterMatch9push_backEid(ptr noundef nonnull align 8 dereferenceable(1513) %7, i32 noundef %9, double noundef 1.000000e+00) #10
  br label %if.end
...
entry:
  ...
  %call = call noundef i64 @_ZNK6openmc10static_mapIiiNS_12integer_hashIiEEE12bucket_indexERKi(ptr noundef nonnull align 8 dereferenceable(50) %this1, ptr noundef nonnull align 4 dereferenceable(4) %key.addr.ascast) #10
  store i64 %call, ptr %idx.ascast, align 8, !tbaa !57
  ...
  %0 = load i64, ptr %idx.ascast, align 8, !tbaa !57
  %call2 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNK6openmc6vectorISt4pairImmEEixEm(ptr noundef nonnull align 8 dereferenceable(24) %buckets_, i64 noundef %0) #10
  ...
  %call3 = call noundef ptr @_ZNK6openmc6vectorISt4pairIiiEE5beginEv(ptr noundef nonnull align 8 dereferenceable(24) %items_) #10
  %second = getelementptr inbounds nuw %"struct.std::pair.9", ptr %bounds.ascast, i32 0, i32 1
  %1 = load i64, ptr %second, align 8, !tbaa !58
  %add.ptr = getelementptr inbounds nuw %"struct.std::pair", ptr %call3, i64 %1
  store ptr %add.ptr, ptr %last.ascast, align 8, !tbaa !49
  ...
  %call5 = call noundef ptr @_ZNK6openmc6vectorISt4pairIiiEE5beginEv(ptr noundef nonnull align 8 dereferenceable(24) %items_4) #10
  %first = getelementptr inbounds nuw %"struct.std::pair.9", ptr %bounds.ascast, i32 0, i32 0
  %2 = load i64, ptr %first, align 8, !tbaa !60
  %add.ptr6 = getelementptr inbounds nuw %"struct.std::pair", ptr %call5, i64 %2
  store ptr %add.ptr6, ptr %iter.ascast, align 8, !tbaa !49
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %3 = load ptr, ptr %iter.ascast, align 8, !tbaa !49
  %4 = load ptr, ptr %last.ascast, align 8, !tbaa !49
  %cmp = icmp ne ptr %3, %4
  br i1 %cmp, label %for.body, label %for.cond.cleanup
...
for.body:                                         ; preds = %for.cond
  ...
  %6 = load ptr, ptr %iter.ascast, align 8, !tbaa !49
  %first7 = getelementptr inbounds nuw %"struct.std::pair", ptr %6, i32 0, i32 0
  %7 = load i32, ptr %first7, align 4, !tbaa !61
  %cmp8 = icmp eq i32 %5, %7
  br i1 %cmp8, label %if.then, label %if.end

if.then:                                          ; preds = %for.body
  %8 = load ptr, ptr %iter.ascast, align 8, !tbaa !49
...
for.inc:                                          ; preds = %if.end
  %9 = load ptr, ptr %iter.ascast, align 8, !tbaa !49
  %incdec.ptr = getelementptr inbounds nuw %"struct.std::pair", ptr %9, i32 1
  store ptr %incdec.ptr, ptr %iter.ascast, align 8, !tbaa !49
...
for.end:                                          ; preds = %cleanup
  ...
  %call10 = call noundef ptr @_ZNK6openmc6vectorISt4pairIiiEE3endEv(ptr noundef nonnull align 8 dereferenceable(24) %items_9) #10
...
entry:
  ...
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  %items_ = getelementptr inbounds nuw %"class.openmc::static_map", ptr %this1, i32 0, i32 0
  %call = call noundef ptr @_ZNK6openmc6vectorISt4pairIiiEE3endEv(ptr noundef nonnull align 8 dereferenceable(24) %items_) #10
  ret ptr %call
}
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i32, ptr %bins_weights_length_, align 8, !tbaa !63
  ...
  %3 = load i32, ptr %bins_weights_length_2, align 8, !tbaa !63
  ...
  %4 = load i32, ptr %bins_weights_length_5, align 8, !tbaa !63
  %inc = add nsw i32 %4, 1
  store i32 %inc, ptr %bins_weights_length_5, align 8, !tbaa !63
  br label %if.end
...
entry:
  ...
  %key.addr.ascast = addrspacecast ptr addrspace(5) %key.addr to ptr
  store ptr %this, ptr %this.addr.ascast, align 8, !tbaa !55
  store ptr %key, ptr %key.addr.ascast, align 8, !tbaa !65
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  %0 = getelementptr inbounds i8, ptr %this1, i64 49
  %1 = load ptr, ptr %key.addr.ascast, align 8, !tbaa !65
  %2 = load i32, ptr %1, align 4, !tbaa !18
  %call = call noundef i64 @_ZNK6openmc12integer_hashIiEclEi(ptr noundef nonnull align 1 dereferenceable(1) %0, i32 noundef %2) #10
  %call2 = call noundef i64 @_ZNK6openmc10static_mapIiiNS_12integer_hashIiEEE12bucket_countEv(ptr noundef nonnull align 8 dereferenceable(50) %this1) #10
...
entry:
  ...
  store i64 %pos, ptr %pos.addr.ascast, align 8, !tbaa !57
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  %data_ = getelementptr inbounds nuw %"class.openmc::vector.3", ptr %this1, i32 0, i32 0
  %0 = load ptr, ptr %data_, align 8, !tbaa !69
  %1 = load i64, ptr %pos.addr.ascast, align 8, !tbaa !57
...
entry:
  ...
  %0 = load ptr, ptr %data_, align 8, !tbaa !74
  ret ptr %0
}
...
entry:
  ...
  %0 = load i64, ptr %size_, align 8, !tbaa !79
  ret i64 %0
}
...
entry:
  ...
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  %bins_weights_length_ = getelementptr inbounds nuw %"class.openmc::FilterMatch", ptr %this1, i32 0, i32 3
  %0 = load i32, ptr %bins_weights_length_, align 8, !tbaa !63
...
define internal double @__ocml_logb_f64(double noundef %0) #6 {
  ...
  %5 = load i8, ptr addrspace(4) @__oclc_finite_only_opt, align 1, !tbaa !80, !range !84, !noundef !85
  %6 = icmp eq i8 %5, 0
...
!49 = !{!50, !50, i64 0}
!50 = !{!"p1 _ZTSSt4pairIiiE", !24, i64 0}
!51 = !{!52, !19, i64 4}
!52 = !{!"_ZTSSt4pairIiiE", !19, i64 0, !19, i64 4}
!53 = distinct !{!53, !54}
!54 = !{!"llvm.loop.mustprogress"}
!55 = !{!56, !56, i64 0}
!56 = !{!"p1 _ZTSN6openmc10static_mapIiiNS_12integer_hashIiEEEE", !24, i64 0}
!57 = !{!35, !35, i64 0}
!58 = !{!59, !35, i64 8}
!59 = !{!"_ZTSSt4pairImmE", !35, i64 0, !35, i64 8}
!60 = !{!59, !35, i64 0}
!61 = !{!52, !19, i64 0}
!62 = distinct !{!62, !54}
!63 = !{!64, !19, i64 1504}
!64 = !{!"_ZTSN6openmc11FilterMatchE", !16, i64 0, !16, i64 504, !19, i64 1504, !19, i64 1508, !38, i64 1512}
!65 = !{!66, !66, i64 0}
!66 = !{!"p1 int", !24, i64 0}
!67 = !{!68, !68, i64 0}
!68 = !{!"p1 _ZTSN6openmc6vectorISt4pairImmEEE", !24, i64 0}
!69 = !{!70, !71, i64 0}
!70 = !{!"_ZTSN6openmc6vectorISt4pairImmEEE", !71, i64 0, !35, i64 8, !35, i64 16}
!71 = !{!"p1 _ZTSSt4pairImmE", !24, i64 0}
!72 = !{!73, !73, i64 0}
!73 = !{!"p1 _ZTSN6openmc6vectorISt4pairIiiEEE", !24, i64 0}
!74 = !{!75, !50, i64 0}
!75 = !{!"_ZTSN6openmc6vectorISt4pairIiiEEE", !50, i64 0, !35, i64 8, !35, i64 16}
!76 = !{!75, !35, i64 8}
!77 = !{!78, !78, i64 0}
!78 = !{!"p1 _ZTSN6openmc12integer_hashIiEE", !24, i64 0}
!79 = !{!70, !35, i64 8}
!80 = !{!81, !81, i64 0}
!81 = !{!"bool", !82, i64 0}
