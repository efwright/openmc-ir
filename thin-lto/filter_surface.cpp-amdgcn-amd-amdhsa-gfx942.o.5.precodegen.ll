; ModuleID = 'filter_surface.cpp-amdgcn-amd-amdhsa-gfx942.o.5.precodegen.bc'
...
define hidden void @_ZNK6openmc6Filter26SurfaceFilter_get_all_binsERKNS_8ParticleENS_14TallyEstimatorERNS_11FilterMatchE(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(448) %this, ptr noundef nonnull readonly align 8 captures(none) dereferenceable(2728) %p, i32 noundef %estimator, ptr noundef nonnull align 8 captures(none) dereferenceable(1513) %match) local_unnamed_addr #0 align 2 {
entry:
  %map_ = getelementptr inbounds nuw i8, ptr %this, i64 72
  %surface_ = getelementptr inbounds nuw i8, ptr %p, i64 1592
  %0 = load i32, ptr %surface_, align 8, !tbaa !15
  %1 = tail call noundef range(i32 0, -2147483648) i32 @llvm.abs.i32(i32 %0, i1 true) #2, !range !37
  %sub = add nsw i32 %1, -1
  %2 = getelementptr inbounds nuw i8, ptr %this, i64 104
  %this.val.i = load i64, ptr %2, align 8, !tbaa !38
  ...
  %buckets_.val.i = load ptr, ptr %buckets_.i, align 8, !tbaa !41
  %arrayidx.i.i = getelementptr inbounds nuw %"struct.std::pair.9", ptr %buckets_.val.i, i64 %rem.i.i
  %3 = load <2 x i64>, ptr %arrayidx.i.i, align 8
  %this.val1.i = load ptr, ptr %map_, align 8, !tbaa !42
  %4 = extractelement <2 x i64> %3, i64 1
  %add.ptr.i = getelementptr inbounds nuw %"struct.std::pair", ptr %this.val1.i, i64 %4
  %5 = extractelement <2 x i64> %3, i64 0
  %cmp.not6.i = icmp samesign eq i64 %5, %4
  br i1 %cmp.not6.i, label %for.end.i, label %for.body.preheader.i

for.body.preheader.i:                             ; preds = %entry
  %add.ptr6.i = getelementptr inbounds nuw %"struct.std::pair", ptr %this.val1.i, i64 %5
  br label %for.body.i

for.body.i:                                       ; preds = %for.inc.i, %for.body.preheader.i
  %iter.07.i = phi ptr [ %incdec.ptr.i, %for.inc.i ], [ %add.ptr6.i, %for.body.preheader.i ]
  %6 = load i32, ptr %iter.07.i, align 4, !tbaa !45
  %cmp8.i = icmp eq i32 %sub, %6
...
for.end.i:                                        ; preds = %for.inc.i, %entry
  ...
  %this.val4.i = load i64, ptr %7, align 8, !tbaa !49
...
_ZNK6openmc10static_mapIiiNS_12integer_hashIiEEE4findEi.internalized.exit.loopexit: ; preds = %for.body.i
  ...
  %map_.val5.pre = load i64, ptr %.phi.trans.insert, align 8, !tbaa !49
  br label %_ZNK6openmc10static_mapIiiNS_12integer_hashIiEEE4findEi.internalized.exit
...
if.then:                                          ; preds = %_ZNK6openmc10static_mapIiiNS_12integer_hashIiEEE4findEi.internalized.exit
  ...
  %this.val.i7 = load i32, ptr %8, align 8, !tbaa !50
...
!37 = !{i32 0, i32 -2147483648}
!38 = !{!39, !22, i64 8}
!39 = !{!"_ZTSN6openmc6vectorISt4pairImmEEE", !40, i64 0, !22, i64 8, !22, i64 16}
!40 = !{!"p1 _ZTSSt4pairImmE", !31, i64 0}
!41 = !{!39, !40, i64 0}
!42 = !{!43, !44, i64 0}
!43 = !{!"_ZTSN6openmc6vectorISt4pairIiiEEE", !44, i64 0, !22, i64 8, !22, i64 16}
!44 = !{!"p1 _ZTSSt4pairIiiE", !31, i64 0}
!45 = !{!46, !24, i64 0}
