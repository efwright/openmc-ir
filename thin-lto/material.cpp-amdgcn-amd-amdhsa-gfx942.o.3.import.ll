; ModuleID = 'material.cpp-amdgcn-amd-amdhsa-gfx942.o.3.import.bc'
...
for.body.i:                                       ; preds = %if.end.i, %for.body.lr.ph.i
  ...
  %99 = load ptr, ptr addrspace(1) @_ZN6openmc5model17materials_nuclideE, align 8, !tbaa !152
  %100 = load i64, ptr addrspace(1) getelementptr inbounds nuw (i8, ptr addrspace(1) @_ZN6openmc5model17materials_nuclideE, i64 24), align 8, !tbaa !153
  ...
  %102 = load i32, ptr %arrayidx.i.i.i, align 4, !tbaa !155
  %103 = load ptr, ptr addrspace(1) @_ZN6openmc4data8nuclidesE, align 8, !tbaa !156
  %idxprom.i = sext i32 %102 to i64
  %arrayidx.i = getelementptr inbounds %"class.openmc::Nuclide", ptr %103, i64 %idxprom.i
  %104 = load ptr, ptr addrspace(1) @_ZN6openmc5model9materialsE, align 8, !tbaa !158, !noalias !160
  %105 = load i32, ptr %material_.i.i, align 8, !tbaa !163, !noalias !160
  ...
  %thermal_tables_.val.i.i = load i64, ptr %106, align 8, !tbaa !164, !noalias !160
...
for.body.lr.ph.i.i:                               ; preds = %for.body.i
  ...
  %arrayidx.val.i.i = load i64, ptr %107, align 8, !tbaa !113, !noalias !160
  %108 = load ptr, ptr addrspace(1) @_ZN6openmc5model24materials_thermal_tablesE, align 8, !tbaa !165, !noalias !160
  %109 = load i64, ptr addrspace(1) getelementptr inbounds nuw (i8, ptr addrspace(1) @_ZN6openmc5model24materials_thermal_tablesE, i64 24), align 8, !tbaa !166, !noalias !160
  ...
  %111 = load i64, ptr %index_.i.i, align 8, !tbaa !168, !noalias !160
  %112 = load ptr, ptr addrspace(1) @_ZN6openmc4data20device_thermal_scattE, align 8, !noalias !160
...
for.cond.cleanup.i.i:                             ; preds = %if.end9.i.i, %for.body.i
  ...
  %this.val.i.i = load ptr, ptr %113, align 8, !tbaa !205, !noalias !160
...
if.then.i.i:                                      ; preds = %for.body.i.i
  ...
  %117 = load double, ptr %energy_max_.i.i, align 8, !tbaa !210, !noalias !160
...
if.then11.i.i:                                    ; preds = %for.cond.cleanup.i.i
  ...
  %118 = load double, ptr %E_min_.i.i, align 8, !tbaa !221, !noalias !160
...
land.rhs.i.i:                                     ; preds = %if.then11.i.i
  ...
  %119 = load double, ptr %E_max_.i.i, align 8, !tbaa !246, !noalias !160
...
if.then18.i.i:                                    ; preds = %if.end17.i.i
  call void @llvm.lifetime.start.p5(i64 24, ptr addrspace(5) %ref.tmp.i.i) #10, !noalias !160
  call void @_ZNK6openmc17WindowedMultipole8evaluateEdd(ptr addrspace(5) dead_on_unwind writable sret(%"class.std::tuple.99") align 8 %ref.tmp.i.i, ptr noundef nonnull align 8 dereferenceable(340) %this.val.i.i, double noundef %1, double noundef %2) #11, !noalias !160
  %120 = load double, ptr addrspace(5) %add.ptr.i.i.i.i.i, align 8, !tbaa !112, !noalias !160
  %121 = load double, ptr addrspace(5) %add.ptr.i.i.i.i.i.i, align 8, !tbaa !112, !noalias !160
  %__in.val.i.i.i.i.i = load double, ptr addrspace(5) %ref.tmp.i.i, align 8, !tbaa !112, !noalias !160
  call void @llvm.lifetime.end.p5(i64 24, ptr addrspace(5) %ref.tmp.i.i) #10, !noalias !160
  %add.i.i = fadd double %120, %121
  %fissionable_.i.i = getelementptr inbounds nuw i8, ptr %arrayidx.i, i64 192
  %122 = load i8, ptr %fissionable_.i.i, align 8, !tbaa !247, !range !248, !noalias !160, !noundef !249
...
cond.true.i.i:                                    ; preds = %if.then18.i.i
  %call23.i.i = call noundef double @_ZNK6openmc7Nuclide2nuEdNS_15ReactionProduct12EmissionModeEi(ptr noundef nonnull align 8 dereferenceable(7680) %arrayidx.i, double noundef %1, i32 noundef 2, i32 noundef 0) #11, !noalias !160
...
if.else.i.i:                                      ; preds = %if.end17.i.i
  %123 = load i32, ptr addrspace(1) @_ZN6openmc8settings18temperature_methodE, align 4, !tbaa !250, !noalias !160
...
for.cond48.preheader.i.i:                         ; preds = %if.else.i.i
  ...
  %kTs_50.val.i.i = load i64, ptr %124, align 8, !tbaa !252, !noalias !160
...
for.cond29.preheader.i.i:                         ; preds = %if.else.i.i
  ...
  %kTs_.val.i.i = load i64, ptr %127, align 8, !tbaa !252, !noalias !160
...
for.body35.i.i:                                   ; preds = %for.body35.i.i, %for.body35.lr.ph.i.i
  ...
  %128 = load double, ptr %arrayidx.i.i3.i, align 8, !tbaa !112, !noalias !160
  %sub39.i.i = fsub double %128, %mul28.i.i
  %129 = call noundef double @llvm.fabs.f64(double %sub39.i.i) #12
...
for.body54.i.i:                                   ; preds = %for.inc66.i.i, %for.body54.lr.ph.i.i
  ...
  %130 = load double, ptr %arrayidx.i24.i.i, align 8, !tbaa !112, !noalias !160
...
land.lhs.true.i.i:                                ; preds = %for.body54.i.i
  ...
  %131 = load double, ptr %gep.i.i, align 8, !tbaa !112, !noalias !160
...
for.end68.i.i:                                    ; preds = %for.end68.loopexit.split.loop.exit.i.i, %for.inc66.i.i, %for.cond48.preheader.i.i
  ...
  %132 = load double, ptr %arrayidx.i26.i.i, align 8, !tbaa !112, !noalias !160
  ...
  %133 = load double, ptr %arrayidx.i27.i.i, align 8, !tbaa !112, !noalias !160
  ...
  %134 = load i64, ptr %index_81.i.i, align 8, !tbaa !168, !noalias !160
  %135 = load i64, ptr %arrayidx82.i.i, align 8, !tbaa !256, !noalias !160
  %call83.i.i = call noundef double @_ZN6openmc10future_prnElm(i64 noundef %134, i64 noundef %135) #11, !noalias !160
...
sw.epilog.i.i:                                    ; preds = %for.end68.i.i, %for.body35.i.i, %for.cond29.preheader.i.i, %if.else.i.i
  ...
  %136 = load i32, ptr addrspace(1) @_ZN6openmc8settings10n_log_binsE, align 4, !tbaa !155, !noalias !160
  ...
  %137 = load ptr, ptr %flat_grid_index_.i.i, align 8, !tbaa !257, !noalias !160
  ...
  %138 = load ptr, ptr %flat_temp_offsets_.i.i, align 8, !tbaa !258, !noalias !160
  %idxprom93.i.i = sext i32 %i_temp.4.i.i to i64
  %arrayidx94.i.i = getelementptr inbounds i32, ptr %138, i64 %idxprom93.i.i
  %139 = load i32, ptr %arrayidx94.i.i, align 4, !tbaa !155, !noalias !160
  %flat_grid_energy_.i.i = getelementptr inbounds nuw i8, ptr %arrayidx.i, i64 160
  %140 = load ptr, ptr %flat_grid_energy_.i.i, align 8, !tbaa !259, !noalias !160
  ...
  %141 = load ptr, ptr %flat_xs_.i.i, align 8, !tbaa !260, !noalias !160
  ...
  %kTs_104.val.i.i = load i64, ptr %142, align 8, !tbaa !252, !noalias !160
  ...
  %143 = load double, ptr %arrayidx96.i.i, align 8, !tbaa !112, !noalias !160
...
if.else120.i.i:                                   ; preds = %sw.epilog.i.i
  ...
  %146 = load double, ptr %arrayidx123.i.i, align 8, !tbaa !112, !noalias !160
...
if.else127.i.i:                                   ; preds = %if.else120.i.i
  ...
  %147 = load i32, ptr %arrayidx129.i.i, align 4, !tbaa !155, !noalias !160
  %arrayidx132.i.i = getelementptr i8, ptr %arrayidx129.i.i, i64 4
  %148 = load i32, ptr %arrayidx132.i.i, align 4, !tbaa !155, !noalias !160
...
for.body137.i.i:                                  ; preds = %for.cond134.i.i
  ...
  %149 = load double, ptr %arrayidx140.i.i, align 8, !tbaa !112, !noalias !160
  %cmp141.i.i = fcmp olt double %1, %149
  br i1 %cmp141.i.i, label %if.end148.i.i, label %for.cond134.i.i, !llvm.loop !261
...
if.end148.i.i:                                    ; preds = %for.body137.i.i, %for.cond134.i.i, %if.then125.i.i, %sw.epilog.i.i
  ...
  %150 = load double, ptr %arrayidx150.i.i, align 8, !tbaa !112, !noalias !160
  ...
  %151 = load double, ptr %arrayidx153.i.i, align 8, !tbaa !112, !noalias !160
  ...
  %152 = load i32, ptr addrspace(1) @_ZN6openmc7Nuclide8XS_TOTALE, align 4, !tbaa !155, !noalias !160
  ...
  %153 = load double, ptr %arrayidx163.i.i, align 8, !tbaa !112, !noalias !160
  %154 = load i32, ptr addrspace(1) @_ZN6openmc7Nuclide13XS_ABSORPTIONE, align 4, !tbaa !155, !noalias !160
  ...
  %155 = load double, ptr %arrayidx166.i.i, align 8, !tbaa !112, !noalias !160
  %156 = load i32, ptr addrspace(1) @_ZN6openmc7Nuclide10XS_FISSIONE, align 4, !tbaa !155, !noalias !160
  ...
  %157 = load double, ptr %arrayidx169.i.i, align 8, !tbaa !112, !noalias !160
  %158 = load i32, ptr addrspace(1) @_ZN6openmc7Nuclide13XS_NU_FISSIONE, align 4, !tbaa !155, !noalias !160
  ...
  %159 = load double, ptr %arrayidx172.i.i, align 8, !tbaa !112, !noalias !160
  ...
  %160 = load double, ptr %arrayidx178.i.i, align 8, !tbaa !112, !noalias !160
  ...
  %161 = load double, ptr %arrayidx181.i.i, align 8, !tbaa !112, !noalias !160
  ...
  %162 = load double, ptr %arrayidx184.i.i, align 8, !tbaa !112, !noalias !160
  ...
  %163 = load double, ptr %arrayidx187.i.i, align 8, !tbaa !112, !noalias !160
  ...
  %164 = load double, ptr %arrayidx192.i.i, align 8, !tbaa !112, !noalias !160
  ...
  %165 = load double, ptr %arrayidx196.i.i, align 8, !tbaa !112, !noalias !160
...
for.cond214.preheader.i.i:                        ; preds = %if.end148.i.i
  ...
  %170 = load i64, ptr %arrayidx.i.i30.i.i, align 8, !tbaa !256, !noalias !160
...
if.then227.i.i:                                   ; preds = %for.cond214.preheader.i.i
  call void @llvm.lifetime.start.p5(i64 24, ptr addrspace(5) %ref.tmp228.i.i) #10, !noalias !160
  %conv229.i.i = and i64 %170, 2147483647
  %reactions_.val.i.i = load ptr, ptr %reactions_.i.i, align 8, !tbaa !262, !noalias !160
  %arrayidx.i31.i.i = getelementptr inbounds nuw %"class.openmc::ReactionFlatContainer", ptr %reactions_.val.i.i, i64 %conv229.i.i
  %call231.i.i = call %"class.openmc::ReactionFlat" @_ZNK6openmc21ReactionFlatContainer3objEv(ptr noundef nonnull align 8 dereferenceable(32) %arrayidx.i31.i.i) #11, !noalias !160
  %172 = extractvalue %"class.openmc::ReactionFlat" %call231.i.i, 0
  store ptr %172, ptr addrspace(5) %ref.tmp228.i.i, align 8, !noalias !160
  %173 = extractvalue %"class.openmc::ReactionFlat" %call231.i.i, 1
  store i64 %173, ptr addrspace(5) %91, align 8, !noalias !160
  %174 = extractvalue %"class.openmc::ReactionFlat" %call231.i.i, 2
  store i64 %174, ptr addrspace(5) %92, align 8, !noalias !160
  %call236.i.i = call noundef double @_ZNK6openmc12ReactionFlat2xsElld(ptr noundef nonnull align 8 dereferenceable(24) %ref.tmp228.ascast.i.i, i64 noundef %idxprom93.i.i, i64 noundef %idxprom191.i.i, double noundef %div200.i.i) #11, !noalias !160
  call void @llvm.lifetime.end.p5(i64 24, ptr addrspace(5) %ref.tmp228.i.i) #10, !noalias !160
...
for.inc259.i.i:                                   ; preds = %cleanup256.i.i, %cleanup256.i.i
  ...
  %175 = load i64, ptr %arrayidx.i.i30.1.i.i, align 8, !tbaa !256, !noalias !160
...
if.then227.1.i.i:                                 ; preds = %for.inc259.i.i
  ...
  %reactions_.val.1.i.i = load ptr, ptr %reactions_.i.i, align 8, !tbaa !262, !noalias !160
  ...
  %call231.1.i.i = call %"class.openmc::ReactionFlat" @_ZNK6openmc21ReactionFlatContainer3objEv(ptr noundef nonnull align 8 dereferenceable(32) %arrayidx.i31.1.i.i) #11, !noalias !160
  %177 = extractvalue %"class.openmc::ReactionFlat" %call231.1.i.i, 0
  store ptr %177, ptr addrspace(5) %ref.tmp228.i.i, align 8, !noalias !160
  %178 = extractvalue %"class.openmc::ReactionFlat" %call231.1.i.i, 1
  store i64 %178, ptr addrspace(5) %91, align 8, !noalias !160
  %179 = extractvalue %"class.openmc::ReactionFlat" %call231.1.i.i, 2
  store i64 %179, ptr addrspace(5) %92, align 8, !noalias !160
  %call240.1.i.i = call noundef i32 @_ZNK6openmc12ReactionFlat12xs_thresholdEl(ptr noundef nonnull align 8 dereferenceable(24) %ref.tmp228.ascast.i.i, i64 noundef %idxprom93.i.i) #11, !noalias !160
...
if.then242.1.i.i:                                 ; preds = %if.then227.1.i.i
  %call245.1.i.i = call noundef double @_ZNK6openmc12ReactionFlat2xsElld(ptr noundef nonnull align 8 dereferenceable(24) %ref.tmp228.ascast.i.i, i64 noundef %idxprom93.i.i, i64 noundef %idxprom191.i.i, double noundef %div200.i.i) #11, !noalias !160
...
for.inc259.1.i.i:                                 ; preds = %cleanup253.1.i.i, %for.inc259.i.i
  ...
  %180 = load i64, ptr %arrayidx.i.i30.2.i.i, align 8, !tbaa !256, !noalias !160
...
if.then227.2.i.i:                                 ; preds = %for.inc259.1.i.i
  ...
  %reactions_.val.2.i.i = load ptr, ptr %reactions_.i.i, align 8, !tbaa !262, !noalias !160
  ...
  %call231.2.i.i = call %"class.openmc::ReactionFlat" @_ZNK6openmc21ReactionFlatContainer3objEv(ptr noundef nonnull align 8 dereferenceable(32) %arrayidx.i31.2.i.i) #11, !noalias !160
  %182 = extractvalue %"class.openmc::ReactionFlat" %call231.2.i.i, 0
  store ptr %182, ptr addrspace(5) %ref.tmp228.i.i, align 8, !noalias !160
  %183 = extractvalue %"class.openmc::ReactionFlat" %call231.2.i.i, 1
  store i64 %183, ptr addrspace(5) %91, align 8, !noalias !160
  %184 = extractvalue %"class.openmc::ReactionFlat" %call231.2.i.i, 2
  store i64 %184, ptr addrspace(5) %92, align 8, !noalias !160
  %call240.2.i.i = call noundef i32 @_ZNK6openmc12ReactionFlat12xs_thresholdEl(ptr noundef nonnull align 8 dereferenceable(24) %ref.tmp228.ascast.i.i, i64 noundef %idxprom93.i.i) #11, !noalias !160
...
if.then242.2.i.i:                                 ; preds = %if.then227.2.i.i
  %call245.2.i.i = call noundef double @_ZNK6openmc12ReactionFlat2xsElld(ptr noundef nonnull align 8 dereferenceable(24) %ref.tmp228.ascast.i.i, i64 noundef %idxprom93.i.i, i64 noundef %idxprom191.i.i, double noundef %div200.i.i) #11, !noalias !160
...
for.inc259.2.i.i:                                 ; preds = %cleanup253.2.i.i, %for.inc259.1.i.i
  ...
  %185 = load i64, ptr %arrayidx.i.i30.3.i.i, align 8, !tbaa !256, !noalias !160
...
if.then227.3.i.i:                                 ; preds = %for.inc259.2.i.i
  ...
  %reactions_.val.3.i.i = load ptr, ptr %reactions_.i.i, align 8, !tbaa !262, !noalias !160
  ...
  %call231.3.i.i = call %"class.openmc::ReactionFlat" @_ZNK6openmc21ReactionFlatContainer3objEv(ptr noundef nonnull align 8 dereferenceable(32) %arrayidx.i31.3.i.i) #11, !noalias !160
  %187 = extractvalue %"class.openmc::ReactionFlat" %call231.3.i.i, 0
  store ptr %187, ptr addrspace(5) %ref.tmp228.i.i, align 8, !noalias !160
  %188 = extractvalue %"class.openmc::ReactionFlat" %call231.3.i.i, 1
  store i64 %188, ptr addrspace(5) %91, align 8, !noalias !160
  %189 = extractvalue %"class.openmc::ReactionFlat" %call231.3.i.i, 2
  store i64 %189, ptr addrspace(5) %92, align 8, !noalias !160
  %call240.3.i.i = call noundef i32 @_ZNK6openmc12ReactionFlat12xs_thresholdEl(ptr noundef nonnull align 8 dereferenceable(24) %ref.tmp228.ascast.i.i, i64 noundef %idxprom93.i.i) #11, !noalias !160
...
if.then242.3.i.i:                                 ; preds = %if.then227.3.i.i
  %call245.3.i.i = call noundef double @_ZNK6openmc12ReactionFlat2xsElld(ptr noundef nonnull align 8 dereferenceable(24) %ref.tmp228.ascast.i.i, i64 noundef %idxprom93.i.i, i64 noundef %idxprom191.i.i, double noundef %div200.i.i) #11, !noalias !160
...
for.inc259.3.i.i:                                 ; preds = %cleanup256.3.i.i
  ...
  %190 = load i64, ptr %arrayidx.i.i30.4.i.i, align 8, !tbaa !256, !noalias !160
...
if.then227.4.i.i:                                 ; preds = %for.inc259.3.i.i
  ...
  %reactions_.val.4.i.i = load ptr, ptr %reactions_.i.i, align 8, !tbaa !262, !noalias !160
  ...
  %call231.4.i.i = call %"class.openmc::ReactionFlat" @_ZNK6openmc21ReactionFlatContainer3objEv(ptr noundef nonnull align 8 dereferenceable(32) %arrayidx.i31.4.i.i) #11, !noalias !160
  %192 = extractvalue %"class.openmc::ReactionFlat" %call231.4.i.i, 0
  store ptr %192, ptr addrspace(5) %ref.tmp228.i.i, align 8, !noalias !160
  %193 = extractvalue %"class.openmc::ReactionFlat" %call231.4.i.i, 1
  store i64 %193, ptr addrspace(5) %91, align 8, !noalias !160
  %194 = extractvalue %"class.openmc::ReactionFlat" %call231.4.i.i, 2
  store i64 %194, ptr addrspace(5) %92, align 8, !noalias !160
  %call240.4.i.i = call noundef i32 @_ZNK6openmc12ReactionFlat12xs_thresholdEl(ptr noundef nonnull align 8 dereferenceable(24) %ref.tmp228.ascast.i.i, i64 noundef %idxprom93.i.i) #11, !noalias !160
...
if.then242.4.i.i:                                 ; preds = %if.then227.4.i.i
  %call245.4.i.i = call noundef double @_ZNK6openmc12ReactionFlat2xsElld(ptr noundef nonnull align 8 dereferenceable(24) %ref.tmp228.ascast.i.i, i64 noundef %idxprom93.i.i, i64 noundef %idxprom191.i.i, double noundef %div200.i.i) #11, !noalias !160
...
for.inc259.4.i.i:                                 ; preds = %cleanup256.4.i.i
  ...
  %195 = load i64, ptr %arrayidx.i.i30.5.i.i, align 8, !tbaa !256, !noalias !160
...
if.then227.5.i.i:                                 ; preds = %for.inc259.4.i.i
  ...
  %reactions_.val.5.i.i = load ptr, ptr %reactions_.i.i, align 8, !tbaa !262, !noalias !160
  ...
  %call231.5.i.i = call %"class.openmc::ReactionFlat" @_ZNK6openmc21ReactionFlatContainer3objEv(ptr noundef nonnull align 8 dereferenceable(32) %arrayidx.i31.5.i.i) #11, !noalias !160
  %197 = extractvalue %"class.openmc::ReactionFlat" %call231.5.i.i, 0
  store ptr %197, ptr addrspace(5) %ref.tmp228.i.i, align 8, !noalias !160
  %198 = extractvalue %"class.openmc::ReactionFlat" %call231.5.i.i, 1
  store i64 %198, ptr addrspace(5) %91, align 8, !noalias !160
  %199 = extractvalue %"class.openmc::ReactionFlat" %call231.5.i.i, 2
  store i64 %199, ptr addrspace(5) %92, align 8, !noalias !160
  %call240.5.i.i = call noundef i32 @_ZNK6openmc12ReactionFlat12xs_thresholdEl(ptr noundef nonnull align 8 dereferenceable(24) %ref.tmp228.ascast.i.i, i64 noundef %idxprom93.i.i) #11, !noalias !160
...
if.then242.5.i.i:                                 ; preds = %if.then227.5.i.i
  %call245.5.i.i = call noundef double @_ZNK6openmc12ReactionFlat2xsElld(ptr noundef nonnull align 8 dereferenceable(24) %ref.tmp228.ascast.i.i, i64 noundef %idxprom93.i.i, i64 noundef %idxprom191.i.i, double noundef %div200.i.i) #11, !noalias !160
...
if.then266.i.i:                                   ; preds = %if.end264.i.i
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %sab_i_temp.i.i) #10, !noalias !160
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %sab_elastic.i.i) #10, !noalias !160
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %sab_inelastic.i.i) #10, !noalias !160
  %index_268.i.i = getelementptr inbounds nuw i8, ptr %arrayidx.i, i64 56
  %200 = load i64, ptr %index_268.i.i, align 8, !tbaa !168, !noalias !160
  %201 = load i64, ptr %arrayidx82.i.i, align 8, !tbaa !256, !noalias !160
  %call271.i.i = call noundef double @_ZN6openmc10future_prnElm(i64 noundef %200, i64 noundef %201) #11, !noalias !160
  %202 = load ptr, ptr addrspace(1) @_ZN6openmc4data20device_thermal_scattE, align 8, !tbaa !263, !noalias !160
  ...
  %203 = load double, ptr addrspace(5) %sab_elastic.i.i, align 8, !tbaa !112, !noalias !160
  %204 = load double, ptr addrspace(5) %sab_inelastic.i.i, align 8, !tbaa !112, !noalias !160
...
if.then278.i.i:                                   ; preds = %if.then266.i.i
  %call279.i.i = call noundef double @_ZNK6openmc7Nuclide20calculate_elastic_xsEiid(ptr noundef nonnull align 8 dereferenceable(7680) %arrayidx.i, i32 noundef %i_temp.5.i.i, i32 noundef %i_grid.2.i.i, double noundef %f.0.i.i) #11, !noalias !160
...
if.end280.i.i:                                    ; preds = %if.then278.i.i, %if.then266.i.i
  ...
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %sab_inelastic.i.i) #10, !noalias !160
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %sab_elastic.i.i) #10, !noalias !160
  call void @llvm.lifetime.end.p5(i64 4, ptr addrspace(5) %sab_i_temp.i.i) #10, !noalias !160
...
if.end286.i.i:                                    ; preds = %if.end280.i.i, %if.end264.i.i
  ...
  %206 = load i8, ptr addrspace(1) @_ZN6openmc8settings14urr_ptables_onE, align 1, !tbaa !265, !range !248, !noalias !160, !noundef !249
...
land.lhs.true288.i.i:                             ; preds = %if.end286.i.i
  ...
  %207 = load i8, ptr %urr_present_.i.i, align 8, !tbaa !266, !range !248, !noalias !160, !noundef !249
...
if.then292.i.i:                                   ; preds = %land.lhs.true288.i.i
  ...
  %urr_data_.val.i.i = load ptr, ptr %urr_data_.i.i, align 8, !tbaa !267, !noalias !160
  ...
  %208 = load ptr, ptr %device_energy_.i.i, align 8, !tbaa !268, !noalias !160
  %209 = load double, ptr %208, align 8, !tbaa !112, !noalias !160
...
land.lhs.true300.i.i:                             ; preds = %if.then292.i.i
  ...
  %210 = load i32, ptr %n_energy_.i.i, align 8, !tbaa !271, !noalias !160
  %211 = sext i32 %210 to i64
  %212 = getelementptr double, ptr %208, i64 %211
  %arrayidx307.i.i = getelementptr i8, ptr %212, i64 -8
  %213 = load double, ptr %arrayidx307.i.i, align 8, !tbaa !112, !noalias !160
...
while.cond.i.i:                                   ; preds = %while.cond.i.i, %land.lhs.true300.i.i
  ...
  %214 = load double, ptr %arrayidx316.i.i, align 8, !tbaa !112, !noalias !160
  %cmp317.i.i = fcmp ult double %1, %214
  br i1 %cmp317.i.i, label %while.end.i.i, label %while.cond.i.i, !llvm.loop !272

while.end.i.i:                                    ; preds = %while.cond.i.i
  %index_319.i.i = getelementptr inbounds nuw i8, ptr %arrayidx.i, i64 56
  %215 = load i64, ptr %index_319.i.i, align 8, !tbaa !168, !noalias !160
  %add320.i.i = add nsw i64 %215, 1
  %216 = load i64, ptr %arrayidx322.i.i, align 8, !tbaa !256, !noalias !160
  %call323.i.i = call noundef double @_ZN6openmc10future_prnElm(i64 noundef %add320.i.i, i64 noundef %216) #11, !noalias !160
...
while.cond325.i.i:                                ; preds = %while.cond325.i.i, %while.end.i.i
  ...
  %call326.i.i = call noundef double @_ZNK6openmc7UrrData4probEiNS_13URRTableParamEi(ptr noundef nonnull align 8 dereferenceable(240) %arrayidx.i32.i.i, i32 noundef %i_energy.0.i.i, i32 noundef 0, i32 noundef %i_low324.0.i.i) #11, !noalias !160
  %cmp327.i.i = fcmp ugt double %call326.i.i, %call323.i.i
  %inc329.i.i = add nuw nsw i32 %i_low324.0.i.i, 1
  br i1 %cmp327.i.i, label %while.cond331.i.i.preheader, label %while.cond325.i.i, !llvm.loop !273
...
while.cond331.i.i:                                ; preds = %while.cond331.i.i, %while.cond331.i.i.preheader
  ...
  %call333.i.i = call noundef double @_ZNK6openmc7UrrData4probEiNS_13URRTableParamEi(ptr noundef nonnull align 8 dereferenceable(240) %arrayidx.i32.i.i, i32 noundef %add314.i.i, i32 noundef 0, i32 noundef %i_up.0.i.i) #11, !noalias !160
  %cmp334.i.i = fcmp ugt double %call333.i.i, %call323.i.i
  %inc336.i.i = add nuw nsw i32 %i_up.0.i.i, 1
  br i1 %cmp334.i.i, label %while.end337.i.i, label %while.cond331.i.i, !llvm.loop !274

while.end337.i.i:                                 ; preds = %while.cond331.i.i
  %217 = load i32, ptr %arrayidx.i32.i.i, align 8, !tbaa !275, !noalias !160
...
if.then339.i.i:                                   ; preds = %while.end337.i.i
  %218 = load ptr, ptr %device_energy_.i.i, align 8, !tbaa !268, !noalias !160
  ...
  %219 = load double, ptr %arrayidx342.i.i, align 8, !tbaa !112, !noalias !160
  %sub343.i.i = fsub double %1, %219
  %arrayidx347.i.i = getelementptr inbounds nuw double, ptr %218, i64 %idxprom315.i.i
  %220 = load double, ptr %arrayidx347.i.i, align 8, !tbaa !112, !noalias !160
  %sub351.i.i = fsub double %220, %219
  %div352.i.i = fdiv double %sub343.i.i, %sub351.i.i
  %sub353.i.i = fsub double 1.000000e+00, %div352.i.i
  %call354.i.i = call noundef double @_ZNK6openmc7UrrData4probEiNS_13URRTableParamEi(ptr noundef nonnull align 8 dereferenceable(240) %arrayidx.i32.i.i, i32 noundef %i_energy.0.i.i, i32 noundef 2, i32 noundef %i_low324.0.i.i) #11, !noalias !160
  %call357.i.i = call noundef double @_ZNK6openmc7UrrData4probEiNS_13URRTableParamEi(ptr noundef nonnull align 8 dereferenceable(240) %arrayidx.i32.i.i, i32 noundef %add314.i.i, i32 noundef 2, i32 noundef %i_up.0.i.i) #11, !noalias !160
  ...
  %call360.i.i = call noundef double @_ZNK6openmc7UrrData4probEiNS_13URRTableParamEi(ptr noundef nonnull align 8 dereferenceable(240) %arrayidx.i32.i.i, i32 noundef %i_energy.0.i.i, i32 noundef 3, i32 noundef %i_low324.0.i.i) #11, !noalias !160
  %call363.i.i = call noundef double @_ZNK6openmc7UrrData4probEiNS_13URRTableParamEi(ptr noundef nonnull align 8 dereferenceable(240) %arrayidx.i32.i.i, i32 noundef %add314.i.i, i32 noundef 3, i32 noundef %i_up.0.i.i) #11, !noalias !160
  ...
  %call366.i.i = call noundef double @_ZNK6openmc7UrrData4probEiNS_13URRTableParamEi(ptr noundef nonnull align 8 dereferenceable(240) %arrayidx.i32.i.i, i32 noundef %i_energy.0.i.i, i32 noundef 4, i32 noundef %i_low324.0.i.i) #11, !noalias !160
  %call369.i.i = call noundef double @_ZNK6openmc7UrrData4probEiNS_13URRTableParamEi(ptr noundef nonnull align 8 dereferenceable(240) %arrayidx.i32.i.i, i32 noundef %add314.i.i, i32 noundef 4, i32 noundef %i_up.0.i.i) #11, !noalias !160
...
if.then374.i.i:                                   ; preds = %while.end337.i.i
  %224 = load ptr, ptr %device_energy_.i.i, align 8, !tbaa !268, !noalias !160
  ...
  %225 = load double, ptr %arrayidx377.i.i, align 8, !tbaa !112, !noalias !160
  ...
  %310 = load double, ptr %arrayidx383.i.i, align 8, !tbaa !112, !noalias !160
  ...
  %call390.i.i = call noundef double @_ZNK6openmc7UrrData4probEiNS_13URRTableParamEi(ptr noundef nonnull align 8 dereferenceable(240) %arrayidx.i32.i.i, i32 noundef %i_energy.0.i.i, i32 noundef 2, i32 noundef %i_low324.0.i.i) #11, !noalias !160
...
land.lhs.true392.i.i:                             ; preds = %if.then374.i.i
  %call394.i.i = call noundef double @_ZNK6openmc7UrrData4probEiNS_13URRTableParamEi(ptr noundef nonnull align 8 dereferenceable(240) %arrayidx.i32.i.i, i32 noundef %add314.i.i, i32 noundef 2, i32 noundef %i_up.0.i.i) #11, !noalias !160
...
if.then396.i.i:                                   ; preds = %land.lhs.true392.i.i
  ...
  %call398.i.i = call noundef double @_ZNK6openmc7UrrData4probEiNS_13URRTableParamEi(ptr noundef nonnull align 8 dereferenceable(240) %arrayidx.i32.i.i, i32 noundef %i_energy.0.i.i, i32 noundef 2, i32 noundef %i_low324.0.i.i) #11, !noalias !160
  ...
  %call402.i.i = call noundef double @_ZNK6openmc7UrrData4probEiNS_13URRTableParamEi(ptr noundef nonnull align 8 dereferenceable(240) %arrayidx.i32.i.i, i32 noundef %add314.i.i, i32 noundef 2, i32 noundef %i_up.0.i.i) #11, !noalias !160
...
if.end407.i.i:                                    ; preds = %if.then396.i.i, %land.lhs.true392.i.i, %if.then374.i.i
  ...
  %call408.i.i = call noundef double @_ZNK6openmc7UrrData4probEiNS_13URRTableParamEi(ptr noundef nonnull align 8 dereferenceable(240) %arrayidx.i32.i.i, i32 noundef %i_energy.0.i.i, i32 noundef 3, i32 noundef %i_low324.0.i.i) #11, !noalias !160
...
land.lhs.true410.i.i:                             ; preds = %if.end407.i.i
  %call412.i.i = call noundef double @_ZNK6openmc7UrrData4probEiNS_13URRTableParamEi(ptr noundef nonnull align 8 dereferenceable(240) %arrayidx.i32.i.i, i32 noundef %add314.i.i, i32 noundef 3, i32 noundef %i_up.0.i.i) #11, !noalias !160
...
if.then414.i.i:                                   ; preds = %land.lhs.true410.i.i
  ...
  %call416.i.i = call noundef double @_ZNK6openmc7UrrData4probEiNS_13URRTableParamEi(ptr noundef nonnull align 8 dereferenceable(240) %arrayidx.i32.i.i, i32 noundef %i_energy.0.i.i, i32 noundef 3, i32 noundef %i_low324.0.i.i) #11, !noalias !160
  ...
  %call420.i.i = call noundef double @_ZNK6openmc7UrrData4probEiNS_13URRTableParamEi(ptr noundef nonnull align 8 dereferenceable(240) %arrayidx.i32.i.i, i32 noundef %add314.i.i, i32 noundef 3, i32 noundef %i_up.0.i.i) #11, !noalias !160
...
if.end425.i.i:                                    ; preds = %if.then414.i.i, %land.lhs.true410.i.i, %if.end407.i.i
  ...
  %call426.i.i = call noundef double @_ZNK6openmc7UrrData4probEiNS_13URRTableParamEi(ptr noundef nonnull align 8 dereferenceable(240) %arrayidx.i32.i.i, i32 noundef %i_energy.0.i.i, i32 noundef 4, i32 noundef %i_low324.0.i.i) #11, !noalias !160
...
land.lhs.true428.i.i:                             ; preds = %if.end425.i.i
  %call430.i.i = call noundef double @_ZNK6openmc7UrrData4probEiNS_13URRTableParamEi(ptr noundef nonnull align 8 dereferenceable(240) %arrayidx.i32.i.i, i32 noundef %add314.i.i, i32 noundef 4, i32 noundef %i_up.0.i.i) #11, !noalias !160
...
if.then432.i.i:                                   ; preds = %land.lhs.true428.i.i
  ...
  %call434.i.i = call noundef double @_ZNK6openmc7UrrData4probEiNS_13URRTableParamEi(ptr noundef nonnull align 8 dereferenceable(240) %arrayidx.i32.i.i, i32 noundef %i_energy.0.i.i, i32 noundef 4, i32 noundef %i_low324.0.i.i) #11, !noalias !160
  ...
  %call438.i.i = call noundef double @_ZNK6openmc7UrrData4probEiNS_13URRTableParamEi(ptr noundef nonnull align 8 dereferenceable(240) %arrayidx.i32.i.i, i32 noundef %add314.i.i, i32 noundef 4, i32 noundef %i_up.0.i.i) #11, !noalias !160
...
if.end445.i.i:                                    ; preds = %if.then432.i.i, %land.lhs.true428.i.i, %if.end425.i.i, %if.then339.i.i, %while.end337.i.i
  ...
  %968 = load i32, ptr %inelastic_flag_.i.i, align 4, !tbaa !276, !noalias !160
...
if.then447.i.i:                                   ; preds = %if.end445.i.i
  call void @llvm.lifetime.start.p5(i64 24, ptr addrspace(5) %rx448.i.i) #10, !noalias !160
  ...
  %969 = load i32, ptr %urr_inelastic_.i.i, align 4, !tbaa !277, !noalias !160
  %conv450.i.i = sext i32 %969 to i64
  %reactions_449.val.i.i = load ptr, ptr %reactions_449.i.i, align 8, !tbaa !262, !noalias !160
  %arrayidx.i43.i.i = getelementptr inbounds nuw %"class.openmc::ReactionFlatContainer", ptr %reactions_449.val.i.i, i64 %conv450.i.i
  %call452.i.i = call %"class.openmc::ReactionFlat" @_ZNK6openmc21ReactionFlatContainer3objEv(ptr noundef nonnull align 8 dereferenceable(32) %arrayidx.i43.i.i) #11, !noalias !160
  %970 = extractvalue %"class.openmc::ReactionFlat" %call452.i.i, 0
  store ptr %970, ptr addrspace(5) %rx448.i.i, align 8, !noalias !160
  %971 = extractvalue %"class.openmc::ReactionFlat" %call452.i.i, 1
  store i64 %971, ptr addrspace(5) %93, align 8, !noalias !160
  %972 = extractvalue %"class.openmc::ReactionFlat" %call452.i.i, 2
  store i64 %972, ptr addrspace(5) %94, align 8, !noalias !160
  %conv454.i.i = sext i32 %i_grid.2.i.i to i64
  %call455.i.i = call noundef double @_ZNK6openmc12ReactionFlat2xsElld(ptr noundef nonnull align 8 dereferenceable(24) %rx448.ascast.i.i, i64 noundef %conv293.i.i, i64 noundef %conv454.i.i, double noundef %f.0.i.i) #11, !noalias !160
  call void @llvm.lifetime.end.p5(i64 24, ptr addrspace(5) %rx448.i.i) #10, !noalias !160
...
if.end456.i.i:                                    ; preds = %if.then447.i.i, %if.end445.i.i
  ...
  %973 = load i8, ptr %multiply_smooth_.i.i, align 4, !tbaa !278, !range !248, !noalias !160, !noundef !249
...
if.then458.i.i:                                   ; preds = %if.end456.i.i
  ...
  %call459.i.i = call noundef double @_ZNK6openmc7Nuclide20calculate_elastic_xsEiid(ptr noundef nonnull align 8 dereferenceable(7680) %arrayidx.i, i32 noundef %i_temp.5.i.i, i32 noundef %i_grid.2.i.i, double noundef %f.0.i.i) #11, !noalias !160
...
if.end464.i.i:                                    ; preds = %if.then458.i.i, %if.end456.i.i
  ...
  %974 = load i8, ptr %fissionable_482.i.i, align 8, !tbaa !247, !range !248, !noalias !160, !noundef !249
...
if.then484.i.i:                                   ; preds = %if.end464.i.i
  %call485.i.i = call noundef double @_ZNK6openmc7Nuclide2nuEdNS_15ReactionProduct12EmissionModeEi(ptr noundef nonnull align 8 dereferenceable(7680) %arrayidx.i, double noundef %1, i32 noundef 2, i32 noundef 0) #11, !noalias !160
...
_ZN6openmc7Nuclide12calculate_xsINS_7MicroXSEEET_iRNS_8ParticleEbdd.internalized.exit.i: ; preds = %if.then484.i.i, %if.end464.i.i, %land.lhs.true300.i.i, %if.then292.i.i, %land.lhs.true288.i.i, %if.end286.i.i
  ...
  %975 = load ptr, ptr addrspace(1) @_ZN6openmc5model22materials_atom_densityE, align 8, !tbaa !253
  %976 = load i64, ptr addrspace(1) getelementptr inbounds nuw (i8, ptr addrspace(1) @_ZN6openmc5model22materials_atom_densityE, i64 24), align 8, !tbaa !279
  ...
  %978 = load double, ptr %arrayidx.i.i6.i, align 8, !tbaa !112
...
if.end.i:                                         ; preds = %for.body17.preheader.i, %_ZN6openmc7Nuclide12calculate_xsINS_7MicroXSEEET_iRNS_8ParticleEbdd.internalized.exit.i
  ...
  br i1 %cmp.i, label %for.body.i, label %for.cond.cleanup.i, !llvm.loop !281
...
if.then4:                                         ; preds = %entry
  ...
  store double 0.000000e+00, ptr %coherent.i, align 8, !tbaa !282
  %incoherent.i = getelementptr inbounds nuw i8, ptr %p, i64 840
  store double 0.000000e+00, ptr %incoherent.i, align 8, !tbaa !283
  %photoelectric.i = getelementptr inbounds nuw i8, ptr %p, i64 848
  store double 0.000000e+00, ptr %photoelectric.i, align 8, !tbaa !284
  %pair_production.i = getelementptr inbounds nuw i8, ptr %p, i64 856
  store double 0.000000e+00, ptr %pair_production.i, align 8, !tbaa !285
  %989 = getelementptr inbounds nuw i8, ptr %this, i64 48
  %nuclide_.val5.i = load i64, ptr %989, align 8, !tbaa !109
...
for.body.lr.ph.i5:                                ; preds = %if.then4
  ...
  %this.val1.pre.i = load i64, ptr %990, align 8, !tbaa !113
...
for.body.i7:                                      ; preds = %if.end.i13, %for.body.lr.ph.i5
  ...
  %999 = load i32, ptr %arrayidx.i.i.i10, align 4, !tbaa !155
  ...
  %1000 = load double, ptr %E_.i6, align 8, !tbaa !107
  %last_E.i = getelementptr inbounds nuw i8, ptr %arrayidx.i12, i64 8
  %1001 = load double, ptr %last_E.i, align 8, !tbaa !286
  %cmp7.i = fcmp une double %1000, %1001
  br i1 %cmp7.i, label %if.then.i, label %if.end.i13

if.then.i:                                        ; preds = %for.body.i7
  %1002 = load ptr, ptr addrspace(1) @_ZN6openmc4data8elementsE, align 8, !tbaa !288
  %arrayidx9.i = getelementptr inbounds %"class.openmc::PhotonInteraction", ptr %1002, i64 %idxprom.i11
  tail call void @_ZNK6openmc17PhotonInteraction12calculate_xsERNS_8ParticleE(ptr noundef nonnull align 8 dereferenceable(1936) %arrayidx9.i, ptr noundef nonnull align 8 dereferenceable(2728) %p) #11
  ...
  %this.val.pre.i18 = load i64, ptr %990, align 8, !tbaa !113
  %.pre14.i = load double, ptr %macro_xs_.i4, align 8, !tbaa !148
  %.pre15.i = load double, ptr %coherent.i, align 8, !tbaa !282
  %.pre16.i = load double, ptr %incoherent.i, align 8, !tbaa !283
  %.pre17.i = load double, ptr %photoelectric.i, align 8, !tbaa !284
  %.pre18.i = load double, ptr %pair_production.i, align 8, !tbaa !285
  %nuclide_.val.pre.i = load i64, ptr %989, align 8, !tbaa !109
  br label %if.end.i13
...
if.end.i13:                                       ; preds = %if.then.i, %for.body.i7
  ...
  %1010 = load ptr, ptr addrspace(1) @_ZN6openmc5model22materials_atom_densityE, align 8, !tbaa !253
  %1011 = load i64, ptr addrspace(1) getelementptr inbounds nuw (i8, ptr addrspace(1) @_ZN6openmc5model22materials_atom_densityE, i64 24), align 8, !tbaa !279
...
define available_externally hidden noundef double @_ZNK6openmc14PolynomialFlatclEd(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(8) %this, double noundef %x) local_unnamed_addr #6 align 2 {
entry:
  %this.val = load ptr, ptr %this, align 8, !tbaa !296
  %add.ptr.i = getelementptr inbounds nuw i8, ptr %this.val, i64 4
  %0 = load i32, ptr %add.ptr.i, align 4, !tbaa !155
...
for.body:                                         ; preds = %for.body, %for.body.preheader
  ...
  %1 = load double, ptr %incdec.ptr.i.ptr, align 8, !tbaa !112
  %2 = tail call double @llvm.fmuladd.f64(double %y.07, double %x, double %1) #12
  %cmp.i.i.not = icmp eq i64 %c.sroa.0.0.add, 8
  br i1 %cmp.i.i.not, label %for.cond.cleanup, label %for.body, !llvm.loop !298
}

; Function Attrs: convergent mustprogress nofree norecurse nosync nounwind willreturn memory(read, inaccessiblemem: none)
define available_externally hidden noundef double @_ZNK6openmc21CoherentElasticXSFlatclEd(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(8) %this, double noundef %E) local_unnamed_addr #7 align 2 {
entry:
  %this.val = load ptr, ptr %this, align 8, !tbaa !299
  %add.ptr.i = getelementptr inbounds nuw i8, ptr %this.val, i64 4
  %0 = load i32, ptr %add.ptr.i, align 4, !tbaa !155
  %conv.i = sext i32 %0 to i64
  ...
  %1 = load double, ptr %add.ptr3.i, align 8, !tbaa !112
...
while.body.i.i.i:                                 ; preds = %while.body.i.i.i, %if.end.i
  ...
  %.val.i.i.i = load double, ptr %add.ptr.sink.i.i.i.i.i, align 8, !tbaa !112
  ...
  br i1 %cmp.i.i.i, label %while.body.i.i.i, label %_ZSt11lower_boundIPKddET_S2_S2_RKT0_.internalized.exit.loopexit.i, !llvm.loop !301
...
_ZN6openmc17lower_bound_indexIPKddEENSt15iterator_traitsIT_E15difference_typeES4_S4_RKT0_.internalized.exit: ; preds = %_ZSt11lower_boundIPKddET_S2_S2_RKT0_.internalized.exit.i, %if.else
  ...
  %4 = load double, ptr %arrayidx.i, align 8, !tbaa !112
  %div = fdiv double %4, %E
  br label %cleanup
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(read, inaccessiblemem: none)
define available_externally hidden noundef double @_ZNK6openmc23IncoherentElasticXSFlatclEd(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(8) %this, double noundef %E) local_unnamed_addr #6 align 2 {
entry:
  %this.val = load ptr, ptr %this, align 8, !tbaa !302
  %0 = getelementptr i8, ptr %this.val, i64 16
  %this.val.val = load double, ptr %0, align 8, !tbaa !112
  %1 = getelementptr i8, ptr %this.val, i64 8
  %this.val3.val = load double, ptr %1, align 8, !tbaa !112
...
entry:
  ...
  %this.val = load ptr, ptr %this, align 8, !tbaa !308
  %this.val.val.i = load i32, ptr %this.val, align 4, !tbaa !155
...
sw.bb.i:                                          ; preds = %entry
  ...
  call void @llvm.lifetime.start.p5(i64 24, ptr addrspace(5) %dist.i) #13
  call void @_ZN6openmc15Tabulated1DFlatC1EPKh(ptr noundef nonnull align 8 dereferenceable(24) %dist.ascast.i, ptr noundef nonnull %this.val) #11
  %call2.i = call noundef double @_ZNK6openmc15Tabulated1DFlatclEd(ptr noundef nonnull align 8 dereferenceable(24) %dist.ascast.i, double noundef %x) #11
  call void @llvm.lifetime.end.p5(i64 24, ptr addrspace(5) %dist.i) #10
...
sw.bb3.i:                                         ; preds = %entry
  ...
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %dist4.i) #10
  store ptr %this.val, ptr addrspace(5) %dist4.i, align 8, !tbaa !296
  %call6.i = call noundef double @_ZNK6openmc14PolynomialFlatclEd(ptr noundef nonnull align 8 dereferenceable(8) %dist4.ascast.i, double noundef %x) #11
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %dist4.i) #10
  br label %_ZNK6openmc14Function1DFlatclEd.internalized.exit
...
sw.bb8.i:                                         ; preds = %entry
  ...
  store ptr %this.val, ptr addrspace(5) %dist9.i, align 8, !tbaa !299
  %call11.i = call noundef double @_ZNK6openmc21CoherentElasticXSFlatclEd(ptr noundef nonnull align 8 dereferenceable(8) %dist9.ascast.i, double noundef %x) #11
...
sw.bb13.i:                                        ; preds = %entry
  ...
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %dist14.i) #10
  store ptr %this.val, ptr addrspace(5) %dist14.i, align 8, !tbaa !302
  %call16.i = call noundef double @_ZNK6openmc23IncoherentElasticXSFlatclEd(ptr noundef nonnull align 8 dereferenceable(8) %dist14.ascast.i, double noundef %x) #11
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %dist14.i) #10
  br label %_ZNK6openmc14Function1DFlatclEd.internalized.exit
...
; Function Attrs: convergent mustprogress nounwind
define available_externally hidden noundef double @_ZNK6openmc7Nuclide20calculate_elastic_xsEiid(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(7680) %this, i32 noundef %i_temp, i32 noundef %i_grid, double noundef %interp_factor) local_unnamed_addr #4 align 2 {
entry:
...
if.then:                                          ; preds = %entry
  ...
  %reactions_.val = load ptr, ptr %reactions_, align 8, !tbaa !262
  %call2 = tail call %"class.openmc::vector" @_ZNK6openmc21ReactionFlatContainer3objEv(ptr noundef nonnull align 8 dereferenceable(32) %reactions_.val) #11
  ...
  %call4 = call noundef double @_ZNK6openmc12ReactionFlat2xsElld(ptr noundef nonnull align 8 dereferenceable(24) %rx.ascast, i64 noundef %conv, i64 noundef %conv3, double noundef %interp_factor) #11
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define available_externally hidden noundef double @_ZN6openmc10future_prnElm(i64 noundef %n, i64 noundef %seed) local_unnamed_addr #3 {
entry:
...
if.end.i:                                         ; preds = %if.then.i, %while.body.i
  ...
  br i1 %cmp.not.i, label %_ZN6openmc11future_seedEmm.internalized.exit, label %while.body.i, !llvm.loop !312
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(read, inaccessiblemem: none)
define available_externally hidden noundef double @_ZNK6openmc12ReactionFlat2xsElld(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(24) %this, i64 noundef %i_temp, i64 noundef %i_grid, double noundef %interp_factor) local_unnamed_addr #6 align 2 {
entry:
  ...
  %1 = load i32, ptr %arrayidx, align 4, !tbaa !155
  %idx.ext = sext i32 %1 to i64
  %add.ptr3 = getelementptr inbounds i8, ptr %0, i64 %idx.ext
  %2 = load i32, ptr %add.ptr3, align 4, !tbaa !155
...
cond.false:                                       ; preds = %entry
  ...
  %3 = load double, ptr %arrayidx7, align 8, !tbaa !112
  %4 = load double, ptr %arrayidx10, align 8, !tbaa !112
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(read, inaccessiblemem: none)
define available_externally hidden noundef i32 @_ZNK6openmc12ReactionFlat12xs_thresholdEl(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(24) %this, i64 noundef %i_temp) local_unnamed_addr #6 align 2 {
entry:
  %0 = load ptr, ptr %this, align 8, !tbaa !313
  %add.ptr = getelementptr inbounds nuw i8, ptr %0, i64 40
  %arrayidx = getelementptr inbounds i32, ptr %add.ptr, i64 %i_temp
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(read, inaccessiblemem: none)
define available_externally hidden %"class.openmc::vector" @_ZNK6openmc21ReactionFlatContainer3objEv(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(32) %this) local_unnamed_addr #6 align 2 {
entry:
...
; Function Attrs: convergent mustprogress nounwind
define available_externally hidden void @_ZNK6openmc17ThermalScattering12calculate_xsEddPiPdS2_d(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(120) %this, double noundef %E, double noundef %sqrtkT, ptr noundef writeonly captures(none) %i_temp, ptr noundef writeonly captures(none) %elastic, ptr noundef writeonly captures(none) %inelastic, double noundef %sample) local_unnamed_addr #4 align 2 {
entry:
  %mul = fmul double %sqrtkT, %sqrtkT
  %0 = getelementptr inbounds nuw i8, ptr %this, i64 56
  %kTs_.val = load i64, ptr %0, align 8, !tbaa !252
...
while.cond.preheader:                             ; preds = %entry
  ...
  %kTs_.val17 = load ptr, ptr %kTs_, align 8, !tbaa !253
...
while.cond:                                       ; preds = %while.cond, %while.cond.preheader
  ...
  %1 = load double, ptr %arrayidx.i, align 8, !tbaa !112
  %cmp4 = fcmp olt double %1, %mul
  %cmp7 = icmp ugt i64 %sub, %conv
  %or.cond = and i1 %cmp4, %cmp7
  br i1 %or.cond, label %while.cond, label %while.end, !llvm.loop !317

while.end:                                        ; preds = %while.cond
  %2 = load i32, ptr addrspace(1) @_ZN6openmc8settings18temperature_methodE, align 4, !tbaa !250
  ...
  %3 = load double, ptr %arrayidx.i23, align 8, !tbaa !112
...
if.end39:                                         ; preds = %if.else, %if.then20, %if.then9, %entry
  ...
  store i32 %i.2, ptr %i_temp, align 4, !tbaa !155
  %data_ = getelementptr inbounds nuw i8, ptr %this, i64 96
  %conv40 = sext i32 %i.2 to i64
  %data_.val = load ptr, ptr %data_, align 8, !tbaa !318
  ...
  %4 = load ptr, ptr %device_xs.i, align 8, !tbaa !319
...
if.then.i:                                        ; preds = %if.end39
  %call.i = tail call noundef double @_ZNK6openmc23Function1DFlatContainerclEd(ptr noundef nonnull align 8 dereferenceable(32) %4, double noundef %E) #11
...
_ZNK6openmc11ThermalData12calculate_xsEdPdS1_.internalized.exit: ; preds = %if.then.i, %if.end39
  ...
  store double %storemerge.i, ptr %elastic, align 8, !tbaa !112
  %device_xs4.i = getelementptr inbounds nuw i8, ptr %arrayidx.i28, i64 48
  %5 = load ptr, ptr %device_xs4.i, align 8, !tbaa !329
  %call5.i = tail call noundef double @_ZNK6openmc23Function1DFlatContainerclEd(ptr noundef nonnull align 8 dereferenceable(32) %5, double noundef %E) #11
  store double %call5.i, ptr %inelastic, align 8, !tbaa !112
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(read, inaccessiblemem: none)
define available_externally hidden noundef double @_ZNK6openmc7UrrData4probEiNS_13URRTableParamEi(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(240) %this, i32 noundef %i_energy, i32 noundef %i_tableparam, i32 noundef %band) local_unnamed_addr #6 align 2 {
entry:
  %device_prob_ = getelementptr inbounds nuw i8, ptr %this, i64 224
  %0 = load ptr, ptr %device_prob_, align 8, !tbaa !330
  %mul = mul nsw i32 %i_energy, 6
  %n_bands_ = getelementptr inbounds nuw i8, ptr %this, i64 232
  %1 = load i32, ptr %n_bands_, align 8, !tbaa !331
  ...
  %2 = load double, ptr %arrayidx, align 8, !tbaa !112
  ret double %2
}
...
!opencl.ocl.version = !{!82, !82, !82, !82, !82, !82, !82, !82, !82, !82, !82}
!llvm.ident = !{!83, !84, !83, !84, !83, !84, !83, !84, !83, !84, !83, !84, !83, !84, !83, !84, !83, !84, !83, !84, !83, !84}
...
!262 = !{!202, !203, i64 0}
!263 = !{!264, !264, i64 0}
!264 = !{!"p1 _ZTSN6openmc17ThermalScatteringE", !101, i64 0}
!265 = !{!96, !96, i64 0}
!266 = !{!169, !96, i64 376}
!267 = !{!200, !201, i64 0}
!268 = !{!269, !133, i64 96}
!269 = !{!"_ZTSN6openmc7UrrDataE", !270, i64 0, !94, i64 4, !94, i64 8, !96, i64 12, !94, i64 16, !118, i64 24, !133, i64 96, !225, i64 104, !133, i64 224, !94, i64 232, !94, i64 236}
!270 = !{!"_ZTSN6openmc13InterpolationE", !88, i64 0}
!271 = !{!269, !94, i64 16}
!272 = distinct !{!272, !220}
!273 = distinct !{!273, !220}
...
!278 = !{!269, !96, i64 12}
!279 = !{!280, !92, i64 24}
!280 = !{!"_ZTSN6openmc8vector2dIdEE", !170, i64 0, !92, i64 24}
...
!285 = !{!86, !91, i64 856}
!286 = !{!287, !91, i64 8}
!287 = !{!"_ZTSN6openmc14ElementMicroXSE", !94, i64 0, !91, i64 8, !91, i64 16, !91, i64 24, !91, i64 32, !91, i64 40, !91, i64 48, !91, i64 56}
!288 = !{!289, !289, i64 0}
!289 = !{!"p1 _ZTSN6openmc17PhotonInteractionE", !101, i64 0}
!290 = !{!287, !91, i64 24}
!291 = !{!287, !91, i64 32}
!292 = !{!287, !91, i64 40}
!293 = !{!287, !91, i64 48}
!294 = !{!287, !91, i64 56}
!295 = distinct !{!295, !220}
!296 = !{!297, !117, i64 0}
!297 = !{!"_ZTSN6openmc14PolynomialFlatE", !117, i64 0}
!298 = distinct !{!298, !220}
!299 = !{!300, !117, i64 0}
!300 = !{!"_ZTSN6openmc21CoherentElasticXSFlatE", !117, i64 0}
!301 = distinct !{!301, !220}
!302 = !{!303, !117, i64 0}
!303 = !{!"_ZTSN6openmc23IncoherentElasticXSFlatE", !117, i64 0}
!304 = !{!305, !117, i64 0}
!305 = !{!"_ZTSN6openmc15Tabulated1DFlatE", !117, i64 0, !92, i64 8, !92, i64 16}
!306 = !{!305, !92, i64 8}
!307 = !{!305, !92, i64 16}
!308 = !{!309, !117, i64 0}
!309 = !{!"_ZTSN6openmc23Function1DFlatContainerE", !310, i64 0}
!310 = !{!"_ZTSN6openmc10DataBufferE", !117, i64 0, !92, i64 8, !92, i64 16, !311, i64 24}
!311 = !{!"_ZTSN6openmc10DataBuffer4ModeE", !88, i64 0}
!312 = distinct !{!312, !220}
!313 = !{!314, !117, i64 0}
!314 = !{!"_ZTSN6openmc12ReactionFlatE", !117, i64 0, !92, i64 8, !92, i64 16}
!315 = !{!316, !117, i64 0}
!316 = !{!"_ZTSN6openmc21ReactionFlatContainerE", !310, i64 0}
!317 = distinct !{!317, !220}
!318 = !{!217, !218, i64 0}
!319 = !{!320, !199, i64 16}
!320 = !{!"_ZTSN6openmc11ThermalDataE", !321, i64 0, !321, i64 32}
!321 = !{!"_ZTSN6openmc11ThermalData8ReactionE", !193, i64 0, !322, i64 8, !199, i64 16, !328, i64 24}
!322 = !{!"_ZTSSt10unique_ptrIN6openmc24AngleEnergyFlatContainerESt14default_deleteIS1_EE", !323, i64 0}
!323 = !{!"_ZTSSt15__uniq_ptr_dataIN6openmc24AngleEnergyFlatContainerESt14default_deleteIS1_ELb1ELb1EE", !324, i64 0}
!324 = !{!"_ZTSSt15__uniq_ptr_implIN6openmc24AngleEnergyFlatContainerESt14default_deleteIS1_EE", !325, i64 0}
!325 = !{!"_ZTSSt5tupleIJPN6openmc24AngleEnergyFlatContainerESt14default_deleteIS1_EEE", !326, i64 0}
!326 = !{!"_ZTSSt11_Tuple_implILm0EJPN6openmc24AngleEnergyFlatContainerESt14default_deleteIS1_EEE", !327, i64 0}
!327 = !{!"_ZTSSt10_Head_baseILm0EPN6openmc24AngleEnergyFlatContainerELb0EE", !328, i64 0}
!328 = !{!"p1 _ZTSN6openmc24AngleEnergyFlatContainerE", !101, i64 0}
!329 = !{!320, !199, i64 48}
!330 = !{!269, !133, i64 224}
!331 = !{!269, !94, i64 232}
