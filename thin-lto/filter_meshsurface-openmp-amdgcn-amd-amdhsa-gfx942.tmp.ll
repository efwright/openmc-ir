; ModuleID = 'filter_meshsurface-openmp-amdgcn-amd-amdhsa-gfx942.tmp.bc'
...
entry:
  ...
  %starting_length = alloca i32, align 4, addrspace(5)
  %ending_length = alloca i32, align 4, addrspace(5)
  ...
  %starting_length.ascast = addrspacecast ptr addrspace(5) %starting_length to ptr
  %ending_length.ascast = addrspacecast ptr addrspace(5) %ending_length to ptr
  ...
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %starting_length) #7
  ...
  store i32 %1, ptr %starting_length.ascast, align 4, !tbaa !18
  %2 = load ptr, ptr addrspacecast (ptr addrspace(1) @_ZN6openmc5model6meshesE to ptr), align 8, !tbaa !34
  %mesh_ = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 19
  %3 = load i32, ptr %mesh_, align 8, !tbaa !36
  ...
  call void @_ZNK6openmc4Mesh20surface_bins_crossedERKNS_8ParticleERNS_11FilterMatchE(ptr noundef nonnull align 8 dereferenceable(112) %arrayidx, ptr noundef nonnull align 8 dereferenceable(2728) %4, ptr noundef nonnull align 8 dereferenceable(1513) %5) #9
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %ending_length) #7
  ...
  %7 = load i32, ptr %bins_weights_length_2, align 8, !tbaa !31
  store i32 %7, ptr %ending_length.ascast, align 4, !tbaa !18
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %i) #7
  %8 = load i32, ptr %starting_length.ascast, align 4, !tbaa !18
  store i32 %8, ptr %i.ascast, align 4, !tbaa !18
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %9 = load i32, ptr %i.ascast, align 4, !tbaa !18
  %10 = load i32, ptr %ending_length.ascast, align 4, !tbaa !18
...
for.body:                                         ; preds = %for.cond
  ...
  store double 1.000000e+00, ptr %arrayidx4, align 8, !tbaa !14
  br label %for.inc

for.inc:                                          ; preds = %for.body
  %13 = load i32, ptr %i.ascast, align 4, !tbaa !18
  %inc = add nsw i32 %13, 1
  store i32 %inc, ptr %i.ascast, align 4, !tbaa !18
  br label %for.cond, !llvm.loop !59

for.end:                                          ; preds = %for.cond.cleanup
  call void @llvm.lifetime.end.p5(i64 4, ptr addrspace(5) %ending_length) #7
  call void @llvm.lifetime.end.p5(i64 4, ptr addrspace(5) %starting_length) #7
  ret void
}

; Function Attrs: convergent
declare void @_ZNK6openmc4Mesh20surface_bins_crossedERKNS_8ParticleERNS_11FilterMatchE(ptr noundef nonnull align 8 dereferenceable(112), ptr noundef nonnull align 8 dereferenceable(2728), ptr noundef nonnull align 8 dereferenceable(1513)) #4
...
define internal double @__ocml_logb_f64(double noundef %0) #5 {
  ...
  %5 = load i8, ptr addrspace(4) @__oclc_finite_only_opt, align 1, !tbaa !61, !range !65, !noundef !66
  %6 = icmp eq i8 %5, 0
...
!33 = !{!"bool", !16, i64 0}
!34 = !{!35, !35, i64 0}
!35 = !{!"p1 _ZTSN6openmc4MeshE", !24, i64 0}
!36 = !{!37, !19, i64 344}
!37 = !{!"_ZTSN6openmc6FilterE", !38, i64 0, !19, i64 4, !19, i64 8, !39, i64 16, !40, i64 24, !42, i64 48, !44, i64 72, !50, i64 128, !52, i64 152, !42, i64 208, !19, i64 232, !33, i64 236, !40, i64 240, !15, i64 264, !40, i64 272, !15, i64 296, !15, i64 304, !19, i64 312, !42, i64 320, !19, i64 344, !56, i64 352, !57, i64 376, !58, i64 380, !15, i64 384, !15, i64 392, !42, i64 400, !42, i64 424}
!38 = !{!"_ZTSN6openmc6Filter10FilterTypeE", !16, i64 0}
!39 = !{!"long", !16, i64 0}
!40 = !{!"_ZTSN6openmc6vectorIdEE", !41, i64 0, !39, i64 8, !39, i64 16}
!41 = !{!"p1 double", !24, i64 0}
!42 = !{!"_ZTSN6openmc6vectorIiEE", !43, i64 0, !39, i64 8, !39, i64 16}
!43 = !{!"p1 int", !24, i64 0}
!44 = !{!"_ZTSN6openmc10static_mapIiiNS_12integer_hashIiEEEE", !45, i64 0, !47, i64 24, !33, i64 48, !49, i64 49}
!45 = !{!"_ZTSN6openmc6vectorISt4pairIiiEEE", !46, i64 0, !39, i64 8, !39, i64 16}
!46 = !{!"p1 _ZTSSt4pairIiiE", !24, i64 0}
!47 = !{!"_ZTSN6openmc6vectorISt4pairImmEEE", !48, i64 0, !39, i64 8, !39, i64 16}
!48 = !{!"p1 _ZTSSt4pairImmE", !24, i64 0}
!49 = !{!"_ZTSN6openmc12integer_hashIiEE"}
!50 = !{!"_ZTSN6openmc6vectorINS_12CellInstanceEEE", !51, i64 0, !39, i64 8, !39, i64 16}
!51 = !{!"p1 _ZTSN6openmc12CellInstanceE", !24, i64 0}
!52 = !{!"_ZTSN6openmc10static_mapINS_12CellInstanceElNS_16CellInstanceHashEEE", !53, i64 0, !47, i64 24, !33, i64 48, !55, i64 49}
!53 = !{!"_ZTSN6openmc6vectorISt4pairINS_12CellInstanceElEEE", !54, i64 0, !39, i64 8, !39, i64 16}
!54 = !{!"p1 _ZTSSt4pairIN6openmc12CellInstanceElE", !24, i64 0}
!55 = !{!"_ZTSN6openmc16CellInstanceHashE"}
!56 = !{!"_ZTSN6openmc6vectorINS_8Particle4TypeEEE", !24, i64 0, !39, i64 8, !39, i64 16}
!57 = !{!"_ZTSN6openmc24SphericalHarmonicsCosineE", !16, i64 0}
!58 = !{!"_ZTSN6openmc12LegendreAxisE", !16, i64 0}
!59 = distinct !{!59, !60}
