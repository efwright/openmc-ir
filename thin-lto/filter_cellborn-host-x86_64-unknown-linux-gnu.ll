; ModuleID = 'filter_cellborn-host-x86_64-unknown-linux-gnu.bc'
source_filename = "/g/g0/wright117/workspace/openmc/openmc-omp/openmc/src/tallies/filter_cellborn.cpp"
...
%"class.openmc::Cell" = type { i32, %"class.std::__cxx11::basic_string", i32, i32, i32, i32, i32, %"class.openmc::vector.0", %"class.openmc::vector", %"class.openmc::vector.0", i8, %"class.openmc::NeighborList", %"struct.openmc::Position", [12 x double], i32, %"class.openmc::vector.0" }
...
@.str = private unnamed_addr constant [12 x i8] c"Birth Cell \00", align 1
...
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_filter_cellborn.cpp, ptr null }]
...
entry:
  ...
  %0 = load ptr, ptr %p.addr, align 8, !tbaa !16
  %cell_born_ = getelementptr inbounds nuw %"class.openmc::Particle", ptr %0, i32 0, i32 31
  %1 = load i32, ptr %cell_born_, align 4, !tbaa !22
  %call = call noundef ptr @_ZNK6openmc10static_mapIiiNS_12integer_hashIiEEE4findEi(ptr noundef nonnull align 8 dereferenceable(50) %map_, i32 noundef %1)
  store ptr %call, ptr %search, align 8, !tbaa !40
  %2 = load ptr, ptr %search, align 8, !tbaa !40
  ...
  %cmp = icmp ne ptr %2, %call3
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %3 = load ptr, ptr %match.addr, align 8, !tbaa !20
  %4 = load ptr, ptr %search, align 8, !tbaa !40
  %second = getelementptr inbounds nuw %"struct.std::pair", ptr %4, i32 0, i32 1
  %5 = load i32, ptr %second, align 4, !tbaa !42
  call void @_ZN6openmc11FilterMatch9push_backEid(ptr noundef nonnull align 8 dereferenceable(1513) %3, i32 noundef %5, double noundef 1.000000e+00)
  br label %if.end
...
entry:
  ...
  store i32 %key, ptr %key.addr, align 4, !tbaa !46
  %this1 = load ptr, ptr %this.addr, align 8
  ...
  store i64 %call, ptr %idx, align 8, !tbaa !47
  ...
  %0 = load i64, ptr %idx, align 8, !tbaa !47
  ...
  %1 = load i64, ptr %second, align 8, !tbaa !48
  %add.ptr = getelementptr inbounds nuw %"struct.std::pair", ptr %call3, i64 %1
  store ptr %add.ptr, ptr %last, align 8, !tbaa !40
  ...
  %2 = load i64, ptr %first, align 8, !tbaa !50
  %add.ptr6 = getelementptr inbounds nuw %"struct.std::pair", ptr %call5, i64 %2
  store ptr %add.ptr6, ptr %iter, align 8, !tbaa !40
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %3 = load ptr, ptr %iter, align 8, !tbaa !40
  %4 = load ptr, ptr %last, align 8, !tbaa !40
  %cmp = icmp ne ptr %3, %4
...
for.body:                                         ; preds = %for.cond
  %5 = load i32, ptr %key.addr, align 4, !tbaa !46
  %6 = load ptr, ptr %iter, align 8, !tbaa !40
  %first7 = getelementptr inbounds nuw %"struct.std::pair", ptr %6, i32 0, i32 0
  %7 = load i32, ptr %first7, align 4, !tbaa !51
  %cmp8 = icmp eq i32 %5, %7
  br i1 %cmp8, label %if.then, label %if.end

if.then:                                          ; preds = %for.body
  %8 = load ptr, ptr %iter, align 8, !tbaa !40
...
for.inc:                                          ; preds = %if.end
  %9 = load ptr, ptr %iter, align 8, !tbaa !40
  %incdec.ptr = getelementptr inbounds nuw %"struct.std::pair", ptr %9, i32 1
  store ptr %incdec.ptr, ptr %iter, align 8, !tbaa !40
...
entry:
  ...
  store i32 %bin, ptr %bin.addr, align 4, !tbaa !46
  store double %weight, ptr %weight.addr, align 8, !tbaa !54
  %this1 = load ptr, ptr %this.addr, align 8
...
if.then:                                          ; preds = %entry
  %0 = load i32, ptr %bin.addr, align 4, !tbaa !46
  ...
  store i32 %0, ptr %arrayidx, align 4, !tbaa !46
  %2 = load double, ptr %weight.addr, align 8, !tbaa !54
  ...
  store double %2, ptr %arrayidx4, align 8, !tbaa !54
...
entry:
  ...
  store ptr %this, ptr %this.addr, align 8, !tbaa !44
  store ptr %key, ptr %key.addr, align 8, !tbaa !57
  %this1 = load ptr, ptr %this.addr, align 8
  %0 = getelementptr inbounds i8, ptr %this1, i64 49
  %1 = load ptr, ptr %key.addr, align 8, !tbaa !57
...
entry:
  ...
  store i64 %pos, ptr %pos.addr, align 8, !tbaa !47
  %this1 = load ptr, ptr %this.addr, align 8
  %data_ = getelementptr inbounds nuw %"class.openmc::vector.2", ptr %this1, i32 0, i32 0
  %0 = load ptr, ptr %data_, align 8, !tbaa !61
  %1 = load i64, ptr %pos.addr, align 8, !tbaa !47
...
entry:
  ...
  store i32 %value, ptr %value.addr, align 4, !tbaa !46
  %this1 = load ptr, ptr %this.addr, align 8
  %0 = load i32, ptr %value.addr, align 4, !tbaa !46
...
entry:
  ...
  %0 = load i64, ptr %size_, align 8, !tbaa !71
  ret i64 %0
}
...
; Function Attrs: mustprogress uwtable
define void @_ZNK6openmc6Filter25CellbornFilter_text_labelB5cxx11Ei(ptr dead_on_unwind noalias writable sret(%"class.std::__cxx11::basic_string") align 8 %agg.result, ptr noundef nonnull align 8 dereferenceable(448) %this, i32 noundef %bin) #4 align 2 personality ptr @__gxx_personality_v0 {
entry:
  ...
  %1 = load i32, ptr %call, align 4, !tbaa !46
  ...
  %2 = load i32, ptr %id_, align 8, !tbaa !72
...
entry:
  ...
  store ptr %agg.result, ptr %result.ptr, align 8
  store ptr %__lhs, ptr %__lhs.addr, align 8, !tbaa !82
  store ptr %__rhs, ptr %__rhs.addr, align 8, !tbaa !83
  %0 = load ptr, ptr %__rhs.addr, align 8, !tbaa !83
  %1 = load ptr, ptr %__lhs.addr, align 8, !tbaa !82
...
entry:
  ...
  store ptr %agg.result, ptr %result.ptr, align 8
  store i32 %__val, ptr %__val.addr, align 4, !tbaa !46
  call void @llvm.lifetime.start.p0(i64 1, ptr %__neg) #3
  %0 = load i32, ptr %__val.addr, align 4, !tbaa !46
  %cmp = icmp slt i32 %0, 0
  %storedv = zext i1 %cmp to i8
  store i8 %storedv, ptr %__neg, align 1, !tbaa !85
  call void @llvm.lifetime.start.p0(i64 4, ptr %__uval) #3
  %1 = load i8, ptr %__neg, align 1, !tbaa !85, !range !86, !noundef !87
  %loadedv = trunc i8 %1 to i1
  br i1 %loadedv, label %cond.true, label %cond.false

cond.true:                                        ; preds = %entry
  %2 = load i32, ptr %__val.addr, align 4, !tbaa !46
  %not = xor i32 %2, -1
  %add = add i32 %not, 1
  br label %cond.end

cond.false:                                       ; preds = %entry
  %3 = load i32, ptr %__val.addr, align 4, !tbaa !46
  br label %cond.end

cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32 [ %add, %cond.true ], [ %3, %cond.false ]
  store i32 %cond, ptr %__uval, align 4, !tbaa !46
  call void @llvm.lifetime.start.p0(i64 4, ptr %__len) #3
  %4 = load i32, ptr %__uval, align 4, !tbaa !46
  %call = call noundef i32 @_ZNSt8__detail14__to_chars_lenIjEEjT_i(i32 noundef %4, i32 noundef 10) #3
  store i32 %call, ptr %__len, align 4, !tbaa !46
  store i1 false, ptr %nrvo, align 1
  %5 = load i8, ptr %__neg, align 1, !tbaa !85, !range !86, !noundef !87
  %loadedv1 = trunc i8 %5 to i1
  %conv = zext i1 %loadedv1 to i32
  %6 = load i32, ptr %__len, align 4, !tbaa !46
  %add2 = add i32 %conv, %6
...
invoke.cont:                                      ; preds = %cond.end
  ...
  %7 = load i8, ptr %__neg, align 1, !tbaa !85, !range !86, !noundef !87
...
invoke.cont6:                                     ; preds = %invoke.cont
  %8 = load i32, ptr %__len, align 4, !tbaa !46
  %9 = load i32, ptr %__uval, align 4, !tbaa !46
...
entry:
  ...
  %0 = load ptr, ptr %data_, align 8, !tbaa !95
  %1 = load i64, ptr %pos.addr, align 8, !tbaa !47
...
entry:
  ...
  store ptr %__s, ptr %__s.addr, align 8, !tbaa !82
  %this1 = load ptr, ptr %this.addr, align 8
  %0 = load i64, ptr %__pos.addr, align 8, !tbaa !47
  %1 = load ptr, ptr %__s.addr, align 8, !tbaa !82
  %2 = load ptr, ptr %__s.addr, align 8, !tbaa !82
...
entry:
  ...
  store ptr %this, ptr %this.addr, align 8, !tbaa !83
  store ptr %__str, ptr %__str.addr, align 8, !tbaa !83
  %this1 = load ptr, ptr %this.addr, align 8
  %_M_dataplus = getelementptr inbounds nuw %"class.std::__cxx11::basic_string", ptr %this1, i32 0, i32 0
...
invoke.cont:                                      ; preds = %entry
  %0 = load ptr, ptr %__str.addr, align 8, !tbaa !83
...
invoke.cont4:                                     ; preds = %invoke.cont2
  %1 = load ptr, ptr %__str.addr, align 8, !tbaa !83
...
if.then:                                          ; preds = %invoke.cont5
  ...
  %3 = load ptr, ptr %__str.addr, align 8, !tbaa !83
  %4 = getelementptr inbounds nuw %"class.std::__cxx11::basic_string", ptr %3, i32 0, i32 2
  %arraydecay7 = getelementptr inbounds [16 x i8], ptr %4, i64 0, i64 0
  %5 = load ptr, ptr %__str.addr, align 8, !tbaa !83
...
if.else:                                          ; preds = %invoke.cont5
  %6 = load ptr, ptr %__str.addr, align 8, !tbaa !83
...
invoke.cont13:                                    ; preds = %invoke.cont11
  %7 = load ptr, ptr %__str.addr, align 8, !tbaa !83
...
if.end:                                           ; preds = %invoke.cont14, %invoke.cont9
  %10 = load ptr, ptr %__str.addr, align 8, !tbaa !83
...
invoke.cont16:                                    ; preds = %if.end
  %11 = load ptr, ptr %__str.addr, align 8, !tbaa !83
  %12 = load ptr, ptr %__str.addr, align 8, !tbaa !83
...
invoke.cont19:                                    ; preds = %invoke.cont17
  %13 = load ptr, ptr %__str.addr, align 8, !tbaa !83
...
entry:
  ...
  %3 = load ptr, ptr %__s.addr, align 8, !tbaa !82
...
entry:
  %__s.addr = alloca ptr, align 8
  store ptr %__s, ptr %__s.addr, align 8, !tbaa !82
  %0 = load ptr, ptr %__s.addr, align 8, !tbaa !82
...
entry:
  ...
  %2 = load i8, ptr %__testoff, align 1, !tbaa !85, !range !86, !noundef !87
...
entry:
  ...
  store ptr %__dat, ptr %__dat.addr, align 8, !tbaa !82
  store ptr %__a, ptr %__a.addr, align 8, !tbaa !100
  %this1 = load ptr, ptr %this.addr, align 8
  %0 = load ptr, ptr %__a.addr, align 8, !tbaa !100
  ...
  %1 = load ptr, ptr %__dat.addr, align 8, !tbaa !82
...
entry:
  ...
  %__n.addr = alloca i64, align 8
  store ptr %__s1, ptr %__s1.addr, align 8, !tbaa !82
  store ptr %__s2, ptr %__s2.addr, align 8, !tbaa !82
  store i64 %__n, ptr %__n.addr, align 8, !tbaa !47
...
if.then:                                          ; preds = %entry
  %1 = load ptr, ptr %__s1.addr, align 8, !tbaa !82
  store ptr %1, ptr %retval, align 8
  br label %return

if.end:                                           ; preds = %entry
  %2 = load ptr, ptr %__s1.addr, align 8, !tbaa !82
  %3 = load ptr, ptr %__s2.addr, align 8, !tbaa !82
...
entry:
  ...
  store ptr %this, ptr %this.addr, align 8, !tbaa !83
  store ptr %__p, ptr %__p.addr, align 8, !tbaa !82
  %this1 = load ptr, ptr %this.addr, align 8
  %0 = load ptr, ptr %__p.addr, align 8, !tbaa !82
  %_M_dataplus = getelementptr inbounds nuw %"class.std::__cxx11::basic_string", ptr %this1, i32 0, i32 0
...
entry:
  ...
  store ptr %__r, ptr %__r.addr, align 8, !tbaa !82
  %0 = load ptr, ptr %__r.addr, align 8, !tbaa !82
  ret ptr %0
}
...
entry:
  ...
  store ptr %__c1, ptr %__c1.addr, align 8, !tbaa !82
  store ptr %__c2, ptr %__c2.addr, align 8, !tbaa !82
  %0 = load ptr, ptr %__c2.addr, align 8, !tbaa !82
  %1 = load i8, ptr %0, align 1, !tbaa !96
  %2 = load ptr, ptr %__c1.addr, align 8, !tbaa !82
...
entry:
  ...
  %cleanup.dest.slot = alloca i32, align 4
  store i32 %__value, ptr %__value.addr, align 4, !tbaa !46
  store i32 %__base, ptr %__base.addr, align 4, !tbaa !46
  call void @llvm.lifetime.start.p0(i64 4, ptr %__n) #3
  store i32 1, ptr %__n, align 4, !tbaa !46
  call void @llvm.lifetime.start.p0(i64 4, ptr %__b2) #3
  %0 = load i32, ptr %__base.addr, align 4, !tbaa !46
  %1 = load i32, ptr %__base.addr, align 4, !tbaa !46
  %mul = mul nsw i32 %0, %1
  store i32 %mul, ptr %__b2, align 4, !tbaa !46
  call void @llvm.lifetime.start.p0(i64 4, ptr %__b3) #3
  %2 = load i32, ptr %__b2, align 4, !tbaa !46
  %3 = load i32, ptr %__base.addr, align 4, !tbaa !46
  %mul1 = mul i32 %2, %3
  store i32 %mul1, ptr %__b3, align 4, !tbaa !46
  call void @llvm.lifetime.start.p0(i64 8, ptr %__b4) #3
  %4 = load i32, ptr %__b3, align 4, !tbaa !46
  %5 = load i32, ptr %__base.addr, align 4, !tbaa !46
  %mul2 = mul i32 %4, %5
  %conv = zext i32 %mul2 to i64
  store i64 %conv, ptr %__b4, align 8, !tbaa !47
  br label %for.cond

for.cond:                                         ; preds = %if.end14, %entry
  %6 = load i32, ptr %__value.addr, align 4, !tbaa !46
  %7 = load i32, ptr %__base.addr, align 4, !tbaa !46
  %cmp = icmp ult i32 %6, %7
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %for.cond
  %8 = load i32, ptr %__n, align 4, !tbaa !46
  store i32 %8, ptr %retval, align 4
  store i32 1, ptr %cleanup.dest.slot, align 4
  br label %cleanup

if.end:                                           ; preds = %for.cond
  %9 = load i32, ptr %__value.addr, align 4, !tbaa !46
  %10 = load i32, ptr %__b2, align 4, !tbaa !46
  %cmp3 = icmp ult i32 %9, %10
  br i1 %cmp3, label %if.then4, label %if.end5

if.then4:                                         ; preds = %if.end
  %11 = load i32, ptr %__n, align 4, !tbaa !46
  %add = add i32 %11, 1
...
if.end5:                                          ; preds = %if.end
  %12 = load i32, ptr %__value.addr, align 4, !tbaa !46
  %13 = load i32, ptr %__b3, align 4, !tbaa !46
  %cmp6 = icmp ult i32 %12, %13
  br i1 %cmp6, label %if.then7, label %if.end9

if.then7:                                         ; preds = %if.end5
  %14 = load i32, ptr %__n, align 4, !tbaa !46
  %add8 = add i32 %14, 2
...
if.end9:                                          ; preds = %if.end5
  %15 = load i32, ptr %__value.addr, align 4, !tbaa !46
  %conv10 = zext i32 %15 to i64
  %16 = load i64, ptr %__b4, align 8, !tbaa !47
  %cmp11 = icmp ult i64 %conv10, %16
  br i1 %cmp11, label %if.then12, label %if.end14

if.then12:                                        ; preds = %if.end9
  %17 = load i32, ptr %__n, align 4, !tbaa !46
  %add13 = add i32 %17, 3
...
if.end14:                                         ; preds = %if.end9
  %18 = load i64, ptr %__b4, align 8, !tbaa !47
  %19 = load i32, ptr %__value.addr, align 4, !tbaa !46
  %conv15 = zext i32 %19 to i64
  %div = udiv i64 %conv15, %18
  %conv16 = trunc i64 %div to i32
  store i32 %conv16, ptr %__value.addr, align 4, !tbaa !46
  %20 = load i32, ptr %__n, align 4, !tbaa !46
  %add17 = add i32 %20, 4
  store i32 %add17, ptr %__n, align 4, !tbaa !46
...
entry:
  ...
  store ptr %this, ptr %this.addr, align 8, !tbaa !83
  store i64 %__n, ptr %__n.addr, align 8, !tbaa !47
  store i8 %__c, ptr %__c.addr, align 1, !tbaa !96
  store ptr %__a, ptr %__a.addr, align 8, !tbaa !100
  %this1 = load ptr, ptr %this.addr, align 8
  %_M_dataplus = getelementptr inbounds nuw %"class.std::__cxx11::basic_string", ptr %this1, i32 0, i32 0
  ...
  %1 = load i64, ptr %__n.addr, align 8, !tbaa !47
  %2 = load i8, ptr %__c.addr, align 1, !tbaa !96
...
entry:
  ...
  store ptr %__first, ptr %__first.addr, align 8, !tbaa !82
  store i32 %__len, ptr %__len.addr, align 4, !tbaa !46
  store i32 %__val, ptr %__val.addr, align 4, !tbaa !46
  call void @llvm.lifetime.start.p0(i64 4, ptr %__pos) #3
  %0 = load i32, ptr %__len.addr, align 4, !tbaa !46
  %sub = sub i32 %0, 1
  store i32 %sub, ptr %__pos, align 4, !tbaa !46
  br label %while.cond

while.cond:                                       ; preds = %while.body, %entry
  %1 = load i32, ptr %__val.addr, align 4, !tbaa !46
...
while.body:                                       ; preds = %while.cond
  ...
  %rem = urem i32 %2, 100
  %mul = mul i32 %rem, 2
  store i32 %mul, ptr %__num, align 4, !tbaa !46
  %3 = load i32, ptr %__val.addr, align 4, !tbaa !46
  %div = udiv i32 %3, 100
  store i32 %div, ptr %__val.addr, align 4, !tbaa !46
  %4 = load i32, ptr %__num, align 4, !tbaa !46
  %add = add i32 %4, 1
  ...
  %5 = load i8, ptr %arrayidx, align 1, !tbaa !96
  %6 = load ptr, ptr %__first.addr, align 8, !tbaa !82
  %7 = load i32, ptr %__pos, align 4, !tbaa !46
  %idxprom1 = zext i32 %7 to i64
  %arrayidx2 = getelementptr inbounds nuw i8, ptr %6, i64 %idxprom1
  store i8 %5, ptr %arrayidx2, align 1, !tbaa !96
  %8 = load i32, ptr %__num, align 4, !tbaa !46
  ...
  %9 = load i8, ptr %arrayidx4, align 1, !tbaa !96
  %10 = load ptr, ptr %__first.addr, align 8, !tbaa !82
  %11 = load i32, ptr %__pos, align 4, !tbaa !46
  %sub5 = sub i32 %11, 1
  %idxprom6 = zext i32 %sub5 to i64
  %arrayidx7 = getelementptr inbounds nuw i8, ptr %10, i64 %idxprom6
  store i8 %9, ptr %arrayidx7, align 1, !tbaa !96
  %12 = load i32, ptr %__pos, align 4, !tbaa !46
  %sub8 = sub i32 %12, 2
  store i32 %sub8, ptr %__pos, align 4, !tbaa !46
  call void @llvm.lifetime.end.p0(i64 4, ptr %__num) #3
  br label %while.cond, !llvm.loop !107

while.end:                                        ; preds = %while.cond
  %13 = load i32, ptr %__val.addr, align 4, !tbaa !46
  %cmp9 = icmp uge i32 %13, 10
  br i1 %cmp9, label %if.then, label %if.else

if.then:                                          ; preds = %while.end
  call void @llvm.lifetime.start.p0(i64 4, ptr %__num10) #3
  %14 = load i32, ptr %__val.addr, align 4, !tbaa !46
  %mul11 = mul i32 %14, 2
  store i32 %mul11, ptr %__num10, align 4, !tbaa !46
  %15 = load i32, ptr %__num10, align 4, !tbaa !46
  %add12 = add i32 %15, 1
  ...
  %16 = load i8, ptr %arrayidx14, align 1, !tbaa !96
  %17 = load ptr, ptr %__first.addr, align 8, !tbaa !82
  %arrayidx15 = getelementptr inbounds i8, ptr %17, i64 1
  store i8 %16, ptr %arrayidx15, align 1, !tbaa !96
  %18 = load i32, ptr %__num10, align 4, !tbaa !46
  ...
  %19 = load i8, ptr %arrayidx17, align 1, !tbaa !96
  %20 = load ptr, ptr %__first.addr, align 8, !tbaa !82
  %arrayidx18 = getelementptr inbounds i8, ptr %20, i64 0
  store i8 %19, ptr %arrayidx18, align 1, !tbaa !96
  call void @llvm.lifetime.end.p0(i64 4, ptr %__num10) #3
  br label %if.end

if.else:                                          ; preds = %while.end
  %21 = load i32, ptr %__val.addr, align 4, !tbaa !46
  %add19 = add i32 48, %21
  %conv = trunc i32 %add19 to i8
  %22 = load ptr, ptr %__first.addr, align 8, !tbaa !82
  %arrayidx20 = getelementptr inbounds i8, ptr %22, i64 0
  store i8 %conv, ptr %arrayidx20, align 1, !tbaa !96
  br label %if.end
...
entry:
  ...
  store i64 %__n, ptr %__n.addr, align 8, !tbaa !47
  %0 = load ptr, ptr %__a.addr, align 8, !tbaa !100
  %1 = load ptr, ptr %__p.addr, align 8, !tbaa !82
...
; Function Attrs: uwtable
define internal void @_GLOBAL__sub_I_filter_cellborn.cpp() #0 section ".text.startup" {
entry:
...
!22 = !{!23, !29, i64 1596}
!23 = !{!"_ZTSN6openmc8ParticleE", !24, i64 0, !14, i64 168, !25, i64 744, !27, i64 864, !28, i64 872, !29, i64 876, !29, i64 880, !14, i64 888, !29, i64 1368, !14, i64 1372, !26, i64 1400, !26, i64 1408, !29, i64 1416, !29, i64 1420, !26, i64 1424, !26, i64 1432, !30, i64 1440, !30, i64 1464, !30, i64 1488, !26, i64 1512, !31, i64 1520, !32, i64 1524, !29, i64 1528, !29, i64 1532, !29, i64 1536, !29, i64 1540, !29, i64 1544, !26, i64 1552, !14, i64 1560, !29, i64 1592, !29, i64 1596, !29, i64 1600, !29, i64 1604, !33, i64 1608, !26, i64 1640, !26, i64 1648, !29, i64 1656, !31, i64 1660, !14, i64 1664, !29, i64 1728, !14, i64 1736, !27, i64 2216, !27, i64 2224, !14, i64 2232, !21, i64 2240, !35, i64 2248, !14, i64 2272, !26, i64 2656, !26, i64 2664, !26, i64 2672, !26, i64 2680, !31, i64 2688, !26, i64 2696, !26, i64 2704, !29, i64 2712, !27, i64 2720}
!24 = !{!"_ZTSN6openmc19NuclideMicroXSCacheE", !14, i64 0}
!25 = !{!"_ZTSN6openmc7MacroXSE", !26, i64 0, !26, i64 8, !26, i64 16, !26, i64 24, !26, i64 32, !14, i64 40, !26, i64 88, !26, i64 96, !26, i64 104, !26, i64 112}
!26 = !{!"double", !14, i64 0}
!27 = !{!"long", !14, i64 0}
!28 = !{!"_ZTSN6openmc8Particle4TypeE", !14, i64 0}
!29 = !{!"int", !14, i64 0}
!30 = !{!"_ZTSN6openmc8PositionE", !26, i64 0, !26, i64 8, !26, i64 16}
!31 = !{!"bool", !14, i64 0}
!32 = !{!"_ZTSN6openmc10TallyEventE", !14, i64 0}
!33 = !{!"_ZTSN6openmc12BoundaryInfoE", !26, i64 0, !29, i64 8, !29, i64 12, !34, i64 16}
!34 = !{!"_ZTSSt5arrayIiLm3EE", !14, i64 0}
...
!39 = !{!"p1 _ZTSSt6vectorIN6openmc8PositionESaIS1_EE", !13, i64 0}
!40 = !{!41, !41, i64 0}
!41 = !{!"p1 _ZTSSt4pairIiiE", !13, i64 0}
!42 = !{!43, !29, i64 4}
!43 = !{!"_ZTSSt4pairIiiE", !29, i64 0, !29, i64 4}
!44 = !{!45, !45, i64 0}
!45 = !{!"p1 _ZTSN6openmc10static_mapIiiNS_12integer_hashIiEEEE", !13, i64 0}
!46 = !{!29, !29, i64 0}
!47 = !{!27, !27, i64 0}
!48 = !{!49, !27, i64 8}
!49 = !{!"_ZTSSt4pairImmE", !27, i64 0, !27, i64 8}
!50 = !{!49, !27, i64 0}
!51 = !{!43, !29, i64 0}
!52 = distinct !{!52, !53}
...
!54 = !{!26, !26, i64 0}
!55 = !{!56, !29, i64 1504}
!56 = !{!"_ZTSN6openmc11FilterMatchE", !14, i64 0, !14, i64 504, !29, i64 1504, !29, i64 1508, !31, i64 1512}
!57 = !{!58, !58, i64 0}
!58 = !{!"p1 int", !13, i64 0}
!59 = !{!60, !60, i64 0}
!60 = !{!"p1 _ZTSN6openmc6vectorISt4pairImmEEE", !13, i64 0}
!61 = !{!62, !63, i64 0}
!62 = !{!"_ZTSN6openmc6vectorISt4pairImmEEE", !63, i64 0, !27, i64 8, !27, i64 16}
!63 = !{!"p1 _ZTSSt4pairImmE", !13, i64 0}
!64 = !{!65, !65, i64 0}
!65 = !{!"p1 _ZTSN6openmc6vectorISt4pairIiiEEE", !13, i64 0}
!66 = !{!67, !41, i64 0}
!67 = !{!"_ZTSN6openmc6vectorISt4pairIiiEEE", !41, i64 0, !27, i64 8, !27, i64 16}
!68 = !{!67, !27, i64 8}
!69 = !{!70, !70, i64 0}
!70 = !{!"p1 _ZTSN6openmc12integer_hashIiEE", !13, i64 0}
!71 = !{!62, !27, i64 8}
!72 = !{!73, !29, i64 0}
!73 = !{!"_ZTSN6openmc4CellE", !29, i64 0, !74, i64 8, !77, i64 40, !29, i64 44, !29, i64 48, !29, i64 52, !29, i64 56, !78, i64 64, !79, i64 88, !78, i64 112, !31, i64 136, !81, i64 140, !30, i64 344, !14, i64 368, !29, i64 464, !78, i64 472}
!74 = !{!"_ZTSNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE", !75, i64 0, !27, i64 8, !14, i64 16}
!75 = !{!"_ZTSNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE12_Alloc_hiderE", !76, i64 0}
!76 = !{!"p1 omnipotent char", !13, i64 0}
!77 = !{!"_ZTSN6openmc4FillE", !14, i64 0}
!78 = !{!"_ZTSN6openmc6vectorIiEE", !58, i64 0, !27, i64 8, !27, i64 16}
!79 = !{!"_ZTSN6openmc6vectorIdEE", !80, i64 0, !27, i64 8, !27, i64 16}
!80 = !{!"p1 double", !13, i64 0}
!81 = !{!"_ZTSN6openmc12NeighborListE", !14, i64 0}
!82 = !{!76, !76, i64 0}
!83 = !{!84, !84, i64 0}
...
!87 = !{}
!88 = !{!89, !89, i64 0}
!89 = !{!"p1 _ZTSSt6vectorIN6openmc4CellESaIS1_EE", !13, i64 0}
!90 = !{!91, !92, i64 0}
!91 = !{!"_ZTSNSt12_Vector_baseIN6openmc4CellESaIS1_EE17_Vector_impl_dataE", !92, i64 0, !92, i64 8, !92, i64 16}
!92 = !{!"p1 _ZTSN6openmc4CellE", !13, i64 0}
!93 = !{!94, !94, i64 0}
!94 = !{!"p1 _ZTSN6openmc6vectorIiEE", !13, i64 0}
!95 = !{!78, !58, i64 0}
!96 = !{!14, !14, i64 0}
!97 = !{!74, !27, i64 8}
!98 = !{!99, !99, i64 0}
!99 = !{!"p1 _ZTSNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE12_Alloc_hiderE", !13, i64 0}
!100 = !{!101, !101, i64 0}
!101 = !{!"p1 _ZTSSaIcE", !13, i64 0}
!102 = !{!75, !76, i64 0}
!103 = !{!74, !76, i64 0}
!104 = !{!105, !105, i64 0}
!105 = !{!"p1 _ZTSSt15__new_allocatorIcE", !13, i64 0}
!106 = distinct !{!106, !53}
!107 = distinct !{!107, !53}
