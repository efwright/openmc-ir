; ModuleID = 'secondary_uncorrelated.cpp-amdgcn-amd-amdhsa-gfx942.o.3.import.bc'
...
entry:
  store ptr %data, ptr %this, align 8, !tbaa !25
  %0 = load i32, ptr %data, align 4, !tbaa !21
  %conv = sext i32 %0 to i64
  %n_ = getelementptr inbounds nuw i8, ptr %this, i64 8
  store i64 %conv, ptr %n_, align 8, !tbaa !28
  ret void
}
...
entry:
  ...
  store ptr %data, ptr %data_, align 8, !tbaa !29
  %0 = load i32, ptr %data, align 4, !tbaa !21
  store i32 %0, ptr %this, align 8, !tbaa !32
  ret void
}
...
!opencl.ocl.version = !{!12, !12, !12}
!llvm.ident = !{!13, !14, !13, !14, !13, !14}
...
!24 = !{!"double", !19, i64 0}
!25 = !{!26, !17, i64 0}
!26 = !{!"_ZTSN6openmc21AngleDistributionFlatE", !17, i64 0, !27, i64 8}
!27 = !{!"long", !19, i64 0}
!28 = !{!26, !27, i64 8}
!29 = !{!30, !17, i64 8}
!30 = !{!"_ZTSN6openmc22EnergyDistributionFlatE", !31, i64 0, !17, i64 8}
!31 = !{!"_ZTSN6openmc14EnergyDistTypeE", !19, i64 0}
!32 = !{!30, !31, i64 0}
