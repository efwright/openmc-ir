; ModuleID = 'filter_surface.cpp-amdgcn-amd-amdhsa-gfx942.o.2.internalize.bc'
...
define hidden void @_ZNK6openmc6Filter26SurfaceFilter_get_all_binsERKNS_8ParticleENS_14TallyEstimatorERNS_11FilterMatchE(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(448) %this, ptr noundef nonnull readonly align 8 captures(none) dereferenceable(2728) %p, i32 noundef %estimator, ptr noundef nonnull align 8 captures(none) dereferenceable(1513) %match) local_unnamed_addr #2 align 2 {
entry:
  ...
  %1 = tail call noundef range(i32 0, -2147483648) i32 @llvm.abs.i32(i32 %0, i1 true) #3, !range !37
  %sub = add nsw i32 %1, -1
...
for.body.i:                                       ; preds = %for.inc.i, %for.body.preheader.i
  ...
  %3 = load i32, ptr %iter.07.i, align 4, !tbaa !45
...
for.end.i:                                        ; preds = %for.inc.i, %entry
  ...
  %this.val4.i = load i64, ptr %4, align 8, !tbaa !49
...
if.then:                                          ; preds = %_ZNK6openmc10static_mapIiiNS_12integer_hashIiEEE4findEi.internalized.exit
  ...
  %this.val.i7 = load i32, ptr %5, align 8, !tbaa !50
...
if.end9.sink.split:                               ; preds = %if.then
  ...
  store i32 %inc.i16, ptr %5, align 8, !tbaa !50
  br label %if.end9
