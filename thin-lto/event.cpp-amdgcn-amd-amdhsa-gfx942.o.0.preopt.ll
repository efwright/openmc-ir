; ModuleID = 'event.cpp-amdgcn-amd-amdhsa-gfx942.o.0.preopt.bc'
...
user_code.entry:                                  ; preds = %entry
  ...
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %not_sorted1.i) #15, !noalias !40
...
omp.precond.then.i:                               ; preds = %user_code.entry
  ...
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.comb.lb.i) #15, !noalias !40
  store i32 0, ptr addrspace(5) %.omp.comb.lb.i, align 4, !tbaa !43, !noalias !40
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.comb.ub.i) #15, !noalias !40
  store i32 %sub4.i, ptr addrspace(5) %.omp.comb.ub.i, align 4, !tbaa !43, !noalias !40
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.stride.i) #15, !noalias !40
  store i32 1, ptr addrspace(5) %.omp.stride.i, align 4, !tbaa !43, !noalias !40
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.is_last.i) #15, !noalias !40
...
omp.precond.then.i:                               ; preds = %user_code.entry
  ...
  %.omp.comb.ub.ascast.i = addrspacecast ptr addrspace(5) %.omp.comb.ub.i to ptr
  %.omp.comb.lb.ascast.i = addrspacecast ptr addrspace(5) %.omp.comb.lb.i to ptr
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.comb.lb.i) #15, !noalias !57
  store i32 0, ptr addrspace(5) %.omp.comb.lb.i, align 4, !tbaa !43, !noalias !57
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.comb.ub.i) #15, !noalias !57
  store i32 %sub2.i, ptr addrspace(5) %.omp.comb.ub.i, align 4, !tbaa !43, !noalias !57
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.stride.i) #15, !noalias !57
  store i32 1, ptr addrspace(5) %.omp.stride.i, align 4, !tbaa !43, !noalias !57
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.is_last.i) #15, !noalias !57
...
define hidden void @_ZN6openmc17dispatch_xs_eventEi(i32 noundef %buffer_idx) local_unnamed_addr #11 {
entry:
  %0 = load ptr, ptr addrspace(1) @_ZN6openmc10simulation16device_particlesE, align 8, !tbaa !60
  %idxprom = sext i32 %buffer_idx to i64
  %arrayidx = getelementptr inbounds %"class.openmc::Particle", ptr %0, i64 %idxprom
  %call = tail call noundef zeroext i1 @_ZN6openmc8Particle27event_calculate_xs_dispatchEv(ptr noundef nonnull align 8 dereferenceable(2728) %arrayidx) #5
  %n_coord_ = getelementptr inbounds nuw i8, ptr %arrayidx, i64 876
  %1 = load i32, ptr %n_coord_, align 4, !tbaa !62
  %sub = add nsw i32 %1, -1
  %idxprom1 = sext i32 %sub to i64
  %cell.idx = mul nsw i64 %idxprom1, 80
  %2 = getelementptr i8, ptr %arrayidx, i64 936
  %cell = getelementptr i8, ptr %2, i64 %cell.idx
  %3 = load i32, ptr %cell, align 8, !tbaa !80
  %surface_index = getelementptr inbounds nuw i8, ptr %arrayidx, i64 1616
  %4 = load i32, ptr %surface_index, align 8, !tbaa !82
  br i1 %call, label %if.then, label %if.else12

if.then:                                          ; preds = %entry
  %5 = load ptr, ptr addrspace(1) @_ZN6openmc5model9materialsE, align 8, !tbaa !83
  %material_ = getelementptr inbounds nuw i8, ptr %arrayidx, i64 1600
  %6 = load i32, ptr %material_, align 8, !tbaa !85
  %idxprom3 = sext i32 %6 to i64
  %fissionable_ = getelementptr inbounds %"class.openmc::Material", ptr %5, i64 %idxprom3, i32 8
  %7 = load i8, ptr %fissionable_, align 8, !tbaa !86, !range !123, !noundef !124
  %loadedv5 = trunc nuw i8 %7 to i1
  %E_10 = getelementptr inbounds nuw i8, ptr %arrayidx, i64 1400
  %8 = load double, ptr %E_10, align 8, !tbaa !125
  br i1 %loadedv5, label %if.else, label %if.then6

if.then6:                                         ; preds = %if.then
  %9 = atomicrmw add ptr addrspace(1) getelementptr inbounds nuw (i8, ptr addrspace(1) @_ZN6openmc10simulation26calculate_nonfuel_xs_queueE, i64 16), i32 1 monotonic, align 8, !amdgpu.no.fine.grained.memory !124, !amdgpu.no.remote.memory !124
  %10 = load i32, ptr addrspace(1) getelementptr inbounds nuw (i8, ptr addrspace(1) @_ZN6openmc10simulation26calculate_nonfuel_xs_queueE, i64 20), align 4, !tbaa !126
  %cmp.not.i = icmp slt i32 %9, %10
  br i1 %cmp.not.i, label %if.end.i, label %if.then.i

if.then.i:                                        ; preds = %if.then6
  store atomic i32 %10, ptr addrspace(1) getelementptr inbounds nuw (i8, ptr addrspace(1) @_ZN6openmc10simulation26calculate_nonfuel_xs_queueE, i64 16) monotonic, align 4, !tbaa !47
  br label %if.end16

if.end.i:                                         ; preds = %if.then6
  %conv.i = fptrunc double %8 to float
  %11 = load ptr, ptr addrspace(1) @_ZN6openmc10simulation26calculate_nonfuel_xs_queueE, align 8, !tbaa !53
  %idxprom.i = sext i32 %9 to i64
  %arrayidx.i = getelementptr inbounds %"struct.openmc::EventQueueItem", ptr %11, i64 %idxprom.i
  store i32 %buffer_idx, ptr %arrayidx.i, align 4, !tbaa !43
  %ref.tmp.sroa.4.0.arrayidx.i.sroa_idx = getelementptr inbounds nuw i8, ptr %arrayidx.i, i64 4
  store i32 %6, ptr %ref.tmp.sroa.4.0.arrayidx.i.sroa_idx, align 4, !tbaa !43
  %ref.tmp.sroa.5.0.arrayidx.i.sroa_idx = getelementptr inbounds nuw i8, ptr %arrayidx.i, i64 8
  store float %conv.i, ptr %ref.tmp.sroa.5.0.arrayidx.i.sroa_idx, align 4, !tbaa !127
  %ref.tmp.sroa.6.0.arrayidx.i.sroa_idx = getelementptr inbounds nuw i8, ptr %arrayidx.i, i64 12
  store i32 %3, ptr %ref.tmp.sroa.6.0.arrayidx.i.sroa_idx, align 4, !tbaa !43
  %ref.tmp.sroa.7.0.arrayidx.i.sroa_idx = getelementptr inbounds nuw i8, ptr %arrayidx.i, i64 16
  store i32 %4, ptr %ref.tmp.sroa.7.0.arrayidx.i.sroa_idx, align 4, !tbaa !43
  br label %if.end16

if.else:                                          ; preds = %if.then
  %12 = atomicrmw add ptr addrspace(1) getelementptr inbounds nuw (i8, ptr addrspace(1) @_ZN6openmc10simulation23calculate_fuel_xs_queueE, i64 16), i32 1 monotonic, align 8, !amdgpu.no.fine.grained.memory !124, !amdgpu.no.remote.memory !124
  %13 = load i32, ptr addrspace(1) getelementptr inbounds nuw (i8, ptr addrspace(1) @_ZN6openmc10simulation23calculate_fuel_xs_queueE, i64 20), align 4, !tbaa !126
  %cmp.not.i21 = icmp slt i32 %12, %13
  br i1 %cmp.not.i21, label %if.end.i24, label %if.then.i22

if.then.i22:                                      ; preds = %if.else
  store atomic i32 %13, ptr addrspace(1) getelementptr inbounds nuw (i8, ptr addrspace(1) @_ZN6openmc10simulation23calculate_fuel_xs_queueE, i64 16) monotonic, align 4, !tbaa !47
  br label %if.end16

if.end.i24:                                       ; preds = %if.else
  %conv.i18 = fptrunc double %8 to float
  %14 = load ptr, ptr addrspace(1) @_ZN6openmc10simulation23calculate_fuel_xs_queueE, align 8, !tbaa !53
  %idxprom.i25 = sext i32 %12 to i64
  %arrayidx.i26 = getelementptr inbounds %"struct.openmc::EventQueueItem", ptr %14, i64 %idxprom.i25
  store i32 %buffer_idx, ptr %arrayidx.i26, align 4, !tbaa !43
  %ref.tmp9.sroa.4.0.arrayidx.i26.sroa_idx = getelementptr inbounds nuw i8, ptr %arrayidx.i26, i64 4
  store i32 0, ptr %ref.tmp9.sroa.4.0.arrayidx.i26.sroa_idx, align 4, !tbaa !43
  %ref.tmp9.sroa.5.0.arrayidx.i26.sroa_idx = getelementptr inbounds nuw i8, ptr %arrayidx.i26, i64 8
  store float %conv.i18, ptr %ref.tmp9.sroa.5.0.arrayidx.i26.sroa_idx, align 4, !tbaa !127
  %ref.tmp9.sroa.6.0.arrayidx.i26.sroa_idx = getelementptr inbounds nuw i8, ptr %arrayidx.i26, i64 12
  store i32 %3, ptr %ref.tmp9.sroa.6.0.arrayidx.i26.sroa_idx, align 4, !tbaa !43
  %ref.tmp9.sroa.7.0.arrayidx.i26.sroa_idx = getelementptr inbounds nuw i8, ptr %arrayidx.i26, i64 16
  store i32 %4, ptr %ref.tmp9.sroa.7.0.arrayidx.i26.sroa_idx, align 4, !tbaa !43
  br label %if.end16

if.else12:                                        ; preds = %entry
  %E_14 = getelementptr inbounds nuw i8, ptr %arrayidx, i64 1400
  %15 = load double, ptr %E_14, align 8, !tbaa !125
  %16 = atomicrmw add ptr addrspace(1) getelementptr inbounds nuw (i8, ptr addrspace(1) @_ZN6openmc10simulation22advance_particle_queueE, i64 16), i32 1 monotonic, align 8, !amdgpu.no.fine.grained.memory !124, !amdgpu.no.remote.memory !124
  %17 = load i32, ptr addrspace(1) getelementptr inbounds nuw (i8, ptr addrspace(1) @_ZN6openmc10simulation22advance_particle_queueE, i64 20), align 4, !tbaa !126
  %cmp.not.i33 = icmp slt i32 %16, %17
  br i1 %cmp.not.i33, label %if.end.i36, label %if.then.i34

if.then.i34:                                      ; preds = %if.else12
  store atomic i32 %17, ptr addrspace(1) getelementptr inbounds nuw (i8, ptr addrspace(1) @_ZN6openmc10simulation22advance_particle_queueE, i64 16) monotonic, align 4, !tbaa !47
  br label %if.end16

if.end.i36:                                       ; preds = %if.else12
  %conv.i30 = fptrunc double %15 to float
  %18 = load ptr, ptr addrspace(1) @_ZN6openmc10simulation22advance_particle_queueE, align 8, !tbaa !53
  %idxprom.i37 = sext i32 %16 to i64
  %arrayidx.i38 = getelementptr inbounds %"struct.openmc::EventQueueItem", ptr %18, i64 %idxprom.i37
  store i32 %buffer_idx, ptr %arrayidx.i38, align 4, !tbaa !43
  %ref.tmp13.sroa.4.0.arrayidx.i38.sroa_idx = getelementptr inbounds nuw i8, ptr %arrayidx.i38, i64 4
  store i32 0, ptr %ref.tmp13.sroa.4.0.arrayidx.i38.sroa_idx, align 4, !tbaa !43
  %ref.tmp13.sroa.5.0.arrayidx.i38.sroa_idx = getelementptr inbounds nuw i8, ptr %arrayidx.i38, i64 8
  store float %conv.i30, ptr %ref.tmp13.sroa.5.0.arrayidx.i38.sroa_idx, align 4, !tbaa !127
  %ref.tmp13.sroa.6.0.arrayidx.i38.sroa_idx = getelementptr inbounds nuw i8, ptr %arrayidx.i38, i64 12
  store i32 %3, ptr %ref.tmp13.sroa.6.0.arrayidx.i38.sroa_idx, align 4, !tbaa !43
  %ref.tmp13.sroa.7.0.arrayidx.i38.sroa_idx = getelementptr inbounds nuw i8, ptr %arrayidx.i38, i64 16
  store i32 %4, ptr %ref.tmp13.sroa.7.0.arrayidx.i38.sroa_idx, align 4, !tbaa !43
  br label %if.end16

if.end16:                                         ; preds = %if.end.i36, %if.then.i34, %if.end.i24, %if.then.i22, %if.end.i, %if.then.i
  ret void
}
...
user_code.entry:                                  ; preds = %entry
  ...
  %captured_vars_addrs.ascast.i = addrspacecast ptr addrspace(5) %captured_vars_addrs.i to ptr
  %n_particles.addr.sroa.0.0.extract.trunc.i = trunc i64 %n_particles to i32
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %total_weight1.i) #15, !noalias !128
...
omp.precond.then.i:                               ; preds = %user_code.entry
  ...
  %.omp.comb.ub.ascast.i = addrspacecast ptr addrspace(5) %.omp.comb.ub.i to ptr
  %.omp.comb.lb.ascast.i = addrspacecast ptr addrspace(5) %.omp.comb.lb.i to ptr
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.comb.lb.i) #15, !noalias !128
  store i32 0, ptr addrspace(5) %.omp.comb.lb.i, align 4, !tbaa !43, !noalias !128
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.comb.ub.i) #15, !noalias !128
  store i32 %sub3.i, ptr addrspace(5) %.omp.comb.ub.i, align 4, !tbaa !43, !noalias !128
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.stride.i) #15, !noalias !128
  store i32 1, ptr addrspace(5) %.omp.stride.i, align 4, !tbaa !43, !noalias !128
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.is_last.i) #15, !noalias !128
...
omp.precond.then.i:                               ; preds = %user_code.entry
  ...
  %.omp.comb.ub.ascast.i = addrspacecast ptr addrspace(5) %.omp.comb.ub.i to ptr
  %.omp.comb.lb.ascast.i = addrspacecast ptr addrspace(5) %.omp.comb.lb.i to ptr
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.comb.lb.i) #15, !noalias !133
  store i32 0, ptr addrspace(5) %.omp.comb.lb.i, align 4, !tbaa !43, !noalias !133
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.comb.ub.i) #15, !noalias !133
  store i32 %sub2.i, ptr addrspace(5) %.omp.comb.ub.i, align 4, !tbaa !43, !noalias !133
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.stride.i) #15, !noalias !133
  store i32 1, ptr addrspace(5) %.omp.stride.i, align 4, !tbaa !43, !noalias !133
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.is_last.i) #15, !noalias !133
...
omp.precond.then.i:                               ; preds = %user_code.entry
  ...
  %.omp.comb.ub.ascast.i = addrspacecast ptr addrspace(5) %.omp.comb.ub.i to ptr
  %.omp.comb.lb.ascast.i = addrspacecast ptr addrspace(5) %.omp.comb.lb.i to ptr
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.comb.lb.i) #15, !noalias !138
  store i32 0, ptr addrspace(5) %.omp.comb.lb.i, align 4, !tbaa !43, !noalias !138
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.comb.ub.i) #15, !noalias !138
  store i32 %sub2.i, ptr addrspace(5) %.omp.comb.ub.i, align 4, !tbaa !43, !noalias !138
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.stride.i) #15, !noalias !138
  store i32 1, ptr addrspace(5) %.omp.stride.i, align 4, !tbaa !43, !noalias !138
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.is_last.i) #15, !noalias !138
...
omp.precond.then.i:                               ; preds = %user_code.entry
  ...
  %.omp.comb.ub.ascast.i = addrspacecast ptr addrspace(5) %.omp.comb.ub.i to ptr
  %.omp.comb.lb.ascast.i = addrspacecast ptr addrspace(5) %.omp.comb.lb.i to ptr
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.comb.lb.i) #15, !noalias !141
  store i32 0, ptr addrspace(5) %.omp.comb.lb.i, align 4, !tbaa !43, !noalias !141
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.comb.ub.i) #15, !noalias !141
  store i32 %sub2.i, ptr addrspace(5) %.omp.comb.ub.i, align 4, !tbaa !43, !noalias !141
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.stride.i) #15, !noalias !141
  store i32 1, ptr addrspace(5) %.omp.stride.i, align 4, !tbaa !43, !noalias !141
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.is_last.i) #15, !noalias !141
...
omp.precond.then.i:                               ; preds = %user_code.entry
  ...
  %.omp.comb.ub.ascast.i = addrspacecast ptr addrspace(5) %.omp.comb.ub.i to ptr
  %.omp.comb.lb.ascast.i = addrspacecast ptr addrspace(5) %.omp.comb.lb.i to ptr
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.comb.lb.i) #15, !noalias !146
  store i32 0, ptr addrspace(5) %.omp.comb.lb.i, align 4, !tbaa !43, !noalias !146
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.comb.ub.i) #15, !noalias !146
  store i32 %sub2.i, ptr addrspace(5) %.omp.comb.ub.i, align 4, !tbaa !43, !noalias !146
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.stride.i) #15, !noalias !146
  store i32 1, ptr addrspace(5) %.omp.stride.i, align 4, !tbaa !43, !noalias !146
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.is_last.i) #15, !noalias !146
...
omp.precond.then.i:                               ; preds = %user_code.entry
  ...
  %.omp.comb.ub.ascast.i = addrspacecast ptr addrspace(5) %.omp.comb.ub.i to ptr
  %.omp.comb.lb.ascast.i = addrspacecast ptr addrspace(5) %.omp.comb.lb.i to ptr
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.comb.lb.i) #15, !noalias !149
  store i32 0, ptr addrspace(5) %.omp.comb.lb.i, align 4, !tbaa !43, !noalias !149
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.comb.ub.i) #15, !noalias !149
  store i32 %sub2.i, ptr addrspace(5) %.omp.comb.ub.i, align 4, !tbaa !43, !noalias !149
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.stride.i) #15, !noalias !149
  store i32 1, ptr addrspace(5) %.omp.stride.i, align 4, !tbaa !43, !noalias !149
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.is_last.i) #15, !noalias !149
...
omp.precond.then.i:                               ; preds = %user_code.entry
  ...
  %.omp.comb.ub.ascast.i = addrspacecast ptr addrspace(5) %.omp.comb.ub.i to ptr
  %.omp.comb.lb.ascast.i = addrspacecast ptr addrspace(5) %.omp.comb.lb.i to ptr
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.comb.lb.i) #15, !noalias !152
  store i32 0, ptr addrspace(5) %.omp.comb.lb.i, align 4, !tbaa !43, !noalias !152
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.comb.ub.i) #15, !noalias !152
  store i32 %sub2.i, ptr addrspace(5) %.omp.comb.ub.i, align 4, !tbaa !43, !noalias !152
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.stride.i) #15, !noalias !152
  store i32 1, ptr addrspace(5) %.omp.stride.i, align 4, !tbaa !43, !noalias !152
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.is_last.i) #15, !noalias !152
...
user_code.entry:                                  ; preds = %entry
  ...
  %captured_vars_addrs.ascast.i = addrspacecast ptr addrspace(5) %captured_vars_addrs.i to ptr
  %n_particles.addr.sroa.0.0.extract.trunc.i = trunc i64 %n_particles to i32
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %absorption1.i) #15, !noalias !155
  store double 0.000000e+00, ptr addrspace(5) %absorption1.i, align 8, !tbaa !131, !noalias !155
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %collision2.i) #15, !noalias !155
  store double 0.000000e+00, ptr addrspace(5) %collision2.i, align 8, !tbaa !131, !noalias !155
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %tracklength3.i) #15, !noalias !155
  store double 0.000000e+00, ptr addrspace(5) %tracklength3.i, align 8, !tbaa !131, !noalias !155
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %leakage4.i) #15, !noalias !155
...
omp.precond.then.i:                               ; preds = %user_code.entry
  ...
  %.omp.comb.ub.ascast.i = addrspacecast ptr addrspace(5) %.omp.comb.ub.i to ptr
  %.omp.comb.lb.ascast.i = addrspacecast ptr addrspace(5) %.omp.comb.lb.i to ptr
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.comb.lb.i) #15, !noalias !155
  store i32 0, ptr addrspace(5) %.omp.comb.lb.i, align 4, !tbaa !43, !noalias !155
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.comb.ub.i) #15, !noalias !155
  store i32 %sub6.i, ptr addrspace(5) %.omp.comb.ub.i, align 4, !tbaa !43, !noalias !155
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.stride.i) #15, !noalias !155
  store i32 1, ptr addrspace(5) %.omp.stride.i, align 4, !tbaa !43, !noalias !155
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.is_last.i) #15, !noalias !155
...
user_code.entry:                                  ; preds = %entry
  ...
  %captured_vars_addrs.ascast.i = addrspacecast ptr addrspace(5) %captured_vars_addrs.i to ptr
  %n_particles.addr.sroa.0.0.extract.trunc.i = trunc i64 %n_particles to i32
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %extra_weight1.i) #15, !noalias !158
...
omp.precond.then.i:                               ; preds = %user_code.entry
  ...
  %.omp.comb.ub.ascast.i = addrspacecast ptr addrspace(5) %.omp.comb.ub.i to ptr
  %.omp.comb.lb.ascast.i = addrspacecast ptr addrspace(5) %.omp.comb.lb.i to ptr
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.comb.lb.i) #15, !noalias !158
  store i32 0, ptr addrspace(5) %.omp.comb.lb.i, align 4, !tbaa !43, !noalias !158
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.comb.ub.i) #15, !noalias !158
  store i32 %sub3.i, ptr addrspace(5) %.omp.comb.ub.i, align 4, !tbaa !43, !noalias !158
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.stride.i) #15, !noalias !158
  store i32 1, ptr addrspace(5) %.omp.stride.i, align 4, !tbaa !43, !noalias !158
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.is_last.i) #15, !noalias !158
...
define weak hidden { double, double } @__muldc3(double noundef %__a, double noundef %__b, double noundef %__c, double noundef %__d) local_unnamed_addr #13 {
entry:
...
; Function Attrs: cold mustprogress noinline nounwind optsize
define weak hidden [2 x i32] @__mulsc3(float noundef %__a, float noundef %__b, float noundef %__c, float noundef %__d) local_unnamed_addr #13 {
entry:
...
; Function Attrs: cold mustprogress noinline nounwind optsize
define weak hidden { double, double } @__divdc3(double noundef %__a, double noundef %__b, double noundef %__c, double noundef %__d) local_unnamed_addr #13 {
entry:
...
; Function Attrs: cold mustprogress noinline nounwind optsize
define weak hidden [2 x i32] @__divsc3(float noundef %__a, float noundef %__b, float noundef %__c, float noundef %__d) local_unnamed_addr #13 {
entry:
...
; Function Attrs: nocallback nofree nosync nounwind speculatable willreturn memory(none)
declare i32 @llvm.amdgcn.frexp.exp.i32.f64(double) #14

; Function Attrs: nocallback nofree nosync nounwind speculatable willreturn memory(none)
declare i32 @llvm.amdgcn.frexp.exp.i32.f32(float) #14

; Function Attrs: nocallback nofree nosync nounwind speculatable willreturn memory(none)
declare double @llvm.ldexp.f64.i32(double, i32) #14
...
attributes #11 = { convergent mustprogress nounwind "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="gfx942" "target-features"="+16-bit-insts,+atomic-buffer-global-pk-add-f16-insts,+atomic-ds-pk-add-16-insts,+atomic-fadd-rtn-insts,+atomic-flat-pk-add-16-insts,+atomic-global-pk-add-bf16-inst,+ci-insts,+dl-insts,+dot1-insts,+dot10-insts,+dot2-insts,+dot3-insts,+dot4-insts,+dot5-insts,+dot6-insts,+dot7-insts,+dpp,+fp8-conversion-insts,+fp8-insts,+gfx8-insts,+gfx9-insts,+gfx90a-insts,+gfx940-insts,+mai-insts,+s-memrealtime,+s-memtime-inst,+wavefrontsize64,+xf32-insts" }
attributes #12 = { nocallback nofree nounwind willreturn memory(argmem: readwrite) }
attributes #13 = { cold mustprogress noinline nounwind optsize "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="gfx942" "target-features"="+16-bit-insts,+atomic-buffer-global-pk-add-f16-insts,+atomic-ds-pk-add-16-insts,+atomic-fadd-rtn-insts,+atomic-flat-pk-add-16-insts,+atomic-global-pk-add-bf16-inst,+ci-insts,+dl-insts,+dot1-insts,+dot10-insts,+dot2-insts,+dot3-insts,+dot4-insts,+dot5-insts,+dot6-insts,+dot7-insts,+dpp,+fp8-conversion-insts,+fp8-insts,+gfx8-insts,+gfx9-insts,+gfx90a-insts,+gfx940-insts,+mai-insts,+s-memrealtime,+s-memtime-inst,+wavefrontsize64,+xf32-insts" }
