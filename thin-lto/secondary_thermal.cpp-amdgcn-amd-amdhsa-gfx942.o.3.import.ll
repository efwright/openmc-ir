; ModuleID = 'secondary_thermal.cpp-amdgcn-amd-amdhsa-gfx942.o.3.import.bc'
...
while.body.i.i.i.i:                               ; preds = %while.body.i.i.i.i, %if.end.i.i
  ...
  %.val.i.i.i.i = load double, ptr %add.ptr.sink.i.i.i.i.i.i, align 8, !tbaa !22
  ...
  br i1 %cmp.i.i.i.i, label %while.body.i.i.i.i, label %_ZSt11lower_boundIPKddET_S2_S2_RKT0_.internalized.exit.loopexit.i.i, !llvm.loop !24
...
_ZN6openmc16get_energy_indexEN3gsl4spanIKdEEdRiRd.internalized.exit: ; preds = %_ZSt11lower_boundIPKddET_S2_S2_RKT0_.internalized.exit.i.i, %if.then.i, %entry
  ...
  %10 = load double, ptr %7, align 8, !tbaa !22
...
while.body.i.i.i:                                 ; preds = %while.body.i.i.i, %if.end.i
  ...
  %.val.i.i.i = load double, ptr %add.ptr.sink.i.i.i.i.i, align 8, !tbaa !22
  ...
  br i1 %cmp.i.i.i, label %while.body.i.i.i, label %_ZSt11lower_boundIPKddET_S2_S2_RKT0_.internalized.exit.loopexit.i, !llvm.loop !24
...
if.end:                                           ; preds = %_ZSt11lower_boundIPKddET_S2_S2_RKT0_.internalized.exit.i, %_ZN6openmc16get_energy_indexEN3gsl4spanIKdEEdRiRd.internalized.exit
  ...
  %15 = load double, ptr %arrayidx.i11, align 8, !tbaa !22
  %mul14 = fmul double %15, 2.000000e+00
  %div = fdiv double %mul14, %E_in
  %sub = fsub double 1.000000e+00, %div
  store double %sub, ptr %mu, align 8, !tbaa !22
  store double %E_in, ptr %E_out, align 8, !tbaa !22
...
entry:
  ...
  %this.val = load ptr, ptr %this, align 8, !tbaa !26
  %0 = getelementptr i8, ptr %this.val, i64 8
  %this.val.val = load double, ptr %0, align 8, !tbaa !22
  ...
  store double %sub8, ptr %mu, align 8, !tbaa !22
  store double %E_in, ptr %E_out, align 8, !tbaa !22
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite)
define internal void @_ZN6openmc31IncoherentElasticAEDiscreteFlatC2EPKh(ptr noundef nonnull writeonly align 8 captures(none) dereferenceable(32) initializes((0, 32)) %this, ptr noundef %data) unnamed_addr #5 align 2 {
entry:
  store ptr %data, ptr %this, align 8, !tbaa !28
  %add.ptr = getelementptr inbounds nuw i8, ptr %data, i64 8
  %0 = load i64, ptr %add.ptr, align 8, !tbaa !32
  %n_e_out_ = getelementptr inbounds nuw i8, ptr %this, i64 8
  store i64 %0, ptr %n_e_out_, align 8, !tbaa !33
  %add.ptr4 = getelementptr inbounds nuw i8, ptr %data, i64 16
  %1 = load i64, ptr %add.ptr4, align 8, !tbaa !32
  %n_mu_ = getelementptr inbounds nuw i8, ptr %this, i64 16
  store i64 %1, ptr %n_mu_, align 8, !tbaa !34
  ...
  store ptr %add.ptr8, ptr %mu_out_, align 8, !tbaa !35
  ret void
}
...
entry:
  ...
  %0 = load double, ptr %add.ptr.i, align 8, !tbaa !22
  %cmp.i = fcmp ult double %E_in, %0
  br i1 %cmp.i, label %_ZN6openmc16get_energy_indexEN3gsl4spanIKdEEdRiRd.internalized.exit, label %if.then.i

if.then.i:                                        ; preds = %entry
  %1 = getelementptr inbounds nuw i8, ptr %this, i64 8
  %this.val18 = load i64, ptr %1, align 8, !tbaa !33
...
_ZN6openmc16get_energy_indexEN3gsl4spanIKdEEdRiRd.internalized.exit: ; preds = %if.then8.i, %_ZN6openmc17lower_bound_indexIPKddEENSt15iterator_traitsIT_E15difference_typeES4_S4_RKT0_.internalized.exit.i, %entry
  ...
  %n_mu_ = getelementptr inbounds nuw i8, ptr %this, i64 16
  %8 = load i64, ptr %n_mu_, align 8, !tbaa !34
  ...
  %this.val20 = load ptr, ptr %9, align 8, !tbaa !35
  ...
  %10 = load double, ptr %add.ptr2.i, align 8, !tbaa !22
...
cond.false:                                       ; preds = %_ZN6openmc16get_energy_indexEN3gsl4spanIKdEEdRiRd.internalized.exit
  ...
  %13 = load double, ptr %add.ptr2.i46, align 8, !tbaa !22
  %add.ptr2.i49 = getelementptr inbounds double, ptr %add.ptr.i39, i64 %conv20
  %14 = load double, ptr %add.ptr2.i49, align 8, !tbaa !22
...
cond.false40:                                     ; preds = %cond.end
  ...
  %16 = load double, ptr %add.ptr2.i55, align 8, !tbaa !22
  %add.ptr2.i58 = getelementptr inbounds double, ptr %add.ptr.i39, i64 %conv43
  %17 = load double, ptr %add.ptr2.i58, align 8, !tbaa !22
...
cond.end56:                                       ; preds = %cond.false40, %cond.true37
  ...
  %19 = load double, ptr %mu, align 8, !tbaa !22
  %20 = tail call double @llvm.fmuladd.f64(double %.sroa.speculated, double %sub63, double %19)
  store double %20, ptr %mu, align 8, !tbaa !22
  store double %E_in, ptr %E_out, align 8, !tbaa !22
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite)
define internal void @_ZN6openmc33IncoherentInelasticAEDiscreteFlatC2EPKh(ptr noundef nonnull writeonly align 8 captures(none) dereferenceable(48) initializes((0, 48)) %this, ptr noundef %data) unnamed_addr #5 align 2 {
entry:
  store ptr %data, ptr %this, align 8, !tbaa !36
  %add.ptr = getelementptr inbounds nuw i8, ptr %data, i64 8
  %0 = load i64, ptr %add.ptr, align 8, !tbaa !32
  %n_energy_ = getelementptr inbounds nuw i8, ptr %this, i64 8
  store i64 %0, ptr %n_energy_, align 8, !tbaa !38
  %add.ptr4 = getelementptr inbounds nuw i8, ptr %data, i64 16
  %1 = load i64, ptr %add.ptr4, align 8, !tbaa !32
  %n_e_out_ = getelementptr inbounds nuw i8, ptr %this, i64 16
  store i64 %1, ptr %n_e_out_, align 8, !tbaa !39
  %add.ptr6 = getelementptr inbounds nuw i8, ptr %data, i64 24
  %2 = load i64, ptr %add.ptr6, align 8, !tbaa !32
  %n_mu_ = getelementptr inbounds nuw i8, ptr %this, i64 24
  store i64 %2, ptr %n_mu_, align 8, !tbaa !40
  ...
  store ptr %add.ptr10, ptr %energy_out_, align 8, !tbaa !41
  %add = add i64 %1, 1
  ...
  store ptr %add.ptr17, ptr %mu_out_, align 8, !tbaa !42
  ret void
}
...
entry:
  %this.val = load ptr, ptr %this, align 8, !tbaa !36
...
if.then.i:                                        ; preds = %entry
  %1 = getelementptr inbounds nuw i8, ptr %this, i64 8
  %this.val14 = load i64, ptr %1, align 8, !tbaa !38
  %cmp.i.i = fcmp oeq double %0, %E_in
  %.pre11.i = ptrtoint ptr %add.ptr.i to i64
  br i1 %cmp.i.i, label %_ZN6openmc17lower_bound_indexIPKddEENSt15iterator_traitsIT_E15difference_typeES4_S4_RKT0_.internalized.exit.i, label %if.end.i.i
...
_ZN6openmc16get_energy_indexEN3gsl4spanIKdEEdRiRd.internalized.exit: ; preds = %if.then8.i, %_ZN6openmc17lower_bound_indexIPKddEENSt15iterator_traitsIT_E15difference_typeES4_S4_RKT0_.internalized.exit.i, %entry
  ...
  %f.0 = phi double [ 0.000000e+00, %entry ], [ %div.i, %if.then8.i ], [ 0.000000e+00, %_ZN6openmc17lower_bound_indexIPKddEENSt15iterator_traitsIT_E15difference_typeES4_S4_RKT0_.internalized.exit.i ]
  %n_e_out_ = getelementptr inbounds nuw i8, ptr %this, i64 16
  %8 = load i64, ptr %n_e_out_, align 8, !tbaa !39
  %conv = trunc i64 %8 to i32
  %9 = getelementptr i8, ptr %this.val, i64 4
  %this.val15.val = load i32, ptr %9, align 4, !tbaa !43
...
if.end26:                                         ; preds = %if.else19, %if.then17, %if.then13, %if.then9, %if.then
  ...
  %this.val16 = load i64, ptr %n_e_out_, align 8, !tbaa !39
  %10 = getelementptr inbounds nuw i8, ptr %this, i64 32
  %this.val17 = load ptr, ptr %10, align 8, !tbaa !41
  ...
  %11 = load double, ptr %add.ptr2.i, align 8, !tbaa !22
  ...
  %12 = load double, ptr %add.ptr2.i23, align 8, !tbaa !22
  ...
  store double %13, ptr %E_out, align 8, !tbaa !22
  %n_mu_ = getelementptr inbounds nuw i8, ptr %this, i64 24
  %14 = load i64, ptr %n_mu_, align 8, !tbaa !40
  ...
  %15 = load ptr, ptr %mu_out_.i, align 8, !tbaa !42
  %16 = load i64, ptr %n_mu_, align 8, !tbaa !40
  %17 = load i64, ptr %n_e_out_, align 8, !tbaa !39
  ...
  %18 = load double, ptr %add.ptr3.i, align 8, !tbaa !22
  ...
  %19 = load double, ptr %add.ptr3.i34, align 8, !tbaa !22
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite)
define internal void @_ZN6openmc25IncoherentInelasticAEFlatC2EPKh(ptr noundef nonnull writeonly align 8 captures(none) dereferenceable(16) initializes((0, 16)) %this, ptr noundef %data) unnamed_addr #5 align 2 {
entry:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite)
declare hidden void @_ZN6openmc17DistEnergySabFlatC2EPKh(ptr noundef nonnull writeonly align 8 captures(none) dereferenceable(24) initializes((0, 24)), ptr noundef) unnamed_addr #5 align 2
...
_ZN6openmc16get_energy_indexEN3gsl4spanIKdEEdRiRd.internalized.exit: ; preds = %if.then8.i, %_ZN6openmc17lower_bound_indexIPKddEENSt15iterator_traitsIT_E15difference_typeES4_S4_RKT0_.internalized.exit.i, %entry
  ...
  %13 = load double, ptr %add.ptr2.i68, align 8, !tbaa !22
  %sub = add i64 %11, -1
...
for.body:                                         ; preds = %for.cond, %_ZN6openmc16get_energy_indexEN3gsl4spanIKdEEdRiRd.internalized.exit
  ...
  %14 = load double, ptr %arrayidx.i73, align 8, !tbaa !22
  %cmp10 = fcmp olt double %call4, %14
  br i1 %cmp10, label %for.body.for.end_crit_edge, label %for.cond, !llvm.loop !48
...
if.end38:                                         ; preds = %if.else, %if.then24
  ...
  store double %storemerge202, ptr %E_out, align 8, !tbaa !22
  %arrayidx.i91 = getelementptr inbounds nuw double, ptr %add.ptr.i, i64 %conv
  %21 = load double, ptr %arrayidx.i91, align 8, !tbaa !22
...
if.end50:                                         ; preds = %if.else47, %if.then42
  ...
  store double %storemerge48, ptr %E_out, align 8, !tbaa !22
  ...
  %22 = load double, ptr %add.ptr5.i, align 8, !tbaa !22
...
cond.false70:                                     ; preds = %if.end50
  ...
  %25 = load double, ptr %add.ptr5.i119, align 8, !tbaa !22
  %add.ptr5.i127 = getelementptr inbounds double, ptr %add.ptr4.i102, i64 %sub71
  %26 = load double, ptr %add.ptr5.i127, align 8, !tbaa !22
...
cond.false88:                                     ; preds = %cond.end80
  ...
  %28 = load double, ptr %add.ptr5.i143, align 8, !tbaa !22
  %add.ptr5.i151 = getelementptr inbounds double, ptr %add.ptr4.i102, i64 %add89
  %29 = load double, ptr %add.ptr5.i151, align 8, !tbaa !22
...
define available_externally hidden %"class.gsl::span" @_ZNK6openmc21CoherentElasticXSFlat11bragg_edgesEv(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(8) %this) local_unnamed_addr #6 align 2 {
entry:
  %0 = load ptr, ptr %this, align 8, !tbaa !49
  %add.ptr = getelementptr inbounds nuw i8, ptr %0, i64 4
  %1 = load i32, ptr %add.ptr, align 4, !tbaa !43
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(read, inaccessiblemem: none)
define available_externally hidden %"class.gsl::span" @_ZNK6openmc21CoherentElasticXSFlat7factorsEv(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(8) %this) local_unnamed_addr #6 align 2 {
entry:
  %0 = load ptr, ptr %this, align 8, !tbaa !49
  %add.ptr = getelementptr inbounds nuw i8, ptr %0, i64 4
  %1 = load i32, ptr %add.ptr, align 4, !tbaa !43
...
entry:
  %0 = load i64, ptr %seed, align 8, !tbaa !32
  %mul = mul i64 %0, 2806196910506780709
  %add = add i64 %mul, 1
  %and = and i64 %add, 9223372036854775807
  store i64 %and, ptr %seed, align 8, !tbaa !32
...
!26 = !{!27, !18, i64 0}
!27 = !{!"_ZTSN6openmc23IncoherentElasticAEFlatE", !18, i64 0}
!28 = !{!29, !18, i64 0}
!29 = !{!"_ZTSN6openmc31IncoherentElasticAEDiscreteFlatE", !18, i64 0, !30, i64 8, !30, i64 16, !31, i64 24}
!30 = !{!"long", !20, i64 0}
!31 = !{!"p1 double", !19, i64 0}
!32 = !{!30, !30, i64 0}
!33 = !{!29, !30, i64 8}
!34 = !{!29, !30, i64 16}
!35 = !{!29, !31, i64 24}
!36 = !{!37, !18, i64 0}
!37 = !{!"_ZTSN6openmc33IncoherentInelasticAEDiscreteFlatE", !18, i64 0, !30, i64 8, !30, i64 16, !30, i64 24, !31, i64 32, !31, i64 40}
!38 = !{!37, !30, i64 8}
!39 = !{!37, !30, i64 16}
!40 = !{!37, !30, i64 24}
!41 = !{!37, !31, i64 32}
...
!44 = !{!"int", !20, i64 0}
!45 = !{!46, !18, i64 0}
!46 = !{!"_ZTSN6openmc25IncoherentInelasticAEFlatE", !18, i64 0, !30, i64 8}
!47 = !{!46, !30, i64 8}
!48 = distinct !{!48, !25}
!49 = !{!50, !18, i64 0}
!50 = !{!"_ZTSN6openmc21CoherentElasticXSFlatE", !18, i64 0}
