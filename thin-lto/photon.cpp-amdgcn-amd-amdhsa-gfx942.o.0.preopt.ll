; ModuleID = 'photon.cpp-amdgcn-amd-amdhsa-gfx942.o.0.preopt.bc'
...
entry:
  ...
  %0 = tail call i32 @__kmpc_target_init(ptr addrspacecast (ptr addrspace(1) @__omp_offloading_52_26f9b84__ZN6openmc17PhotonInteraction14copy_to_deviceEv_l863_kernel_environment to ptr), ptr %dyn_ptr) #9
...
for.cond.preheader:                               ; preds = %entry
  ...
  %shells_.val = load i64, ptr addrspace(1) %1, align 8, !tbaa !26
...
for.body.lr.ph:                                   ; preds = %for.cond.preheader
  ...
  %shells_.val11 = load ptr, ptr addrspace(1) %shells_, align 8, !tbaa !33
...
for.cond.cleanup:                                 ; preds = %for.body, %for.cond.preheader
  tail call void @__kmpc_target_deinit() #9
  br label %common.ret
...
for.body:                                         ; preds = %for.body, %for.body.lr.ph
  ...
  %cross_section.val = load ptr, ptr %cross_section, align 8, !tbaa !34
  %2 = getelementptr i8, ptr %arrayidx.i, i64 32
  %cross_section.val12 = load ptr, ptr %2, align 8, !tbaa !37
  ...
  %cross_section_.val = load ptr, ptr addrspace(1) %cross_section_, align 8, !tbaa !38
  ...
  store ptr %arrayidx.i14, ptr %cross_section, align 8, !tbaa !40
  store ptr %add.ptr.i, ptr %2, align 8, !tbaa !40
  %add = add nsw i64 %sub.ptr.div.i, %conv5
  %transitions = getelementptr inbounds nuw i8, ptr %arrayidx.i, i64 40
  %transitions.val = load ptr, ptr %transitions, align 8, !tbaa !41
  %3 = getelementptr i8, ptr %arrayidx.i, i64 48
  %transitions.val13 = load ptr, ptr %3, align 8, !tbaa !44
  ...
  %transitions_.val = load ptr, ptr addrspace(1) %transitions_, align 8, !tbaa !45
  ...
  store ptr %arrayidx.i19, ptr %transitions, align 8, !tbaa !47
  store ptr %add.ptr.i20, ptr %3, align 8, !tbaa !47
...
define weak hidden { double, double } @__muldc3(double noundef %__a, double noundef %__b, double noundef %__c, double noundef %__d) local_unnamed_addr #2 {
entry:
...
; Function Attrs: cold mustprogress noinline nounwind optsize
define weak hidden [2 x i32] @__mulsc3(float noundef %__a, float noundef %__b, float noundef %__c, float noundef %__d) local_unnamed_addr #2 {
entry:
...
; Function Attrs: cold mustprogress noinline nounwind optsize
define weak hidden { double, double } @__divdc3(double noundef %__a, double noundef %__b, double noundef %__c, double noundef %__d) local_unnamed_addr #2 {
entry:
...
; Function Attrs: cold mustprogress noinline nounwind optsize
define weak hidden [2 x i32] @__divsc3(float noundef %__a, float noundef %__b, float noundef %__c, float noundef %__d) local_unnamed_addr #2 {
entry:
...
entry:
  ...
  %123 = fneg double %122
  %124 = call double @llvm.fma.f64(double %2, double %119, double %123) #10
  %125 = call double @llvm.fma.f64(double %2, double %121, double %124) #10
  %126 = fadd double %122, %125
  %127 = fsub double %126, %122
  %128 = fsub double %125, %127
  %129 = call double @llvm.fabs.f64(double %122) #10
  %130 = fcmp oeq double %129, 0x7FF0000000000000
  %131 = select i1 %130, double %122, double %126
  %132 = call double @llvm.fabs.f64(double %131) #10
  ...
  %157 = call double @llvm.fma.f64(double %156, double %134, double %156) #10
  %158 = call double @llvm.fabs.f64(double %156) #10
  %159 = fcmp oeq double %158, 0x7FF0000000000000
  %160 = select i1 %159, double %156, double %157
  %161 = call double @llvm.trunc.f64(double %2) #10
  %162 = fcmp oeq double %161, %2
  %163 = fmul double %2, 5.000000e-01
  %164 = call double @llvm.trunc.f64(double %163) #10
  %165 = fcmp une double %164, %163
  %166 = and i1 %162, %165
  %167 = select i1 %166, double %0, double 1.000000e+00
  %168 = call double @llvm.copysign.f64(double %160, double %167) #10
  ...
  %179 = call double @llvm.copysign.f64(double %177, double %178) #10
...
while.cond.i:                                     ; preds = %if.end26.i, %while.cond
  %call.i = call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #11
  %cmp1.i = fcmp olt double %call.i, %div.i
  br i1 %cmp1.i, label %if.then2.i, label %if.else.i

if.then2.i:                                       ; preds = %while.cond.i
  %call3.i = call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #11
  %mul.i = fmul double %call3.i, 2.000000e+00
  %277 = call double @llvm.fmuladd.f64(double %alpha, double %mul.i, double 1.000000e+00)
  %call5.i = call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #11
...
if.else.i:                                        ; preds = %while.cond.i
  %call13.i = call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #11
  ...
  %call19.i = call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #11
...
if.else28.i:                                      ; preds = %while.cond
  %call31.i = call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #11
...
if.then43.i:                                      ; preds = %if.else28.i
  %call45.i = call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #11
...
if.then51.i:                                      ; preds = %if.else48.i
  %call53.i = call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #11
...
if.then61.i:                                      ; preds = %if.else57.i
  %call62.i = call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #11
  %282 = call double @llvm.fmuladd.f64(double %neg.i, double %call62.i, double 1.000000e+00)
  %283 = call noundef double @llvm.sqrt.f64(double %282) #10
  %mul65.i = fmul double %alpha, %283
  br label %if.end72.i

if.else66.i:                                      ; preds = %if.else57.i
  %call67.i = call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #11
  ...
  %287 = call double @llvm.fabs.f64(double %286) #10
  ...
  %407 = fneg double %406
  %408 = call double @llvm.fma.f64(double %284, double %403, double %407) #10
  %409 = call double @llvm.fma.f64(double %284, double %405, double %408) #10
  %410 = fadd double %406, %409
  %411 = fsub double %410, %406
  %412 = fsub double %409, %411
  %413 = call double @llvm.fabs.f64(double %406) #10
  %414 = fcmp oeq double %413, 0x7FF0000000000000
  %415 = select i1 %414, double %406, double %410
  %416 = call double @llvm.fabs.f64(double %415) #10
  ...
  %441 = call double @llvm.fma.f64(double %440, double %418, double %440) #10
  %442 = call double @llvm.fabs.f64(double %440) #10
  %443 = fcmp oeq double %442, 0x7FF0000000000000
  %444 = select i1 %443, double %440, double %441
  %445 = call double @llvm.trunc.f64(double %284) #10
  %446 = fcmp oeq double %445, %284
  %447 = fmul double %284, 5.000000e-01
  %448 = call double @llvm.trunc.f64(double %447) #10
  %449 = fcmp une double %448, %447
  %450 = and i1 %446, %449
  %451 = select i1 %450, double %286, double 1.000000e+00
  %452 = call double @llvm.copysign.f64(double %444, double %451) #10
  ...
  %456 = call double @llvm.fabs.f64(double %284) #10
  ...
  %472 = call double @llvm.copysign.f64(double %470, double %471) #10
...
_ZN6openmc13klein_nishinaEdPm.internalized.exit:  ; preds = %if.end72.i, %while.end.i
  ...
  store double %alpha_out.1.i, ptr %alpha_out, align 8, !tbaa !51
  store double %mu.4.i, ptr %mu, align 8, !tbaa !51
  %sub = fsub double 1.000000e+00, %mu.4.i
  %mul4 = fmul double %sub, 5.000000e-01
  %476 = call noundef double @llvm.sqrt.f64(double %mul4) #10
  %mul6 = fmul double %mul, %476
  call void @llvm.lifetime.start.p5(i64 24, ptr addrspace(5) %ref.tmp7) #9
  %this.val = load ptr, ptr %265, align 8, !tbaa !53
  ...
  call void @_ZN6openmc15Tabulated1DFlatC1EPKh(ptr noundef nonnull align 8 dereferenceable(24) %retval.ascast.i, ptr noundef nonnull %add.ptr.i) #11
  ...
  %call9 = call noundef double @_ZNK6openmc15Tabulated1DFlatclEd(ptr noundef nonnull align 8 dereferenceable(24) %ref.tmp7.ascast, double noundef %mul6) #11
  call void @llvm.lifetime.end.p5(i64 24, ptr addrspace(5) %ref.tmp7) #9
  %cmp = fcmp oeq double %form_factor_xmax.0, 0.000000e+00
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %_ZN6openmc13klein_nishinaEdPm.internalized.exit
  call void @llvm.lifetime.start.p5(i64 24, ptr addrspace(5) %ref.tmp10) #9
  %this.val14 = load ptr, ptr %265, align 8, !tbaa !53
  ...
  call void @_ZN6openmc15Tabulated1DFlatC1EPKh(ptr noundef nonnull align 8 dereferenceable(24) %retval.ascast.i18, ptr noundef nonnull %add.ptr.i19) #11
  ...
  %call13 = call noundef double @_ZNK6openmc15Tabulated1DFlatclEd(ptr noundef nonnull align 8 dereferenceable(24) %ref.tmp10.ascast, double noundef %mul) #11
  call void @llvm.lifetime.end.p5(i64 24, ptr addrspace(5) %ref.tmp10) #9
  br label %if.end
...
if.end:                                           ; preds = %if.then, %_ZN6openmc13klein_nishinaEdPm.internalized.exit
  ...
  %call14 = call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #11
...
if.then17:                                        ; preds = %if.then16
  %477 = load double, ptr %mu, align 8, !tbaa !51
  %478 = load i64, ptr addrspace(1) @_ZN6openmc4data23compton_profile_pz_sizeE, align 8, !tbaa !111
...
while.cond.i29:                                   ; preds = %while.cond.backedge.i, %if.then17
  %call.i30 = call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #11
  %electron_pdf_.val.i = load ptr, ptr %270, align 8, !tbaa !112
  %electron_pdf_.val9.i = load ptr, ptr %271, align 8, !tbaa !113
...
for.body.lr.ph.i:                                 ; preds = %while.cond.i29
  ...
  %480 = load ptr, ptr %device_electron_pdf_.i, align 8, !tbaa !114
...
for.body.i:                                       ; preds = %for.inc.i, %for.body.lr.ph.i
  ...
  %481 = load double, ptr %arrayidx.i, align 8, !tbaa !51
...
for.inc.i:                                        ; preds = %for.body.i
  ...
  br i1 %exitcond.not, label %for.end.loopexit.i, label %for.body.i, !llvm.loop !115
...
for.end.i:                                        ; preds = %for.end.loopexit.i, %while.cond.i29
  ...
  %482 = load ptr, ptr %device_binding_energy_.i, align 8, !tbaa !116
  %arrayidx5.i = getelementptr inbounds nuw double, ptr %482, i64 %conv.lcssa.i
  %483 = load double, ptr %arrayidx5.i, align 8, !tbaa !51
...
if.end10.i:                                       ; preds = %for.end.i
  ...
  %486 = call noundef double @llvm.sqrt.f64(double %485) #10
...
if.end30.i:                                       ; preds = %if.end10.i
  %487 = load ptr, ptr addrspace(1) @_ZN6openmc4data18compton_profile_pzE, align 8, !tbaa !40
  %arrayidx32.i = getelementptr inbounds nuw double, ptr %487, i64 %sub31.i
  %488 = load double, ptr %arrayidx32.i, align 8, !tbaa !51
  %cmp33.i = fcmp ogt double %div23.i, %488
  br i1 %cmp33.i, label %if.then34.i, label %if.else.i34

if.then34.i:                                      ; preds = %if.end30.i
  %this.val.i39 = load i64, ptr %273, align 8, !tbaa !117
  %this.val10.i = load ptr, ptr %275, align 8, !tbaa !118
  ...
  %489 = load double, ptr %add.ptr2.i.i, align 8, !tbaa !51
  br label %if.end76.i

if.else.i34:                                      ; preds = %if.end30.i
  %490 = load double, ptr %487, align 8, !tbaa !51
...
if.end.i.i:                                       ; preds = %if.else.i34
  %491 = load i64, ptr addrspace(1) @_ZN6openmc4data23compton_profile_pz_sizeE, align 8, !tbaa !111
...
while.body.i.i.i.i:                               ; preds = %while.body.i.i.i.i, %if.end.i.i
  ...
  %492 = call i1 @llvm.is.constant.i64(i64 range(i64 0, 4611686018427387904) %shr.i.i.i.i) #10
  ...
  %.val.i.i.i.i = load double, ptr %add.ptr.sink.i.i.i.i.i.i, align 8, !tbaa !51
  ...
  br i1 %cmp.i.i.i.i, label %while.body.i.i.i.i, label %_ZSt11lower_boundIPddET_S1_S1_RKT0_.internalized.exit.loopexit.i.i, !llvm.loop !119
...
_ZN6openmc17lower_bound_indexIPddEENSt15iterator_traitsIT_E15difference_typeES3_S3_RKT0_.internalized.exit.i: ; preds = %_ZSt11lower_boundIPddET_S1_S1_RKT0_.internalized.exit.i.i, %if.else.i34
  ...
  %495 = load double, ptr %arrayidx41.i, align 8, !tbaa !51
  ...
  %496 = load double, ptr %arrayidx44.i, align 8, !tbaa !51
  %this.val15.i = load i64, ptr %273, align 8, !tbaa !117
  %this.val16.i = load ptr, ptr %274, align 8, !tbaa !120
  ...
  %497 = load double, ptr %add.ptr2.i25.i, align 8, !tbaa !51
  %add.ptr2.i28.i = getelementptr inbounds double, ptr %add.ptr.i24.i, i64 %idxprom43.i
  %498 = load double, ptr %add.ptr2.i28.i, align 8, !tbaa !51
  %this.val12.i = load ptr, ptr %275, align 8, !tbaa !118
  ...
  %499 = load double, ptr %add.ptr2.i31.i, align 8, !tbaa !51
...
if.else62.i:                                      ; preds = %if.else57.i35
  ...
  %504 = call double @llvm.fabs.f64(double %501) #10
  ...
  %624 = fneg double %623
  %625 = call double @llvm.fma.f64(double %503, double %620, double %624) #10
  %626 = call double @llvm.fma.f64(double %503, double %622, double %625) #10
  %627 = fadd double %623, %626
  %628 = fsub double %627, %623
  %629 = fsub double %626, %628
  %630 = call double @llvm.fabs.f64(double %623) #10
  %631 = fcmp oeq double %630, 0x7FF0000000000000
  %632 = select i1 %631, double %623, double %627
  %633 = call double @llvm.fabs.f64(double %632) #10
  ...
  %658 = call double @llvm.fma.f64(double %657, double %635, double %657) #10
  %659 = call double @llvm.fabs.f64(double %657) #10
  %660 = fcmp oeq double %659, 0x7FF0000000000000
  %661 = select i1 %660, double %657, double %658
  %662 = call double @llvm.trunc.f64(double %503) #10
  %663 = fcmp oeq double %662, %503
  %664 = fmul double %503, 5.000000e-01
  %665 = call double @llvm.trunc.f64(double %664) #10
  %666 = fcmp une double %665, %664
  %667 = and i1 %663, %666
  %668 = select i1 %667, double %501, double 1.000000e+00
  %669 = call double @llvm.copysign.f64(double %661, double %668) #10
  ...
  %678 = call double @llvm.copysign.f64(double %676, double %677) #10
...
if.end76.i:                                       ; preds = %if.else62.i, %if.then59.i, %_ZN6openmc17lower_bound_indexIPddEENSt15iterator_traitsIT_E15difference_typeES3_S3_RKT0_.internalized.exit.i, %if.then34.i
  ...
  %call77.i = call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #11
  %mul78.i = fmul double %c_max.1.i, %call77.i
  %683 = load ptr, ptr %275, align 8, !tbaa !118
  %684 = load i64, ptr %273, align 8, !tbaa !117
  %mul80.i = mul i64 %684, %conv.lcssa.i
  %add.ptr81.i = getelementptr inbounds nuw double, ptr %683, i64 %mul80.i
  %685 = load double, ptr %add.ptr81.i, align 8, !tbaa !51
...
if.end.i33.i:                                     ; preds = %if.end76.i
  %shells_.val.i = load i64, ptr %276, align 8, !tbaa !26
...
while.body.i.i.i45.i:                             ; preds = %while.body.i.i.i45.i, %if.end.i33.i
  ...
  %686 = call i1 @llvm.is.constant.i64(i64 range(i64 0, 4611686018427387904) %shr.i.i.i48.i) #10
  ...
  %.val.i.i.i54.i = load double, ptr %add.ptr.sink.i.i.i.i.i53.i, align 8, !tbaa !51
  ...
  br i1 %cmp.i.i.i60.i, label %while.body.i.i.i45.i, label %_ZSt11lower_boundIPddET_S1_S1_RKT0_.internalized.exit.loopexit.i61.i, !llvm.loop !119
...
_ZN6openmc17lower_bound_indexIPddEENSt15iterator_traitsIT_E15difference_typeES3_S3_RKT0_.internalized.exit63.i: ; preds = %_ZSt11lower_boundIPddET_S1_S1_RKT0_.internalized.exit.i39.i, %if.end76.i
  ...
  %689 = load ptr, ptr addrspace(1) @_ZN6openmc4data18compton_profile_pzE, align 8, !tbaa !40
  %idxprom88.i = ashr exact i64 %retval.0.i44.i, 32
  %arrayidx89.i = getelementptr inbounds double, ptr %689, i64 %idxprom88.i
  %690 = load double, ptr %arrayidx89.i, align 8, !tbaa !51
  ...
  %691 = load double, ptr %arrayidx93.i, align 8, !tbaa !51
  %this.val20.i = load ptr, ptr %274, align 8, !tbaa !120
...
if.else115.i:                                     ; preds = %if.else109.i
  ...
  %696 = call noundef double @llvm.sqrt.f64(double %695) #10
...
if.end129.i:                                      ; preds = %if.else115.i, %if.then111.i, %_ZN6openmc17lower_bound_indexIPddEENSt15iterator_traitsIT_E15difference_typeES3_S3_RKT0_.internalized.exit63.i
  ...
  %699 = call double @llvm.fabs.f64(double %div130.i) #10
  ...
  %819 = fneg double %818
  %820 = call double @llvm.fma.f64(double %698, double %815, double %819) #10
  %821 = call double @llvm.fma.f64(double %698, double %817, double %820) #10
  %822 = fadd double %818, %821
  %823 = fsub double %822, %818
  %824 = fsub double %821, %823
  %825 = call double @llvm.fabs.f64(double %818) #10
  %826 = fcmp oeq double %825, 0x7FF0000000000000
  %827 = select i1 %826, double %818, double %822
  %828 = call double @llvm.fabs.f64(double %827) #10
  ...
  %853 = call double @llvm.fma.f64(double %852, double %830, double %852) #10
  %854 = call double @llvm.fabs.f64(double %852) #10
  %855 = fcmp oeq double %854, 0x7FF0000000000000
  %856 = select i1 %855, double %852, double %853
  %857 = call double @llvm.trunc.f64(double %698) #10
  %858 = fcmp oeq double %857, %698
  %859 = fmul double %698, 5.000000e-01
  %860 = call double @llvm.trunc.f64(double %859) #10
  %861 = fcmp une double %860, %859
  %862 = and i1 %858, %861
  %863 = select i1 %862, double %div130.i, double 1.000000e+00
  %864 = call double @llvm.copysign.f64(double %856, double %863) #10
  ...
  %873 = call double @llvm.copysign.f64(double %871, double %872) #10
...
if.end153.i:                                      ; preds = %if.end129.i
  %882 = call noundef double @llvm.sqrt.f64(double %881) #10
...
if.then165.i:                                     ; preds = %if.then163.i
  %call166.i = call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #11
...
while.cond.backedge.i:                            ; preds = %if.end175.i, %if.else170.i
  br label %while.cond.i29, !llvm.loop !121
...
_ZNK6openmc17PhotonInteraction15compton_dopplerEddPdPiPm.internalized.exit: ; preds = %while.end.sink.split.i, %if.end175.i
  ...
  store i32 %shell.0.lcssa.i, ptr %i_shell, align 4, !tbaa !122
  %div18 = fdiv double %E_out.0, 0x411F305BC8CE703B
  store double %div18, ptr %alpha_out, align 8, !tbaa !51
  %conv = sext i32 %shell.0.lcssa.i to i64
  %shells_.val = load i64, ptr %276, align 8, !tbaa !26
...
cleanup.sink.split:                               ; preds = %_ZNK6openmc17PhotonInteraction15compton_dopplerEddPdPiPm.internalized.exit, %if.then16
  store i32 -1, ptr %i_shell, align 4, !tbaa !122
  br label %cleanup
...
; Function Attrs: convergent mustprogress nounwind
define hidden %"struct.std::pair" @_ZN6openmc13klein_nishinaEdPm(double noundef %alpha, ptr noundef %seed) local_unnamed_addr #4 {
entry:
  %0 = tail call double @llvm.fmuladd.f64(double %alpha, double 2.000000e+00, double 1.000000e+00)
  %cmp = fcmp olt double %alpha, 3.000000e+00
  br i1 %cmp, label %if.then, label %if.else28

if.then:                                          ; preds = %entry
  %add = fadd double %0, 8.000000e+00
  %div = fdiv double %0, %add
  %mul12 = fmul double %alpha, 2.000000e+00
  br label %while.cond

while.cond:                                       ; preds = %if.end26, %if.then
  %call = tail call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #11
  %cmp1 = fcmp olt double %call, %div
...
if.then2:                                         ; preds = %while.cond
  ...
  %1 = tail call double @llvm.fmuladd.f64(double %alpha, double %mul, double 1.000000e+00)
  %call5 = tail call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #11
  %div6 = fdiv double 4.000000e+00, %1
  %div7 = fdiv double 1.000000e+00, %1
  %sub = fsub double 1.000000e+00, %div7
  %mul8 = fmul double %div6, %sub
  %cmp9 = fcmp uge double %call5, %mul8
  br i1 %cmp9, label %if.end26, label %while.end.split.loop.exit

if.else:                                          ; preds = %while.cond
  %call13 = tail call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #11
  %2 = tail call double @llvm.fmuladd.f64(double %mul12, double %call13, double 1.000000e+00)
  %div15 = fdiv double %0, %2
  %sub16 = fsub double 1.000000e+00, %div15
  %div17 = fdiv double %sub16, %alpha
  %add18 = fadd double %div17, 1.000000e+00
  %call19 = tail call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #11
  %div21 = fdiv double 1.000000e+00, %div15
  %3 = tail call double @llvm.fmuladd.f64(double %add18, double %add18, double %div21)
  %mul22 = fmul double %3, 5.000000e-01
...
while.end.split.loop.exit:                        ; preds = %if.then2
  %sub11.le = fsub double 1.000000e+00, %mul
  br label %while.end

while.end:                                        ; preds = %while.end.split.loop.exit, %if.else
  %mu.3 = phi double [ %sub11.le, %while.end.split.loop.exit ], [ %add18, %if.else ]
  %x.0 = phi double [ %1, %while.end.split.loop.exit ], [ %div15, %if.else ]
  %div27 = fdiv double %alpha, %x.0
  br label %if.end77

if.else28:                                        ; preds = %entry
  %4 = fcmp oeq double %0, 1.000000e+00
  %5 = select i1 %4, double 1.000000e+00, double -2.000000e+00
  %6 = tail call double @llvm.fabs.f64(double %0)
  %7 = tail call double @llvm.amdgcn.frexp.mant.f64(double %6)
  %8 = fcmp olt double %7, 0x3FE5555555555555
  %.neg.i.i.i = sext i1 %8 to i32
  %9 = select i1 %8, double 2.000000e+00, double 1.000000e+00
  %10 = fmul double %7, %9
  %11 = tail call i32 @llvm.amdgcn.frexp.exp.i32.f64(double %6)
  %12 = add i32 %11, %.neg.i.i.i
  ...
  %41 = fneg double %40
  %42 = tail call double @llvm.fma.f64(double %37, double %37, double %41)
  %43 = fmul double %39, 2.000000e+00
  %44 = tail call double @llvm.fma.f64(double %37, double %43, double %42)
  %45 = fadd double %40, %44
  %46 = fsub double %45, %40
  %47 = fsub double %44, %46
  %48 = tail call double @llvm.fma.f64(double %45, double 0x3FBDEE674222DE17, double 0x3FBA6564968915A9)
  %49 = tail call double @llvm.fma.f64(double %45, double %48, double 0x3FBE25E43ABE935A)
  %50 = tail call double @llvm.fma.f64(double %45, double %49, double 0x3FC110EF47E6C9C2)
  %51 = tail call double @llvm.fma.f64(double %45, double %50, double 0x3FC3B13BCFA74449)
  %52 = tail call double @llvm.fma.f64(double %45, double %51, double 0x3FC745D171BF3C30)
  %53 = tail call double @llvm.fma.f64(double %45, double %52, double 0x3FCC71C71C7792CE)
  %54 = tail call double @llvm.fma.f64(double %45, double %53, double 0x3FD24924924920DA)
  %55 = tail call double @llvm.fma.f64(double %45, double %54, double 0x3FD999999999999C)
  ...
  %64 = tail call double @llvm.ldexp.f64.i32(double %37, i32 1)
  %65 = tail call double @llvm.ldexp.f64.i32(double %39, i32 1)
  %66 = fmul double %37, %45
  %67 = fneg double %66
  %68 = tail call double @llvm.fma.f64(double %45, double %37, double %67)
  %69 = tail call double @llvm.fma.f64(double %45, double %39, double %68)
  %70 = tail call double @llvm.fma.f64(double %47, double %37, double %69)
  %71 = fadd double %66, %70
  %72 = fsub double %71, %66
  %73 = fsub double %70, %72
  %74 = fmul double %45, %55
  %75 = fneg double %74
  %76 = tail call double @llvm.fma.f64(double %45, double %55, double %75)
  %77 = tail call double @llvm.fma.f64(double %47, double %55, double %76)
  ...
  %90 = fneg double %89
  %91 = tail call double @llvm.fma.f64(double %71, double %86, double %90)
  %92 = tail call double @llvm.fma.f64(double %71, double %88, double %91)
  %93 = tail call double @llvm.fma.f64(double %73, double %86, double %92)
  ...
  %125 = fmul double %5, %122
  %126 = fneg double %125
  %127 = tail call double @llvm.fma.f64(double %5, double %122, double %126) #10
  %128 = tail call double @llvm.fma.f64(double %5, double %124, double %127) #10
  %129 = fadd double %125, %128
  %130 = fsub double %129, %125
  %131 = fsub double %128, %130
  %132 = tail call double @llvm.fabs.f64(double %125) #10
  %133 = fcmp oeq double %132, 0x7FF0000000000000
  %134 = select i1 %133, double %125, double %129
  %135 = tail call double @llvm.fabs.f64(double %134) #10
  %136 = fcmp oeq double %135, 0x7FF0000000000000
  %137 = select i1 %136, double 0.000000e+00, double %131
  %138 = fmul double %134, 0x3FF71547652B82FE
  %139 = tail call double @llvm.rint.f64(double %138)
  %140 = fneg double %139
  %141 = tail call double @llvm.fma.f64(double %140, double 0x3FE62E42FEFA39EF, double %134)
  %142 = tail call double @llvm.fma.f64(double %140, double 0x3C7ABC9E3B39803F, double %141)
  %143 = tail call double @llvm.fma.f64(double %142, double 0x3E5ADE156A5DCB37, double 0x3E928AF3FCA7AB0C)
  %144 = tail call double @llvm.fma.f64(double %142, double %143, double 0x3EC71DEE623FDE64)
  %145 = tail call double @llvm.fma.f64(double %142, double %144, double 0x3EFA01997C89E6B0)
  %146 = tail call double @llvm.fma.f64(double %142, double %145, double 0x3F2A01A014761F6E)
  %147 = tail call double @llvm.fma.f64(double %142, double %146, double 0x3F56C16C1852B7B0)
  %148 = tail call double @llvm.fma.f64(double %142, double %147, double 0x3F81111111122322)
  %149 = tail call double @llvm.fma.f64(double %142, double %148, double 0x3FA55555555502A1)
  %150 = tail call double @llvm.fma.f64(double %142, double %149, double 0x3FC5555555555511)
  %151 = tail call double @llvm.fma.f64(double %142, double %150, double 0x3FE000000000000B)
  %152 = tail call double @llvm.fma.f64(double %142, double %151, double 1.000000e+00)
  %153 = tail call double @llvm.fma.f64(double %142, double %152, double 1.000000e+00)
  %154 = fptosi double %139 to i32
  %155 = tail call double @llvm.ldexp.f64.i32(double %153, i32 %154)
  %156 = fcmp ogt double %134, 1.024000e+03
  %157 = select i1 %156, double 0x7FF0000000000000, double %155
  %158 = fcmp olt double %134, -1.075000e+03
  %159 = select i1 %158, double 0.000000e+00, double %157
  %160 = tail call double @llvm.fma.f64(double %159, double %137, double %159) #10
  %161 = tail call double @llvm.fabs.f64(double %159) #10
  %162 = fcmp oeq double %161, 0x7FF0000000000000
  %163 = select i1 %162, double %159, double %160
  %164 = tail call double @llvm.trunc.f64(double %5) #10
  %165 = fcmp oeq double %164, %5
  %166 = fmul double %5, 5.000000e-01
  %167 = tail call double @llvm.trunc.f64(double %166) #10
  %168 = fcmp une double %167, %166
  %169 = and i1 %165, %168
  %170 = select i1 %169, double %0, double 1.000000e+00
  %171 = tail call double @llvm.copysign.f64(double %163, double %170) #10
  %172 = fcmp olt double %0, 0.000000e+00
  %173 = select i1 %165, double %171, double 0x7FF8000000000000
  %174 = select i1 %172, double %173, double %171
  %175 = fcmp oeq double %6, 0x7FF0000000000000
  %176 = fcmp oeq double %0, 0.000000e+00
  %177 = or i1 %176, %175
  %178 = fcmp olt double %5, 0.000000e+00
  %179 = xor i1 %176, %178
  %180 = select i1 %179, double 0.000000e+00, double 0x7FF0000000000000
  %181 = select i1 %169, double %0, double 0.000000e+00
  %182 = tail call double @llvm.copysign.f64(double %180, double %181) #10
  %183 = select i1 %177, double %182, double %174
  %184 = fcmp uno double %0, 0.000000e+00
  %185 = fsub double 1.000000e+00, %183
  %sub30 = select i1 %184, double 0x7FF8000000000000, double %185
  %call31 = tail call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #11
  %div32 = fdiv double 4.000000e+00, %alpha
  %186 = tail call double @llvm.fmuladd.f64(double %sub30, double 5.000000e-01, double %div32)
  %add34 = fadd double %0, 1.000000e+00
  %mul35 = fmul double %alpha, %alpha
  %div36 = fdiv double %add34, %mul35
  %sub37 = fsub double 1.000000e+00, %div36
  %187 = tail call double @llvm.amdgcn.frexp.mant.f64(double %0)
  ...
  %191 = tail call i32 @llvm.amdgcn.frexp.exp.i32.f64(double %0)
  %192 = add i32 %191, %.neg.i
  ...
  %264 = select i1 %175, double %0, double %263
  %265 = select i1 %172, double 0x7FF8000000000000, double %264
  %266 = select i1 %176, double 0xFFF0000000000000, double %265
  %267 = tail call double @llvm.fmuladd.f64(double %sub37, double %266, double %186)
  %mul40 = fmul double %267, %call31
  %div41 = fdiv double 2.000000e+00, %alpha
  %cmp42 = fcmp ugt double %mul40, %div41
  br i1 %cmp42, label %if.else48, label %if.then43

if.then43:                                        ; preds = %if.else28
  %mul44 = fmul double %alpha, 2.000000e+00
  %call45 = tail call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #11
  %268 = tail call double @llvm.fmuladd.f64(double %mul44, double %call45, double 1.000000e+00)
  %div47 = fdiv double %alpha, %268
  br label %if.end72

if.else48:                                        ; preds = %if.else28
  %cmp50 = fcmp ugt double %mul40, %div32
  br i1 %cmp50, label %if.else57, label %if.then51

if.then51:                                        ; preds = %if.else48
  %mul52 = fmul double %alpha, 2.000000e+00
  %call53 = tail call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #11
  %269 = tail call double @llvm.fmuladd.f64(double %mul52, double %call53, double 1.000000e+00)
  %mul55 = fmul double %alpha, %269
  %div56 = fdiv double %mul55, %0
  br label %if.end72

if.else57:                                        ; preds = %if.else48
  %cmp60 = fcmp ugt double %mul40, %186
  br i1 %cmp60, label %if.else66, label %if.then61

if.then61:                                        ; preds = %if.else57
  %call62 = tail call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #11
  %neg = fneg double %sub30
  %270 = tail call double @llvm.fmuladd.f64(double %neg, double %call62, double 1.000000e+00)
  %271 = tail call noundef double @llvm.sqrt.f64(double %270) #10
  %mul65 = fmul double %alpha, %271
  br label %if.end72

if.else66:                                        ; preds = %if.else57
  %call67 = tail call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #11
  %272 = select i1 %4, double 1.000000e+00, double %call67
  %273 = fcmp oeq double %272, 0.000000e+00
  %274 = select i1 %273, double 1.000000e+00, double %0
  %275 = tail call double @llvm.fabs.f64(double %274) #10
  %276 = tail call double @llvm.amdgcn.frexp.mant.f64(double %275)
  %277 = fcmp olt double %276, 0x3FE5555555555555
  %.neg.i.i = sext i1 %277 to i32
  %278 = select i1 %277, double 2.000000e+00, double 1.000000e+00
  %279 = fmul double %276, %278
  %280 = tail call i32 @llvm.amdgcn.frexp.exp.i32.f64(double %275)
  %281 = add i32 %280, %.neg.i.i
  ...
  %310 = fneg double %309
  %311 = tail call double @llvm.fma.f64(double %306, double %306, double %310)
  %312 = fmul double %308, 2.000000e+00
  %313 = tail call double @llvm.fma.f64(double %306, double %312, double %311)
  %314 = fadd double %309, %313
  %315 = fsub double %314, %309
  %316 = fsub double %313, %315
  %317 = tail call double @llvm.fma.f64(double %314, double 0x3FBDEE674222DE17, double 0x3FBA6564968915A9)
  %318 = tail call double @llvm.fma.f64(double %314, double %317, double 0x3FBE25E43ABE935A)
  %319 = tail call double @llvm.fma.f64(double %314, double %318, double 0x3FC110EF47E6C9C2)
  %320 = tail call double @llvm.fma.f64(double %314, double %319, double 0x3FC3B13BCFA74449)
  %321 = tail call double @llvm.fma.f64(double %314, double %320, double 0x3FC745D171BF3C30)
  %322 = tail call double @llvm.fma.f64(double %314, double %321, double 0x3FCC71C71C7792CE)
  %323 = tail call double @llvm.fma.f64(double %314, double %322, double 0x3FD24924924920DA)
  %324 = tail call double @llvm.fma.f64(double %314, double %323, double 0x3FD999999999999C)
  %325 = sitofp i32 %281 to double
  %326 = fmul double %325, 0x3FE62E42FEFA39EF
  %327 = fneg double %326
  %328 = tail call double @llvm.fma.f64(double %325, double 0x3FE62E42FEFA39EF, double %327)
  %329 = tail call double @llvm.fma.f64(double %325, double 0x3C7ABC9E3B39803F, double %328)
  %330 = fadd double %326, %329
  %331 = fsub double %330, %326
  %332 = fsub double %329, %331
  %333 = tail call double @llvm.ldexp.f64.i32(double %306, i32 1)
  %334 = tail call double @llvm.ldexp.f64.i32(double %308, i32 1)
  %335 = fmul double %306, %314
  %336 = fneg double %335
  %337 = tail call double @llvm.fma.f64(double %314, double %306, double %336)
  %338 = tail call double @llvm.fma.f64(double %314, double %308, double %337)
  %339 = tail call double @llvm.fma.f64(double %316, double %306, double %338)
  %340 = fadd double %335, %339
  %341 = fsub double %340, %335
  %342 = fsub double %339, %341
  %343 = fmul double %314, %324
  %344 = fneg double %343
  %345 = tail call double @llvm.fma.f64(double %314, double %324, double %344)
  %346 = tail call double @llvm.fma.f64(double %316, double %324, double %345)
  %347 = fadd double %343, %346
  %348 = fsub double %347, %343
  %349 = fsub double %346, %348
  %350 = fadd double %347, 0x3FE5555555555555
  %351 = fadd double %350, 0xBFE5555555555555
  %352 = fsub double %347, %351
  %353 = fadd double %349, 0x3C8543B0D5DF274D
  %354 = fadd double %353, %352
  %355 = fadd double %350, %354
  %356 = fsub double %350, %355
  %357 = fadd double %354, %356
  %358 = fmul double %340, %355
  %359 = fneg double %358
  %360 = tail call double @llvm.fma.f64(double %340, double %355, double %359)
  %361 = tail call double @llvm.fma.f64(double %340, double %357, double %360)
  %362 = tail call double @llvm.fma.f64(double %342, double %355, double %361)
  %363 = fadd double %358, %362
  %364 = fsub double %363, %358
  %365 = fsub double %362, %364
  %366 = fadd double %333, %363
  %367 = fsub double %366, %333
  %368 = fsub double %363, %367
  %369 = fadd double %334, %365
  %370 = fadd double %369, %368
  %371 = fadd double %366, %370
  %372 = fsub double %371, %366
  %373 = fsub double %370, %372
  %374 = fadd double %330, %371
  %375 = fsub double %374, %330
  %376 = fsub double %374, %375
  %377 = fsub double %330, %376
  %378 = fsub double %371, %375
  %379 = fadd double %378, %377
  %380 = fadd double %332, %373
  %381 = fsub double %380, %332
  %382 = fsub double %380, %381
  %383 = fsub double %332, %382
  %384 = fsub double %373, %381
  %385 = fadd double %384, %383
  %386 = fadd double %380, %379
  %387 = fadd double %374, %386
  %388 = fsub double %387, %374
  %389 = fsub double %386, %388
  %390 = fadd double %385, %389
  %391 = fadd double %387, %390
  %392 = fsub double %391, %387
  %393 = fsub double %390, %392
  %394 = fmul double %272, %391
  %395 = fneg double %394
  %396 = tail call double @llvm.fma.f64(double %272, double %391, double %395) #10
  %397 = tail call double @llvm.fma.f64(double %272, double %393, double %396) #10
  %398 = fadd double %394, %397
  %399 = fsub double %398, %394
  %400 = fsub double %397, %399
  %401 = tail call double @llvm.fabs.f64(double %394) #10
  %402 = fcmp oeq double %401, 0x7FF0000000000000
  %403 = select i1 %402, double %394, double %398
  %404 = tail call double @llvm.fabs.f64(double %403) #10
  %405 = fcmp oeq double %404, 0x7FF0000000000000
  %406 = select i1 %405, double 0.000000e+00, double %400
  %407 = fmul double %403, 0x3FF71547652B82FE
  %408 = tail call double @llvm.rint.f64(double %407)
  %409 = fneg double %408
  %410 = tail call double @llvm.fma.f64(double %409, double 0x3FE62E42FEFA39EF, double %403)
  %411 = tail call double @llvm.fma.f64(double %409, double 0x3C7ABC9E3B39803F, double %410)
  %412 = tail call double @llvm.fma.f64(double %411, double 0x3E5ADE156A5DCB37, double 0x3E928AF3FCA7AB0C)
  %413 = tail call double @llvm.fma.f64(double %411, double %412, double 0x3EC71DEE623FDE64)
  %414 = tail call double @llvm.fma.f64(double %411, double %413, double 0x3EFA01997C89E6B0)
  %415 = tail call double @llvm.fma.f64(double %411, double %414, double 0x3F2A01A014761F6E)
  %416 = tail call double @llvm.fma.f64(double %411, double %415, double 0x3F56C16C1852B7B0)
  %417 = tail call double @llvm.fma.f64(double %411, double %416, double 0x3F81111111122322)
  %418 = tail call double @llvm.fma.f64(double %411, double %417, double 0x3FA55555555502A1)
  %419 = tail call double @llvm.fma.f64(double %411, double %418, double 0x3FC5555555555511)
  %420 = tail call double @llvm.fma.f64(double %411, double %419, double 0x3FE000000000000B)
  %421 = tail call double @llvm.fma.f64(double %411, double %420, double 1.000000e+00)
  %422 = tail call double @llvm.fma.f64(double %411, double %421, double 1.000000e+00)
  %423 = fptosi double %408 to i32
  %424 = tail call double @llvm.ldexp.f64.i32(double %422, i32 %423)
  %425 = fcmp ogt double %403, 1.024000e+03
  %426 = select i1 %425, double 0x7FF0000000000000, double %424
  %427 = fcmp olt double %403, -1.075000e+03
  %428 = select i1 %427, double 0.000000e+00, double %426
  %429 = tail call double @llvm.fma.f64(double %428, double %406, double %428) #10
  %430 = tail call double @llvm.fabs.f64(double %428) #10
  %431 = fcmp oeq double %430, 0x7FF0000000000000
  %432 = select i1 %431, double %428, double %429
  %433 = tail call double @llvm.trunc.f64(double %272) #10
  %434 = fcmp oeq double %433, %272
  %435 = fmul double %272, 5.000000e-01
  %436 = tail call double @llvm.trunc.f64(double %435) #10
  %437 = fcmp une double %436, %435
  %438 = and i1 %434, %437
  %439 = select i1 %438, double %274, double 1.000000e+00
  %440 = tail call double @llvm.copysign.f64(double %432, double %439) #10
  %441 = fcmp olt double %274, 0.000000e+00
  %442 = select i1 %434, double %440, double 0x7FF8000000000000
  %443 = select i1 %441, double %442, double %440
  %444 = tail call double @llvm.fabs.f64(double %272) #10
  %445 = fcmp oeq double %444, 0x7FF0000000000000
  %446 = fcmp oeq double %275, 1.000000e+00
  %447 = fcmp une double %272, %444
  %448 = fcmp olt double %275, 1.000000e+00
  %449 = xor i1 %447, %448
  %450 = select i1 %449, double 0.000000e+00, double 0x7FF0000000000000
  %451 = select i1 %446, double 1.000000e+00, double %450
  %452 = select i1 %445, double %451, double %443
  %453 = fcmp oeq double %275, 0x7FF0000000000000
  %454 = fcmp oeq double %274, 0.000000e+00
  %455 = or i1 %454, %453
  %456 = fcmp olt double %272, 0.000000e+00
  %457 = xor i1 %456, %454
  %458 = select i1 %457, double 0.000000e+00, double 0x7FF0000000000000
  %459 = select i1 %438, double %274, double 0.000000e+00
  %460 = tail call double @llvm.copysign.f64(double %458, double %459) #10
  %461 = select i1 %455, double %460, double %452
  %462 = fcmp uno double %274, %272
  %463 = select i1 %462, double 0x7FF8000000000000, double %461
  %div69 = fdiv double %alpha, %463
  br label %if.end72

if.end72:                                         ; preds = %if.else66, %if.then61, %if.then51, %if.then43
  %alpha_out.0 = phi double [ %div69, %if.else66 ], [ %mul65, %if.then61 ], [ %div56, %if.then51 ], [ %div47, %if.then43 ]
  %div73 = fdiv double 1.000000e+00, %alpha
  %add74 = fadd double %div73, 1.000000e+00
  %div75 = fdiv double 1.000000e+00, %alpha_out.0
  %sub76 = fsub double %add74, %div75
  br label %if.end77

if.end77:                                         ; preds = %if.end72, %while.end
  %alpha_out.1 = phi double [ %div27, %while.end ], [ %alpha_out.0, %if.end72 ]
  %mu.4 = phi double [ %mu.3, %while.end ], [ %sub76, %if.end72 ]
  %.fca.0.insert = insertvalue %"struct.std::pair" poison, double %alpha_out.1, 0
  %.fca.1.insert = insertvalue %"struct.std::pair" %.fca.0.insert, double %mu.4, 1
  ret %"struct.std::pair" %.fca.1.insert
}

; Function Attrs: convergent mustprogress nounwind
define hidden %"class.openmc::Tabulated1DFlat" @_ZNK6openmc17PhotonInteraction22incoherent_form_factorEv(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(1936) %this) local_unnamed_addr #4 align 2 {
entry:
  %retval = alloca %"class.openmc::Tabulated1DFlat", align 8, addrspace(5)
  %retval.ascast = addrspacecast ptr addrspace(5) %retval to ptr
  %buffer_ = getelementptr inbounds nuw i8, ptr %this, i64 1904
  %0 = load ptr, ptr %buffer_, align 8, !tbaa !53
  %add.ptr = getelementptr inbounds nuw i8, ptr %0, i64 8
  call void @_ZN6openmc15Tabulated1DFlatC1EPKh(ptr noundef nonnull align 8 dereferenceable(24) %retval.ascast, ptr noundef nonnull %add.ptr) #11
...
; Function Attrs: convergent mustprogress nounwind
define hidden void @_ZNK6openmc17PhotonInteraction15compton_dopplerEddPdPiPm(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(1936) %this, double noundef %alpha, double noundef %mu, ptr noundef writeonly captures(none) %E_out, ptr noundef writeonly captures(none) %i_shell, ptr noundef %seed) local_unnamed_addr #4 align 2 {
entry:
  %0 = load i64, ptr addrspace(1) @_ZN6openmc4data23compton_profile_pz_sizeE, align 8, !tbaa !111
  %device_electron_pdf_ = getelementptr inbounds nuw i8, ptr %this, i64 1528
  %p_end.i.i = getelementptr inbounds nuw i8, ptr %this, i64 1488
  %p_begin.i.i = getelementptr inbounds nuw i8, ptr %this, i64 1480
  %device_binding_energy_ = getelementptr inbounds nuw i8, ptr %this, i64 1520
  %mul = fmul double %alpha, 0x411F305BC8CE703B
  %sub13 = fsub double 1.000000e+00, %mu
  %1 = fneg double %alpha
  %mul16 = fmul double %mul, 2.000000e+00
  %sub31 = add i64 %0, -1
  %device_profile_pdf_.i = getelementptr inbounds nuw i8, ptr %this, i64 1504
  %n_profile_.i109 = getelementptr inbounds nuw i8, ptr %this, i64 1496
  %device_profile_cdf_.i118 = getelementptr inbounds nuw i8, ptr %this, i64 1512
  %size_.i = getelementptr inbounds nuw i8, ptr %this, i64 1144
  %2 = tail call double @llvm.fmuladd.f64(double %alpha, double %sub13, double 1.000000e+00)
  %neg135 = fneg double %2
  %mul140 = fmul double %mul, %mul
  br label %while.cond

while.cond:                                       ; preds = %while.cond.backedge, %entry
  %call = tail call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #11
  %3 = load ptr, ptr %p_end.i.i, align 8, !tbaa !113
  %4 = load ptr, ptr %p_begin.i.i, align 8, !tbaa !112
  %sub.ptr.lhs.cast.i.i = ptrtoint ptr %3 to i64
  %sub.ptr.rhs.cast.i.i = ptrtoint ptr %4 to i64
  %sub.ptr.sub.i.i = sub i64 %sub.ptr.lhs.cast.i.i, %sub.ptr.rhs.cast.i.i
  %sub.ptr.div.i.i = ashr exact i64 %sub.ptr.sub.i.i, 3
  %cmp182.not = icmp eq ptr %3, %4
  br i1 %cmp182.not, label %for.end, label %for.body.lr.ph

for.body.lr.ph:                                   ; preds = %while.cond
  %5 = load ptr, ptr %device_electron_pdf_, align 8, !tbaa !114
  %umax = call i64 @llvm.umax.i64(i64 %sub.ptr.div.i.i, i64 1)
  br label %for.body

for.body:                                         ; preds = %for.inc, %for.body.lr.ph
  %conv185 = phi i64 [ 0, %for.body.lr.ph ], [ %inc, %for.inc ]
  %c.0183 = phi double [ 0.000000e+00, %for.body.lr.ph ], [ %add, %for.inc ]
  %arrayidx = getelementptr inbounds nuw double, ptr %5, i64 %conv185
  %6 = load double, ptr %arrayidx, align 8, !tbaa !51
  %add = fadd double %c.0183, %6
  %cmp3 = fcmp olt double %call, %add
  br i1 %cmp3, label %for.end.loopexit, label %for.inc

for.inc:                                          ; preds = %for.body
  %inc = add nuw i64 %conv185, 1
  %cmp = icmp ugt i64 %sub.ptr.div.i.i, %inc
  br i1 %cmp, label %for.body, label %for.end.loopexit, !llvm.loop !124

for.end.loopexit:                                 ; preds = %for.inc, %for.body
  %conv.lcssa.ph = phi i64 [ %umax, %for.inc ], [ %conv185, %for.body ]
  %shell.0.lcssa.ph = trunc i64 %conv.lcssa.ph to i32
  br label %for.end

for.end:                                          ; preds = %for.end.loopexit, %while.cond
  %shell.0.lcssa = phi i32 [ 0, %while.cond ], [ %shell.0.lcssa.ph, %for.end.loopexit ]
  %conv.lcssa = phi i64 [ 0, %while.cond ], [ %conv.lcssa.ph, %for.end.loopexit ]
  %7 = load ptr, ptr %device_binding_energy_, align 8, !tbaa !116
  %arrayidx5 = getelementptr inbounds nuw double, ptr %7, i64 %conv.lcssa
  %8 = load double, ptr %arrayidx5, align 8, !tbaa !51
  %cmp6 = fcmp olt double %mul, %8
  br i1 %cmp6, label %while.end.sink.split, label %if.end10

if.end10:                                         ; preds = %for.end
  %sub11 = fsub double %mul, %8
  %neg = fmul double %sub11, %1
  %9 = tail call double @llvm.fmuladd.f64(double %neg, double %sub13, double %8)
  %mul15 = fmul double %9, 0xC0612126E7AA960E
  %mul18 = fmul double %mul16, %sub11
  %mul21 = fmul double %8, %8
  %10 = tail call double @llvm.fmuladd.f64(double %mul18, double %sub13, double %mul21)
  %11 = tail call noundef double @llvm.sqrt.f64(double %10) #10
  %div23 = fdiv double %mul15, %11
  %cmp24 = fcmp olt double %div23, 0.000000e+00
  br i1 %cmp24, label %while.end.sink.split, label %if.end30

if.end30:                                         ; preds = %if.end10
  %12 = load ptr, ptr addrspace(1) @_ZN6openmc4data18compton_profile_pzE, align 8, !tbaa !40
  %arrayidx32 = getelementptr inbounds nuw double, ptr %12, i64 %sub31
  %13 = load double, ptr %arrayidx32, align 8, !tbaa !51
  %cmp33 = fcmp ogt double %div23, %13
  br i1 %cmp33, label %if.then34, label %if.else

if.then34:                                        ; preds = %if.end30
  %14 = load ptr, ptr %device_profile_cdf_.i118, align 8, !tbaa !118
  %15 = load i64, ptr %n_profile_.i109, align 8, !tbaa !117
  %mul.i = mul i64 %15, %conv.lcssa
  %add.ptr.i = getelementptr inbounds nuw double, ptr %14, i64 %mul.i
  %add.ptr2.i = getelementptr inbounds double, ptr %add.ptr.i, i64 %sub31
  %16 = load double, ptr %add.ptr2.i, align 8, !tbaa !51
  br label %if.end76

if.else:                                          ; preds = %if.end30
  %17 = load double, ptr %12, align 8, !tbaa !51
  %cmp.i = fcmp oeq double %17, %div23
  br i1 %cmp.i, label %_ZN6openmc17lower_bound_indexIPddEENSt15iterator_traitsIT_E15difference_typeES3_S3_RKT0_.exit, label %if.end.i

if.end.i:                                         ; preds = %if.else
  %18 = load i64, ptr addrspace(1) @_ZN6openmc4data23compton_profile_pz_sizeE, align 8, !tbaa !111
  %sub.ptr.rhs.cast.i.i.i.i.i = ptrtoint ptr %12 to i64
  %cmp11.i.i.i = icmp sgt i64 %18, 0
  br i1 %cmp11.i.i.i, label %while.body.i.i.i, label %_ZSt11lower_boundIPddET_S1_S1_RKT0_.exit.i

while.body.i.i.i:                                 ; preds = %while.body.i.i.i, %if.end.i
  %__first.addr.013.i.i.i = phi ptr [ %__first.addr.1.i.i.i, %while.body.i.i.i ], [ %12, %if.end.i ]
  %__len.012.i.i.i = phi i64 [ %__len.1.i.i.i, %while.body.i.i.i ], [ %18, %if.end.i ]
  %shr.i.i.i = lshr i64 %__len.012.i.i.i, 1
  %19 = tail call i1 @llvm.is.constant.i64(i64 %shr.i.i.i)
  %cmp.i.i.i.i.i = icmp eq i64 %shr.i.i.i, 1
  %or.cond.i.i.i.i.i = and i1 %19, %cmp.i.i.i.i.i
  ...
  %20 = load double, ptr %incdec.ptr4.sink.i.i.i.i.i, align 8, !tbaa !51
  %cmp.i.i.i.i = fcmp olt double %20, %div23
  ...
  br i1 %cmp.i.i.i, label %while.body.i.i.i, label %_ZSt11lower_boundIPddET_S1_S1_RKT0_.exit.loopexit.i, !llvm.loop !125

_ZSt11lower_boundIPddET_S1_S1_RKT0_.exit.loopexit.i: ; preds = %while.body.i.i.i
  %.pre.i = ptrtoint ptr %__first.addr.1.i.i.i to i64
  br label %_ZSt11lower_boundIPddET_S1_S1_RKT0_.exit.i

_ZSt11lower_boundIPddET_S1_S1_RKT0_.exit.i:       ; preds = %_ZSt11lower_boundIPddET_S1_S1_RKT0_.exit.loopexit.i, %if.end.i
  %sub.ptr.lhs.cast.pre-phi.i = phi i64 [ %.pre.i, %_ZSt11lower_boundIPddET_S1_S1_RKT0_.exit.loopexit.i ], [ %sub.ptr.rhs.cast.i.i.i.i.i, %if.end.i ]
  %sub.ptr.sub.i = sub i64 %sub.ptr.lhs.cast.pre-phi.i, %sub.ptr.rhs.cast.i.i.i.i.i
  %sub.i = shl i64 %sub.ptr.sub.i, 29
  %22 = add i64 %sub.i, -4294967296
  br label %_ZN6openmc17lower_bound_indexIPddEENSt15iterator_traitsIT_E15difference_typeES3_S3_RKT0_.exit

_ZN6openmc17lower_bound_indexIPddEENSt15iterator_traitsIT_E15difference_typeES3_S3_RKT0_.exit: ; preds = %_ZSt11lower_boundIPddET_S1_S1_RKT0_.exit.i, %if.else
  %retval.0.i = phi i64 [ %22, %_ZSt11lower_boundIPddET_S1_S1_RKT0_.exit.i ], [ 0, %if.else ]
  %idxprom40 = ashr exact i64 %retval.0.i, 32
  %arrayidx41 = getelementptr inbounds double, ptr %12, i64 %idxprom40
  %23 = load double, ptr %arrayidx41, align 8, !tbaa !51
  %sext106 = add i64 %retval.0.i, 4294967296
  %idxprom43 = ashr exact i64 %sext106, 32
  %arrayidx44 = getelementptr inbounds double, ptr %12, i64 %idxprom43
  %24 = load double, ptr %arrayidx44, align 8, !tbaa !51
  %25 = load ptr, ptr %device_profile_pdf_.i, align 8, !tbaa !120
  %26 = load i64, ptr %n_profile_.i109, align 8, !tbaa !117
  %mul.i110 = mul i64 %26, %conv.lcssa
  %add.ptr.i111 = getelementptr inbounds nuw double, ptr %25, i64 %mul.i110
  %add.ptr2.i112 = getelementptr inbounds double, ptr %add.ptr.i111, i64 %idxprom40
  %27 = load double, ptr %add.ptr2.i112, align 8, !tbaa !51
  %add.ptr2.i117 = getelementptr inbounds double, ptr %add.ptr.i111, i64 %idxprom43
  %28 = load double, ptr %add.ptr2.i117, align 8, !tbaa !51
  %29 = load ptr, ptr %device_profile_cdf_.i118, align 8, !tbaa !118
  %add.ptr.i121 = getelementptr inbounds nuw double, ptr %29, i64 %mul.i110
  %add.ptr2.i122 = getelementptr inbounds double, ptr %add.ptr.i121, i64 %idxprom40
  %30 = load double, ptr %add.ptr2.i122, align 8, !tbaa !51
  %cmp55 = fcmp oeq double %23, %24
  br i1 %cmp55, label %if.end76, label %if.else57

if.else57:                                        ; preds = %_ZN6openmc17lower_bound_indexIPddEENSt15iterator_traitsIT_E15difference_typeES3_S3_RKT0_.exit
  %cmp58 = fcmp oeq double %27, %28
  br i1 %cmp58, label %if.then59, label %if.else62

if.then59:                                        ; preds = %if.else57
  %sub60 = fsub double %div23, %23
  %31 = tail call double @llvm.fmuladd.f64(double %sub60, double %27, double %30)
  br label %if.end76

if.else62:                                        ; preds = %if.else57
  %sub63 = fsub double %27, %28
  %sub64 = fsub double %23, %24
  %div65 = fdiv double %sub63, %sub64
  %sub66 = fsub double %div23, %23
  %32 = tail call double @llvm.fmuladd.f64(double %div65, double %sub66, double %27)
  %33 = fcmp oeq double %32, 1.000000e+00
  %34 = select i1 %33, double 1.000000e+00, double 2.000000e+00
  %35 = tail call double @llvm.fabs.f64(double %32) #10
  ...
  %38 = select i1 %37, double 2.000000e+00, double 1.000000e+00
  %39 = fmul double %36, %38
  %40 = tail call i32 @llvm.amdgcn.frexp.exp.i32.f64(double %35)
  %41 = add i32 %40, %.neg.i.i.i
  ...
  %59 = fsub double %42, %57
  %60 = fsub double %42, %59
  %61 = fsub double %60, %57
  %62 = fsub double %58, %56
  ...
  %70 = fneg double %69
  %71 = tail call double @llvm.fma.f64(double %66, double %66, double %70)
  %72 = fmul double %68, 2.000000e+00
  %73 = tail call double @llvm.fma.f64(double %66, double %72, double %71)
  %74 = fadd double %69, %73
  %75 = fsub double %74, %69
  %76 = fsub double %73, %75
  %77 = tail call double @llvm.fma.f64(double %74, double 0x3FBDEE674222DE17, double 0x3FBA6564968915A9)
  %78 = tail call double @llvm.fma.f64(double %74, double %77, double 0x3FBE25E43ABE935A)
  %79 = tail call double @llvm.fma.f64(double %74, double %78, double 0x3FC110EF47E6C9C2)
  %80 = tail call double @llvm.fma.f64(double %74, double %79, double 0x3FC3B13BCFA74449)
  %81 = tail call double @llvm.fma.f64(double %74, double %80, double 0x3FC745D171BF3C30)
  %82 = tail call double @llvm.fma.f64(double %74, double %81, double 0x3FCC71C71C7792CE)
  %83 = tail call double @llvm.fma.f64(double %74, double %82, double 0x3FD24924924920DA)
  %84 = tail call double @llvm.fma.f64(double %74, double %83, double 0x3FD999999999999C)
  %85 = sitofp i32 %41 to double
  %86 = fmul double %85, 0x3FE62E42FEFA39EF
  %87 = fneg double %86
  %88 = tail call double @llvm.fma.f64(double %85, double 0x3FE62E42FEFA39EF, double %87)
  %89 = tail call double @llvm.fma.f64(double %85, double 0x3C7ABC9E3B39803F, double %88)
  %90 = fadd double %86, %89
  %91 = fsub double %90, %86
  %92 = fsub double %89, %91
  %93 = tail call double @llvm.ldexp.f64.i32(double %66, i32 1)
  %94 = tail call double @llvm.ldexp.f64.i32(double %68, i32 1)
  %95 = fmul double %66, %74
  %96 = fneg double %95
  %97 = tail call double @llvm.fma.f64(double %74, double %66, double %96)
  %98 = tail call double @llvm.fma.f64(double %74, double %68, double %97)
  %99 = tail call double @llvm.fma.f64(double %76, double %66, double %98)
  %100 = fadd double %95, %99
  %101 = fsub double %100, %95
  %102 = fsub double %99, %101
  %103 = fmul double %74, %84
  %104 = fneg double %103
  %105 = tail call double @llvm.fma.f64(double %74, double %84, double %104)
  %106 = tail call double @llvm.fma.f64(double %76, double %84, double %105)
  %107 = fadd double %103, %106
  %108 = fsub double %107, %103
  %109 = fsub double %106, %108
  %110 = fadd double %107, 0x3FE5555555555555
  %111 = fadd double %110, 0xBFE5555555555555
  %112 = fsub double %107, %111
  %113 = fadd double %109, 0x3C8543B0D5DF274D
  %114 = fadd double %113, %112
  %115 = fadd double %110, %114
  %116 = fsub double %110, %115
  %117 = fadd double %114, %116
  %118 = fmul double %100, %115
  %119 = fneg double %118
  %120 = tail call double @llvm.fma.f64(double %100, double %115, double %119)
  %121 = tail call double @llvm.fma.f64(double %100, double %117, double %120)
  %122 = tail call double @llvm.fma.f64(double %102, double %115, double %121)
  %123 = fadd double %118, %122
  %124 = fsub double %123, %118
  %125 = fsub double %122, %124
  %126 = fadd double %93, %123
  %127 = fsub double %126, %93
  ...
  %134 = fadd double %90, %131
  %135 = fsub double %134, %90
  %136 = fsub double %134, %135
  %137 = fsub double %90, %136
  %138 = fsub double %131, %135
  %139 = fadd double %138, %137
  %140 = fadd double %92, %133
  %141 = fsub double %140, %92
  ...
  %154 = fmul double %34, %151
  %155 = fneg double %154
  %156 = tail call double @llvm.fma.f64(double %34, double %151, double %155) #10
  %157 = tail call double @llvm.fma.f64(double %34, double %153, double %156) #10
  %158 = fadd double %154, %157
  %159 = fsub double %158, %154
  %160 = fsub double %157, %159
  %161 = tail call double @llvm.fabs.f64(double %154) #10
  %162 = fcmp oeq double %161, 0x7FF0000000000000
  %163 = select i1 %162, double %154, double %158
  %164 = tail call double @llvm.fabs.f64(double %163) #10
  %165 = fcmp oeq double %164, 0x7FF0000000000000
  %166 = select i1 %165, double 0.000000e+00, double %160
  %167 = fmul double %163, 0x3FF71547652B82FE
  %168 = tail call double @llvm.rint.f64(double %167)
  %169 = fneg double %168
  %170 = tail call double @llvm.fma.f64(double %169, double 0x3FE62E42FEFA39EF, double %163)
  %171 = tail call double @llvm.fma.f64(double %169, double 0x3C7ABC9E3B39803F, double %170)
  %172 = tail call double @llvm.fma.f64(double %171, double 0x3E5ADE156A5DCB37, double 0x3E928AF3FCA7AB0C)
  %173 = tail call double @llvm.fma.f64(double %171, double %172, double 0x3EC71DEE623FDE64)
  %174 = tail call double @llvm.fma.f64(double %171, double %173, double 0x3EFA01997C89E6B0)
  %175 = tail call double @llvm.fma.f64(double %171, double %174, double 0x3F2A01A014761F6E)
  %176 = tail call double @llvm.fma.f64(double %171, double %175, double 0x3F56C16C1852B7B0)
  %177 = tail call double @llvm.fma.f64(double %171, double %176, double 0x3F81111111122322)
  %178 = tail call double @llvm.fma.f64(double %171, double %177, double 0x3FA55555555502A1)
  %179 = tail call double @llvm.fma.f64(double %171, double %178, double 0x3FC5555555555511)
  %180 = tail call double @llvm.fma.f64(double %171, double %179, double 0x3FE000000000000B)
  %181 = tail call double @llvm.fma.f64(double %171, double %180, double 1.000000e+00)
  %182 = tail call double @llvm.fma.f64(double %171, double %181, double 1.000000e+00)
  %183 = fptosi double %168 to i32
  %184 = tail call double @llvm.ldexp.f64.i32(double %182, i32 %183)
  %185 = fcmp ogt double %163, 1.024000e+03
  %186 = select i1 %185, double 0x7FF0000000000000, double %184
  %187 = fcmp olt double %163, -1.075000e+03
  %188 = select i1 %187, double 0.000000e+00, double %186
  %189 = tail call double @llvm.fma.f64(double %188, double %166, double %188) #10
  %190 = tail call double @llvm.fabs.f64(double %188) #10
  %191 = fcmp oeq double %190, 0x7FF0000000000000
  %192 = select i1 %191, double %188, double %189
  %193 = tail call double @llvm.trunc.f64(double %34) #10
  %194 = fcmp oeq double %193, %34
  %195 = fmul double %34, 5.000000e-01
  %196 = tail call double @llvm.trunc.f64(double %195) #10
  %197 = fcmp une double %196, %195
  %198 = and i1 %194, %197
  %199 = select i1 %198, double %32, double 1.000000e+00
  %200 = tail call double @llvm.copysign.f64(double %192, double %199) #10
  %201 = fcmp olt double %32, 0.000000e+00
  %202 = select i1 %194, double %200, double 0x7FF8000000000000
  %203 = select i1 %201, double %202, double %200
  %204 = fcmp oeq double %35, 0x7FF0000000000000
  %205 = fcmp oeq double %32, 0.000000e+00
  %206 = or i1 %205, %204
  %207 = select i1 %205, double 0.000000e+00, double 0x7FF0000000000000
  %208 = select i1 %198, double %32, double 0.000000e+00
  %209 = tail call double @llvm.copysign.f64(double %207, double %208) #10
  %210 = select i1 %206, double %209, double %203
  %211 = fcmp uno double %32, 0.000000e+00
  %neg70 = fneg double %27
  %212 = tail call double @llvm.fmuladd.f64(double %neg70, double %27, double %210)
  %213 = select i1 %211, double 0x7FF8000000000000, double %212
  %mul71 = fmul double %div65, 2.000000e+00
  %div72 = fdiv double %213, %mul71
  %add73 = fadd double %30, %div72
  br label %if.end76

if.end76:                                         ; preds = %if.else62, %if.then59, %_ZN6openmc17lower_bound_indexIPddEENSt15iterator_traitsIT_E15difference_typeES3_S3_RKT0_.exit, %if.then34
  %c_max.1 = phi double [ %16, %if.then34 ], [ %31, %if.then59 ], [ %add73, %if.else62 ], [ %30, %_ZN6openmc17lower_bound_indexIPddEENSt15iterator_traitsIT_E15difference_typeES3_S3_RKT0_.exit ]
  %call77 = tail call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #11
  %mul78 = fmul double %c_max.1, %call77
  %214 = load ptr, ptr %device_profile_cdf_.i118, align 8, !tbaa !118
  %215 = load i64, ptr %n_profile_.i109, align 8, !tbaa !117
  %mul80 = mul i64 %215, %conv.lcssa
  %add.ptr81 = getelementptr inbounds nuw double, ptr %214, i64 %mul80
  %216 = load double, ptr %add.ptr81, align 8, !tbaa !51
  %cmp.i123 = fcmp oeq double %216, %mul78
  br i1 %cmp.i123, label %_ZN6openmc17lower_bound_indexIPddEENSt15iterator_traitsIT_E15difference_typeES3_S3_RKT0_.exit153, label %if.end.i124

if.end.i124:                                      ; preds = %if.end76
  %217 = load i64, ptr %size_.i, align 8, !tbaa !26
  %sub.ptr.rhs.cast.i.i.i.i.i126 = ptrtoint ptr %add.ptr81 to i64
  %cmp11.i.i.i129 = icmp sgt i64 %217, 0
  br i1 %cmp11.i.i.i129, label %while.body.i.i.i136, label %_ZSt11lower_boundIPddET_S1_S1_RKT0_.exit.i130

while.body.i.i.i136:                              ; preds = %while.body.i.i.i136, %if.end.i124
  %__first.addr.013.i.i.i137 = phi ptr [ %__first.addr.1.i.i.i149, %while.body.i.i.i136 ], [ %add.ptr81, %if.end.i124 ]
  %__len.012.i.i.i138 = phi i64 [ %__len.1.i.i.i148, %while.body.i.i.i136 ], [ %217, %if.end.i124 ]
  %shr.i.i.i139 = lshr i64 %__len.012.i.i.i138, 1
  %218 = tail call i1 @llvm.is.constant.i64(i64 %shr.i.i.i139)
  %cmp.i.i.i.i.i140 = icmp eq i64 %shr.i.i.i139, 1
  %or.cond.i.i.i.i.i141 = and i1 %218, %cmp.i.i.i.i.i140
  %add.ptr.i.i.i.i.i142 = getelementptr inbounds nuw double, ptr %__first.addr.013.i.i.i137, i64 %shr.i.i.i139
  %incdec.ptr.i.i.i.i.i143 = getelementptr inbounds nuw i8, ptr %__first.addr.013.i.i.i137, i64 8
  %incdec.ptr4.sink.i.i.i.i.i144 = select i1 %or.cond.i.i.i.i.i141, ptr %incdec.ptr.i.i.i.i.i143, ptr %add.ptr.i.i.i.i.i142
  %219 = load double, ptr %incdec.ptr4.sink.i.i.i.i.i144, align 8, !tbaa !51
  %cmp.i.i.i.i145 = fcmp olt double %219, %mul78
  %incdec.ptr.i.i.i146 = getelementptr inbounds nuw i8, ptr %incdec.ptr4.sink.i.i.i.i.i144, i64 8
  %220 = xor i64 %shr.i.i.i139, -1
  %sub2.i.i.i147 = add nsw i64 %__len.012.i.i.i138, %220
  ...
  br i1 %cmp.i.i.i150, label %while.body.i.i.i136, label %_ZSt11lower_boundIPddET_S1_S1_RKT0_.exit.loopexit.i151, !llvm.loop !125

_ZSt11lower_boundIPddET_S1_S1_RKT0_.exit.loopexit.i151: ; preds = %while.body.i.i.i136
  %.pre.i152 = ptrtoint ptr %__first.addr.1.i.i.i149 to i64
  br label %_ZSt11lower_boundIPddET_S1_S1_RKT0_.exit.i130

_ZSt11lower_boundIPddET_S1_S1_RKT0_.exit.i130:    ; preds = %_ZSt11lower_boundIPddET_S1_S1_RKT0_.exit.loopexit.i151, %if.end.i124
  %sub.ptr.lhs.cast.pre-phi.i131 = phi i64 [ %.pre.i152, %_ZSt11lower_boundIPddET_S1_S1_RKT0_.exit.loopexit.i151 ], [ %sub.ptr.rhs.cast.i.i.i.i.i126, %if.end.i124 ]
  %sub.ptr.sub.i132 = sub i64 %sub.ptr.lhs.cast.pre-phi.i131, %sub.ptr.rhs.cast.i.i.i.i.i126
  %sub.i134 = shl i64 %sub.ptr.sub.i132, 29
  %221 = add i64 %sub.i134, -4294967296
  br label %_ZN6openmc17lower_bound_indexIPddEENSt15iterator_traitsIT_E15difference_typeES3_S3_RKT0_.exit153

_ZN6openmc17lower_bound_indexIPddEENSt15iterator_traitsIT_E15difference_typeES3_S3_RKT0_.exit153: ; preds = %_ZSt11lower_boundIPddET_S1_S1_RKT0_.exit.i130, %if.end76
  %retval.0.i135 = phi i64 [ %221, %_ZSt11lower_boundIPddET_S1_S1_RKT0_.exit.i130 ], [ 0, %if.end76 ]
  %222 = load ptr, ptr addrspace(1) @_ZN6openmc4data18compton_profile_pzE, align 8, !tbaa !40
  %idxprom88 = ashr exact i64 %retval.0.i135, 32
  %arrayidx89 = getelementptr inbounds double, ptr %222, i64 %idxprom88
  %223 = load double, ptr %arrayidx89, align 8, !tbaa !51
  %sext108 = add i64 %retval.0.i135, 4294967296
  %idxprom92 = ashr exact i64 %sext108, 32
  %arrayidx93 = getelementptr inbounds double, ptr %222, i64 %idxprom92
  %224 = load double, ptr %arrayidx93, align 8, !tbaa !51
  %225 = load ptr, ptr %device_profile_pdf_.i, align 8, !tbaa !120
  %add.ptr.i157 = getelementptr inbounds nuw double, ptr %225, i64 %mul80
  %add.ptr2.i158 = getelementptr inbounds double, ptr %add.ptr.i157, i64 %idxprom88
  %226 = load double, ptr %add.ptr2.i158, align 8, !tbaa !51
  %add.ptr2.i163 = getelementptr inbounds double, ptr %add.ptr.i157, i64 %idxprom92
  %227 = load double, ptr %add.ptr2.i163, align 8, !tbaa !51
  %add.ptr2.i168 = getelementptr inbounds double, ptr %add.ptr81, i64 %idxprom88
  %228 = load double, ptr %add.ptr2.i168, align 8, !tbaa !51
  %cmp107 = fcmp oeq double %223, %224
  br i1 %cmp107, label %if.end129, label %if.else109

if.else109:                                       ; preds = %_ZN6openmc17lower_bound_indexIPddEENSt15iterator_traitsIT_E15difference_typeES3_S3_RKT0_.exit153
  %cmp110 = fcmp oeq double %226, %227
  br i1 %cmp110, label %if.then111, label %if.else115

if.then111:                                       ; preds = %if.else109
  %sub112 = fsub double %mul78, %228
  %div113 = fdiv double %sub112, %226
  %add114 = fadd double %223, %div113
  br label %if.end129

if.else115:                                       ; preds = %if.else109
  %sub117 = fsub double %226, %227
  %sub118 = fsub double %223, %224
  %div119 = fdiv double %sub117, %sub118
  %mul121 = fmul double %div119, 2.000000e+00
  %sub122 = fsub double %mul78, %228
  %mul123 = fmul double %sub122, %mul121
  %229 = tail call double @llvm.fmuladd.f64(double %226, double %226, double %mul123)
  %230 = tail call noundef double @llvm.sqrt.f64(double %229) #10
  %sub125 = fsub double %230, %226
  %div126 = fdiv double %sub125, %div119
  %add127 = fadd double %223, %div126
  br label %if.end129

if.end129:                                        ; preds = %if.else115, %if.then111, %_ZN6openmc17lower_bound_indexIPddEENSt15iterator_traitsIT_E15difference_typeES3_S3_RKT0_.exit153
  %pz.0 = phi double [ %add114, %if.then111 ], [ %add127, %if.else115 ], [ %223, %_ZN6openmc17lower_bound_indexIPddEENSt15iterator_traitsIT_E15difference_typeES3_S3_RKT0_.exit153 ]
  %div130 = fdiv double %pz.0, 0x40612126E7AA960E
  %231 = fcmp oeq double %div130, 1.000000e+00
  %232 = select i1 %231, double 1.000000e+00, double 2.000000e+00
  %233 = tail call double @llvm.fabs.f64(double %div130) #10
  %234 = tail call double @llvm.amdgcn.frexp.mant.f64(double %233)
  %235 = fcmp olt double %234, 0x3FE5555555555555
  %.neg.i.i.i169 = sext i1 %235 to i32
  ...
  %291 = tail call double @llvm.ldexp.f64.i32(double %264, i32 1)
  %292 = tail call double @llvm.ldexp.f64.i32(double %266, i32 1)
  ...
  %352 = fmul double %232, %349
  %353 = fneg double %352
  %354 = tail call double @llvm.fma.f64(double %232, double %349, double %353) #10
  %355 = tail call double @llvm.fma.f64(double %232, double %351, double %354) #10
  %356 = fadd double %352, %355
  %357 = fsub double %356, %352
  %358 = fsub double %355, %357
  %359 = tail call double @llvm.fabs.f64(double %352) #10
  ...
  %382 = tail call double @llvm.ldexp.f64.i32(double %380, i32 %381)
  ...
  %387 = tail call double @llvm.fma.f64(double %386, double %364, double %386) #10
  %388 = tail call double @llvm.fabs.f64(double %386) #10
  %389 = fcmp oeq double %388, 0x7FF0000000000000
  %390 = select i1 %389, double %386, double %387
  %391 = tail call double @llvm.trunc.f64(double %232) #10
  %392 = fcmp oeq double %391, %232
  %393 = fmul double %232, 5.000000e-01
  %394 = tail call double @llvm.trunc.f64(double %393) #10
  %395 = fcmp une double %394, %393
  %396 = and i1 %392, %395
  %397 = select i1 %396, double %div130, double 1.000000e+00
  %398 = tail call double @llvm.copysign.f64(double %390, double %397) #10
  %399 = fcmp olt double %div130, 0.000000e+00
  %400 = select i1 %392, double %398, double 0x7FF8000000000000
  %401 = select i1 %399, double %400, double %398
  %402 = fcmp oeq double %233, 0x7FF0000000000000
  %403 = fcmp oeq double %div130, 0.000000e+00
  %404 = or i1 %403, %402
  %405 = select i1 %403, double 0.000000e+00, double 0x7FF0000000000000
  %406 = select i1 %396, double %div130, double 0.000000e+00
  %407 = tail call double @llvm.copysign.f64(double %405, double %406) #10
  %408 = select i1 %404, double %407, double %401
  %409 = fcmp uno double %div130, 0.000000e+00
  %410 = select i1 %409, double 0x7FF8000000000000, double %408
  %411 = tail call double @llvm.fmuladd.f64(double %neg135, double %2, double %410)
  %neg138 = fneg double %410
  %412 = tail call double @llvm.fmuladd.f64(double %neg138, double %mu, double %2)
  %mul139 = fmul double %mul16, %412
  %sub141 = fadd double %410, -1.000000e+00
  %mul144 = fmul double %411, 4.000000e+00
  %413 = fneg double %sub141
  %414 = fmul double %mul140, %413
  %neg146 = fmul double %mul144, %414
  %415 = tail call double @llvm.fmuladd.f64(double %mul139, double %mul139, double %neg146)
  %cmp147 = fcmp olt double %415, 0.000000e+00
  br i1 %cmp147, label %while.end.sink.split, label %if.end153

if.end153:                                        ; preds = %if.end129
  %416 = tail call noundef double @llvm.sqrt.f64(double %415) #10
  %add155 = fadd double %mul139, %416
  %fneg = fneg double %add155
  %mul156 = fmul double %411, 2.000000e+00
  %div157 = fdiv double %fneg, %mul156
  %sub158 = fsub double %mul139, %416
  %fneg159 = fneg double %sub158
  %div161 = fdiv double %fneg159, %mul156
  %cmp162 = fcmp ogt double %div157, 0.000000e+00
  %cmp164 = fcmp ogt double %div161, 0.000000e+00
  br i1 %cmp162, label %if.then163, label %if.else170

if.then163:                                       ; preds = %if.end153
  br i1 %cmp164, label %if.then165, label %if.end175

if.then165:                                       ; preds = %if.then163
  %call166 = tail call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #11
  %cmp167 = fcmp olt double %call166, 5.000000e-01
  %cond = select i1 %cmp167, double %div157, double %div161
  br label %if.end175

if.else170:                                       ; preds = %if.end153
  br i1 %cmp164, label %if.end175, label %while.cond.backedge

if.end175:                                        ; preds = %if.else170, %if.then165, %if.then163
  %cond.sink = phi double [ %cond, %if.then165 ], [ %div157, %if.then163 ], [ %div161, %if.else170 ]
  store double %cond.sink, ptr %E_out, align 8, !tbaa !51
  %cmp177 = fcmp olt double %cond.sink, %sub11
  br i1 %cmp177, label %while.end, label %while.cond.backedge

while.cond.backedge:                              ; preds = %if.end175, %if.else170
  br label %while.cond, !llvm.loop !126

while.end.sink.split:                             ; preds = %if.end129, %if.end10, %for.end
  %div = fdiv double %alpha, %2
  %mul9 = fmul double %div, 0x411F305BC8CE703B
  store double %mul9, ptr %E_out, align 8, !tbaa !51
  br label %while.end

while.end:                                        ; preds = %while.end.sink.split, %if.end175
  store i32 %shell.0.lcssa, ptr %i_shell, align 4, !tbaa !122
  ret void
}
...
define hidden noundef double @_ZNK6openmc17PhotonInteraction11profile_cdfEll(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(1936) %this, i64 noundef %i, i64 noundef %j) local_unnamed_addr #6 align 2 {
entry:
  %device_profile_cdf_ = getelementptr inbounds nuw i8, ptr %this, i64 1512
  %0 = load ptr, ptr %device_profile_cdf_, align 8, !tbaa !118
  %n_profile_ = getelementptr inbounds nuw i8, ptr %this, i64 1496
  %1 = load i64, ptr %n_profile_, align 8, !tbaa !117
  %mul = mul i64 %1, %i
  %add.ptr = getelementptr inbounds nuw double, ptr %0, i64 %mul
  %add.ptr2 = getelementptr inbounds double, ptr %add.ptr, i64 %j
  %2 = load double, ptr %add.ptr2, align 8, !tbaa !51
  ret double %2
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(read, inaccessiblemem: none)
define hidden noundef double @_ZNK6openmc17PhotonInteraction11profile_pdfEll(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(1936) %this, i64 noundef %i, i64 noundef %j) local_unnamed_addr #6 align 2 {
entry:
  %device_profile_pdf_ = getelementptr inbounds nuw i8, ptr %this, i64 1504
  %0 = load ptr, ptr %device_profile_pdf_, align 8, !tbaa !120
  %n_profile_ = getelementptr inbounds nuw i8, ptr %this, i64 1496
  %1 = load i64, ptr %n_profile_, align 8, !tbaa !117
  %mul = mul i64 %1, %i
  %add.ptr = getelementptr inbounds nuw double, ptr %0, i64 %mul
...
define hidden void @_ZNK6openmc17PhotonInteraction12calculate_xsERNS_8ParticleE(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(1936) %this, ptr noundef nonnull align 8 captures(none) dereferenceable(2728) %p) local_unnamed_addr #8 align 2 {
entry:
  %0 = getelementptr inbounds nuw i8, ptr %this, i64 104
  %energy_.val = load ptr, ptr %0, align 8, !tbaa !112
  %1 = getelementptr inbounds nuw i8, ptr %this, i64 112
  %energy_.val51 = load ptr, ptr %1, align 8, !tbaa !113
  ...
  %2 = load double, ptr %E_, align 8, !tbaa !127
  ...
  %87 = load ptr, ptr %device_energy_, align 8, !tbaa !143
...
if.else:                                          ; preds = %entry
  ...
  %90 = load double, ptr %arrayidx4, align 8, !tbaa !51
...
while.body.i.i.i:                                 ; preds = %while.body.i.i.i, %if.else8
  ...
  %91 = tail call i1 @llvm.is.constant.i64(i64 range(i64 0, 4611686018427387904) %shr.i.i.i) #10
  %cmp.i.i.i.i.i = icmp eq i64 %shr.i.i.i, 1
  ...
  %.val.i.i.i = load double, ptr %add.ptr.sink.i.i.i.i.i, align 8, !tbaa !51
  ...
  %cmp.i.i.i = icmp sgt i64 %__len.1.i.i.i, 0
  br i1 %cmp.i.i.i, label %while.body.i.i.i, label %_ZSt11upper_boundIPddET_S1_S1_RKT0_.internalized.exit.loopexit.i, !llvm.loop !144
...
if.end15:                                         ; preds = %_ZN6openmc17upper_bound_indexIPddEENSt15iterator_traitsIT_E15difference_typeES3_S3_RKT0_.internalized.exit, %if.then6, %entry
  ...
  store double %124, ptr %coherent, align 8, !tbaa !150
  %device_incoherent_ = getelementptr inbounds nuw i8, ptr %this, i64 640
  %125 = load ptr, ptr %device_incoherent_, align 8, !tbaa !151
  %arrayidx50 = getelementptr inbounds double, ptr %125, i64 %idxprom26
  %126 = load double, ptr %arrayidx50, align 8, !tbaa !51
  %arrayidx54 = getelementptr inbounds double, ptr %125, i64 %idxprom31
  %127 = load double, ptr %arrayidx54, align 8, !tbaa !51
  %sub58 = fsub double %127, %126
  %128 = tail call double @llvm.fmuladd.f64(double %div, double %sub58, double %126) #10
  ...
  store double %150, ptr %incoherent, align 8, !tbaa !152
  %photoelectric = getelementptr inbounds nuw i8, ptr %arrayidx37, i64 48
  store double 0.000000e+00, ptr %photoelectric, align 8, !tbaa !153
  %151 = getelementptr inbounds nuw i8, ptr %this, i64 1144
  %shells_.val = load i64, ptr %151, align 8, !tbaa !26
...
for.body.lr.ph:                                   ; preds = %if.end15
  ...
  %shells_.val54 = load ptr, ptr %shells_, align 8, !tbaa !33
  br label %for.body
...
for.cond.cleanup:                                 ; preds = %cleanup, %if.end15
  ...
  %153 = load ptr, ptr %device_pair_production_total_, align 8, !tbaa !154
  %arrayidx89 = getelementptr inbounds double, ptr %153, i64 %idxprom26
  %154 = load double, ptr %arrayidx89, align 8, !tbaa !51
  %arrayidx93 = getelementptr inbounds double, ptr %153, i64 %idxprom31
  %155 = load double, ptr %arrayidx93, align 8, !tbaa !51
  %sub97 = fsub double %155, %154
  %156 = tail call double @llvm.fmuladd.f64(double %div, double %sub97, double %154) #10
  ...
  store double %178, ptr %pair_production, align 8, !tbaa !155
  ...
  store double %add105, ptr %total, align 8, !tbaa !156
  %last_E = getelementptr inbounds nuw i8, ptr %arrayidx37, i64 8
  store double %2, ptr %last_E, align 8, !tbaa !157
  ret void
...
for.body:                                         ; preds = %cleanup, %for.body.lr.ph
  ...
  %180 = load i32, ptr %threshold, align 4, !tbaa !158
...
if.end68:                                         ; preds = %for.body
  ...
  %181 = load double, ptr %arrayidx.i61, align 8, !tbaa !51
  ...
  %182 = load double, ptr %arrayidx.i62, align 8, !tbaa !51
  %sub81 = fsub double %182, %181
  %183 = tail call double @llvm.fmuladd.f64(double %div, double %sub81, double %181) #10
  ...
  store double %add84, ptr %photoelectric, align 8, !tbaa !153
  br label %cleanup
...
cleanup:                                          ; preds = %if.end68, %for.body
  ...
  br i1 %cmp62, label %for.body, label %for.cond.cleanup, !llvm.loop !160
}
...
entry:
  ...
  %2 = call double @llvm.fabs.f64(double %mul) #10
  ...
  %122 = fneg double %121
  %123 = call double @llvm.fma.f64(double %1, double %118, double %122) #10
  %124 = call double @llvm.fma.f64(double %1, double %120, double %123) #10
  %125 = fadd double %121, %124
  %126 = fsub double %125, %121
  %127 = fsub double %124, %126
  %128 = call double @llvm.fabs.f64(double %121) #10
  %129 = fcmp oeq double %128, 0x7FF0000000000000
  %130 = select i1 %129, double %121, double %125
  %131 = call double @llvm.fabs.f64(double %130) #10
  ...
  %156 = call double @llvm.fma.f64(double %155, double %133, double %155) #10
  %157 = call double @llvm.fabs.f64(double %155) #10
  %158 = fcmp oeq double %157, 0x7FF0000000000000
  %159 = select i1 %158, double %155, double %156
  %160 = call double @llvm.trunc.f64(double %1) #10
  %161 = fcmp oeq double %160, %1
  %162 = fmul double %1, 5.000000e-01
  %163 = call double @llvm.trunc.f64(double %162) #10
  %164 = fcmp une double %163, %162
  %165 = and i1 %161, %164
  %166 = select i1 %165, double %mul, double 1.000000e+00
  %167 = call double @llvm.copysign.f64(double %159, double %166) #10
  ...
  %176 = call double @llvm.copysign.f64(double %174, double %175) #10
...
while.cond:                                       ; preds = %_ZN6openmc17lower_bound_indexIPKddEENSt15iterator_traitsIT_E15difference_typeES4_S4_RKT0_.internalized.exit, %entry
  call void @llvm.lifetime.start.p5(i64 24, ptr addrspace(5) %form_factor) #9
  %this.val = load ptr, ptr %180, align 8, !tbaa !53
  call void @llvm.lifetime.start.p5(i64 24, ptr addrspace(5) %retval.i)
  %183 = load i64, ptr %this.val, align 8, !tbaa !111
  ...
  %call3 = call noundef double @_ZNK6openmc15Tabulated1DFlatclEd(ptr noundef nonnull align 8 dereferenceable(24) %form_factor.ascast, double noundef %179) #11
  %call4 = call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #11
  %mul5 = fmul double %call3, %call4
  %call6 = call %"class.gsl::span" @_ZNK6openmc15Tabulated1DFlat1xEv(ptr noundef nonnull align 8 dereferenceable(24) %form_factor.ascast) #11
  %184 = extractvalue %"class.gsl::span" %call6, 0
  %call8 = call %"class.gsl::span" @_ZNK6openmc15Tabulated1DFlat1yEv(ptr noundef nonnull align 8 dereferenceable(24) %form_factor.ascast) #11
...
while.body.i.i.i:                                 ; preds = %while.body.i.i.i, %if.end.i
  ...
  %shr.i.i.i = lshr i64 %__len.04.i.i.i, 1
  %188 = call i1 @llvm.is.constant.i64(i64 range(i64 0, 576460752303423488) %shr.i.i.i) #10
  %cmp.i.i.i.i.i = icmp eq i64 %shr.i.i.i, 1
  ...
  %cmp.i.i.i = icmp sgt i64 %__len.1.i.i.i, 0
  br i1 %cmp.i.i.i, label %while.body.i.i.i, label %_ZSt11lower_boundIPKddET_S2_S2_RKT0_.internalized.exit.loopexit.i, !llvm.loop !161
...
_ZN6openmc17lower_bound_indexIPKddEENSt15iterator_traitsIT_E15difference_typeES4_S4_RKT0_.internalized.exit: ; preds = %_ZSt11lower_boundIPKddET_S2_S2_RKT0_.internalized.exit.i, %while.cond
  ...
  %191 = load double, ptr %arrayidx.i, align 8, !tbaa !51
  ...
  %call31 = call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #11
  ...
  call void @llvm.lifetime.end.p5(i64 24, ptr addrspace(5) %form_factor) #9
...
; Function Attrs: convergent mustprogress nounwind
define hidden %"class.openmc::Tabulated1DFlat" @_ZNK6openmc17PhotonInteraction24coherent_int_form_factorEv(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(1936) %this) local_unnamed_addr #4 align 2 {
entry:
  %retval = alloca %"class.openmc::Tabulated1DFlat", align 8, addrspace(5)
  %retval.ascast = addrspacecast ptr addrspace(5) %retval to ptr
  %buffer_ = getelementptr inbounds nuw i8, ptr %this, i64 1904
...
; Function Attrs: convergent
declare %"class.gsl::span" @_ZNK6openmc15Tabulated1DFlat1xEv(ptr noundef nonnull align 8 dereferenceable(24)) local_unnamed_addr #5

; Function Attrs: convergent
declare %"class.gsl::span" @_ZNK6openmc15Tabulated1DFlat1yEv(ptr noundef nonnull align 8 dereferenceable(24)) local_unnamed_addr #5
...
entry:
  ...
  %0 = load i32, ptr %Z_, align 8, !tbaa !162
  %conv = sitofp i32 %0 to double
  %div = fdiv double %conv, 0x40612126E7AA960E
  %mul = fmul double %div, %div
  %1 = tail call double @llvm.fmuladd.f64(double %div, double %div, double 1.000000e+00) #10
  %div3 = fdiv double 1.000000e+00, %1
  %add = fadd double %div3, 2.020590e-01
  %2 = tail call double @llvm.fmuladd.f64(double %mul, double 3.000000e-05, double -1.200000e-04) #10
  %3 = tail call double @llvm.fmuladd.f64(double %mul, double %2, double 4.900000e-04) #10
  %4 = tail call double @llvm.fmuladd.f64(double %mul, double %3, double -2.010000e-03) #10
  %5 = tail call double @llvm.fmuladd.f64(double %mul, double %4, double 8.350000e-03) #10
  %6 = tail call double @llvm.fmuladd.f64(double %mul, double %5, double -3.693000e-02) #10
  %7 = tail call double @llvm.fmuladd.f64(double %mul, double %6, double %add) #10
  %mul16 = fmul double %mul, %7
  %div17 = fdiv double 2.000000e+00, %alpha
  %8 = tail call noundef double @llvm.sqrt.f64(double %div17) #10
  %9 = tail call double @llvm.fmuladd.f64(double %div, double -1.210000e+01, double -1.774000e-01) #10
  %mul19 = fmul double %div, 1.118000e+01
  %10 = tail call double @llvm.fmuladd.f64(double %mul19, double %div, double %9) #10
  %mul22 = fmul double %8, %8
  %11 = tail call double @llvm.fmuladd.f64(double %div, double 7.326000e+01, double 0x40210BC6A7EF9DB2) #10
  ...
  %13 = tail call double @llvm.fmuladd.f64(double %8, double %10, double %mul26) #10
  %mul28 = fmul double %8, %mul22
  %14 = tail call double @llvm.fmuladd.f64(double %div, double -1.211000e+02, double -1.352000e+01) #10
  %mul30 = fmul double %div, 0x40581A3D70A3D70A
  %15 = tail call double @llvm.fmuladd.f64(double %mul30, double %div, double %14) #10
  %16 = tail call double @llvm.fmuladd.f64(double %mul28, double %15, double %13) #10
  %mul35 = fmul double %8, %mul28
  %17 = tail call double @llvm.fmuladd.f64(double %div, double 6.205000e+01, double 8.946000e+00) #10
  %neg39 = fmul double %div, -6.341000e+01
  %18 = tail call double @llvm.fmuladd.f64(double %neg39, double %div, double %17) #10
  ...
  %20 = load double, ptr addrspace(4) %arrayidx, align 8, !tbaa !51
  ...
  %104 = tail call double @llvm.fabs.f64(double %div47) #10
  ...
  %130 = fneg double %129
  %131 = tail call double @llvm.fma.f64(double 0x3FEDD9AD336A0500, double 0x3FFAF154EEB562D6, double %130) #10
  %132 = select i1 %105, double %131, double %129
  %133 = tail call noundef double @llvm.copysign.f64(double %132, double %div47) #10
  %mul49 = fmul double %div43, %133
  %mul50 = fmul double %div43, %div43
  %134 = tail call double @llvm.fmuladd.f64(double %mul49, double -4.000000e+00, double 4.000000e+00) #10
  ...
  %300 = tail call double @llvm.fmuladd.f64(double %mul49, double -3.000000e+00, double %sub69) #10
  ...
  %304 = tail call double @llvm.fabs.f64(double %sub74) #10
  ...
  %424 = fneg double %423
  %425 = tail call double @llvm.fma.f64(double %303, double %420, double %424) #10
  %426 = tail call double @llvm.fma.f64(double %303, double %422, double %425) #10
  %427 = fadd double %423, %426
  %428 = fsub double %427, %423
  %429 = fsub double %426, %428
  %430 = tail call double @llvm.fabs.f64(double %423) #10
  %431 = fcmp oeq double %430, 0x7FF0000000000000
  %432 = select i1 %431, double %423, double %427
  %433 = tail call double @llvm.fabs.f64(double %432) #10
  ...
  %458 = tail call double @llvm.fma.f64(double %457, double %435, double %457) #10
  %459 = tail call double @llvm.fabs.f64(double %457) #10
  %460 = fcmp oeq double %459, 0x7FF0000000000000
  %461 = select i1 %460, double %457, double %458
  %462 = tail call double @llvm.trunc.f64(double %303) #10
  %463 = fcmp oeq double %462, %303
  %464 = fmul double %303, 5.000000e-01
  %465 = tail call double @llvm.trunc.f64(double %464) #10
  %466 = fcmp une double %465, %464
  %467 = and i1 %463, %466
  %468 = select i1 %467, double %sub74, double 1.000000e+00
  %469 = tail call double @llvm.copysign.f64(double %461, double %468) #10
  ...
  %478 = tail call double @llvm.copysign.f64(double %476, double %477) #10
...
while.cond:                                       ; preds = %if.end145, %entry
  %call78 = tail call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #11
  %call79 = tail call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #11
...
cond.true:                                        ; preds = %if.then
  ...
  %485 = tail call double @llvm.fabs.f64(double %482) #10
  ...
  %605 = fneg double %604
  %606 = tail call double @llvm.fma.f64(double %484, double %601, double %605) #10
  %607 = tail call double @llvm.fma.f64(double %484, double %603, double %606) #10
  %608 = fadd double %604, %607
  %609 = fsub double %608, %604
  %610 = fsub double %607, %609
  %611 = tail call double @llvm.fabs.f64(double %604) #10
  %612 = fcmp oeq double %611, 0x7FF0000000000000
  %613 = select i1 %612, double %604, double %608
  %614 = tail call double @llvm.fabs.f64(double %613) #10
  ...
  %639 = tail call double @llvm.fma.f64(double %638, double %616, double %638) #10
  %640 = tail call double @llvm.fabs.f64(double %638) #10
  %641 = fcmp oeq double %640, 0x7FF0000000000000
  %642 = select i1 %641, double %638, double %639
  %643 = tail call double @llvm.trunc.f64(double %484) #10
  %644 = fcmp oeq double %643, %484
  %645 = fmul double %484, 5.000000e-01
  %646 = tail call double @llvm.trunc.f64(double %645) #10
  %647 = fcmp une double %646, %645
  %648 = and i1 %644, %647
  %649 = select i1 %648, double %482, double 1.000000e+00
  %650 = tail call double @llvm.copysign.f64(double %642, double %649) #10
  ...
  %659 = tail call double @llvm.copysign.f64(double %657, double %658) #10
...
cond.false:                                       ; preds = %if.then
  ...
  %667 = tail call double @llvm.fabs.f64(double %664) #10
  ...
  %787 = fneg double %786
  %788 = tail call double @llvm.fma.f64(double %666, double %783, double %787) #10
  %789 = tail call double @llvm.fma.f64(double %666, double %785, double %788) #10
  %790 = fadd double %786, %789
  %791 = fsub double %790, %786
  %792 = fsub double %789, %791
  %793 = tail call double @llvm.fabs.f64(double %786) #10
  %794 = fcmp oeq double %793, 0x7FF0000000000000
  %795 = select i1 %794, double %786, double %790
  %796 = tail call double @llvm.fabs.f64(double %795) #10
  ...
  %821 = tail call double @llvm.fma.f64(double %820, double %798, double %820) #10
  %822 = tail call double @llvm.fabs.f64(double %820) #10
  %823 = fcmp oeq double %822, 0x7FF0000000000000
  %824 = select i1 %823, double %820, double %821
  %825 = tail call double @llvm.trunc.f64(double %666) #10
  %826 = fcmp oeq double %825, %666
  %827 = fmul double %666, 5.000000e-01
  %828 = tail call double @llvm.trunc.f64(double %827) #10
  %829 = fcmp une double %828, %827
  %830 = and i1 %826, %829
  %831 = select i1 %830, double %664, double 1.000000e+00
  %832 = tail call double @llvm.copysign.f64(double %824, double %831) #10
  ...
  %841 = tail call double @llvm.copysign.f64(double %839, double %840) #10
...
if.end:                                           ; preds = %if.else, %cond.false, %cond.true
  ...
  %847 = load i32, ptr %Z_, align 8, !tbaa !162
  ...
  %848 = load double, ptr addrspace(4) %arrayidx101, align 8, !tbaa !51
  ...
  %932 = tail call double @llvm.fabs.f64(double %div110) #10
  ...
  %958 = fneg double %957
  %959 = tail call double @llvm.fma.f64(double 0x3FEDD9AD336A0500, double 0x3FFAF154EEB562D6, double %958) #10
  %960 = select i1 %933, double %959, double %957
  %961 = tail call noundef double @llvm.copysign.f64(double %960, double %div110) #10
...
if.then122:                                       ; preds = %if.end
  ...
  %call127 = tail call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #11
...
if.else132:                                       ; preds = %if.end
  ...
  %call137 = tail call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #11
...
while.end:                                        ; preds = %if.else132, %if.then122
  ...
  store double %mul151, ptr %E_electron, align 8, !tbaa !51
  ...
  store double %mul154, ptr %E_positron, align 8, !tbaa !51
  %1051 = load double, ptr %E_electron, align 8, !tbaa !51
  %add155 = fadd double %1051, 0x412F305BC8CE703B
  %mul156 = fmul double %1051, %add155
  %1052 = tail call noundef double @llvm.sqrt.f64(double %mul156) #10
  %add158 = fadd double %1051, 0x411F305BC8CE703B
  %div159 = fdiv double %1052, %add158
  %call161 = tail call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #11
  ...
  store double %div165, ptr %mu_electron, align 8, !tbaa !51
  %1055 = load double, ptr %E_positron, align 8, !tbaa !51
  %add166 = fadd double %1055, 0x412F305BC8CE703B
  %mul167 = fmul double %1055, %add166
  %1056 = tail call noundef double @llvm.sqrt.f64(double %mul167) #10
  %add169 = fadd double %1055, 0x411F305BC8CE703B
  %div170 = fdiv double %1056, %add169
  %call171 = tail call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #11
  ...
  store double %div175, ptr %mu_positron, align 8, !tbaa !51
  ret void
}
...
while.body:                                       ; preds = %cleanup, %entry
  ...
  %shells_.val = load ptr, ptr %shells_, align 8, !tbaa !33
...
__ocml_sin_f64.exit:                              ; preds = %167, %148
  ...
  %287 = load double, ptr %binding_energy, align 8, !tbaa !164
  %288 = load double, ptr %wgt_66, align 8, !tbaa !165
  tail call void @_ZN6openmc8Particle16create_secondaryEdNS_8PositionEdNS0_4TypeE(ptr noundef nonnull align 8 dereferenceable(2728) %p, double noundef %288, double %4, double %mul13, double %mul18, double noundef %287, i32 noundef 1) #11
  br label %cleanup

if.end:                                           ; preds = %while.body
  %call20 = tail call noundef double @_ZN6openmc3prnEPm(ptr noundef nonnull %add.ptr.i) #11
  %transitions.val41 = load ptr, ptr %transitions, align 8, !tbaa !41
  %transitions.val42 = load ptr, ptr %2, align 8, !tbaa !44
...
for.cond:                                         ; preds = %for.body
  ...
  br i1 %cmp24, label %for.body, label %for.end, !llvm.loop !166
...
for.body:                                         ; preds = %for.cond, %for.body.preheader
  ...
  %289 = load double, ptr %probability, align 8, !tbaa !167
...
for.end:                                          ; preds = %for.body, %for.cond, %if.end
  ...
  %294 = tail call noundef double @llvm.sqrt.f64(double %293) #10
  %295 = tail call double @llvm.fabs.f64(double %mul42) #10
...
__ocml_sin_f64.exit82:                            ; preds = %454, %435
  ...
  %574 = load i32, ptr %arrayidx.i62, align 8, !tbaa !169
  ...
  %576 = load i32, ptr %secondary_subshell, align 4, !tbaa !170
...
if.then61:                                        ; preds = %__ocml_sin_f64.exit82
  ...
  %578 = load double, ptr %wgt_66, align 8, !tbaa !165
  %energy = getelementptr inbounds nuw i8, ptr %arrayidx.i62, i64 8
  %579 = load double, ptr %energy, align 8, !tbaa !171
  tail call void @_ZN6openmc8Particle16create_secondaryEdNS_8PositionEdNS0_4TypeE(ptr noundef nonnull align 8 dereferenceable(2728) %p, double noundef %578, double %291, double %mul49, double %mul55, double noundef %579, i32 noundef 2) #11
  br label %cleanup

if.else:                                          ; preds = %__ocml_sin_f64.exit82
  %580 = load double, ptr %wgt_66, align 8, !tbaa !165
  %energy70 = getelementptr inbounds nuw i8, ptr %arrayidx.i62, i64 8
  %581 = load double, ptr %energy70, align 8, !tbaa !171
  tail call void @_ZN6openmc8Particle16create_secondaryEdNS_8PositionEdNS0_4TypeE(ptr noundef nonnull align 8 dereferenceable(2728) %p, double noundef %580, double %291, double %mul49, double %mul55, double noundef %581, i32 noundef 1) #11
  br label %cleanup
...
; Function Attrs: convergent
declare void @_ZN6openmc8Particle16create_secondaryEdNS_8PositionEdNS0_4TypeE(ptr noundef nonnull align 8 dereferenceable(2728), double noundef, double, double, double, double noundef, i32 noundef) local_unnamed_addr #5
...
!26 = !{!27, !32, i64 8}
!27 = !{!"_ZTSN6openmc6vectorINS_16ElectronSubshellEEE", !28, i64 0, !32, i64 8, !32, i64 16}
!28 = !{!"p1 _ZTSN6openmc16ElectronSubshellE", !29, i64 0}
...
!33 = !{!27, !28, i64 0}
!34 = !{!35, !36, i64 0}
!35 = !{!"_ZTSN3gsl4spanIKdEE", !36, i64 0, !36, i64 8}
!36 = !{!"p1 double", !29, i64 0}
!37 = !{!35, !36, i64 8}
!38 = !{!39, !36, i64 0}
!39 = !{!"_ZTSN6openmc6vectorIdEE", !36, i64 0, !32, i64 8, !32, i64 16}
!40 = !{!36, !36, i64 0}
!41 = !{!42, !43, i64 0}
!42 = !{!"_ZTSN3gsl4spanIKN6openmc16ElectronSubshell10TransitionEEE", !43, i64 0, !43, i64 8}
!43 = !{!"p1 _ZTSN6openmc16ElectronSubshell10TransitionE", !29, i64 0}
!44 = !{!42, !43, i64 8}
!45 = !{!46, !43, i64 0}
!46 = !{!"_ZTSN6openmc6vectorINS_16ElectronSubshell10TransitionEEE", !43, i64 0, !32, i64 8, !32, i64 16}
!47 = !{!43, !43, i64 0}
!48 = distinct !{!48, !49}
...
!52 = !{!"double", !30, i64 0}
!53 = !{!54, !57, i64 1904}
!54 = !{!"_ZTSN6openmc17PhotonInteractionE", !55, i64 0, !58, i64 32, !32, i64 40, !59, i64 48, !59, i64 120, !59, i64 192, !59, i64 264, !59, i64 336, !59, i64 408, !59, i64 480, !59, i64 552, !36, i64 624, !36, i64 632, !36, i64 640, !36, i64 648, !74, i64 656, !74, i64 776, !74, i64 896, !74, i64 1016, !27, i64 1136, !89, i64 1160, !89, i64 1256, !59, i64 1352, !59, i64 1424, !32, i64 1496, !36, i64 1504, !36, i64 1512, !36, i64 1520, !36, i64 1528, !52, i64 1536, !99, i64 1544, !59, i64 1616, !59, i64 1688, !89, i64 1760, !39, i64 1856, !46, i64 1880, !109, i64 1904}
!55 = !{!"_ZTSNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE", !56, i64 0, !32, i64 8, !30, i64 16}
!56 = !{!"_ZTSNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE12_Alloc_hiderE", !57, i64 0}
!57 = !{!"p1 omnipotent char", !29, i64 0}
!58 = !{!"int", !30, i64 0}
!59 = !{!"_ZTSN2xt17xtensor_containerINS_7uvectorIdSaIdEEELm1ELNS_11layout_typeE1ENS_22xtensor_expression_tagEEE", !60, i64 0, !64, i64 32, !72, i64 48}
!60 = !{!"_ZTSN2xt18xstrided_containerINS_17xtensor_containerINS_7uvectorIdSaIdEEELm1ELNS_11layout_typeE1ENS_22xtensor_expression_tagEEEEE", !61, i64 0, !62, i64 8, !62, i64 16, !63, i64 24}
!61 = !{!"_ZTSSt5arrayImLm1EE", !30, i64 0}
!62 = !{!"_ZTSSt5arrayIlLm1EE", !30, i64 0}
!63 = !{!"_ZTSN2xt11layout_typeE", !30, i64 0}
!64 = !{!"_ZTSN2xt19xcontainer_semanticINS_17xtensor_containerINS_7uvectorIdSaIdEEELm1ELNS_11layout_typeE1ENS_22xtensor_expression_tagEEEEE", !65, i64 0}
!65 = !{!"_ZTSN2xt14xsemantic_baseINS_17xtensor_containerINS_7uvectorIdSaIdEEELm1ELNS_11layout_typeE1ENS_22xtensor_expression_tagEEEEE", !66, i64 0}
!66 = !{!"_ZTSN2xt20xsharable_expressionINS_17xtensor_containerINS_7uvectorIdSaIdEEELm1ELNS_11layout_typeE1ENS_22xtensor_expression_tagEEEEE", !67, i64 0}
!67 = !{!"_ZTSSt10shared_ptrIN2xt17xtensor_containerINS0_7uvectorIdSaIdEEELm1ELNS0_11layout_typeE1ENS0_22xtensor_expression_tagEEEE", !68, i64 0}
!68 = !{!"_ZTSSt12__shared_ptrIN2xt17xtensor_containerINS0_7uvectorIdSaIdEEELm1ELNS0_11layout_typeE1ENS0_22xtensor_expression_tagEEELN9__gnu_cxx12_Lock_policyE2EE", !69, i64 0, !70, i64 8}
!69 = !{!"p1 _ZTSN2xt17xtensor_containerINS_7uvectorIdSaIdEEELm1ELNS_11layout_typeE1ENS_22xtensor_expression_tagEEE", !29, i64 0}
!70 = !{!"_ZTSSt14__shared_countILN9__gnu_cxx12_Lock_policyE2EE", !71, i64 0}
!71 = !{!"p1 _ZTSSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE", !29, i64 0}
!72 = !{!"_ZTSN2xt7uvectorIdSaIdEEE", !73, i64 0, !36, i64 8, !36, i64 16}
!73 = !{!"_ZTSSaIdE"}
!74 = !{!"_ZTSN6openmc11Tabulated1DE", !75, i64 0, !32, i64 8, !76, i64 16, !81, i64 40, !32, i64 64, !85, i64 72, !85, i64 96}
!75 = !{!"_ZTSN6openmc10Function1DE"}
...
!80 = !{!"p1 int", !29, i64 0}
!81 = !{!"_ZTSSt6vectorIN6openmc13InterpolationESaIS1_EE", !82, i64 0}
!82 = !{!"_ZTSSt12_Vector_baseIN6openmc13InterpolationESaIS1_EE", !83, i64 0}
!83 = !{!"_ZTSNSt12_Vector_baseIN6openmc13InterpolationESaIS1_EE12_Vector_implE", !84, i64 0}
!84 = !{!"_ZTSNSt12_Vector_baseIN6openmc13InterpolationESaIS1_EE17_Vector_impl_dataE", !29, i64 0, !29, i64 8, !29, i64 16}
...
!88 = !{!"_ZTSNSt12_Vector_baseIdSaIdEE17_Vector_impl_dataE", !36, i64 0, !36, i64 8, !36, i64 16}
!89 = !{!"_ZTSN2xt17xtensor_containerINS_7uvectorIdSaIdEEELm2ELNS_11layout_typeE1ENS_22xtensor_expression_tagEEE", !90, i64 0, !93, i64 56, !72, i64 72}
!90 = !{!"_ZTSN2xt18xstrided_containerINS_17xtensor_containerINS_7uvectorIdSaIdEEELm2ELNS_11layout_typeE1ENS_22xtensor_expression_tagEEEEE", !91, i64 0, !92, i64 16, !92, i64 32, !63, i64 48}
!91 = !{!"_ZTSSt5arrayImLm2EE", !30, i64 0}
!92 = !{!"_ZTSSt5arrayIlLm2EE", !30, i64 0}
...
!97 = !{!"_ZTSSt12__shared_ptrIN2xt17xtensor_containerINS0_7uvectorIdSaIdEEELm2ELNS0_11layout_typeE1ENS0_22xtensor_expression_tagEEELN9__gnu_cxx12_Lock_policyE2EE", !98, i64 0, !70, i64 8}
!98 = !{!"p1 _ZTSN2xt17xtensor_containerINS_7uvectorIdSaIdEEELm2ELNS_11layout_typeE1ENS_22xtensor_expression_tagEEE", !29, i64 0}
!99 = !{!"_ZTSN2xt17xtensor_containerINS_7uvectorIiSaIiEEELm1ELNS_11layout_typeE1ENS_22xtensor_expression_tagEEE", !100, i64 0, !101, i64 32, !107, i64 48}
!100 = !{!"_ZTSN2xt18xstrided_containerINS_17xtensor_containerINS_7uvectorIiSaIiEEELm1ELNS_11layout_typeE1ENS_22xtensor_expression_tagEEEEE", !61, i64 0, !62, i64 8, !62, i64 16, !63, i64 24}
!101 = !{!"_ZTSN2xt19xcontainer_semanticINS_17xtensor_containerINS_7uvectorIiSaIiEEELm1ELNS_11layout_typeE1ENS_22xtensor_expression_tagEEEEE", !102, i64 0}
!102 = !{!"_ZTSN2xt14xsemantic_baseINS_17xtensor_containerINS_7uvectorIiSaIiEEELm1ELNS_11layout_typeE1ENS_22xtensor_expression_tagEEEEE", !103, i64 0}
!103 = !{!"_ZTSN2xt20xsharable_expressionINS_17xtensor_containerINS_7uvectorIiSaIiEEELm1ELNS_11layout_typeE1ENS_22xtensor_expression_tagEEEEE", !104, i64 0}
!104 = !{!"_ZTSSt10shared_ptrIN2xt17xtensor_containerINS0_7uvectorIiSaIiEEELm1ELNS0_11layout_typeE1ENS0_22xtensor_expression_tagEEEE", !105, i64 0}
!105 = !{!"_ZTSSt12__shared_ptrIN2xt17xtensor_containerINS0_7uvectorIiSaIiEEELm1ELNS0_11layout_typeE1ENS0_22xtensor_expression_tagEEELN9__gnu_cxx12_Lock_policyE2EE", !106, i64 0, !70, i64 8}
!106 = !{!"p1 _ZTSN2xt17xtensor_containerINS_7uvectorIiSaIiEEELm1ELNS_11layout_typeE1ENS_22xtensor_expression_tagEEE", !29, i64 0}
!107 = !{!"_ZTSN2xt7uvectorIiSaIiEEE", !108, i64 0, !80, i64 8, !80, i64 16}
!108 = !{!"_ZTSSaIiE"}
!109 = !{!"_ZTSN6openmc10DataBufferE", !57, i64 0, !32, i64 8, !32, i64 16, !110, i64 24}
!110 = !{!"_ZTSN6openmc10DataBuffer4ModeE", !30, i64 0}
!111 = !{!32, !32, i64 0}
!112 = !{!72, !36, i64 8}
!113 = !{!72, !36, i64 16}
!114 = !{!54, !36, i64 1528}
...
!126 = distinct !{!126, !49}
!127 = !{!128, !52, i64 1400}
!128 = !{!"_ZTSN6openmc8ParticleE", !129, i64 0, !30, i64 168, !130, i64 744, !32, i64 864, !131, i64 872, !58, i64 876, !58, i64 880, !30, i64 888, !58, i64 1368, !30, i64 1372, !52, i64 1400, !52, i64 1408, !58, i64 1416, !58, i64 1420, !52, i64 1424, !52, i64 1432, !132, i64 1440, !132, i64 1464, !132, i64 1488, !52, i64 1512, !133, i64 1520, !134, i64 1524, !58, i64 1528, !58, i64 1532, !58, i64 1536, !58, i64 1540, !58, i64 1544, !52, i64 1552, !30, i64 1560, !58, i64 1592, !58, i64 1596, !58, i64 1600, !58, i64 1604, !135, i64 1608, !52, i64 1640, !52, i64 1648, !58, i64 1656, !133, i64 1660, !30, i64 1664, !58, i64 1728, !30, i64 1736, !32, i64 2216, !32, i64 2224, !30, i64 2232, !137, i64 2240, !138, i64 2248, !30, i64 2272, !52, i64 2656, !52, i64 2664, !52, i64 2672, !52, i64 2680, !133, i64 2688, !52, i64 2696, !52, i64 2704, !58, i64 2712, !32, i64 2720}
!129 = !{!"_ZTSN6openmc19NuclideMicroXSCacheE", !30, i64 0}
!130 = !{!"_ZTSN6openmc7MacroXSE", !52, i64 0, !52, i64 8, !52, i64 16, !52, i64 24, !52, i64 32, !30, i64 40, !52, i64 88, !52, i64 96, !52, i64 104, !52, i64 112}
!131 = !{!"_ZTSN6openmc8Particle4TypeE", !30, i64 0}
!132 = !{!"_ZTSN6openmc8PositionE", !52, i64 0, !52, i64 8, !52, i64 16}
!133 = !{!"bool", !30, i64 0}
!134 = !{!"_ZTSN6openmc10TallyEventE", !30, i64 0}
!135 = !{!"_ZTSN6openmc12BoundaryInfoE", !52, i64 0, !58, i64 8, !58, i64 12, !136, i64 16}
!136 = !{!"_ZTSSt5arrayIiLm3EE", !30, i64 0}
!137 = !{!"p1 _ZTSN6openmc11FilterMatchE", !29, i64 0}
...
!142 = !{!"p1 _ZTSSt6vectorIN6openmc8PositionESaIS1_EE", !29, i64 0}
!143 = !{!54, !36, i64 624}
!144 = distinct !{!144, !49}
!145 = !{!54, !32, i64 40}
!146 = !{!147, !58, i64 0}
!147 = !{!"_ZTSN6openmc14ElementMicroXSE", !58, i64 0, !52, i64 8, !52, i64 16, !52, i64 24, !52, i64 32, !52, i64 40, !52, i64 48, !52, i64 56}
!148 = !{!147, !52, i64 16}
!149 = !{!54, !36, i64 632}
!150 = !{!147, !52, i64 32}
!151 = !{!54, !36, i64 640}
...
!157 = !{!147, !52, i64 8}
!158 = !{!159, !58, i64 4}
!159 = !{!"_ZTSN6openmc16ElectronSubshellE", !58, i64 0, !58, i64 4, !52, i64 8, !52, i64 16, !35, i64 24, !42, i64 40}
!160 = distinct !{!160, !49}
!161 = distinct !{!161, !49}
!162 = !{!54, !58, i64 32}
!163 = !{!128, !58, i64 1728}
...
!166 = distinct !{!166, !49}
!167 = !{!168, !52, i64 16}
!168 = !{!"_ZTSN6openmc16ElectronSubshell10TransitionE", !58, i64 0, !58, i64 4, !52, i64 8, !52, i64 16}
!169 = !{!168, !58, i64 0}
!170 = !{!168, !58, i64 4}
!171 = !{!168, !52, i64 8}
