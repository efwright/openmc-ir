; ModuleID = 'endf.cpp-amdgcn-amd-amdhsa-gfx942.o.2.internalize.bc'
...
define internal void @_ZN6openmc15Tabulated1DFlatC2EPKh(ptr noundef nonnull writeonly align 8 captures(none) dereferenceable(24) initializes((0, 24)) %this, ptr noundef %data) unnamed_addr #4 align 2 {
entry:
