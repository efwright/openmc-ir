; ModuleID = 'math_functions.cpp-amdgcn-amd-amdhsa-gfx942.o.0.preopt.bc'
...
define hidden %"class.std::complex" @_ZN6openmc5zpf8hESt7complexIdE({ double, double } %z.coerce) local_unnamed_addr #6 {
entry:
  %0 = extractvalue { double, double } %z.coerce, 0
  %1 = extractvalue { double, double } %z.coerce, 1
  %add.r.i = fadd double %0, 0.000000e+00
  %add.i.i = fadd double %1, 9.000000e-01
  %mul_ac.i.i = fmul double %add.r.i, %add.r.i
  %mul_bd.i.i = fmul double %add.i.i, %add.i.i
  %mul_ad.i.i = fmul double %add.r.i, %add.i.i
...
complex_mul_libcall.i.i:                          ; preds = %complex_mul_imag_nan.i.i
  %call5.i.i = tail call noundef { double, double } @__muldc3(double noundef %add.r.i, double noundef %add.i.i, double noundef %add.r.i, double noundef %add.i.i) #9
...
_ZStmlIdESt7complexIT_ERKS2_S4_.exit:             ; preds = %complex_mul_libcall.i.i, %complex_mul_imag_nan.i.i, %entry
  ...
  %mul_ac.i.i100 = fmul double %add.r.i, 0.000000e+00
  %mul_bd.i.i101 = fmul double %add.i.i, 0x3FE20DD725F5D729
  %mul_ad.i.i102 = fmul double %add.i.i, 0.000000e+00
  %mul_bc.i.i103 = fmul double %add.r.i, 0x3FE20DD725F5D729
  %mul_r.i.i104 = fsub double %mul_ac.i.i100, %mul_bd.i.i101
  %mul_i.i.i105 = fadd double %mul_bc.i.i103, %mul_ad.i.i102
  %isnan_cmp.i.i106 = fcmp uno double %mul_r.i.i104, 0.000000e+00
  br i1 %isnan_cmp.i.i106, label %complex_mul_imag_nan.i.i111, label %_ZStmlIdESt7complexIT_ERKS2_S4_.exit115, !prof !19

complex_mul_imag_nan.i.i111:                      ; preds = %_ZStmlIdESt7complexIT_ERKS2_S4_.exit
  %isnan_cmp4.i.i112 = fcmp uno double %mul_i.i.i105, 0.000000e+00
  br i1 %isnan_cmp4.i.i112, label %complex_mul_libcall.i.i113, label %_ZStmlIdESt7complexIT_ERKS2_S4_.exit115, !prof !19

complex_mul_libcall.i.i113:                       ; preds = %complex_mul_imag_nan.i.i111
  %call5.i.i114 = tail call noundef { double, double } @__muldc3(double noundef 0.000000e+00, double noundef 0x3FE20DD725F5D729, double noundef %add.r.i, double noundef %add.i.i) #9
  %4 = extractvalue { double, double } %call5.i.i114, 0
  %5 = extractvalue { double, double } %call5.i.i114, 1
  br label %_ZStmlIdESt7complexIT_ERKS2_S4_.exit115

_ZStmlIdESt7complexIT_ERKS2_S4_.exit115:          ; preds = %complex_mul_libcall.i.i113, %complex_mul_imag_nan.i.i111, %_ZStmlIdESt7complexIT_ERKS2_S4_.exit
  %real_mul_phi.i.i107 = phi double [ %mul_r.i.i104, %_ZStmlIdESt7complexIT_ERKS2_S4_.exit ], [ %mul_r.i.i104, %complex_mul_imag_nan.i.i111 ], [ %4, %complex_mul_libcall.i.i113 ]
  %imag_mul_phi.i.i108 = phi double [ %mul_i.i.i105, %_ZStmlIdESt7complexIT_ERKS2_S4_.exit ], [ %mul_i.i.i105, %complex_mul_imag_nan.i.i111 ], [ %5, %complex_mul_libcall.i.i113 ]
  %add.r.i.i = fadd double %real_mul_phi.i.i107, 0xBFE03FA9947C808F
  %add.i.i.i = fadd double %imag_mul_phi.i.i108, 0.000000e+00
  %mul_ac.i.i131 = fmul double %add.r.i, %add.r.i.i
  %mul_bd.i.i132 = fmul double %add.i.i, %add.i.i.i
  %mul_ad.i.i133 = fmul double %add.i.i, %add.r.i.i
  %mul_bc.i.i134 = fmul double %add.r.i, %add.i.i.i
  %mul_r.i.i135 = fsub double %mul_ac.i.i131, %mul_bd.i.i132
  %mul_i.i.i136 = fadd double %mul_ad.i.i133, %mul_bc.i.i134
  %isnan_cmp.i.i137 = fcmp uno double %mul_r.i.i135, 0.000000e+00
  br i1 %isnan_cmp.i.i137, label %complex_mul_imag_nan.i.i142, label %_ZStmlIdESt7complexIT_ERKS2_S4_.exit146, !prof !19

complex_mul_imag_nan.i.i142:                      ; preds = %_ZStmlIdESt7complexIT_ERKS2_S4_.exit115
  %isnan_cmp4.i.i143 = fcmp uno double %mul_i.i.i136, 0.000000e+00
  br i1 %isnan_cmp4.i.i143, label %complex_mul_libcall.i.i144, label %_ZStmlIdESt7complexIT_ERKS2_S4_.exit146, !prof !19

complex_mul_libcall.i.i144:                       ; preds = %complex_mul_imag_nan.i.i142
  %call5.i.i145 = tail call noundef { double, double } @__muldc3(double noundef %add.r.i.i, double noundef %add.i.i.i, double noundef %add.r.i, double noundef %add.i.i) #9
  %6 = extractvalue { double, double } %call5.i.i145, 0
  %7 = extractvalue { double, double } %call5.i.i145, 1
  br label %_ZStmlIdESt7complexIT_ERKS2_S4_.exit146

_ZStmlIdESt7complexIT_ERKS2_S4_.exit146:          ; preds = %complex_mul_libcall.i.i144, %complex_mul_imag_nan.i.i142, %_ZStmlIdESt7complexIT_ERKS2_S4_.exit115
  %real_mul_phi.i.i138 = phi double [ %mul_r.i.i135, %_ZStmlIdESt7complexIT_ERKS2_S4_.exit115 ], [ %mul_r.i.i135, %complex_mul_imag_nan.i.i142 ], [ %6, %complex_mul_libcall.i.i144 ]
  %imag_mul_phi.i.i139 = phi double [ %mul_i.i.i136, %_ZStmlIdESt7complexIT_ERKS2_S4_.exit115 ], [ %mul_i.i.i136, %complex_mul_imag_nan.i.i142 ], [ %7, %complex_mul_libcall.i.i144 ]
  %add.i.i.i155 = fadd double %imag_mul_phi.i.i139, 0xC02025A7E69A687B
  %mul_ac.i.i164 = fmul double %add.r.i, %real_mul_phi.i.i138
  %mul_bd.i.i165 = fmul double %add.i.i, %add.i.i.i155
  %mul_ad.i.i166 = fmul double %add.i.i, %real_mul_phi.i.i138
  %mul_bc.i.i167 = fmul double %add.r.i, %add.i.i.i155
  %mul_r.i.i168 = fsub double %mul_ac.i.i164, %mul_bd.i.i165
  %mul_i.i.i169 = fadd double %mul_ad.i.i166, %mul_bc.i.i167
  %isnan_cmp.i.i170 = fcmp uno double %mul_r.i.i168, 0.000000e+00
  br i1 %isnan_cmp.i.i170, label %complex_mul_imag_nan.i.i175, label %_ZStmlIdESt7complexIT_ERKS2_S4_.exit179, !prof !19

complex_mul_imag_nan.i.i175:                      ; preds = %_ZStmlIdESt7complexIT_ERKS2_S4_.exit146
  %isnan_cmp4.i.i176 = fcmp uno double %mul_i.i.i169, 0.000000e+00
  br i1 %isnan_cmp4.i.i176, label %complex_mul_libcall.i.i177, label %_ZStmlIdESt7complexIT_ERKS2_S4_.exit179, !prof !19

complex_mul_libcall.i.i177:                       ; preds = %complex_mul_imag_nan.i.i175
  %call5.i.i178 = tail call noundef { double, double } @__muldc3(double noundef %real_mul_phi.i.i138, double noundef %add.i.i.i155, double noundef %add.r.i, double noundef %add.i.i) #9
  %8 = extractvalue { double, double } %call5.i.i178, 0
  %9 = extractvalue { double, double } %call5.i.i178, 1
  br label %_ZStmlIdESt7complexIT_ERKS2_S4_.exit179

_ZStmlIdESt7complexIT_ERKS2_S4_.exit179:          ; preds = %complex_mul_libcall.i.i177, %complex_mul_imag_nan.i.i175, %_ZStmlIdESt7complexIT_ERKS2_S4_.exit146
  %real_mul_phi.i.i171 = phi double [ %mul_r.i.i168, %_ZStmlIdESt7complexIT_ERKS2_S4_.exit146 ], [ %mul_r.i.i168, %complex_mul_imag_nan.i.i175 ], [ %8, %complex_mul_libcall.i.i177 ]
  %imag_mul_phi.i.i172 = phi double [ %mul_i.i.i169, %_ZStmlIdESt7complexIT_ERKS2_S4_.exit146 ], [ %mul_i.i.i169, %complex_mul_imag_nan.i.i175 ], [ %9, %complex_mul_libcall.i.i177 ]
  %add.r.i.i187 = fadd double %real_mul_phi.i.i171, 0x401B08AD71E14CA6
  %add.i.i.i188 = fadd double %imag_mul_phi.i.i172, 0.000000e+00
  %mul_ac.i.i197 = fmul double %add.r.i, %add.r.i.i187
  %mul_bd.i.i198 = fmul double %add.i.i, %add.i.i.i188
  %mul_ad.i.i199 = fmul double %add.i.i, %add.r.i.i187
  %mul_bc.i.i200 = fmul double %add.r.i, %add.i.i.i188
  %mul_r.i.i201 = fsub double %mul_ac.i.i197, %mul_bd.i.i198
  %mul_i.i.i202 = fadd double %mul_ad.i.i199, %mul_bc.i.i200
  %isnan_cmp.i.i203 = fcmp uno double %mul_r.i.i201, 0.000000e+00
  br i1 %isnan_cmp.i.i203, label %complex_mul_imag_nan.i.i208, label %_ZStmlIdESt7complexIT_ERKS2_S4_.exit212, !prof !19

complex_mul_imag_nan.i.i208:                      ; preds = %_ZStmlIdESt7complexIT_ERKS2_S4_.exit179
  %isnan_cmp4.i.i209 = fcmp uno double %mul_i.i.i202, 0.000000e+00
  br i1 %isnan_cmp4.i.i209, label %complex_mul_libcall.i.i210, label %_ZStmlIdESt7complexIT_ERKS2_S4_.exit212, !prof !19

complex_mul_libcall.i.i210:                       ; preds = %complex_mul_imag_nan.i.i208
  %call5.i.i211 = tail call noundef { double, double } @__muldc3(double noundef %add.r.i.i187, double noundef %add.i.i.i188, double noundef %add.r.i, double noundef %add.i.i) #9
  %10 = extractvalue { double, double } %call5.i.i211, 0
  %11 = extractvalue { double, double } %call5.i.i211, 1
  br label %_ZStmlIdESt7complexIT_ERKS2_S4_.exit212

_ZStmlIdESt7complexIT_ERKS2_S4_.exit212:          ; preds = %complex_mul_libcall.i.i210, %complex_mul_imag_nan.i.i208, %_ZStmlIdESt7complexIT_ERKS2_S4_.exit179
  %real_mul_phi.i.i204 = phi double [ %mul_r.i.i201, %_ZStmlIdESt7complexIT_ERKS2_S4_.exit179 ], [ %mul_r.i.i201, %complex_mul_imag_nan.i.i208 ], [ %10, %complex_mul_libcall.i.i210 ]
  %imag_mul_phi.i.i205 = phi double [ %mul_i.i.i202, %_ZStmlIdESt7complexIT_ERKS2_S4_.exit179 ], [ %mul_i.i.i202, %complex_mul_imag_nan.i.i208 ], [ %11, %complex_mul_libcall.i.i210 ]
  %add.r.i.i220 = fadd double %real_mul_phi.i.i204, 0.000000e+00
  %add.i.i.i221 = fadd double %imag_mul_phi.i.i205, 0x403F7D93C6FE0D60
  %mul_ac.i.i230 = fmul double %add.r.i, %add.r.i.i220
  %mul_bd.i.i231 = fmul double %add.i.i, %add.i.i.i221
  %mul_ad.i.i232 = fmul double %add.i.i, %add.r.i.i220
  %mul_bc.i.i233 = fmul double %add.r.i, %add.i.i.i221
  %mul_r.i.i234 = fsub double %mul_ac.i.i230, %mul_bd.i.i231
  %mul_i.i.i235 = fadd double %mul_ad.i.i232, %mul_bc.i.i233
  %isnan_cmp.i.i236 = fcmp uno double %mul_r.i.i234, 0.000000e+00
  br i1 %isnan_cmp.i.i236, label %complex_mul_imag_nan.i.i241, label %_ZStmlIdESt7complexIT_ERKS2_S4_.exit245, !prof !19

complex_mul_imag_nan.i.i241:                      ; preds = %_ZStmlIdESt7complexIT_ERKS2_S4_.exit212
  %isnan_cmp4.i.i242 = fcmp uno double %mul_i.i.i235, 0.000000e+00
  br i1 %isnan_cmp4.i.i242, label %complex_mul_libcall.i.i243, label %_ZStmlIdESt7complexIT_ERKS2_S4_.exit245, !prof !19

complex_mul_libcall.i.i243:                       ; preds = %complex_mul_imag_nan.i.i241
  %call5.i.i244 = tail call noundef { double, double } @__muldc3(double noundef %add.r.i.i220, double noundef %add.i.i.i221, double noundef %add.r.i, double noundef %add.i.i) #9
  %12 = extractvalue { double, double } %call5.i.i244, 0
  %13 = extractvalue { double, double } %call5.i.i244, 1
  br label %_ZStmlIdESt7complexIT_ERKS2_S4_.exit245

_ZStmlIdESt7complexIT_ERKS2_S4_.exit245:          ; preds = %complex_mul_libcall.i.i243, %complex_mul_imag_nan.i.i241, %_ZStmlIdESt7complexIT_ERKS2_S4_.exit212
  %real_mul_phi.i.i237 = phi double [ %mul_r.i.i234, %_ZStmlIdESt7complexIT_ERKS2_S4_.exit212 ], [ %mul_r.i.i234, %complex_mul_imag_nan.i.i241 ], [ %12, %complex_mul_libcall.i.i243 ]
  %imag_mul_phi.i.i238 = phi double [ %mul_i.i.i235, %_ZStmlIdESt7complexIT_ERKS2_S4_.exit212 ], [ %mul_i.i.i235, %complex_mul_imag_nan.i.i241 ], [ %13, %complex_mul_libcall.i.i243 ]
  %add.r.i.i253 = fadd double %real_mul_phi.i.i237, 0xC035EF8D07342F5E
  %add.i.i.i254 = fadd double %imag_mul_phi.i.i238, 0.000000e+00
  %mul_ac.i.i263 = fmul double %add.r.i, %add.r.i.i253
  %mul_bd.i.i264 = fmul double %add.i.i, %add.i.i.i254
  %mul_ad.i.i265 = fmul double %add.i.i, %add.r.i.i253
  %mul_bc.i.i266 = fmul double %add.r.i, %add.i.i.i254
  %mul_r.i.i267 = fsub double %mul_ac.i.i263, %mul_bd.i.i264
  %mul_i.i.i268 = fadd double %mul_ad.i.i265, %mul_bc.i.i266
  %isnan_cmp.i.i269 = fcmp uno double %mul_r.i.i267, 0.000000e+00
  br i1 %isnan_cmp.i.i269, label %complex_mul_imag_nan.i.i274, label %_ZStmlIdESt7complexIT_ERKS2_S4_.exit278, !prof !19

complex_mul_imag_nan.i.i274:                      ; preds = %_ZStmlIdESt7complexIT_ERKS2_S4_.exit245
  %isnan_cmp4.i.i275 = fcmp uno double %mul_i.i.i268, 0.000000e+00
  br i1 %isnan_cmp4.i.i275, label %complex_mul_libcall.i.i276, label %_ZStmlIdESt7complexIT_ERKS2_S4_.exit278, !prof !19

complex_mul_libcall.i.i276:                       ; preds = %complex_mul_imag_nan.i.i274
  %call5.i.i277 = tail call noundef { double, double } @__muldc3(double noundef %add.r.i.i253, double noundef %add.i.i.i254, double noundef %add.r.i, double noundef %add.i.i) #9
  %14 = extractvalue { double, double } %call5.i.i277, 0
  %15 = extractvalue { double, double } %call5.i.i277, 1
  br label %_ZStmlIdESt7complexIT_ERKS2_S4_.exit278

_ZStmlIdESt7complexIT_ERKS2_S4_.exit278:          ; preds = %complex_mul_libcall.i.i276, %complex_mul_imag_nan.i.i274, %_ZStmlIdESt7complexIT_ERKS2_S4_.exit245
  %real_mul_phi.i.i270 = phi double [ %mul_r.i.i267, %_ZStmlIdESt7complexIT_ERKS2_S4_.exit245 ], [ %mul_r.i.i267, %complex_mul_imag_nan.i.i274 ], [ %14, %complex_mul_libcall.i.i276 ]
  %imag_mul_phi.i.i271 = phi double [ %mul_i.i.i268, %_ZStmlIdESt7complexIT_ERKS2_S4_.exit245 ], [ %mul_i.i.i268, %complex_mul_imag_nan.i.i274 ], [ %15, %complex_mul_libcall.i.i276 ]
  %add.i.i.i287 = fadd double %imag_mul_phi.i.i271, 0xC04027B4A033A7EC
  %mul_ac.i.i296 = fmul double %add.r.i, %real_mul_phi.i.i270
  %mul_bd.i.i297 = fmul double %add.i.i, %add.i.i.i287
  %mul_ad.i.i298 = fmul double %add.i.i, %real_mul_phi.i.i270
  %mul_bc.i.i299 = fmul double %add.r.i, %add.i.i.i287
  %mul_r.i.i300 = fsub double %mul_ac.i.i296, %mul_bd.i.i297
  %mul_i.i.i301 = fadd double %mul_ad.i.i298, %mul_bc.i.i299
  %isnan_cmp.i.i302 = fcmp uno double %mul_r.i.i300, 0.000000e+00
  br i1 %isnan_cmp.i.i302, label %complex_mul_imag_nan.i.i307, label %_ZStmlIdESt7complexIT_ERKS2_S4_.exit311, !prof !19

complex_mul_imag_nan.i.i307:                      ; preds = %_ZStmlIdESt7complexIT_ERKS2_S4_.exit278
  %isnan_cmp4.i.i308 = fcmp uno double %mul_i.i.i301, 0.000000e+00
  br i1 %isnan_cmp4.i.i308, label %complex_mul_libcall.i.i309, label %_ZStmlIdESt7complexIT_ERKS2_S4_.exit311, !prof !19

complex_mul_libcall.i.i309:                       ; preds = %complex_mul_imag_nan.i.i307
  %call5.i.i310 = tail call noundef { double, double } @__muldc3(double noundef %real_mul_phi.i.i270, double noundef %add.i.i.i287, double noundef %add.r.i, double noundef %add.i.i) #9
  %16 = extractvalue { double, double } %call5.i.i310, 0
  %17 = extractvalue { double, double } %call5.i.i310, 1
  br label %_ZStmlIdESt7complexIT_ERKS2_S4_.exit311

_ZStmlIdESt7complexIT_ERKS2_S4_.exit311:          ; preds = %complex_mul_libcall.i.i309, %complex_mul_imag_nan.i.i307, %_ZStmlIdESt7complexIT_ERKS2_S4_.exit278
  %real_mul_phi.i.i303 = phi double [ %mul_r.i.i300, %_ZStmlIdESt7complexIT_ERKS2_S4_.exit278 ], [ %mul_r.i.i300, %complex_mul_imag_nan.i.i307 ], [ %16, %complex_mul_libcall.i.i309 ]
  %imag_mul_phi.i.i304 = phi double [ %mul_i.i.i301, %_ZStmlIdESt7complexIT_ERKS2_S4_.exit278 ], [ %mul_i.i.i301, %complex_mul_imag_nan.i.i307 ], [ %17, %complex_mul_libcall.i.i309 ]
  %mul_bd.i.i331 = fmul double %imag_mul_phi.i.i, 0.000000e+00
  %mul_bc.i.i333 = fmul double %real_mul_phi.i.i, 0.000000e+00
  %mul_r.i.i334 = fsub double %real_mul_phi.i.i, %mul_bd.i.i331
  %mul_i.i.i335 = fadd double %mul_bc.i.i333, %imag_mul_phi.i.i
  %isnan_cmp.i.i336 = fcmp uno double %mul_r.i.i334, 0.000000e+00
  br i1 %isnan_cmp.i.i336, label %complex_mul_imag_nan.i.i341, label %_ZStmlIdESt7complexIT_ERKS2_S4_.exit345, !prof !19

complex_mul_imag_nan.i.i341:                      ; preds = %_ZStmlIdESt7complexIT_ERKS2_S4_.exit311
  %isnan_cmp4.i.i342 = fcmp uno double %mul_i.i.i335, 0.000000e+00
  br i1 %isnan_cmp4.i.i342, label %complex_mul_libcall.i.i343, label %_ZStmlIdESt7complexIT_ERKS2_S4_.exit345, !prof !19

complex_mul_libcall.i.i343:                       ; preds = %complex_mul_imag_nan.i.i341
  %call5.i.i344 = tail call noundef { double, double } @__muldc3(double noundef 1.000000e+00, double noundef 0.000000e+00, double noundef %real_mul_phi.i.i, double noundef %imag_mul_phi.i.i) #9
  %18 = extractvalue { double, double } %call5.i.i344, 0
  %19 = extractvalue { double, double } %call5.i.i344, 1
  br label %_ZStmlIdESt7complexIT_ERKS2_S4_.exit345

_ZStmlIdESt7complexIT_ERKS2_S4_.exit345:          ; preds = %complex_mul_libcall.i.i343, %complex_mul_imag_nan.i.i341, %_ZStmlIdESt7complexIT_ERKS2_S4_.exit311
  %real_mul_phi.i.i337 = phi double [ %mul_r.i.i334, %_ZStmlIdESt7complexIT_ERKS2_S4_.exit311 ], [ %mul_r.i.i334, %complex_mul_imag_nan.i.i341 ], [ %18, %complex_mul_libcall.i.i343 ]
  %imag_mul_phi.i.i338 = phi double [ %mul_i.i.i335, %_ZStmlIdESt7complexIT_ERKS2_S4_.exit311 ], [ %mul_i.i.i335, %complex_mul_imag_nan.i.i341 ], [ %19, %complex_mul_libcall.i.i343 ]
  %add.r.i.i353 = fadd double %real_mul_phi.i.i337, -1.400000e+01
  %add.i.i.i354 = fadd double %imag_mul_phi.i.i338, 0.000000e+00
  %mul_ac.i.i363 = fmul double %real_mul_phi.i.i, %add.r.i.i353
  %mul_bd.i.i364 = fmul double %imag_mul_phi.i.i, %add.i.i.i354
  %mul_ad.i.i365 = fmul double %imag_mul_phi.i.i, %add.r.i.i353
  %mul_bc.i.i366 = fmul double %real_mul_phi.i.i, %add.i.i.i354
  %mul_r.i.i367 = fsub double %mul_ac.i.i363, %mul_bd.i.i364
  %mul_i.i.i368 = fadd double %mul_ad.i.i365, %mul_bc.i.i366
  %isnan_cmp.i.i369 = fcmp uno double %mul_r.i.i367, 0.000000e+00
  br i1 %isnan_cmp.i.i369, label %complex_mul_imag_nan.i.i374, label %_ZStmlIdESt7complexIT_ERKS2_S4_.exit378, !prof !19

complex_mul_imag_nan.i.i374:                      ; preds = %_ZStmlIdESt7complexIT_ERKS2_S4_.exit345
  %isnan_cmp4.i.i375 = fcmp uno double %mul_i.i.i368, 0.000000e+00
  br i1 %isnan_cmp4.i.i375, label %complex_mul_libcall.i.i376, label %_ZStmlIdESt7complexIT_ERKS2_S4_.exit378, !prof !19

complex_mul_libcall.i.i376:                       ; preds = %complex_mul_imag_nan.i.i374
  %call5.i.i377 = tail call noundef { double, double } @__muldc3(double noundef %add.r.i.i353, double noundef %add.i.i.i354, double noundef %real_mul_phi.i.i, double noundef %imag_mul_phi.i.i) #9
  %20 = extractvalue { double, double } %call5.i.i377, 0
  %21 = extractvalue { double, double } %call5.i.i377, 1
  br label %_ZStmlIdESt7complexIT_ERKS2_S4_.exit378

_ZStmlIdESt7complexIT_ERKS2_S4_.exit378:          ; preds = %complex_mul_libcall.i.i376, %complex_mul_imag_nan.i.i374, %_ZStmlIdESt7complexIT_ERKS2_S4_.exit345
  %real_mul_phi.i.i370 = phi double [ %mul_r.i.i367, %_ZStmlIdESt7complexIT_ERKS2_S4_.exit345 ], [ %mul_r.i.i367, %complex_mul_imag_nan.i.i374 ], [ %20, %complex_mul_libcall.i.i376 ]
  %imag_mul_phi.i.i371 = phi double [ %mul_i.i.i368, %_ZStmlIdESt7complexIT_ERKS2_S4_.exit345 ], [ %mul_i.i.i368, %complex_mul_imag_nan.i.i374 ], [ %21, %complex_mul_libcall.i.i376 ]
  %add.r.i.i386 = fadd double %real_mul_phi.i.i370, 5.250000e+01
  %add.i.i.i387 = fadd double %imag_mul_phi.i.i371, 0.000000e+00
  %mul_ac.i.i396 = fmul double %real_mul_phi.i.i, %add.r.i.i386
  %mul_bd.i.i397 = fmul double %imag_mul_phi.i.i, %add.i.i.i387
  %mul_ad.i.i398 = fmul double %imag_mul_phi.i.i, %add.r.i.i386
  %mul_bc.i.i399 = fmul double %real_mul_phi.i.i, %add.i.i.i387
  %mul_r.i.i400 = fsub double %mul_ac.i.i396, %mul_bd.i.i397
  %mul_i.i.i401 = fadd double %mul_ad.i.i398, %mul_bc.i.i399
  %isnan_cmp.i.i402 = fcmp uno double %mul_r.i.i400, 0.000000e+00
  br i1 %isnan_cmp.i.i402, label %complex_mul_imag_nan.i.i407, label %_ZStmlIdESt7complexIT_ERKS2_S4_.exit411, !prof !19

complex_mul_imag_nan.i.i407:                      ; preds = %_ZStmlIdESt7complexIT_ERKS2_S4_.exit378
  %isnan_cmp4.i.i408 = fcmp uno double %mul_i.i.i401, 0.000000e+00
  br i1 %isnan_cmp4.i.i408, label %complex_mul_libcall.i.i409, label %_ZStmlIdESt7complexIT_ERKS2_S4_.exit411, !prof !19

complex_mul_libcall.i.i409:                       ; preds = %complex_mul_imag_nan.i.i407
  %call5.i.i410 = tail call noundef { double, double } @__muldc3(double noundef %add.r.i.i386, double noundef %add.i.i.i387, double noundef %real_mul_phi.i.i, double noundef %imag_mul_phi.i.i) #9
  %22 = extractvalue { double, double } %call5.i.i410, 0
  %23 = extractvalue { double, double } %call5.i.i410, 1
  br label %_ZStmlIdESt7complexIT_ERKS2_S4_.exit411

_ZStmlIdESt7complexIT_ERKS2_S4_.exit411:          ; preds = %complex_mul_libcall.i.i409, %complex_mul_imag_nan.i.i407, %_ZStmlIdESt7complexIT_ERKS2_S4_.exit378
  %real_mul_phi.i.i403 = phi double [ %mul_r.i.i400, %_ZStmlIdESt7complexIT_ERKS2_S4_.exit378 ], [ %mul_r.i.i400, %complex_mul_imag_nan.i.i407 ], [ %22, %complex_mul_libcall.i.i409 ]
  %imag_mul_phi.i.i404 = phi double [ %mul_i.i.i401, %_ZStmlIdESt7complexIT_ERKS2_S4_.exit378 ], [ %mul_i.i.i401, %complex_mul_imag_nan.i.i407 ], [ %23, %complex_mul_libcall.i.i409 ]
  %add.r.i.i419 = fadd double %real_mul_phi.i.i403, -5.250000e+01
  %add.i.i.i420 = fadd double %imag_mul_phi.i.i404, 0.000000e+00
  %mul_ac.i.i429 = fmul double %real_mul_phi.i.i, %add.r.i.i419
  %mul_bd.i.i430 = fmul double %imag_mul_phi.i.i, %add.i.i.i420
  %mul_ad.i.i431 = fmul double %imag_mul_phi.i.i, %add.r.i.i419
  %mul_bc.i.i432 = fmul double %real_mul_phi.i.i, %add.i.i.i420
  %mul_r.i.i433 = fsub double %mul_ac.i.i429, %mul_bd.i.i430
  %mul_i.i.i434 = fadd double %mul_ad.i.i431, %mul_bc.i.i432
  %isnan_cmp.i.i435 = fcmp uno double %mul_r.i.i433, 0.000000e+00
  br i1 %isnan_cmp.i.i435, label %complex_mul_imag_nan.i.i440, label %_ZStmlIdESt7complexIT_ERKS2_S4_.exit444, !prof !19

complex_mul_imag_nan.i.i440:                      ; preds = %_ZStmlIdESt7complexIT_ERKS2_S4_.exit411
  %isnan_cmp4.i.i441 = fcmp uno double %mul_i.i.i434, 0.000000e+00
  br i1 %isnan_cmp4.i.i441, label %complex_mul_libcall.i.i442, label %_ZStmlIdESt7complexIT_ERKS2_S4_.exit444, !prof !19

complex_mul_libcall.i.i442:                       ; preds = %complex_mul_imag_nan.i.i440
  %call5.i.i443 = tail call noundef { double, double } @__muldc3(double noundef %add.r.i.i419, double noundef %add.i.i.i420, double noundef %real_mul_phi.i.i, double noundef %imag_mul_phi.i.i) #9
  %24 = extractvalue { double, double } %call5.i.i443, 0
  %25 = extractvalue { double, double } %call5.i.i443, 1
  br label %_ZStmlIdESt7complexIT_ERKS2_S4_.exit444

_ZStmlIdESt7complexIT_ERKS2_S4_.exit444:          ; preds = %complex_mul_libcall.i.i442, %complex_mul_imag_nan.i.i440, %_ZStmlIdESt7complexIT_ERKS2_S4_.exit411
  %real_mul_phi.i.i436 = phi double [ %mul_r.i.i433, %_ZStmlIdESt7complexIT_ERKS2_S4_.exit411 ], [ %mul_r.i.i433, %complex_mul_imag_nan.i.i440 ], [ %24, %complex_mul_libcall.i.i442 ]
  %imag_mul_phi.i.i437 = phi double [ %mul_i.i.i434, %_ZStmlIdESt7complexIT_ERKS2_S4_.exit411 ], [ %mul_i.i.i434, %complex_mul_imag_nan.i.i440 ], [ %25, %complex_mul_libcall.i.i442 ]
  %add.i.i.i320 = fadd double %imag_mul_phi.i.i304, 0.000000e+00
  %add.r.i.i319 = fadd double %real_mul_phi.i.i303, 0x4027830642DA00A6
  %add.r.i.i452 = fadd double %real_mul_phi.i.i436, 6.562500e+00
  %add.i.i.i453 = fadd double %imag_mul_phi.i.i437, 0.000000e+00
  %call4.i.i = tail call noundef { double, double } @__divdc3(double noundef %add.r.i.i319, double noundef %add.i.i.i320, double noundef %add.r.i.i452, double noundef %add.i.i.i453) #9
  %.fca.0.extract89 = extractvalue { double, double } %call4.i.i, 0
  %.fca.1.extract91 = extractvalue { double, double } %call4.i.i, 1
  %.fca.0.0.insert = insertvalue %"class.std::complex" poison, double %.fca.0.extract89, 0, 0
  %.fca.0.1.insert = insertvalue %"class.std::complex" %.fca.0.0.insert, double %.fca.1.extract91, 0, 1
