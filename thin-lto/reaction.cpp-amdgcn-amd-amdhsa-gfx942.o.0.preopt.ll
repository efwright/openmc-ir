; ModuleID = 'reaction.cpp-amdgcn-amd-amdhsa-gfx942.o.0.preopt.bc'
...
define hidden void @_ZN6openmc12ReactionFlatC2EPKh(ptr noundef nonnull writeonly align 8 captures(none) dereferenceable(24) initializes((0, 24)) %this, ptr noundef %data) unnamed_addr #2 align 2 {
entry:
  store ptr %data, ptr %this, align 8, !tbaa !15
  %add.ptr = getelementptr inbounds nuw i8, ptr %data, i64 24
  %0 = load i64, ptr %add.ptr, align 8, !tbaa !22
  %n_xs_ = getelementptr inbounds nuw i8, ptr %this, i64 8
  store i64 %0, ptr %n_xs_, align 8, !tbaa !23
  %add.ptr4 = getelementptr inbounds nuw i8, ptr %data, i64 32
  %1 = load i64, ptr %add.ptr4, align 8, !tbaa !22
  %n_products_ = getelementptr inbounds nuw i8, ptr %this, i64 16
  store i64 %1, ptr %n_products_, align 8, !tbaa !24
  ret void
}
...
entry:
  ...
  %2 = load i32, ptr %add.ptr3, align 4, !tbaa !25
...
cond.false:                                       ; preds = %entry
  ...
  %3 = load double, ptr %arrayidx7, align 8, !tbaa !27
  %4 = load double, ptr %arrayidx10, align 8, !tbaa !27
...
entry:
  ...
  %0 = load i32, ptr %index_temp, align 4, !tbaa !29
  %conv = sext i32 %0 to i64
  %index_grid = getelementptr inbounds nuw i8, ptr %micro, i64 112
  %1 = load i32, ptr %index_grid, align 8, !tbaa !32
...
cond.false.i:                                     ; preds = %entry
  ...
  %4 = load double, ptr %interp_factor, align 8, !tbaa !33
  ...
  %5 = load double, ptr %arrayidx7.i, align 8, !tbaa !27
  %6 = load double, ptr %arrayidx10.i, align 8, !tbaa !27
  %mul11.i = fmul double %4, %6
  %7 = tail call double @llvm.fmuladd.f64(double %sub.i, double %5, double %mul11.i) #6
...
entry:
  ...
  %1 = load double, ptr %add.ptr, align 8, !tbaa !27
  ret double %1
}
...
entry:
  ...
  %add.ptr = getelementptr inbounds nuw i8, ptr %0, i64 40
  %n_xs_ = getelementptr inbounds nuw i8, ptr %this, i64 8
  %1 = load i64, ptr %n_xs_, align 8, !tbaa !23
  %2 = getelementptr i32, ptr %add.ptr, i64 %1
  %arrayidx = getelementptr i32, ptr %2, i64 %i
  %3 = load i32, ptr %arrayidx, align 4, !tbaa !25
  %idx.ext = sext i32 %3 to i64
  %add.ptr3 = getelementptr inbounds i8, ptr %0, i64 %idx.ext
  call void @_ZN6openmc19ReactionProductFlatC1EPKh(ptr noundef nonnull align 8 dereferenceable(32) %retval.ascast, ptr noundef %add.ptr3) #7
...
declare void @_ZN6openmc19ReactionProductFlatC1EPKh(ptr noundef nonnull align 8 dereferenceable(32), ptr noundef) unnamed_addr #5
...
entry:
  ...
  %1 = load i64, ptr %add.ptr.i, align 8, !tbaa !22
  %add.ptr4.i = getelementptr inbounds nuw i8, ptr %0, i64 32
  %2 = load i64, ptr %add.ptr4.i, align 8, !tbaa !22
...
!28 = !{!"double", !19, i64 0}
!29 = !{!30, !26, i64 116}
!30 = !{!"_ZTSN6openmc14NuclideMicroXSE", !28, i64 0, !28, i64 8, !28, i64 16, !28, i64 24, !28, i64 32, !28, i64 40, !28, i64 48, !28, i64 56, !19, i64 64, !26, i64 112, !26, i64 116, !28, i64 120, !26, i64 128, !26, i64 132, !28, i64 136, !31, i64 144, !28, i64 152, !28, i64 160}
!31 = !{!"bool", !19, i64 0}
!32 = !{!30, !26, i64 112}
!33 = !{!30, !28, i64 120}
!34 = !{!35, !17, i64 0}
!35 = !{!"_ZTSN6openmc21ReactionFlatContainerE", !36, i64 0}
!36 = !{!"_ZTSN6openmc10DataBufferE", !17, i64 0, !21, i64 8, !21, i64 16, !37, i64 24}
