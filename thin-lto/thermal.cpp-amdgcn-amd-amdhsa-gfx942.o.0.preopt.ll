; ModuleID = 'thermal.cpp-amdgcn-amd-amdhsa-gfx942.o.0.preopt.bc'
...
; Function Attrs: convergent mustprogress nounwind
define hidden void @_ZNK6openmc11ThermalData12calculate_xsEdPdS1_(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(64) %this, double noundef %E, ptr noundef writeonly captures(none) initializes((0, 8)) %elastic, ptr noundef writeonly captures(none) initializes((0, 8)) %inelastic) local_unnamed_addr #2 align 2 {
entry:
  %device_xs = getelementptr inbounds nuw i8, ptr %this, i64 16
  %0 = load ptr, ptr %device_xs, align 8, !tbaa !35
  %tobool.not = icmp eq ptr %0, null
  br i1 %tobool.not, label %if.end, label %if.then

if.then:                                          ; preds = %entry
  %call = tail call noundef double @_ZNK6openmc23Function1DFlatContainerclEd(ptr noundef nonnull align 8 dereferenceable(32) %0, double noundef %E) #4
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %storemerge = phi double [ %call, %if.then ], [ 0.000000e+00, %entry ]
  store double %storemerge, ptr %elastic, align 8, !tbaa !24
  %device_xs4 = getelementptr inbounds nuw i8, ptr %this, i64 48
  %1 = load ptr, ptr %device_xs4, align 8, !tbaa !52
  %call5 = tail call noundef double @_ZNK6openmc23Function1DFlatContainerclEd(ptr noundef nonnull align 8 dereferenceable(32) %1, double noundef %E) #4
  store double %call5, ptr %inelastic, align 8, !tbaa !24
  ret void
}
