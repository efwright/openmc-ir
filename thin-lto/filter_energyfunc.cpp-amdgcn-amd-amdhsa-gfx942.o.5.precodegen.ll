; ModuleID = 'filter_energyfunc.cpp-amdgcn-amd-amdhsa-gfx942.o.5.precodegen.bc'
...
define hidden void @_ZNK6openmc6Filter33EnergyFunctionFilter_get_all_binsERKNS_8ParticleENS_14TallyEstimatorERNS_11FilterMatchE(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(448) %this, ptr noundef nonnull readonly align 8 captures(none) dereferenceable(2728) %p, i32 noundef %estimator, ptr noundef nonnull align 8 captures(none) dereferenceable(1513) %match) local_unnamed_addr #1 align 2 {
entry:
  ...
  %energy_.val = load ptr, ptr %energy_, align 8, !tbaa !37
  %1 = load double, ptr %energy_.val, align 8, !tbaa !40
  %cmp = fcmp ult double %0, %1
  br i1 %cmp, label %if.end, label %land.lhs.true

land.lhs.true:                                    ; preds = %entry
  %2 = getelementptr inbounds nuw i8, ptr %this, i64 248
  %energy_.val10 = load i64, ptr %2, align 8, !tbaa !41
...
while.body.i.i.i:                                 ; preds = %while.body.i.i.i, %if.end.i
  ...
  %.val.i.i.i = load double, ptr %add.ptr.i.i.i.i.i, align 8, !tbaa !40
...
_ZN6openmc17lower_bound_indexIPKddEENSt15iterator_traitsIT_E15difference_typeES4_S4_RKT0_.internalized.exit: ; preds = %_ZSt11lower_boundIPKddET_S2_S2_RKT0_.internalized.exit.i, %if.then
  ...
  %this.val.i = load i32, ptr %6, align 8, !tbaa !44
...
if.then.i:                                        ; preds = %_ZN6openmc17lower_bound_indexIPKddEENSt15iterator_traitsIT_E15difference_typeES4_S4_RKT0_.internalized.exit
  ...
  store double %11, ptr %arrayidx4.i, align 8, !tbaa !40
  %inc.i = add nsw i32 %12, 1
  store i32 %inc.i, ptr %6, align 8, !tbaa !44
  br label %if.end
