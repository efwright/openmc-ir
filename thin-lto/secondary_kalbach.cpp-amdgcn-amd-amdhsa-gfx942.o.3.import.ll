; ModuleID = 'secondary_kalbach.cpp-amdgcn-amd-amdhsa-gfx942.o.3.import.bc'
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite)
define internal void @_ZN6openmc15KalbachMannFlatC2EPKh(ptr noundef nonnull writeonly align 8 captures(none) dereferenceable(24) initializes((0, 24)) %this, ptr noundef %data) unnamed_addr #2 align 2 {
entry:
...
entry:
  ...
  store double %0, ptr %mu, align 8, !tbaa !28
  ...
  %2 = load i64, ptr %n_region_.i, align 8, !tbaa !25
  %mul.i = shl i64 %2, 3
  ...
  %3 = load i64, ptr %n_energy_.i, align 8, !tbaa !27
...
if.else:                                          ; preds = %entry
  ...
  %5 = load double, ptr %arrayidx.i, align 8, !tbaa !28
...
while.body.i.i.i:                                 ; preds = %while.body.i.i.i, %if.end.i
  ...
  %6 = tail call i1 @llvm.is.constant.i64(i64 range(i64 0, 576460752303423488) %shr.i.i.i) #6
  ...
  %.val.i.i.i = load double, ptr %add.ptr.sink.i.i.i.i.i, align 8, !tbaa !28
...
if.end22:                                         ; preds = %_ZN6openmc17lower_bound_indexIPKddEENSt15iterator_traitsIT_E15difference_typeES4_S4_RKT0_.internalized.exit, %if.then7, %entry
  ...
  %call23 = tail call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #5
  ...
  %13 = load i64, ptr %n_region_.i, align 8, !tbaa !25
  ...
  %14 = load i64, ptr %n_energy_.i, align 8, !tbaa !27
  %mul5.i = shl i64 %14, 3
  ...
  %16 = load i32, ptr %arrayidx.i174, align 4, !tbaa !23
  ...
  %17 = load i64, ptr %add.ptr.i.i175, align 8, !tbaa !26
  ...
  %18 = load double, ptr %arrayidx.i186, align 8, !tbaa !28
  %sub34 = shl i64 %17, 32
  ...
  %20 = load double, ptr %arrayidx.i187, align 8, !tbaa !28
  %arrayidx.i196 = getelementptr i8, ptr %arrayidx.i174, i64 4
  %21 = load i32, ptr %arrayidx.i196, align 4, !tbaa !23
  ...
  %22 = load i64, ptr %add.ptr.i.i199, align 8, !tbaa !26
  ...
  %23 = load double, ptr %arrayidx.i210, align 8, !tbaa !28
  %sub46 = shl i64 %22, 32
  ...
  %25 = load double, ptr %arrayidx.i211, align 8, !tbaa !28
  ...
  %call62 = tail call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #5
  %29 = load double, ptr %add.ptr4.i224, align 8, !tbaa !28
...
for.body:                                         ; preds = %for.inc, %for.body.preheader
  ...
  %31 = load double, ptr %arrayidx.i233, align 8, !tbaa !28
...
for.body75:                                       ; preds = %for.cond72, %cleanup
  ...
  %32 = load double, ptr %arrayidx.i234, align 8, !tbaa !28
  %cmp79 = fcmp olt double %call62, %32
  br i1 %cmp79, label %for.body75.cleanup85_crit_edge, label %for.cond72, !llvm.loop !33
...
cleanup85:                                        ; preds = %for.body75.cleanup85_crit_edge, %for.cond72, %cleanup
  ...
  %33 = load double, ptr %arrayidx.i235, align 8, !tbaa !28
  %arrayidx.i236 = getelementptr inbounds nuw double, ptr %add.ptr4.i218, i64 %conv87
  %34 = load double, ptr %arrayidx.i236, align 8, !tbaa !28
  %35 = getelementptr i8, ptr %cond55.val148.sroa.speculated, i64 4
  %cond55.val154.val = load i32, ptr %35, align 4, !tbaa !23
...
if.end101:                                        ; preds = %if.then96, %if.then93
  ...
  %36 = load double, ptr %arrayidx.i243, align 8, !tbaa !28
  ...
  %37 = load double, ptr %arrayidx.i250, align 8, !tbaa !28
  br label %if.end160
...
if.else109:                                       ; preds = %cleanup85
  ...
  %38 = load double, ptr %arrayidx.i251, align 8, !tbaa !28
  %arrayidx.i252 = getelementptr inbounds nuw double, ptr %add.ptr4.i218, i64 %conv111
  %39 = load double, ptr %arrayidx.i252, align 8, !tbaa !28
...
if.else124:                                       ; preds = %if.else109
  ...
  %41 = tail call noundef double @llvm.sqrt.f64(double %.sroa.speculated) #6
...
if.end135:                                        ; preds = %if.else124, %if.then120
  ...
  %42 = load double, ptr %arrayidx.i266, align 8, !tbaa !28
  ...
  %43 = load double, ptr %arrayidx.i267, align 8, !tbaa !28
  ...
  %45 = load double, ptr %arrayidx.i269, align 8, !tbaa !28
  %arrayidx.i270 = getelementptr inbounds nuw double, ptr %add.ptr4.i262, i64 %conv111
  %46 = load double, ptr %arrayidx.i270, align 8, !tbaa !28
...
if.end178:                                        ; preds = %if.end178.sink.split, %if.end160
  %call179 = tail call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #5
  %cmp180 = fcmp ogt double %call179, %km_r.0
  br i1 %cmp180, label %if.then181, label %if.else191

if.then181:                                       ; preds = %if.end178
  %call182 = tail call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #5
  %49 = tail call double @llvm.fmuladd.f64(double %call182, double 2.000000e+00, double -1.000000e+00)
  %50 = tail call double @llvm.fabs.f64(double %km_a.0) #6
  ...
  %125 = tail call double @llvm.amdgcn.rcp.f64(double %123) #6
  %126 = fneg double %123
  %127 = tail call double @llvm.fma.f64(double %126, double %125, double 1.000000e+00) #6
  %128 = tail call double @llvm.fma.f64(double %127, double %125, double %125) #6
  %129 = tail call double @llvm.fma.f64(double %126, double %128, double 1.000000e+00) #6
  %130 = tail call double @llvm.fma.f64(double %129, double %128, double %128) #6
  %131 = fmul double %123, %130
  %132 = fneg double %131
  %133 = tail call double @llvm.fma.f64(double %130, double %123, double %132) #6
  %134 = tail call double @llvm.fma.f64(double %130, double %124, double %133) #6
  ...
  %147 = fneg double %146
  %148 = tail call double @llvm.fma.f64(double %145, double %123, double %147) #6
  %149 = tail call double @llvm.fma.f64(double %145, double %124, double %148) #6
  ...
  %167 = tail call double @llvm.ldexp.f64.i32(double %164, i32 -2) #6
  %168 = tail call double @llvm.ldexp.f64.i32(double %166, i32 -2) #6
  ...
  %179 = tail call noundef double @llvm.copysign.f64(double %178, double %km_a.0) #6
  %mul185 = fmul double %179, %49
  %180 = tail call double @llvm.fmuladd.f64(double %mul185, double %mul185, double 1.000000e+00)
  %181 = tail call noundef double @llvm.sqrt.f64(double %180) #6
  %add188 = fadd double %mul185, %181
  br label %if.end201

if.else191:                                       ; preds = %if.end178
  %call193 = tail call noundef double @_ZN6openmc3prnEPm(ptr noundef %seed) #5
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite)
define available_externally hidden noundef double @_ZN6openmc3prnEPm(ptr noundef captures(none) %seed) local_unnamed_addr #2 {
entry:
  %0 = load i64, ptr %seed, align 8, !tbaa !26
  %mul = mul i64 %0, 2806196910506780709
  %add = add i64 %mul, 1
  %and = and i64 %add, 9223372036854775807
  store i64 %and, ptr %seed, align 8, !tbaa !26
