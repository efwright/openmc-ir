; ModuleID = 'physics_common.cpp-amdgcn-amd-amdhsa-gfx942.o.5.precodegen.bc'
...
define hidden void @_ZN6openmc16russian_rouletteERNS_8ParticleEd(ptr noundef nonnull align 8 captures(none) dereferenceable(2728) %p, double noundef %weight_survive) local_unnamed_addr #0 {
entry:
  ...
  %2 = load double, ptr %wgt_, align 8, !tbaa !39
  %div = fdiv double %2, %weight_survive
  %cmp = fcmp olt double %mul1.i, %div
  %weight_survive. = select i1 %cmp, double %weight_survive, double 0.000000e+00
  store double %weight_survive., ptr %wgt_, align 8, !tbaa !39
  ret void
}
