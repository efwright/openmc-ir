; ModuleID = 'geometry.cpp-amdgcn-amd-amdhsa-gfx942.o.0.preopt.bc'
...
; Function Attrs: convergent mustprogress nounwind
define hidden noundef zeroext i1 @_ZN6openmc15find_cell_innerERNS_8ParticleEPKNS_12NeighborListE(ptr noundef nonnull align 8 dereferenceable(2728) %p, ptr noundef readonly captures(address_is_null) %neighbor_list) local_unnamed_addr #3 {
entry:
  ...
  %tobool.not = icmp ne ptr %neighbor_list, null
  br i1 %tobool.not, label %for.cond.preheader, label %if.end28

for.cond.preheader:                               ; preds = %entry
  %coord_ = getelementptr inbounds nuw i8, ptr %p, i64 888
  %n_coord_ = getelementptr inbounds nuw i8, ptr %p, i64 876
  %invariant.gep = getelementptr inbounds nuw i8, ptr %p, i64 940
  %0 = getelementptr inbounds nuw i8, ptr %p, i64 912
  %surface_ = getelementptr inbounds nuw i8, ptr %p, i64 1592
  %invariant.gep209 = getelementptr inbounds nuw i8, ptr %p, i64 936
  br label %for.body

for.body:                                         ; preds = %for.inc, %for.cond.preheader
  %found.0.off0208 = phi i1 [ false, %for.cond.preheader ], [ %found.2.off0, %for.inc ]
  %i.0207 = phi i64 [ 0, %for.cond.preheader ], [ %inc, %for.inc ]
  %arrayidx = getelementptr inbounds nuw [50 x i32], ptr %neighbor_list, i64 0, i64 %i.0207
  %1 = load i32, ptr %arrayidx, align 4, !tbaa !49
  %cmp1 = icmp eq i32 %1, -1
  br i1 %cmp1, label %cleanup24, label %if.end

if.end:                                           ; preds = %for.body
  %2 = load i32, ptr %n_coord_, align 4, !tbaa !23
  %sub = add nsw i32 %2, -1
  %idxprom = sext i32 %sub to i64
  %universe.idx = mul nsw i64 %idxprom, 80
  %gep = getelementptr i8, ptr %invariant.gep, i64 %universe.idx
  %3 = load i32, ptr %gep, align 4, !tbaa !50
  %4 = load ptr, ptr addrspace(1) @_ZN6openmc5model12device_cellsE, align 8, !tbaa !47
  %idxprom4 = sext i32 %1 to i64
  %universe_ = getelementptr inbounds %"class.openmc::Cell", ptr %4, i64 %idxprom4, i32 3
  %5 = load i32, ptr %universe_, align 4, !tbaa !51
  %cmp6.not = icmp eq i32 %5, %3
  br i1 %cmp6.not, label %if.end8, label %cleanup23

if.end8:                                          ; preds = %if.end
  %arrayidx.i = getelementptr inbounds [6 x %"class.openmc::LocalCoord"], ptr %coord_, i64 0, i64 %idxprom
  %r.sroa.0.0.copyload = load double, ptr %arrayidx.i, align 8, !tbaa !62
  %r.sroa.4.0.call.sroa_idx = getelementptr inbounds nuw i8, ptr %arrayidx.i, i64 8
  %r.sroa.4.0.copyload = load double, ptr %r.sroa.4.0.call.sroa_idx, align 8, !tbaa !62
  %r.sroa.5.0.call.sroa_idx = getelementptr inbounds nuw i8, ptr %arrayidx.i, i64 16
  %r.sroa.5.0.copyload = load double, ptr %r.sroa.5.0.call.sroa_idx, align 8, !tbaa !62
  %u.i = getelementptr i8, ptr %0, i64 %universe.idx
  %u.sroa.0.0.copyload = load double, ptr %u.i, align 8, !tbaa !62
  %u.sroa.4.0.call9.sroa_idx = getelementptr inbounds nuw i8, ptr %u.i, i64 8
  %u.sroa.4.0.copyload = load double, ptr %u.sroa.4.0.call9.sroa_idx, align 8, !tbaa !62
  %u.sroa.5.0.call9.sroa_idx = getelementptr inbounds nuw i8, ptr %u.i, i64 16
  %u.sroa.5.0.copyload = load double, ptr %u.sroa.5.0.call9.sroa_idx, align 8, !tbaa !62
  %6 = load i32, ptr %surface_, align 8, !tbaa !63
  %arrayidx11 = getelementptr inbounds %"class.openmc::Cell", ptr %4, i64 %idxprom4
  %call13 = tail call noundef zeroext i1 @_ZNK6openmc4Cell8containsENS_8PositionES1_i(ptr noundef nonnull align 8 dereferenceable(496) %arrayidx11, double %r.sroa.0.0.copyload, double %r.sroa.4.0.copyload, double %r.sroa.5.0.copyload, double %u.sroa.0.0.copyload, double %u.sroa.4.0.copyload, double %u.sroa.5.0.copyload, i32 noundef %6) #6
  br i1 %call13, label %if.then14, label %cleanup23

if.then14:                                        ; preds = %if.end8
  %7 = load i32, ptr %n_coord_, align 4, !tbaa !23
  %sub17 = add nsw i32 %7, -1
  %idxprom18 = sext i32 %sub17 to i64
  %cell.idx = mul nsw i64 %idxprom18, 80
  %gep210 = getelementptr i8, ptr %invariant.gep209, i64 %cell.idx
  store i32 %1, ptr %gep210, align 8, !tbaa !45
  br label %cleanup23

cleanup23:                                        ; preds = %if.then14, %if.end8, %if.end
  %cleanup.dest.slot.1 = phi i32 [ 4, %if.end ], [ 2, %if.then14 ], [ 0, %if.end8 ]
  %found.2.off0 = phi i1 [ %found.0.off0208, %if.end ], [ true, %if.then14 ], [ %found.0.off0208, %if.end8 ]
  switch i32 %cleanup.dest.slot.1, label %cleanup24 [
    i32 0, label %for.inc
    i32 4, label %for.inc
  ]

for.inc:                                          ; preds = %cleanup23, %cleanup23
  %inc = add nuw nsw i64 %i.0207, 1
  %exitcond.not = icmp eq i64 %inc, 50
  br i1 %exitcond.not, label %cleanup24, label %for.body, !llvm.loop !98

cleanup24:                                        ; preds = %for.inc, %cleanup23, %for.body
  %found.3.off0 = phi i1 [ %found.2.off0, %cleanup23 ], [ %found.2.off0, %for.inc ], [ %found.0.off0208, %for.body ]
  br i1 %found.3.off0, label %if.end28, label %cleanup291

if.end28:                                         ; preds = %cleanup24, %entry
  %i_cell.2 = phi i32 [ %1, %cleanup24 ], [ -1, %entry ]
  %coord_33 = getelementptr inbounds nuw i8, ptr %p, i64 888
  %n_coord_34 = getelementptr inbounds nuw i8, ptr %p, i64 876
  %invariant.gep227 = getelementptr inbounds nuw i8, ptr %p, i64 940
  %8 = getelementptr inbounds nuw i8, ptr %p, i64 912
  %invariant.gep213 = getelementptr inbounds nuw i8, ptr %p, i64 936
  %surface_82 = getelementptr inbounds nuw i8, ptr %p, i64 1592
  ...
  %arrayinit.element155 = getelementptr inbounds nuw i8, ptr addrspace(5) %i_xyz, i32 8
  %cell_instance_ = getelementptr inbounds nuw i8, ptr %p, i64 880
  %material_ = getelementptr inbounds nuw i8, ptr %p, i64 1600
  %material_last_ = getelementptr inbounds nuw i8, ptr %p, i64 1604
  %sqrtkT_ = getelementptr inbounds nuw i8, ptr %p, i64 1640
  %sqrtkT_last_ = getelementptr inbounds nuw i8, ptr %p, i64 1648
  br label %for.cond29

for.cond29:                                       ; preds = %for.inc288, %if.end28
  %i_cell.3 = phi i32 [ %i_cell.2, %if.end28 ], [ %i_cell.7, %for.inc288 ]
  %found.5.off0 = phi i1 [ %tobool.not, %if.end28 ], [ true, %for.inc288 ]
  %cmp30 = icmp eq i32 %i_cell.3, -1
  br i1 %cmp30, label %if.then31, label %if.end108

if.then31:                                        ; preds = %for.cond29
  %9 = load i32, ptr %n_coord_34, align 4, !tbaa !23
  %sub35 = add nsw i32 %9, -1
  %idxprom36 = sext i32 %sub35 to i64
  %universe38.idx = mul nsw i64 %idxprom36, 80
  %gep228 = getelementptr i8, ptr %invariant.gep227, i64 %universe38.idx
  %10 = load i32, ptr %gep228, align 4, !tbaa !50
  %11 = load ptr, ptr addrspace(1) @_ZN6openmc5model16device_universesE, align 8, !tbaa !66
  %idxprom39 = sext i32 %10 to i64
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %ncells) #7
  %partitioner_ = getelementptr inbounds %"class.openmc::Universe", ptr %11, i64 %idxprom39, i32 2
  %12 = load ptr, ptr %partitioner_, align 8, !tbaa !68
  %tobool41.not = icmp eq ptr %12, null
  br i1 %tobool41.not, label %if.then42, label %if.else

if.then42:                                        ; preds = %if.then31
  %cells_ = getelementptr inbounds %"class.openmc::Universe", ptr %11, i64 %idxprom39, i32 1
  %13 = load ptr, ptr %cells_, align 8, !tbaa !71
  %size_.i = getelementptr inbounds nuw i8, ptr %cells_, i64 8
  %14 = load i64, ptr %size_.i, align 8, !tbaa !72
  %conv = trunc i64 %14 to i32
  store i32 %conv, ptr addrspace(5) %ncells, align 4, !tbaa !49
  br label %if.end56

if.else:                                          ; preds = %if.then31
  %arrayidx.i155 = getelementptr inbounds [6 x %"class.openmc::LocalCoord"], ptr %coord_33, i64 0, i64 %idxprom36
  %agg.tmp51.sroa.0.0.copyload = load double, ptr %arrayidx.i155, align 8, !tbaa !62
  %agg.tmp51.sroa.2.0.call52.sroa_idx = getelementptr inbounds nuw i8, ptr %arrayidx.i155, i64 8
  %agg.tmp51.sroa.2.0.copyload = load double, ptr %agg.tmp51.sroa.2.0.call52.sroa_idx, align 8, !tbaa !62
  %agg.tmp51.sroa.3.0.call52.sroa_idx = getelementptr inbounds nuw i8, ptr %arrayidx.i155, i64 16
  %agg.tmp51.sroa.3.0.copyload = load double, ptr %agg.tmp51.sroa.3.0.call52.sroa_idx, align 8, !tbaa !62
  %u.i160 = getelementptr i8, ptr %8, i64 %universe38.idx
  %agg.tmp53.sroa.0.0.copyload = load double, ptr %u.i160, align 8, !tbaa !62
  %agg.tmp53.sroa.2.0.call54.sroa_idx = getelementptr inbounds nuw i8, ptr %u.i160, i64 8
  %agg.tmp53.sroa.2.0.copyload = load double, ptr %agg.tmp53.sroa.2.0.call54.sroa_idx, align 8, !tbaa !62
  %agg.tmp53.sroa.3.0.call54.sroa_idx = getelementptr inbounds nuw i8, ptr %u.i160, i64 16
  %agg.tmp53.sroa.3.0.copyload = load double, ptr %agg.tmp53.sroa.3.0.call54.sroa_idx, align 8, !tbaa !62
  %call55 = call noundef ptr @_ZNK6openmc19UniversePartitioner9get_cellsENS_8PositionES1_Ri(ptr noundef nonnull align 8 dereferenceable(72) %12, double %agg.tmp51.sroa.0.0.copyload, double %agg.tmp51.sroa.2.0.copyload, double %agg.tmp51.sroa.3.0.copyload, double %agg.tmp53.sroa.0.0.copyload, double %agg.tmp53.sroa.2.0.copyload, double %agg.tmp53.sroa.3.0.copyload, ptr noundef nonnull align 4 dereferenceable(4) %ncells.ascast) #6
  %.pre = load i32, ptr addrspace(5) %ncells, align 4, !tbaa !49
  br label %if.end56

if.end56:                                         ; preds = %if.else, %if.then42
  %15 = phi i32 [ %.pre, %if.else ], [ %conv, %if.then42 ]
  %cells.0 = phi ptr [ %call55, %if.else ], [ %13, %if.then42 ]
  %cmp59215 = icmp sgt i32 %15, 0
  br i1 %cmp59215, label %for.body61.preheader, label %cleanup106

for.body61.preheader:                             ; preds = %if.end56
  %.pre230 = load ptr, ptr addrspace(1) @_ZN6openmc5model12device_cellsE, align 8, !tbaa !47
  br label %for.body61

for.body61:                                       ; preds = %for.inc104, %for.body61.preheader
  %16 = phi ptr [ %23, %for.inc104 ], [ %.pre230, %for.body61.preheader ]
  %found.6.off0217 = phi i1 [ %found.8.off0, %for.inc104 ], [ %found.5.off0, %for.body61.preheader ]
  %i57.0216 = phi i32 [ %inc105, %for.inc104 ], [ 0, %for.body61.preheader ]
  %idxprom62 = zext nneg i32 %i57.0216 to i64
  %arrayidx63 = getelementptr inbounds nuw i32, ptr %cells.0, i64 %idxprom62
  %17 = load i32, ptr %arrayidx63, align 4, !tbaa !49
  %18 = load i32, ptr %n_coord_34, align 4, !tbaa !23
  %sub67 = add nsw i32 %18, -1
  %idxprom68 = sext i32 %sub67 to i64
  %universe70.idx = mul nsw i64 %idxprom68, 80
  %gep212 = getelementptr i8, ptr %invariant.gep227, i64 %universe70.idx
  %19 = load i32, ptr %gep212, align 4, !tbaa !50
  %idxprom71 = sext i32 %17 to i64
  %universe_73 = getelementptr inbounds %"class.openmc::Cell", ptr %16, i64 %idxprom71, i32 3
  %20 = load i32, ptr %universe_73, align 4, !tbaa !51
  %cmp74.not = icmp eq i32 %20, %19
  br i1 %cmp74.not, label %if.end76, label %cleanup101

if.end76:                                         ; preds = %for.body61
  %arrayidx.i165 = getelementptr inbounds [6 x %"class.openmc::LocalCoord"], ptr %coord_33, i64 0, i64 %idxprom68
  %r77.sroa.0.0.copyload = load double, ptr %arrayidx.i165, align 8, !tbaa !62
  %r77.sroa.4.0.call78.sroa_idx = getelementptr inbounds nuw i8, ptr %arrayidx.i165, i64 8
  %r77.sroa.4.0.copyload = load double, ptr %r77.sroa.4.0.call78.sroa_idx, align 8, !tbaa !62
  %r77.sroa.5.0.call78.sroa_idx = getelementptr inbounds nuw i8, ptr %arrayidx.i165, i64 16
  %r77.sroa.5.0.copyload = load double, ptr %r77.sroa.5.0.call78.sroa_idx, align 8, !tbaa !62
  %u.i170 = getelementptr i8, ptr %8, i64 %universe70.idx
  %u79.sroa.0.0.copyload = load double, ptr %u.i170, align 8, !tbaa !62
  %u79.sroa.4.0.call80.sroa_idx = getelementptr inbounds nuw i8, ptr %u.i170, i64 8
  %u79.sroa.4.0.copyload = load double, ptr %u79.sroa.4.0.call80.sroa_idx, align 8, !tbaa !62
  %u79.sroa.5.0.call80.sroa_idx = getelementptr inbounds nuw i8, ptr %u.i170, i64 16
  %u79.sroa.5.0.copyload = load double, ptr %u79.sroa.5.0.call80.sroa_idx, align 8, !tbaa !62
  %21 = load i32, ptr %surface_82, align 8, !tbaa !63
  %arrayidx84 = getelementptr inbounds %"class.openmc::Cell", ptr %16, i64 %idxprom71
  %call87 = call noundef zeroext i1 @_ZNK6openmc4Cell8containsENS_8PositionES1_i(ptr noundef nonnull align 8 dereferenceable(496) %arrayidx84, double %r77.sroa.0.0.copyload, double %r77.sroa.4.0.copyload, double %r77.sroa.5.0.copyload, double %u79.sroa.0.0.copyload, double %u79.sroa.4.0.copyload, double %u79.sroa.5.0.copyload, i32 noundef %21) #6
  %.pre229 = load ptr, ptr addrspace(1) @_ZN6openmc5model12device_cellsE, align 8, !tbaa !47
  br i1 %call87, label %if.then89, label %cleanup101

if.then89:                                        ; preds = %if.end76
  %22 = load i32, ptr %n_coord_34, align 4, !tbaa !23
  %sub92 = add nsw i32 %22, -1
  %idxprom93 = sext i32 %sub92 to i64
  %cell95.idx = mul nsw i64 %idxprom93, 80
  %gep214 = getelementptr i8, ptr %invariant.gep213, i64 %cell95.idx
  store i32 %17, ptr %gep214, align 8, !tbaa !45
  br label %cleanup101

cleanup101:                                       ; preds = %if.then89, %if.end76, %for.body61
  %23 = phi ptr [ %16, %for.body61 ], [ %.pre229, %if.then89 ], [ %.pre229, %if.end76 ]
  %cleanup.dest.slot.3 = phi i32 [ 10, %for.body61 ], [ 8, %if.then89 ], [ 0, %if.end76 ]
  %found.8.off0 = phi i1 [ %found.6.off0217, %for.body61 ], [ true, %if.then89 ], [ %found.6.off0217, %if.end76 ]
  switch i32 %cleanup.dest.slot.3, label %cleanup106 [
    i32 0, label %for.inc104
    i32 10, label %for.inc104
  ]

for.inc104:                                       ; preds = %cleanup101, %cleanup101
  %inc105 = add nuw nsw i32 %i57.0216, 1
  %24 = load i32, ptr addrspace(5) %ncells, align 4, !tbaa !49
  %cmp59 = icmp slt i32 %inc105, %24
  br i1 %cmp59, label %for.body61, label %cleanup106, !llvm.loop !99

cleanup106:                                       ; preds = %for.inc104, %cleanup101, %if.end56
  %i_cell.5 = phi i32 [ -1, %if.end56 ], [ %17, %for.inc104 ], [ %17, %cleanup101 ]
  %found.9.off0 = phi i1 [ %found.5.off0, %if.end56 ], [ %found.8.off0, %for.inc104 ], [ %found.8.off0, %cleanup101 ]
  call void @llvm.lifetime.end.p5(i64 4, ptr addrspace(5) %ncells) #7
  br label %if.end108

if.end108:                                        ; preds = %cleanup106, %for.cond29
  %i_cell.6 = phi i32 [ %i_cell.5, %cleanup106 ], [ %i_cell.3, %for.cond29 ]
  %found.10.off0 = phi i1 [ %found.9.off0, %cleanup106 ], [ %found.5.off0, %for.cond29 ]
  br i1 %found.10.off0, label %if.end112, label %cleanup291

if.end112:                                        ; preds = %if.end108
  %25 = load ptr, ptr addrspace(1) @_ZN6openmc5model12device_cellsE, align 8, !tbaa !47
  %idxprom113 = sext i32 %i_cell.6 to i64
  %arrayidx114 = getelementptr inbounds %"class.openmc::Cell", ptr %25, i64 %idxprom113
  %type_ = getelementptr inbounds nuw i8, ptr %arrayidx114, i64 40
  %26 = load i32, ptr %type_, align 8, !tbaa !74
  %cmp115.not = icmp eq i32 %26, 0
  br i1 %cmp115.not, label %if.then116, label %if.else202

if.then116:                                       ; preds = %if.end112
  %distribcell_index_ = getelementptr inbounds nuw i8, ptr %arrayidx114, i64 56
  %27 = load i32, ptr %distribcell_index_, align 8, !tbaa !75
  %cmp117 = icmp sgt i32 %27, -1
  %28 = load i32, ptr %n_coord_34, align 4
  %cmp122221 = icmp sgt i32 %28, 0
  %or.cond = select i1 %cmp117, i1 %cmp122221, i1 false
  br i1 %or.cond, label %for.body124, label %if.end173

for.body124:                                      ; preds = %if.end168, %if.then116
  %29 = phi i32 [ %43, %if.end168 ], [ %28, %if.then116 ]
  %offset.0223 = phi i32 [ %offset.2, %if.end168 ], [ 0, %if.then116 ]
  %i119.0222 = phi i32 [ %inc170, %if.end168 ], [ 0, %if.then116 ]
  %30 = load ptr, ptr addrspace(1) @_ZN6openmc5model12device_cellsE, align 8, !tbaa !47
  %idxprom126 = zext nneg i32 %i119.0222 to i64
  %cell128.idx = mul nuw nsw i64 %idxprom126, 80
  %gep226 = getelementptr inbounds nuw i8, ptr %invariant.gep213, i64 %cell128.idx
  %31 = load i32, ptr %gep226, align 8, !tbaa !45
  %idxprom129 = sext i32 %31 to i64
  %arrayidx130 = getelementptr inbounds %"class.openmc::Cell", ptr %30, i64 %idxprom129
  %type_131 = getelementptr inbounds nuw i8, ptr %arrayidx130, i64 40
  %32 = load i32, ptr %type_131, align 8, !tbaa !74
  switch i32 %32, label %if.end168 [
    i32 1, label %if.then133
    i32 2, label %if.then140
  ]

if.then133:                                       ; preds = %for.body124
  %offset_ = getelementptr inbounds nuw i8, ptr %arrayidx130, i64 472
  %33 = load i32, ptr %distribcell_index_, align 8, !tbaa !75
  %conv135 = sext i32 %33 to i64
  %34 = load ptr, ptr %offset_, align 8, !tbaa !71
  %arrayidx.i171 = getelementptr inbounds nuw i32, ptr %34, i64 %conv135
  %35 = load i32, ptr %arrayidx.i171, align 4, !tbaa !49
  %add = add nsw i32 %35, %offset.0223
  br label %if.end168

if.then140:                                       ; preds = %for.body124
  %36 = load ptr, ptr addrspace(1) @_ZN6openmc5model15device_latticesE, align 8, !tbaa !76
  %add142 = add nuw nsw i32 %i119.0222, 1
  %idxprom143 = zext nneg i32 %add142 to i64
  %arrayidx144 = getelementptr inbounds nuw [6 x %"class.openmc::LocalCoord"], ptr %coord_33, i64 0, i64 %idxprom143
  %lattice = getelementptr inbounds nuw i8, ptr %arrayidx144, i64 56
  %37 = load i32, ptr %lattice, align 8, !tbaa !78
  %idxprom145 = sext i32 %37 to i64
  %arrayidx146 = getelementptr inbounds %"class.openmc::Lattice", ptr %36, i64 %idxprom145
  call void @llvm.lifetime.start.p5(i64 12, ptr addrspace(5) %i_xyz) #7
  %lattice_x = getelementptr inbounds nuw i8, ptr %arrayidx144, i64 60
  %38 = load i32, ptr %lattice_x, align 4, !tbaa !79
  store i32 %38, ptr addrspace(5) %i_xyz, align 4, !tbaa !49
  %lattice_y = getelementptr inbounds nuw i8, ptr %arrayidx144, i64 64
  %39 = load i32, ptr %lattice_y, align 8, !tbaa !80
  store i32 %39, ptr addrspace(5) %arrayinit.element, align 4, !tbaa !49
  %lattice_z = getelementptr inbounds nuw i8, ptr %arrayidx144, i64 68
  %40 = load i32, ptr %lattice_z, align 4, !tbaa !81
  store i32 %40, ptr addrspace(5) %arrayinit.element155, align 4, !tbaa !49
  %call160 = call noundef zeroext i1 @_ZNK6openmc7Lattice17are_valid_indicesEPKi(ptr noundef nonnull align 8 dereferenceable(209) %arrayidx146, ptr noundef nonnull %i_xyz.ascast) #6
  br i1 %call160, label %if.then161, label %if.end166

if.then161:                                       ; preds = %if.then140
  %41 = load i32, ptr %distribcell_index_, align 8, !tbaa !75
  %call164 = call noundef nonnull align 4 dereferenceable(4) ptr @_ZN6openmc7Lattice6offsetEiPKi(ptr noundef nonnull align 8 dereferenceable(209) %arrayidx146, i32 noundef %41, ptr noundef nonnull %i_xyz.ascast) #6
  %42 = load i32, ptr %call164, align 4, !tbaa !49
  %add165 = add nsw i32 %42, %offset.0223
  br label %if.end166

if.end166:                                        ; preds = %if.then161, %if.then140
  %offset.1 = phi i32 [ %add165, %if.then161 ], [ %offset.0223, %if.then140 ]
  call void @llvm.lifetime.end.p5(i64 12, ptr addrspace(5) %i_xyz) #7
  %.pre231 = load i32, ptr %n_coord_34, align 4, !tbaa !23
  br label %if.end168

if.end168:                                        ; preds = %if.end166, %if.then133, %for.body124
  %43 = phi i32 [ %29, %if.then133 ], [ %.pre231, %if.end166 ], [ %29, %for.body124 ]
  %offset.2 = phi i32 [ %add, %if.then133 ], [ %offset.1, %if.end166 ], [ %offset.0223, %for.body124 ]
  %inc170 = add nuw nsw i32 %i119.0222, 1
  %cmp122 = icmp slt i32 %inc170, %43
  br i1 %cmp122, label %for.body124, label %if.end173, !llvm.loop !100

if.end173:                                        ; preds = %if.end168, %if.then116
  %offset.3 = phi i32 [ 0, %if.then116 ], [ %offset.2, %if.end168 ]
  store i32 %offset.3, ptr %cell_instance_, align 8, !tbaa !83
  %44 = load i32, ptr %material_, align 8, !tbaa !84
  store i32 %44, ptr %material_last_, align 4, !tbaa !85
  %material_174 = getelementptr inbounds nuw i8, ptr %arrayidx114, i64 64
  %size_.i172 = getelementptr inbounds nuw i8, ptr %arrayidx114, i64 72
  %45 = load i64, ptr %size_.i172, align 8, !tbaa !72
  %cmp176 = icmp ugt i64 %45, 1
  br i1 %cmp176, label %if.then177, label %if.else183

if.then177:                                       ; preds = %if.end173
  %conv180 = sext i32 %offset.3 to i64
  %46 = load ptr, ptr %material_174, align 8, !tbaa !71
  %arrayidx.i173 = getelementptr inbounds nuw i32, ptr %46, i64 %conv180
  br label %if.end187

if.else183:                                       ; preds = %if.end173
  %47 = load ptr, ptr %material_174, align 8, !tbaa !71
  br label %if.end187

if.end187:                                        ; preds = %if.else183, %if.then177
  %storemerge.in = phi ptr [ %47, %if.else183 ], [ %arrayidx.i173, %if.then177 ]
  %storemerge = load i32, ptr %storemerge.in, align 4, !tbaa !49
  store i32 %storemerge, ptr %material_, align 8, !tbaa !84
  %48 = load double, ptr %sqrtkT_, align 8, !tbaa !86
  store double %48, ptr %sqrtkT_last_, align 8, !tbaa !87
  %sqrtkT_188 = getelementptr inbounds nuw i8, ptr %arrayidx114, i64 88
  %size_.i175 = getelementptr inbounds nuw i8, ptr %arrayidx114, i64 96
  %49 = load i64, ptr %size_.i175, align 8, !tbaa !88
  %cmp190 = icmp ugt i64 %49, 1
  br i1 %cmp190, label %if.then191, label %if.else197

if.then191:                                       ; preds = %if.end187
  %conv194 = sext i32 %offset.3 to i64
  %50 = load ptr, ptr %sqrtkT_188, align 8, !tbaa !89
  %arrayidx.i176 = getelementptr inbounds nuw double, ptr %50, i64 %conv194
  br label %if.end201

if.else197:                                       ; preds = %if.end187
  %51 = load ptr, ptr %sqrtkT_188, align 8, !tbaa !89
  br label %if.end201

if.end201:                                        ; preds = %if.else197, %if.then191
  %storemerge147.in = phi ptr [ %51, %if.else197 ], [ %arrayidx.i176, %if.then191 ]
  %storemerge147 = load double, ptr %storemerge147.in, align 8, !tbaa !62
  store double %storemerge147, ptr %sqrtkT_, align 8, !tbaa !86
  br label %cleanup285

if.else202:                                       ; preds = %if.end112
  switch i32 %26, label %cleanup285 [
    i32 1, label %if.then205
    i32 2, label %if.then225
  ]

if.then205:                                       ; preds = %if.else202
  %52 = load i32, ptr %n_coord_34, align 4, !tbaa !23
  %idxprom208 = sext i32 %52 to i64
  %arrayidx209 = getelementptr inbounds [6 x %"class.openmc::LocalCoord"], ptr %coord_33, i64 0, i64 %idxprom208
  %fill_ = getelementptr inbounds nuw i8, ptr %arrayidx114, i64 48
  %53 = load i32, ptr %fill_, align 8, !tbaa !90
  %universe210 = getelementptr inbounds nuw i8, ptr %arrayidx209, i64 52
  store i32 %53, ptr %universe210, align 4, !tbaa !50
  %sub.i180 = add nsw i32 %52, -1
  %idxprom.i181 = sext i32 %sub.i180 to i64
  %arrayidx.i182 = getelementptr inbounds [6 x %"class.openmc::LocalCoord"], ptr %coord_33, i64 0, i64 %idxprom.i181
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %arrayidx209, ptr noundef nonnull align 8 dereferenceable(24) %arrayidx.i182, i64 24, i1 false), !tbaa.struct !91
  %u.idx.i186 = mul nsw i64 %idxprom.i181, 80
  %u.i187 = getelementptr i8, ptr %8, i64 %u.idx.i186
  %u214 = getelementptr inbounds nuw i8, ptr %arrayidx209, i64 24
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %u214, ptr noundef nonnull align 8 dereferenceable(24) %u.i187, i64 24, i1 false), !tbaa.struct !91
  %translation_ = getelementptr inbounds nuw i8, ptr %arrayidx114, i64 344
  %agg.tmp215.sroa.0.0.copyload = load double, ptr %translation_, align 8, !tbaa !62
  %agg.tmp215.sroa.2.0.translation_.sroa_idx = getelementptr inbounds nuw i8, ptr %arrayidx114, i64 352
  %agg.tmp215.sroa.2.0.copyload = load double, ptr %agg.tmp215.sroa.2.0.translation_.sroa_idx, align 8, !tbaa !62
  %agg.tmp215.sroa.3.0.translation_.sroa_idx = getelementptr inbounds nuw i8, ptr %arrayidx114, i64 360
  %agg.tmp215.sroa.3.0.copyload = load double, ptr %agg.tmp215.sroa.3.0.translation_.sroa_idx, align 8, !tbaa !62
  %call217 = call noundef nonnull align 8 dereferenceable(24) ptr @_ZN6openmc8PositionmIES0_(ptr noundef nonnull align 8 dereferenceable(24) %arrayidx209, double %agg.tmp215.sroa.0.0.copyload, double %agg.tmp215.sroa.2.0.copyload, double %agg.tmp215.sroa.3.0.copyload) #6
  %rotation_length_ = getelementptr inbounds nuw i8, ptr %arrayidx114, i64 464
  %54 = load i32, ptr %rotation_length_, align 8, !tbaa !92
  %cmp218.not = icmp eq i32 %54, 0
  br i1 %cmp218.not, label %cleanup285, label %if.then219

if.then219:                                       ; preds = %if.then205
  %rotation_ = getelementptr inbounds nuw i8, ptr %arrayidx114, i64 368
  call void @_ZN6openmc10LocalCoord6rotateEPKd(ptr noundef nonnull align 8 dereferenceable(73) %arrayidx209, ptr noundef nonnull %rotation_) #6
  br label %cleanup285

if.then225:                                       ; preds = %if.else202
  %55 = load ptr, ptr addrspace(1) @_ZN6openmc5model15device_latticesE, align 8, !tbaa !76
  %fill_227 = getelementptr inbounds nuw i8, ptr %arrayidx114, i64 48
  %56 = load i32, ptr %fill_227, align 8, !tbaa !90
  %idxprom228 = sext i32 %56 to i64
  %arrayidx229 = getelementptr inbounds %"class.openmc::Lattice", ptr %55, i64 %idxprom228
  %57 = load i32, ptr %n_coord_34, align 4, !tbaa !23
  %idxprom233 = sext i32 %57 to i64
  %arrayidx234 = getelementptr inbounds [6 x %"class.openmc::LocalCoord"], ptr %coord_33, i64 0, i64 %idxprom233
  %sub.i190 = add nsw i32 %57, -1
  %idxprom.i191 = sext i32 %sub.i190 to i64
  %arrayidx.i192 = getelementptr inbounds [6 x %"class.openmc::LocalCoord"], ptr %coord_33, i64 0, i64 %idxprom.i191
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %arrayidx234, ptr noundef nonnull align 8 dereferenceable(24) %arrayidx.i192, i64 24, i1 false), !tbaa.struct !91
  %u.idx.i196 = mul nsw i64 %idxprom.i191, 80
  %u.i197 = getelementptr i8, ptr %8, i64 %u.idx.i196
  %u238 = getelementptr inbounds nuw i8, ptr %arrayidx234, i64 24
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %u238, ptr noundef nonnull align 8 dereferenceable(24) %u.i197, i64 24, i1 false), !tbaa.struct !91
  %translation_240 = getelementptr inbounds nuw i8, ptr %arrayidx114, i64 344
  %agg.tmp239.sroa.0.0.copyload = load double, ptr %translation_240, align 8, !tbaa !62
  %agg.tmp239.sroa.2.0.translation_240.sroa_idx = getelementptr inbounds nuw i8, ptr %arrayidx114, i64 352
  %agg.tmp239.sroa.2.0.copyload = load double, ptr %agg.tmp239.sroa.2.0.translation_240.sroa_idx, align 8, !tbaa !62
  %agg.tmp239.sroa.3.0.translation_240.sroa_idx = getelementptr inbounds nuw i8, ptr %arrayidx114, i64 360
  %agg.tmp239.sroa.3.0.copyload = load double, ptr %agg.tmp239.sroa.3.0.translation_240.sroa_idx, align 8, !tbaa !62
  %call242 = call noundef nonnull align 8 dereferenceable(24) ptr @_ZN6openmc8PositionmIES0_(ptr noundef nonnull align 8 dereferenceable(24) %arrayidx234, double %agg.tmp239.sroa.0.0.copyload, double %agg.tmp239.sroa.2.0.copyload, double %agg.tmp239.sroa.3.0.copyload) #6
  %rotation_length_243 = getelementptr inbounds nuw i8, ptr %arrayidx114, i64 464
  %58 = load i32, ptr %rotation_length_243, align 8, !tbaa !92
  %cmp244.not = icmp eq i32 %58, 0
  br i1 %cmp244.not, label %if.end248, label %if.then245

if.then245:                                       ; preds = %if.then225
  %rotation_246 = getelementptr inbounds nuw i8, ptr %arrayidx114, i64 368
  call void @_ZN6openmc10LocalCoord6rotateEPKd(ptr noundef nonnull align 8 dereferenceable(73) %arrayidx234, ptr noundef nonnull %rotation_246) #6
  br label %if.end248

if.end248:                                        ; preds = %if.then245, %if.then225
  %agg.tmp250.sroa.0.0.copyload = load double, ptr %arrayidx234, align 8, !tbaa !62
  %agg.tmp250.sroa.2.0.r251.sroa_idx = getelementptr inbounds nuw i8, ptr %arrayidx234, i64 8
  %agg.tmp250.sroa.2.0.copyload = load double, ptr %agg.tmp250.sroa.2.0.r251.sroa_idx, align 8, !tbaa !62
  %agg.tmp250.sroa.3.0.r251.sroa_idx = getelementptr inbounds nuw i8, ptr %arrayidx234, i64 16
  %agg.tmp250.sroa.3.0.copyload = load double, ptr %agg.tmp250.sroa.3.0.r251.sroa_idx, align 8, !tbaa !62
  %agg.tmp252.sroa.0.0.copyload = load double, ptr %u238, align 8, !tbaa !62
  %agg.tmp252.sroa.2.0.u253.sroa_idx = getelementptr inbounds nuw i8, ptr %arrayidx234, i64 32
  %agg.tmp252.sroa.2.0.copyload = load double, ptr %agg.tmp252.sroa.2.0.u253.sroa_idx, align 8, !tbaa !62
  %agg.tmp252.sroa.3.0.u253.sroa_idx = getelementptr inbounds nuw i8, ptr %arrayidx234, i64 40
  %agg.tmp252.sroa.3.0.copyload = load double, ptr %agg.tmp252.sroa.3.0.u253.sroa_idx, align 8, !tbaa !62
  %call254 = call %"struct.std::array.0" @_ZNK6openmc7Lattice11get_indicesENS_8PositionES1_(ptr noundef nonnull align 8 dereferenceable(209) %arrayidx229, double %agg.tmp250.sroa.0.0.copyload, double %agg.tmp250.sroa.2.0.copyload, double %agg.tmp250.sroa.3.0.copyload, double %agg.tmp252.sroa.0.0.copyload, double %agg.tmp252.sroa.2.0.copyload, double %agg.tmp252.sroa.3.0.copyload) #6
  %59 = extractvalue %"struct.std::array.0" %call254, 0
  %.fca.0.extract = extractvalue [3 x i32] %59, 0
  %.fca.1.extract = extractvalue [3 x i32] %59, 1
  %.fca.2.extract = extractvalue [3 x i32] %59, 2
  %agg.tmp255.sroa.0.0.copyload = load double, ptr %arrayidx234, align 8, !tbaa !62
  %agg.tmp255.sroa.2.0.copyload = load double, ptr %agg.tmp250.sroa.2.0.r251.sroa_idx, align 8, !tbaa !62
  %agg.tmp255.sroa.3.0.copyload = load double, ptr %agg.tmp250.sroa.3.0.r251.sroa_idx, align 8, !tbaa !62
  %call258 = call %"struct.openmc::Position" @_ZNK6openmc7Lattice18get_local_positionENS_8PositionESt5arrayIiLm3EE(ptr noundef nonnull align 8 dereferenceable(209) %arrayidx229, double %agg.tmp255.sroa.0.0.copyload, double %agg.tmp255.sroa.2.0.copyload, double %agg.tmp255.sroa.3.0.copyload, [3 x i32] %59) #6
  %60 = extractvalue %"struct.openmc::Position" %call258, 0
  %61 = extractvalue %"struct.openmc::Position" %call258, 1
  %62 = extractvalue %"struct.openmc::Position" %call258, 2
  store double %60, ptr %arrayidx234, align 8, !tbaa !62
  store double %61, ptr %agg.tmp250.sroa.2.0.r251.sroa_idx, align 8, !tbaa !62
  store double %62, ptr %agg.tmp250.sroa.3.0.r251.sroa_idx, align 8, !tbaa !62
  %63 = load i32, ptr %fill_227, align 8, !tbaa !90
  %lattice261 = getelementptr inbounds nuw i8, ptr %arrayidx234, i64 56
  store i32 %63, ptr %lattice261, align 8, !tbaa !78
  %lattice_x263 = getelementptr inbounds nuw i8, ptr %arrayidx234, i64 60
  store i32 %.fca.0.extract, ptr %lattice_x263, align 4, !tbaa !79
  %lattice_y265 = getelementptr inbounds nuw i8, ptr %arrayidx234, i64 64
  store i32 %.fca.1.extract, ptr %lattice_y265, align 8, !tbaa !80
  %lattice_z267 = getelementptr inbounds nuw i8, ptr %arrayidx234, i64 68
  store i32 %.fca.2.extract, ptr %lattice_z267, align 4, !tbaa !81
  call void @llvm.lifetime.start.p5(i64 12, ptr addrspace(5) %i_xyz_.i) #7
  store i32 %.fca.0.extract, ptr addrspace(5) %i_xyz_.i, align 4, !tbaa !49
  store i32 %.fca.1.extract, ptr addrspace(5) %arrayinit.element.i, align 4, !tbaa !49
  store i32 %.fca.2.extract, ptr addrspace(5) %arrayinit.element4.i, align 4, !tbaa !49
  %call6.i = call noundef zeroext i1 @_ZNK6openmc7Lattice17are_valid_indicesEPKi(ptr noundef nonnull align 8 dereferenceable(209) %arrayidx229, ptr noundef nonnull %i_xyz_.ascast.i) #6
  call void @llvm.lifetime.end.p5(i64 12, ptr addrspace(5) %i_xyz_.i) #7
  br i1 %call6.i, label %if.then270, label %if.else274

if.then270:                                       ; preds = %if.end248
  %call272 = call noundef nonnull align 4 dereferenceable(4) ptr @_ZN6openmc7LatticeixESt5arrayIiLm3EE(ptr noundef nonnull align 8 dereferenceable(209) %arrayidx229, [3 x i32] %59) #6
  %64 = load i32, ptr %call272, align 4, !tbaa !49
  %universe273 = getelementptr inbounds nuw i8, ptr %arrayidx234, i64 52
  store i32 %64, ptr %universe273, align 4, !tbaa !50
  br label %cleanup285

if.else274:                                       ; preds = %if.end248
  %outer_ = getelementptr inbounds nuw i8, ptr %arrayidx229, i64 72
  %65 = load i32, ptr %outer_, align 8, !tbaa !93
  %cmp275.not = icmp eq i32 %65, -1
  br i1 %cmp275.not, label %if.else279, label %if.then276

if.then276:                                       ; preds = %if.else274
  %universe278 = getelementptr inbounds nuw i8, ptr %arrayidx234, i64 52
  store i32 %65, ptr %universe278, align 4, !tbaa !50
  br label %cleanup285
...
cleanup285:                                       ; preds = %if.else279, %if.then276, %if.then270, %if.then219, %if.then205, %if.else202, %if.end201
  %i_cell.7 = phi i32 [ %i_cell.6, %if.end201 ], [ -1, %if.else202 ], [ -1, %if.then205 ], [ -1, %if.then219 ], [ -1, %if.then276 ], [ -1, %if.else279 ], [ -1, %if.then270 ]
  br i1 %cmp115.not, label %cleanup291, label %for.inc288

for.inc288:                                       ; preds = %cleanup285
  %66 = load i32, ptr %n_coord_34, align 4, !tbaa !23
  %inc290 = add nsw i32 %66, 1
  store i32 %inc290, ptr %n_coord_34, align 4, !tbaa !23
  br label %for.cond29, !llvm.loop !101

cleanup291:                                       ; preds = %cleanup285, %if.end108, %cleanup24
  %retval.2 = phi i1 [ false, %cleanup24 ], [ true, %cleanup285 ], [ false, %if.end108 ]
  ret i1 %retval.2
}
...
for.inc104.i:                                     ; preds = %cleanup101.i, %cleanup101.i
  ...
  br i1 %cmp59.i, label %for.body61.i, label %cleanup106.i, !llvm.loop !99
...
if.end168.i:                                      ; preds = %if.end166.i, %if.then133.i, %for.body124.i
  ...
  br i1 %cmp122.i, label %for.body124.i, label %if.end173.i, !llvm.loop !100
...
for.inc288.i:                                     ; preds = %cleanup285.i
  ...
  %inc290.i = add nsw i32 %63, 1
  store i32 %inc290.i, ptr %n_coord_, align 4, !tbaa !23
  br label %for.cond29.i, !llvm.loop !101
...
for.body:                                         ; preds = %for.body, %if.end
  ...
  br i1 %cmp6, label %for.body, label %for.cond.cleanup, !llvm.loop !102
}
...
for.body.i309:                                    ; preds = %for.body.i309, %if.end.i54
  ...
  br i1 %cmp6.i314, label %for.body.i309, label %for.cond.cleanup.i56, !llvm.loop !103
...
if.then:                                          ; preds = %for.body
  ...
  %13 = load i32, ptr %type_, align 8, !tbaa !104
...
sw.bb16:                                          ; preds = %if.then
  ...
  %16 = load i8, ptr %rotated, align 8, !tbaa !105, !range !106, !noundef !107
...
if.end:                                           ; preds = %if.then30, %sw.bb16.if.end_crit_edge
  ...
  %19 = load double, ptr %r.sroa.9.0.r1.sroa_idx, align 8, !tbaa !108
  store double %19, ptr addrspace(5) %ref.tmp31.sroa.5.0.r_hex.ascast.sroa_idx, align 8, !tbaa !109
...
if.then53:                                        ; preds = %lor.lhs.false, %if.then49
  ...
  %20 = load i8, ptr %simple_, align 8, !tbaa !110, !range !106, !noundef !107
...
if.else:                                          ; preds = %if.then53
  ...
  %21 = load ptr, ptr addrspace(1) @_ZN6openmc5model15device_surfacesE, align 8, !tbaa !111
...
!110 = !{!52, !34, i64 136}
!111 = !{!112, !112, i64 0}
!112 = !{!"p1 _ZTSN6openmc7SurfaceE", !39, i64 0}
!113 = distinct !{!113, !65}
