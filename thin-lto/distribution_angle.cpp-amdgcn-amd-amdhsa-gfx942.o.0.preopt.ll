; ModuleID = 'distribution_angle.cpp-amdgcn-amd-amdhsa-gfx942.o.0.preopt.bc'
...
; Function Attrs: convergent mustprogress nounwind
define hidden %"class.openmc::TabularFlat" @_ZNK6openmc21AngleDistributionFlat12distributionEl(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(16) %this, i64 noundef %i) local_unnamed_addr #4 align 2 {
entry:
  ...
  call void @_ZN6openmc11TabularFlatC1EPKh(ptr noundef nonnull align 8 dereferenceable(16) %retval.ascast, ptr noundef %add.ptr4) #8
