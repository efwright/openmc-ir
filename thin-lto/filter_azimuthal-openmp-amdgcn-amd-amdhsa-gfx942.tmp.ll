; ModuleID = 'filter_azimuthal-openmp-amdgcn-amd-amdhsa-gfx942.tmp.bc'
...
cond.true:                                        ; preds = %entry
  ...
  %call = call noundef nonnull align 8 dereferenceable(24) ptr @_ZNK6openmc8Particle1uEv(ptr noundef nonnull align 8 dereferenceable(2728) %1) #12
  br label %cond.end

cond.false:                                       ; preds = %entry
  %2 = load ptr, ptr %p.addr.ascast, align 8, !tbaa !25
  %u_last_ = getelementptr inbounds nuw %"class.openmc::Particle", ptr %2, i32 0, i32 19
  br label %cond.end

cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi ptr [ %call, %cond.true ], [ %u_last_, %cond.false ]
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %u.ascast, ptr align 8 %cond, i64 24, i1 false), !tbaa.struct !31
  ...
  %3 = load double, ptr %y, align 8, !tbaa !32
  %x = getelementptr inbounds nuw %"struct.openmc::Position", ptr %u.ascast, i32 0, i32 0
  %4 = load double, ptr %x, align 8, !tbaa !34
  %call2 = call noundef double @"_ZL30atan2$ompvariant$S2$s7$Pamdgcndd"(double noundef %3, double noundef %4) #13
  store double %call2, ptr %phi.ascast, align 8, !tbaa !14
  %5 = load double, ptr %phi.ascast, align 8, !tbaa !14
  %bins_ = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 4
  %call3 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNK6openmc6vectorIdE5frontEv(ptr noundef nonnull align 8 dereferenceable(24) %bins_) #12
  %6 = load double, ptr %call3, align 8, !tbaa !14
  %cmp4 = fcmp oge double %5, %6
  br i1 %cmp4, label %land.lhs.true, label %if.end

land.lhs.true:                                    ; preds = %cond.end
  %7 = load double, ptr %phi.ascast, align 8, !tbaa !14
  %bins_5 = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 4
  %call6 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNK6openmc6vectorIdE4backEv(ptr noundef nonnull align 8 dereferenceable(24) %bins_5) #12
  %8 = load double, ptr %call6, align 8, !tbaa !14
  %cmp7 = fcmp ole double %7, %8
  br i1 %cmp7, label %if.then, label %if.end

if.then:                                          ; preds = %land.lhs.true
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %bin) #10
  %bins_8 = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 4
  %call9 = call noundef ptr @_ZNK6openmc6vectorIdE5beginEv(ptr noundef nonnull align 8 dereferenceable(24) %bins_8) #12
  %bins_10 = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 4
  %call11 = call noundef ptr @_ZNK6openmc6vectorIdE3endEv(ptr noundef nonnull align 8 dereferenceable(24) %bins_10) #12
  %call12 = call noundef i64 @_ZN6openmc17lower_bound_indexIPKddEENSt15iterator_traitsIT_E15difference_typeES4_S4_RKT0_(ptr noundef %call9, ptr noundef %call11, ptr noundef nonnull align 8 dereferenceable(8) %phi.ascast) #12
  store i64 %call12, ptr %bin.ascast, align 8, !tbaa !35
  %9 = load ptr, ptr %match.addr.ascast, align 8, !tbaa !29
  %10 = load i64, ptr %bin.ascast, align 8, !tbaa !35
  %conv = trunc i64 %10 to i32
  call void @_ZN6openmc11FilterMatch9push_backEid(ptr noundef nonnull align 8 dereferenceable(1513) %9, i32 noundef %conv, double noundef 1.000000e+00) #12
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %bin) #10
  br label %if.end
...
define internal noundef double @"_ZL30atan2$ompvariant$S2$s7$Pamdgcndd"(double noundef %__x, double noundef %__y) #5 {
entry:
  ...
  %call = call double @__ocml_atan2_f64(double noundef %0, double noundef %1) #11
  ret double %call
}
...
entry:
  ...
  %1 = load i64, ptr %size_, align 8, !tbaa !42
  %sub = sub i64 %1, 1
...
entry:
  ...
  store ptr %first, ptr %first.addr.ascast, align 8, !tbaa !43
  store ptr %last, ptr %last.addr.ascast, align 8, !tbaa !43
  store ptr %value, ptr %value.addr.ascast, align 8, !tbaa !43
  %0 = load ptr, ptr %first.addr.ascast, align 8, !tbaa !43
  %1 = load double, ptr %0, align 8, !tbaa !14
  %2 = load ptr, ptr %value.addr.ascast, align 8, !tbaa !43
...
if.end:                                           ; preds = %entry
  %4 = load ptr, ptr %first.addr.ascast, align 8, !tbaa !43
  %5 = load ptr, ptr %last.addr.ascast, align 8, !tbaa !43
  %6 = load ptr, ptr %value.addr.ascast, align 8, !tbaa !43
  ...
  %7 = load ptr, ptr %first.addr.ascast, align 8, !tbaa !43
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i32, ptr %bins_weights_length_, align 8, !tbaa !44
  ...
  %3 = load i32, ptr %bins_weights_length_2, align 8, !tbaa !44
  ...
  %4 = load i32, ptr %bins_weights_length_5, align 8, !tbaa !44
  %inc = add nsw i32 %4, 1
  store i32 %inc, ptr %bins_weights_length_5, align 8, !tbaa !44
  br label %if.end
...
entry:
  ...
  store ptr %__first, ptr %__first.addr.ascast, align 8, !tbaa !43
  store ptr %__last, ptr %__last.addr.ascast, align 8, !tbaa !43
  store ptr %__val, ptr %__val.addr.ascast, align 8, !tbaa !43
  %0 = load ptr, ptr %__first.addr.ascast, align 8, !tbaa !43
  %1 = load ptr, ptr %__last.addr.ascast, align 8, !tbaa !43
  %2 = load ptr, ptr %__val.addr.ascast, align 8, !tbaa !43
...
while.body:                                       ; preds = %while.cond
  ...
  %4 = load ptr, ptr %__first.addr.ascast, align 8, !tbaa !43
  store ptr %4, ptr %__middle.ascast, align 8, !tbaa !43
  ...
  %6 = load ptr, ptr %__middle.ascast, align 8, !tbaa !43
  %7 = load ptr, ptr %__val.addr.ascast, align 8, !tbaa !43
...
if.then:                                          ; preds = %while.body
  %8 = load ptr, ptr %__middle.ascast, align 8, !tbaa !43
  store ptr %8, ptr %__first.addr.ascast, align 8, !tbaa !43
  %9 = load ptr, ptr %__first.addr.ascast, align 8, !tbaa !43
  %incdec.ptr = getelementptr inbounds nuw double, ptr %9, i32 1
  store ptr %incdec.ptr, ptr %__first.addr.ascast, align 8, !tbaa !43
...
while.end:                                        ; preds = %while.cond
  %13 = load ptr, ptr %__first.addr.ascast, align 8, !tbaa !43
...
entry:
  ...
  store ptr %__it, ptr %__it.addr.ascast, align 8, !tbaa !43
  store ptr %__val, ptr %__val.addr.ascast, align 8, !tbaa !43
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  %0 = load ptr, ptr %__it.addr.ascast, align 8, !tbaa !43
  %1 = load double, ptr %0, align 8, !tbaa !14
  %2 = load ptr, ptr %__val.addr.ascast, align 8, !tbaa !43
  %3 = load double, ptr %2, align 8, !tbaa !14
...
entry:
  ...
  store ptr %__last, ptr %__last.addr.ascast, align 8, !tbaa !43
  %1 = load ptr, ptr %__last.addr.ascast, align 8, !tbaa !43
  %2 = load ptr, ptr %__first.addr.ascast, align 8, !tbaa !43
...
if.then:                                          ; preds = %land.lhs.true
  ...
  store ptr %incdec.ptr, ptr %4, align 8, !tbaa !43
  br label %if.end6
...
if.then3:                                         ; preds = %land.lhs.true1
  ...
  store ptr %incdec.ptr4, ptr %9, align 8, !tbaa !43
  br label %if.end
...
if.else5:                                         ; preds = %land.lhs.true1, %if.else
  ...
  store ptr %add.ptr, ptr %12, align 8, !tbaa !43
  br label %if.end
...
entry:
  ...
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  %bins_weights_length_ = getelementptr inbounds nuw %"class.openmc::FilterMatch", ptr %this1, i32 0, i32 3
  %0 = load i32, ptr %bins_weights_length_, align 8, !tbaa !44
...
define internal double @__ocml_atan2_f64(double noundef %0, double noundef %1) #8 {
  %3 = tail call double @llvm.fabs.f64(double %0)
  %4 = tail call double @llvm.fabs.f64(double %1)
  %5 = tail call double @llvm.maxnum.f64(double %4, double %3)
  %6 = tail call double @llvm.minnum.f64(double %4, double %3)
  %7 = fdiv double %6, %5
  %8 = tail call double @__ocmlpriv_atanred_f64(double noundef %7) #11
  ...
  %20 = load i8, ptr addrspace(4) @__oclc_finite_only_opt, align 1, !tbaa !54, !range !58, !noundef !59
  %21 = icmp eq i8 %20, 0
...
define internal double @__ocmlpriv_atanred_f64(double noundef %0) local_unnamed_addr #9 {
  %2 = fmul double %0, %0
...
!31 = !{i64 0, i64 8, !14, i64 8, i64 8, !14, i64 16, i64 8, !14}
!32 = !{!33, !15, i64 8}
!33 = !{!"_ZTSN6openmc8PositionE", !15, i64 0, !15, i64 8, !15, i64 16}
!34 = !{!33, !15, i64 0}
!35 = !{!36, !36, i64 0}
!36 = !{!"long", !16, i64 0}
!37 = !{!38, !38, i64 0}
!38 = !{!"p1 _ZTSN6openmc6vectorIdEE", !24, i64 0}
!39 = !{!40, !41, i64 0}
!40 = !{!"_ZTSN6openmc6vectorIdEE", !41, i64 0, !36, i64 8, !36, i64 16}
!41 = !{!"p1 double", !24, i64 0}
!42 = !{!40, !36, i64 8}
!43 = !{!41, !41, i64 0}
!44 = !{!45, !19, i64 1504}
!45 = !{!"_ZTSN6openmc11FilterMatchE", !16, i64 0, !16, i64 504, !19, i64 1504, !19, i64 1508, !46, i64 1512}
!46 = !{!"bool", !16, i64 0}
!47 = distinct !{!47, !48}
