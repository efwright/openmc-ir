; ModuleID = 'filter_mesh-openmp-amdgcn-amd-amdhsa-gfx942.tmp.bc'
...
@_ZN6openmc5model6meshesE = external addrspace(1) global ptr, align 8
...
entry:
  ...
  %bin = alloca i32, align 4, addrspace(5)
...
if.then:                                          ; preds = %entry
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %bin) #8
  %1 = load ptr, ptr addrspacecast (ptr addrspace(1) @_ZN6openmc5model6meshesE to ptr), align 8, !tbaa !31
  %mesh_ = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 19
  %2 = load i32, ptr %mesh_, align 8, !tbaa !33
  %idxprom = sext i32 %2 to i64
  %arrayidx = getelementptr inbounds %"class.openmc::Mesh", ptr %1, i64 %idxprom
  %3 = load ptr, ptr %p.addr.ascast, align 8, !tbaa !25
  %call = call noundef nonnull align 8 dereferenceable(24) ptr @_ZNK6openmc8Particle1rEv(ptr noundef nonnull align 8 dereferenceable(2728) %3) #10
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %agg.tmp.ascast, ptr align 8 %call, i64 24, i1 false), !tbaa.struct !57
  ...
  %call2 = call noundef i32 @_ZNK6openmc4Mesh7get_binENS_8PositionE(ptr noundef nonnull align 8 dereferenceable(112) %arrayidx, double %5, double %7, double %9) #10
  store i32 %call2, ptr %bin.ascast, align 4, !tbaa !18
  %10 = load i32, ptr %bin.ascast, align 4, !tbaa !18
  %cmp3 = icmp sge i32 %10, 0
  br i1 %cmp3, label %if.then4, label %if.end

if.then4:                                         ; preds = %if.then
  %11 = load ptr, ptr %match.addr.ascast, align 8, !tbaa !29
  %12 = load i32, ptr %bin.ascast, align 4, !tbaa !18
  call void @_ZN6openmc11FilterMatch9push_backEid(ptr noundef nonnull align 8 dereferenceable(1513) %11, i32 noundef %12, double noundef 1.000000e+00) #10
  br label %if.end

if.end:                                           ; preds = %if.then4, %if.then
  call void @llvm.lifetime.end.p5(i64 4, ptr addrspace(5) %bin) #8
  br label %if.end8

if.else:                                          ; preds = %entry
  %13 = load ptr, ptr addrspacecast (ptr addrspace(1) @_ZN6openmc5model6meshesE to ptr), align 8, !tbaa !31
  %mesh_5 = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 19
  %14 = load i32, ptr %mesh_5, align 8, !tbaa !33
  %idxprom6 = sext i32 %14 to i64
  %arrayidx7 = getelementptr inbounds %"class.openmc::Mesh", ptr %13, i64 %idxprom6
  %15 = load ptr, ptr %p.addr.ascast, align 8, !tbaa !25
  %16 = load ptr, ptr %match.addr.ascast, align 8, !tbaa !29
  call void @_ZNK6openmc4Mesh12bins_crossedERKNS_8ParticleERNS_11FilterMatchE(ptr noundef nonnull align 8 dereferenceable(112) %arrayidx7, ptr noundef nonnull align 8 dereferenceable(2728) %15, ptr noundef nonnull align 8 dereferenceable(1513) %16) #10
  br label %if.end8
...
declare noundef i32 @_ZNK6openmc4Mesh7get_binENS_8PositionE(ptr noundef nonnull align 8 dereferenceable(112), double, double, double) #4
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i32, ptr %bins_weights_length_, align 8, !tbaa !58
  ...
  %3 = load i32, ptr %bins_weights_length_2, align 8, !tbaa !58
  ...
  %4 = load i32, ptr %bins_weights_length_5, align 8, !tbaa !58
  %inc = add nsw i32 %4, 1
  store i32 %inc, ptr %bins_weights_length_5, align 8, !tbaa !58
  br label %if.end
...
; Function Attrs: convergent
declare void @_ZNK6openmc4Mesh12bins_crossedERKNS_8ParticleERNS_11FilterMatchE(ptr noundef nonnull align 8 dereferenceable(112), ptr noundef nonnull align 8 dereferenceable(2728), ptr noundef nonnull align 8 dereferenceable(1513)) #4
...
entry:
  ...
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  %bins_weights_length_ = getelementptr inbounds nuw %"class.openmc::FilterMatch", ptr %this1, i32 0, i32 3
  %0 = load i32, ptr %bins_weights_length_, align 8, !tbaa !58
...
define internal double @__ocml_logb_f64(double noundef %0) #6 {
  ...
  %5 = load i8, ptr addrspace(4) @__oclc_finite_only_opt, align 1, !tbaa !60, !range !64, !noundef !65
  %6 = icmp eq i8 %5, 0
...
!31 = !{!32, !32, i64 0}
!32 = !{!"p1 _ZTSN6openmc4MeshE", !24, i64 0}
!33 = !{!34, !19, i64 344}
...
!57 = !{i64 0, i64 8, !14, i64 8, i64 8, !14, i64 16, i64 8, !14}
!58 = !{!59, !19, i64 1504}
!59 = !{!"_ZTSN6openmc11FilterMatchE", !16, i64 0, !16, i64 504, !19, i64 1504, !19, i64 1508, !46, i64 1512}
!60 = !{!61, !61, i64 0}
!61 = !{!"bool", !62, i64 0}
