; ModuleID = 'endf_flat.cpp-amdgcn-amd-amdhsa-gfx942.o.0.preopt.bc'
...
sw.bb:                                            ; preds = %entry
  ...
  call void @llvm.lifetime.start.p5(i64 24, ptr addrspace(5) %dist) #6
  call void @_ZN6openmc15Tabulated1DFlatC1EPKh(ptr noundef nonnull align 8 dereferenceable(24) %dist.ascast, ptr noundef nonnull %0) #7
  %call2 = call noundef double @_ZNK6openmc15Tabulated1DFlatclEd(ptr noundef nonnull align 8 dereferenceable(24) %dist.ascast, double noundef %x) #7
  call void @llvm.lifetime.end.p5(i64 24, ptr addrspace(5) %dist) #6
  br label %return

sw.bb3:                                           ; preds = %entry
  %dist4.ascast = addrspacecast ptr addrspace(5) %dist4 to ptr
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %dist4) #6
  store ptr %0, ptr addrspace(5) %dist4, align 8, !tbaa !23
  %call6 = call noundef double @_ZNK6openmc14PolynomialFlatclEd(ptr noundef nonnull align 8 dereferenceable(8) %dist4.ascast, double noundef %x) #7
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %dist4) #6
  br label %return

sw.bb8:                                           ; preds = %entry
  %dist9.ascast = addrspacecast ptr addrspace(5) %dist9 to ptr
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %dist9) #6
  store ptr %0, ptr addrspace(5) %dist9, align 8, !tbaa !25
  %call11 = call noundef double @_ZNK6openmc21CoherentElasticXSFlatclEd(ptr noundef nonnull align 8 dereferenceable(8) %dist9.ascast, double noundef %x) #7
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %dist9) #6
  br label %return

sw.bb13:                                          ; preds = %entry
  %dist14.ascast = addrspacecast ptr addrspace(5) %dist14 to ptr
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %dist14) #6
  store ptr %0, ptr addrspace(5) %dist14, align 8, !tbaa !27
  %call16 = call noundef double @_ZNK6openmc23IncoherentElasticXSFlatclEd(ptr noundef nonnull align 8 dereferenceable(8) %dist14.ascast, double noundef %x) #7
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %dist14) #6
  br label %return
...
define hidden noundef i32 @_ZNK6openmc14Function1DFlat4typeEv(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(8) %this) local_unnamed_addr #4 align 2 {
entry:
  %0 = load ptr, ptr %this, align 8, !tbaa !15
  %1 = load i32, ptr %0, align 4, !tbaa !21
  ret i32 %1
...
; Function Attrs: convergent
declare noundef double @_ZNK6openmc14PolynomialFlatclEd(ptr noundef nonnull align 8 dereferenceable(8), double noundef) local_unnamed_addr #5

; Function Attrs: convergent
declare noundef double @_ZNK6openmc21CoherentElasticXSFlatclEd(ptr noundef nonnull align 8 dereferenceable(8), double noundef) local_unnamed_addr #5

; Function Attrs: convergent
declare noundef double @_ZNK6openmc23IncoherentElasticXSFlatclEd(ptr noundef nonnull align 8 dereferenceable(8), double noundef) local_unnamed_addr #5
...
sw.bb.i:                                          ; preds = %entry
  ...
  call void @_ZN6openmc15Tabulated1DFlatC1EPKh(ptr noundef nonnull align 8 dereferenceable(24) %dist.ascast.i, ptr noundef nonnull %this.val) #7
  %call2.i = call noundef double @_ZNK6openmc15Tabulated1DFlatclEd(ptr noundef nonnull align 8 dereferenceable(24) %dist.ascast.i, double noundef %x) #7
  call void @llvm.lifetime.end.p5(i64 24, ptr addrspace(5) %dist.i) #6
...
sw.bb3.i:                                         ; preds = %entry
  ...
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %dist4.i) #6
  store ptr %this.val, ptr addrspace(5) %dist4.i, align 8, !tbaa !23
  %call6.i = call noundef double @_ZNK6openmc14PolynomialFlatclEd(ptr noundef nonnull align 8 dereferenceable(8) %dist4.ascast.i, double noundef %x) #7
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %dist4.i) #6
  br label %_ZNK6openmc14Function1DFlatclEd.internalized.exit
...
sw.bb8.i:                                         ; preds = %entry
  ...
  %call11.i = call noundef double @_ZNK6openmc21CoherentElasticXSFlatclEd(ptr noundef nonnull align 8 dereferenceable(8) %dist9.ascast.i, double noundef %x) #7
...
sw.bb13.i:                                        ; preds = %entry
  ...
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %dist14.i) #6
  store ptr %this.val, ptr addrspace(5) %dist14.i, align 8, !tbaa !27
  %call16.i = call noundef double @_ZNK6openmc23IncoherentElasticXSFlatclEd(ptr noundef nonnull align 8 dereferenceable(8) %dist14.ascast.i, double noundef %x) #7
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %dist14.i) #6
  br label %_ZNK6openmc14Function1DFlatclEd.internalized.exit
