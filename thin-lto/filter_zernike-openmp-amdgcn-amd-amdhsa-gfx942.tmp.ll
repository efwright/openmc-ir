; ModuleID = 'filter_zernike-openmp-amdgcn-amd-amdhsa-gfx942.tmp.bc'
...
entry:
  ...
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %x) #8
  %0 = load ptr, ptr %p.addr.ascast, align 8, !tbaa !25
  %call = call noundef nonnull align 8 dereferenceable(24) ptr @_ZNK6openmc8Particle1rEv(ptr noundef nonnull align 8 dereferenceable(2728) %0) #10
  %x2 = getelementptr inbounds nuw %"struct.openmc::Position", ptr %call, i32 0, i32 0
  %1 = load double, ptr %x2, align 8, !tbaa !31
  %x_ = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 13
  %2 = load double, ptr %x_, align 8, !tbaa !33
  %sub = fsub double %1, %2
  store double %sub, ptr %x.ascast, align 8, !tbaa !14
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %y) #8
  %3 = load ptr, ptr %p.addr.ascast, align 8, !tbaa !25
  %call3 = call noundef nonnull align 8 dereferenceable(24) ptr @_ZNK6openmc8Particle1rEv(ptr noundef nonnull align 8 dereferenceable(2728) %3) #10
  %y4 = getelementptr inbounds nuw %"struct.openmc::Position", ptr %call3, i32 0, i32 1
  %4 = load double, ptr %y4, align 8, !tbaa !57
  %yy_ = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 15
  %5 = load double, ptr %yy_, align 8, !tbaa !58
  %sub5 = fsub double %4, %5
  store double %sub5, ptr %y.ascast, align 8, !tbaa !14
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %r) #8
  %6 = load double, ptr %x.ascast, align 8, !tbaa !14
  %7 = load double, ptr %x.ascast, align 8, !tbaa !14
  %8 = load double, ptr %y.ascast, align 8, !tbaa !14
  %9 = load double, ptr %y.ascast, align 8, !tbaa !14
  %mul6 = fmul double %8, %9
  %10 = call double @llvm.fmuladd.f64(double %6, double %7, double %mul6)
  %call7 = call noundef double @"_ZL29sqrt$ompvariant$S2$s7$Pamdgcnd"(double noundef %10) #11
  %r_ = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 16
  %11 = load double, ptr %r_, align 8, !tbaa !59
  %div = fdiv double %call7, %11
  store double %div, ptr %r.ascast, align 8, !tbaa !14
  %12 = load double, ptr %r.ascast, align 8, !tbaa !14
  %cmp = fcmp ole double %12, 1.000000e+00
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  call void @llvm.lifetime.start.p5(i64 1000, ptr addrspace(5) %zn) #8
  %order_ = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 17
  %13 = load i32, ptr %order_, align 8, !tbaa !60
  %14 = load double, ptr %r.ascast, align 8, !tbaa !14
  %arraydecay = getelementptr inbounds [125 x double], ptr %zn.ascast, i64 0, i64 0
  call void @calc_zn_rad(i32 noundef %13, double noundef %14, ptr noundef %arraydecay) #10
...
for.cond:                                         ; preds = %for.inc, %if.then
  ...
  %16 = load i32, ptr %n_bins_, align 4, !tbaa !61
...
for.body:                                         ; preds = %for.cond
  %17 = load ptr, ptr %match.addr.ascast, align 8, !tbaa !29
  %18 = load i32, ptr %i.ascast, align 4, !tbaa !18
  %19 = load i32, ptr %i.ascast, align 4, !tbaa !18
  %idxprom = sext i32 %19 to i64
  %arrayidx = getelementptr inbounds [125 x double], ptr %zn.ascast, i64 0, i64 %idxprom
  %20 = load double, ptr %arrayidx, align 8, !tbaa !14
  call void @_ZN6openmc11FilterMatch9push_backEid(ptr noundef nonnull align 8 dereferenceable(1513) %17, i32 noundef %18, double noundef %20) #10
  br label %for.inc
...
for.end:                                          ; preds = %for.cond.cleanup
  call void @llvm.lifetime.end.p5(i64 1000, ptr addrspace(5) %zn) #8
  br label %if.end

if.end:                                           ; preds = %for.end, %entry
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %r) #8
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %y) #8
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %x) #8
  ret void
}
...
declare void @calc_zn_rad(i32 noundef, double noundef, ptr noundef) #5
...
!64 = !{!65, !19, i64 1504}
!65 = !{!"_ZTSN6openmc11FilterMatchE", !16, i64 0, !16, i64 504, !19, i64 1504, !19, i64 1508, !46, i64 1512}
!66 = !{!67, !67, i64 0}
!67 = !{!"bool", !68, i64 0}
