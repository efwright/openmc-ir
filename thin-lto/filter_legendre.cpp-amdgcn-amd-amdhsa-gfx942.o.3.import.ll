; ModuleID = 'filter_legendre.cpp-amdgcn-amd-amdhsa-gfx942.o.3.import.bc'
...
entry:
  ...
  %2 = load i32, ptr %n_bins_, align 4, !tbaa !60
...
for.body.lr.ph:                                   ; preds = %entry
  ...
  %this.val.i.pre = load i32, ptr %3, align 8, !tbaa !61
  br label %for.body
...
if.then.i:                                        ; preds = %for.body
  ...
  store double %5, ptr %arrayidx4.i, align 8, !tbaa !63
  %inc.i = add nsw i32 %6, 1
  store i32 %inc.i, ptr %3, align 8, !tbaa !61
  %.pre = load i32, ptr %n_bins_, align 4, !tbaa !60
...
entry:
  store double 1.000000e+00, ptr %pnx, align 8, !tbaa !63
  %cmp = icmp sgt i32 %n, 0
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %arrayidx1 = getelementptr inbounds nuw i8, ptr %pnx, i64 8
  store double %x, ptr %arrayidx1, align 8, !tbaa !63
  br label %if.end
...
for.body.preheader:                               ; preds = %if.end
  ...
  %.pre = load double, ptr %arrayidx4.phi.trans.insert, align 8, !tbaa !63
...
for.body:                                         ; preds = %for.body, %for.body.preheader
  ...
  %1 = load double, ptr %gep, align 8, !tbaa !63
  %2 = fneg double %conv6
  %neg = fmul double %1, %2
  ...
  store double %div, ptr %arrayidx14, align 8, !tbaa !63
...
!60 = !{!17, !21, i64 4}
!61 = !{!62, !21, i64 1504}
!62 = !{!"_ZTSN6openmc11FilterMatchE", !19, i64 0, !19, i64 504, !21, i64 1504, !21, i64 1508, !33, i64 1512}
!63 = !{!41, !41, i64 0}
!64 = !{!21, !21, i64 0}
!65 = distinct !{!65, !66}
