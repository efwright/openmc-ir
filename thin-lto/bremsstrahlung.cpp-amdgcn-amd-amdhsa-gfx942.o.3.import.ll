; ModuleID = 'bremsstrahlung.cpp-amdgcn-amd-amdhsa-gfx942.o.3.import.bc'
...
if.end3:                                          ; preds = %if.end
  ...
  %5 = tail call double @llvm.amdgcn.frexp.mant.f64(double %1) #7
  %6 = fcmp olt double %5, 0x3FE5555555555555
  %.neg.i = sext i1 %6 to i32
  %7 = select i1 %6, double 2.000000e+00, double 1.000000e+00
  %8 = fmul double %5, %7
  %9 = tail call i32 @llvm.amdgcn.frexp.exp.i32.f64(double %1) #7
  %10 = add i32 %9, %.neg.i
  %11 = fadd double %8, -1.000000e+00
  %12 = fadd double %8, 1.000000e+00
  %13 = fadd double %12, -1.000000e+00
  %14 = fsub double %8, %13
  %15 = tail call double @llvm.amdgcn.rcp.f64(double %12) #7
  %16 = fneg double %12
  %17 = tail call double @llvm.fma.f64(double %16, double %15, double 1.000000e+00) #7
  %18 = tail call double @llvm.fma.f64(double %17, double %15, double %15) #7
  %19 = tail call double @llvm.fma.f64(double %16, double %18, double 1.000000e+00) #7
  %20 = tail call double @llvm.fma.f64(double %19, double %18, double %18) #7
  %21 = fmul double %11, %20
  %22 = fmul double %12, %21
  %23 = fneg double %22
  %24 = tail call double @llvm.fma.f64(double %21, double %12, double %23) #7
  %25 = tail call double @llvm.fma.f64(double %21, double %14, double %24) #7
  ...
  %39 = tail call double @llvm.fma.f64(double %38, double 0x3FC3AB76BF559E2B, double 0x3FC385386B47B09A) #7
  %40 = tail call double @llvm.fma.f64(double %38, double %39, double 0x3FC7474DD7F4DF2E) #7
  %41 = tail call double @llvm.fma.f64(double %38, double %40, double 0x3FCC71C016291751) #7
  %42 = tail call double @llvm.fma.f64(double %38, double %41, double 0x3FD249249B27ACF1) #7
  %43 = tail call double @llvm.fma.f64(double %38, double %42, double 0x3FD99999998EF7B6) #7
  ...
  %58 = fneg double %57
  %59 = tail call double @llvm.fma.f64(double %56, double 0x3FE62E42FEFA39EF, double %58) #7
...
while.body.i.i.i:                                 ; preds = %while.body.i.i.i, %if.end.i
  ...
  %92 = tail call i1 @llvm.is.constant.i64(i64 range(i64 0, 4611686018427387904) %shr.i.i.i) #7
...
_ZN6openmc17lower_bound_indexIPddEENSt15iterator_traitsIT_E15difference_typeES3_S3_RKT0_.internalized.exit: ; preds = %_ZSt11lower_boundIPddET_S1_S1_RKT0_.internalized.exit.i, %if.end3
  ...
  %122 = load i32, ptr %stream_.i, align 8, !tbaa !123
  %idx.ext.i = sext i32 %122 to i64
  %add.ptr.i = getelementptr inbounds i64, ptr %seeds_.i, i64 %idx.ext.i
  %call29 = tail call noundef double @_ZN6openmc3prnEPm(ptr noundef nonnull %add.ptr.i) #8
...
if.end34:                                         ; preds = %_ZN6openmc17lower_bound_indexIPddEENSt15iterator_traitsIT_E15difference_typeES3_S3_RKT0_.internalized.exit
  ...
  %call36 = tail call noundef double @_ZN6openmc3prnEPm(ptr noundef nonnull %add.ptr.i87) #8
...
if.then39:                                        ; preds = %if.end34
  ...
  %mat.0.val = load ptr, ptr %124, align 8, !tbaa !124
  %125 = load i64, ptr addrspace(1) @_ZN6openmc4data15ttb_e_grid_sizeE, align 8, !tbaa !91
...
if.else65:                                        ; preds = %if.end34
  ...
  %260 = load i64, ptr addrspace(1) @_ZN6openmc4data15ttb_e_grid_sizeE, align 8, !tbaa !91
  ...
  %261 = load double, ptr %add.ptr2.i98, align 8, !tbaa !87
  br label %if.end70
...
while.body.i.i.i116:                              ; preds = %while.body.i.i.i116, %if.end.i104
  ...
  %267 = tail call i1 @llvm.is.constant.i64(i64 range(i64 0, 4611686018427387904) %shr.i.i.i119) #7
  ...
  %.val.i.i.i125 = load double, ptr %add.ptr.sink.i.i.i.i.i124, align 8, !tbaa !87
...
_ZN6openmc17lower_bound_indexIPddEENSt15iterator_traitsIT_E15difference_typeES3_S3_RKT0_.internalized.exit134: ; preds = %_ZSt11lower_boundIPddET_S1_S1_RKT0_.internalized.exit.i110, %for.body
  ...
  %270 = load ptr, ptr addrspace(1) @_ZN6openmc4data17device_ttb_e_gridE, align 8, !tbaa !92
  %idxprom81 = ashr exact i64 %retval.0.i115, 32
  %arrayidx82 = getelementptr inbounds double, ptr %270, i64 %idxprom81
  %271 = load double, ptr %arrayidx82, align 8, !tbaa !87
  ...
  %272 = load double, ptr %arrayidx85, align 8, !tbaa !87
  %mat.0.val79 = load ptr, ptr %262, align 8, !tbaa !124
  ...
  %273 = load double, ptr %add.ptr2.i137, align 8, !tbaa !87
  %add.ptr2.i140 = getelementptr inbounds double, ptr %add.ptr.i136, i64 %idxprom84
  %274 = load double, ptr %add.ptr2.i140, align 8, !tbaa !87
  %add.ptr2.i143 = getelementptr inbounds double, ptr %add.ptr77, i64 %idxprom81
  %275 = load double, ptr %add.ptr2.i143, align 8, !tbaa !87
  ...
  %386 = tail call double @llvm.fabs.f64(double %385) #7
  ...
  %506 = fneg double %505
  %507 = tail call double @llvm.fma.f64(double %383, double %502, double %506) #7
  %508 = tail call double @llvm.fma.f64(double %383, double %504, double %507) #7
  %509 = fadd double %505, %508
  %510 = fsub double %509, %505
  %511 = fsub double %508, %510
  %512 = tail call double @llvm.fabs.f64(double %505) #7
  %513 = fcmp oeq double %512, 0x7FF0000000000000
  %514 = select i1 %513, double %505, double %509
  %515 = tail call double @llvm.fabs.f64(double %514) #7
  ...
  %540 = tail call double @llvm.fma.f64(double %539, double %517, double %539) #7
  %541 = tail call double @llvm.fabs.f64(double %539) #7
  %542 = fcmp oeq double %541, 0x7FF0000000000000
  %543 = select i1 %542, double %539, double %540
  %544 = tail call double @llvm.trunc.f64(double %383) #7
  %545 = fcmp oeq double %544, %383
  %546 = fmul double %383, 5.000000e-01
  %547 = tail call double @llvm.trunc.f64(double %546) #7
  %548 = fcmp une double %547, %546
  %549 = and i1 %545, %548
  %550 = select i1 %549, double %385, double 1.000000e+00
  %551 = tail call double @llvm.copysign.f64(double %543, double %550) #7
  ...
  %555 = tail call double @llvm.fabs.f64(double %383) #7
  ...
  %571 = tail call double @llvm.copysign.f64(double %569, double %570) #7
  ...
  %575 = load double, ptr addrspace(1) getelementptr inbounds nuw (i8, ptr addrspace(1) @_ZN6openmc8settings13energy_cutoffE, i64 8), align 8, !tbaa !87
...
if.then118:                                       ; preds = %_ZN6openmc17lower_bound_indexIPddEENSt15iterator_traitsIT_E15difference_typeES3_S3_RKT0_.internalized.exit134
  %576 = load double, ptr %wgt_, align 8, !tbaa !126
  ...
  tail call void @_ZN6openmc8Particle16create_secondaryEdNS_8PositionEdNS0_4TypeE(ptr noundef nonnull align 8 dereferenceable(2728) %p, double noundef %576, double %agg.tmp.sroa.0.0.copyload, double %agg.tmp.sroa.2.0.copyload, double %agg.tmp.sroa.3.0.copyload, double noundef %mul114, i32 noundef 1) #8
  %577 = load double, ptr %E_lost, align 8, !tbaa !87
...
if.end121:                                        ; preds = %if.then118, %_ZN6openmc17lower_bound_indexIPddEENSt15iterator_traitsIT_E15difference_typeES3_S3_RKT0_.internalized.exit134
  ...
  br i1 %exitcond.not, label %cleanup.cont, label %for.body, !llvm.loop !127
...
define available_externally hidden void @_ZN6openmc8Particle16create_secondaryEdNS_8PositionEdNS0_4TypeE(ptr noundef nonnull align 8 captures(none) dereferenceable(2728) %this, double noundef %wgt, double %u.coerce0, double %u.coerce1, double %u.coerce2, double noundef %E, i32 noundef %type) local_unnamed_addr #4 align 2 {
entry:
  ...
  %0 = load i64, ptr %secondary_bank_length_, align 8, !tbaa !128
  %inc = add i64 %0, 1
  store i64 %inc, ptr %secondary_bank_length_, align 8, !tbaa !128
  ...
  store i32 %type, ptr %particle, align 8, !tbaa !129
  %wgt3 = getelementptr inbounds nuw i8, ptr %arrayidx, i64 56
  store double %wgt, ptr %wgt3, align 8, !tbaa !131
  %coord_.i = getelementptr inbounds nuw i8, ptr %this, i64 888
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %arrayidx, ptr noundef nonnull align 8 dereferenceable(24) %coord_.i, i64 24, i1 false), !tbaa.struct !132
  %u4 = getelementptr inbounds nuw i8, ptr %arrayidx, i64 24
  store double %u.coerce0, ptr %u4, align 8, !tbaa !87
  %u.sroa.2.0.u4.sroa_idx = getelementptr inbounds nuw i8, ptr %arrayidx, i64 32
  store double %u.coerce1, ptr %u.sroa.2.0.u4.sroa_idx, align 8, !tbaa !87
  %u.sroa.3.0.u4.sroa_idx = getelementptr inbounds nuw i8, ptr %arrayidx, i64 40
  store double %u.coerce2, ptr %u.sroa.3.0.u4.sroa_idx, align 8, !tbaa !87
  %1 = load i8, ptr addrspace(1) @run_CE, align 1, !tbaa !133, !range !134, !noundef !135
  ...
  store double %cond, ptr %E5, align 8, !tbaa !136
  %n_bank_second_ = getelementptr inbounds nuw i8, ptr %this, i64 1544
  %3 = load i32, ptr %n_bank_second_, align 8, !tbaa !137
  %add = add nsw i32 %3, 1
  store i32 %add, ptr %n_bank_second_, align 8, !tbaa !137
  ret void
}
...
define available_externally hidden noundef double @_ZN6openmc3prnEPm(ptr noundef captures(none) %seed) local_unnamed_addr #6 {
entry:
  %0 = load i64, ptr %seed, align 8, !tbaa !91
  %mul = mul i64 %0, 2806196910506780709
  %add = add i64 %mul, 1
  %and = and i64 %add, 9223372036854775807
  store i64 %and, ptr %seed, align 8, !tbaa !91
...
!opencl.ocl.version = !{!61, !61, !61, !61, !61}
!llvm.ident = !{!62, !63, !62, !63, !62, !63, !62, !63, !62, !63}
