; ModuleID = 'lattice.cpp-amdgcn-amd-amdhsa-gfx942.o.3.import.bc'
...
sw.bb:                                            ; preds = %entry
  ...
  %2 = tail call noundef double @llvm.copysign.f64(double %mul.i, double %u.coerce0) #6
  ...
  %4 = tail call noundef double @llvm.copysign.f64(double %mul11.i, double %u.coerce1) #6
  %sub.i = fsub double %r.coerce0, %2
  %5 = tail call noundef double @llvm.fabs.f64(double %sub.i) #6
...
if.end27.i:                                       ; preds = %if.then.i, %sw.bb
  ...
  %6 = tail call noundef double @llvm.fabs.f64(double %sub28.i) #6
...
if.then55.i:                                      ; preds = %if.end54.i
  ...
  %9 = tail call noundef double @llvm.copysign.f64(double %mul58.i, double %u.coerce2) #6
  %sub61.i = fsub double %r.coerce2, %9
  %10 = tail call noundef double @llvm.fabs.f64(double %sub61.i) #6
...
if.end.i:                                         ; preds = %if.else.i, %if.then.i24
  ...
  %13 = tail call noundef double @llvm.copysign.f64(double %mul28.i, double %beta_dir.0.i) #6
...
if.then.i.i.i:                                    ; preds = %sw.bb5.i.i
  ...
  %18 = tail call double @llvm.fmuladd.f64(double %mul.i.i.i, double %12, double %16) #6
  ...
  %20 = tail call double @llvm.fmuladd.f64(double %conv14.i.i.i, double %12, double %19) #6
...
if.else.i.i.i:                                    ; preds = %sw.bb5.i.i
  %21 = tail call double @llvm.fmuladd.f64(double %conv.i7.i.i, double %12, double %16) #6
  ...
  %23 = tail call double @llvm.fmuladd.f64(double %mul61.i.i.i, double %12, double %22) #6
  br label %if.end52.i
...
if.then.i.i52.i:                                  ; preds = %sw.bb5.i9.i
  ...
  %24 = tail call double @llvm.fmuladd.f64(double %mul.i.i53.i, double %12, double %16) #6
  ...
  %26 = tail call double @llvm.fmuladd.f64(double %conv14.i.i58.i, double %12, double %25) #6
...
if.else.i.i17.i:                                  ; preds = %sw.bb5.i9.i
  %27 = tail call double @llvm.fmuladd.f64(double %conv.i7.i16.i, double %12, double %16) #6
  ...
  %29 = tail call double @llvm.fmuladd.f64(double %mul61.i.i26.i, double %12, double %28) #6
  br label %if.end52.i
...
if.end52.i:                                       ; preds = %if.else.i.i17.i, %if.then.i.i52.i, %if.else.i.i.i, %if.then.i.i.i
  ...
  %31 = tail call noundef double @llvm.fabs.f64(double %sub66.i) #6
...
if.end85.i:                                       ; preds = %if.then70.i, %if.end52.i
  ...
  %32 = tail call noundef double @llvm.copysign.f64(double %mul28.i, double %gamma_dir.0.i) #6
...
if.then.i.i129.i:                                 ; preds = %sw.bb5.i86.i
  ...
  %33 = tail call double @llvm.fmuladd.f64(double %mul.i.i130.i, double %12, double %16) #6
  %add13.i.i134.i = sub i32 %15, %17
  %conv14.i.i135.i = sitofp i32 %add13.i.i134.i to double
  %34 = tail call double @llvm.fmuladd.f64(double %conv14.i.i135.i, double %12, double %30) #6
...
if.else.i.i94.i:                                  ; preds = %sw.bb5.i86.i
  %35 = tail call double @llvm.fmuladd.f64(double %conv.i7.i93.i, double %12, double %16) #6
  ...
  %36 = tail call double @llvm.fmuladd.f64(double %mul61.i.i103.i, double %12, double %30) #6
  br label %if.end120.i
...
if.then.i.i206.i:                                 ; preds = %sw.bb5.i163.i
  ...
  %37 = tail call double @llvm.fmuladd.f64(double %mul.i.i207.i, double %12, double %16) #6
  %sub12.i.i210.i = add i32 %15, 2
  %add13.i.i211.i = sub i32 %sub12.i.i210.i, %17
  %conv14.i.i212.i = sitofp i32 %add13.i.i211.i to double
  %38 = tail call double @llvm.fmuladd.f64(double %conv14.i.i212.i, double %12, double %30) #6
...
if.else.i.i171.i:                                 ; preds = %sw.bb5.i163.i
  %39 = tail call double @llvm.fmuladd.f64(double %conv.i7.i170.i, double %12, double %16) #6
  ...
  %40 = tail call double @llvm.fmuladd.f64(double %mul61.i.i180.i, double %12, double %30) #6
  br label %if.end120.i
...
if.end120.i:                                      ; preds = %if.else.i.i171.i, %if.then.i.i206.i, %if.else.i.i94.i, %if.then.i.i129.i
  ...
  %41 = tail call noundef double @llvm.fabs.f64(double %sub140.i) #6
...
if.end163.i:                                      ; preds = %if.then149.i, %if.then145.i, %if.end120.i
  ...
  %42 = tail call noundef double @llvm.copysign.f64(double %mul28.i, double %delta_dir.0.i) #6
...
if.then.i.i283.i:                                 ; preds = %sw.bb5.i240.i
  ...
  %43 = tail call double @llvm.fmuladd.f64(double %mul.i.i284.i, double %12, double %16) #6
  %sub12.i.i287.i = add i32 %15, 2
  %add13.i.i288.i = sub i32 %sub12.i.i287.i, %17
  %conv14.i.i289.i = sitofp i32 %add13.i.i288.i to double
  %44 = tail call double @llvm.fmuladd.f64(double %conv14.i.i289.i, double %12, double %30) #6
...
if.else.i.i248.i:                                 ; preds = %sw.bb5.i240.i
  %45 = tail call double @llvm.fmuladd.f64(double %conv.i7.i247.i, double %12, double %16) #6
  ...
  %46 = tail call double @llvm.fmuladd.f64(double %mul61.i.i257.i, double %12, double %30) #6
  br label %if.end196.i
...
if.then.i.i360.i:                                 ; preds = %sw.bb5.i317.i
  ...
  %47 = tail call double @llvm.fmuladd.f64(double %mul.i.i361.i, double %12, double %16) #6
  %add13.i.i365.i = sub i32 %15, %17
  %conv14.i.i366.i = sitofp i32 %add13.i.i365.i to double
  %48 = tail call double @llvm.fmuladd.f64(double %conv14.i.i366.i, double %12, double %30) #6
...
if.else.i.i325.i:                                 ; preds = %sw.bb5.i317.i
  %49 = tail call double @llvm.fmuladd.f64(double %conv.i7.i247.i, double %12, double %16) #6
  ...
  %50 = tail call double @llvm.fmuladd.f64(double %mul61.i.i334.i, double %12, double %30) #6
  br label %if.end196.i
...
if.end196.i:                                      ; preds = %if.else.i.i325.i, %if.then.i.i360.i, %if.else.i.i248.i, %if.then.i.i283.i
  ...
  %51 = tail call noundef double @llvm.fabs.f64(double %sub210.i) #6
...
if.then235.i:                                     ; preds = %if.end234.i
  ...
  %54 = tail call noundef double @llvm.copysign.f64(double %mul239.i, double %u.coerce2) #6
  %sub242.i = fsub double %r.coerce2, %54
  %55 = tail call noundef double @llvm.fabs.f64(double %sub242.i) #6
...
sw.bb:                                            ; preds = %entry
  ...
  %8 = tail call double @llvm.fmuladd.f64(double %add17.i, double %7, double %6) #6
  ...
  %9 = tail call double @llvm.fmuladd.f64(double %add9.i, double %4, double %3) #6
  ...
  %10 = tail call double @llvm.fmuladd.f64(double %add.i, double %2, double %1) #6
...
if.then.i:                                        ; preds = %sw.bb5
  ...
  %15 = tail call double @llvm.fmuladd.f64(double %mul.i, double %14, double %12) #6
  ...
  %17 = tail call double @llvm.fmuladd.f64(double %conv14.i, double %14, double %16) #6
...
if.else.i:                                        ; preds = %sw.bb5
  ...
  %19 = tail call double @llvm.fmuladd.f64(double %conv.i17, double %18, double %12) #6
  ...
  %21 = tail call double @llvm.fmuladd.f64(double %mul61.i, double %18, double %20) #6
  br label %if.end.i
...
if.then67.i:                                      ; preds = %if.end.i
  ...
  %25 = tail call double @llvm.fmuladd.f64(double %conv69.i, double 5.000000e-01, double %neg.i) #6
  %sub73.i = fadd double %25, -5.000000e-01
  %y.i.i = getelementptr inbounds nuw i8, ptr %this, i64 152
  %26 = load double, ptr %y.i.i, align 8, !tbaa !37
  %neg77.i = fneg double %sub73.i
  %27 = tail call double @llvm.fmuladd.f64(double %neg77.i, double %26, double %23) #6
...
sw.bb:                                            ; preds = %entry
  ...
  %3 = tail call noundef double @llvm.round.f64(double %div.i) #6
  %conv.i = fptosi double %3 to i64
  %conv6.i = sitofp i64 %conv.i to double
  %sub.i.i = fsub double %div.i, %conv6.i
  %4 = tail call noundef double @llvm.fabs.f64(double %sub.i.i) #6
...
if.else.i:                                        ; preds = %sw.bb
  %5 = tail call noundef double @llvm.floor.f64(double %div.i) #6
...
if.end.i:                                         ; preds = %if.else.i, %if.then.i
  ...
  %8 = tail call noundef double @llvm.round.f64(double %div18.i) #6
  %conv20.i = fptosi double %8 to i64
  %conv21.i = sitofp i64 %conv20.i to double
  %sub.i1.i = fsub double %div18.i, %conv21.i
  %9 = tail call noundef double @llvm.fabs.f64(double %sub.i1.i) #6
...
if.else32.i:                                      ; preds = %if.end.i
  %10 = tail call noundef double @llvm.floor.f64(double %div18.i) #6
...
if.then36.i:                                      ; preds = %if.end35.i
  ...
  %14 = tail call noundef double @llvm.round.f64(double %div42.i) #6
  %conv44.i = fptosi double %14 to i64
  %conv45.i = sitofp i64 %conv44.i to double
  %sub.i3.i = fsub double %div42.i, %conv45.i
  %15 = tail call noundef double @llvm.fabs.f64(double %sub.i3.i) #6
...
if.else56.i:                                      ; preds = %if.then36.i
  %16 = tail call noundef double @llvm.floor.f64(double %div42.i) #6
...
if.then14.i:                                      ; preds = %sw.bb5
  ...
  %23 = tail call double @llvm.fmuladd.f64(double %conv.i19, double 5.000000e-01, double %div.i18) #6
  %24 = tail call double @llvm.round.f64(double %23) #6
  %conv.i.i = fptosi double %24 to i64
  %conv17.i = sitofp i64 %conv.i.i to double
  %sub.i.i20 = fsub double %23, %conv17.i
  %25 = tail call noundef double @llvm.fabs.f64(double %sub.i.i20) #6
...
if.else.i22:                                      ; preds = %if.then14.i
  %26 = tail call noundef double @llvm.floor.f64(double %23) #6
...
if.then28.i:                                      ; preds = %if.end26.i
  ...
  %29 = tail call noundef double @llvm.floor.f64(double %div39.i) #6
...
if.else47.i:                                      ; preds = %if.end26.i
  ...
  %32 = tail call noundef double @llvm.floor.f64(double %div57.i) #6
...
if.end69.i:                                       ; preds = %if.else47.i, %if.then28.i
  ...
  %34 = tail call noundef double @llvm.floor.f64(double %div66.sink.i) #6
  ...
  call void @llvm.lifetime.start.p5(i64 24, ptr addrspace(5) %r_t.i) #7
...
if.then.i.i.i:                                    ; preds = %sw.bb5.i.i
  %mul.i.i.i = fmul double %conv.i7.i.i, 0x3FEBB67AE8584CAA
  %38 = tail call double @llvm.fmuladd.f64(double %mul.i.i.i, double %33, double %17) #6
  %conv14.i.i.i = sitofp i32 %i2.0.i to double
  %39 = tail call double @llvm.fmuladd.f64(double %conv14.i.i.i, double %33, double %18) #6
...
if.else.i.i.i:                                    ; preds = %sw.bb5.i.i
  %40 = tail call double @llvm.fmuladd.f64(double %conv.i7.i.i, double %33, double %17) #6
  %conv44.i.i.i = sitofp i32 %i2.0.i to double
  %mul47.i.i.i = fmul double %33, %conv44.i.i.i
  %div48.i.i.i = fmul double %mul47.i.i.i, 5.000000e-01
  %add49.i.i.i = fadd double %40, %div48.i.i.i
  %mul61.i.i.i = fmul double %conv44.i.i.i, 0x3FEBB67AE8584CAA
  %41 = tail call double @llvm.fmuladd.f64(double %mul61.i.i.i, double %33, double %18) #6
  br label %if.end.i.i.i
...
if.then67.i.i.i:                                  ; preds = %if.end.i.i.i
  %42 = load double, ptr %z.i13.i.i, align 8, !tbaa !48
  %43 = load i32, ptr %n_axial_.i.i.i, align 4, !tbaa !49
  %conv69.i.i.i = sitofp i32 %43 to double
  %44 = fmul double %conv69.i.i.i, 5.000000e-01
  %sub73.i.i.i = fadd double %44, -5.000000e-01
  %45 = load double, ptr %y.i.i.i.i, align 8, !tbaa !37
  %neg77.i.i.i = fneg double %sub73.i.i.i
  %46 = tail call double @llvm.fmuladd.f64(double %neg77.i.i.i, double %45, double %42) #6
...
_ZNK6openmc7Lattice18get_local_positionENS_8PositionESt5arrayIiLm3EE.internalized.exit.i: ; preds = %_ZNK6openmc7Lattice29HexLattice_get_local_positionENS_8PositionESt5arrayIiLm3EE.internalized.exit.i.i, %if.end69.i
  ...
  %48 = tail call noundef double @llvm.fabs.f64(double %sub.i3.i13) #6
...
if.then94.i:                                      ; preds = %_ZNK6openmc7Lattice18get_local_positionENS_8PositionESt5arrayIiLm3EE.internalized.exit.i
  %49 = tail call noundef double @llvm.sqrt.f64(double %47) #6
  %call96.i = call noundef nonnull align 8 dereferenceable(24) ptr @_ZN6openmc8PositiondVEd(ptr noundef nonnull align 8 dereferenceable(24) %r_t.ascast.i, double noundef %49) #8
...
cleanup108.i:                                     ; preds = %if.then94.i, %_ZNK6openmc7Lattice18get_local_positionENS_8PositionESt5arrayIiLm3EE.internalized.exit.i
  ...
  call void @llvm.lifetime.end.p5(i64 24, ptr addrspace(5) %r_t.i) #7
  call void @llvm.lifetime.start.p5(i64 24, ptr addrspace(5) %r_t.i) #7
...
sw.bb5.i.1.i:                                     ; preds = %cleanup108.i
  %54 = load i32, ptr %orientation_.i, align 8, !tbaa !41
  %cmp.i.i.1.i = icmp eq i32 %54, 0
  %55 = load double, ptr %center_.i, align 8, !tbaa !42
...
if.else.i.i.1.i:                                  ; preds = %sw.bb5.i.1.i
  %57 = load double, ptr %pitch_37.i.i.i, align 8, !tbaa !37
  %58 = call double @llvm.fmuladd.f64(double %conv.i7.i.1.i, double %57, double %55) #6
  ...
  %59 = load double, ptr %y6.i, align 8, !tbaa !43
  %mul61.i.i.1.i = fmul double %conv44.i.i.1.i, 0x3FEBB67AE8584CAA
  %60 = call double @llvm.fmuladd.f64(double %mul61.i.i.1.i, double %57, double %59) #6
  br label %if.end.i.i.1.i

if.then.i.i.1.i:                                  ; preds = %sw.bb5.i.1.i
  %mul.i.i.1.i = fmul double %conv.i7.i.1.i, 0x3FEBB67AE8584CAA
  %61 = load double, ptr %pitch_37.i.i.i, align 8, !tbaa !37
  %62 = call double @llvm.fmuladd.f64(double %mul.i.i.1.i, double %61, double %55) #6
  %63 = load double, ptr %y6.i, align 8, !tbaa !43
  %add13.i.i.1.i = sub i32 %sub42.i.i.i, %56
  %conv14.i.i.1.i = sitofp i32 %add13.i.i.1.i to double
  %64 = call double @llvm.fmuladd.f64(double %conv14.i.i.1.i, double %61, double %63) #6
...
if.end.i.i.1.i:                                   ; preds = %if.then.i.i.1.i, %if.else.i.i.1.i
  ...
  %65 = load i8, ptr %is_3d_.i10, align 8, !tbaa !38, !range !39, !noundef !40
...
if.then67.i.i.1.i:                                ; preds = %if.end.i.i.1.i
  %66 = load double, ptr %z.i13.i.i, align 8, !tbaa !48
  %67 = load i32, ptr %n_axial_.i.i.i, align 4, !tbaa !49
  ...
  %69 = load double, ptr %y.i.i.i.i, align 8, !tbaa !37
  %neg77.i.i.1.i = fneg double %sub73.i.i.1.i
  %70 = call double @llvm.fmuladd.f64(double %neg77.i.i.1.i, double %69, double %66) #6
...
sw.bb.i.1.i:                                      ; preds = %cleanup108.i
  ...
  %80 = call double @llvm.fmuladd.f64(double %add.i.i.1.i, double %72, double %71) #6
...
_ZNK6openmc7Lattice18get_local_positionENS_8PositionESt5arrayIiLm3EE.internalized.exit.1.i: ; preds = %sw.bb.i.1.i, %_ZNK6openmc7Lattice29HexLattice_get_local_positionENS_8PositionESt5arrayIiLm3EE.internalized.exit.i.1.i, %cleanup108.i
  ...
  %82 = call noundef double @llvm.fabs.f64(double %sub.i3.1.i) #6
...
if.then94.1.i:                                    ; preds = %_ZNK6openmc7Lattice18get_local_positionENS_8PositionESt5arrayIiLm3EE.internalized.exit.1.i
  %83 = call noundef double @llvm.sqrt.f64(double %81) #6
  %call96.1.i = call noundef nonnull align 8 dereferenceable(24) ptr @_ZN6openmc8PositiondVEd(ptr noundef nonnull align 8 dereferenceable(24) %r_t.ascast.i, double noundef %83) #8
...
sw.bb5.i.122.i:                                   ; preds = %cleanup108.1.i
  %88 = load i32, ptr %orientation_.i, align 8, !tbaa !41
  %cmp.i.i.119.i = icmp eq i32 %88, 0
  %89 = load double, ptr %center_.i, align 8, !tbaa !42
...
if.else.i.i.129.i:                                ; preds = %sw.bb5.i.122.i
  %91 = load double, ptr %pitch_37.i.i.i, align 8, !tbaa !37
  %92 = call double @llvm.fmuladd.f64(double %conv.i7.i.121.i, double %91, double %89) #6
  ...
  %93 = load double, ptr %y6.i, align 8, !tbaa !43
  %mul61.i.i.128.i = fmul double %conv44.i.i.124.i, 0x3FEBB67AE8584CAA
  %94 = call double @llvm.fmuladd.f64(double %mul61.i.i.128.i, double %91, double %93) #6
...
if.then.i.i.136.i:                                ; preds = %sw.bb5.i.122.i
  ...
  %95 = load double, ptr %pitch_37.i.i.i, align 8, !tbaa !37
  %96 = call double @llvm.fmuladd.f64(double %mul.i.i.130.i, double %95, double %89) #6
  %97 = load double, ptr %y6.i, align 8, !tbaa !43
  %add13.i.i.131.i = sub i32 %sub42.i.i.1.i, %90
  %conv14.i.i.132.i = sitofp i32 %add13.i.i.131.i to double
  %98 = call double @llvm.fmuladd.f64(double %conv14.i.i.132.i, double %95, double %97) #6
...
if.end.i.i.140.i:                                 ; preds = %if.then.i.i.136.i, %if.else.i.i.129.i
  ...
  %99 = load i8, ptr %is_3d_.i10, align 8, !tbaa !38, !range !39, !noundef !40
...
if.then67.i.i.145.i:                              ; preds = %if.end.i.i.140.i
  %100 = load double, ptr %z.i13.i.i, align 8, !tbaa !48
  %101 = load i32, ptr %n_axial_.i.i.i, align 4, !tbaa !49
  ...
  %103 = load double, ptr %y.i.i.i.i, align 8, !tbaa !37
  %neg77.i.i.143.i = fneg double %sub73.i.i.142.i
  %104 = call double @llvm.fmuladd.f64(double %neg77.i.i.143.i, double %103, double %100) #6
...
sw.bb.i.157.i:                                    ; preds = %cleanup108.1.i
  %105 = load double, ptr %lower_left_.i.i.i, align 8, !tbaa !44
  %106 = load double, ptr %pitch_37.i.i.i, align 8, !tbaa !45
  %107 = load double, ptr %y.i1.i.i, align 8, !tbaa !46
  %108 = load double, ptr %y.i.i.i.i, align 8, !tbaa !47
  %109 = load i8, ptr %is_3d_.i10, align 8, !tbaa !38, !range !39, !noundef !40
  %loadedv.i.i.150.i = trunc nuw i8 %109 to i1
  %110 = load double, ptr %z.i.i.i, align 8
  %111 = load double, ptr %z19.i.i.i, align 8
  %112 = call double @llvm.fmuladd.f64(double %111, double 5.000000e-01, double %110) #6
  ...
  %113 = call double @llvm.fmuladd.f64(double %add9.i.i.1.i, double %108, double %107) #6
  ...
  %114 = call double @llvm.fmuladd.f64(double %add.i.i.155.i, double %106, double %105) #6
...
_ZNK6openmc7Lattice18get_local_positionENS_8PositionESt5arrayIiLm3EE.internalized.exit.167.i: ; preds = %sw.bb.i.157.i, %_ZNK6openmc7Lattice29HexLattice_get_local_positionENS_8PositionESt5arrayIiLm3EE.internalized.exit.i.149.i, %cleanup108.1.i
  ...
  %116 = call noundef double @llvm.fabs.f64(double %sub.i3.163.i) #6
...
if.then94.172.i:                                  ; preds = %_ZNK6openmc7Lattice18get_local_positionENS_8PositionESt5arrayIiLm3EE.internalized.exit.167.i
  %117 = call noundef double @llvm.sqrt.f64(double %115) #6
  %call96.168.i = call noundef nonnull align 8 dereferenceable(24) ptr @_ZN6openmc8PositiondVEd(ptr noundef nonnull align 8 dereferenceable(24) %r_t.ascast.i, double noundef %117) #8
...
sw.bb5.i.1.1.i:                                   ; preds = %cleanup108.178.i
  %122 = load i32, ptr %orientation_.i, align 8, !tbaa !41
  %cmp.i.i.1.1.i = icmp eq i32 %122, 0
  %123 = load double, ptr %center_.i, align 8, !tbaa !42
...
if.else.i.i.1.1.i:                                ; preds = %sw.bb5.i.1.1.i
  %125 = load double, ptr %pitch_37.i.i.i, align 8, !tbaa !37
  %126 = call double @llvm.fmuladd.f64(double %conv.i7.i.1.1.i, double %125, double %123) #6
  ...
  %127 = load double, ptr %y6.i, align 8, !tbaa !43
  %mul61.i.i.1.1.i = fmul double %conv44.i.i.1.1.i, 0x3FEBB67AE8584CAA
  %128 = call double @llvm.fmuladd.f64(double %mul61.i.i.1.1.i, double %125, double %127) #6
...
if.then.i.i.1.1.i:                                ; preds = %sw.bb5.i.1.1.i
  ...
  %129 = load double, ptr %pitch_37.i.i.i, align 8, !tbaa !37
  %130 = call double @llvm.fmuladd.f64(double %mul.i.i.1.1.i, double %129, double %123) #6
  %131 = load double, ptr %y6.i, align 8, !tbaa !43
  %add13.i.i.1.1.i = sub i32 %sub42.i.i.1.i, %124
  %conv14.i.i.1.1.i = sitofp i32 %add13.i.i.1.1.i to double
  %132 = call double @llvm.fmuladd.f64(double %conv14.i.i.1.1.i, double %129, double %131) #6
...
if.end.i.i.1.1.i:                                 ; preds = %if.then.i.i.1.1.i, %if.else.i.i.1.1.i
  ...
  %133 = load i8, ptr %is_3d_.i10, align 8, !tbaa !38, !range !39, !noundef !40
...
if.then67.i.i.1.1.i:                              ; preds = %if.end.i.i.1.1.i
  %134 = load double, ptr %z.i13.i.i, align 8, !tbaa !48
  %135 = load i32, ptr %n_axial_.i.i.i, align 4, !tbaa !49
  ...
  %137 = load double, ptr %y.i.i.i.i, align 8, !tbaa !37
  %neg77.i.i.1.1.i = fneg double %sub73.i.i.1.1.i
  %138 = call double @llvm.fmuladd.f64(double %neg77.i.i.1.1.i, double %137, double %134) #6
...
sw.bb.i.1.1.i:                                    ; preds = %cleanup108.178.i
  %139 = load double, ptr %lower_left_.i.i.i, align 8, !tbaa !44
  %140 = load double, ptr %pitch_37.i.i.i, align 8, !tbaa !45
  %141 = load double, ptr %y.i1.i.i, align 8, !tbaa !46
  %142 = load double, ptr %y.i.i.i.i, align 8, !tbaa !47
  %143 = load i8, ptr %is_3d_.i10, align 8, !tbaa !38, !range !39, !noundef !40
  %loadedv.i.i.1.1.i = trunc nuw i8 %143 to i1
  %144 = load double, ptr %z.i.i.i, align 8
  %145 = load double, ptr %z19.i.i.i, align 8
  %146 = call double @llvm.fmuladd.f64(double %145, double 5.000000e-01, double %144) #6
  ...
  %147 = call double @llvm.fmuladd.f64(double %add9.i.i.1.i, double %142, double %141) #6
  ...
  %148 = call double @llvm.fmuladd.f64(double %add.i.i.1.1.i, double %140, double %139) #6
...
_ZNK6openmc7Lattice18get_local_positionENS_8PositionESt5arrayIiLm3EE.internalized.exit.1.1.i: ; preds = %sw.bb.i.1.1.i, %_ZNK6openmc7Lattice29HexLattice_get_local_positionENS_8PositionESt5arrayIiLm3EE.internalized.exit.i.1.1.i, %cleanup108.178.i
  ...
  %150 = call noundef double @llvm.fabs.f64(double %sub.i3.1.1.i) #6
...
if.then94.1.1.i:                                  ; preds = %_ZNK6openmc7Lattice18get_local_positionENS_8PositionESt5arrayIiLm3EE.internalized.exit.1.1.i
  %151 = call noundef double @llvm.sqrt.f64(double %149) #6
  %call96.1.1.i = call noundef nonnull align 8 dereferenceable(24) ptr @_ZN6openmc8PositiondVEd(ptr noundef nonnull align 8 dereferenceable(24) %r_t.ascast.i, double noundef %151) #8
...
entry:
  %0 = load double, ptr %this, align 8, !tbaa !52
  %div = fdiv double %0, %v
  store double %div, ptr %this, align 8, !tbaa !52
  %y = getelementptr inbounds nuw i8, ptr %this, i64 8
  %1 = load double, ptr %y, align 8, !tbaa !53
  %div2 = fdiv double %1, %v
  store double %div2, ptr %y, align 8, !tbaa !53
  %z = getelementptr inbounds nuw i8, ptr %this, i64 16
  %2 = load double, ptr %z, align 8, !tbaa !54
  %div3 = fdiv double %2, %v
  store double %div3, ptr %z, align 8, !tbaa !54
  ret ptr %this
}
