; ModuleID = 'filter_delayedgroup.cpp-amdgcn-amd-amdhsa-gfx942.o.5.precodegen.bc'
...
define hidden void @_ZNK6openmc6Filter31DelayedGroupFilter_get_all_binsERKNS_8ParticleENS_14TallyEstimatorERNS_11FilterMatchE(ptr noundef nonnull readnone align 8 captures(none) dereferenceable(448) %this, ptr noundef nonnull readnone align 8 captures(none) dereferenceable(2728) %p, i32 noundef %estimator, ptr noundef nonnull align 8 captures(none) dereferenceable(1513) %match) local_unnamed_addr #0 align 2 {
entry:
  %0 = getelementptr inbounds nuw i8, ptr %match, i64 1504
  %this.val.i = load i32, ptr %0, align 8, !tbaa !15
