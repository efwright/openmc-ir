; ModuleID = 'tally.cpp-amdgcn-amd-amdhsa-gfx942.o.5.precodegen.bc'
...
define hidden noundef ptr @_ZN6openmc5Tally7resultsEllNS_11TallyResultE(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(240) %this, i64 noundef %i, i64 noundef %j, i32 noundef %k) local_unnamed_addr #0 align 2 {
entry:
