; ModuleID = 'secondary_uncorrelated-openmp-amdgcn-amd-amdhsa-gfx942.tmp.bc'
...
define hidden void @_ZNK6openmc27UncorrelatedAngleEnergyFlat6sampleEdRdS1_Pm(ptr noundef nonnull align 8 dereferenceable(8) %this, double noundef %E_in, ptr noundef nonnull align 8 dereferenceable(8) %E_out, ptr noundef nonnull align 8 dereferenceable(8) %mu, ptr noundef %seed) #3 align 2 {
entry:
  ...
  %call = call noundef zeroext i1 @_ZNK6openmc27UncorrelatedAngleEnergyFlat7fissionEv(ptr noundef nonnull align 8 dereferenceable(8) %this1) #9
  br i1 %call, label %if.then, label %if.else

if.then:                                          ; preds = %entry
  %0 = load ptr, ptr %mu.addr.ascast, align 8, !tbaa !25
  store double 1.000000e+00, ptr %0, align 8, !tbaa !14
  br label %if.end

if.else:                                          ; preds = %entry
  call void @llvm.lifetime.start.p5(i64 16, ptr addrspace(5) %ref.tmp) #7
  %call2 = call %"class.openmc::AngleDistributionFlat" @_ZNK6openmc27UncorrelatedAngleEnergyFlat5angleEv(ptr noundef nonnull align 8 dereferenceable(8) %this1) #9
  %1 = getelementptr inbounds nuw %"class.openmc::AngleDistributionFlat", ptr %ref.tmp.ascast, i32 0, i32 0
  %2 = extractvalue %"class.openmc::AngleDistributionFlat" %call2, 0
  store ptr %2, ptr %1, align 8
  %3 = getelementptr inbounds nuw %"class.openmc::AngleDistributionFlat", ptr %ref.tmp.ascast, i32 0, i32 1
  %4 = extractvalue %"class.openmc::AngleDistributionFlat" %call2, 1
  store i64 %4, ptr %3, align 8
  %5 = load double, ptr %E_in.addr.ascast, align 8, !tbaa !14
  %6 = load ptr, ptr %seed.addr.ascast, align 8, !tbaa !27
  %call3 = call noundef double @_ZNK6openmc21AngleDistributionFlat6sampleEdPm(ptr noundef nonnull align 8 dereferenceable(16) %ref.tmp.ascast, double noundef %5, ptr noundef %6) #9
  %7 = load ptr, ptr %mu.addr.ascast, align 8, !tbaa !25
  store double %call3, ptr %7, align 8, !tbaa !14
  call void @llvm.lifetime.end.p5(i64 16, ptr addrspace(5) %ref.tmp) #7
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  call void @llvm.lifetime.start.p5(i64 16, ptr addrspace(5) %ref.tmp4) #7
  %call5 = call %"class.openmc::EnergyDistributionFlat" @_ZNK6openmc27UncorrelatedAngleEnergyFlat6energyEv(ptr noundef nonnull align 8 dereferenceable(8) %this1) #9
  %8 = getelementptr inbounds nuw %"class.openmc::EnergyDistributionFlat", ptr %ref.tmp4.ascast, i32 0, i32 0
  %9 = extractvalue %"class.openmc::EnergyDistributionFlat" %call5, 0
  store i32 %9, ptr %8, align 8
  %10 = getelementptr inbounds nuw %"class.openmc::EnergyDistributionFlat", ptr %ref.tmp4.ascast, i32 0, i32 1
  %11 = extractvalue %"class.openmc::EnergyDistributionFlat" %call5, 1
  store ptr %11, ptr %10, align 8
  %12 = load double, ptr %E_in.addr.ascast, align 8, !tbaa !14
  %13 = load ptr, ptr %seed.addr.ascast, align 8, !tbaa !27
  %call6 = call noundef double @_ZNK6openmc22EnergyDistributionFlat6sampleEdPm(ptr noundef nonnull align 8 dereferenceable(16) %ref.tmp4.ascast, double noundef %12, ptr noundef %13) #9
  %14 = load ptr, ptr %E_out.addr.ascast, align 8, !tbaa !25
  store double %call6, ptr %14, align 8, !tbaa !14
  call void @llvm.lifetime.end.p5(i64 16, ptr addrspace(5) %ref.tmp4) #7
  ret void
}

; Function Attrs: convergent mustprogress nounwind
define hidden noundef zeroext i1 @_ZNK6openmc27UncorrelatedAngleEnergyFlat7fissionEv(ptr noundef nonnull align 8 dereferenceable(8) %this) #3 align 2 {
entry:
...
; Function Attrs: convergent mustprogress nounwind
define hidden %"class.openmc::AngleDistributionFlat" @_ZNK6openmc27UncorrelatedAngleEnergyFlat5angleEv(ptr noundef nonnull align 8 dereferenceable(8) %this) #3 align 2 {
entry:
  ...
  call void @_ZN6openmc21AngleDistributionFlatC1EPKh(ptr noundef nonnull align 8 dereferenceable(16) %retval.ascast, ptr noundef %add.ptr) #9
  %1 = load %"class.openmc::AngleDistributionFlat", ptr %retval.ascast, align 8
  ret %"class.openmc::AngleDistributionFlat" %1
}
...
; Function Attrs: convergent mustprogress nounwind
define hidden %"class.openmc::EnergyDistributionFlat" @_ZNK6openmc27UncorrelatedAngleEnergyFlat6energyEv(ptr noundef nonnull align 8 dereferenceable(8) %this) #3 align 2 {
entry:
  %retval = alloca %"class.openmc::EnergyDistributionFlat", align 8, addrspace(5)
  %this.addr = alloca ptr, align 8, addrspace(5)
  ...
  store i64 %conv, ptr %offset.ascast, align 8, !tbaa !32
  %data_2 = getelementptr inbounds nuw %"class.openmc::UncorrelatedAngleEnergyFlat", ptr %this1, i32 0, i32 0
  %2 = load ptr, ptr %data_2, align 8, !tbaa !29
  %3 = load i64, ptr %offset.ascast, align 8, !tbaa !32
  %add.ptr3 = getelementptr inbounds nuw i8, ptr %2, i64 %3
  call void @_ZN6openmc22EnergyDistributionFlatC1EPKh(ptr noundef nonnull align 8 dereferenceable(16) %retval.ascast, ptr noundef %add.ptr3) #9
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %offset) #7
  %4 = load %"class.openmc::EnergyDistributionFlat", ptr %retval.ascast, align 8
  ret %"class.openmc::EnergyDistributionFlat" %4
}

; Function Attrs: convergent
declare noundef double @_ZNK6openmc22EnergyDistributionFlat6sampleEdPm(ptr noundef nonnull align 8 dereferenceable(16), double noundef, ptr noundef) #4
...
!21 = !{!"float", !16, i64 0}
!22 = !{!23, !23, i64 0}
!23 = !{!"p1 _ZTSN6openmc27UncorrelatedAngleEnergyFlatE", !24, i64 0}
...
!28 = !{!"p1 long", !24, i64 0}
!29 = !{!30, !31, i64 0}
!30 = !{!"_ZTSN6openmc27UncorrelatedAngleEnergyFlatE", !31, i64 0}
