; ModuleID = 'distribution_energy.cpp-amdgcn-amd-amdhsa-gfx942.o.2.internalize.bc'
...
; Function Attrs: convergent
declare double @maxwell_spectrum(double noundef, ptr noundef) local_unnamed_addr #5

; Function Attrs: convergent
declare double @watt_spectrum(double noundef, double noundef, ptr noundef) local_unnamed_addr #5
