; ModuleID = 'filter_sph_harm-openmp-amdgcn-amd-amdhsa-gfx942.tmp.bc'
...
entry:
  ...
  %num_nm = alloca i32, align 4, addrspace(5)
  %i14 = alloca i32, align 4, addrspace(5)
  ...
  %cleanup.dest.slot11.ascast = addrspacecast ptr addrspace(5) %cleanup.dest.slot11 to ptr
  %num_nm.ascast = addrspacecast ptr addrspace(5) %num_nm to ptr
  %i14.ascast = addrspacecast ptr addrspace(5) %i14 to ptr
  ...
  call void @llvm.lifetime.start.p5(i64 1000, ptr addrspace(5) %wgt) #8
  %cosine_ = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 21
  %0 = load i32, ptr %cosine_, align 8, !tbaa !31
  %cmp = icmp eq i32 %0, 0
  br i1 %cmp, label %if.then, label %if.else

if.then:                                          ; preds = %entry
  %order_ = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 17
  %1 = load i32, ptr %order_, align 8, !tbaa !55
  %2 = load ptr, ptr %p.addr.ascast, align 8, !tbaa !25
  %mu_ = getelementptr inbounds nuw %"class.openmc::Particle", ptr %2, i32 0, i32 16
  %3 = load double, ptr %mu_, align 8, !tbaa !56
  %arraydecay = getelementptr inbounds [125 x double], ptr %wgt.ascast, i64 0, i64 0
  call void @calc_pn_c(i32 noundef %1, double noundef %3, ptr noundef %arraydecay) #10
  br label %if.end
...
for.cond:                                         ; preds = %for.inc, %if.else
  ...
  %5 = load i32, ptr %order_2, align 8, !tbaa !55
  %add = add nsw i32 %5, 1
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [125 x double], ptr %wgt.ascast, i64 0, i64 %idxprom
...
if.end:                                           ; preds = %for.end, %if.then
  call void @llvm.lifetime.start.p5(i64 1000, ptr addrspace(5) %rn) #8
  %order_4 = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 17
  %8 = load i32, ptr %order_4, align 8, !tbaa !55
  %9 = load ptr, ptr %p.addr.ascast, align 8, !tbaa !25
  %u_last_ = getelementptr inbounds nuw %"class.openmc::Particle", ptr %9, i32 0, i32 19
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %agg.tmp.ascast, ptr align 8 %u_last_, i64 24, i1 false), !tbaa.struct !72
  %arraydecay5 = getelementptr inbounds [125 x double], ptr %rn.ascast, i64 0, i64 0
  ...
  call void @_ZN6openmc7calc_rnEiNS_8PositionEPd(i32 noundef %8, double %11, double %13, double %15, ptr noundef %arraydecay5) #10
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %j) #8
  store i32 0, ptr %j.ascast, align 4, !tbaa !18
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %n) #8
  store i32 0, ptr %n.ascast, align 4, !tbaa !18
  br label %for.cond6

for.cond6:                                        ; preds = %for.inc28, %if.end
  %16 = load i32, ptr %n.ascast, align 4, !tbaa !18
  %order_7 = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 17
  %17 = load i32, ptr %order_7, align 8, !tbaa !55
...
for.cond.cleanup10:                               ; preds = %for.cond6
  store i32 5, ptr %cleanup.dest.slot11.ascast, align 4
  call void @llvm.lifetime.end.p5(i64 4, ptr addrspace(5) %n) #8
  br label %for.end30

for.body12:                                       ; preds = %for.cond6
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %num_nm) #8
  %18 = load i32, ptr %n.ascast, align 4, !tbaa !18
  %mul = mul nsw i32 2, %18
  %add13 = add nsw i32 %mul, 1
  store i32 %add13, ptr %num_nm.ascast, align 4, !tbaa !18
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %i14) #8
  store i32 0, ptr %i14.ascast, align 4, !tbaa !18
  br label %for.cond15

for.cond15:                                       ; preds = %for.inc25, %for.body12
  %19 = load i32, ptr %i14.ascast, align 4, !tbaa !18
  %20 = load i32, ptr %num_nm.ascast, align 4, !tbaa !18
  %cmp16 = icmp slt i32 %19, %20
  br i1 %cmp16, label %for.body18, label %for.cond.cleanup17

for.cond.cleanup17:                               ; preds = %for.cond15
  store i32 8, ptr %cleanup.dest.slot11.ascast, align 4
  call void @llvm.lifetime.end.p5(i64 4, ptr addrspace(5) %i14) #8
  br label %for.end27

for.body18:                                       ; preds = %for.cond15
  %21 = load ptr, ptr %match.addr.ascast, align 8, !tbaa !29
  %22 = load i32, ptr %j.ascast, align 4, !tbaa !18
  %23 = load i32, ptr %n.ascast, align 4, !tbaa !18
  %idxprom19 = sext i32 %23 to i64
  %arrayidx20 = getelementptr inbounds [125 x double], ptr %wgt.ascast, i64 0, i64 %idxprom19
  %24 = load double, ptr %arrayidx20, align 8, !tbaa !14
  %25 = load i32, ptr %j.ascast, align 4, !tbaa !18
  %idxprom21 = sext i32 %25 to i64
  %arrayidx22 = getelementptr inbounds [125 x double], ptr %rn.ascast, i64 0, i64 %idxprom21
  %26 = load double, ptr %arrayidx22, align 8, !tbaa !14
  %mul23 = fmul double %24, %26
  call void @_ZN6openmc11FilterMatch9push_backEid(ptr noundef nonnull align 8 dereferenceable(1513) %21, i32 noundef %22, double noundef %mul23) #10
  %27 = load i32, ptr %j.ascast, align 4, !tbaa !18
  %inc24 = add nsw i32 %27, 1
  store i32 %inc24, ptr %j.ascast, align 4, !tbaa !18
  br label %for.inc25

for.inc25:                                        ; preds = %for.body18
  %28 = load i32, ptr %i14.ascast, align 4, !tbaa !18
  %inc26 = add nsw i32 %28, 1
  store i32 %inc26, ptr %i14.ascast, align 4, !tbaa !18
  br label %for.cond15, !llvm.loop !73

for.end27:                                        ; preds = %for.cond.cleanup17
  call void @llvm.lifetime.end.p5(i64 4, ptr addrspace(5) %num_nm) #8
  br label %for.inc28

for.inc28:                                        ; preds = %for.end27
  %29 = load i32, ptr %n.ascast, align 4, !tbaa !18
  %inc29 = add nsw i32 %29, 1
  store i32 %inc29, ptr %n.ascast, align 4, !tbaa !18
  br label %for.cond6, !llvm.loop !74

for.end30:                                        ; preds = %for.cond.cleanup10
  call void @llvm.lifetime.end.p5(i64 4, ptr addrspace(5) %j) #8
  call void @llvm.lifetime.end.p5(i64 1000, ptr addrspace(5) %rn) #8
  call void @llvm.lifetime.end.p5(i64 1000, ptr addrspace(5) %wgt) #8
  ret void
}

; Function Attrs: convergent
declare void @calc_pn_c(i32 noundef, double noundef, ptr noundef) #4

; Function Attrs: convergent
declare void @_ZN6openmc7calc_rnEiNS_8PositionEPd(i32 noundef, double, double, double, ptr noundef) #4
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i32, ptr %bins_weights_length_, align 8, !tbaa !75
  ...
  %3 = load i32, ptr %bins_weights_length_2, align 8, !tbaa !75
  ...
  %4 = load i32, ptr %bins_weights_length_5, align 8, !tbaa !75
  %inc = add nsw i32 %4, 1
  store i32 %inc, ptr %bins_weights_length_5, align 8, !tbaa !75
  br label %if.end
...
entry:
  ...
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  %bins_weights_length_ = getelementptr inbounds nuw %"class.openmc::FilterMatch", ptr %this1, i32 0, i32 3
  %0 = load i32, ptr %bins_weights_length_, align 8, !tbaa !75
...
!31 = !{!32, !53, i64 376}
!32 = !{!"_ZTSN6openmc6FilterE", !33, i64 0, !19, i64 4, !19, i64 8, !34, i64 16, !35, i64 24, !37, i64 48, !39, i64 72, !46, i64 128, !48, i64 152, !37, i64 208, !19, i64 232, !44, i64 236, !35, i64 240, !15, i64 264, !35, i64 272, !15, i64 296, !15, i64 304, !19, i64 312, !37, i64 320, !19, i64 344, !52, i64 352, !53, i64 376, !54, i64 380, !15, i64 384, !15, i64 392, !37, i64 400, !37, i64 424}
!33 = !{!"_ZTSN6openmc6Filter10FilterTypeE", !16, i64 0}
!34 = !{!"long", !16, i64 0}
!35 = !{!"_ZTSN6openmc6vectorIdEE", !36, i64 0, !34, i64 8, !34, i64 16}
!36 = !{!"p1 double", !24, i64 0}
...
!50 = !{!"p1 _ZTSSt4pairIN6openmc12CellInstanceElE", !24, i64 0}
!51 = !{!"_ZTSN6openmc16CellInstanceHashE"}
!52 = !{!"_ZTSN6openmc6vectorINS_8Particle4TypeEEE", !24, i64 0, !34, i64 8, !34, i64 16}
!53 = !{!"_ZTSN6openmc24SphericalHarmonicsCosineE", !16, i64 0}
!54 = !{!"_ZTSN6openmc12LegendreAxisE", !16, i64 0}
!55 = !{!32, !19, i64 312}
!56 = !{!57, !15, i64 1432}
!57 = !{!"_ZTSN6openmc8ParticleE", !58, i64 0, !16, i64 168, !59, i64 744, !34, i64 864, !60, i64 872, !19, i64 876, !19, i64 880, !16, i64 888, !19, i64 1368, !16, i64 1372, !15, i64 1400, !15, i64 1408, !19, i64 1416, !19, i64 1420, !15, i64 1424, !15, i64 1432, !61, i64 1440, !61, i64 1464, !61, i64 1488, !15, i64 1512, !44, i64 1520, !62, i64 1524, !19, i64 1528, !19, i64 1532, !19, i64 1536, !19, i64 1540, !19, i64 1544, !15, i64 1552, !16, i64 1560, !19, i64 1592, !19, i64 1596, !19, i64 1600, !19, i64 1604, !63, i64 1608, !15, i64 1640, !15, i64 1648, !19, i64 1656, !44, i64 1660, !16, i64 1664, !19, i64 1728, !16, i64 1736, !34, i64 2216, !34, i64 2224, !16, i64 2232, !30, i64 2240, !65, i64 2248, !16, i64 2272, !15, i64 2656, !15, i64 2664, !15, i64 2672, !15, i64 2680, !44, i64 2688, !15, i64 2696, !15, i64 2704, !19, i64 2712, !34, i64 2720}
!58 = !{!"_ZTSN6openmc19NuclideMicroXSCacheE", !16, i64 0}
!59 = !{!"_ZTSN6openmc7MacroXSE", !15, i64 0, !15, i64 8, !15, i64 16, !15, i64 24, !15, i64 32, !16, i64 40, !15, i64 88, !15, i64 96, !15, i64 104, !15, i64 112}
!60 = !{!"_ZTSN6openmc8Particle4TypeE", !16, i64 0}
!61 = !{!"_ZTSN6openmc8PositionE", !15, i64 0, !15, i64 8, !15, i64 16}
!62 = !{!"_ZTSN6openmc10TallyEventE", !16, i64 0}
!63 = !{!"_ZTSN6openmc12BoundaryInfoE", !15, i64 0, !19, i64 8, !19, i64 12, !64, i64 16}
!64 = !{!"_ZTSSt5arrayIiLm3EE", !16, i64 0}
!65 = !{!"_ZTSSt6vectorIS_IN6openmc8PositionESaIS1_EESaIS3_EE", !66, i64 0}
!66 = !{!"_ZTSSt12_Vector_baseISt6vectorIN6openmc8PositionESaIS2_EESaIS4_EE", !67, i64 0}
!67 = !{!"_ZTSNSt12_Vector_baseISt6vectorIN6openmc8PositionESaIS2_EESaIS4_EE12_Vector_implE", !68, i64 0}
!68 = !{!"_ZTSNSt12_Vector_baseISt6vectorIN6openmc8PositionESaIS2_EESaIS4_EE17_Vector_impl_dataE", !69, i64 0, !69, i64 8, !69, i64 16}
!69 = !{!"p1 _ZTSSt6vectorIN6openmc8PositionESaIS1_EE", !24, i64 0}
!70 = distinct !{!70, !71}
...
!74 = distinct !{!74, !71}
!75 = !{!76, !19, i64 1504}
!76 = !{!"_ZTSN6openmc11FilterMatchE", !16, i64 0, !16, i64 504, !19, i64 1504, !19, i64 1508, !44, i64 1512}
!77 = !{!78, !78, i64 0}
!78 = !{!"bool", !79, i64 0}
