; ModuleID = 'filter_surface-openmp-amdgcn-amd-amdhsa-gfx942.tmp.bc'
source_filename = "/g/g0/wright117/workspace/openmc/openmc-omp/openmc/src/tallies/filter_surface.cpp"
...
define hidden void @_ZNK6openmc6Filter26SurfaceFilter_get_all_binsERKNS_8ParticleENS_14TallyEstimatorERNS_11FilterMatchE(ptr noundef nonnull align 8 dereferenceable(448) %this, ptr noundef nonnull align 8 dereferenceable(2728) %p, i32 noundef %estimator, ptr noundef nonnull align 8 dereferenceable(1513) %match) #3 align 2 {
entry:
  ...
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %search) #9
  ...
  %1 = load i32, ptr %surface_, align 8, !tbaa !31
  %call = call noundef i32 @"_ZL28abs$ompvariant$S2$s7$Pamdgcni"(i32 noundef %1) #11
  %sub = sub nsw i32 %call, 1
  %call2 = call noundef ptr @_ZNK6openmc10static_mapIiiNS_12integer_hashIiEEE4findEi(ptr noundef nonnull align 8 dereferenceable(50) %map_, i32 noundef %sub) #12
  store ptr %call2, ptr %search.ascast, align 8, !tbaa !47
  %2 = load ptr, ptr %search.ascast, align 8, !tbaa !47
  %map_3 = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 6
  %call4 = call noundef ptr @_ZNK6openmc10static_mapIiiNS_12integer_hashIiEEE3endEv(ptr noundef nonnull align 8 dereferenceable(50) %map_3) #12
  %cmp = icmp ne ptr %2, %call4
  br i1 %cmp, label %if.then, label %if.end9

if.then:                                          ; preds = %entry
  %3 = load ptr, ptr %p.addr.ascast, align 8, !tbaa !25
  %surface_5 = getelementptr inbounds nuw %"class.openmc::Particle", ptr %3, i32 0, i32 30
  %4 = load i32, ptr %surface_5, align 8, !tbaa !31
  %cmp6 = icmp slt i32 %4, 0
  br i1 %cmp6, label %if.then7, label %if.else

if.then7:                                         ; preds = %if.then
  %5 = load ptr, ptr %match.addr.ascast, align 8, !tbaa !29
  %6 = load ptr, ptr %search.ascast, align 8, !tbaa !47
  %second = getelementptr inbounds nuw %"struct.std::pair", ptr %6, i32 0, i32 1
  %7 = load i32, ptr %second, align 4, !tbaa !49
  call void @_ZN6openmc11FilterMatch9push_backEid(ptr noundef nonnull align 8 dereferenceable(1513) %5, i32 noundef %7, double noundef -1.000000e+00) #12
  br label %if.end

if.else:                                          ; preds = %if.then
  %8 = load ptr, ptr %match.addr.ascast, align 8, !tbaa !29
  %9 = load ptr, ptr %search.ascast, align 8, !tbaa !47
  %second8 = getelementptr inbounds nuw %"struct.std::pair", ptr %9, i32 0, i32 1
  %10 = load i32, ptr %second8, align 4, !tbaa !49
  call void @_ZN6openmc11FilterMatch9push_backEid(ptr noundef nonnull align 8 dereferenceable(1513) %8, i32 noundef %10, double noundef 1.000000e+00) #12
  br label %if.end
...
if.end9:                                          ; preds = %if.end, %entry
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %search) #9
  ret void
}

; Function Attrs: convergent inlinehint mustprogress nounwind
define linkonce_odr hidden noundef ptr @_ZNK6openmc10static_mapIiiNS_12integer_hashIiEEE4findEi(ptr noundef nonnull align 8 dereferenceable(50) %this, i32 noundef %key) #4 comdat align 2 {
entry:
  %retval = alloca ptr, align 8, addrspace(5)
  %this.addr = alloca ptr, align 8, addrspace(5)
  %key.addr = alloca i32, align 4, addrspace(5)
  ...
  store i32 %key, ptr %key.addr.ascast, align 4, !tbaa !18
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %idx) #9
  %call = call noundef i64 @_ZNK6openmc10static_mapIiiNS_12integer_hashIiEEE12bucket_indexERKi(ptr noundef nonnull align 8 dereferenceable(50) %this1, ptr noundef nonnull align 4 dereferenceable(4) %key.addr.ascast) #12
  store i64 %call, ptr %idx.ascast, align 8, !tbaa !53
  call void @llvm.lifetime.start.p5(i64 16, ptr addrspace(5) %bounds) #9
  %buckets_ = getelementptr inbounds nuw %"class.openmc::static_map", ptr %this1, i32 0, i32 1
  %0 = load i64, ptr %idx.ascast, align 8, !tbaa !53
  %call2 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNK6openmc6vectorISt4pairImmEEixEm(ptr noundef nonnull align 8 dereferenceable(24) %buckets_, i64 noundef %0) #12
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %bounds.ascast, ptr align 8 %call2, i64 16, i1 false)
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %last) #9
  %items_ = getelementptr inbounds nuw %"class.openmc::static_map", ptr %this1, i32 0, i32 0
  %call3 = call noundef ptr @_ZNK6openmc6vectorISt4pairIiiEE5beginEv(ptr noundef nonnull align 8 dereferenceable(24) %items_) #12
  %second = getelementptr inbounds nuw %"struct.std::pair.9", ptr %bounds.ascast, i32 0, i32 1
  %1 = load i64, ptr %second, align 8, !tbaa !54
  %add.ptr = getelementptr inbounds nuw %"struct.std::pair", ptr %call3, i64 %1
  store ptr %add.ptr, ptr %last.ascast, align 8, !tbaa !47
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %iter) #9
  %items_4 = getelementptr inbounds nuw %"class.openmc::static_map", ptr %this1, i32 0, i32 0
  %call5 = call noundef ptr @_ZNK6openmc6vectorISt4pairIiiEE5beginEv(ptr noundef nonnull align 8 dereferenceable(24) %items_4) #12
  %first = getelementptr inbounds nuw %"struct.std::pair.9", ptr %bounds.ascast, i32 0, i32 0
  %2 = load i64, ptr %first, align 8, !tbaa !56
  %add.ptr6 = getelementptr inbounds nuw %"struct.std::pair", ptr %call5, i64 %2
  store ptr %add.ptr6, ptr %iter.ascast, align 8, !tbaa !47
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %3 = load ptr, ptr %iter.ascast, align 8, !tbaa !47
  %4 = load ptr, ptr %last.ascast, align 8, !tbaa !47
  %cmp = icmp ne ptr %3, %4
...
for.body:                                         ; preds = %for.cond
  %5 = load i32, ptr %key.addr.ascast, align 4, !tbaa !18
  %6 = load ptr, ptr %iter.ascast, align 8, !tbaa !47
  %first7 = getelementptr inbounds nuw %"struct.std::pair", ptr %6, i32 0, i32 0
  %7 = load i32, ptr %first7, align 4, !tbaa !57
  %cmp8 = icmp eq i32 %5, %7
  br i1 %cmp8, label %if.then, label %if.end

if.then:                                          ; preds = %for.body
  %8 = load ptr, ptr %iter.ascast, align 8, !tbaa !47
...
for.inc:                                          ; preds = %if.end
  %9 = load ptr, ptr %iter.ascast, align 8, !tbaa !47
  %incdec.ptr = getelementptr inbounds nuw %"struct.std::pair", ptr %9, i32 1
  store ptr %incdec.ptr, ptr %iter.ascast, align 8, !tbaa !47
  br label %for.cond, !llvm.loop !58

cleanup:                                          ; preds = %if.then, %for.cond.cleanup
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %iter) #9
...
for.end:                                          ; preds = %cleanup
  ...
  %call10 = call noundef ptr @_ZNK6openmc6vectorISt4pairIiiEE3endEv(ptr noundef nonnull align 8 dereferenceable(24) %items_9) #12
  store ptr %call10, ptr %retval.ascast, align 8
  store i32 1, ptr %cleanup.dest.slot.ascast, align 4
  br label %cleanup11

cleanup11:                                        ; preds = %for.end, %cleanup
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %last) #9
  call void @llvm.lifetime.end.p5(i64 16, ptr addrspace(5) %bounds) #9
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %idx) #9
...
entry:
  ...
  store i32 %__x, ptr %__x.addr.ascast, align 4, !tbaa !18
  %0 = load i32, ptr %__x.addr.ascast, align 4, !tbaa !18
  %1 = call i32 @llvm.abs.i32(i32 %0, i1 true)
  ret i32 %1
}

; Function Attrs: convergent mustprogress nounwind
define linkonce_odr hidden noundef ptr @_ZNK6openmc10static_mapIiiNS_12integer_hashIiEEE3endEv(ptr noundef nonnull align 8 dereferenceable(50) %this) #3 comdat align 2 {
entry:
  %retval = alloca ptr, align 8, addrspace(5)
  %this.addr = alloca ptr, align 8, addrspace(5)
  %retval.ascast = addrspacecast ptr addrspace(5) %retval to ptr
  ...
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  %items_ = getelementptr inbounds nuw %"class.openmc::static_map", ptr %this1, i32 0, i32 0
  %call = call noundef ptr @_ZNK6openmc6vectorISt4pairIiiEE3endEv(ptr noundef nonnull align 8 dereferenceable(24) %items_) #12
  ret ptr %call
}
...
entry:
  ...
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  %call = call noundef zeroext i1 @_ZN6openmc11FilterMatch7is_fullEv(ptr noundef nonnull align 8 dereferenceable(1513) %this1) #12
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i32, ptr %bins_weights_length_, align 8, !tbaa !60
  ...
  %3 = load i32, ptr %bins_weights_length_2, align 8, !tbaa !60
  ...
  %4 = load i32, ptr %bins_weights_length_5, align 8, !tbaa !60
  %inc = add nsw i32 %4, 1
  store i32 %inc, ptr %bins_weights_length_5, align 8, !tbaa !60
  br label %if.end
...
; Function Attrs: convergent mustprogress nounwind
define linkonce_odr hidden noundef i64 @_ZNK6openmc10static_mapIiiNS_12integer_hashIiEEE12bucket_indexERKi(ptr noundef nonnull align 8 dereferenceable(50) %this, ptr noundef nonnull align 4 dereferenceable(4) %key) #3 comdat align 2 {
entry:
  ...
  %key.addr.ascast = addrspacecast ptr addrspace(5) %key.addr to ptr
  store ptr %this, ptr %this.addr.ascast, align 8, !tbaa !51
  store ptr %key, ptr %key.addr.ascast, align 8, !tbaa !62
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  %0 = getelementptr inbounds i8, ptr %this1, i64 49
  %1 = load ptr, ptr %key.addr.ascast, align 8, !tbaa !62
  %2 = load i32, ptr %1, align 4, !tbaa !18
  %call = call noundef i64 @_ZNK6openmc12integer_hashIiEclEi(ptr noundef nonnull align 1 dereferenceable(1) %0, i32 noundef %2) #12
  %call2 = call noundef i64 @_ZNK6openmc10static_mapIiiNS_12integer_hashIiEEE12bucket_countEv(ptr noundef nonnull align 8 dereferenceable(50) %this1) #12
...
; Function Attrs: convergent mustprogress nounwind
define linkonce_odr hidden noundef ptr @_ZNK6openmc6vectorISt4pairIiiEE5beginEv(ptr noundef nonnull align 8 dereferenceable(24) %this) #3 comdat align 2 {
entry:
  %retval = alloca ptr, align 8, addrspace(5)
  %this.addr = alloca ptr, align 8, addrspace(5)
  %retval.ascast = addrspacecast ptr addrspace(5) %retval to ptr
...
; Function Attrs: convergent mustprogress nounwind
define linkonce_odr hidden noundef ptr @_ZNK6openmc6vectorISt4pairIiiEE3endEv(ptr noundef nonnull align 8 dereferenceable(24) %this) #3 comdat align 2 {
entry:
  %retval = alloca ptr, align 8, addrspace(5)
  %this.addr = alloca ptr, align 8, addrspace(5)
  %retval.ascast = addrspacecast ptr addrspace(5) %retval to ptr
  ...
  %1 = load i64, ptr %size_, align 8, !tbaa !73
  %add.ptr = getelementptr inbounds nuw %"struct.std::pair", ptr %0, i64 %1
  ret ptr %add.ptr
}

; Function Attrs: convergent mustprogress nounwind
define linkonce_odr hidden noundef i64 @_ZNK6openmc12integer_hashIiEclEi(ptr noundef nonnull align 1 dereferenceable(1) %this, i32 noundef %value) #3 comdat align 2 {
entry:
  %retval = alloca i64, align 8, addrspace(5)
  %this.addr = alloca ptr, align 8, addrspace(5)
  ...
  store i32 %value, ptr %value.addr.ascast, align 4, !tbaa !18
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  %0 = load i32, ptr %value.addr.ascast, align 4, !tbaa !18
  %conv = sext i32 %0 to i64
  ret i64 %conv
}

; Function Attrs: convergent mustprogress nounwind
define linkonce_odr hidden noundef i64 @_ZNK6openmc10static_mapIiiNS_12integer_hashIiEEE12bucket_countEv(ptr noundef nonnull align 8 dereferenceable(50) %this) #3 comdat align 2 {
entry:
  %retval = alloca i64, align 8, addrspace(5)
  %this.addr = alloca ptr, align 8, addrspace(5)
  %retval.ascast = addrspacecast ptr addrspace(5) %retval to ptr
  ...
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  %buckets_ = getelementptr inbounds nuw %"class.openmc::static_map", ptr %this1, i32 0, i32 1
  %call = call noundef i64 @_ZNK6openmc6vectorISt4pairImmEE4sizeEv(ptr noundef nonnull align 8 dereferenceable(24) %buckets_) #12
  ret i64 %call
}
...
entry:
  ...
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  %bins_weights_length_ = getelementptr inbounds nuw %"class.openmc::FilterMatch", ptr %this1, i32 0, i32 3
  %0 = load i32, ptr %bins_weights_length_, align 8, !tbaa !60
...
define internal double @__ocml_logb_f64(double noundef %0) #7 {
  ...
  %5 = load i8, ptr addrspace(4) @__oclc_finite_only_opt, align 1, !tbaa !77, !range !81, !noundef !82
  %6 = icmp eq i8 %5, 0
...
!47 = !{!48, !48, i64 0}
!48 = !{!"p1 _ZTSSt4pairIiiE", !24, i64 0}
!49 = !{!50, !19, i64 4}
!50 = !{!"_ZTSSt4pairIiiE", !19, i64 0, !19, i64 4}
!51 = !{!52, !52, i64 0}
!52 = !{!"p1 _ZTSN6openmc10static_mapIiiNS_12integer_hashIiEEEE", !24, i64 0}
!53 = !{!35, !35, i64 0}
!54 = !{!55, !35, i64 8}
!55 = !{!"_ZTSSt4pairImmE", !35, i64 0, !35, i64 8}
!56 = !{!55, !35, i64 0}
!57 = !{!50, !19, i64 0}
!58 = distinct !{!58, !59}
!59 = !{!"llvm.loop.mustprogress"}
!60 = !{!61, !19, i64 1504}
!61 = !{!"_ZTSN6openmc11FilterMatchE", !16, i64 0, !16, i64 504, !19, i64 1504, !19, i64 1508, !38, i64 1512}
!62 = !{!63, !63, i64 0}
!63 = !{!"p1 int", !24, i64 0}
!64 = !{!65, !65, i64 0}
!65 = !{!"p1 _ZTSN6openmc6vectorISt4pairImmEEE", !24, i64 0}
!66 = !{!67, !68, i64 0}
!67 = !{!"_ZTSN6openmc6vectorISt4pairImmEEE", !68, i64 0, !35, i64 8, !35, i64 16}
!68 = !{!"p1 _ZTSSt4pairImmE", !24, i64 0}
!69 = !{!70, !70, i64 0}
!70 = !{!"p1 _ZTSN6openmc6vectorISt4pairIiiEEE", !24, i64 0}
!71 = !{!72, !48, i64 0}
!72 = !{!"_ZTSN6openmc6vectorISt4pairIiiEEE", !48, i64 0, !35, i64 8, !35, i64 16}
!73 = !{!72, !35, i64 8}
!74 = !{!75, !75, i64 0}
!75 = !{!"p1 _ZTSN6openmc12integer_hashIiEE", !24, i64 0}
!76 = !{!67, !35, i64 8}
!77 = !{!78, !78, i64 0}
!78 = !{!"bool", !79, i64 0}
