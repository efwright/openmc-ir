; ModuleID = 'filter_cellfrom-openmp-amdgcn-amd-amdhsa-gfx942.tmp.bc'
...
define hidden void @_ZNK6openmc6Filter27CellFromFilter_get_all_binsERKNS_8ParticleENS_14TallyEstimatorERNS_11FilterMatchE(ptr noundef nonnull align 8 dereferenceable(448) %this, ptr noundef nonnull align 8 dereferenceable(2728) %p, i32 noundef %estimator, ptr noundef nonnull align 8 dereferenceable(1513) %match) #3 align 2 {
entry:
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %2 = load i32, ptr %n_coord_last_, align 8, !tbaa !31
...
if.then:                                          ; preds = %for.body
  ...
  %8 = load ptr, ptr %search.ascast, align 8, !tbaa !47
  %second = getelementptr inbounds nuw %"struct.std::pair", ptr %8, i32 0, i32 1
  %9 = load i32, ptr %second, align 4, !tbaa !49
...
entry:
  ...
  store ptr %this, ptr %this.addr.ascast, align 8, !tbaa !53
  ...
  store i64 %call, ptr %idx.ascast, align 8, !tbaa !55
  ...
  %0 = load i64, ptr %idx.ascast, align 8, !tbaa !55
  ...
  %1 = load i64, ptr %second, align 8, !tbaa !56
  ...
  %2 = load i64, ptr %first, align 8, !tbaa !58
...
for.body:                                         ; preds = %for.cond
  ...
  %7 = load i32, ptr %first7, align 4, !tbaa !59
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i32, ptr %bins_weights_length_, align 8, !tbaa !61
  ...
  %3 = load i32, ptr %bins_weights_length_2, align 8, !tbaa !61
  ...
  %4 = load i32, ptr %bins_weights_length_5, align 8, !tbaa !61
  %inc = add nsw i32 %4, 1
  store i32 %inc, ptr %bins_weights_length_5, align 8, !tbaa !61
  br label %if.end
...
entry:
  ...
  %key.addr.ascast = addrspacecast ptr addrspace(5) %key.addr to ptr
  store ptr %this, ptr %this.addr.ascast, align 8, !tbaa !53
  store ptr %key, ptr %key.addr.ascast, align 8, !tbaa !63
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  %0 = getelementptr inbounds i8, ptr %this1, i64 49
  %1 = load ptr, ptr %key.addr.ascast, align 8, !tbaa !63
...
entry:
  ...
  store ptr %this, ptr %this.addr.ascast, align 8, !tbaa !75
...
entry:
  ...
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  %bins_weights_length_ = getelementptr inbounds nuw %"class.openmc::FilterMatch", ptr %this1, i32 0, i32 3
  %0 = load i32, ptr %bins_weights_length_, align 8, !tbaa !61
...
define internal double @__ocml_logb_f64(double noundef %0) #6 {
  ...
  %5 = load i8, ptr addrspace(4) @__oclc_finite_only_opt, align 1, !tbaa !78, !range !82, !noundef !83
  %6 = icmp eq i8 %5, 0
...
!53 = !{!54, !54, i64 0}
!54 = !{!"p1 _ZTSN6openmc10static_mapIiiNS_12integer_hashIiEEEE", !24, i64 0}
!55 = !{!35, !35, i64 0}
!56 = !{!57, !35, i64 8}
!57 = !{!"_ZTSSt4pairImmE", !35, i64 0, !35, i64 8}
!58 = !{!57, !35, i64 0}
!59 = !{!50, !19, i64 0}
!60 = distinct !{!60, !52}
!61 = !{!62, !19, i64 1504}
!62 = !{!"_ZTSN6openmc11FilterMatchE", !16, i64 0, !16, i64 504, !19, i64 1504, !19, i64 1508, !38, i64 1512}
!63 = !{!64, !64, i64 0}
!64 = !{!"p1 int", !24, i64 0}
!65 = !{!66, !66, i64 0}
!66 = !{!"p1 _ZTSN6openmc6vectorISt4pairImmEEE", !24, i64 0}
!67 = !{!68, !69, i64 0}
!68 = !{!"_ZTSN6openmc6vectorISt4pairImmEEE", !69, i64 0, !35, i64 8, !35, i64 16}
!69 = !{!"p1 _ZTSSt4pairImmE", !24, i64 0}
!70 = !{!71, !71, i64 0}
!71 = !{!"p1 _ZTSN6openmc6vectorISt4pairIiiEEE", !24, i64 0}
!72 = !{!73, !48, i64 0}
!73 = !{!"_ZTSN6openmc6vectorISt4pairIiiEEE", !48, i64 0, !35, i64 8, !35, i64 16}
!74 = !{!73, !35, i64 8}
!75 = !{!76, !76, i64 0}
!76 = !{!"p1 _ZTSN6openmc12integer_hashIiEE", !24, i64 0}
!77 = !{!68, !35, i64 8}
!78 = !{!79, !79, i64 0}
!79 = !{!"bool", !80, i64 0}
