; ModuleID = 'filter_distribcell-openmp-amdgcn-amd-amdhsa-gfx942.tmp.bc'
...
%"class.openmc::Filter" = type { i32, i32, i32, i64, %"class.openmc::vector.0", %"class.openmc::vector", %"class.openmc::static_map", %"class.openmc::vector.3", %"class.openmc::static_map.4", %"class.openmc::vector", i32, i8, %"class.openmc::vector.0", double, %"class.openmc::vector.0", double, double, i32, %"class.openmc::vector", i32, %"class.openmc::vector.7", i32, i32, double, double, %"class.openmc::vector", %"class.openmc::vector" }
...
entry:
  ...
  %distribcell_index = alloca i32, align 4, addrspace(5)
  ...
  %distribcell_index.ascast = addrspacecast ptr addrspace(5) %distribcell_index to ptr
  ...
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %offset) #7
  store i32 0, ptr %offset.ascast, align 4, !tbaa !18
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %distribcell_index) #7
  %0 = load ptr, ptr addrspacecast (ptr addrspace(1) @_ZN6openmc5model12device_cellsE to ptr), align 8, !tbaa !31
  %cell_ = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 10
  %1 = load i32, ptr %cell_, align 8, !tbaa !33
  %idxprom = sext i32 %1 to i64
  %arrayidx = getelementptr inbounds %"class.openmc::Cell", ptr %0, i64 %idxprom
  %distribcell_index_ = getelementptr inbounds nuw %"class.openmc::Cell", ptr %arrayidx, i32 0, i32 6
  %2 = load i32, ptr %distribcell_index_, align 8, !tbaa !57
  store i32 %2, ptr %distribcell_index.ascast, align 4, !tbaa !18
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %i) #7
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %5 = load i32, ptr %n_coord_, align 4, !tbaa !65
...
for.body:                                         ; preds = %for.cond
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %c) #7
  %6 = load ptr, ptr addrspacecast (ptr addrspace(1) @_ZN6openmc5model12device_cellsE to ptr), align 8, !tbaa !31
  %7 = load ptr, ptr %p.addr.ascast, align 8, !tbaa !25
  %coord_ = getelementptr inbounds nuw %"class.openmc::Particle", ptr %7, i32 0, i32 8
  %8 = load i32, ptr %i.ascast, align 4, !tbaa !18
  %idxprom2 = sext i32 %8 to i64
  %arrayidx3 = getelementptr inbounds [6 x %"class.openmc::LocalCoord"], ptr %coord_, i64 0, i64 %idxprom2
  %cell = getelementptr inbounds nuw %"class.openmc::LocalCoord", ptr %arrayidx3, i32 0, i32 2
  %9 = load i32, ptr %cell, align 8, !tbaa !78
  %idxprom4 = sext i32 %9 to i64
  %arrayidx5 = getelementptr inbounds %"class.openmc::Cell", ptr %6, i64 %idxprom4
  store ptr %arrayidx5, ptr %c.ascast, align 8, !tbaa !31
  %10 = load ptr, ptr %c.ascast, align 8, !tbaa !31
  %type_ = getelementptr inbounds nuw %"class.openmc::Cell", ptr %10, i32 0, i32 2
  %11 = load i32, ptr %type_, align 8, !tbaa !80
  %cmp6 = icmp eq i32 %11, 1
  br i1 %cmp6, label %if.then, label %if.else

if.then:                                          ; preds = %for.body
  %12 = load ptr, ptr %c.ascast, align 8, !tbaa !31
  %offset_ = getelementptr inbounds nuw %"class.openmc::Cell", ptr %12, i32 0, i32 15
  %13 = load i32, ptr %distribcell_index.ascast, align 4, !tbaa !18
  %conv = sext i32 %13 to i64
  %call = call noundef nonnull align 4 dereferenceable(4) ptr @_ZN6openmc6vectorIiEixEm(ptr noundef nonnull align 8 dereferenceable(24) %offset_, i64 noundef %conv) #9
  %14 = load i32, ptr %call, align 4, !tbaa !18
  %15 = load i32, ptr %offset.ascast, align 4, !tbaa !18
  %add = add nsw i32 %15, %14
  store i32 %add, ptr %offset.ascast, align 4, !tbaa !18
  br label %if.end35

if.else:                                          ; preds = %for.body
  %16 = load ptr, ptr %c.ascast, align 8, !tbaa !31
  %type_7 = getelementptr inbounds nuw %"class.openmc::Cell", ptr %16, i32 0, i32 2
  %17 = load i32, ptr %type_7, align 8, !tbaa !80
  %cmp8 = icmp eq i32 %17, 2
  br i1 %cmp8, label %if.then9, label %if.end34

if.then9:                                         ; preds = %if.else
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %lat) #7
  %18 = load ptr, ptr addrspacecast (ptr addrspace(1) @_ZN6openmc5model15device_latticesE to ptr), align 8, !tbaa !81
  %19 = load ptr, ptr %p.addr.ascast, align 8, !tbaa !25
  %coord_10 = getelementptr inbounds nuw %"class.openmc::Particle", ptr %19, i32 0, i32 8
  %20 = load i32, ptr %i.ascast, align 4, !tbaa !18
  %add11 = add nsw i32 %20, 1
  %idxprom12 = sext i32 %add11 to i64
  %arrayidx13 = getelementptr inbounds [6 x %"class.openmc::LocalCoord"], ptr %coord_10, i64 0, i64 %idxprom12
  %lattice = getelementptr inbounds nuw %"class.openmc::LocalCoord", ptr %arrayidx13, i32 0, i32 4
  %21 = load i32, ptr %lattice, align 8, !tbaa !83
  %idxprom14 = sext i32 %21 to i64
  %arrayidx15 = getelementptr inbounds %"class.openmc::Lattice", ptr %18, i64 %idxprom14
  store ptr %arrayidx15, ptr %lat.ascast, align 8, !tbaa !81
  call void @llvm.lifetime.start.p5(i64 12, ptr addrspace(5) %i_xyz) #7
  %22 = load ptr, ptr %p.addr.ascast, align 8, !tbaa !25
  %coord_16 = getelementptr inbounds nuw %"class.openmc::Particle", ptr %22, i32 0, i32 8
  %23 = load i32, ptr %i.ascast, align 4, !tbaa !18
  %add17 = add nsw i32 %23, 1
  %idxprom18 = sext i32 %add17 to i64
  %arrayidx19 = getelementptr inbounds [6 x %"class.openmc::LocalCoord"], ptr %coord_16, i64 0, i64 %idxprom18
  %lattice_x = getelementptr inbounds nuw %"class.openmc::LocalCoord", ptr %arrayidx19, i32 0, i32 5
  %24 = load i32, ptr %lattice_x, align 4, !tbaa !84
  store i32 %24, ptr %i_xyz.ascast, align 4, !tbaa !18
  %arrayinit.element = getelementptr inbounds i32, ptr %i_xyz.ascast, i64 1
  %25 = load ptr, ptr %p.addr.ascast, align 8, !tbaa !25
  %coord_20 = getelementptr inbounds nuw %"class.openmc::Particle", ptr %25, i32 0, i32 8
  %26 = load i32, ptr %i.ascast, align 4, !tbaa !18
  %add21 = add nsw i32 %26, 1
  %idxprom22 = sext i32 %add21 to i64
  %arrayidx23 = getelementptr inbounds [6 x %"class.openmc::LocalCoord"], ptr %coord_20, i64 0, i64 %idxprom22
  %lattice_y = getelementptr inbounds nuw %"class.openmc::LocalCoord", ptr %arrayidx23, i32 0, i32 6
  %27 = load i32, ptr %lattice_y, align 8, !tbaa !85
  store i32 %27, ptr %arrayinit.element, align 4, !tbaa !18
  %arrayinit.element24 = getelementptr inbounds i32, ptr %i_xyz.ascast, i64 2
  %28 = load ptr, ptr %p.addr.ascast, align 8, !tbaa !25
  %coord_25 = getelementptr inbounds nuw %"class.openmc::Particle", ptr %28, i32 0, i32 8
  %29 = load i32, ptr %i.ascast, align 4, !tbaa !18
  %add26 = add nsw i32 %29, 1
  %idxprom27 = sext i32 %add26 to i64
  %arrayidx28 = getelementptr inbounds [6 x %"class.openmc::LocalCoord"], ptr %coord_25, i64 0, i64 %idxprom27
  %lattice_z = getelementptr inbounds nuw %"class.openmc::LocalCoord", ptr %arrayidx28, i32 0, i32 7
  %30 = load i32, ptr %lattice_z, align 4, !tbaa !86
  store i32 %30, ptr %arrayinit.element24, align 4, !tbaa !18
  %31 = load ptr, ptr %lat.ascast, align 8, !tbaa !81
  %arraydecay = getelementptr inbounds [3 x i32], ptr %i_xyz.ascast, i64 0, i64 0
  %call29 = call noundef zeroext i1 @_ZNK6openmc7Lattice17are_valid_indicesEPKi(ptr noundef nonnull align 8 dereferenceable(209) %31, ptr noundef %arraydecay) #9
  br i1 %call29, label %if.then30, label %if.end

if.then30:                                        ; preds = %if.then9
  %32 = load ptr, ptr %lat.ascast, align 8, !tbaa !81
  %33 = load i32, ptr %distribcell_index.ascast, align 4, !tbaa !18
  %arraydecay31 = getelementptr inbounds [3 x i32], ptr %i_xyz.ascast, i64 0, i64 0
  %call32 = call noundef nonnull align 4 dereferenceable(4) ptr @_ZN6openmc7Lattice6offsetEiPKi(ptr noundef nonnull align 8 dereferenceable(209) %32, i32 noundef %33, ptr noundef %arraydecay31) #9
  %34 = load i32, ptr %call32, align 4, !tbaa !18
  %35 = load i32, ptr %offset.ascast, align 4, !tbaa !18
  %add33 = add nsw i32 %35, %34
  store i32 %add33, ptr %offset.ascast, align 4, !tbaa !18
  br label %if.end

if.end:                                           ; preds = %if.then30, %if.then9
  call void @llvm.lifetime.end.p5(i64 12, ptr addrspace(5) %i_xyz) #7
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %lat) #7
  br label %if.end34

if.end34:                                         ; preds = %if.end, %if.else
  br label %if.end35

if.end35:                                         ; preds = %if.end34, %if.then
  %cell_36 = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 10
  %36 = load i32, ptr %cell_36, align 8, !tbaa !33
  %37 = load ptr, ptr %p.addr.ascast, align 8, !tbaa !25
  %coord_37 = getelementptr inbounds nuw %"class.openmc::Particle", ptr %37, i32 0, i32 8
  %38 = load i32, ptr %i.ascast, align 4, !tbaa !18
  %idxprom38 = sext i32 %38 to i64
  %arrayidx39 = getelementptr inbounds [6 x %"class.openmc::LocalCoord"], ptr %coord_37, i64 0, i64 %idxprom38
  %cell40 = getelementptr inbounds nuw %"class.openmc::LocalCoord", ptr %arrayidx39, i32 0, i32 2
  %39 = load i32, ptr %cell40, align 8, !tbaa !78
  %cmp41 = icmp eq i32 %36, %39
  br i1 %cmp41, label %if.then42, label %if.end43

if.then42:                                        ; preds = %if.end35
  %40 = load ptr, ptr %match.addr.ascast, align 8, !tbaa !29
  %41 = load i32, ptr %offset.ascast, align 4, !tbaa !18
  call void @_ZN6openmc11FilterMatch9push_backEid(ptr noundef nonnull align 8 dereferenceable(1513) %40, i32 noundef %41, double noundef 1.000000e+00) #9
...
cleanup:                                          ; preds = %if.end43, %if.then42
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %c) #7
...
for.inc:                                          ; preds = %cleanup.cont
  %42 = load i32, ptr %i.ascast, align 4, !tbaa !18
  %inc = add nsw i32 %42, 1
  store i32 %inc, ptr %i.ascast, align 4, !tbaa !18
  br label %for.cond, !llvm.loop !87

cleanup44:                                        ; preds = %cleanup, %for.cond.cleanup
  call void @llvm.lifetime.end.p5(i64 4, ptr addrspace(5) %i) #7
  %cleanup.dest45 = load i32, ptr %cleanup.dest.slot.ascast, align 4
...
cleanup46:                                        ; preds = %for.end, %cleanup44
  call void @llvm.lifetime.end.p5(i64 4, ptr addrspace(5) %distribcell_index) #7
  call void @llvm.lifetime.end.p5(i64 4, ptr addrspace(5) %offset) #7
...
cleanup.cont49:                                   ; preds = %cleanup46, %cleanup46
  ret void
...
entry:
  ...
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  %call = call noundef zeroext i1 @_ZN6openmc11FilterMatch7is_fullEv(ptr noundef nonnull align 8 dereferenceable(1513) %this1) #9
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i32, ptr %bins_weights_length_, align 8, !tbaa !93
  %idxprom = sext i32 %1 to i64
  ...
  %3 = load i32, ptr %bins_weights_length_2, align 8, !tbaa !93
  ...
  %4 = load i32, ptr %bins_weights_length_5, align 8, !tbaa !93
  %inc = add nsw i32 %4, 1
  store i32 %inc, ptr %bins_weights_length_5, align 8, !tbaa !93
  br label %if.end
...
entry:
  ...
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  %bins_weights_length_ = getelementptr inbounds nuw %"class.openmc::FilterMatch", ptr %this1, i32 0, i32 3
  %0 = load i32, ptr %bins_weights_length_, align 8, !tbaa !93
...
!31 = !{!32, !32, i64 0}
!32 = !{!"p1 _ZTSN6openmc4CellE", !24, i64 0}
!33 = !{!34, !19, i64 232}
!34 = !{!"_ZTSN6openmc6FilterE", !35, i64 0, !19, i64 4, !19, i64 8, !36, i64 16, !37, i64 24, !39, i64 48, !41, i64 72, !48, i64 128, !50, i64 152, !39, i64 208, !19, i64 232, !46, i64 236, !37, i64 240, !15, i64 264, !37, i64 272, !15, i64 296, !15, i64 304, !19, i64 312, !39, i64 320, !19, i64 344, !54, i64 352, !55, i64 376, !56, i64 380, !15, i64 384, !15, i64 392, !39, i64 400, !39, i64 424}
!35 = !{!"_ZTSN6openmc6Filter10FilterTypeE", !16, i64 0}
!36 = !{!"long", !16, i64 0}
!37 = !{!"_ZTSN6openmc6vectorIdEE", !38, i64 0, !36, i64 8, !36, i64 16}
!38 = !{!"p1 double", !24, i64 0}
...
!52 = !{!"p1 _ZTSSt4pairIN6openmc12CellInstanceElE", !24, i64 0}
!53 = !{!"_ZTSN6openmc16CellInstanceHashE"}
!54 = !{!"_ZTSN6openmc6vectorINS_8Particle4TypeEEE", !24, i64 0, !36, i64 8, !36, i64 16}
!55 = !{!"_ZTSN6openmc24SphericalHarmonicsCosineE", !16, i64 0}
!56 = !{!"_ZTSN6openmc12LegendreAxisE", !16, i64 0}
!57 = !{!58, !19, i64 56}
!58 = !{!"_ZTSN6openmc4CellE", !19, i64 0, !59, i64 8, !62, i64 40, !19, i64 44, !19, i64 48, !19, i64 52, !19, i64 56, !39, i64 64, !37, i64 88, !39, i64 112, !46, i64 136, !63, i64 140, !64, i64 344, !16, i64 368, !19, i64 464, !39, i64 472}
!59 = !{!"_ZTSNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE", !60, i64 0, !36, i64 8, !16, i64 16}
!60 = !{!"_ZTSNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE12_Alloc_hiderE", !61, i64 0}
!61 = !{!"p1 omnipotent char", !24, i64 0}
!62 = !{!"_ZTSN6openmc4FillE", !16, i64 0}
!63 = !{!"_ZTSN6openmc12NeighborListE", !16, i64 0}
!64 = !{!"_ZTSN6openmc8PositionE", !15, i64 0, !15, i64 8, !15, i64 16}
!65 = !{!66, !19, i64 876}
!66 = !{!"_ZTSN6openmc8ParticleE", !67, i64 0, !16, i64 168, !68, i64 744, !36, i64 864, !69, i64 872, !19, i64 876, !19, i64 880, !16, i64 888, !19, i64 1368, !16, i64 1372, !15, i64 1400, !15, i64 1408, !19, i64 1416, !19, i64 1420, !15, i64 1424, !15, i64 1432, !64, i64 1440, !64, i64 1464, !64, i64 1488, !15, i64 1512, !46, i64 1520, !70, i64 1524, !19, i64 1528, !19, i64 1532, !19, i64 1536, !19, i64 1540, !19, i64 1544, !15, i64 1552, !16, i64 1560, !19, i64 1592, !19, i64 1596, !19, i64 1600, !19, i64 1604, !71, i64 1608, !15, i64 1640, !15, i64 1648, !19, i64 1656, !46, i64 1660, !16, i64 1664, !19, i64 1728, !16, i64 1736, !36, i64 2216, !36, i64 2224, !16, i64 2232, !30, i64 2240, !73, i64 2248, !16, i64 2272, !15, i64 2656, !15, i64 2664, !15, i64 2672, !15, i64 2680, !46, i64 2688, !15, i64 2696, !15, i64 2704, !19, i64 2712, !36, i64 2720}
!67 = !{!"_ZTSN6openmc19NuclideMicroXSCacheE", !16, i64 0}
!68 = !{!"_ZTSN6openmc7MacroXSE", !15, i64 0, !15, i64 8, !15, i64 16, !15, i64 24, !15, i64 32, !16, i64 40, !15, i64 88, !15, i64 96, !15, i64 104, !15, i64 112}
!69 = !{!"_ZTSN6openmc8Particle4TypeE", !16, i64 0}
!70 = !{!"_ZTSN6openmc10TallyEventE", !16, i64 0}
!71 = !{!"_ZTSN6openmc12BoundaryInfoE", !15, i64 0, !19, i64 8, !19, i64 12, !72, i64 16}
!72 = !{!"_ZTSSt5arrayIiLm3EE", !16, i64 0}
...
!77 = !{!"p1 _ZTSSt6vectorIN6openmc8PositionESaIS1_EE", !24, i64 0}
!78 = !{!79, !19, i64 48}
!79 = !{!"_ZTSN6openmc10LocalCoordE", !64, i64 0, !64, i64 24, !19, i64 48, !19, i64 52, !19, i64 56, !19, i64 60, !19, i64 64, !19, i64 68, !46, i64 72}
!80 = !{!58, !62, i64 40}
!81 = !{!82, !82, i64 0}
!82 = !{!"p1 _ZTSN6openmc7LatticeE", !24, i64 0}
!83 = !{!79, !19, i64 56}
!84 = !{!79, !19, i64 60}
!85 = !{!79, !19, i64 64}
!86 = !{!79, !19, i64 68}
...
!89 = !{!90, !90, i64 0}
!90 = !{!"p1 _ZTSN6openmc6vectorIiEE", !24, i64 0}
!91 = !{!36, !36, i64 0}
!92 = !{!39, !40, i64 0}
!93 = !{!94, !19, i64 1504}
!94 = !{!"_ZTSN6openmc11FilterMatchE", !16, i64 0, !16, i64 504, !19, i64 1504, !19, i64 1508, !46, i64 1512}
!95 = !{!96, !96, i64 0}
!96 = !{!"bool", !97, i64 0}
