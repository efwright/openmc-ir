; ModuleID = 'filter_energy-openmp-amdgcn-amd-amdhsa-gfx942.tmp.bc'
...
entry:
  ...
  %bin = alloca i64, align 8, addrspace(5)
  ...
  %bin.ascast = addrspacecast ptr addrspace(5) %bin to ptr
  ...
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %E) #8
  ...
  store double %1, ptr %E.ascast, align 8, !tbaa !14
  %2 = load double, ptr %E.ascast, align 8, !tbaa !14
  %bins_ = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 4
  %call = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNK6openmc6vectorIdE5frontEv(ptr noundef nonnull align 8 dereferenceable(24) %bins_) #10
  %3 = load double, ptr %call, align 8, !tbaa !14
  %cmp = fcmp oge double %2, %3
  br i1 %cmp, label %land.lhs.true, label %if.end

land.lhs.true:                                    ; preds = %entry
  %4 = load double, ptr %E.ascast, align 8, !tbaa !14
  %bins_2 = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 4
  %call3 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNK6openmc6vectorIdE4backEv(ptr noundef nonnull align 8 dereferenceable(24) %bins_2) #10
  %5 = load double, ptr %call3, align 8, !tbaa !14
  %cmp4 = fcmp ole double %4, %5
  br i1 %cmp4, label %if.then, label %if.end

if.then:                                          ; preds = %land.lhs.true
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %bin) #8
  %bins_5 = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 4
  %call6 = call noundef ptr @_ZNK6openmc6vectorIdE5beginEv(ptr noundef nonnull align 8 dereferenceable(24) %bins_5) #10
  %bins_7 = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 4
  %call8 = call noundef ptr @_ZNK6openmc6vectorIdE3endEv(ptr noundef nonnull align 8 dereferenceable(24) %bins_7) #10
  %call9 = call noundef i64 @_ZN6openmc17lower_bound_indexIPKddEENSt15iterator_traitsIT_E15difference_typeES4_S4_RKT0_(ptr noundef %call6, ptr noundef %call8, ptr noundef nonnull align 8 dereferenceable(8) %E.ascast) #10
  store i64 %call9, ptr %bin.ascast, align 8, !tbaa !47
  %6 = load ptr, ptr %match.addr.ascast, align 8, !tbaa !29
  %7 = load i64, ptr %bin.ascast, align 8, !tbaa !47
  %conv = trunc i64 %7 to i32
  call void @_ZN6openmc11FilterMatch9push_backEid(ptr noundef nonnull align 8 dereferenceable(1513) %6, i32 noundef %conv, double noundef 1.000000e+00) #10
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %bin) #8
  br label %if.end

if.end:                                           ; preds = %if.then, %land.lhs.true, %entry
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %E) #8
  ret void
}
...
entry:
  ...
  %1 = load double, ptr %E_, align 8, !tbaa !64
  %bins_ = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 4
  %call = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNK6openmc6vectorIdE5frontEv(ptr noundef nonnull align 8 dereferenceable(24) %bins_) #10
...
land.lhs.true:                                    ; preds = %entry
  ...
  %E_2 = getelementptr inbounds nuw %"class.openmc::Particle", ptr %3, i32 0, i32 11
  %4 = load double, ptr %E_2, align 8, !tbaa !64
  %bins_3 = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 4
  %call4 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNK6openmc6vectorIdE4backEv(ptr noundef nonnull align 8 dereferenceable(24) %bins_3) #10
...
if.then:                                          ; preds = %land.lhs.true
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %bin) #8
  %bins_6 = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 4
  %call7 = call noundef ptr @_ZNK6openmc6vectorIdE5beginEv(ptr noundef nonnull align 8 dereferenceable(24) %bins_6) #10
  %bins_8 = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 4
  %call9 = call noundef ptr @_ZNK6openmc6vectorIdE3endEv(ptr noundef nonnull align 8 dereferenceable(24) %bins_8) #10
  %6 = load ptr, ptr %p.addr.ascast, align 8, !tbaa !25
  %E_10 = getelementptr inbounds nuw %"class.openmc::Particle", ptr %6, i32 0, i32 11
  %call11 = call noundef i64 @_ZN6openmc17lower_bound_indexIPKddEENSt15iterator_traitsIT_E15difference_typeES4_S4_RKT0_(ptr noundef %call7, ptr noundef %call9, ptr noundef nonnull align 8 dereferenceable(8) %E_10) #10
  store i64 %call11, ptr %bin.ascast, align 8, !tbaa !47
  %7 = load ptr, ptr %match.addr.ascast, align 8, !tbaa !29
  %8 = load i64, ptr %bin.ascast, align 8, !tbaa !47
  %conv = trunc i64 %8 to i32
  call void @_ZN6openmc11FilterMatch9push_backEid(ptr noundef nonnull align 8 dereferenceable(1513) %7, i32 noundef %conv, double noundef 1.000000e+00) #10
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %bin) #8
  br label %if.end
...
define internal double @__ocml_logb_f64(double noundef %0) #6 {
  ...
  %5 = load i8, ptr addrspace(4) @__oclc_finite_only_opt, align 1, !tbaa !65, !range !69, !noundef !70
  %6 = icmp eq i8 %5, 0
