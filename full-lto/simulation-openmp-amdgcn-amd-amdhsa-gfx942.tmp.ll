; ModuleID = 'simulation-openmp-amdgcn-amd-amdhsa-gfx942.tmp.bc'
...
@current_batch = protected addrspace(1) global i32 0, align 4
@current_gen = protected addrspace(1) global i32 0, align 4
@keff = protected addrspace(1) global double 1.000000e+00, align 8
@n_lost_particles = protected addrspace(1) global i32 0, align 4
@need_depletion_rx = protected addrspace(1) global i8 0, align 1
@depletion_scores_present = protected addrspace(1) global i8 0, align 1
@total_gen = protected addrspace(1) global i32 0, align 4
...
@_ZN6openmc10simulation11log_spacingE = protected addrspace(1) global double 0.000000e+00, align 8
@_ZN6openmc10simulation12total_weightE = protected addrspace(1) global double 0.000000e+00, align 8
@_ZN6openmc10simulation13work_per_rankE = protected addrspace(1) global i64 0, align 8
@_ZN6openmc10simulation17device_work_indexE = protected addrspace(1) global ptr null, align 8
@_ZN6openmc10simulation16device_particlesE = protected addrspace(1) global ptr null, align 8
@_ZN6openmc10simulation18device_source_bankE = external addrspace(1) global ptr, align 8
...
entry:
  ...
  store double %__a, ptr %__a.addr.ascast, align 8, !tbaa !32
  store double %__b, ptr %__b.addr.ascast, align 8, !tbaa !32
  store double %__c, ptr %__c.addr.ascast, align 8, !tbaa !32
  store double %__d, ptr %__d.addr.ascast, align 8, !tbaa !32
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %__ac) #8
  %0 = load double, ptr %__a.addr.ascast, align 8, !tbaa !32
  %1 = load double, ptr %__c.addr.ascast, align 8, !tbaa !32
  %mul = fmul double %0, %1
  store double %mul, ptr %__ac.ascast, align 8, !tbaa !32
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %__bd) #8
  %2 = load double, ptr %__b.addr.ascast, align 8, !tbaa !32
  %3 = load double, ptr %__d.addr.ascast, align 8, !tbaa !32
  %mul1 = fmul double %2, %3
  store double %mul1, ptr %__bd.ascast, align 8, !tbaa !32
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %__ad) #8
  %4 = load double, ptr %__a.addr.ascast, align 8, !tbaa !32
  %5 = load double, ptr %__d.addr.ascast, align 8, !tbaa !32
  %mul2 = fmul double %4, %5
  store double %mul2, ptr %__ad.ascast, align 8, !tbaa !32
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %__bc) #8
  %6 = load double, ptr %__b.addr.ascast, align 8, !tbaa !32
  %7 = load double, ptr %__c.addr.ascast, align 8, !tbaa !32
  %mul3 = fmul double %6, %7
  store double %mul3, ptr %__bc.ascast, align 8, !tbaa !32
  call void @llvm.lifetime.start.p5(i64 16, ptr addrspace(5) %z) #8
  %8 = load double, ptr %__ac.ascast, align 8, !tbaa !32
  %9 = load double, ptr %__bd.ascast, align 8, !tbaa !32
  %sub = fsub double %8, %9
  %z.ascast.realp = getelementptr inbounds nuw { double, double }, ptr %z.ascast, i32 0, i32 0
  store double %sub, ptr %z.ascast.realp, align 8, !tbaa !32
  %10 = load double, ptr %__ad.ascast, align 8, !tbaa !32
  %11 = load double, ptr %__bc.ascast, align 8, !tbaa !32
  %add = fadd double %10, %11
  %z.ascast.imagp = getelementptr inbounds nuw { double, double }, ptr %z.ascast, i32 0, i32 1
  store double %add, ptr %z.ascast.imagp, align 8, !tbaa !32
  %z.ascast.realp4 = getelementptr inbounds nuw { double, double }, ptr %z.ascast, i32 0, i32 0
  %12 = load double, ptr %z.ascast.realp4, align 8, !tbaa !32
...
land.lhs.true:                                    ; preds = %entry
  ...
  %13 = load double, ptr %z.ascast.imagp5, align 8, !tbaa !32
...
if.then12:                                        ; preds = %lor.lhs.false, %if.then
  %16 = load double, ptr %__a.addr.ascast, align 8, !tbaa !32
  ...
  %18 = load double, ptr %__a.addr.ascast, align 8, !tbaa !32
  %call15 = call double @__ocml_copysign_f64(double noundef %conv, double noundef %18) #9
  store double %call15, ptr %__a.addr.ascast, align 8, !tbaa !32
  %19 = load double, ptr %__b.addr.ascast, align 8, !tbaa !32
  ...
  %21 = load double, ptr %__b.addr.ascast, align 8, !tbaa !32
  %call20 = call double @__ocml_copysign_f64(double noundef %conv19, double noundef %21) #9
  store double %call20, ptr %__b.addr.ascast, align 8, !tbaa !32
  %22 = load double, ptr %__c.addr.ascast, align 8, !tbaa !32
...
if.end30:                                         ; preds = %if.end29, %lor.lhs.false
  %26 = load double, ptr %__c.addr.ascast, align 8, !tbaa !32
...
lor.lhs.false33:                                  ; preds = %if.end30
  %27 = load double, ptr %__d.addr.ascast, align 8, !tbaa !32
...
if.then36:                                        ; preds = %lor.lhs.false33, %if.end30
  %28 = load double, ptr %__c.addr.ascast, align 8, !tbaa !32
  ...
  %30 = load double, ptr %__c.addr.ascast, align 8, !tbaa !32
  %call41 = call double @__ocml_copysign_f64(double noundef %conv40, double noundef %30) #9
  store double %call41, ptr %__c.addr.ascast, align 8, !tbaa !32
  %31 = load double, ptr %__d.addr.ascast, align 8, !tbaa !32
...
land.lhs.true59:                                  ; preds = %if.end57
  %39 = load double, ptr %__ac.ascast, align 8, !tbaa !32
...
if.then94:                                        ; preds = %if.end92
  %52 = load double, ptr %__a.addr.ascast, align 8, !tbaa !32
  %53 = load double, ptr %__c.addr.ascast, align 8, !tbaa !32
  %54 = load double, ptr %__b.addr.ascast, align 8, !tbaa !32
  %55 = load double, ptr %__d.addr.ascast, align 8, !tbaa !32
  ...
  store double %mul97, ptr %z.ascast.realp98, align 8, !tbaa !32
  %57 = load double, ptr %__a.addr.ascast, align 8, !tbaa !32
  %58 = load double, ptr %__d.addr.ascast, align 8, !tbaa !32
  %59 = load double, ptr %__b.addr.ascast, align 8, !tbaa !32
  %60 = load double, ptr %__c.addr.ascast, align 8, !tbaa !32
  ...
  store double %mul101, ptr %z.ascast.imagp102, align 8, !tbaa !32
  br label %if.end103
...
entry:
  ...
  %z.ascast = addrspacecast ptr addrspace(5) %z to ptr
  %__recalc.ascast = addrspacecast ptr addrspace(5) %__recalc to ptr
  store float %__a, ptr %__a.addr.ascast, align 4, !tbaa !38
  store float %__b, ptr %__b.addr.ascast, align 4, !tbaa !38
  store float %__c, ptr %__c.addr.ascast, align 4, !tbaa !38
  store float %__d, ptr %__d.addr.ascast, align 4, !tbaa !38
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %__ac) #8
  %0 = load float, ptr %__a.addr.ascast, align 4, !tbaa !38
  %1 = load float, ptr %__c.addr.ascast, align 4, !tbaa !38
  %mul = fmul float %0, %1
  store float %mul, ptr %__ac.ascast, align 4, !tbaa !38
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %__bd) #8
  %2 = load float, ptr %__b.addr.ascast, align 4, !tbaa !38
  %3 = load float, ptr %__d.addr.ascast, align 4, !tbaa !38
  %mul1 = fmul float %2, %3
  store float %mul1, ptr %__bd.ascast, align 4, !tbaa !38
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %__ad) #8
  %4 = load float, ptr %__a.addr.ascast, align 4, !tbaa !38
  %5 = load float, ptr %__d.addr.ascast, align 4, !tbaa !38
  %mul2 = fmul float %4, %5
  store float %mul2, ptr %__ad.ascast, align 4, !tbaa !38
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %__bc) #8
  %6 = load float, ptr %__b.addr.ascast, align 4, !tbaa !38
  %7 = load float, ptr %__c.addr.ascast, align 4, !tbaa !38
  %mul3 = fmul float %6, %7
  store float %mul3, ptr %__bc.ascast, align 4, !tbaa !38
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %z) #8
  %8 = load float, ptr %__ac.ascast, align 4, !tbaa !38
  %9 = load float, ptr %__bd.ascast, align 4, !tbaa !38
  %sub = fsub float %8, %9
  %z.ascast.realp = getelementptr inbounds nuw { float, float }, ptr %z.ascast, i32 0, i32 0
  store float %sub, ptr %z.ascast.realp, align 4, !tbaa !38
  %10 = load float, ptr %__ad.ascast, align 4, !tbaa !38
  %11 = load float, ptr %__bc.ascast, align 4, !tbaa !38
  %add = fadd float %10, %11
  %z.ascast.imagp = getelementptr inbounds nuw { float, float }, ptr %z.ascast, i32 0, i32 1
  store float %add, ptr %z.ascast.imagp, align 4, !tbaa !38
  %z.ascast.realp4 = getelementptr inbounds nuw { float, float }, ptr %z.ascast, i32 0, i32 0
  %12 = load float, ptr %z.ascast.realp4, align 4, !tbaa !38
...
land.lhs.true:                                    ; preds = %entry
  ...
  %13 = load float, ptr %z.ascast.imagp5, align 4, !tbaa !38
...
if.then:                                          ; preds = %land.lhs.true
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %__recalc) #8
  store i32 0, ptr %__recalc.ascast, align 4, !tbaa !36
  %14 = load float, ptr %__a.addr.ascast, align 4, !tbaa !38
  %call8 = call i32 @__ocml_isinf_f32(float noundef %14) #9
  %tobool9 = icmp ne i32 %call8, 0
  br i1 %tobool9, label %if.then12, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %if.then
  %15 = load float, ptr %__b.addr.ascast, align 4, !tbaa !38
  %call10 = call i32 @__ocml_isinf_f32(float noundef %15) #9
  %tobool11 = icmp ne i32 %call10, 0
  br i1 %tobool11, label %if.then12, label %if.end30

if.then12:                                        ; preds = %lor.lhs.false, %if.then
  %16 = load float, ptr %__a.addr.ascast, align 4, !tbaa !38
  %call13 = call i32 @__ocml_isinf_f32(float noundef %16) #9
  %tobool14 = icmp ne i32 %call13, 0
  %17 = zext i1 %tobool14 to i64
  %cond = select i1 %tobool14, i32 1, i32 0
  %conv = sitofp i32 %cond to float
  %18 = load float, ptr %__a.addr.ascast, align 4, !tbaa !38
  %call15 = call float @__ocml_copysign_f32(float noundef %conv, float noundef %18) #9
  store float %call15, ptr %__a.addr.ascast, align 4, !tbaa !38
  %19 = load float, ptr %__b.addr.ascast, align 4, !tbaa !38
  %call16 = call i32 @__ocml_isinf_f32(float noundef %19) #9
  %tobool17 = icmp ne i32 %call16, 0
  %20 = zext i1 %tobool17 to i64
  %cond18 = select i1 %tobool17, i32 1, i32 0
  %conv19 = sitofp i32 %cond18 to float
  %21 = load float, ptr %__b.addr.ascast, align 4, !tbaa !38
  %call20 = call float @__ocml_copysign_f32(float noundef %conv19, float noundef %21) #9
  store float %call20, ptr %__b.addr.ascast, align 4, !tbaa !38
  %22 = load float, ptr %__c.addr.ascast, align 4, !tbaa !38
  %call21 = call i32 @__ocml_isnan_f32(float noundef %22) #9
  %tobool22 = icmp ne i32 %call21, 0
  br i1 %tobool22, label %if.then23, label %if.end

if.then23:                                        ; preds = %if.then12
  %23 = load float, ptr %__c.addr.ascast, align 4, !tbaa !38
  %call24 = call float @__ocml_copysign_f32(float noundef 0.000000e+00, float noundef %23) #9
  store float %call24, ptr %__c.addr.ascast, align 4, !tbaa !38
  br label %if.end

if.end:                                           ; preds = %if.then23, %if.then12
  %24 = load float, ptr %__d.addr.ascast, align 4, !tbaa !38
  %call25 = call i32 @__ocml_isnan_f32(float noundef %24) #9
  %tobool26 = icmp ne i32 %call25, 0
  br i1 %tobool26, label %if.then27, label %if.end29

if.then27:                                        ; preds = %if.end
  %25 = load float, ptr %__d.addr.ascast, align 4, !tbaa !38
  %call28 = call float @__ocml_copysign_f32(float noundef 0.000000e+00, float noundef %25) #9
  store float %call28, ptr %__d.addr.ascast, align 4, !tbaa !38
  br label %if.end29
...
if.end30:                                         ; preds = %if.end29, %lor.lhs.false
  %26 = load float, ptr %__c.addr.ascast, align 4, !tbaa !38
  %call31 = call i32 @__ocml_isinf_f32(float noundef %26) #9
  %tobool32 = icmp ne i32 %call31, 0
  br i1 %tobool32, label %if.then36, label %lor.lhs.false33

lor.lhs.false33:                                  ; preds = %if.end30
  %27 = load float, ptr %__d.addr.ascast, align 4, !tbaa !38
  %call34 = call i32 @__ocml_isinf_f32(float noundef %27) #9
  %tobool35 = icmp ne i32 %call34, 0
  br i1 %tobool35, label %if.then36, label %if.end57

if.then36:                                        ; preds = %lor.lhs.false33, %if.end30
  %28 = load float, ptr %__c.addr.ascast, align 4, !tbaa !38
  %call37 = call i32 @__ocml_isinf_f32(float noundef %28) #9
  %tobool38 = icmp ne i32 %call37, 0
  %29 = zext i1 %tobool38 to i64
  %cond39 = select i1 %tobool38, i32 1, i32 0
  %conv40 = sitofp i32 %cond39 to float
  %30 = load float, ptr %__c.addr.ascast, align 4, !tbaa !38
  %call41 = call float @__ocml_copysign_f32(float noundef %conv40, float noundef %30) #9
  store float %call41, ptr %__c.addr.ascast, align 4, !tbaa !38
  %31 = load float, ptr %__d.addr.ascast, align 4, !tbaa !38
  %call42 = call i32 @__ocml_isinf_f32(float noundef %31) #9
  %tobool43 = icmp ne i32 %call42, 0
  %32 = zext i1 %tobool43 to i64
  %cond44 = select i1 %tobool43, i32 1, i32 0
  %conv45 = sitofp i32 %cond44 to float
  %33 = load float, ptr %__d.addr.ascast, align 4, !tbaa !38
  %call46 = call float @__ocml_copysign_f32(float noundef %conv45, float noundef %33) #9
  store float %call46, ptr %__d.addr.ascast, align 4, !tbaa !38
  %34 = load float, ptr %__a.addr.ascast, align 4, !tbaa !38
  %call47 = call i32 @__ocml_isnan_f32(float noundef %34) #9
  %tobool48 = icmp ne i32 %call47, 0
  br i1 %tobool48, label %if.then49, label %if.end51

if.then49:                                        ; preds = %if.then36
  %35 = load float, ptr %__a.addr.ascast, align 4, !tbaa !38
  %call50 = call float @__ocml_copysign_f32(float noundef 0.000000e+00, float noundef %35) #9
  store float %call50, ptr %__a.addr.ascast, align 4, !tbaa !38
  br label %if.end51

if.end51:                                         ; preds = %if.then49, %if.then36
  %36 = load float, ptr %__b.addr.ascast, align 4, !tbaa !38
  %call52 = call i32 @__ocml_isnan_f32(float noundef %36) #9
  %tobool53 = icmp ne i32 %call52, 0
  br i1 %tobool53, label %if.then54, label %if.end56

if.then54:                                        ; preds = %if.end51
  %37 = load float, ptr %__b.addr.ascast, align 4, !tbaa !38
  %call55 = call float @__ocml_copysign_f32(float noundef 0.000000e+00, float noundef %37) #9
  store float %call55, ptr %__b.addr.ascast, align 4, !tbaa !38
  br label %if.end56
...
land.lhs.true59:                                  ; preds = %if.end57
  %39 = load float, ptr %__ac.ascast, align 4, !tbaa !38
  %call60 = call i32 @__ocml_isinf_f32(float noundef %39) #9
  %tobool61 = icmp ne i32 %call60, 0
  br i1 %tobool61, label %if.then71, label %lor.lhs.false62

lor.lhs.false62:                                  ; preds = %land.lhs.true59
  %40 = load float, ptr %__bd.ascast, align 4, !tbaa !38
  %call63 = call i32 @__ocml_isinf_f32(float noundef %40) #9
  %tobool64 = icmp ne i32 %call63, 0
  br i1 %tobool64, label %if.then71, label %lor.lhs.false65

lor.lhs.false65:                                  ; preds = %lor.lhs.false62
  %41 = load float, ptr %__ad.ascast, align 4, !tbaa !38
  %call66 = call i32 @__ocml_isinf_f32(float noundef %41) #9
  %tobool67 = icmp ne i32 %call66, 0
  br i1 %tobool67, label %if.then71, label %lor.lhs.false68

lor.lhs.false68:                                  ; preds = %lor.lhs.false65
  %42 = load float, ptr %__bc.ascast, align 4, !tbaa !38
  %call69 = call i32 @__ocml_isinf_f32(float noundef %42) #9
  %tobool70 = icmp ne i32 %call69, 0
  br i1 %tobool70, label %if.then71, label %if.end92

if.then71:                                        ; preds = %lor.lhs.false68, %lor.lhs.false65, %lor.lhs.false62, %land.lhs.true59
  %43 = load float, ptr %__a.addr.ascast, align 4, !tbaa !38
  %call72 = call i32 @__ocml_isnan_f32(float noundef %43) #9
  %tobool73 = icmp ne i32 %call72, 0
  br i1 %tobool73, label %if.then74, label %if.end76

if.then74:                                        ; preds = %if.then71
  %44 = load float, ptr %__a.addr.ascast, align 4, !tbaa !38
  %call75 = call float @__ocml_copysign_f32(float noundef 0.000000e+00, float noundef %44) #9
  store float %call75, ptr %__a.addr.ascast, align 4, !tbaa !38
  br label %if.end76

if.end76:                                         ; preds = %if.then74, %if.then71
  %45 = load float, ptr %__b.addr.ascast, align 4, !tbaa !38
  %call77 = call i32 @__ocml_isnan_f32(float noundef %45) #9
  %tobool78 = icmp ne i32 %call77, 0
  br i1 %tobool78, label %if.then79, label %if.end81

if.then79:                                        ; preds = %if.end76
  %46 = load float, ptr %__b.addr.ascast, align 4, !tbaa !38
  %call80 = call float @__ocml_copysign_f32(float noundef 0.000000e+00, float noundef %46) #9
  store float %call80, ptr %__b.addr.ascast, align 4, !tbaa !38
  br label %if.end81

if.end81:                                         ; preds = %if.then79, %if.end76
  %47 = load float, ptr %__c.addr.ascast, align 4, !tbaa !38
  %call82 = call i32 @__ocml_isnan_f32(float noundef %47) #9
  %tobool83 = icmp ne i32 %call82, 0
  br i1 %tobool83, label %if.then84, label %if.end86

if.then84:                                        ; preds = %if.end81
  %48 = load float, ptr %__c.addr.ascast, align 4, !tbaa !38
  %call85 = call float @__ocml_copysign_f32(float noundef 0.000000e+00, float noundef %48) #9
  store float %call85, ptr %__c.addr.ascast, align 4, !tbaa !38
  br label %if.end86

if.end86:                                         ; preds = %if.then84, %if.end81
  %49 = load float, ptr %__d.addr.ascast, align 4, !tbaa !38
  %call87 = call i32 @__ocml_isnan_f32(float noundef %49) #9
  %tobool88 = icmp ne i32 %call87, 0
  br i1 %tobool88, label %if.then89, label %if.end91

if.then89:                                        ; preds = %if.end86
  %50 = load float, ptr %__d.addr.ascast, align 4, !tbaa !38
  %call90 = call float @__ocml_copysign_f32(float noundef 0.000000e+00, float noundef %50) #9
  store float %call90, ptr %__d.addr.ascast, align 4, !tbaa !38
  br label %if.end91
...
if.then94:                                        ; preds = %if.end92
  %52 = load float, ptr %__a.addr.ascast, align 4, !tbaa !38
  %53 = load float, ptr %__c.addr.ascast, align 4, !tbaa !38
  %54 = load float, ptr %__b.addr.ascast, align 4, !tbaa !38
  %55 = load float, ptr %__d.addr.ascast, align 4, !tbaa !38
  ...
  store float %mul97, ptr %z.ascast.realp98, align 4, !tbaa !38
  %57 = load float, ptr %__a.addr.ascast, align 4, !tbaa !38
  %58 = load float, ptr %__d.addr.ascast, align 4, !tbaa !38
  %59 = load float, ptr %__b.addr.ascast, align 4, !tbaa !38
  %60 = load float, ptr %__c.addr.ascast, align 4, !tbaa !38
  ...
  store float %mul101, ptr %z.ascast.imagp102, align 4, !tbaa !38
  br label %if.end103
...
entry:
  ...
  %0 = load double, ptr %__c.addr.ascast, align 8, !tbaa !32
  %call = call double @__ocml_fabs_f64(double noundef %0) #9
  %1 = load double, ptr %__d.addr.ascast, align 8, !tbaa !32
  ...
  store double %call3, ptr %__logbw.ascast, align 8, !tbaa !32
  %2 = load double, ptr %__logbw.ascast, align 8, !tbaa !32
  %call4 = call i32 @__ocml_isfinite_f64(double noundef %2) #9
  %tobool = icmp ne i32 %call4, 0
  br i1 %tobool, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %3 = load double, ptr %__logbw.ascast, align 8, !tbaa !32
  %conv = fptosi double %3 to i32
  store i32 %conv, ptr %__ilogbw.ascast, align 4, !tbaa !36
  %4 = load double, ptr %__c.addr.ascast, align 8, !tbaa !32
  %5 = load i32, ptr %__ilogbw.ascast, align 4, !tbaa !36
  %sub = sub nsw i32 0, %5
  %call5 = call double @__ocml_scalbn_f64(double noundef %4, i32 noundef %sub) #9
  store double %call5, ptr %__c.addr.ascast, align 8, !tbaa !32
  %6 = load double, ptr %__d.addr.ascast, align 8, !tbaa !32
  ...
  store double %call7, ptr %__d.addr.ascast, align 8, !tbaa !32
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %__denom) #8
  %8 = load double, ptr %__c.addr.ascast, align 8, !tbaa !32
  %9 = load double, ptr %__c.addr.ascast, align 8, !tbaa !32
  %10 = load double, ptr %__d.addr.ascast, align 8, !tbaa !32
  %11 = load double, ptr %__d.addr.ascast, align 8, !tbaa !32
  %mul8 = fmul double %10, %11
  %12 = call double @llvm.fmuladd.f64(double %8, double %9, double %mul8)
  store double %12, ptr %__denom.ascast, align 8, !tbaa !32
  call void @llvm.lifetime.start.p5(i64 16, ptr addrspace(5) %z) #8
  %13 = load double, ptr %__a.addr.ascast, align 8, !tbaa !32
  %14 = load double, ptr %__c.addr.ascast, align 8, !tbaa !32
  %15 = load double, ptr %__b.addr.ascast, align 8, !tbaa !32
  %16 = load double, ptr %__d.addr.ascast, align 8, !tbaa !32
  %mul9 = fmul double %15, %16
  %17 = call double @llvm.fmuladd.f64(double %13, double %14, double %mul9)
  %18 = load double, ptr %__denom.ascast, align 8, !tbaa !32
  %div = fdiv double %17, %18
  %19 = load i32, ptr %__ilogbw.ascast, align 4, !tbaa !36
  %sub10 = sub nsw i32 0, %19
  %call11 = call double @__ocml_scalbn_f64(double noundef %div, i32 noundef %sub10) #9
  %z.ascast.realp = getelementptr inbounds nuw { double, double }, ptr %z.ascast, i32 0, i32 0
  store double %call11, ptr %z.ascast.realp, align 8, !tbaa !32
  %20 = load double, ptr %__b.addr.ascast, align 8, !tbaa !32
  %21 = load double, ptr %__c.addr.ascast, align 8, !tbaa !32
  %22 = load double, ptr %__a.addr.ascast, align 8, !tbaa !32
  %23 = load double, ptr %__d.addr.ascast, align 8, !tbaa !32
  %mul12 = fmul double %22, %23
  %neg = fneg double %mul12
  %24 = call double @llvm.fmuladd.f64(double %20, double %21, double %neg)
  %25 = load double, ptr %__denom.ascast, align 8, !tbaa !32
  %div13 = fdiv double %24, %25
  %26 = load i32, ptr %__ilogbw.ascast, align 4, !tbaa !36
  %sub14 = sub nsw i32 0, %26
  %call15 = call double @__ocml_scalbn_f64(double noundef %div13, i32 noundef %sub14) #9
  %z.ascast.imagp = getelementptr inbounds nuw { double, double }, ptr %z.ascast, i32 0, i32 1
  store double %call15, ptr %z.ascast.imagp, align 8, !tbaa !32
  %z.ascast.realp16 = getelementptr inbounds nuw { double, double }, ptr %z.ascast, i32 0, i32 0
  %27 = load double, ptr %z.ascast.realp16, align 8, !tbaa !32
...
if.then45:                                        ; preds = %land.lhs.true42
  ...
  %42 = load double, ptr %__a.addr.ascast, align 8, !tbaa !32
  %call48 = call double @__ocml_copysign_f64(double noundef %cond, double noundef %42) #9
  store double %call48, ptr %__a.addr.ascast, align 8, !tbaa !32
  %43 = load double, ptr %__b.addr.ascast, align 8, !tbaa !32
  ...
  store double %call52, ptr %__b.addr.ascast, align 8, !tbaa !32
  %46 = load double, ptr %__a.addr.ascast, align 8, !tbaa !32
  %47 = load double, ptr %__c.addr.ascast, align 8, !tbaa !32
  %48 = load double, ptr %__b.addr.ascast, align 8, !tbaa !32
  %49 = load double, ptr %__d.addr.ascast, align 8, !tbaa !32
  ...
  store double %mul55, ptr %z.ascast.realp56, align 8, !tbaa !32
  %51 = load double, ptr %__b.addr.ascast, align 8, !tbaa !32
  %52 = load double, ptr %__c.addr.ascast, align 8, !tbaa !32
  %53 = load double, ptr %__a.addr.ascast, align 8, !tbaa !32
  %54 = load double, ptr %__d.addr.ascast, align 8, !tbaa !32
  ...
  store double %mul60, ptr %z.ascast.imagp61, align 8, !tbaa !32
  br label %if.end92

if.else62:                                        ; preds = %land.lhs.true42, %land.lhs.true39, %lor.lhs.false36
  %56 = load double, ptr %__logbw.ascast, align 8, !tbaa !32
...
land.lhs.true65:                                  ; preds = %if.else62
  %57 = load double, ptr %__logbw.ascast, align 8, !tbaa !32
...
land.lhs.true67:                                  ; preds = %land.lhs.true65
  %58 = load double, ptr %__a.addr.ascast, align 8, !tbaa !32
...
if.then73:                                        ; preds = %land.lhs.true70
  ...
  %62 = load double, ptr %__c.addr.ascast, align 8, !tbaa !32
  %call77 = call double @__ocml_copysign_f64(double noundef %cond76, double noundef %62) #9
  store double %call77, ptr %__c.addr.ascast, align 8, !tbaa !32
  %63 = load double, ptr %__d.addr.ascast, align 8, !tbaa !32
  ...
  %65 = load double, ptr %__d.addr.ascast, align 8, !tbaa !32
  %call81 = call double @__ocml_copysign_f64(double noundef %cond80, double noundef %65) #9
  store double %call81, ptr %__d.addr.ascast, align 8, !tbaa !32
  %66 = load double, ptr %__a.addr.ascast, align 8, !tbaa !32
  %67 = load double, ptr %__c.addr.ascast, align 8, !tbaa !32
  %68 = load double, ptr %__b.addr.ascast, align 8, !tbaa !32
  %69 = load double, ptr %__d.addr.ascast, align 8, !tbaa !32
  ...
  store double %mul84, ptr %z.ascast.realp85, align 8, !tbaa !32
  %71 = load double, ptr %__b.addr.ascast, align 8, !tbaa !32
  %72 = load double, ptr %__c.addr.ascast, align 8, !tbaa !32
  %73 = load double, ptr %__a.addr.ascast, align 8, !tbaa !32
  %74 = load double, ptr %__d.addr.ascast, align 8, !tbaa !32
  ...
  store double %mul89, ptr %z.ascast.imagp90, align 8, !tbaa !32
  br label %if.end91
...
entry:
  ...
  %0 = load float, ptr %__c.addr.ascast, align 4, !tbaa !38
  %call = call float @__ocml_fabs_f32(float noundef %0) #9
  %1 = load float, ptr %__d.addr.ascast, align 4, !tbaa !38
  ...
  store float %call3, ptr %__logbw.ascast, align 4, !tbaa !38
  %2 = load float, ptr %__logbw.ascast, align 4, !tbaa !38
  %call4 = call i32 @__ocml_isfinite_f32(float noundef %2) #9
  %tobool = icmp ne i32 %call4, 0
  br i1 %tobool, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %3 = load float, ptr %__logbw.ascast, align 4, !tbaa !38
  %conv = fptosi float %3 to i32
  store i32 %conv, ptr %__ilogbw.ascast, align 4, !tbaa !36
  %4 = load float, ptr %__c.addr.ascast, align 4, !tbaa !38
  %5 = load i32, ptr %__ilogbw.ascast, align 4, !tbaa !36
  %sub = sub nsw i32 0, %5
  %call5 = call float @__ocml_scalbn_f32(float noundef %4, i32 noundef %sub) #9
  store float %call5, ptr %__c.addr.ascast, align 4, !tbaa !38
  %6 = load float, ptr %__d.addr.ascast, align 4, !tbaa !38
  %7 = load i32, ptr %__ilogbw.ascast, align 4, !tbaa !36
  %sub6 = sub nsw i32 0, %7
  %call7 = call float @__ocml_scalbn_f32(float noundef %6, i32 noundef %sub6) #9
  store float %call7, ptr %__d.addr.ascast, align 4, !tbaa !38
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %__denom) #8
  %8 = load float, ptr %__c.addr.ascast, align 4, !tbaa !38
  %9 = load float, ptr %__c.addr.ascast, align 4, !tbaa !38
  %10 = load float, ptr %__d.addr.ascast, align 4, !tbaa !38
  %11 = load float, ptr %__d.addr.ascast, align 4, !tbaa !38
  %mul8 = fmul float %10, %11
  %12 = call float @llvm.fmuladd.f32(float %8, float %9, float %mul8)
  store float %12, ptr %__denom.ascast, align 4, !tbaa !38
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %z) #8
  %13 = load float, ptr %__a.addr.ascast, align 4, !tbaa !38
  %14 = load float, ptr %__c.addr.ascast, align 4, !tbaa !38
  %15 = load float, ptr %__b.addr.ascast, align 4, !tbaa !38
  %16 = load float, ptr %__d.addr.ascast, align 4, !tbaa !38
  %mul9 = fmul float %15, %16
  %17 = call float @llvm.fmuladd.f32(float %13, float %14, float %mul9)
  %18 = load float, ptr %__denom.ascast, align 4, !tbaa !38
  %div = fdiv float %17, %18
  %19 = load i32, ptr %__ilogbw.ascast, align 4, !tbaa !36
  %sub10 = sub nsw i32 0, %19
  %call11 = call float @__ocml_scalbn_f32(float noundef %div, i32 noundef %sub10) #9
  %z.ascast.realp = getelementptr inbounds nuw { float, float }, ptr %z.ascast, i32 0, i32 0
  store float %call11, ptr %z.ascast.realp, align 4, !tbaa !38
  %20 = load float, ptr %__b.addr.ascast, align 4, !tbaa !38
  %21 = load float, ptr %__c.addr.ascast, align 4, !tbaa !38
  %22 = load float, ptr %__a.addr.ascast, align 4, !tbaa !38
  %23 = load float, ptr %__d.addr.ascast, align 4, !tbaa !38
  %mul12 = fmul float %22, %23
  %neg = fneg float %mul12
  %24 = call float @llvm.fmuladd.f32(float %20, float %21, float %neg)
  %25 = load float, ptr %__denom.ascast, align 4, !tbaa !38
  %div13 = fdiv float %24, %25
  %26 = load i32, ptr %__ilogbw.ascast, align 4, !tbaa !36
  %sub14 = sub nsw i32 0, %26
  %call15 = call float @__ocml_scalbn_f32(float noundef %div13, i32 noundef %sub14) #9
  %z.ascast.imagp = getelementptr inbounds nuw { float, float }, ptr %z.ascast, i32 0, i32 1
  store float %call15, ptr %z.ascast.imagp, align 4, !tbaa !38
  %z.ascast.realp16 = getelementptr inbounds nuw { float, float }, ptr %z.ascast, i32 0, i32 0
  %27 = load float, ptr %z.ascast.realp16, align 4, !tbaa !38
...
if.then45:                                        ; preds = %land.lhs.true42
  ...
  store float %call54, ptr %__b.addr.ascast, align 4, !tbaa !38
  %46 = load float, ptr %__a.addr.ascast, align 4, !tbaa !38
  %47 = load float, ptr %__c.addr.ascast, align 4, !tbaa !38
  %48 = load float, ptr %__b.addr.ascast, align 4, !tbaa !38
  %49 = load float, ptr %__d.addr.ascast, align 4, !tbaa !38
  ...
  store float %mul57, ptr %z.ascast.realp58, align 4, !tbaa !38
  %51 = load float, ptr %__b.addr.ascast, align 4, !tbaa !38
  %52 = load float, ptr %__c.addr.ascast, align 4, !tbaa !38
  %53 = load float, ptr %__a.addr.ascast, align 4, !tbaa !38
  %54 = load float, ptr %__d.addr.ascast, align 4, !tbaa !38
  ...
  store float %mul62, ptr %z.ascast.imagp63, align 4, !tbaa !38
  br label %if.end96

if.else64:                                        ; preds = %land.lhs.true42, %land.lhs.true39, %lor.lhs.false36
  %56 = load float, ptr %__logbw.ascast, align 4, !tbaa !38
...
land.lhs.true67:                                  ; preds = %if.else64
  %57 = load float, ptr %__logbw.ascast, align 4, !tbaa !38
...
land.lhs.true69:                                  ; preds = %land.lhs.true67
  %58 = load float, ptr %__a.addr.ascast, align 4, !tbaa !38
...
if.then75:                                        ; preds = %land.lhs.true72
  ...
  %62 = load float, ptr %__c.addr.ascast, align 4, !tbaa !38
  %call80 = call float @__ocml_copysign_f32(float noundef %conv79, float noundef %62) #9
  store float %call80, ptr %__c.addr.ascast, align 4, !tbaa !38
  %63 = load float, ptr %__d.addr.ascast, align 4, !tbaa !38
  ...
  %65 = load float, ptr %__d.addr.ascast, align 4, !tbaa !38
  %call85 = call float @__ocml_copysign_f32(float noundef %conv84, float noundef %65) #9
  store float %call85, ptr %__d.addr.ascast, align 4, !tbaa !38
  %66 = load float, ptr %__a.addr.ascast, align 4, !tbaa !38
  %67 = load float, ptr %__c.addr.ascast, align 4, !tbaa !38
  %68 = load float, ptr %__b.addr.ascast, align 4, !tbaa !38
  %69 = load float, ptr %__d.addr.ascast, align 4, !tbaa !38
  ...
  store float %mul88, ptr %z.ascast.realp89, align 4, !tbaa !38
  %71 = load float, ptr %__b.addr.ascast, align 4, !tbaa !38
  %72 = load float, ptr %__c.addr.ascast, align 4, !tbaa !38
  %73 = load float, ptr %__a.addr.ascast, align 4, !tbaa !38
  %74 = load float, ptr %__d.addr.ascast, align 4, !tbaa !38
  ...
  store float %mul93, ptr %z.ascast.imagp94, align 4, !tbaa !38
  br label %if.end95
...
define hidden noundef double @_ZN6openmc18initialize_historyERNS_8ParticleEi(ptr noundef nonnull align 8 dereferenceable(2728) %p, i32 noundef %index_source) #3 {
entry:
  %retval = alloca double, align 8, addrspace(5)
  %p.addr = alloca ptr, align 8, addrspace(5)
  %index_source.addr = alloca i32, align 4, addrspace(5)
  %particle_seed = alloca i64, align 8, addrspace(5)
  %cleanup.dest.slot = alloca i32, align 4, addrspace(5)
  %retval.ascast = addrspacecast ptr addrspace(5) %retval to ptr
  %p.addr.ascast = addrspacecast ptr addrspace(5) %p.addr to ptr
  %index_source.addr.ascast = addrspacecast ptr addrspace(5) %index_source.addr to ptr
  %particle_seed.ascast = addrspacecast ptr addrspace(5) %particle_seed to ptr
  store ptr %p, ptr %p.addr.ascast, align 8, !tbaa !40
  store i32 %index_source, ptr %index_source.addr.ascast, align 4, !tbaa !36
  %0 = load ptr, ptr %p.addr.ascast, align 8, !tbaa !40
  %1 = load ptr, ptr addrspacecast (ptr addrspace(1) @_ZN6openmc10simulation18device_source_bankE to ptr), align 8, !tbaa !43
  %2 = load i32, ptr %index_source.addr.ascast, align 4, !tbaa !36
  %sub = sub nsw i32 %2, 1
  %idxprom = sext i32 %sub to i64
  %arrayidx = getelementptr inbounds %"struct.openmc::Particle::Bank", ptr %1, i64 %idxprom
  call void @_ZN6openmc8Particle11from_sourceERKNS0_4BankE(ptr noundef nonnull align 8 dereferenceable(2728) %0, ptr noundef nonnull align 8 dereferenceable(96) %arrayidx) #10
  %3 = load i32, ptr %index_source.addr.ascast, align 4, !tbaa !36
  %conv = sext i32 %3 to i64
  %4 = load ptr, ptr %p.addr.ascast, align 8, !tbaa !40
  %current_work_ = getelementptr inbounds nuw %"class.openmc::Particle", ptr %4, i32 0, i32 43
  store i64 %conv, ptr %current_work_, align 8, !tbaa !45
  %5 = load ptr, ptr addrspacecast (ptr addrspace(1) @_ZN6openmc10simulation17device_work_indexE to ptr), align 8, !tbaa !62
  %6 = load i32, ptr addrspacecast (ptr addrspace(1) @_ZN6openmc3mpi4rankE to ptr), align 4, !tbaa !36
  %idxprom1 = sext i32 %6 to i64
  %arrayidx2 = getelementptr inbounds i64, ptr %5, i64 %idxprom1
  %7 = load i64, ptr %arrayidx2, align 8, !tbaa !64
  %8 = load i32, ptr %index_source.addr.ascast, align 4, !tbaa !36
  %conv3 = sext i32 %8 to i64
  %add = add nsw i64 %7, %conv3
  %9 = load ptr, ptr %p.addr.ascast, align 8, !tbaa !40
  %id_ = getelementptr inbounds nuw %"class.openmc::Particle", ptr %9, i32 0, i32 3
  store i64 %add, ptr %id_, align 8, !tbaa !65
  %10 = load ptr, ptr %p.addr.ascast, align 8, !tbaa !40
  %n_progeny_ = getelementptr inbounds nuw %"class.openmc::Particle", ptr %10, i32 0, i32 56
  store i64 0, ptr %n_progeny_, align 8, !tbaa !66
  %11 = load ptr, ptr %p.addr.ascast, align 8, !tbaa !40
  %n_event_ = getelementptr inbounds nuw %"class.openmc::Particle", ptr %11, i32 0, i32 55
  store i32 0, ptr %n_event_, align 8, !tbaa !67
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %particle_seed) #8
  %12 = load i32, ptr addrspacecast (ptr addrspace(1) @total_gen to ptr), align 4, !tbaa !36
  %call = call i32 @overall_generation() #10
  %add4 = add nsw i32 %12, %call
  %sub5 = sub nsw i32 %add4, 1
  %conv6 = sext i32 %sub5 to i64
  %13 = load i64, ptr addrspacecast (ptr addrspace(1) @n_particles to ptr), align 8, !tbaa !64
  %mul = mul nsw i64 %conv6, %13
  %14 = load ptr, ptr %p.addr.ascast, align 8, !tbaa !40
  %id_7 = getelementptr inbounds nuw %"class.openmc::Particle", ptr %14, i32 0, i32 3
  %15 = load i64, ptr %id_7, align 8, !tbaa !65
  %add8 = add nsw i64 %mul, %15
  store i64 %add8, ptr %particle_seed.ascast, align 8, !tbaa !64
  %16 = load i64, ptr %particle_seed.ascast, align 8, !tbaa !64
  %17 = load ptr, ptr %p.addr.ascast, align 8, !tbaa !40
  %seeds_ = getelementptr inbounds nuw %"class.openmc::Particle", ptr %17, i32 0, i32 39
  %arraydecay = getelementptr inbounds [8 x i64], ptr %seeds_, i64 0, i64 0
  call void @_ZN6openmc19init_particle_seedsElPm(i64 noundef %16, ptr noundef %arraydecay) #10
  %18 = load ptr, ptr %p.addr.ascast, align 8, !tbaa !40
  %trace_ = getelementptr inbounds nuw %"class.openmc::Particle", ptr %18, i32 0, i32 52
  store i8 0, ptr %trace_, align 8, !tbaa !68
  %19 = load ptr, ptr %p.addr.ascast, align 8, !tbaa !40
  %write_track_ = getelementptr inbounds nuw %"class.openmc::Particle", ptr %19, i32 0, i32 38
  store i8 0, ptr %write_track_, align 4, !tbaa !69
  %20 = load ptr, ptr %p.addr.ascast, align 8, !tbaa !40
  call void @_ZN6openmc26initialize_history_partialERNS_8ParticleE(ptr noundef nonnull align 8 dereferenceable(2728) %20) #10
  %21 = load ptr, ptr %p.addr.ascast, align 8, !tbaa !40
  %wgt_ = getelementptr inbounds nuw %"class.openmc::Particle", ptr %21, i32 0, i32 15
  %22 = load double, ptr %wgt_, align 8, !tbaa !70
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %particle_seed) #8
  ret double %22
}

; Function Attrs: convergent
declare void @_ZN6openmc8Particle11from_sourceERKNS0_4BankE(ptr noundef nonnull align 8 dereferenceable(2728), ptr noundef nonnull align 8 dereferenceable(96)) #4

; Function Attrs: convergent mustprogress nounwind
define hidden i32 @overall_generation() #3 {
entry:
  %retval = alloca i32, align 4, addrspace(5)
  %retval.ascast = addrspacecast ptr addrspace(5) %retval to ptr
  %0 = load i32, ptr addrspacecast (ptr addrspace(1) @gen_per_batch to ptr), align 4, !tbaa !36
  %1 = load i32, ptr addrspacecast (ptr addrspace(1) @current_batch to ptr), align 4, !tbaa !36
  %sub = sub nsw i32 %1, 1
  %mul = mul nsw i32 %0, %sub
  %2 = load i32, ptr addrspacecast (ptr addrspace(1) @current_gen to ptr), align 4, !tbaa !36
  %add = add nsw i32 %mul, %2
  ret i32 %add
}

; Function Attrs: convergent
declare void @_ZN6openmc19init_particle_seedsElPm(i64 noundef, ptr noundef) #4

; Function Attrs: convergent mustprogress nounwind
define hidden void @_ZN6openmc26initialize_history_partialERNS_8ParticleE(ptr noundef nonnull align 8 dereferenceable(2728) %p) #3 {
entry:
  %p.addr = alloca ptr, align 8, addrspace(5)
  ...
  call void @_ZN6openmc19NuclideMicroXSCache5clearEv(ptr noundef nonnull align 8 dereferenceable(168) %neutron_xs_) #10
  %1 = load ptr, ptr %p.addr.ascast, align 8, !tbaa !40
  %flux_derivs_ = getelementptr inbounds nuw %"class.openmc::Particle", ptr %1, i32 0, i32 44
  %arraydecay = getelementptr inbounds [1 x double], ptr %flux_derivs_, i64 0, i64 0
  %2 = load ptr, ptr %p.addr.ascast, align 8, !tbaa !40
  %flux_derivs_1 = getelementptr inbounds nuw %"class.openmc::Particle", ptr %2, i32 0, i32 44
  %arraydecay2 = getelementptr inbounds [1 x double], ptr %flux_derivs_1, i64 0, i64 0
  %add.ptr = getelementptr inbounds double, ptr %arraydecay2, i64 1
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %ref.tmp) #8
  store double 0.000000e+00, ptr %ref.tmp.ascast, align 8, !tbaa !32
  call void @_ZSt4fillIPddEvT_S1_RKT0_(ptr noundef %arraydecay, ptr noundef %add.ptr, ptr noundef nonnull align 8 dereferenceable(8) %ref.tmp.ascast) #10
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %ref.tmp) #8
  %3 = load ptr, ptr %p.addr.ascast, align 8, !tbaa !40
  %secondary_bank_length_ = getelementptr inbounds nuw %"class.openmc::Particle", ptr %3, i32 0, i32 42
  store i64 0, ptr %secondary_bank_length_, align 8, !tbaa !71
  ret void
}
...
entry:
  ...
  %0 = load i8, ptr addrspacecast (ptr addrspace(1) @run_CE to ptr), align 1, !tbaa !74, !range !75, !noundef !76
  %loadedv = trunc i8 %0 to i1
  br i1 %loadedv, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %__range3) #8
  %neutron_xs_ = getelementptr inbounds nuw %"class.openmc::NuclideMicroXSCache", ptr %this1, i32 0, i32 0
  store ptr %neutron_xs_, ptr %__range3.ascast, align 8, !tbaa !77
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %__begin3) #8
  %1 = load ptr, ptr %__range3.ascast, align 8, !tbaa !77
  %arraydecay = getelementptr inbounds [1 x %"struct.openmc::NuclideMicroXS"], ptr %1, i64 0, i64 0
  store ptr %arraydecay, ptr %__begin3.ascast, align 8, !tbaa !77
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %__end3) #8
  %2 = load ptr, ptr %__range3.ascast, align 8, !tbaa !77
  ...
  store ptr %add.ptr, ptr %__end3.ascast, align 8, !tbaa !77
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %if.then
  %3 = load ptr, ptr %__begin3.ascast, align 8, !tbaa !77
  %4 = load ptr, ptr %__end3.ascast, align 8, !tbaa !77
  %cmp = icmp ne ptr %3, %4
  br i1 %cmp, label %for.body, label %for.cond.cleanup

for.cond.cleanup:                                 ; preds = %for.cond
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %__end3) #8
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %__begin3) #8
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %__range3) #8
  br label %for.end

for.body:                                         ; preds = %for.cond
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %micro) #8
  %5 = load ptr, ptr %__begin3.ascast, align 8, !tbaa !77
  store ptr %5, ptr %micro.ascast, align 8, !tbaa !77
  %6 = load ptr, ptr %micro.ascast, align 8, !tbaa !77
  %last_E = getelementptr inbounds nuw %"struct.openmc::NuclideMicroXS", ptr %6, i32 0, i32 16
  store double 0.000000e+00, ptr %last_E, align 8, !tbaa !79
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %micro) #8
  br label %for.inc

for.inc:                                          ; preds = %for.body
  %7 = load ptr, ptr %__begin3.ascast, align 8, !tbaa !77
  %incdec.ptr = getelementptr inbounds nuw %"struct.openmc::NuclideMicroXS", ptr %7, i32 1
  store ptr %incdec.ptr, ptr %__begin3.ascast, align 8, !tbaa !77
  br label %for.cond
...
define linkonce_odr hidden void @_ZSt4fillIPddEvT_S1_RKT0_(ptr noundef %__first, ptr noundef %__last, ptr noundef nonnull align 8 dereferenceable(8) %__value) #5 comdat {
entry:
  ...
  store ptr %__first, ptr %__first.addr.ascast, align 8, !tbaa !81
  store ptr %__last, ptr %__last.addr.ascast, align 8, !tbaa !81
  store ptr %__value, ptr %__value.addr.ascast, align 8, !tbaa !81
  %0 = load ptr, ptr %__first.addr.ascast, align 8, !tbaa !81
  %1 = load ptr, ptr %__last.addr.ascast, align 8, !tbaa !81
  %2 = load ptr, ptr %__value.addr.ascast, align 8, !tbaa !81
  call void @_ZSt8__fill_aIPddEvT_S1_RKT0_(ptr noundef %0, ptr noundef %1, ptr noundef nonnull align 8 dereferenceable(8) %2) #10
  ret void
}

; Function Attrs: convergent inlinehint mustprogress nounwind
define linkonce_odr hidden void @_ZSt8__fill_aIPddEvT_S1_RKT0_(ptr noundef %__first, ptr noundef %__last, ptr noundef nonnull align 8 dereferenceable(8) %__value) #5 comdat {
entry:
  %__first.addr = alloca ptr, align 8, addrspace(5)
  %__last.addr = alloca ptr, align 8, addrspace(5)
  %__value.addr = alloca ptr, align 8, addrspace(5)
  ...
  %1 = load ptr, ptr %__last.addr.ascast, align 8, !tbaa !81
  %2 = load ptr, ptr %__value.addr.ascast, align 8, !tbaa !81
  call void @_ZSt9__fill_a1IPddEN9__gnu_cxx11__enable_ifIXsr11__is_scalarIT0_EE7__valueEvE6__typeET_S6_RKS3_(ptr noundef %0, ptr noundef %1, ptr noundef nonnull align 8 dereferenceable(8) %2) #10
  ret void
}

; Function Attrs: convergent inlinehint mustprogress nounwind
define linkonce_odr hidden void @_ZSt9__fill_a1IPddEN9__gnu_cxx11__enable_ifIXsr11__is_scalarIT0_EE7__valueEvE6__typeET_S6_RKS3_(ptr noundef %__first, ptr noundef %__last, ptr noundef nonnull align 8 dereferenceable(8) %__value) #5 comdat {
entry:
  %__first.addr = alloca ptr, align 8, addrspace(5)
  %__last.addr = alloca ptr, align 8, addrspace(5)
  %__value.addr = alloca ptr, align 8, addrspace(5)
  ...
  store ptr %__last, ptr %__last.addr.ascast, align 8, !tbaa !81
  store ptr %__value, ptr %__value.addr.ascast, align 8, !tbaa !81
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %__tmp) #8
  %0 = load ptr, ptr %__value.addr.ascast, align 8, !tbaa !81
  %1 = load double, ptr %0, align 8, !tbaa !32
  store double %1, ptr %__tmp.ascast, align 8, !tbaa !32
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %2 = load ptr, ptr %__first.addr.ascast, align 8, !tbaa !81
  %3 = load ptr, ptr %__last.addr.ascast, align 8, !tbaa !81
  %cmp = icmp ne ptr %2, %3
  br i1 %cmp, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %4 = load double, ptr %__tmp.ascast, align 8, !tbaa !32
  %5 = load ptr, ptr %__first.addr.ascast, align 8, !tbaa !81
  store double %4, ptr %5, align 8, !tbaa !32
  br label %for.inc

for.inc:                                          ; preds = %for.body
  %6 = load ptr, ptr %__first.addr.ascast, align 8, !tbaa !81
  %incdec.ptr = getelementptr inbounds nuw double, ptr %6, i32 1
  store ptr %incdec.ptr, ptr %__first.addr.ascast, align 8, !tbaa !81
  br label %for.cond, !llvm.loop !83

for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %__tmp) #8
  ret void
}
...
define internal double @__ocml_logb_f64(double noundef %0) #6 {
  ...
  %5 = load i8, ptr addrspace(4) @__oclc_finite_only_opt, align 1, !tbaa !85, !range !75, !noundef !76
  %6 = icmp eq i8 %5, 0
...
!39 = !{!"float", !34, i64 0}
!40 = !{!41, !41, i64 0}
!41 = !{!"p1 _ZTSN6openmc8ParticleE", !42, i64 0}
!42 = !{!"any pointer", !34, i64 0}
!43 = !{!44, !44, i64 0}
!44 = !{!"p1 _ZTSN6openmc8Particle4BankE", !42, i64 0}
!45 = !{!46, !49, i64 2224}
!46 = !{!"_ZTSN6openmc8ParticleE", !47, i64 0, !34, i64 168, !48, i64 744, !49, i64 864, !50, i64 872, !37, i64 876, !37, i64 880, !34, i64 888, !37, i64 1368, !34, i64 1372, !33, i64 1400, !33, i64 1408, !37, i64 1416, !37, i64 1420, !33, i64 1424, !33, i64 1432, !51, i64 1440, !51, i64 1464, !51, i64 1488, !33, i64 1512, !52, i64 1520, !53, i64 1524, !37, i64 1528, !37, i64 1532, !37, i64 1536, !37, i64 1540, !37, i64 1544, !33, i64 1552, !34, i64 1560, !37, i64 1592, !37, i64 1596, !37, i64 1600, !37, i64 1604, !54, i64 1608, !33, i64 1640, !33, i64 1648, !37, i64 1656, !52, i64 1660, !34, i64 1664, !37, i64 1728, !34, i64 1736, !49, i64 2216, !49, i64 2224, !34, i64 2232, !56, i64 2240, !57, i64 2248, !34, i64 2272, !33, i64 2656, !33, i64 2664, !33, i64 2672, !33, i64 2680, !52, i64 2688, !33, i64 2696, !33, i64 2704, !37, i64 2712, !49, i64 2720}
!47 = !{!"_ZTSN6openmc19NuclideMicroXSCacheE", !34, i64 0}
!48 = !{!"_ZTSN6openmc7MacroXSE", !33, i64 0, !33, i64 8, !33, i64 16, !33, i64 24, !33, i64 32, !34, i64 40, !33, i64 88, !33, i64 96, !33, i64 104, !33, i64 112}
!49 = !{!"long", !34, i64 0}
!50 = !{!"_ZTSN6openmc8Particle4TypeE", !34, i64 0}
!51 = !{!"_ZTSN6openmc8PositionE", !33, i64 0, !33, i64 8, !33, i64 16}
!52 = !{!"bool", !34, i64 0}
!53 = !{!"_ZTSN6openmc10TallyEventE", !34, i64 0}
!54 = !{!"_ZTSN6openmc12BoundaryInfoE", !33, i64 0, !37, i64 8, !37, i64 12, !55, i64 16}
!55 = !{!"_ZTSSt5arrayIiLm3EE", !34, i64 0}
!56 = !{!"p1 _ZTSN6openmc11FilterMatchE", !42, i64 0}
!57 = !{!"_ZTSSt6vectorIS_IN6openmc8PositionESaIS1_EESaIS3_EE", !58, i64 0}
!58 = !{!"_ZTSSt12_Vector_baseISt6vectorIN6openmc8PositionESaIS2_EESaIS4_EE", !59, i64 0}
!59 = !{!"_ZTSNSt12_Vector_baseISt6vectorIN6openmc8PositionESaIS2_EESaIS4_EE12_Vector_implE", !60, i64 0}
!60 = !{!"_ZTSNSt12_Vector_baseISt6vectorIN6openmc8PositionESaIS2_EESaIS4_EE17_Vector_impl_dataE", !61, i64 0, !61, i64 8, !61, i64 16}
!61 = !{!"p1 _ZTSSt6vectorIN6openmc8PositionESaIS1_EE", !42, i64 0}
!62 = !{!63, !63, i64 0}
!63 = !{!"p1 long", !42, i64 0}
!64 = !{!49, !49, i64 0}
!65 = !{!46, !49, i64 864}
...
!71 = !{!46, !49, i64 2216}
!72 = !{!73, !73, i64 0}
!73 = !{!"p1 _ZTSN6openmc19NuclideMicroXSCacheE", !42, i64 0}
!74 = !{!52, !52, i64 0}
!75 = !{i8 0, i8 2}
!76 = !{}
!77 = !{!78, !78, i64 0}
!78 = !{!"p1 _ZTSN6openmc14NuclideMicroXSE", !42, i64 0}
!79 = !{!80, !33, i64 152}
!80 = !{!"_ZTSN6openmc14NuclideMicroXSE", !33, i64 0, !33, i64 8, !33, i64 16, !33, i64 24, !33, i64 32, !33, i64 40, !33, i64 48, !33, i64 56, !34, i64 64, !37, i64 112, !37, i64 116, !33, i64 120, !37, i64 128, !37, i64 132, !33, i64 136, !52, i64 144, !33, i64 152, !33, i64 160}
!81 = !{!82, !82, i64 0}
!82 = !{!"p1 double", !42, i64 0}
!83 = distinct !{!83, !84}
