; ModuleID = 'distribution_angle-openmp-amdgcn-amd-amdhsa-gfx942.tmp.bc'
...
define hidden void @_ZN6openmc21AngleDistributionFlatC2EPKh(ptr noundef nonnull align 8 dereferenceable(16) %this, ptr noundef %data) unnamed_addr #3 align 2 {
entry:
...
; Function Attrs: convergent mustprogress nounwind
define hidden noundef double @_ZNK6openmc21AngleDistributionFlat6sampleEdPm(ptr noundef nonnull align 8 dereferenceable(16) %this, double noundef %E, ptr noundef %seed) #3 align 2 {
entry:
...
if.then:                                          ; preds = %entry
  %1 = load ptr, ptr %seed.addr.ascast, align 8, !tbaa !31
  %call = call noundef double @_ZN6openmc3prnEPm(ptr noundef %1) #12
  %2 = call double @llvm.fmuladd.f64(double 2.000000e+00, double %call, double -1.000000e+00)
  store double %2, ptr %retval.ascast, align 8
  br label %return

if.end:                                           ; preds = %entry
  call void @llvm.lifetime.start.p5(i64 16, ptr addrspace(5) %energy) #10
  %call2 = call %"class.gsl::span" @_ZNK6openmc21AngleDistributionFlat6energyEv(ptr noundef nonnull align 8 dereferenceable(16) %this1) #12
  %3 = getelementptr inbounds nuw %"class.gsl::span", ptr %energy.ascast, i32 0, i32 0
  %4 = extractvalue %"class.gsl::span" %call2, 0
  store ptr %4, ptr %3, align 8
  %5 = getelementptr inbounds nuw %"class.gsl::span", ptr %energy.ascast, i32 0, i32 1
  ...
  %call3 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNK3gsl4spanIKdEixEm(ptr noundef nonnull align 8 dereferenceable(16) %energy.ascast, i64 noundef 0) #12
...
if.else:                                          ; preds = %if.end
  ...
  %10 = load i64, ptr %n_6, align 8, !tbaa !30
  %sub = sub i64 %10, 1
  %call7 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNK3gsl4spanIKdEixEm(ptr noundef nonnull align 8 dereferenceable(16) %energy.ascast, i64 noundef %sub) #12
...
if.then9:                                         ; preds = %if.else
  ...
  %12 = load i64, ptr %n_10, align 8, !tbaa !30
  %sub11 = sub i64 %12, 2
...
if.else12:                                        ; preds = %if.else
  %call13 = call noundef ptr @_ZNK3gsl4spanIKdE5beginEv(ptr noundef nonnull align 8 dereferenceable(16) %energy.ascast) #13
  %call14 = call noundef ptr @_ZNK3gsl4spanIKdE3endEv(ptr noundef nonnull align 8 dereferenceable(16) %energy.ascast) #13
  %call15 = call noundef i64 @_ZN6openmc17lower_bound_indexIPKddEENSt15iterator_traitsIT_E15difference_typeES4_S4_RKT0_(ptr noundef %call13, ptr noundef %call14, ptr noundef nonnull align 8 dereferenceable(8) %E.addr.ascast) #12
  %conv16 = trunc i64 %call15 to i32
  store i32 %conv16, ptr %i.ascast, align 4, !tbaa !18
  %13 = load double, ptr %E.addr.ascast, align 8, !tbaa !14
  %14 = load i32, ptr %i.ascast, align 4, !tbaa !18
  %conv17 = sext i32 %14 to i64
  %call18 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNK3gsl4spanIKdEixEm(ptr noundef nonnull align 8 dereferenceable(16) %energy.ascast, i64 noundef %conv17) #12
  %15 = load double, ptr %call18, align 8, !tbaa !14
  %sub19 = fsub double %13, %15
  %16 = load i32, ptr %i.ascast, align 4, !tbaa !18
  %add = add nsw i32 %16, 1
  %conv20 = sext i32 %add to i64
  %call21 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNK3gsl4spanIKdEixEm(ptr noundef nonnull align 8 dereferenceable(16) %energy.ascast, i64 noundef %conv20) #12
  %17 = load double, ptr %call21, align 8, !tbaa !14
  %18 = load i32, ptr %i.ascast, align 4, !tbaa !18
  %conv22 = sext i32 %18 to i64
  %call23 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNK3gsl4spanIKdEixEm(ptr noundef nonnull align 8 dereferenceable(16) %energy.ascast, i64 noundef %conv22) #12
  %19 = load double, ptr %call23, align 8, !tbaa !14
...
if.end26:                                         ; preds = %if.end25, %if.then5
  ...
  %call27 = call noundef double @_ZN6openmc3prnEPm(ptr noundef %21) #12
...
if.end30:                                         ; preds = %if.then29, %if.end26
  ...
  %call32 = call %"class.openmc::TabularFlat" @_ZNK6openmc21AngleDistributionFlat12distributionEl(ptr noundef nonnull align 8 dereferenceable(16) %this1, i64 noundef %conv31) #12
  %24 = getelementptr inbounds nuw %"class.openmc::TabularFlat", ptr %ref.tmp.ascast, i32 0, i32 0
  %25 = extractvalue %"class.openmc::TabularFlat" %call32, 0
  store ptr %25, ptr %24, align 8
  %26 = getelementptr inbounds nuw %"class.openmc::TabularFlat", ptr %ref.tmp.ascast, i32 0, i32 1
  %27 = extractvalue %"class.openmc::TabularFlat" %call32, 1
  store i64 %27, ptr %26, align 8
  %28 = load ptr, ptr %seed.addr.ascast, align 8, !tbaa !31
  %call33 = call noundef double @_ZNK6openmc11TabularFlat6sampleEPm(ptr noundef nonnull align 8 dereferenceable(16) %ref.tmp.ascast, ptr noundef %28) #12
  call void @llvm.lifetime.end.p5(i64 16, ptr addrspace(5) %ref.tmp) #10
  store double %call33, ptr %mu.ascast, align 8, !tbaa !14
  %29 = load double, ptr %mu.ascast, align 8, !tbaa !14
  %call34 = call noundef double @"_ZL28abs$ompvariant$S2$s7$Pamdgcnd"(double noundef %29) #13
  %cmp35 = fcmp ogt double %call34, 1.000000e+00
  br i1 %cmp35, label %if.then36, label %if.end38

if.then36:                                        ; preds = %if.end30
  %30 = load double, ptr %mu.ascast, align 8, !tbaa !14
  %call37 = call noundef double @"_ZL33copysign$ompvariant$S2$s7$Pamdgcndd"(double noundef 1.000000e+00, double noundef %30) #13
  store double %call37, ptr %mu.ascast, align 8, !tbaa !14
  br label %if.end38

if.end38:                                         ; preds = %if.then36, %if.end30
  %31 = load double, ptr %mu.ascast, align 8, !tbaa !14
  ...
  call void @llvm.lifetime.end.p5(i64 16, ptr addrspace(5) %energy) #10
  br label %return

return:                                           ; preds = %if.end38, %if.then
  %32 = load double, ptr %retval.ascast, align 8
  ret double %32
}
...
; Function Attrs: convergent mustprogress nounwind
define hidden %"class.gsl::span" @_ZNK6openmc21AngleDistributionFlat6energyEv(ptr noundef nonnull align 8 dereferenceable(16) %this) #3 align 2 {
entry:
  ...
  store ptr %add.ptr, ptr %start.ascast, align 8, !tbaa !33
  %1 = load ptr, ptr %start.ascast, align 8, !tbaa !33
  %n_ = getelementptr inbounds nuw %"class.openmc::AngleDistributionFlat", ptr %this1, i32 0, i32 1
...
entry:
  ...
  %0 = load ptr, ptr %first_, align 8, !tbaa !38
...
entry:
  ...
  store ptr %first, ptr %first.addr.ascast, align 8, !tbaa !33
  store ptr %last, ptr %last.addr.ascast, align 8, !tbaa !33
  store ptr %value, ptr %value.addr.ascast, align 8, !tbaa !33
  %0 = load ptr, ptr %first.addr.ascast, align 8, !tbaa !33
  %1 = load double, ptr %0, align 8, !tbaa !14
  %2 = load ptr, ptr %value.addr.ascast, align 8, !tbaa !33
...
if.end:                                           ; preds = %entry
  %4 = load ptr, ptr %first.addr.ascast, align 8, !tbaa !33
  %5 = load ptr, ptr %last.addr.ascast, align 8, !tbaa !33
  %6 = load ptr, ptr %value.addr.ascast, align 8, !tbaa !33
  ...
  %7 = load ptr, ptr %first.addr.ascast, align 8, !tbaa !33
...
entry:
  ...
  %0 = load ptr, ptr %last_, align 8, !tbaa !40
  ret ptr %0
}

; Function Attrs: convergent mustprogress nounwind
define hidden %"class.openmc::TabularFlat" @_ZNK6openmc21AngleDistributionFlat12distributionEl(ptr noundef nonnull align 8 dereferenceable(16) %this, i64 noundef %i) #3 align 2 {
entry:
  ...
  store ptr %add.ptr2, ptr %indices.ascast, align 8, !tbaa !41
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %idx) #10
  %2 = load ptr, ptr %indices.ascast, align 8, !tbaa !41
  ...
  store i64 %conv, ptr %idx.ascast, align 8, !tbaa !37
  ...
  %6 = load i64, ptr %idx.ascast, align 8, !tbaa !37
  %add.ptr4 = getelementptr inbounds nuw i8, ptr %5, i64 %6
  call void @_ZN6openmc11TabularFlatC1EPKh(ptr noundef nonnull align 8 dereferenceable(16) %retval.ascast, ptr noundef %add.ptr4) #12
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %idx) #10
...
entry:
  ...
  store ptr %this, ptr %this.addr.ascast, align 8, !tbaa !35
  store ptr %data_in, ptr %data_in.addr.ascast, align 8, !tbaa !33
  store i64 %size_in, ptr %size_in.addr.ascast, align 8, !tbaa !37
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  %0 = load ptr, ptr %data_in.addr.ascast, align 8, !tbaa !33
  %first_ = getelementptr inbounds nuw %"class.gsl::span", ptr %this1, i32 0, i32 0
  store ptr %0, ptr %first_, align 8, !tbaa !38
  %1 = load ptr, ptr %data_in.addr.ascast, align 8, !tbaa !33
  %2 = load i64, ptr %size_in.addr.ascast, align 8, !tbaa !37
  %add.ptr = getelementptr inbounds nuw double, ptr %1, i64 %2
  %last_ = getelementptr inbounds nuw %"class.gsl::span", ptr %this1, i32 0, i32 1
  store ptr %add.ptr, ptr %last_, align 8, !tbaa !40
  ret void
}
...
entry:
  ...
  store ptr %__first, ptr %__first.addr.ascast, align 8, !tbaa !33
  store ptr %__last, ptr %__last.addr.ascast, align 8, !tbaa !33
  store ptr %__val, ptr %__val.addr.ascast, align 8, !tbaa !33
  %0 = load ptr, ptr %__first.addr.ascast, align 8, !tbaa !33
  %1 = load ptr, ptr %__last.addr.ascast, align 8, !tbaa !33
  %2 = load ptr, ptr %__val.addr.ascast, align 8, !tbaa !33
...
while.body:                                       ; preds = %while.cond
  ...
  %4 = load ptr, ptr %__first.addr.ascast, align 8, !tbaa !33
  store ptr %4, ptr %__middle.ascast, align 8, !tbaa !33
  ...
  %6 = load ptr, ptr %__middle.ascast, align 8, !tbaa !33
  %7 = load ptr, ptr %__val.addr.ascast, align 8, !tbaa !33
...
if.then:                                          ; preds = %while.body
  %8 = load ptr, ptr %__middle.ascast, align 8, !tbaa !33
  store ptr %8, ptr %__first.addr.ascast, align 8, !tbaa !33
  %9 = load ptr, ptr %__first.addr.ascast, align 8, !tbaa !33
  %incdec.ptr = getelementptr inbounds nuw double, ptr %9, i32 1
  store ptr %incdec.ptr, ptr %__first.addr.ascast, align 8, !tbaa !33
...
while.end:                                        ; preds = %while.cond
  %13 = load ptr, ptr %__first.addr.ascast, align 8, !tbaa !33
...
entry:
  ...
  %agg.tmp.ascast = addrspacecast ptr addrspace(5) %agg.tmp to ptr
  %undef.agg.tmp.ascast = addrspacecast ptr addrspace(5) %undef.agg.tmp to ptr
  store ptr %__i, ptr %__i.addr.ascast, align 8, !tbaa !45
  ...
  %1 = load ptr, ptr %__i.addr.ascast, align 8, !tbaa !45
  %2 = load i64, ptr %__d.ascast, align 8, !tbaa !37
  %3 = load ptr, ptr %__i.addr.ascast, align 8, !tbaa !45
...
entry:
  ...
  store ptr %__it, ptr %__it.addr.ascast, align 8, !tbaa !33
  store ptr %__val, ptr %__val.addr.ascast, align 8, !tbaa !33
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  %0 = load ptr, ptr %__it.addr.ascast, align 8, !tbaa !33
  %1 = load double, ptr %0, align 8, !tbaa !14
  %2 = load ptr, ptr %__val.addr.ascast, align 8, !tbaa !33
  %3 = load double, ptr %2, align 8, !tbaa !14
...
entry:
  ...
  store ptr %__last, ptr %__last.addr.ascast, align 8, !tbaa !33
  %1 = load ptr, ptr %__last.addr.ascast, align 8, !tbaa !33
  %2 = load ptr, ptr %__first.addr.ascast, align 8, !tbaa !33
...
entry:
  ...
  store ptr %0, ptr %.addr.ascast, align 8, !tbaa !45
  ret void
}
...
if.then:                                          ; preds = %land.lhs.true
  %4 = load ptr, ptr %__i.addr.ascast, align 8, !tbaa !45
  %5 = load ptr, ptr %4, align 8, !tbaa !33
  %incdec.ptr = getelementptr inbounds nuw double, ptr %5, i32 1
  store ptr %incdec.ptr, ptr %4, align 8, !tbaa !33
  br label %if.end6
...
if.then3:                                         ; preds = %land.lhs.true1
  %9 = load ptr, ptr %__i.addr.ascast, align 8, !tbaa !45
  %10 = load ptr, ptr %9, align 8, !tbaa !33
  %incdec.ptr4 = getelementptr inbounds double, ptr %10, i32 -1
  store ptr %incdec.ptr4, ptr %9, align 8, !tbaa !33
  br label %if.end

if.else5:                                         ; preds = %land.lhs.true1, %if.else
  %11 = load i64, ptr %__n.addr.ascast, align 8, !tbaa !37
  %12 = load ptr, ptr %__i.addr.ascast, align 8, !tbaa !45
  %13 = load ptr, ptr %12, align 8, !tbaa !33
  %add.ptr = getelementptr inbounds double, ptr %13, i64 %11
  store ptr %add.ptr, ptr %12, align 8, !tbaa !33
  br label %if.end
...
!21 = !{!"float", !16, i64 0}
!22 = !{!23, !23, i64 0}
!23 = !{!"p1 _ZTSN6openmc21AngleDistributionFlatE", !24, i64 0}
!24 = !{!"any pointer", !16, i64 0}
!25 = !{!26, !26, i64 0}
!26 = !{!"p1 omnipotent char", !24, i64 0}
!27 = !{!28, !26, i64 0}
!28 = !{!"_ZTSN6openmc21AngleDistributionFlatE", !26, i64 0, !29, i64 8}
!29 = !{!"long", !16, i64 0}
!30 = !{!28, !29, i64 8}
!31 = !{!32, !32, i64 0}
!32 = !{!"p1 long", !24, i64 0}
...
!37 = !{!29, !29, i64 0}
!38 = !{!39, !34, i64 0}
!39 = !{!"_ZTSN3gsl4spanIKdEE", !34, i64 0, !34, i64 8}
!40 = !{!39, !34, i64 8}
!41 = !{!42, !42, i64 0}
!42 = !{!"p1 int", !24, i64 0}
!43 = distinct !{!43, !44}
...
!47 = !{!"any p2 pointer", !24, i64 0}
!48 = !{!49, !49, i64 0}
!49 = !{!"p1 _ZTSN9__gnu_cxx5__ops14_Iter_less_valE", !24, i64 0}
!50 = !{!51, !51, i64 0}
!51 = !{!"bool", !52, i64 0}
