; ModuleID = 'mgxs_interface-openmp-amdgcn-amd-amdhsa-gfx942.tmp.bc'
source_filename = "/g/g0/wright117/workspace/openmc/openmc-omp/openmc/src/mgxs_interface.cpp"
...
define internal double @__ocml_logb_f64(double noundef %0) #3 {
  ...
  %5 = load i8, ptr addrspace(4) @__oclc_finite_only_opt, align 1, !tbaa !28, !range !32, !noundef !33
  %6 = icmp eq i8 %5, 0
