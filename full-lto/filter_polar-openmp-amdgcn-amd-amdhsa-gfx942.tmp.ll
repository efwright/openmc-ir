; ModuleID = 'filter_polar-openmp-amdgcn-amd-amdhsa-gfx942.tmp.bc'
...
entry:
  ...
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %z) #9
  %0 = load i32, ptr %estimator.addr.ascast, align 4, !tbaa !27
  %cmp = icmp eq i32 %0, 1
  br i1 %cmp, label %cond.true, label %cond.false

cond.true:                                        ; preds = %entry
  %1 = load ptr, ptr %p.addr.ascast, align 8, !tbaa !25
  %call = call noundef nonnull align 8 dereferenceable(24) ptr @_ZNK6openmc8Particle1uEv(ptr noundef nonnull align 8 dereferenceable(2728) %1) #11
  %z2 = getelementptr inbounds nuw %"struct.openmc::Position", ptr %call, i32 0, i32 2
  %2 = load double, ptr %z2, align 8, !tbaa !31
  br label %cond.end

cond.false:                                       ; preds = %entry
  %3 = load ptr, ptr %p.addr.ascast, align 8, !tbaa !25
  %u_last_ = getelementptr inbounds nuw %"class.openmc::Particle", ptr %3, i32 0, i32 19
  %z3 = getelementptr inbounds nuw %"struct.openmc::Position", ptr %u_last_, i32 0, i32 2
  %4 = load double, ptr %z3, align 8, !tbaa !33
  br label %cond.end

cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi double [ %2, %cond.true ], [ %4, %cond.false ]
  store double %cond, ptr %z.ascast, align 8, !tbaa !14
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %theta) #9
  %5 = load double, ptr %z.ascast, align 8, !tbaa !14
  %call4 = call noundef double @"_ZL29acos$ompvariant$S2$s7$Pamdgcnd"(double noundef %5) #12
  store double %call4, ptr %theta.ascast, align 8, !tbaa !14
  %6 = load double, ptr %theta.ascast, align 8, !tbaa !14
  %bins_ = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 4
  %call5 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNK6openmc6vectorIdE5frontEv(ptr noundef nonnull align 8 dereferenceable(24) %bins_) #11
  %7 = load double, ptr %call5, align 8, !tbaa !14
  %cmp6 = fcmp oge double %6, %7
...
land.lhs.true:                                    ; preds = %cond.end
  ...
  %call8 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNK6openmc6vectorIdE4backEv(ptr noundef nonnull align 8 dereferenceable(24) %bins_7) #11
  %9 = load double, ptr %call8, align 8, !tbaa !14
  %cmp9 = fcmp ole double %8, %9
  br i1 %cmp9, label %if.then, label %if.end

if.then:                                          ; preds = %land.lhs.true
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %bin) #9
  %bins_10 = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 4
  %call11 = call noundef ptr @_ZNK6openmc6vectorIdE5beginEv(ptr noundef nonnull align 8 dereferenceable(24) %bins_10) #11
  %bins_12 = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 4
  %call13 = call noundef ptr @_ZNK6openmc6vectorIdE3endEv(ptr noundef nonnull align 8 dereferenceable(24) %bins_12) #11
  %call14 = call noundef i64 @_ZN6openmc17lower_bound_indexIPKddEENSt15iterator_traitsIT_E15difference_typeES4_S4_RKT0_(ptr noundef %call11, ptr noundef %call13, ptr noundef nonnull align 8 dereferenceable(8) %theta.ascast) #11
  store i64 %call14, ptr %bin.ascast, align 8, !tbaa !48
  %10 = load ptr, ptr %match.addr.ascast, align 8, !tbaa !29
  %11 = load i64, ptr %bin.ascast, align 8, !tbaa !48
  %conv = trunc i64 %11 to i32
  call void @_ZN6openmc11FilterMatch9push_backEid(ptr noundef nonnull align 8 dereferenceable(1513) %10, i32 noundef %conv, double noundef 1.000000e+00) #11
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %bin) #9
  br label %if.end

if.end:                                           ; preds = %if.then, %land.lhs.true, %cond.end
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %theta) #9
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %z) #9
  ret void
}
...
define internal noundef double @"_ZL29acos$ompvariant$S2$s7$Pamdgcnd"(double noundef %__x) #4 {
entry:
  ...
  %call = call double @__ocml_acos_f64(double noundef %0) #10
  ret double %call
}
...
entry:
  ...
  %retval.ascast = addrspacecast ptr addrspace(5) %retval to ptr
  %this.addr.ascast = addrspacecast ptr addrspace(5) %this.addr to ptr
  store ptr %this, ptr %this.addr.ascast, align 8, !tbaa !49
  %this1 = load ptr, ptr %this.addr.ascast, align 8
...
entry:
  ...
  store ptr %first, ptr %first.addr.ascast, align 8, !tbaa !55
  store ptr %last, ptr %last.addr.ascast, align 8, !tbaa !55
  store ptr %value, ptr %value.addr.ascast, align 8, !tbaa !55
  %0 = load ptr, ptr %first.addr.ascast, align 8, !tbaa !55
  %1 = load double, ptr %0, align 8, !tbaa !14
  %2 = load ptr, ptr %value.addr.ascast, align 8, !tbaa !55
...
if.end:                                           ; preds = %entry
  %4 = load ptr, ptr %first.addr.ascast, align 8, !tbaa !55
  %5 = load ptr, ptr %last.addr.ascast, align 8, !tbaa !55
  %6 = load ptr, ptr %value.addr.ascast, align 8, !tbaa !55
  ...
  %7 = load ptr, ptr %first.addr.ascast, align 8, !tbaa !55
...
entry:
  ...
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  %call = call noundef zeroext i1 @_ZN6openmc11FilterMatch7is_fullEv(ptr noundef nonnull align 8 dereferenceable(1513) %this1) #11
...
define linkonce_odr hidden noundef ptr @_ZSt11lower_boundIPKddET_S2_S2_RKT0_(ptr noundef %__first, ptr noundef %__last, ptr noundef nonnull align 8 dereferenceable(8) %__val) #5 comdat {
entry:
  %retval = alloca ptr, align 8, addrspace(5)
  ...
  store ptr %__first, ptr %__first.addr.ascast, align 8, !tbaa !55
  store ptr %__last, ptr %__last.addr.ascast, align 8, !tbaa !55
  store ptr %__val, ptr %__val.addr.ascast, align 8, !tbaa !55
  %0 = load ptr, ptr %__first.addr.ascast, align 8, !tbaa !55
  %1 = load ptr, ptr %__last.addr.ascast, align 8, !tbaa !55
  %2 = load ptr, ptr %__val.addr.ascast, align 8, !tbaa !55
...
while.body:                                       ; preds = %while.cond
  ...
  %4 = load ptr, ptr %__first.addr.ascast, align 8, !tbaa !55
  store ptr %4, ptr %__middle.ascast, align 8, !tbaa !55
  ...
  %6 = load ptr, ptr %__middle.ascast, align 8, !tbaa !55
  %7 = load ptr, ptr %__val.addr.ascast, align 8, !tbaa !55
...
if.then:                                          ; preds = %while.body
  %8 = load ptr, ptr %__middle.ascast, align 8, !tbaa !55
  store ptr %8, ptr %__first.addr.ascast, align 8, !tbaa !55
  %9 = load ptr, ptr %__first.addr.ascast, align 8, !tbaa !55
  %incdec.ptr = getelementptr inbounds nuw double, ptr %9, i32 1
  store ptr %incdec.ptr, ptr %__first.addr.ascast, align 8, !tbaa !55
...
while.end:                                        ; preds = %while.cond
  %13 = load ptr, ptr %__first.addr.ascast, align 8, !tbaa !55
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %__len) #9
  ret ptr %13
}

; Function Attrs: convergent inlinehint mustprogress nounwind
define linkonce_odr hidden void @_ZN9__gnu_cxx5__ops15__iter_less_valEv() #5 comdat {
entry:
...
; Function Attrs: convergent inlinehint mustprogress nounwind
define linkonce_odr hidden noundef i64 @_ZSt8distanceIPKdENSt15iterator_traitsIT_E15difference_typeES3_S3_(ptr noundef %__first, ptr noundef %__last) #5 comdat {
entry:
  %retval = alloca i64, align 8, addrspace(5)
  %__first.addr = alloca ptr, align 8, addrspace(5)
  %__last.addr = alloca ptr, align 8, addrspace(5)
...
; Function Attrs: convergent inlinehint mustprogress nounwind
define linkonce_odr hidden void @_ZSt7advanceIPKdlEvRT_T0_(ptr noundef nonnull align 8 dereferenceable(8) %__i, i64 noundef %__n) #5 comdat {
entry:
  ...
  %agg.tmp.ascast = addrspacecast ptr addrspace(5) %agg.tmp to ptr
  %undef.agg.tmp.ascast = addrspacecast ptr addrspace(5) %undef.agg.tmp to ptr
  store ptr %__i, ptr %__i.addr.ascast, align 8, !tbaa !60
  ...
  %1 = load ptr, ptr %__i.addr.ascast, align 8, !tbaa !60
  %2 = load i64, ptr %__d.ascast, align 8, !tbaa !48
  %3 = load ptr, ptr %__i.addr.ascast, align 8, !tbaa !60
...
entry:
  ...
  store ptr %__it, ptr %__it.addr.ascast, align 8, !tbaa !55
  store ptr %__val, ptr %__val.addr.ascast, align 8, !tbaa !55
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  %0 = load ptr, ptr %__it.addr.ascast, align 8, !tbaa !55
  %1 = load double, ptr %0, align 8, !tbaa !14
  %2 = load ptr, ptr %__val.addr.ascast, align 8, !tbaa !55
  %3 = load double, ptr %2, align 8, !tbaa !14
...
; Function Attrs: convergent inlinehint mustprogress nounwind
define linkonce_odr hidden noundef i64 @_ZSt10__distanceIPKdENSt15iterator_traitsIT_E15difference_typeES3_S3_St26random_access_iterator_tag(ptr noundef %__first, ptr noundef %__last) #5 comdat {
entry:
  %retval = alloca i64, align 8, addrspace(5)
  ...
  store ptr %__last, ptr %__last.addr.ascast, align 8, !tbaa !55
  %1 = load ptr, ptr %__last.addr.ascast, align 8, !tbaa !55
  %2 = load ptr, ptr %__first.addr.ascast, align 8, !tbaa !55
...
; Function Attrs: convergent inlinehint mustprogress nounwind
define linkonce_odr hidden void @_ZSt19__iterator_categoryIPKdENSt15iterator_traitsIT_E17iterator_categoryERKS3_(ptr noundef nonnull align 8 dereferenceable(8) %0) #5 comdat {
entry:
  ...
  store ptr %0, ptr %.addr.ascast, align 8, !tbaa !60
  ret void
}

; Function Attrs: convergent inlinehint mustprogress nounwind
define linkonce_odr hidden void @_ZSt9__advanceIPKdlEvRT_T0_St26random_access_iterator_tag(ptr noundef nonnull align 8 dereferenceable(8) %__i, i64 noundef %__n) #5 comdat {
entry:
  %tmp = alloca %"struct.std::random_access_iterator_tag", align 1, addrspace(5)
  %__i.addr = alloca ptr, align 8, addrspace(5)
  %__n.addr = alloca i64, align 8, addrspace(5)
...
if.then:                                          ; preds = %land.lhs.true
  %4 = load ptr, ptr %__i.addr.ascast, align 8, !tbaa !60
  %5 = load ptr, ptr %4, align 8, !tbaa !55
  %incdec.ptr = getelementptr inbounds nuw double, ptr %5, i32 1
  store ptr %incdec.ptr, ptr %4, align 8, !tbaa !55
  br label %if.end6
...
if.then3:                                         ; preds = %land.lhs.true1
  %9 = load ptr, ptr %__i.addr.ascast, align 8, !tbaa !60
  %10 = load ptr, ptr %9, align 8, !tbaa !55
  %incdec.ptr4 = getelementptr inbounds double, ptr %10, i32 -1
  store ptr %incdec.ptr4, ptr %9, align 8, !tbaa !55
  br label %if.end

if.else5:                                         ; preds = %land.lhs.true1, %if.else
  %11 = load i64, ptr %__n.addr.ascast, align 8, !tbaa !48
  %12 = load ptr, ptr %__i.addr.ascast, align 8, !tbaa !60
  %13 = load ptr, ptr %12, align 8, !tbaa !55
  %add.ptr = getelementptr inbounds double, ptr %13, i64 %11
  store ptr %add.ptr, ptr %12, align 8, !tbaa !55
  br label %if.end
...
define internal double @__ocml_acos_f64(double noundef %0) #7 {
...
!33 = !{!34, !15, i64 1504}
!34 = !{!"_ZTSN6openmc8ParticleE", !35, i64 0, !16, i64 168, !36, i64 744, !37, i64 864, !38, i64 872, !19, i64 876, !19, i64 880, !16, i64 888, !19, i64 1368, !16, i64 1372, !15, i64 1400, !15, i64 1408, !19, i64 1416, !19, i64 1420, !15, i64 1424, !15, i64 1432, !32, i64 1440, !32, i64 1464, !32, i64 1488, !15, i64 1512, !39, i64 1520, !40, i64 1524, !19, i64 1528, !19, i64 1532, !19, i64 1536, !19, i64 1540, !19, i64 1544, !15, i64 1552, !16, i64 1560, !19, i64 1592, !19, i64 1596, !19, i64 1600, !19, i64 1604, !41, i64 1608, !15, i64 1640, !15, i64 1648, !19, i64 1656, !39, i64 1660, !16, i64 1664, !19, i64 1728, !16, i64 1736, !37, i64 2216, !37, i64 2224, !16, i64 2232, !30, i64 2240, !43, i64 2248, !16, i64 2272, !15, i64 2656, !15, i64 2664, !15, i64 2672, !15, i64 2680, !39, i64 2688, !15, i64 2696, !15, i64 2704, !19, i64 2712, !37, i64 2720}
...
!37 = !{!"long", !16, i64 0}
!38 = !{!"_ZTSN6openmc8Particle4TypeE", !16, i64 0}
!39 = !{!"bool", !16, i64 0}
...
!48 = !{!37, !37, i64 0}
!49 = !{!50, !50, i64 0}
!50 = !{!"p1 _ZTSN6openmc6vectorIdEE", !24, i64 0}
!51 = !{!52, !53, i64 0}
!52 = !{!"_ZTSN6openmc6vectorIdEE", !53, i64 0, !37, i64 8, !37, i64 16}
!53 = !{!"p1 double", !24, i64 0}
!54 = !{!52, !37, i64 8}
!55 = !{!53, !53, i64 0}
!56 = !{!57, !19, i64 1504}
...
!62 = !{!"any p2 pointer", !24, i64 0}
!63 = !{!64, !64, i64 0}
!64 = !{!"p1 _ZTSN9__gnu_cxx5__ops14_Iter_less_valE", !24, i64 0}
!65 = !{!66, !66, i64 0}
!66 = !{!"bool", !67, i64 0}
