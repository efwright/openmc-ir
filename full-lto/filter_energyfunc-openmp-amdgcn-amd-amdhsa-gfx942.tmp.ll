; ModuleID = 'filter_energyfunc-openmp-amdgcn-amd-amdhsa-gfx942.tmp.bc'
source_filename = "/g/g0/wright117/workspace/openmc/openmc-omp/openmc/src/tallies/filter_energyfunc.cpp"
...
entry:
  ...
  %E_last_ = getelementptr inbounds nuw %"class.openmc::Particle", ptr %0, i32 0, i32 12
  %1 = load double, ptr %E_last_, align 8, !tbaa !31
  %energy_ = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 12
  %call = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNK6openmc6vectorIdE5frontEv(ptr noundef nonnull align 8 dereferenceable(24) %energy_) #10
...
land.lhs.true:                                    ; preds = %entry
  ...
  %E_last_2 = getelementptr inbounds nuw %"class.openmc::Particle", ptr %3, i32 0, i32 12
  %4 = load double, ptr %E_last_2, align 8, !tbaa !31
  %energy_3 = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 12
  %call4 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNK6openmc6vectorIdE4backEv(ptr noundef nonnull align 8 dereferenceable(24) %energy_3) #10
  %5 = load double, ptr %call4, align 8, !tbaa !14
  %cmp5 = fcmp ole double %4, %5
  br i1 %cmp5, label %if.then, label %if.end

if.then:                                          ; preds = %land.lhs.true
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %i) #8
  %energy_6 = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 12
  %call7 = call noundef ptr @_ZNK6openmc6vectorIdE5beginEv(ptr noundef nonnull align 8 dereferenceable(24) %energy_6) #10
  %energy_8 = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 12
  %call9 = call noundef ptr @_ZNK6openmc6vectorIdE3endEv(ptr noundef nonnull align 8 dereferenceable(24) %energy_8) #10
  %6 = load ptr, ptr %p.addr.ascast, align 8, !tbaa !25
  %E_last_10 = getelementptr inbounds nuw %"class.openmc::Particle", ptr %6, i32 0, i32 12
  %call11 = call noundef i64 @_ZN6openmc17lower_bound_indexIPKddEENSt15iterator_traitsIT_E15difference_typeES4_S4_RKT0_(ptr noundef %call7, ptr noundef %call9, ptr noundef nonnull align 8 dereferenceable(8) %E_last_10) #10
  store i64 %call11, ptr %i.ascast, align 8, !tbaa !47
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %f) #8
  %7 = load ptr, ptr %p.addr.ascast, align 8, !tbaa !25
  %E_last_12 = getelementptr inbounds nuw %"class.openmc::Particle", ptr %7, i32 0, i32 12
  %8 = load double, ptr %E_last_12, align 8, !tbaa !31
  %energy_13 = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 12
  %9 = load i64, ptr %i.ascast, align 8, !tbaa !47
  %call14 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNK6openmc6vectorIdEixEm(ptr noundef nonnull align 8 dereferenceable(24) %energy_13, i64 noundef %9) #10
  %10 = load double, ptr %call14, align 8, !tbaa !14
  %sub = fsub double %8, %10
  %energy_15 = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 12
  %11 = load i64, ptr %i.ascast, align 8, !tbaa !47
  %add = add nsw i64 %11, 1
  %call16 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNK6openmc6vectorIdEixEm(ptr noundef nonnull align 8 dereferenceable(24) %energy_15, i64 noundef %add) #10
  %12 = load double, ptr %call16, align 8, !tbaa !14
  %energy_17 = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 12
  %13 = load i64, ptr %i.ascast, align 8, !tbaa !47
  %call18 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNK6openmc6vectorIdEixEm(ptr noundef nonnull align 8 dereferenceable(24) %energy_17, i64 noundef %13) #10
  %14 = load double, ptr %call18, align 8, !tbaa !14
  %sub19 = fsub double %12, %14
  %div = fdiv double %sub, %sub19
  store double %div, ptr %f.ascast, align 8, !tbaa !14
  %15 = load ptr, ptr %match.addr.ascast, align 8, !tbaa !29
  %16 = load double, ptr %f.ascast, align 8, !tbaa !14
  %sub20 = fsub double 1.000000e+00, %16
  %y_ = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 14
  %17 = load i64, ptr %i.ascast, align 8, !tbaa !47
  %call21 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNK6openmc6vectorIdEixEm(ptr noundef nonnull align 8 dereferenceable(24) %y_, i64 noundef %17) #10
  %18 = load double, ptr %call21, align 8, !tbaa !14
  %19 = load double, ptr %f.ascast, align 8, !tbaa !14
  %y_22 = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 14
  %20 = load i64, ptr %i.ascast, align 8, !tbaa !47
  %add23 = add nsw i64 %20, 1
  %call24 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNK6openmc6vectorIdEixEm(ptr noundef nonnull align 8 dereferenceable(24) %y_22, i64 noundef %add23) #10
  %21 = load double, ptr %call24, align 8, !tbaa !14
  %mul25 = fmul double %19, %21
  %22 = call double @llvm.fmuladd.f64(double %sub20, double %18, double %mul25)
  call void @_ZN6openmc11FilterMatch9push_backEid(ptr noundef nonnull align 8 dereferenceable(1513) %15, i32 noundef 0, double noundef %22) #10
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %f) #8
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %i) #8
  br label %if.end
...
entry:
  ...
  %0 = load ptr, ptr %data_, align 8, !tbaa !50
  %arrayidx = getelementptr inbounds double, ptr %0, i64 0
  ret ptr %arrayidx
}

; Function Attrs: convergent mustprogress nounwind
define linkonce_odr hidden noundef nonnull align 8 dereferenceable(8) ptr @_ZNK6openmc6vectorIdE4backEv(ptr noundef nonnull align 8 dereferenceable(24) %this) #3 comdat align 2 {
entry:
  %retval = alloca ptr, align 8, addrspace(5)
  %this.addr = alloca ptr, align 8, addrspace(5)
  %retval.ascast = addrspacecast ptr addrspace(5) %retval to ptr
  ...
  %1 = load i64, ptr %size_, align 8, !tbaa !53
  %sub = sub i64 %1, 1
...
entry:
  ...
  store ptr %first, ptr %first.addr.ascast, align 8, !tbaa !54
  store ptr %last, ptr %last.addr.ascast, align 8, !tbaa !54
  store ptr %value, ptr %value.addr.ascast, align 8, !tbaa !54
  %0 = load ptr, ptr %first.addr.ascast, align 8, !tbaa !54
  %1 = load double, ptr %0, align 8, !tbaa !14
  %2 = load ptr, ptr %value.addr.ascast, align 8, !tbaa !54
...
if.end:                                           ; preds = %entry
  %4 = load ptr, ptr %first.addr.ascast, align 8, !tbaa !54
  %5 = load ptr, ptr %last.addr.ascast, align 8, !tbaa !54
  %6 = load ptr, ptr %value.addr.ascast, align 8, !tbaa !54
  %call = call noundef ptr @_ZSt11lower_boundIPKddET_S2_S2_RKT0_(ptr noundef %4, ptr noundef %5, ptr noundef nonnull align 8 dereferenceable(8) %6) #10
  %7 = load ptr, ptr %first.addr.ascast, align 8, !tbaa !54
...
entry:
  ...
  store ptr %this, ptr %this.addr.ascast, align 8, !tbaa !48
  store i64 %pos, ptr %pos.addr.ascast, align 8, !tbaa !47
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  %data_ = getelementptr inbounds nuw %"class.openmc::vector", ptr %this1, i32 0, i32 0
  %0 = load ptr, ptr %data_, align 8, !tbaa !50
  %1 = load i64, ptr %pos.addr.ascast, align 8, !tbaa !47
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i32, ptr %bins_weights_length_, align 8, !tbaa !55
  ...
  %3 = load i32, ptr %bins_weights_length_2, align 8, !tbaa !55
  ...
  %4 = load i32, ptr %bins_weights_length_5, align 8, !tbaa !55
  %inc = add nsw i32 %4, 1
  store i32 %inc, ptr %bins_weights_length_5, align 8, !tbaa !55
  br label %if.end
...
entry:
  ...
  store ptr %__first, ptr %__first.addr.ascast, align 8, !tbaa !54
  store ptr %__last, ptr %__last.addr.ascast, align 8, !tbaa !54
  store ptr %__val, ptr %__val.addr.ascast, align 8, !tbaa !54
  %0 = load ptr, ptr %__first.addr.ascast, align 8, !tbaa !54
  %1 = load ptr, ptr %__last.addr.ascast, align 8, !tbaa !54
  %2 = load ptr, ptr %__val.addr.ascast, align 8, !tbaa !54
  call void @_ZN9__gnu_cxx5__ops15__iter_less_valEv() #10
  %call = call noundef ptr @_ZSt13__lower_boundIPKddN9__gnu_cxx5__ops14_Iter_less_valEET_S5_S5_RKT0_T1_(ptr noundef %0, ptr noundef %1, ptr noundef nonnull align 8 dereferenceable(8) %2) #10
  ret ptr %call
}
...
entry:
  ...
  store ptr %__last, ptr %__last.addr.ascast, align 8, !tbaa !54
  store ptr %__val, ptr %__val.addr.ascast, align 8, !tbaa !54
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %__len) #8
  %0 = load ptr, ptr %__first.addr.ascast, align 8, !tbaa !54
  %1 = load ptr, ptr %__last.addr.ascast, align 8, !tbaa !54
  %call = call noundef i64 @_ZSt8distanceIPKdENSt15iterator_traitsIT_E15difference_typeES3_S3_(ptr noundef %0, ptr noundef %1) #10
  store i64 %call, ptr %__len.ascast, align 8, !tbaa !47
  br label %while.cond

while.cond:                                       ; preds = %if.end, %entry
  %2 = load i64, ptr %__len.ascast, align 8, !tbaa !47
  %cmp = icmp sgt i64 %2, 0
  br i1 %cmp, label %while.body, label %while.end

while.body:                                       ; preds = %while.cond
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %__half) #8
  %3 = load i64, ptr %__len.ascast, align 8, !tbaa !47
  %shr = ashr i64 %3, 1
  store i64 %shr, ptr %__half.ascast, align 8, !tbaa !47
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %__middle) #8
  %4 = load ptr, ptr %__first.addr.ascast, align 8, !tbaa !54
  store ptr %4, ptr %__middle.ascast, align 8, !tbaa !54
  %5 = load i64, ptr %__half.ascast, align 8, !tbaa !47
  call void @_ZSt7advanceIPKdlEvRT_T0_(ptr noundef nonnull align 8 dereferenceable(8) %__middle.ascast, i64 noundef %5) #10
  %6 = load ptr, ptr %__middle.ascast, align 8, !tbaa !54
  %7 = load ptr, ptr %__val.addr.ascast, align 8, !tbaa !54
  %call1 = call noundef zeroext i1 @_ZNK9__gnu_cxx5__ops14_Iter_less_valclIPKdS3_EEbT_RT0_(ptr noundef nonnull align 1 dereferenceable(1) %__comp, ptr noundef %6, ptr noundef nonnull align 8 dereferenceable(8) %7) #10
  br i1 %call1, label %if.then, label %if.else

if.then:                                          ; preds = %while.body
  %8 = load ptr, ptr %__middle.ascast, align 8, !tbaa !54
  store ptr %8, ptr %__first.addr.ascast, align 8, !tbaa !54
  %9 = load ptr, ptr %__first.addr.ascast, align 8, !tbaa !54
  %incdec.ptr = getelementptr inbounds nuw double, ptr %9, i32 1
  store ptr %incdec.ptr, ptr %__first.addr.ascast, align 8, !tbaa !54
  %10 = load i64, ptr %__len.ascast, align 8, !tbaa !47
  %11 = load i64, ptr %__half.ascast, align 8, !tbaa !47
  %sub = sub nsw i64 %10, %11
  %sub2 = sub nsw i64 %sub, 1
  store i64 %sub2, ptr %__len.ascast, align 8, !tbaa !47
  br label %if.end

if.else:                                          ; preds = %while.body
  %12 = load i64, ptr %__half.ascast, align 8, !tbaa !47
  store i64 %12, ptr %__len.ascast, align 8, !tbaa !47
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %__middle) #8
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %__half) #8
  br label %while.cond, !llvm.loop !57

while.end:                                        ; preds = %while.cond
  %13 = load ptr, ptr %__first.addr.ascast, align 8, !tbaa !54
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %__len) #8
  ret ptr %13
}
...
entry:
  ...
  %0 = load ptr, ptr %__first.addr.ascast, align 8, !tbaa !54
  %1 = load ptr, ptr %__last.addr.ascast, align 8, !tbaa !54
  call void @_ZSt19__iterator_categoryIPKdENSt15iterator_traitsIT_E17iterator_categoryERKS3_(ptr noundef nonnull align 8 dereferenceable(8) %__first.addr.ascast) #10
  %call = call noundef i64 @_ZSt10__distanceIPKdENSt15iterator_traitsIT_E15difference_typeES3_S3_St26random_access_iterator_tag(ptr noundef %0, ptr noundef %1) #10
  ret i64 %call
}
...
entry:
  ...
  %agg.tmp.ascast = addrspacecast ptr addrspace(5) %agg.tmp to ptr
  %undef.agg.tmp.ascast = addrspacecast ptr addrspace(5) %undef.agg.tmp to ptr
  store ptr %__i, ptr %__i.addr.ascast, align 8, !tbaa !59
  store i64 %__n, ptr %__n.addr.ascast, align 8, !tbaa !47
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %__d) #8
  %0 = load i64, ptr %__n.addr.ascast, align 8, !tbaa !47
  store i64 %0, ptr %__d.ascast, align 8, !tbaa !47
  %1 = load ptr, ptr %__i.addr.ascast, align 8, !tbaa !59
  %2 = load i64, ptr %__d.ascast, align 8, !tbaa !47
  %3 = load ptr, ptr %__i.addr.ascast, align 8, !tbaa !59
  call void @_ZSt19__iterator_categoryIPKdENSt15iterator_traitsIT_E17iterator_categoryERKS3_(ptr noundef nonnull align 8 dereferenceable(8) %3) #10
  call void @_ZSt9__advanceIPKdlEvRT_T0_St26random_access_iterator_tag(ptr noundef nonnull align 8 dereferenceable(8) %1, i64 noundef %2) #10
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %__d) #8
  ret void
}
...
entry:
  ...
  %__val.addr.ascast = addrspacecast ptr addrspace(5) %__val.addr to ptr
  store ptr %this, ptr %this.addr.ascast, align 8, !tbaa !62
  store ptr %__it, ptr %__it.addr.ascast, align 8, !tbaa !54
  store ptr %__val, ptr %__val.addr.ascast, align 8, !tbaa !54
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  %0 = load ptr, ptr %__it.addr.ascast, align 8, !tbaa !54
  %1 = load double, ptr %0, align 8, !tbaa !14
  %2 = load ptr, ptr %__val.addr.ascast, align 8, !tbaa !54
  %3 = load double, ptr %2, align 8, !tbaa !14
...
entry:
  ...
  store ptr %__last, ptr %__last.addr.ascast, align 8, !tbaa !54
  %1 = load ptr, ptr %__last.addr.ascast, align 8, !tbaa !54
  %2 = load ptr, ptr %__first.addr.ascast, align 8, !tbaa !54
...
entry:
  ...
  store ptr %0, ptr %.addr.ascast, align 8, !tbaa !59
  ret void
}
...
entry:
  ...
  store ptr %__i, ptr %__i.addr.ascast, align 8, !tbaa !59
  store i64 %__n, ptr %__n.addr.ascast, align 8, !tbaa !47
  %1 = load i64, ptr %__n.addr.ascast, align 8, !tbaa !47
  %2 = call i1 @llvm.is.constant.i64(i64 %1)
  br i1 %2, label %land.lhs.true, label %if.else

land.lhs.true:                                    ; preds = %entry
  %3 = load i64, ptr %__n.addr.ascast, align 8, !tbaa !47
  %cmp = icmp eq i64 %3, 1
  br i1 %cmp, label %if.then, label %if.else

if.then:                                          ; preds = %land.lhs.true
  %4 = load ptr, ptr %__i.addr.ascast, align 8, !tbaa !59
  %5 = load ptr, ptr %4, align 8, !tbaa !54
  %incdec.ptr = getelementptr inbounds nuw double, ptr %5, i32 1
  store ptr %incdec.ptr, ptr %4, align 8, !tbaa !54
  br label %if.end6

if.else:                                          ; preds = %land.lhs.true, %entry
  %6 = load i64, ptr %__n.addr.ascast, align 8, !tbaa !47
  %7 = call i1 @llvm.is.constant.i64(i64 %6)
  br i1 %7, label %land.lhs.true1, label %if.else5

land.lhs.true1:                                   ; preds = %if.else
  %8 = load i64, ptr %__n.addr.ascast, align 8, !tbaa !47
  %cmp2 = icmp eq i64 %8, -1
  br i1 %cmp2, label %if.then3, label %if.else5

if.then3:                                         ; preds = %land.lhs.true1
  %9 = load ptr, ptr %__i.addr.ascast, align 8, !tbaa !59
  %10 = load ptr, ptr %9, align 8, !tbaa !54
  %incdec.ptr4 = getelementptr inbounds double, ptr %10, i32 -1
  store ptr %incdec.ptr4, ptr %9, align 8, !tbaa !54
  br label %if.end

if.else5:                                         ; preds = %land.lhs.true1, %if.else
  %11 = load i64, ptr %__n.addr.ascast, align 8, !tbaa !47
  %12 = load ptr, ptr %__i.addr.ascast, align 8, !tbaa !59
  %13 = load ptr, ptr %12, align 8, !tbaa !54
  %add.ptr = getelementptr inbounds double, ptr %13, i64 %11
  store ptr %add.ptr, ptr %12, align 8, !tbaa !54
  br label %if.end
...
entry:
  ...
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  %bins_weights_length_ = getelementptr inbounds nuw %"class.openmc::FilterMatch", ptr %this1, i32 0, i32 3
  %0 = load i32, ptr %bins_weights_length_, align 8, !tbaa !55
...
define internal double @__ocml_logb_f64(double noundef %0) #6 {
  ...
  %5 = load i8, ptr addrspace(4) @__oclc_finite_only_opt, align 1, !tbaa !64, !range !68, !noundef !69
  %6 = icmp eq i8 %5, 0
...
!47 = !{!35, !35, i64 0}
!48 = !{!49, !49, i64 0}
!49 = !{!"p1 _ZTSN6openmc6vectorIdEE", !24, i64 0}
!50 = !{!51, !52, i64 0}
!51 = !{!"_ZTSN6openmc6vectorIdEE", !52, i64 0, !35, i64 8, !35, i64 16}
!52 = !{!"p1 double", !24, i64 0}
!53 = !{!51, !35, i64 8}
!54 = !{!52, !52, i64 0}
!55 = !{!56, !19, i64 1504}
!56 = !{!"_ZTSN6openmc11FilterMatchE", !16, i64 0, !16, i64 504, !19, i64 1504, !19, i64 1508, !38, i64 1512}
!57 = distinct !{!57, !58}
!58 = !{!"llvm.loop.mustprogress"}
!59 = !{!60, !60, i64 0}
!60 = !{!"p2 double", !61, i64 0}
!61 = !{!"any p2 pointer", !24, i64 0}
!62 = !{!63, !63, i64 0}
!63 = !{!"p1 _ZTSN9__gnu_cxx5__ops14_Iter_less_valE", !24, i64 0}
!64 = !{!65, !65, i64 0}
!65 = !{!"bool", !66, i64 0}
