; ModuleID = 'filter_mu-openmp-amdgcn-amd-amdhsa-gfx942.tmp.bc'
source_filename = "/g/g0/wright117/workspace/openmc/openmc-omp/openmc/src/tallies/filter_mu.cpp"
...
entry:
  ...
  %mu_ = getelementptr inbounds nuw %"class.openmc::Particle", ptr %0, i32 0, i32 16
  %1 = load double, ptr %mu_, align 8, !tbaa !31
...
land.lhs.true:                                    ; preds = %entry
  ...
  %mu_2 = getelementptr inbounds nuw %"class.openmc::Particle", ptr %3, i32 0, i32 16
  %4 = load double, ptr %mu_2, align 8, !tbaa !31
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %mu_10 = getelementptr inbounds nuw %"class.openmc::Particle", ptr %6, i32 0, i32 16
  %call11 = call noundef i64 @_ZN6openmc17lower_bound_indexIPKddEENSt15iterator_traitsIT_E15difference_typeES4_S4_RKT0_(ptr noundef %call7, ptr noundef %call9, ptr noundef nonnull align 8 dereferenceable(8) %mu_10) #10
