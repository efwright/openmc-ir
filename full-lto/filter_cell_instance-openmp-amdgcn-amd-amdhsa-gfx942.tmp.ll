; ModuleID = 'filter_cell_instance-openmp-amdgcn-amd-amdhsa-gfx942.tmp.bc'
...
$_ZNK6openmc10static_mapINS_12CellInstanceElNS_16CellInstanceHashEE4findES1_ = comdat any

$_ZNK6openmc10static_mapINS_12CellInstanceElNS_16CellInstanceHashEE3endEv = comdat any

$_ZN6openmc11FilterMatch9push_backEid = comdat any

$_ZNK6openmc10static_mapINS_12CellInstanceElNS_16CellInstanceHashEE12bucket_indexERKS1_ = comdat any

$_ZNK6openmc6vectorISt4pairImmEEixEm = comdat any

$_ZNK6openmc6vectorISt4pairINS_12CellInstanceElEE5beginEv = comdat any

$_ZNK6openmc12CellInstanceeqERKS0_ = comdat any

$_ZNK6openmc6vectorISt4pairINS_12CellInstanceElEE3endEv = comdat any

$_ZNK6openmc16CellInstanceHashclERKNS_12CellInstanceE = comdat any

$_ZNK6openmc10static_mapINS_12CellInstanceElNS_16CellInstanceHashEE12bucket_countEv = comdat any
...
entry:
  ...
  %index_cell = alloca i64, align 8, addrspace(5)
  %instance = alloca i64, align 8, addrspace(5)
  %search = alloca ptr, align 8, addrspace(5)
  %agg.tmp = alloca %"struct.openmc::CellInstance", align 8, addrspace(5)
  ...
  %index_cell.ascast = addrspacecast ptr addrspace(5) %index_cell to ptr
  %instance.ascast = addrspacecast ptr addrspace(5) %instance to ptr
  %search.ascast = addrspacecast ptr addrspace(5) %search to ptr
  ...
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %index_cell) #8
  ...
  %2 = load i32, ptr %n_coord_, align 4, !tbaa !31
  %sub = sub nsw i32 %2, 1
  ...
  %3 = load i32, ptr %cell, align 8, !tbaa !47
  %conv = sext i32 %3 to i64
  store i64 %conv, ptr %index_cell.ascast, align 8, !tbaa !49
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %instance) #8
  %4 = load ptr, ptr %p.addr.ascast, align 8, !tbaa !25
  %cell_instance_ = getelementptr inbounds nuw %"class.openmc::Particle", ptr %4, i32 0, i32 6
  %5 = load i32, ptr %cell_instance_, align 8, !tbaa !50
  %conv2 = sext i32 %5 to i64
  store i64 %conv2, ptr %instance.ascast, align 8, !tbaa !49
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %search) #8
  %imap_ = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 8
  %index_cell3 = getelementptr inbounds nuw %"struct.openmc::CellInstance", ptr %agg.tmp.ascast, i32 0, i32 0
  %6 = load i64, ptr %index_cell.ascast, align 8, !tbaa !49
  store i64 %6, ptr %index_cell3, align 8, !tbaa !51
  %instance4 = getelementptr inbounds nuw %"struct.openmc::CellInstance", ptr %agg.tmp.ascast, i32 0, i32 1
  %7 = load i64, ptr %instance.ascast, align 8, !tbaa !49
  store i64 %7, ptr %instance4, align 8, !tbaa !53
  %8 = getelementptr inbounds nuw %"struct.openmc::CellInstance", ptr %agg.tmp.ascast, i32 0, i32 0
  %9 = load i64, ptr %8, align 8
  %10 = getelementptr inbounds nuw %"struct.openmc::CellInstance", ptr %agg.tmp.ascast, i32 0, i32 1
  %11 = load i64, ptr %10, align 8
  %call = call noundef ptr @_ZNK6openmc10static_mapINS_12CellInstanceElNS_16CellInstanceHashEE4findES1_(ptr noundef nonnull align 8 dereferenceable(50) %imap_, i64 %9, i64 %11) #10
  store ptr %call, ptr %search.ascast, align 8, !tbaa !54
  %12 = load ptr, ptr %search.ascast, align 8, !tbaa !54
  %imap_5 = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 8
  %call6 = call noundef ptr @_ZNK6openmc10static_mapINS_12CellInstanceElNS_16CellInstanceHashEE3endEv(ptr noundef nonnull align 8 dereferenceable(50) %imap_5) #10
  %cmp = icmp ne ptr %12, %call6
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %13 = load ptr, ptr %match.addr.ascast, align 8, !tbaa !29
  %14 = load ptr, ptr %search.ascast, align 8, !tbaa !54
  %second = getelementptr inbounds nuw %"struct.std::pair", ptr %14, i32 0, i32 1
  %15 = load i64, ptr %second, align 8, !tbaa !56
  %conv7 = trunc i64 %15 to i32
  call void @_ZN6openmc11FilterMatch9push_backEid(ptr noundef nonnull align 8 dereferenceable(1513) %13, i32 noundef %conv7, double noundef 1.000000e+00) #10
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %search) #8
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %instance) #8
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %index_cell) #8
  ret void
}

; Function Attrs: convergent inlinehint mustprogress nounwind
define linkonce_odr hidden noundef ptr @_ZNK6openmc10static_mapINS_12CellInstanceElNS_16CellInstanceHashEE4findES1_(ptr noundef nonnull align 8 dereferenceable(50) %this, i64 %key.coerce0, i64 %key.coerce1) #4 comdat align 2 {
entry:
  %retval = alloca ptr, align 8, addrspace(5)
  %key = alloca %"struct.openmc::CellInstance", align 8, addrspace(5)
  %this.addr = alloca ptr, align 8, addrspace(5)
  %idx = alloca i64, align 8, addrspace(5)
  %bounds = alloca %"struct.std::pair.9", align 8, addrspace(5)
  %last = alloca ptr, align 8, addrspace(5)
  %iter = alloca ptr, align 8, addrspace(5)
  %cleanup.dest.slot = alloca i32, align 4, addrspace(5)
  %retval.ascast = addrspacecast ptr addrspace(5) %retval to ptr
  %key1 = addrspacecast ptr addrspace(5) %key to ptr
  %this.addr.ascast = addrspacecast ptr addrspace(5) %this.addr to ptr
  %idx.ascast = addrspacecast ptr addrspace(5) %idx to ptr
  %bounds.ascast = addrspacecast ptr addrspace(5) %bounds to ptr
  %last.ascast = addrspacecast ptr addrspace(5) %last to ptr
  %iter.ascast = addrspacecast ptr addrspace(5) %iter to ptr
  %cleanup.dest.slot.ascast = addrspacecast ptr addrspace(5) %cleanup.dest.slot to ptr
  %0 = getelementptr inbounds nuw %"struct.openmc::CellInstance", ptr %key1, i32 0, i32 0
  store i64 %key.coerce0, ptr %0, align 8
  %1 = getelementptr inbounds nuw %"struct.openmc::CellInstance", ptr %key1, i32 0, i32 1
  ...
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %idx) #8
  %call = call noundef i64 @_ZNK6openmc10static_mapINS_12CellInstanceElNS_16CellInstanceHashEE12bucket_indexERKS1_(ptr noundef nonnull align 8 dereferenceable(50) %this2, ptr noundef nonnull align 8 dereferenceable(16) %key1) #10
  store i64 %call, ptr %idx.ascast, align 8, !tbaa !49
  call void @llvm.lifetime.start.p5(i64 16, ptr addrspace(5) %bounds) #8
  %buckets_ = getelementptr inbounds nuw %"class.openmc::static_map.5", ptr %this2, i32 0, i32 1
  %2 = load i64, ptr %idx.ascast, align 8, !tbaa !49
  %call3 = call noundef nonnull align 8 dereferenceable(16) ptr @_ZNK6openmc6vectorISt4pairImmEEixEm(ptr noundef nonnull align 8 dereferenceable(24) %buckets_, i64 noundef %2) #10
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %bounds.ascast, ptr align 8 %call3, i64 16, i1 false)
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %last) #8
  %items_ = getelementptr inbounds nuw %"class.openmc::static_map.5", ptr %this2, i32 0, i32 0
  %call4 = call noundef ptr @_ZNK6openmc6vectorISt4pairINS_12CellInstanceElEE5beginEv(ptr noundef nonnull align 8 dereferenceable(24) %items_) #10
  %second = getelementptr inbounds nuw %"struct.std::pair.9", ptr %bounds.ascast, i32 0, i32 1
  %3 = load i64, ptr %second, align 8, !tbaa !60
  %add.ptr = getelementptr inbounds nuw %"struct.std::pair", ptr %call4, i64 %3
  store ptr %add.ptr, ptr %last.ascast, align 8, !tbaa !54
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %iter) #8
  %items_5 = getelementptr inbounds nuw %"class.openmc::static_map.5", ptr %this2, i32 0, i32 0
  %call6 = call noundef ptr @_ZNK6openmc6vectorISt4pairINS_12CellInstanceElEE5beginEv(ptr noundef nonnull align 8 dereferenceable(24) %items_5) #10
  %first = getelementptr inbounds nuw %"struct.std::pair.9", ptr %bounds.ascast, i32 0, i32 0
  %4 = load i64, ptr %first, align 8, !tbaa !62
  %add.ptr7 = getelementptr inbounds nuw %"struct.std::pair", ptr %call6, i64 %4
  store ptr %add.ptr7, ptr %iter.ascast, align 8, !tbaa !54
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %5 = load ptr, ptr %iter.ascast, align 8, !tbaa !54
  %6 = load ptr, ptr %last.ascast, align 8, !tbaa !54
  %cmp = icmp ne ptr %5, %6
...
for.body:                                         ; preds = %for.cond
  %7 = load ptr, ptr %iter.ascast, align 8, !tbaa !54
  %first8 = getelementptr inbounds nuw %"struct.std::pair", ptr %7, i32 0, i32 0
  %call9 = call noundef zeroext i1 @_ZNK6openmc12CellInstanceeqERKS0_(ptr noundef nonnull align 8 dereferenceable(16) %key1, ptr noundef nonnull align 8 dereferenceable(16) %first8) #10
  br i1 %call9, label %if.then, label %if.end

if.then:                                          ; preds = %for.body
  %8 = load ptr, ptr %iter.ascast, align 8, !tbaa !54
  store ptr %8, ptr %retval.ascast, align 8
...
for.inc:                                          ; preds = %if.end
  %9 = load ptr, ptr %iter.ascast, align 8, !tbaa !54
  %incdec.ptr = getelementptr inbounds nuw %"struct.std::pair", ptr %9, i32 1
  store ptr %incdec.ptr, ptr %iter.ascast, align 8, !tbaa !54
  br label %for.cond, !llvm.loop !63

cleanup:                                          ; preds = %if.then, %for.cond.cleanup
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %iter) #8
...
for.end:                                          ; preds = %cleanup
  %items_10 = getelementptr inbounds nuw %"class.openmc::static_map.5", ptr %this2, i32 0, i32 0
  %call11 = call noundef ptr @_ZNK6openmc6vectorISt4pairINS_12CellInstanceElEE3endEv(ptr noundef nonnull align 8 dereferenceable(24) %items_10) #10
  store ptr %call11, ptr %retval.ascast, align 8
  store i32 1, ptr %cleanup.dest.slot.ascast, align 4
  br label %cleanup12

cleanup12:                                        ; preds = %for.end, %cleanup
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %last) #8
  call void @llvm.lifetime.end.p5(i64 16, ptr addrspace(5) %bounds) #8
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %idx) #8
  %10 = load ptr, ptr %retval.ascast, align 8
  ret ptr %10
}

; Function Attrs: convergent mustprogress nounwind
define linkonce_odr hidden noundef ptr @_ZNK6openmc10static_mapINS_12CellInstanceElNS_16CellInstanceHashEE3endEv(ptr noundef nonnull align 8 dereferenceable(50) %this) #3 comdat align 2 {
entry:
  %retval = alloca ptr, align 8, addrspace(5)
  %this.addr = alloca ptr, align 8, addrspace(5)
  %retval.ascast = addrspacecast ptr addrspace(5) %retval to ptr
  ...
  store ptr %this, ptr %this.addr.ascast, align 8, !tbaa !58
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  %items_ = getelementptr inbounds nuw %"class.openmc::static_map.5", ptr %this1, i32 0, i32 0
  %call = call noundef ptr @_ZNK6openmc6vectorISt4pairINS_12CellInstanceElEE3endEv(ptr noundef nonnull align 8 dereferenceable(24) %items_) #10
  ret ptr %call
}
...
entry:
  ...
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  %call = call noundef zeroext i1 @_ZN6openmc11FilterMatch7is_fullEv(ptr noundef nonnull align 8 dereferenceable(1513) %this1) #10
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i32, ptr %bins_weights_length_, align 8, !tbaa !65
  ...
  %3 = load i32, ptr %bins_weights_length_2, align 8, !tbaa !65
  ...
  %4 = load i32, ptr %bins_weights_length_5, align 8, !tbaa !65
  %inc = add nsw i32 %4, 1
  store i32 %inc, ptr %bins_weights_length_5, align 8, !tbaa !65
  br label %if.end
...
; Function Attrs: convergent mustprogress nounwind
define linkonce_odr hidden noundef i64 @_ZNK6openmc10static_mapINS_12CellInstanceElNS_16CellInstanceHashEE12bucket_indexERKS1_(ptr noundef nonnull align 8 dereferenceable(50) %this, ptr noundef nonnull align 8 dereferenceable(16) %key) #3 comdat align 2 {
entry:
  %retval = alloca i64, align 8, addrspace(5)
  %this.addr = alloca ptr, align 8, addrspace(5)
  %key.addr = alloca ptr, align 8, addrspace(5)
  %retval.ascast = addrspacecast ptr addrspace(5) %retval to ptr
  %this.addr.ascast = addrspacecast ptr addrspace(5) %this.addr to ptr
  %key.addr.ascast = addrspacecast ptr addrspace(5) %key.addr to ptr
  store ptr %this, ptr %this.addr.ascast, align 8, !tbaa !58
  store ptr %key, ptr %key.addr.ascast, align 8, !tbaa !67
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  %0 = getelementptr inbounds i8, ptr %this1, i64 49
  %1 = load ptr, ptr %key.addr.ascast, align 8, !tbaa !67
  %call = call noundef i64 @_ZNK6openmc16CellInstanceHashclERKNS_12CellInstanceE(ptr noundef nonnull align 1 dereferenceable(1) %0, ptr noundef nonnull align 8 dereferenceable(16) %1) #10
  %call2 = call noundef i64 @_ZNK6openmc10static_mapINS_12CellInstanceElNS_16CellInstanceHashEE12bucket_countEv(ptr noundef nonnull align 8 dereferenceable(50) %this1) #10
  %rem = urem i64 %call, %call2
  ret i64 %rem
}

; Function Attrs: convergent mustprogress nounwind
define linkonce_odr hidden noundef nonnull align 8 dereferenceable(16) ptr @_ZNK6openmc6vectorISt4pairImmEEixEm(ptr noundef nonnull align 8 dereferenceable(24) %this, i64 noundef %pos) #3 comdat align 2 {
entry:
  %retval = alloca ptr, align 8, addrspace(5)
  %this.addr = alloca ptr, align 8, addrspace(5)
...
; Function Attrs: convergent mustprogress nounwind
define linkonce_odr hidden noundef ptr @_ZNK6openmc6vectorISt4pairINS_12CellInstanceElEE5beginEv(ptr noundef nonnull align 8 dereferenceable(24) %this) #3 comdat align 2 {
entry:
  %retval = alloca ptr, align 8, addrspace(5)
  %this.addr = alloca ptr, align 8, addrspace(5)
  %retval.ascast = addrspacecast ptr addrspace(5) %retval to ptr
  ...
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  %data_ = getelementptr inbounds nuw %"class.openmc::vector.6", ptr %this1, i32 0, i32 0
  %0 = load ptr, ptr %data_, align 8, !tbaa !76
  ret ptr %0
}

; Function Attrs: convergent mustprogress nounwind
define linkonce_odr hidden noundef zeroext i1 @_ZNK6openmc12CellInstanceeqERKS0_(ptr noundef nonnull align 8 dereferenceable(16) %this, ptr noundef nonnull align 8 dereferenceable(16) %other) #3 comdat align 2 {
entry:
  ...
  store ptr %this, ptr %this.addr.ascast, align 8, !tbaa !67
  store ptr %other, ptr %other.addr.ascast, align 8, !tbaa !67
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  %index_cell = getelementptr inbounds nuw %"struct.openmc::CellInstance", ptr %this1, i32 0, i32 0
  %0 = load i64, ptr %index_cell, align 8, !tbaa !51
  %1 = load ptr, ptr %other.addr.ascast, align 8, !tbaa !67
  %index_cell2 = getelementptr inbounds nuw %"struct.openmc::CellInstance", ptr %1, i32 0, i32 0
  %2 = load i64, ptr %index_cell2, align 8, !tbaa !51
  %cmp = icmp eq i64 %0, %2
  br i1 %cmp, label %land.rhs, label %land.end

land.rhs:                                         ; preds = %entry
  %instance = getelementptr inbounds nuw %"struct.openmc::CellInstance", ptr %this1, i32 0, i32 1
  %3 = load i64, ptr %instance, align 8, !tbaa !53
  %4 = load ptr, ptr %other.addr.ascast, align 8, !tbaa !67
  %instance3 = getelementptr inbounds nuw %"struct.openmc::CellInstance", ptr %4, i32 0, i32 1
  %5 = load i64, ptr %instance3, align 8, !tbaa !53
...
; Function Attrs: convergent mustprogress nounwind
define linkonce_odr hidden noundef ptr @_ZNK6openmc6vectorISt4pairINS_12CellInstanceElEE3endEv(ptr noundef nonnull align 8 dereferenceable(24) %this) #3 comdat align 2 {
entry:
  %retval = alloca ptr, align 8, addrspace(5)
  %this.addr = alloca ptr, align 8, addrspace(5)
  %retval.ascast = addrspacecast ptr addrspace(5) %retval to ptr
  ...
  %data_ = getelementptr inbounds nuw %"class.openmc::vector.6", ptr %this1, i32 0, i32 0
  %0 = load ptr, ptr %data_, align 8, !tbaa !76
  %size_ = getelementptr inbounds nuw %"class.openmc::vector.6", ptr %this1, i32 0, i32 1
...
; Function Attrs: convergent mustprogress nounwind
define linkonce_odr hidden noundef i64 @_ZNK6openmc16CellInstanceHashclERKNS_12CellInstanceE(ptr noundef nonnull align 1 dereferenceable(1) %this, ptr noundef nonnull align 8 dereferenceable(16) %k) #3 comdat align 2 {
entry:
  %retval = alloca i64, align 8, addrspace(5)
  %this.addr = alloca ptr, align 8, addrspace(5)
  %k.addr = alloca ptr, align 8, addrspace(5)
  %retval.ascast = addrspacecast ptr addrspace(5) %retval to ptr
  %this.addr.ascast = addrspacecast ptr addrspace(5) %this.addr to ptr
  %k.addr.ascast = addrspacecast ptr addrspace(5) %k.addr to ptr
  store ptr %this, ptr %this.addr.ascast, align 8, !tbaa !79
  store ptr %k, ptr %k.addr.ascast, align 8, !tbaa !67
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  %0 = load ptr, ptr %k.addr.ascast, align 8, !tbaa !67
  %index_cell = getelementptr inbounds nuw %"struct.openmc::CellInstance", ptr %0, i32 0, i32 0
  %1 = load i64, ptr %index_cell, align 8, !tbaa !51
  %mul = mul nsw i64 4096, %1
  %2 = load ptr, ptr %k.addr.ascast, align 8, !tbaa !67
  %instance = getelementptr inbounds nuw %"struct.openmc::CellInstance", ptr %2, i32 0, i32 1
  %3 = load i64, ptr %instance, align 8, !tbaa !53
...
; Function Attrs: convergent mustprogress nounwind
define linkonce_odr hidden noundef i64 @_ZNK6openmc10static_mapINS_12CellInstanceElNS_16CellInstanceHashEE12bucket_countEv(ptr noundef nonnull align 8 dereferenceable(50) %this) #3 comdat align 2 {
entry:
  %retval = alloca i64, align 8, addrspace(5)
  %this.addr = alloca ptr, align 8, addrspace(5)
  %retval.ascast = addrspacecast ptr addrspace(5) %retval to ptr
  ...
  store ptr %this, ptr %this.addr.ascast, align 8, !tbaa !58
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  %buckets_ = getelementptr inbounds nuw %"class.openmc::static_map.5", ptr %this1, i32 0, i32 1
  %call = call noundef i64 @_ZNK6openmc6vectorISt4pairImmEE4sizeEv(ptr noundef nonnull align 8 dereferenceable(24) %buckets_) #10
  ret i64 %call
}

; Function Attrs: convergent mustprogress nounwind
define linkonce_odr hidden noundef i64 @_ZNK6openmc6vectorISt4pairImmEE4sizeEv(ptr noundef nonnull align 8 dereferenceable(24) %this) #3 comdat align 2 {
entry:
  %retval = alloca i64, align 8, addrspace(5)
  %this.addr = alloca ptr, align 8, addrspace(5)
  %retval.ascast = addrspacecast ptr addrspace(5) %retval to ptr
  ...
  %0 = load i64, ptr %size_, align 8, !tbaa !81
  ret i64 %0
}
...
entry:
  ...
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  %bins_weights_length_ = getelementptr inbounds nuw %"class.openmc::FilterMatch", ptr %this1, i32 0, i32 3
  %0 = load i32, ptr %bins_weights_length_, align 8, !tbaa !65
...
define internal double @__ocml_logb_f64(double noundef %0) #6 {
  ...
  %5 = load i8, ptr addrspace(4) @__oclc_finite_only_opt, align 1, !tbaa !82, !range !86, !noundef !87
  %6 = icmp eq i8 %5, 0
...
!31 = !{!32, !19, i64 876}
!32 = !{!"_ZTSN6openmc8ParticleE", !33, i64 0, !16, i64 168, !34, i64 744, !35, i64 864, !36, i64 872, !19, i64 876, !19, i64 880, !16, i64 888, !19, i64 1368, !16, i64 1372, !15, i64 1400, !15, i64 1408, !19, i64 1416, !19, i64 1420, !15, i64 1424, !15, i64 1432, !37, i64 1440, !37, i64 1464, !37, i64 1488, !15, i64 1512, !38, i64 1520, !39, i64 1524, !19, i64 1528, !19, i64 1532, !19, i64 1536, !19, i64 1540, !19, i64 1544, !15, i64 1552, !16, i64 1560, !19, i64 1592, !19, i64 1596, !19, i64 1600, !19, i64 1604, !40, i64 1608, !15, i64 1640, !15, i64 1648, !19, i64 1656, !38, i64 1660, !16, i64 1664, !19, i64 1728, !16, i64 1736, !35, i64 2216, !35, i64 2224, !16, i64 2232, !30, i64 2240, !42, i64 2248, !16, i64 2272, !15, i64 2656, !15, i64 2664, !15, i64 2672, !15, i64 2680, !38, i64 2688, !15, i64 2696, !15, i64 2704, !19, i64 2712, !35, i64 2720}
!33 = !{!"_ZTSN6openmc19NuclideMicroXSCacheE", !16, i64 0}
!34 = !{!"_ZTSN6openmc7MacroXSE", !15, i64 0, !15, i64 8, !15, i64 16, !15, i64 24, !15, i64 32, !16, i64 40, !15, i64 88, !15, i64 96, !15, i64 104, !15, i64 112}
!35 = !{!"long", !16, i64 0}
!36 = !{!"_ZTSN6openmc8Particle4TypeE", !16, i64 0}
!37 = !{!"_ZTSN6openmc8PositionE", !15, i64 0, !15, i64 8, !15, i64 16}
!38 = !{!"bool", !16, i64 0}
!39 = !{!"_ZTSN6openmc10TallyEventE", !16, i64 0}
!40 = !{!"_ZTSN6openmc12BoundaryInfoE", !15, i64 0, !19, i64 8, !19, i64 12, !41, i64 16}
!41 = !{!"_ZTSSt5arrayIiLm3EE", !16, i64 0}
!42 = !{!"_ZTSSt6vectorIS_IN6openmc8PositionESaIS1_EESaIS3_EE", !43, i64 0}
!43 = !{!"_ZTSSt12_Vector_baseISt6vectorIN6openmc8PositionESaIS2_EESaIS4_EE", !44, i64 0}
!44 = !{!"_ZTSNSt12_Vector_baseISt6vectorIN6openmc8PositionESaIS2_EESaIS4_EE12_Vector_implE", !45, i64 0}
!45 = !{!"_ZTSNSt12_Vector_baseISt6vectorIN6openmc8PositionESaIS2_EESaIS4_EE17_Vector_impl_dataE", !46, i64 0, !46, i64 8, !46, i64 16}
!46 = !{!"p1 _ZTSSt6vectorIN6openmc8PositionESaIS1_EE", !24, i64 0}
!47 = !{!48, !19, i64 48}
!48 = !{!"_ZTSN6openmc10LocalCoordE", !37, i64 0, !37, i64 24, !19, i64 48, !19, i64 52, !19, i64 56, !19, i64 60, !19, i64 64, !19, i64 68, !38, i64 72}
!49 = !{!35, !35, i64 0}
!50 = !{!32, !19, i64 880}
!51 = !{!52, !35, i64 0}
!52 = !{!"_ZTSN6openmc12CellInstanceE", !35, i64 0, !35, i64 8}
!53 = !{!52, !35, i64 8}
!54 = !{!55, !55, i64 0}
!55 = !{!"p1 _ZTSSt4pairIN6openmc12CellInstanceElE", !24, i64 0}
!56 = !{!57, !35, i64 16}
!57 = !{!"_ZTSSt4pairIN6openmc12CellInstanceElE", !52, i64 0, !35, i64 16}
!58 = !{!59, !59, i64 0}
!59 = !{!"p1 _ZTSN6openmc10static_mapINS_12CellInstanceElNS_16CellInstanceHashEEE", !24, i64 0}
!60 = !{!61, !35, i64 8}
!61 = !{!"_ZTSSt4pairImmE", !35, i64 0, !35, i64 8}
!62 = !{!61, !35, i64 0}
!63 = distinct !{!63, !64}
!64 = !{!"llvm.loop.mustprogress"}
!65 = !{!66, !19, i64 1504}
!66 = !{!"_ZTSN6openmc11FilterMatchE", !16, i64 0, !16, i64 504, !19, i64 1504, !19, i64 1508, !38, i64 1512}
!67 = !{!68, !68, i64 0}
!68 = !{!"p1 _ZTSN6openmc12CellInstanceE", !24, i64 0}
!69 = !{!70, !70, i64 0}
!70 = !{!"p1 _ZTSN6openmc6vectorISt4pairImmEEE", !24, i64 0}
!71 = !{!72, !73, i64 0}
!72 = !{!"_ZTSN6openmc6vectorISt4pairImmEEE", !73, i64 0, !35, i64 8, !35, i64 16}
!73 = !{!"p1 _ZTSSt4pairImmE", !24, i64 0}
!74 = !{!75, !75, i64 0}
!75 = !{!"p1 _ZTSN6openmc6vectorISt4pairINS_12CellInstanceElEEE", !24, i64 0}
!76 = !{!77, !55, i64 0}
!77 = !{!"_ZTSN6openmc6vectorISt4pairINS_12CellInstanceElEEE", !55, i64 0, !35, i64 8, !35, i64 16}
!78 = !{!77, !35, i64 8}
!79 = !{!80, !80, i64 0}
!80 = !{!"p1 _ZTSN6openmc16CellInstanceHashE", !24, i64 0}
!81 = !{!72, !35, i64 8}
!82 = !{!83, !83, i64 0}
!83 = !{!"bool", !84, i64 0}
