; ModuleID = 'filter_sptl_legendre-openmp-amdgcn-amd-amdhsa-gfx942.tmp.bc'
...
define hidden void @_ZNK6openmc6Filter34SpatialLegendreFilter_get_all_binsERKNS_8ParticleENS_14TallyEstimatorERNS_11FilterMatchE(ptr noundef nonnull align 8 dereferenceable(448) %this, ptr noundef nonnull align 8 dereferenceable(2728) %p, i32 noundef %estimator, ptr noundef nonnull align 8 dereferenceable(1513) %match) #3 align 2 {
entry:
  ...
  %x_norm = alloca double, align 8, addrspace(5)
  ...
  %x_norm.ascast = addrspacecast ptr addrspace(5) %x_norm to ptr
  ...
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %x) #7
  %axis_ = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 22
  %0 = load i32, ptr %axis_, align 4, !tbaa !31
  %cmp = icmp eq i32 %0, 0
  br i1 %cmp, label %if.then, label %if.else

if.then:                                          ; preds = %entry
  %1 = load ptr, ptr %p.addr.ascast, align 8, !tbaa !25
  %call = call noundef nonnull align 8 dereferenceable(24) ptr @_ZNK6openmc8Particle1rEv(ptr noundef nonnull align 8 dereferenceable(2728) %1) #9
  %x2 = getelementptr inbounds nuw %"struct.openmc::Position", ptr %call, i32 0, i32 0
  %2 = load double, ptr %x2, align 8, !tbaa !55
  store double %2, ptr %x.ascast, align 8, !tbaa !14
  br label %if.end9

if.else:                                          ; preds = %entry
  %axis_3 = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 22
  %3 = load i32, ptr %axis_3, align 4, !tbaa !31
  %cmp4 = icmp eq i32 %3, 1
  br i1 %cmp4, label %if.then5, label %if.else7

if.then5:                                         ; preds = %if.else
  %4 = load ptr, ptr %p.addr.ascast, align 8, !tbaa !25
  %call6 = call noundef nonnull align 8 dereferenceable(24) ptr @_ZNK6openmc8Particle1rEv(ptr noundef nonnull align 8 dereferenceable(2728) %4) #9
  %y = getelementptr inbounds nuw %"struct.openmc::Position", ptr %call6, i32 0, i32 1
  %5 = load double, ptr %y, align 8, !tbaa !57
  store double %5, ptr %x.ascast, align 8, !tbaa !14
  br label %if.end

if.else7:                                         ; preds = %if.else
  %6 = load ptr, ptr %p.addr.ascast, align 8, !tbaa !25
  %call8 = call noundef nonnull align 8 dereferenceable(24) ptr @_ZNK6openmc8Particle1rEv(ptr noundef nonnull align 8 dereferenceable(2728) %6) #9
  %z = getelementptr inbounds nuw %"struct.openmc::Position", ptr %call8, i32 0, i32 2
  %7 = load double, ptr %z, align 8, !tbaa !58
  store double %7, ptr %x.ascast, align 8, !tbaa !14
  br label %if.end
...
if.end9:                                          ; preds = %if.end, %if.then
  %8 = load double, ptr %x.ascast, align 8, !tbaa !14
  %min_ = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 23
  %9 = load double, ptr %min_, align 8, !tbaa !59
  %cmp10 = fcmp oge double %8, %9
  br i1 %cmp10, label %land.lhs.true, label %if.end20

land.lhs.true:                                    ; preds = %if.end9
  %10 = load double, ptr %x.ascast, align 8, !tbaa !14
  %max_ = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 24
  %11 = load double, ptr %max_, align 8, !tbaa !60
  %cmp11 = fcmp ole double %10, %11
  br i1 %cmp11, label %if.then12, label %if.end20

if.then12:                                        ; preds = %land.lhs.true
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %x_norm) #7
  %12 = load double, ptr %x.ascast, align 8, !tbaa !14
  %min_13 = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 23
  %13 = load double, ptr %min_13, align 8, !tbaa !59
  %sub = fsub double %12, %13
  %mul = fmul double 2.000000e+00, %sub
  %max_14 = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 24
  %14 = load double, ptr %max_14, align 8, !tbaa !60
  %min_15 = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 23
  %15 = load double, ptr %min_15, align 8, !tbaa !59
  %sub16 = fsub double %14, %15
  %div = fdiv double %mul, %sub16
  %sub17 = fsub double %div, 1.000000e+00
  store double %sub17, ptr %x_norm.ascast, align 8, !tbaa !14
  call void @llvm.lifetime.start.p5(i64 1000, ptr addrspace(5) %wgt) #7
  %order_ = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 17
  %16 = load i32, ptr %order_, align 8, !tbaa !61
  %17 = load double, ptr %x_norm.ascast, align 8, !tbaa !14
  %arraydecay = getelementptr inbounds [125 x double], ptr %wgt.ascast, i64 0, i64 0
  call void @calc_pn_c(i32 noundef %16, double noundef %17, ptr noundef %arraydecay) #9
...
for.cond:                                         ; preds = %for.inc, %if.then12
  ...
  %order_18 = getelementptr inbounds nuw %"class.openmc::Filter", ptr %this1, i32 0, i32 17
  %19 = load i32, ptr %order_18, align 8, !tbaa !61
  %add = add nsw i32 %19, 1
  %cmp19 = icmp slt i32 %18, %add
...
for.body:                                         ; preds = %for.cond
  %20 = load ptr, ptr %match.addr.ascast, align 8, !tbaa !29
  ...
  %23 = load double, ptr %arrayidx, align 8, !tbaa !14
  call void @_ZN6openmc11FilterMatch9push_backEid(ptr noundef nonnull align 8 dereferenceable(1513) %20, i32 noundef %21, double noundef %23) #9
  br label %for.inc
...
for.end:                                          ; preds = %for.cond.cleanup
  call void @llvm.lifetime.end.p5(i64 1000, ptr addrspace(5) %wgt) #7
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %x_norm) #7
  br label %if.end20

if.end20:                                         ; preds = %for.end, %land.lhs.true, %if.end9
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %x) #7
  ret void
}
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i32, ptr %bins_weights_length_, align 8, !tbaa !64
  ...
  %3 = load i32, ptr %bins_weights_length_2, align 8, !tbaa !64
  ...
  %4 = load i32, ptr %bins_weights_length_5, align 8, !tbaa !64
  %inc = add nsw i32 %4, 1
  store i32 %inc, ptr %bins_weights_length_5, align 8, !tbaa !64
  br label %if.end
...
entry:
  ...
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  %bins_weights_length_ = getelementptr inbounds nuw %"class.openmc::FilterMatch", ptr %this1, i32 0, i32 3
  %0 = load i32, ptr %bins_weights_length_, align 8, !tbaa !64
...
define internal double @__ocml_logb_f64(double noundef %0) #5 {
  ...
  %5 = load i8, ptr addrspace(4) @__oclc_finite_only_opt, align 1, !tbaa !66, !range !70, !noundef !71
  %6 = icmp eq i8 %5, 0
...
!55 = !{!56, !15, i64 0}
!56 = !{!"_ZTSN6openmc8PositionE", !15, i64 0, !15, i64 8, !15, i64 16}
!57 = !{!56, !15, i64 8}
!58 = !{!56, !15, i64 16}
!59 = !{!32, !15, i64 384}
!60 = !{!32, !15, i64 392}
...
!64 = !{!65, !19, i64 1504}
!65 = !{!"_ZTSN6openmc11FilterMatchE", !16, i64 0, !16, i64 504, !19, i64 1504, !19, i64 1508, !44, i64 1512}
!66 = !{!67, !67, i64 0}
!67 = !{!"bool", !68, i64 0}
